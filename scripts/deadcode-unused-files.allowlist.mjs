...
export const KNIP_UNUSED_FILE_ALLOWLIST = [
  ...
  "extensions/slack/src/events-api/endpoint.ts",
  "extensions/slack/src/events-api/index.ts",
  "extensions/slack/src/events-api/signature.ts",
  "extensions/slack/src/state/channel-routing-store.ts",
  "extensions/slack/src/state/event-dedup-store.ts",
  "extensions/slack/src/state/index.ts",
  "extensions/slack/src/state/state-store.ts",
  "extensions/slack/src/state/thread-participation-store.ts",
  "src/agents/eval/instruction-following-harness.ts",
  "src/agents/pi-embedded-runner/run/history-segments.ts",
