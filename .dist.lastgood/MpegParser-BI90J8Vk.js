...
import { c as stripNulls, o as getBitAllignedNumber, s as isBitSet } from "./Util-DouHaPQs.js";
...
var MpegParser = class extends AbstractID3Parser {
  ...
  async parseAdts(header) {
    ...
    if (header.samplingRate !== null) {
      ...
      const bitrate =
        8 * (this.frameCount === 0 ? 0 : this.totalDataLength / this.frameCount) * framesPerSec +
        0.5;
