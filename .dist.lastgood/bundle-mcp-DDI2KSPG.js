...
import {
  ...
  f as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH,
  g as mergeBundlePathLists,
  p as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH,
...
import { n as matchRootFileOpenFailure } from "./root-file-B8t_jFqF.js";
...
function readBundleJsonObject(params) {
  ...
  if (result.reason === "open")
    return (
      params.onOpenFailure?.(result.failure) ?? {
        ok: true,
        raw: {},
      }
    );
...
//#endregion
export {
  loadEnabledBundleConfig as a,
  inspectBundleServerRuntimeSupport as i,
  inspectBundleMcpRuntimeSupport as n,
  readBundleJsonObject as o,
  loadEnabledBundleMcpConfig as r,
  extractMcpServerMap as t,
};
