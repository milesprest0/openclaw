...
import { t as createAllowlistSetupWizardProxy } from "./setup-wizard-proxy-CABzD4QZ.js";
  ...
  return {
    ...
    finalize: async ({ cfg, accountId, options, prompter }) => {
      ...
      if (options?.quickstartDefaults)
        return { cfg: setSlackInteractiveReplies(cfg, accountId, true) };
      return {
        cfg: setSlackInteractiveReplies(
          cfg,
          accountId,
...
//#endregion
export {
  describeSlackSetupAccount as a,
  SLACK_CHANNEL as i,
  createSlackSetupWizardProxy as n,
  isSlackSetupAccountConfigured as o,
  slackSetupAdapter as r,
  createSlackSetupWizardBase as t,
};
