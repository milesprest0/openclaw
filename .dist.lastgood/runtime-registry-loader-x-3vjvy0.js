import { r as withActivatedPluginIds } from "./activation-context-lkE-qLhi.js";
...
import {
  ...
  m as resolveConfiguredChannelPluginIds,
  n as resolveChannelPluginIds,
...
function ensurePluginRegistryLoaded(options) {
  ...
  const requestedPluginIds =
    requestedChannelOwnerPluginIds === void 0
  ...
  const scopedConfig =
    ...
    (!scopedLoad || requestedChannelOwnerPluginIds !== void 0)
  ...
  const scopedActivationSourceConfig =
    ...
    (!scopedLoad || requestedChannelOwnerPluginIds !== void 0)
      ...
      : context.activationSourceConfig;
  resolveOrLoadRuntimePluginRegistry(
