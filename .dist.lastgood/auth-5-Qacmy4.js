...
import "./model-selection-shared-D9oQINZ2.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-B4Bcz6fY.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-ZgH7vAUU.js";
import {
  i as resolveProviderMatch,
  n as applyProviderAuthConfigPatch,
  r as pickAuthMethod,
  t as applyDefaultModel,
} from "./provider-auth-choice-helpers-DGJxQIqG.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DWjbCNVf.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-C6AI0_h_.js";
import { r as normalizeProviderId } from "./provider-id-CG9pXYPs.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DRIJPvX-.js";
import { n as resolvePluginProviders } from "./providers.runtime-MFDKvuvZ.js";
import { t as isRemoteEnvironment } from "./remote-env-DvxkjR8s.js";
import {
  a as loadValidConfigOrThrow,
  s as resolveKnownAgentId,
  u as updateConfig,
} from "./shared-BbHHdmwP.js";
import { s as loadAuthProfileStoreForRuntime } from "./store-9hg03xJO.js";
import {
  c as normalizeOptionalString,
  d as normalizeStringifiedOptionalString,
} from "./string-coerce-BdEutqX5.js";
import { n as clearAuthProfileCooldown } from "./usage-BOP5ZbfL.js";
...
async function runProviderAuthMethod(params) {
  ...
  await persistProviderAuthResult({
    result: await params.method.run({
      ...
      openUrl: async (url) => {
        const { openUrl } = await import("./onboard-helpers-BTj6NKFG.js");
        await openUrl(url);
      },
      oauth: {
...
async function modelsAuthLoginCommand(opts, runtime) {
  ...
  const selectedProvider =
    resolveRequestedLoginProviderOrThrow(authProviders, opts.provider) ??
    (await prompter
      .select({
