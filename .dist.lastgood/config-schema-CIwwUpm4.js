...
import { t as normalizeMatrixAllowList } from "./allowlist-BMsQK3S3.js";
import {
...
const matrixActionSchema = zod_exports.z
  .object({
  ...
  .optional();
const matrixThreadBindingsSchema = zod_exports.z
  .object({
  ...
  .optional();
const matrixExecApprovalsSchema = zod_exports.z
  .object({
    enabled: zod_exports.z.boolean().optional(),
    ...
    target: zod_exports.z.enum(["dm", "channel", "both"]).optional(),
  })
  .optional();
const matrixRoomSchema = zod_exports.z
  .object({
    account: zod_exports.z.string().optional(),
    enabled: zod_exports.z.boolean().optional(),
    requireMention: zod_exports.z.boolean().optional(),
    allowBots: zod_exports.z
      .union([zod_exports.z.boolean(), zod_exports.z.literal("mentions")])
      .optional(),
  ...
  .optional();
const matrixNetworkSchema = zod_exports.z
  .object({ dangerouslyAllowPrivateNetwork: zod_exports.z.boolean().optional() })
  .strict()
  .optional();
const matrixStreamingSchema = zod_exports.z
  .object({
    mode: zod_exports.z.enum(["partial", "quiet", "progress", "off"]).optional(),
    progress: zod_exports.z
      .object({
        label: zod_exports.z
          .union([zod_exports.z.string(), zod_exports.z.literal(false)])
          .optional(),
      ...
      .strict()
      .optional(),
    preview: zod_exports.z
      .object({ toolProgress: zod_exports.z.boolean().optional() })
      .strict()
      .optional(),
  })
  .strict();
const MatrixChannelConfigSchema = buildChannelConfigSchema(
  zod_exports.z.object({
    ...
    streaming: zod_exports.z
      .union([
        zod_exports.z.enum(["partial", "quiet", "progress", "off"]),
        zod_exports.z.boolean(),
        matrixStreamingSchema,
      ])
      .optional(),
    replyToMode: zod_exports.z.enum(["off", "first", "all", "batched"]).optional(),
    threadReplies: zod_exports.z.enum(["off", "inbound", "always"]).optional(),
    ...
    ackReactionScope: zod_exports.z
    ...
    autoJoin: zod_exports.z.enum(["always", "allowlist", "off"]).optional(),
