...
} from "./custom-command-config-DksmCZK4.js";
import { n as isValidInboundPathRootPattern } from "./inbound-path-policy-UV1fIghZ.js";
import { t as isSafeScpRemoteHost } from "./scp-host-4o-2UHZG.js";
...
const ChannelHeartbeatVisibilitySchema = z
  ...
  .strict()
  .optional();
const ChannelHealthMonitorSchema = z
...
function validateSlackSigningSecretRequirements(value, ctx) {
  ...
  forEachEnabledAccount(value.accounts, (accountId, account) => {
    if ((account.mode === "http" || account.mode === "socket" ? account.mode : baseMode) !== "http")
      return;
...
const TelegramCapabilitiesSchema = z.union([
  z.array(z.string()),
  z.object({ inlineButtons: TelegramInlineButtonsScopeSchema.optional() }).strict(),
]);
...
const TelegramDmSchema = z
  .object({ threadReplies: TelegramDmThreadRepliesSchema.optional() })
  .strict();
...
const DiscordUiSchema = z
  .object({ components: z.object({ accentColor: HexColorSchema.optional() }).strict().optional() })
  .strict()
  .optional();
...
const SlackAccountSchema = z
  .object({
    ...
    appMentionRetryTtlMs: z.number().int().min(6e4).optional(),
    eventsApi: z
      .object({
        enabled: z.boolean().optional(),
        webhookPath: z.string().optional(),
...
//#endregion
export {
  MSTeamsConfigSchema as a,
  TelegramConfigSchema as c,
  IMessageConfigSchema as i,
  ChannelHeartbeatVisibilitySchema as l,
  DiscordConfigSchema as n,
  SignalConfigSchema as o,
  GoogleChatConfigSchema as r,
  SlackConfigSchema as s,
  WhatsAppConfigSchema as t,
};
