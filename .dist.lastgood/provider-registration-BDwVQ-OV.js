...
import { n as applyMinimaxApiConfigCn, t as applyMinimaxApiConfig } from "./onboard-CR_yqVqZ.js";
...
import {
  n as buildMinimaxProvider,
  t as buildMinimaxPortalProvider,
} from "./provider-catalog-CtgGzVuQ.js";
...
import {
  o as isMiniMaxModernModelId,
  t as MINIMAX_DEFAULT_MODEL_ID,
} from "./provider-models-CNGFrq1w.js";
import "./provider-stream-family-D6uaWTED.js";
import { r as MINIMAX_FAST_MODE_STREAM_HOOKS } from "./provider-stream-BeWZvrLX.js";
import { n as fetchMinimaxUsage } from "./provider-usage-DMzwZy0Z.js";
...
function resolvePortalCatalog(ctx) {
  ...
  const hasProfiles =
    listProfilesForProvider(
      ensureAuthProfileStore(ctx.agentDir, { allowKeychainPrompt: false }),
      PORTAL_PROVIDER_ID,
    ).length > 0;
  ...
  return {
    provider: buildPortalProviderCatalog({
      baseUrl:
        normalizeOptionalString(explicitProvider?.baseUrl) ||
        buildMinimaxPortalProvider(ctx.env).baseUrl,
      apiKey,
    }),
  };
}
