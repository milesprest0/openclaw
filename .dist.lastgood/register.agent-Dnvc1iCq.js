...
import { n as agentCommand } from "./agent-command-bmrIHuJ_.js";
import { n as listAgentIds } from "./agent-scope-config-CXZGyKMl.js";
import {
  a as agentsBindingsCommand,
  i as agentsBindCommand,
  n as agentsSetIdentityCommand,
  o as agentsUnbindCommand,
  r as agentsDeleteCommand,
  t as agentsListCommand,
} from "./agents-C1sa9_p6.js";
import { t as agentsAddCommand } from "./agents.commands.add-DAK4UdgH.js";
import {
  i as callGateway,
  l as isGatewayTransportError,
  u as randomIdempotencyKey,
...
import {
  ...
  o as buildExplicitSessionIdSessionKey,
...
async function agentViaGatewayCommand(opts, runtime) {
  ...
  const gatewayTimeoutMs =
    timeoutSeconds === 0 ? NO_GATEWAY_TIMEOUT_MS : Math.max(1e4, (timeoutSeconds + 30) * 1e3);
