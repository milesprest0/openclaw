...
import { h as shortenHomeInString } from "./utils-BGRcpLKt.js";
...
function registerPluginsCli(program) {
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginsInspectCommand } = await import("./plugins-inspect-command-T00Pri8o.js");
  ...
  plugins
    ...
    .action(async (id) => {
      ...
      const { enablePluginInConfig } = await import("./enable-BuHCaQgh.js");
      const { normalizePluginId } = await import("./config-state-CaH0sJTm.js");
      const { buildPluginRegistrySnapshotReport } = await import("./status-BNXZBuSb.js");
      const { applySlotSelectionForPlugin, logSlotWarnings } =
        await import("./plugins-command-helpers-j7we7_Es.js");
      const { refreshPluginRegistryAfterConfigMutation } =
        await import("./plugins-registry-refresh-OBE2jYcV.js");
  ...
  plugins
    ...
    .action(async (id) => {
      ...
      const { normalizePluginId } = await import("./config-state-CaH0sJTm.js");
      const { buildPluginRegistrySnapshotReport } = await import("./status-BNXZBuSb.js");
      const { setPluginEnabledInConfig } = await import("./plugins-config-D4mmesD3.js");
      const { refreshPluginRegistryAfterConfigMutation } =
        await import("./plugins-registry-refresh-OBE2jYcV.js");
      const snapshot = await readConfigFileSnapshot();
      const cfg = snapshot.sourceConfig ?? snapshot.config;
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginUninstallCommand } = await import("./plugins-uninstall-command-ClI9LFhk.js");
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginUpdateCommand } = await import("./plugins-update-command-CvqHjM66.js");
  ...
  plugins
    ...
    .action(async (opts) => {
      const { inspectPluginRegistry, refreshPluginRegistry } =
        await import("./plugin-registry-mq9x-VCL.js");
  ...
  plugins
    ...
    .action(async () => {
      ...
      } = await import("./status-BNXZBuSb.js");
      ...
      const shadowed = report.diagnostics.filter((entry) =>
        isErroredConfigSelectedShadowDiagnostic({
          entry,
  ...
  plugins
    ...
    .action(async (source, opts) => {
      const { listMarketplacePlugins } = await import("./marketplace-CTxyPV5E.js");
      const { createPluginInstallLogger } = await import("./plugins-command-helpers-j7we7_Es.js");
