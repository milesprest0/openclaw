...
import { t as createGatewayCredentialPlan } from "./credential-planner-CcCVplQO.js";
import {
  n as isGatewaySecretRefUnavailableError,
  t as GatewaySecretRefUnavailableError,
} from "./credentials-FOmsSSJ3.js";
import { r as resolveFutureConfigActionBlock } from "./future-version-guard-DiNXK9LJ.js";
import { l as readBestEffortConfig, u as readConfigFileSnapshot } from "./io-CEQSCTGy.js";
import { n as formatConfigIssueLines } from "./issue-format-DZoENRCj.js";
import { f as resolveIsNixMode } from "./paths-Cnwfh6dH.js";
import {
  g as writeGatewayRestartIntentSync,
  t as clearGatewayRestartIntentSync,
} from "./restart-BMF0Nrvt.js";
import { o as renderSystemdUnavailableHints } from "./runtime-hints-Bj-tHqaA.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import "./config-CMOdcWpc.js";
import { r as checkTokenDrift } from "./service-audit-lavVZqd0.js";
import {
  a as startGatewayService,
  t as describeGatewayServiceRestart,
} from "./service-XaNrZpdz.js";
import {
  i as filterContainerGenericHints,
  m as createDaemonActionContext,
  p as buildDaemonServiceSnapshot,
} from "./shared-CD1EqH1S.js";
import { a as isSystemdUserServiceAvailable } from "./systemd-DKgtnjvB.js";
import { t as isWSL } from "./wsl-DVnK6WpM.js";
...
async function runServiceStart(params) {
  ...
  try {
    ...
    if (startResult.outcome === "scheduled") {
      emitActionMessage({
        ...
        payload: {
          ok: true,
          result: "scheduled",
          message: describeGatewayServiceRestart(params.serviceNoun, { outcome: "scheduled" })
            .message,
    ...
    if (startResult.outcome === "repair-required") {
      ...
      fail(
        `${params.serviceNoun} service needs repair before it can start: ${startResult.issues.map((issue) => issue.message).join("; ")}`,
...
//#endregion
export {
  runServiceUninstall as i,
  runServiceStart as n,
  runServiceStop as r,
  runServiceRestart as t,
};
