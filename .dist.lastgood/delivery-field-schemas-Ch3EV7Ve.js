...
const LowercaseNonEmptyStringFieldSchema = z.preprocess(
  trimLowercaseStringPreprocess,
  z.string().min(1),
);
const TrimmedNonEmptyStringFieldSchema = z.preprocess(trimStringPreprocess, z.string().min(1));
const DeliveryThreadIdFieldSchema = z.union([
  TrimmedNonEmptyStringFieldSchema,
  z.number().finite(),
]);
const TimeoutSecondsFieldSchema = z
  .number()
  .finite()
...
//#endregion
export {
  parseDeliveryInput as a,
  TrimmedNonEmptyStringFieldSchema as i,
  LowercaseNonEmptyStringFieldSchema as n,
  parseOptionalField as o,
  TimeoutSecondsFieldSchema as r,
  DeliveryThreadIdFieldSchema as t,
};
