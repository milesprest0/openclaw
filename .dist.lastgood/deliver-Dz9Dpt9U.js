import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-PPtZ0iMr.js";
import {
  c as resolveTextChunkLimit,
  i as chunkMarkdownTextWithMode,
  n as chunkByParagraph,
  s as resolveChunkMode,
} from "./chunk-aBEwc7QQ.js";
import {
  _ as runOutboundDeliveryCommitHooks,
  c as enqueueDelivery,
  g as attachOutboundDeliveryCommitHook,
  m as markDeliveryPlatformSendAttemptStarted,
  o as withActiveDeliveryClaim,
  p as markDeliveryPlatformOutcomeUnknown,
  s as ackDelivery,
  u as failDelivery,
} from "./delivery-queue-jB0MZzlm.js";
import { t as diagnosticErrorCategory } from "./diagnostic-error-metadata-XbXBF9cO.js";
import { n as emitDiagnosticEvent } from "./diagnostic-events-9isI4hMq.js";
...
import {
  a as toInternalMessageSentContext,
  d as toPluginMessageSentEvent,
  l as toPluginMessageContext,
  t as buildCanonicalSentMessageHookContext,
...
import { n as resolvePendingSpawnedChildren } from "./pending-spawn-query-77FNakly.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-BlYckV7v.js";
import {
  C as createReplyToDeliveryPolicy,
  m as resolveSendableOutboundReplyParts,
} from "./reply-payload-D_-IJF8p.js";
import { n as stripInternalRuntimeScaffolding } from "./sanitize-text-CR0zkUDk.js";
import {
  c as shouldSuppressReasoningPayload,
  n as resolveSilentReplySettings,
  o as formatBtwTextForExternalDelivery,
...
import { o as resolveMirroredTranscriptText } from "./transcript-B5N3gLUE.js";
...
async function loadChannelBootstrapRuntime() {
  channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-DFe2VLi-.js");
  return await channelBootstrapRuntimePromise;
}
async function resolveChannelOutboundDirectiveOptions(params) {
  return {
    extractMarkdownImages:
      (await loadBootstrappedOutboundAdapter(params))?.extractMarkdownImages === true
        ? true
        : void 0,
  };
}
...
async function deliverOutboundPayloadsCore(params) {
  ...
  const configuredTextLimit = handler.chunker
    ? resolveTextChunkLimit(cfg, channel, accountId, { fallbackLimit: handler.textChunkLimit })
    : void 0;
  const textLimit =
  ...
  for (const payload of normalizedPayloads) {
    ...
    try {
      ...
      const applySendReplyToConsumption = (overrides) =>
...
//#endregion
export {
  normalizeOutboundPayloadsForJson as a,
  projectOutboundPayloadPlanForJson as c,
  createRenderedMessageBatch as d,
  throwIfAborted as f,
  formatOutboundPayloadLog as i,
  projectOutboundPayloadPlanForMirror as l,
  resolveOutboundDurableFinalDeliverySupport as n,
  normalizeReplyPayloadsForDelivery as o,
  parseReplyDirectives as p,
  createOutboundPayloadPlan as r,
  projectOutboundPayloadPlanForDelivery as s,
  deliverOutboundPayloads as t,
  projectOutboundPayloadPlanForOutbound as u,
};
