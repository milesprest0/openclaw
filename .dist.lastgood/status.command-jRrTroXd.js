import {
  n as statusChannelsTableColumns,
  t as buildStatusChannelsTableRows,
} from "./channels-table-D4iJFPyd.js";
import {
  c as normalizePairingConnectRequestId,
  d as readConnectPairingRequiredMessage,
  f as readPairingConnectErrorDetails,
...
import { t as runStatusJsonCommand } from "./status-json-command-RHHKLIsM.js";
import {
  a as resolveStatusSecurityAudit,
  d as buildStatusOverviewSurfaceFromScan,
  i as resolveStatusRuntimeSnapshot,
  n as resolveStatusGatewayHealth,
  s as resolveStatusUsageSummary,
  t as loadStatusProviderUsageModule,
} from "./status-runtime-shared-CyJdhB2r.js";
import { t as logGatewayConnectionDetails } from "./status.gateway-connection-DwyaYBo3.js";
import {
  S as statusHealthColumns,
  _ as buildStatusPluginCompatibilityLines,
  b as buildStatusSystemEventsRows,
  c as buildStatusOverviewSection,
  d as buildStatusUsageSection,
  g as buildStatusPairingRecoveryLines,
  h as buildStatusHealthRows,
  l as buildStatusSessionsSection,
  m as buildStatusFooterLines,
  o as buildStatusChannelsTableSection,
  p as buildStatusCommandOverviewRows,
  s as buildStatusHealthSection,
  t as appendStatusReportSections,
  u as buildStatusSystemEventsSection,
  v as buildStatusSecurityAuditLines,
  x as buildStatusSystemEventsTrailer,
  y as buildStatusSessionsRows,
} from "./text-report-CYCO5xsv.js";
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-Bjx1hAWn.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(
  () => import("./status.scan.fast-json-Csg-nNmo.js"),
);
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-CsKuKi0W.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(
  () => import("./status.command.text-runtime-DCfX_bz9.js"),
);
const statusGatewayConnectionRuntimeLoader = createLazyImportLoader(
  () => import("./status.gateway-connection.runtime.js"),
);
const statusNodeModeModuleLoader = createLazyImportLoader(
  () => import("./status.node-mode-Dtr6TsDr.js"),
);
...
function resolvePairingRecoveryContext(params) {
  ...
  const pairing = readConnectPairingRequiredMessage(
