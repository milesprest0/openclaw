...
import {
  ...
  s as tracePluginLifecyclePhaseAsync,
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
  ...
  } = await import("./installed-plugin-index-records-Dn1Gzc1P.js");
  const { buildPluginSnapshotReport } = await import("./status-BNXZBuSb.js");
  const {
  ...
  } = await import("./uninstall-DLe0Gh00.js");
  const { commitPluginInstallRecordsWithConfig } =
    await import("./plugins-install-record-commit-BgbPdj20.js");
  const { refreshPluginRegistryAfterConfigMutation } =
    await import("./plugins-registry-refresh-OBE2jYcV.js");
  const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-C2qeiK06.js");
  const { PromptInputClosedError, promptYesNo } = await import("./prompt-BSXZJCLD.js");
