import {
  a as OPENAI_CODEX_LOGIN_HINT,
  i as OPENAI_CODEX_DEVICE_PAIRING_LABEL,
  o as OPENAI_CODEX_LOGIN_LABEL,
  r as OPENAI_CODEX_DEVICE_PAIRING_HINT,
  s as OPENAI_CODEX_WIZARD_GROUP,
} from "./auth-choice-copy-3yFxomlK.js";
import {
  i as isOpenAICodexBaseUrl,
  r as isOpenAIApiBaseUrl,
  t as OPENAI_CODEX_RESPONSES_BASE_URL,
} from "./base-url-CL8n5CaB.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-BVjKuR6p.js";
import "./defaults-4m7JJmD2.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { n as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-DkWwPrEp.js";
import { t as buildOpenAICodexProvider } from "./openai-codex-catalog-DoLXvnCo.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-codex-device-code-Dz3imkar.js";
...
import { r as loginOpenAICodexOAuth } from "./provider-auth-login-Cqq-slOk.js";
import { t as buildOauthProviderAuthResult } from "./provider-auth-result-BUtvWgsR.js";
import { s as findCatalogTemplate } from "./provider-catalog-shared-DUixNfPI.js";
...
import { i as fetchCodexUsage } from "./provider-usage-DMzwZy0Z.js";
import {
  n as buildOpenAISyntheticCatalogEntry,
  t as buildOpenAIResponsesProviderHooks,
} from "./shared-DsZ1ZHSm.js";
import { r as ensureAuthProfileStoreForLocalUpdate } from "./store-9hg03xJO.js";
import {
  a as normalizeLowercaseStringOrEmpty,
  f as readStringValue,
} from "./string-coerce-BdEutqX5.js";
import { t as resolveOpenAICodexThinkingProfile } from "./thinking-policy-CJLwigQz.js";
...
function normalizeCodexTransportFields(params) {
  ...
  return {
    api,
    baseUrl:
      api === "openai-codex-responses" && useCodexTransport
...
function normalizeCodexTransport(model) {
  const canonicalModelId =
    normalizeLowercaseStringOrEmpty(model.id) === OPENAI_CODEX_GPT_54_LEGACY_MODEL_ID
      ? OPENAI_CODEX_GPT_54_MODEL_ID
      : model.id;
  const canonicalName =
...
async function refreshOpenAICodexOAuthCredential(cred) {
  try {
    const { refreshOpenAICodexToken } =
      await import("./extensions/openai/openai-codex-provider.runtime.js");
...
function buildOpenAICodexProviderPlugin() {
  return {
    ...
    catalog: {
      ...
      run: async (ctx) => {
        if (
          listProfilesForProvider(ensureAuthProfileStoreForLocalUpdate(ctx.agentDir), PROVIDER_ID)
            .length === 0
        )
          return null;
