import { s as parseRawSessionConversationRef } from "./session-key-utils-B3KPN8Ee.js";
...
function resolveAgentHookChannelId(params) {
  ...
  const metadataChannel =
    stripConversationPrefix(params.currentChannelId ?? void 0, provider) ??
    stripConversationPrefix(params.messageTo ?? void 0, provider);
