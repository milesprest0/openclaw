...
import { _ as resolveChannelStreamingBlockCoalesce } from "./channel-streaming-DxCQl0Kn.js";
...
function resolveProviderChunkContext(cfg, provider, accountId) {
  ...
  return {
    providerKey,
    providerId,
    textLimit: resolveTextChunkLimit(cfg, providerKey, accountId, {
      fallbackLimit: providerId ? getChannelPlugin(providerId)?.outbound?.textChunkLimit : void 0,
    }),
  };
}
...
//#endregion
export {
  resolveBlockStreamingChunking as n,
  resolveEffectiveBlockStreamingConfig as r,
  clampPositiveInteger as t,
};
