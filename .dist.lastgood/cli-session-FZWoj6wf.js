...
function resolveCliSessionReuse(params) {
  ...
  const hasMatchingVersionedAuthEpoch =
    ...
    storedAuthEpoch !== void 0 &&
    currentAuthEpoch !== void 0 &&
  ...
  if (binding?.authEpochVersion === params.authEpochVersion && storedAuthEpoch !== currentAuthEpoch)
  ...
  if (normalizeOptionalString(binding?.mcpConfigHash) !== currentMcpConfigHash)
    return { invalidatedReason: "mcp" };
  return { sessionId };
}
//#endregion
export {
  hashCliSessionText as a,
  setCliSessionId as c,
  getCliSessionId as i,
  clearCliSession as n,
  resolveCliSessionReuse as o,
  getCliSessionBinding as r,
  setCliSessionBinding as s,
  clearAllCliSessions as t,
};
