...
import {
  n as modelKey$1,
  r as normalizeStaticProviderModelId,
} from "./model-ref-shared-C2I7TGOl.js";
import {
...
function buildAllowedModelSetWithFallbacks(params) {
  ...
  const addAllowedModelRef = (raw) => {
    ...
    if (
      ...
      syntheticCatalogEntries.set(
        key,
        buildSyntheticAllowedCatalogEntry({
          parsed,
          metadata,
        }),
      );
...
//#endregion
export {
  modelSupportsInput as C,
  findModelInCatalog as S,
  modelKey as _,
  getModelRefStatusWithFallbackModels as a,
  resolveConfiguredProviderFallback as b,
  normalizeModelSelection as c,
  resolveBareModelDefaultProvider as d,
  resolveConfiguredModelRef as f,
  legacyModelKey as g,
  resolveModelRefFromString as h,
  buildModelAliasIndex as i,
  resolveAllowedModelRefFromAliasIndex as l,
  resolveHooksGmailModel as m,
  buildConfiguredAllowlistKeys as n,
  inferUniqueProviderFromCatalog as o,
  resolveConfiguredOpenRouterCompatAlias as p,
  buildConfiguredModelCatalog as r,
  inferUniqueProviderFromConfiguredModels as s,
  buildAllowedModelSetWithFallbacks as t,
  resolveAllowlistModelKey as u,
  normalizeModelRef as v,
  findModelCatalogEntry as x,
  parseModelRef as y,
};
