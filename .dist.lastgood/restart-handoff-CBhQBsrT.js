...
function parseGatewayRestartHandoff(raw) {
  ...
  if (
    parsed.kind !== "gateway-supervisor-restart-handoff" ||
    parsed.version !== 1 ||
  ...
  if (parsed.processInstanceId !== void 0 && typeof parsed.processInstanceId !== "string")
    return null;
...
//#endregion
export {
  readGatewayRestartHandoffSync as n,
  writeGatewayRestartHandoffSync as r,
  formatGatewayRestartHandoffDiagnostic as t,
};
