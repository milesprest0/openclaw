...
import { i as OPENCLAW_WRAPPER_ENV_KEY } from "./daemon-install-plan.shared-Bdw5CBKo.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CkYPLluX.js";
import { t as isDoctorUpdateRepairMode } from "./doctor-repair-mode-sTnkoI0L.js";
import {
...
import {
  i as renderGatewayServiceCleanupHints,
  n as findExtraGatewayServices,
} from "./inspect-CnGlI8hm.js";
...
} from "./runtime-paths-vFciNMRO.js";
import {
...
import { t as summarizeGatewayServiceLayout } from "./service-layout-CXKCdYxm.js";
...
import {
  S as readManagedServiceEnvKeysFromEnvironment,
  f as uninstallLegacySystemdUnits,
  i as isSystemdUnitActive,
...
const EXECSTART_REPAIR_CODES = new Set([
...
async function maybeScanExtraGatewayServices(options, runtime, prompter) {
  const extraServices = await filterInactiveExtraGatewayServices(
    await findExtraGatewayServices(process.env, { deep: options.deep }),
  );
