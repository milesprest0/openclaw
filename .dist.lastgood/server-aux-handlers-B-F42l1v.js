...
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-DxaQeRwl.js";
import { n as channelRouteDedupeKey } from "./channel-route-B9olp3tt.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-UCNBRHfo.js";
...
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-BPlmHS3G.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-Dn-pJrhh.js";
import {
  a as resolveApnsAuthConfigFromEnv,
  c as sendApnsExecApprovalAlert,
  d as resolveApnsRelayConfigFromEnv,
  l as sendApnsExecApprovalResolvedWake,
...
var ExecApprovalManager = class {
  ...
  listPendingRecords() {
    return Array.from(this.pending.values())
      ...
      .filter((record) => record.resolvedAtMs === void 0);
  }
  ...
  lookupApprovalId(input, opts = {}) {
    ...
    if (exact)
      return opts.includeResolved || exact.record.resolvedAtMs === void 0
        ? {
            kind: "exact",
            id: normalized,
          }
...
function createGatewayAuxHandlers(params) {
  ...
  const loadExecApprovalHandlers = () =>
    (execApprovalHandlersPromise ??= import("./exec-approval-CsMGLi40.js").then(
  ...
  const loadPluginApprovalHandlers = () =>
    (pluginApprovalHandlersPromise ??= import("./plugin-approval-UkCLvcaG.js").then(
  ...
  const loadSecretsHandlers = () =>
    (secretsHandlersPromise ??= import("./secrets-CPs3seP5.js").then(({ createSecretsHandlers }) =>
