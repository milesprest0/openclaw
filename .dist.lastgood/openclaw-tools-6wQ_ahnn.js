...
import {
  t as clearAgentRunContext,
  u as registerAgentRunContext,
...
import { h as isWindowsDrivePath } from "./archive-CfKTdlm5.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-DnuPT-bL.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BuUFK0A0.js";
import { i as callGateway } from "./call-hIeQLRKk.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BYdI2qTA.js";
import { h as stringifyRouteThreadId } from "./channel-route-B9olp3tt.js";
import { n as extractTextFromChatContent } from "./chat-content-DcUT1lrD.js";
import { r as stripToolMessages } from "./chat-history-text-Bx2iqRAi.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BBJMHWvK.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CNlzw0VK.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CkWxZ_Vf.js";
import { n as isRestartEnabled } from "./commands.flags-DSmuIKZj.js";
import {
  b as readSnakeCaseParamRaw,
  f as readNumberParam,
  g as readStringParam$1,
  i as asToolParamsRecord,
  l as jsonResult,
  m as readStringArrayParam,
  r as ToolInputError,
} from "./common-BPZLgNoA.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DWlpS7W-.js";
import {
  n as resolveConfiguredMediaMaxBytes,
  r as resolveGeneratedMediaMaxBytes,
} from "./configured-max-bytes-B8j5nYjM.js";
import "./config-CMOdcWpc.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-BXtaJDEs.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DFTSvtud.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CwiaOxbz.js";
import {
  n as resolveAutoMediaKeyProviders,
  r as resolveDefaultMediaModel,
  t as providerSupportsNativePdfDocument,
} from "./defaults-Miq3q5Uz.js";
import {
  d as getMediaUnderstandingProvider,
  s as DEFAULT_TIMEOUT_SECONDS,
} from "./defaults.constants-u25YkDfl.js";
import {
  i as normalizeDeliveryContext,
  t as deliveryContextFromSession,
} from "./delivery-context.shared-mj-12Z6_.js";
import {
  i as failTaskRunByRunId,
  r as createRunningTaskRun,
  s as recordTaskRunProgressByRunId,
  t as completeTaskRunByRunId,
} from "./detached-task-runtime-CRxjrfaR.js";
import {
  a as resolveVideoGenerationModeCapabilities,
  i as resolveVideoGenerationMode,
  r as listSupportedVideoGenerationModes,
} from "./duration-support-DAFa2fE_.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BnctHCEh.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BCW9yxs8.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-Df3EC-Xg.js";
import { w as trySafeFileURLToPath, x as hasEncodedFileUrlSeparator } from "./fs-safe-CgBWiL92.js";
import {
  n as readGatewayCallOptions,
  r as resolveGatewayOptions,
  t as callGatewayTool,
} from "./gateway-VO6GibHc.js";
import {
  n as HEARTBEAT_TOOL_OUTCOMES,
  o as normalizeHeartbeatToolResponse,
  r as HEARTBEAT_TOOL_PRIORITIES,
...
import { a as getImageMetadata } from "./image-ops-B3yygUDw.js";
import {
...
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BUopmNQM.js";
import {
  i as getRuntimeConfig,
  o as parseConfigJson5,
  y as resolveConfigSnapshotHash,
} from "./io-CEQSCTGy.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-CEV2BIp0.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import { r as getDefaultLocalRoots } from "./local-media-access-gxEsNSj9.js";
import { t as logDebug } from "./logger-BWdMCYqK.js";
import {
  a as loadManifestContractSnapshot,
  i as listAvailableManifestContractValues,
  n as isManifestPluginAvailableForControlPlane,
} from "./manifest-contract-eligibility-Bpx8eP31.js";
import {
  n as classifyMediaReferenceSource,
  r as normalizeMediaReferenceSource,
} from "./media-reference-eQGFHaVt.js";
import { t as applyMergePatch } from "./merge-patch-Gj7xrHOG.js";
import {
  i as listCrossChannelSchemaSupportedMessageActions,
  n as channelSupportsMessageCapabilityForChannel,
  o as resolveChannelMessageToolSchemaProperties,
  t as channelSupportsMessageCapability,
} from "./message-action-discovery-jVpVmmf8.js";
import {
  a as POLL_CREATION_PARAM_DEFS,
  n as runMessageAction,
  o as SHARED_POLL_CREATION_PARAM_NAMES,
  t as getToolResult,
} from "./message-action-runner-C44vBHWX.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-VUC-himU.js";
import { u as normalizeMessageChannel } from "./message-channel-GRZIhFYD.js";
import {
  n as CHANNEL_MESSAGE_ACTION_NAMES,
  t as resolveMessageSecretScope,
} from "./message-secret-scope-DuHRvr44.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CSQ-Gv-M.js";
import {
  a as coerceImageModelConfig,
  c as resolveConfiguredImageModelRefs,
  d as coerceToolModelConfig,
  f as hasAuthForProvider,
  l as resolveProviderVisionModelFromConfig,
  m as resolveDefaultModelRef,
  n as isMinimaxVlmProvider,
  o as decodeDataUrl,
  p as hasToolModelConfig$1,
  u as buildToolModelConfigFromCandidates,
} from "./minimax-vlm-Dobrn9Ul.js";
import { r as getApiKeyForModel } from "./model-auth-Do8Bfz1M.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DOaXxoUi.js";
import { r as loadModelCatalog } from "./model-catalog-CJYpfYgw.js";
import { n as runWithImageModelFallback } from "./model-fallback-fY3p6tiZ.js";
...
import { t as parseVideoGenerationModelRef } from "./model-ref-D6Ih9jWU.js";
import {
...
import { n as ensureOpenClawModelsJson } from "./models-config-BPSkZZri.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BDguOhH4.js";
import {
  a as parseCameraClipPayload,
  c as writeCameraPayloadToFile,
  i as cameraTempPath,
  n as screenRecordTempPath,
  o as parseCameraSnapPayload,
  r as writeScreenRecordToFile,
  s as writeCameraClipPayloadToFile,
  t as parseScreenRecordPayload,
} from "./nodes-screen-CGEvuUeD.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-B1_2Nbxw.js";
...
import { t as parseTimeoutMs } from "./parse-timeout-BoXPCRnA.js";
...
import {
  ...
  u as resolveStorePath,
} from "./paths-CfeECf6Z.js";
import {
  n as resolveEnabledBundledManifestContractPlugins,
  t as extractPdfContent,
} from "./pdf-extract-CqzzuVX6.js";
import "./delivery-context-D3lOjhR9.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DwjIPr7W.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Bicx4uTg.js";
import {
  f as listAllChannelSupportedActions,
...
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-BzJqZ6Iq.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-CWiNK0Xv.js";
...
import {
  n as listMusicGenerationProviders,
  r as parseMusicGenerationModelRef,
  t as getMusicGenerationProvider,
} from "./provider-registry-BmnHV57n.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-SwjmQzH9.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DueHRTen.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DIWEAjvC.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-auWodfwm.js";
import {
  n as normalizeWorkspaceDir,
  o as toRelativeWorkspacePath,
  r as resolveWorkspaceRoot,
} from "./read-capability-BlYckV7v.js";
import { o as redactToolPayloadText } from "./redact-Mxj55RzQ.js";
import {
  a as normalizeChannelId$1,
  i as listChannelPlugins,
  t as getChannelPlugin,
} from "./registry-D3zb3mnd.js";
import { o as normalizeChannelId } from "./registry-V0yq5bwZ.js";
import { s as resolveTimeoutMs } from "./resolve-DB4enOPl.js";
...
import {
  ...
  s as removeRestartSentinelFile,
  t as buildRestartSuccessContinuation,
} from "./restart-sentinel-CXl2NwhJ.js";
import {
  a as waitForAgentRunAndReadUpdatedAssistantReply,
  i as waitForAgentRun,
  r as readLatestAssistantReplySnapshot,
} from "./run-wait-BzfTmTHO.js";
import { t as buildProviderRegistry } from "./runner-BV9etZbE.js";
import {
  n as listRuntimeImageGenerationProviders,
  t as generateImage,
} from "./runtime--xzc_QzW.js";
import { i as runWebSearch } from "./runtime-CNEVbPNH.js";
import {
  n as listRuntimeVideoGenerationProviders,
  t as generateVideo,
} from "./runtime-CqTJyZYU.js";
import {
  i as getActiveSecretsRuntimeSnapshot,
  r as getActiveRuntimeWebToolsMetadata$1,
...
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BGr6b-K6.js";
import {
  n as resolveSandboxedBridgeMediaPath,
  t as createSandboxBridgeReadFile,
} from "./sandbox-media-paths-CQaCu-jq.js";
import "./media-understanding-Br1KJ1Ub.js";
import { n as assertSandboxPath } from "./sandbox-paths-BVIaOwJU.js";
import { o as root } from "./secure-temp-dir-CCj3cY2B.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-BAHvRI41.js";
import { n as resolveSessionConversationRef } from "./session-conversation-YLqp8hUs.js";
import {
...
import {
  _ as resolveSessionModelIdentityRef,
  n as deriveSessionTitle,
} from "./session-utils-Dhg586UW.js";
import {
  C as jsonUtf8Bytes,
  f as readSessionTitleFieldsFromTranscriptAsync,
  n as capArrayByJsonBytes,
...
} from "./session-visibility-1ho43Kz2.js";
import { a as extractDeliveryInfo } from "./sessions-Bdy1wToU.js";
import {
  a as resolveCurrentSessionClientAlias,
  c as resolveMainSessionAlias,
  d as shouldResolveSessionIdInput,
  i as resolveSandboxedSessionToolContext,
  l as resolveSessionReference,
  n as deriveChannel,
  o as resolveDisplaySessionKey,
  r as resolveSessionToolContext,
  s as resolveInternalSessionKey,
  t as classifySessionKind,
  u as resolveVisibleSessionReference,
} from "./sessions-helpers-BUCXJZwG.js";
import { o as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-zGSeuSpR.js";
import { t as SsrFBlockedError } from "./ssrf-DO8eIXaD.js";
import { s as updateSessionStore } from "./store-BpWdoYPF.js";
import { f as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-BSFLPYqQ.js";
...
import {
  i as loadSessionEntryByKey,
  t as deliverSubagentAnnouncement,
} from "./subagent-announce-delivery-BNkDK1si.js";
import {
  c as resolveSubagentController,
  i as killControlledSubagentRun,
  n as MAX_STEER_MESSAGE_CHARS,
  o as listControlledSubagentRuns,
  r as killAllControlledSubagentRuns,
  s as resolveControlledSubagentTarget,
  t as MAX_RECENT_MINUTES,
  u as steerControlledSubagentRun,
} from "./subagent-control-LdQOjN4T.js";
import {
  i as isActiveSubagentRun,
  n as buildSubagentList,
  r as createPendingDescendantCounter,
} from "./subagent-list-CDDt_IaF.js";
import { p as registerSubagentRun } from "./subagent-registry-DESvhcq6.js";
import {
  _ as isReplySkip,
  f as runAgentStep,
  g as isNonDeliverableSessionsReply,
  h as isAnnounceSkip,
  m as REPLY_SKIP_TOKEN,
  p as ANNOUNCE_SKIP_TOKEN,
} from "./subagent-session-cleanup-BWFbipv_.js";
import {
  n as SUBAGENT_SPAWN_CONTEXT_MODES,
  r as SUBAGENT_SPAWN_MODES,
  t as spawnSubagentDirect,
} from "./subagent-spawn-Fksd3kSE.js";
import { t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-mqSx5td5.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BnrukRw_.js";
import {
  f as supportsAutomaticThreadBindingSpawn,
...
import {
  i as resolveImageSanitizationLimits,
  r as sanitizeToolResultImages,
} from "./tool-images-D8ZmIpdW.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-c6IjbWPy.js";
import {
  C as describeSessionsSendTool,
  S as describeSessionsListTool,
  T as describeUpdatePlanTool,
  _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY,
  b as describeSessionStatusTool,
  g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY,
  h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY,
  m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY,
  p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY,
  u as CRON_TOOL_DISPLAY_SUMMARY,
  v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY,
  w as describeSessionsSpawnTool,
  x as describeSessionsHistoryTool,
  y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY,
} from "./tool-policy-shared-DsbREhoR.js";
import {
  a as resolvePluginTools,
  c as hasNonEmptyManifestEnvCandidate,
  d as manifestProviderBaseUrlGuardPasses,
  l as manifestConfigSignalPasses,
  u as manifestPluginSetupProviderEnvVars,
} from "./tools-DcY_52BH.js";
import { k as textToSpeech } from "./tts-runtime-CfX4V8Mc.js";
import "./web-search-provider-common-DvgMsTTY.js";
import {
  i as stringEnum,
...
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-BGRcpLKt.js";
import {
  a as findActiveVideoGenerationTaskForSession,
  c as buildMusicGenerationTaskStatusDetails,
  i as buildVideoGenerationTaskStatusText,
  l as buildMusicGenerationTaskStatusText,
  o as MUSIC_GENERATION_TASK_KIND,
  r as buildVideoGenerationTaskStatusDetails,
  t as VIDEO_GENERATION_TASK_KIND,
  u as findActiveMusicGenerationTaskForSession,
} from "./video-generation-task-status-DL7Kzx8h.js";
import {
  a as truncateText$1,
  n as htmlToMarkdown,
  r as markdownToText,
...
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-E6nAhoMh.js";
import {
...
import { t as normalizeHttpWebhookUrl } from "./webhook-url-CmRMvdiM.js";
...
function hasSnapshotCapabilityAvailability(params) {
  ...
  for (const plugin of params.snapshot.plugins) {
    ...
    for (const providerId of plugin.contracts?.[params.key] ?? []) {
      if (
        (metadataKey ? plugin[metadataKey]?.[providerId] : void 0)?.configSignals?.some((signal) =>
...
function formatReceivedParamHint(record, groups) {
  ...
  for (const group of groups)
    if (group.allowEmpty) for (const key of group.keys) allowEmptyKeys.add(key);
  const received = [];
...
function assertRequiredParams(record, groups, toolName) {
  ...
  if (missingLabels.length > 0) {
    ...
    throw parameterValidationError(
      `Missing required ${missingLabels.length === 1 ? "parameter" : "parameters"}: ${joined}${formatReceivedParamHint(record, groups)}`,
    );
  }
}
...
function didEditLikelyApply(params) {
  ...
  const normalizedOriginal =
    typeof params.originalContent === "string" ? normalizeToLF(params.originalContent) : void 0;
...
function appendMismatchHint(error, currentContent) {
  ...
  const enhanced = /* @__PURE__ */ new Error(
...
function wrapEditToolWithRecovery(base, options) {
  return {
    ...
    execute: async (toolCallId, params, signal, onUpdate) => {
      ...
      const absolutePath =
        typeof pathParam === "string" ? resolveEditPath(options.root, pathParam) : void 0;
      let originalContent;
...
function resolveAdaptiveReadMaxBytes(options) {
  ...
  return clamp(
    Math.floor(contextWindowTokens * CHARS_PER_TOKEN_ESTIMATE * ADAPTIVE_READ_CONTEXT_SHARE),
...
async function readOptionalUtf8File(params) {
  try {
    if (params.sandbox) {
      if (
        !(await params.sandbox.bridge.stat({
...
async function appendMemoryFlushContent(params) {
  if (!params.sandbox) {
    await (
      await root(params.root)
    ).append(params.relativePath, params.content, {
      mkdir: true,
...
function wrapToolMemoryFlushAppendOnlyWrite(tool, options) {
  ...
  return {
    ...
    execute: async (toolCallId, args, signal, onUpdate) => {
      ...
      const filePath =
        typeof record?.path === "string" && record.path.trim() ? record.path : void 0;
  ...
  return {
    ...
    execute: async (toolCallId, params, signal) => {
      ...
      return sanitizeToolResultImages(
        await normalizeReadImageResult(stripReadTruncationContentDetails(result), filePath),
        `read:${filePath}`,
...
function createAgentsListTool(opts) {
  return {
    ...
    execute: async () => {
      ...
      const agents = (all.includes(requesterAgentId) ? [requesterAgentId, ...rest] : rest).map(
        (id) => {
...
const OPENCLAW_OWNER_ONLY_CORE_TOOL_NAME_SET = new Set(["cron", "gateway", "nodes"]);
...
const CRON_SCHEDULE_KINDS = ["at", "every", "cron"];
const CRON_WAKE_MODES = ["now", "next-heartbeat"];
const CRON_PAYLOAD_KINDS = ["systemEvent", "agentTurn"];
const CRON_DELIVERY_MODES = ["none", "announce", "webhook"];
...
function recoverCronObjectFromFlatParams(params) {
  ...
  for (const key of Object.keys(params))
    if (CRON_RECOVERABLE_OBJECT_KEYS.has(key) && params[key] !== void 0) {
...
function hasCronCreateSignal(value) {
  return (
    value.schedule !== void 0 ||
    value.at !== void 0 ||
    value.atMs !== void 0 ||
    value.everyMs !== void 0 ||
    value.cron !== void 0 ||
    value.expr !== void 0 ||
    value.payload !== void 0 ||
...
function cronListResultHasJob(result, jobId) {
  return (
    ...
    result.jobs.some((job) => isRecord$2(job) && job.id === jobId)
  );
}
function readCronListNextOffset(result, currentOffset) {
  if (!isRecord$2(result) || result.hasMore !== true || typeof result.nextOffset !== "number")
    return;
...
async function buildReminderContextLines(params) {
  ...
  try {
    ...
    const recent = (Array.isArray(res?.messages) ? res.messages : [])
...
async function handleChatHistory(params) {
  ...
  const localMessages =
    sessionId && storePath
      ? await rt.readSessionMessagesAsync(sessionId, storePath, entry?.sessionFile, {
          mode: "recent",
          maxMessages: max,
...
function assertGatewayConfigMutationAllowed(params) {
  ...
  const nextConfig =
    params.action === "config.apply"
      ? parsed
      : applyMergePatch(params.currentConfig, parsed, { mergeObjectArraysById: true });
  ...
  const newlyEnabled = collectEnabledInsecureOrDangerousFlags(nextConfig).filter(
    (f) => !currentFlags.has(f),
  );
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      if (action === "config.apply") {
        ...
        return jsonResult({
          ok: true,
          result: stripConfigWriteResultPayload(
      ...
      if (action === "config.patch") {
        ...
        return jsonResult({
          ok: true,
          result: stripConfigWriteResultPayload(
            await callGatewayTool("config.patch", gatewayOpts, {
              raw,
              baseHash,
              sessionKey,
              note,
...
function parseCapabilityModelRefForProviders(params) {
  ...
  const provider = params.providers.find((candidate) => {
    return [candidate.defaultModel, ...(candidate.models ?? [])].some(
      (model) => normalizeOptionalString(model) === raw,
    );
  });
  if (provider)
    return {
...
const SUPPORTED_OUTPUT_FORMATS$1 = ["png", "jpeg", "webp"];
const SUPPORTED_BACKGROUNDS = ["transparent", "opaque", "auto"];
...
const ImageGenerateToolSchema = Type.Object({
  ...
  image: Type.Optional(
    Type.String({ description: "Optional reference image path or URL for edit mode." }),
  ),
  images: Type.Optional(
    Type.Array(Type.String(), {
      description: `Optional reference images for edit mode (up to ${MAX_INPUT_IMAGES$2}).`,
    }),
  ),
  model: Type.Optional(
    Type.String({
  ...
  outputFormat: optionalStringEnum(SUPPORTED_OUTPUT_FORMATS$1, {
...
function normalizeOpenAIOptions(args) {
  ...
  if (outputCompression !== void 0 && (outputCompression < 0 || outputCompression > 100))
...
function validateImageGenerationCapabilities(params) {
  ...
  const maxCount =
    (isEdit ? provider.capabilities.edit : provider.capabilities.generate).maxCount ?? MAX_COUNT;
              ...
              text: providers
                .flatMap((provider) => {
                  ...
                  if ((provider.capabilities.output?.backgrounds?.length ?? 0) > 0)
                    caps.push(
                      `backgrounds ${provider.capabilities.output?.backgrounds?.join("/")}`,
                    );
                  const modelLine =
...
function resolveImageModelConfigForTool(params) {
  ...
  if (hasToolModelConfig$1(explicit))
...
function matchesImageTimeoutEntry(params) {
  ...
  return (
    (configuredModel.startsWith(providerPrefix)
...
function createImageTool(options) {
  ...
  const explicitImageModelConfig = hasToolModelConfig$1(explicit)
...
function buildPollSchema() {
  ...
  for (const name of SHARED_POLL_CREATION_PARAM_NAMES)
    switch (POLL_CREATION_PARAM_DEFS[name].kind) {
      case "string":
...
function applyMessageExtraParams(params) {
  const extraValue = params.extra;
  if (!extraValue || typeof extraValue !== "object" || Array.isArray(extraValue)) return;
  for (const [key, value] of Object.entries(extraValue)) if (!(key in params)) params[key] = value;
}
...
function listAllMessageToolActions(params) {
  ...
  return Array.from(new Set(["send", "broadcast", ...pluginActions]));
}
...
function buildMessageToolSchema(params) {
  ...
  const extraProperties = resolveChannelMessageToolSchemaProperties(
    buildMessageActionDiscoveryInput(
      params,
      normalizeMessageChannel(params.currentChannelProvider) ?? void 0,
    ),
  );
...
function appendMessageToolReadHint(description, actions) {
  for (const action of actions)
    if (action === "read") return `${description}${MESSAGE_TOOL_THREAD_READ_HINT}`;
  return description;
}
function createMessageTool(options) {
  ...
  const currentThreadTs =
    ...
    (options?.agentThreadId != null ? stringifyRouteThreadId(options.agentThreadId) : void 0);
...
function mediaGenerationCompletionRequiresMessageToolDelivery(params) {
  ...
  if (chatType === "group" || chatType === "channel")
    return (
      (params.config?.messages?.groupChat?.visibleReplies ??
        params.config?.messages?.visibleReplies) !== "automatic"
    );
...
async function wakeMediaGenerationTaskCompletion(params) {
  ...
  if (!delivery.delivered && delivery.error)
    log$3.warn("Media generation completion wake failed", {
...
const createMusicGenerationTaskRun = (...params) =>
  musicGenerationTaskLifecycle.createTaskRun(...params);
const recordMusicGenerationTaskProgress = (...params) =>
  musicGenerationTaskLifecycle.recordTaskProgress(...params);
const completeMusicGenerationTaskRun = (...params) =>
  musicGenerationTaskLifecycle.completeTaskRun(...params);
const failMusicGenerationTaskRun = (...params) =>
...
const MusicGenerateToolSchema = Type.Object({
  ...
  image: Type.Optional(
    Type.String({ description: "Optional single reference image path or URL." }),
  ),
  images: Type.Optional(
    Type.Array(Type.String(), {
      description: `Optional reference images (up to ${MAX_INPUT_IMAGES$1}).`,
    }),
  ),
  model: Type.Optional(
    Type.String({
...
function validateMusicGenerationCapabilities(params) {
  ...
  if (params.inputImageCount > 0) {
    ...
    const maxInputImages =
      ("maxInputImages" in caps ? caps.maxInputImages : void 0) ?? MAX_INPUT_IMAGES$1;
    if (params.inputImageCount > maxInputImages)
      throw new ToolInputError(
...
async function executeCameraSnap({ params, gatewayOpts, modelHasVision, imageSanitization }) {
  ...
  const delayMs =
    typeof params.delayMs === "number" && Number.isFinite(params.delayMs) ? params.delayMs : void 0;
  const deviceId =
    typeof params.deviceId === "string" && params.deviceId.trim() ? params.deviceId.trim() : void 0;
  ...
  return await sanitizeToolResultImages(
    {
      ...
      details: {
        snaps: details,
        media: {
          mediaUrls: details.map((entry) => entry.path).filter((path) => typeof path === "string"),
        },
      },
    },
    "nodes:camera_snap",
...
async function executeNodeCommandAction(params) {
  switch (params.action) {
    ...
    case "notifications_action": {
      const node = readStringParam$1(params.input, "node", { required: true });
      const notificationKey = readStringParam$1(params.input, "notificationKey", {
        required: true,
      });
    ...
    case "invoke": {
      ...
      return jsonResult(
        (await callGatewayTool("node.invoke", params.gatewayOpts, {
          nodeId,
...
const NOTIFICATIONS_ACTIONS = ["open", "dismiss", "reply"];
...
async function resolveNodePairApproveScopes(gatewayOpts, requestId) {
  ...
  const match = (Array.isArray(pairing?.pending) ? pairing.pending : []).find(
    ...
    execute: async (_toolCallId, args) => {
      ...
      try {
        switch (action) {
          ...
          case "describe":
            return jsonResult(
              await callGatewayTool("node.describe", gatewayOpts, {
          ...
          case "approve": {
            ...
            return jsonResult(
              await callGatewayTool("node.pair.approve", gatewayOpts, { requestId }, { scopes }),
            );
          }
          case "reject":
            return jsonResult(
...
async function geminiAnalyzePdf(params) {
  ...
  ).replace(/\/v1beta$/i, "")}/v1beta/models/${encodeURIComponent(params.modelId)}:generateContent`;
  ...
  const text = (candidates[0].content?.parts?.filter((p) => typeof p.text === "string") ?? [])
    .map((p) => p.text)
    .join("");
...
function resolvePdfModelConfigForTool(params) {
  ...
  if (preferred?.trim()) {
    for (const candidate of [...nativePdfCandidates, ...genericImageCandidates])
      if (candidate !== preferred) addFallback(candidate);
...
const PdfToolSchema = Type.Object({
  ...
  pdfs: Type.Optional(
    Type.Array(Type.String(), { description: "Multiple PDF paths or URLs (up to 10)." }),
  ),
  pages: Type.Optional(
    Type.String({
...
function hasExplicitPdfToolModelConfig(config) {
  return (
    hasToolModelConfig$1(coercePdfModelConfig(config)) ||
    hasToolModelConfig$1(coerceImageModelConfig(config))
  );
}
  ...
  const result = await runWithImageModelFallback({
    ...
    run: async (provider, modelId) => {
      ...
      if (extractions.some((e) => e.images.length > 0) && !model.input?.includes("image")) {
        if (!extractions.some((e) => e.text.trim().length > 0))
          throw new Error(
        ...
        return {
          text: coercePdfAssistantText({
            message: await complete(
              model,
              buildPdfExtractionContext(params.prompt, textOnlyExtractions, model),
              {
                apiKey,
                maxTokens: resolvePdfToolMaxTokens(model.maxTokens),
              },
      ...
      return {
        text: coercePdfAssistantText({
          message: await complete(
            model,
            buildPdfExtractionContext(params.prompt, extractions, model),
            {
              apiKey,
              maxTokens: resolvePdfToolMaxTokens(model.maxTokens),
            },
...
const commandsStatusRuntimeLoader = createLazyImportLoader(
...
function resolveActiveStatusModelIdentity(params) {
  ...
  if (
    !new Set(
      Array.from(params.liveSessionKeys, (value) => value?.trim()).filter((value) =>
        Boolean(value),
      ),
    ).has(resolvedKey)
  )
    ...
    execute: async (_toolCallId, args) => {
      ...
      const normalizeVisibilityTargetSessionKey = (sessionKey, sessionAgentId) => {
        ...
        if (trimmed.startsWith("agent:")) {
          if (parseAgentSessionKey(trimmed)?.rest === mainKey)
      ...
      let agentId = requestedKeyRaw.startsWith("agent:")
      ...
      if (!resolved && requestedKeyParam === void 0)
          ...
          const persistedEntry = nextEntry.sessionId.trim()
            ...
            : (() => {
                ...
                return mergeSessionEntry(
                  existingEntry?.sessionId?.trim() ? existingEntry : void 0,
                  persistedEntryPatch,
                );
              })();
      ...
      const statusText = await buildStatusText({
        ...
        resolveDefaultThinkingLevel: async () => {
          ...
          const runtimeCatalog =
            ...
            configuredSelectedEntry.reasoning === void 0
...
function createSessionsListTool(opts) {
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      const allowedKindsList = (
        readStringArrayParam(params, "kinds")
      ...
      for (const entry of sessions) {
        ...
        if (!key) continue;
        if (
          !visibilityGuard.check({
            key,
            agentId: typeof entry.agentId === "string" ? entry.agentId : void 0,
            ownerSessionKey:
              typeof entry.ownerSessionKey === "string" ? entry.ownerSessionKey : void 0,
            spawnedBy: typeof entry.spawnedBy === "string" ? entry.spawnedBy : void 0,
            parentSessionKey:
              typeof entry.parentSessionKey === "string" ? entry.parentSessionKey : void 0,
          }).allowed
        )
          continue;
        ...
        const entryOrigin =
          entry.origin && typeof entry.origin === "object" ? entry.origin : void 0;
        const originChannel =
          typeof entryOrigin?.provider === "string" ? entryOrigin.provider : void 0;
        ...
        if (sessionId)
          try {
            ...
            transcriptPath = resolveSessionFilePath(
              sessionId,
              sessionFile ? { sessionFile } : void 0,
              filePathOpts,
            );
          } catch {
        ...
        const row = {
          ...
          origin:
            originChannel ||
            (typeof entryOrigin?.accountId === "string" ? entryOrigin.accountId : void 0)
              ? {
          ...
          estimatedCostUsd:
            typeof entry.estimatedCostUsd === "number" ? entry.estimatedCostUsd : void 0,
...
function resolveAnnounceTargetFromKey(sessionKey) {
  ...
  const normalizedChannel =
    normalizeChannelId$1(parsed.channel) ?? normalizeChannelId(parsed.channel);
  ...
  return {
    ...
    to:
      ...
      (normalizedChannel ? genericTarget : parsed.id),
    threadId: parsed.threadId,
  };
}
...
function buildAgentToAgentMessageContext(params) {
  return ["Agent-to-agent message context:", ...buildAgentSessionLines(params)]
    .filter(Boolean)
    .join("\n");
}
...
async function callGatewayLazy(opts) {
  const { callGateway } = await import("./call-DryNwhyi.js");
...
async function resolveAnnounceTarget(params) {
  ...
  if (fallback) {
    ...
    if (
      !(normalized ? getChannelPlugin(normalized) : null)?.meta
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-BEKsykC9.js"));
...
function createSessionsSpawnTool(opts) {
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      const context =
        params.context === "fork" || params.context === "isolated" ? params.context : void 0;
          ...
          await spawnSubagentDirect(
            {
              ...
              attachMountPath:
                params.attachAs && typeof params.attachAs === "object"
                  ? readStringParam$1(params.attachAs, "mountPath")
                  : void 0,
            },
            {
              agentSessionKey: opts?.agentSessionKey,
...
function sanitizeTranscriptForToolContent(text) {
  return text
    .replace(/^([^\S\r\n]*)MEDIA:/gim, "$1⁠MEDIA:")
    .replace(/\[\[/g, "[⁠[")
    .replace(/^([ \t]*)(`{3,})/gm, (_match, indent, fence) => {
...
const UpdatePlanToolSchema = Type.Object({
  explanation: Type.Optional(
    Type.String({ description: "Optional short note explaining what changed in the plan." }),
  ),
  plan: Type.Array(
    Type.Object(
      {
...
function readPlanSteps(params) {
  ...
  if (steps.filter((entry) => entry.status === "in_progress").length > 1)
...
const createVideoGenerationTaskRun = (...params) =>
  videoGenerationTaskLifecycle.createTaskRun(...params);
const recordVideoGenerationTaskProgress = (...params) =>
  videoGenerationTaskLifecycle.recordTaskProgress(...params);
const completeVideoGenerationTaskRun = (...params) =>
  videoGenerationTaskLifecycle.completeTaskRun(...params);
const failVideoGenerationTaskRun = (...params) =>
...
const VideoGenerateToolSchema = Type.Object({
  ...
  imageRoles: Type.Optional(
    Type.Array(Type.String(), {
      description:
        'Optional semantic roles for the combined reference image list, parallel by index. The list is `image` (if provided) followed by each entry in `images`, in order, after de-duplication. Canonical values: "first_frame", "last_frame", "reference_image". Providers may accept additional role strings. Must not have more entries than the combined image list; use an empty string to leave a position unset.',
    }),
  ),
  video: Type.Optional(
    Type.String({ description: "Optional single reference video path or URL." }),
  ),
  ...
  videoRoles: Type.Optional(
    Type.Array(Type.String(), {
      description:
        'Optional semantic roles for the combined reference video list, parallel by index. The list is `video` (if provided) followed by each entry in `videos`, in order, after de-duplication. Canonical value: "reference_video". Providers may accept additional role strings. Must not have more entries than the combined video list; use an empty string to leave a position unset.',
    }),
  ),
  ...
  audioRoles: Type.Optional(
    Type.Array(Type.String(), {
      description:
        'Optional semantic roles for the combined reference audio list, parallel by index. The list is `audioRef` (if provided) followed by each entry in `audioRefs`, in order, after de-duplication. Canonical value: "reference_audio". Providers may accept additional role strings. Must not have more entries than the combined audio list; use an empty string to leave a position unset.',
    }),
  ),
  model: Type.Optional(
...
function validateVideoGenerationCapabilities(params) {
  ...
  if (!caps) return;
  if (mode === "imageToVideo" && "enabled" in caps && !caps.enabled && params.inputVideoCount === 0)
    throw new ToolInputError(`${provider.id} does not support image-to-video reference inputs.`);
  if (mode === "videoToVideo" && "enabled" in caps && !caps.enabled && params.inputImageCount === 0)
    throw new ToolInputError(`${provider.id} does not support video-to-video reference inputs.`);
  if (params.inputImageCount > 0) {
...
function isWebContentExtractorPlugin(value) {
  return (
    ...
    (value.autoDetectOrder === void 0 || typeof value.autoDetectOrder === "number") &&
...
const webContentExtractorLoader = createConfigScopedPromiseLoader((config) =>
  resolvePluginWebContentExtractors(config ? { config } : void 0),
);
...
function resolveWebToolRuntimeContext(params) {
  const runtimeMetadata =
    (params.lateBindRuntimeConfig === true ? getActiveRuntimeWebToolsMetadata() : null)?.[
      params.kind
    ] ?? params.capturedRuntimeMetadata;
  const config =
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-9KoZyhZx.js"));
const webGuardedFetchLoader = createLazyImportLoader(
  () => import("./web-guarded-fetch-gcgHiI0k.js"),
);
...
function resolveFetchMaxResponseBytes(fetch) {
  ...
  return Math.min(
    ...
    Math.max(FETCH_MAX_RESPONSE_BYTES_MIN, Math.floor(raw)),
  );
}
...
function formatWebFetchErrorDetail(params) {
  ...
  let text = detail;
  if (
    normalizeOptionalLowercaseString(contentType)?.includes("text/html") ||
...
function wrapWebFetchContent(value, maxChars) {
  ...
  if (wrapperOverhead > maxChars) {
    const truncatedWrapper = truncateText$1(
      includeWarning
...
function normalizeProviderWebFetchPayload(params) {
  ...
  const status =
    typeof payload.status === "number" && Number.isFinite(payload.status)
      ...
      : 200;
  const contentType =
    typeof payload.contentType === "string" ? normalizeContentType(payload.contentType) : void 0;
...
//#endregion
export {
  isParentOwnedBackgroundAcpSession as S,
  isStrictAgenticExecutionContractActive as _,
  resolveToolLoopDetectionConfig as a,
  isEmbeddedMode as b,
  createOpenClawReadTool as c,
  createSandboxedWriteTool as d,
  wrapToolMemoryFlushAppendOnlyWrite as f,
  resolveOpenClawPluginToolsForOptions as g,
  sniffMimeFromBase64 as h,
  listSupportedMusicGenerationModes as i,
  createSandboxedEditTool as l,
  wrapToolWorkspaceRootGuardWithOptions as m,
  generateMusic as n,
  createHostWorkspaceEditTool as o,
  wrapToolWorkspaceRootGuard as p,
  listRuntimeMusicGenerationProviders as r,
  createHostWorkspaceWriteTool as s,
  createOpenClawTools as t,
  createSandboxedReadTool as u,
  isStrictAgenticSupportedProviderModel as v,
  setEmbeddedMode as x,
  stripProviderPrefix as y,
};
