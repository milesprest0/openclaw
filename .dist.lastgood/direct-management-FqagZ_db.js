import { n as inspectMatrixDirectRoomEvidence } from "./direct-room-DNGwJuvi.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CKWHZK1l.js";
import "./string-coerce-runtime-Xx8DhtgQ.js";
import {
  n as MATRIX_REACTION_EVENT_TYPE,
  t as MATRIX_ANNOTATION_RELATION_TYPE,
...
async function inspectMatrixDirectRooms(params) {
  ...
  const mappedRoomIds = normalizeMappedRoomIds(
    await readMatrixDirectAccountData(params.client),
    remoteUserId,
  );
...
async function repairMatrixDirectRooms(params) {
  ...
  const activeRoomId =
    ...
    (await params.client.createDirectRoom(remoteUserId, { encrypted: params.encrypted === true }));
...
export {
  EventType as a,
  MsgType as c,
  repairMatrixDirectRooms as i,
  RelationType as l,
  persistMatrixDirectRoomMapping as n,
  MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY as o,
  promoteMatrixDirectRoomCandidate as r,
  MSC4357_LIVE_KEY as s,
  inspectMatrixDirectRooms as t,
};
