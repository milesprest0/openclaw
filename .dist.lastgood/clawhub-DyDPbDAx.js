...
import { n as createTempDownloadTarget } from "./temp-download-CgMpGD8s.js";
...
function normalizeCalVerCorrectionForPluginApi(pluginApiVersion) {
  return (
    OPENCLAW_CALVER_STABLE_CORRECTION_PATTERN.exec(pluginApiVersion.trim())?.[1] ?? pluginApiVersion
  );
}
...
//#endregion
export {
  fetchClawHubPackageDetail as a,
  normalizeClawHubSha256Hex as c,
  resolveLatestVersionFromPackage as d,
  satisfiesGatewayMinimum as f,
  searchClawHubSkills as h,
  fetchClawHubPackageArtifact as i,
  normalizeClawHubSha256Integrity as l,
  searchClawHubPackages as m,
  downloadClawHubPackageArchive as n,
  fetchClawHubPackageVersion as o,
  satisfiesPluginApiRange as p,
  downloadClawHubSkillArchive as r,
  fetchClawHubSkillDetail as s,
  ClawHubRequestError as t,
  resolveClawHubBaseUrl as u,
};
