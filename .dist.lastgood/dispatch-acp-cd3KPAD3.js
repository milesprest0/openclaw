...
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-BRNo7fsu.js";
import {
  r as resolveEffectiveBlockStreamingConfig,
  t as clampPositiveInteger,
} from "./block-streaming-DC6SDJSU.js";
import { a as isDiagnosticsEnabled } from "./diagnostic-events-9isI4hMq.js";
import "./agent-scope-9AmhTwki.js";
import { f as markDiagnosticSessionProgress } from "./diagnostic-TRyCbvnu.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-GtrZOD7p.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-CTaVO-zG.js";
...
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BO8-Oi2a.js";
import {
...
import { r as prefixSystemMessage } from "./system-message-OiD4avN2.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-qyfb5lzi.js";
import {
  ...
  const mediaAttachments = runtime
    ...
    .map((attachment) =>
      normalizeOptionalString(attachment.path)
        ? Object.assign({}, attachment, { url: void 0 })
        : attachment,
    );
...
const dispatchAcpTtsRuntimeLoader$1 = createLazyImportLoader(
  () => import("./dispatch-acp-tts.runtime.js"),
);
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-ChHcCIiB.js"));
const messageActionRuntimeLoader = createLazyImportLoader(
  () => import("./message-action-runner-DOJnAxB7.js"),
);
...
async function tryDispatchAcpReply(params) {
  ...
  try {
    ...
    try {
      ...
      logVerbose(
        `dispatch-acp: transcript persistence failed for ${canonicalSessionKey}: ${formatErrorMessage(error)}`,
      );
    }
    queuedFinal =
