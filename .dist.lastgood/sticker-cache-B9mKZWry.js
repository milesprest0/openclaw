...
import { r as resolveAutoImageModel } from "./runner-BV9etZbE.js";
...
function searchStickers(query, limit = 10) {
  ...
  for (const sticker of Object.values(cache.stickers)) {
    ...
    for (const qWord of queryWords)
      if (descWords.some((dWord) => dWord.includes(qWord))) score += 5;
...
//#endregion
export {
  getCachedSticker as a,
  getCacheStats as i,
  cacheSticker as n,
  searchStickers as o,
  getAllCachedStickers as r,
  describeStickerImage as t,
};
