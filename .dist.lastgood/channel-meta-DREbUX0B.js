...
function buildManifestChannelMeta(params) {
  const hasArrayField = (value) =>
    params.arrayFieldMode === "defined" ? value !== void 0 : Boolean(value?.length);
...
//#endregion
export {
  isChannelVisibleInConfiguredLists as n,
  isChannelVisibleInSetup as r,
  buildManifestChannelMeta as t,
};
