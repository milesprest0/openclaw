...
import { t as createAccountActionGate } from "./account-action-gate-DhhyQbdu.js";
import {
...
import {
  r as resolveDefaultTelegramAccountSelection,
  t as listTelegramAccountIds$1,
} from "./account-selection-QXQj2OM7.js";
import { n as formatSetExplicitDefaultInstruction } from "./default-account-warnings-C3ZhVtNz.js";
...
function resolveDefaultTelegramAccountId(cfg) {
  ...
  if (selection.shouldWarnMissingDefault && !emittedMissingDefaultWarn) {
    ...
    getLog().warn(
      `channels.telegram: accounts.default is missing; falling back to "${selection.accountId}". ${formatSetExplicitDefaultInstruction("telegram")} to avoid routing surprises in multi-account setups.`,
    );
  }
...
//#endregion
export {
  resolveDefaultTelegramAccountId as a,
  resolveTelegramPollActionGateState as c,
  resetMissingDefaultWarnFlag as i,
  listEnabledTelegramAccounts as n,
  resolveTelegramAccount as o,
  listTelegramAccountIds as r,
  resolveTelegramMediaRuntimeOptions as s,
  createTelegramActionGate as t,
};
