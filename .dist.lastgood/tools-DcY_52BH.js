...
import { t as ensureStandaloneRuntimePluginRegistryLoaded } from "./standalone-runtime-registry-loader-B6cWNQLl.js";
import { t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
import { t as findUndeclaredPluginToolNames } from "./tool-contracts-Bt9vhWFl.js";
...
function manifestConfigSignalPasses(params) {
  ...
  if (modeSignal) {
    const mode =
      readStringAtPath(effectiveConfig, modeSignal.path?.trim() || "mode") ?? modeSignal.default;
...
function resolvePluginTools(params) {
  ...
  if (currentRuntimeConfigForDescriptorCache === void 0 && params.context.getRuntimeConfig)
    try {
...
//#endregion
export {
  resolvePluginTools as a,
  hasNonEmptyManifestEnvCandidate as c,
  manifestProviderBaseUrlGuardPasses as d,
  getPluginToolMeta as i,
  manifestConfigSignalPasses as l,
  copyPluginToolMeta as n,
  setPluginToolMeta as o,
  ensureStandalonePluginToolRegistryLoaded as r,
  resetPluginToolDescriptorCache as s,
  buildPluginToolMetadataKey as t,
  manifestPluginSetupProviderEnvVars as u,
};
