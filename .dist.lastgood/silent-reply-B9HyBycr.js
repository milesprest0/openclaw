...
import { t as copyReplyPayloadMetadata } from "./reply-payload-D38mxo21.js";
import {
  r as resolveImplicitCurrentMessageReplyAllowance,
...
import "./reply-payloads-dedupe-BKv1pe4T.js";
...
function resolveSilentReplyRewriteText(params) {
  return (
    SILENT_REPLY_REWRITE_TEXTS[
      hashSeed(params.seed?.trim() || "silent-reply") % SILENT_REPLY_REWRITE_TEXTS.length
    ] ?? SILENT_REPLY_REWRITE_TEXTS[0]
  );
}
//#endregion
...
//#endregion
export {
  applyReplyThreading as a,
  shouldSuppressReasoningPayload as c,
  applyReplyTagsToPayload as i,
  resolveSilentReplySettings as n,
  formatBtwTextForExternalDelivery as o,
  resolveSilentReplyRewriteText as r,
  isRenderablePayload as s,
  resolveSilentReplyPolicy as t,
};
