...
function resolveAvatarMime(filePath) {
  return (
    AVATAR_MIME_BY_EXT[normalizeLowercaseStringOrEmpty(path.extname(filePath))] ??
...
//#endregion
export {
  isAvatarImageDataUrl as a,
  isWindowsAbsolutePath as c,
  resolveAvatarMime as d,
  isAvatarHttpUrl as i,
  isWorkspaceRelativeAvatarPath as l,
  hasAvatarUriScheme as n,
  isPathWithinRoot as o,
  isAvatarDataUrl as r,
  isSupportedLocalAvatarExtension as s,
  AVATAR_MAX_BYTES as t,
  looksLikeAvatarPath as u,
};
