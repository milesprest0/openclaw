...
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-UCNBRHfo.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-zSv0Iydy.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-CWiNK0Xv.js";
import { At as validateSecretsResolveResult } from "./protocol-CUn5aLrV.js";
import { a as resolveSecretRefValue } from "./resolve-BZt0Bv7Z.js";
import { r as createResolverContext } from "./runtime-shared-leW4XjHk.js";
import {
  n as collectConfigAssignments,
  t as resolveRuntimeWebTools,
} from "./runtime-web-tools-C9sbohC3.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-5JX0SNC9.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-BdEutqX5.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-BECxoPqR.js";
  ...
  try {
    ...
    try {
      ...
      const fallbackMessage =
        Object.values(fallback.targetStatesByPath).some((state) => state === "resolved_local") &&
        !fallback.hadUnresolvedTargets
