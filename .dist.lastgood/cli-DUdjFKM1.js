...
import { t as COGNITIVE_SERVICES_RESOURCE } from "./shared-BOb-VlmK.js";
import {
...
function getLoggedInAccount() {
  try {
    return JSON.parse(execAz(["account", "show", "--output", "json"]));
  } catch {
    return null;
  }
}
function listSubscriptions() {
  try {
    return JSON.parse(execAz(["account", "list", "--output", "json", "--all"])).filter(
...
//#endregion
export {
  getAccessTokenResultAsync as a,
  listSubscriptions as c,
  getAccessTokenResult as i,
  azLoginDeviceCodeWithOptions as n,
  getLoggedInAccount as o,
  execAz as r,
  isAzCliInstalled as s,
  azLoginDeviceCode as t,
};
