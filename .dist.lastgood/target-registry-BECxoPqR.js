import {
  n as loadChannelSecretContractApiForRecord,
  t as loadChannelSecretContractApi,
} from "./channel-contract-api-Deoqesoz.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DFTSvtud.js";
import { n as getPath } from "./path-utils-zSv0Iydy.js";
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-C2hpt3LY.js";
import { i as parseDotPath } from "./shared-Dp_cRzjX.js";
...
function toResolvedPlanTarget(entry, pathSegments, captures) {
  const providerId =
    entry.providerIdPathSegmentIndex !== void 0
      ? pathSegments[entry.providerIdPathSegmentIndex]
      : void 0;
  const accountId =
    entry.accountIdPathSegmentIndex !== void 0
...
function resolvePlanTargetAgainstRegistry(candidate) {
  ...
  return resolvePlanTargetAgainstEntries(
    candidate,
    getCompiledSecretTargetRegistryState().targetsByType.get(candidate.type),
  );
}
...
function discoverConfigSecretTargetsByIds(config, targetIds) {
  ...
  return discoverSecretTargetsFromEntries(
    config,
...
//#endregion
export {
  listAuthProfileSecretTargetEntries as a,
  resolvePlanTargetAgainstRegistry as c,
  isKnownSecretTargetId as i,
  discoverConfigSecretTargets as n,
  listSecretTargetRegistryEntries as o,
  discoverConfigSecretTargetsByIds as r,
  resolveConfigSecretTargetByPath as s,
  discoverAuthProfileSecretTargets as t,
};
