import { r as jidToE164 } from "./text-runtime-BMQLJDUy.js";
...
function matchesQuotedConversationTarget(targetJid, candidate) {
  ...
  return (
    ...
    areComparableE164sEqual(jidToE164(targetJid) ?? void 0, candidate.participantE164)
  );
}
...
//#endregion
export {
  lookupInboundMessageMetaForTarget as i,
  cacheInboundMessageMeta as n,
  lookupInboundMessageMeta as r,
  buildQuotedMessageOptions as t,
};
