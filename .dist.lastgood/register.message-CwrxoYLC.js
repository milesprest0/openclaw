...
import {
  n as CHANNEL_TARGET_DESCRIPTION,
  t as CHANNEL_TARGETS_DESCRIPTION,
...
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-DzzZF3B1.js";
...
import { n as runMessageAction } from "./message-action-runner-C44vBHWX.js";
import {
...
import { n as ensurePluginRegistryLoaded } from "./runtime-registry-loader-x-3vjvy0.js";
import {
...
import "./plugin-registry-Di3ulqKt.js";
...
async function messageCommand(opts, deps, runtime) {
  ...
  const { formatMessageCliText } = await import("./message-format-B61VsDxv.js");
...
function isGatewayOwnedMessageAction(action, scopedChannel) {
  ...
  return (
    getChannelPlugin(scopedChannel)?.actions?.resolveExecutionMode?.({ action: messageAction }) ===
    "gateway"
  );
}
