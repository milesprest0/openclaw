import {
  i as supportsNativeStreamingUsageCompat,
  t as applyProviderNativeStreamingUsageCompat,
} from "./provider-catalog-shared-DUixNfPI.js";
...
//#endregion
export {
  isQwenCodingPlanBaseUrl as A,
  buildModelStudioModelDefinition as C,
  isNativeModelStudioBaseUrl as D,
  buildQwenModelDefinition as E,
  isNativeQwenBaseUrl as O,
  buildModelStudioDefaultModelDefinition as S,
  buildQwenModelCatalogForBaseUrl as T,
  QWEN_MODEL_CATALOG as _,
  MODELSTUDIO_DEFAULT_MODEL_REF as a,
  applyModelStudioNativeStreamingUsageCompat as b,
  MODELSTUDIO_STANDARD_CN_BASE_URL as c,
  QWEN_BASE_URL as d,
  QWEN_CN_BASE_URL as f,
  QWEN_GLOBAL_BASE_URL as g,
  QWEN_DEFAULT_MODEL_REF as h,
  MODELSTUDIO_DEFAULT_MODEL_ID as i,
  isQwen36PlusSupportedBaseUrl as k,
  MODELSTUDIO_STANDARD_GLOBAL_BASE_URL as l,
  QWEN_DEFAULT_MODEL_ID as m,
  MODELSTUDIO_CN_BASE_URL as n,
  MODELSTUDIO_GLOBAL_BASE_URL as o,
  QWEN_DEFAULT_COST as p,
  MODELSTUDIO_DEFAULT_COST as r,
  MODELSTUDIO_MODEL_CATALOG as s,
  MODELSTUDIO_BASE_URL as t,
  QWEN_36_PLUS_MODEL_ID as u,
  QWEN_STANDARD_CN_BASE_URL as v,
  buildQwenDefaultModelDefinition as w,
  applyQwenNativeStreamingUsageCompat as x,
  QWEN_STANDARD_GLOBAL_BASE_URL as y,
};
