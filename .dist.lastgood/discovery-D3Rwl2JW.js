...
async function discoverMantleModels(params) {
  ...
  if (cached && now() - cached.fetchedAt < DEFAULT_REFRESH_INTERVAL_SECONDS * 1e3)
...
//#endregion
export {
  mergeImplicitMantleProvider as a,
  resolveImplicitMantleProvider as c,
  getCachedIamToken as i,
  resolveMantleBearerToken as l,
  discoverMantleModels as n,
  resetIamTokenCacheForTest as o,
  generateBearerTokenFromIam as r,
  resetMantleDiscoveryCacheForTest as s,
  MANTLE_IAM_TOKEN_MARKER as t,
  resolveMantleRuntimeBearerToken as u,
};
