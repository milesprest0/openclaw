...
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./provider-policy-D9HYNve_.js";
import { a as postJsonRequest } from "./shared-DqfWqGL5.js";
import "./runtime-api-CfBtFqyG.js";
...
async function generateGeminiInlineDataText(params) {
      ...
      contents: [
        {
          role: "user",
          parts: [
            { text: params.prompt?.trim() || params.defaultPrompt },
            {
              inline_data: {
  ...
  try {
    ...
    const text = ((await res.json()).candidates?.[0]?.content?.parts ?? [])
...
//#endregion
export {
  transcribeGeminiAudio as a,
  googleMediaUnderstandingProvider as i,
  DEFAULT_GOOGLE_VIDEO_BASE_URL as n,
  describeGeminiVideo as r,
  DEFAULT_GOOGLE_AUDIO_BASE_URL as t,
};
