...
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-Bc1Chqe7.js";
...
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-CM7tdiQ8.js";
...
async function installPluginFromClawHubSpecWithProgress(params) {
  ...
  try {
    const { installPluginFromClawHub } = await import("./clawhub-D4SIb__Y.js");
    const result = await withTimeout(
