...
import { r as resolveReactionMessageId } from "./channel-actions-Ds3BuQCc.js";
import {
...
import { at as resolveTelegramTargetChatType } from "./format-xrIurvHN.js";
import { n as notifyTelegramInboundTurnOutboundSuccess } from "./inbound-turn-delivery-Db29TCX8.js";
...
import { i as getCacheStats, o as searchStickers } from "./sticker-cache-B9mKZWry.js";
...
const TELEGRAM_FORUM_TOPIC_ICON_COLORS = [7322096, 16766590, 13338331, 9367192, 16749490, 16478047];
...
function readTelegramSendContent(params) {
  ...
  let content =
    explicitContent ??
    (presentationText?.trim() ? presentationText : void 0) ??
    (interactiveText?.trim() ? interactiveText : void 0);
...
async function handleTelegramAction(params, cfg, options) {
  ...
  if (action === "sendMessage") {
    ...
    const mediaUrl =
      readStringParam(params, "mediaUrl") ?? readStringParam(params, "media", { trim: false });
  ...
  if (action === "editForumTopic") {
    ...
    return jsonResult(
      await telegramActionRuntime.editForumTopicTelegram(chatId ?? "", messageThreadId, {
        cfg,
        token,
        accountId: accountId ?? void 0,
        name: name ?? void 0,
