...
function normalizeStreamingMode(value) {
  ...
  return (
    (normalizeOptionalString(value) == null ? "" : normalizeLowercaseStringOrEmpty(value)) || null
  );
}
...
//#endregion
export {
  resolveSlackNativeStreaming as n,
  resolveSlackStreamingMode as r,
  mapStreamingModeToSlackLegacyDraftStreamMode as t,
};
