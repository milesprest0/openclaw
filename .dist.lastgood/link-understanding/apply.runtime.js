import { t as CLI_OUTPUT_MAX_BUFFER } from "../defaults.constants-u25YkDfl.js";
...
import {
  c as normalizeMediaUnderstandingChatType,
  l as resolveMediaUnderstandingScope,
...
async function runLinkUnderstanding(params) {
  ...
  const links = extractLinksFromMessage(
    params.message ?? params.ctx.CommandBody ?? params.ctx.RawBody ?? params.ctx.Body ?? "",
