...
import { a as createProviderHttpError } from "./provider-http-errors-Gz46brs9.js";
import { r as normalizeGoogleApiBaseUrl } from "./provider-policy-D9HYNve_.js";
import "./text-runtime-lKuAtsoz.js";
import "./provider-http-C6-kkFY-.js";
import "./provider-transport-runtime-CoLpqZWG.js";
import "./thinking-api-CXh3cOOB.js";
import {
  d as isGoogleGemini3FlashModel,
  f as isGoogleGemini3ProModel,
  g as resolveGoogleGemini3ThinkingLevel,
  u as isGoogleGemini25ThinkingBudgetModel,
  v as stripInvalidGoogleThinkingBudget,
      ...
      for (const block of msg.content) {
        ...
        if (block.type === "toolCall") {
          const thoughtSignature =
            (isSameProviderAndModel ? block.thoughtSignature : void 0) ??
...
function buildGoogleHeaders(model, apiKey, optionHeaders) {
  return (
    mergeTransportHeaders(
      ...
      apiKey ? parseGeminiAuth(apiKey).headers : void 0,
      model.headers,
      optionHeaders,
    ) ?? {
      "Content-Type": "application/json",
...
//#endregion
export {
  createGoogleGenerativeAiTransportStreamFn as n,
  createGoogleVertexTransportStreamFn as r,
  buildGoogleGenerativeAiParams as t,
};
