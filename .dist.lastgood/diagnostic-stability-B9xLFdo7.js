...
function sanitizeDiagnosticEvent(event) {
  ...
  switch (event.type) {
    ...
    case "context.assembled":
      ...
      record.context =
        event.contextTokenBudget !== void 0 ? { limit: event.contextTokenBudget } : void 0;
      record.bytes = event.promptChars;
      break;
    case "context.gate.applied":
      ...
      record.context = {
        limit: event.maxAssembledTokens,
        used: event.budgetBeforeReserve,
      };
      break;
    case "context.projectContext.dieted":
      ...
      record.context = {
        used: event.afterChars,
        limit: event.beforeChars,
      };
      break;
...
//#endregion
export {
  selectDiagnosticStabilitySnapshot as a,
  resetDiagnosticStabilityRecorderForTest as i,
  getDiagnosticStabilitySnapshot as n,
  startDiagnosticStabilityRecorder as o,
  normalizeDiagnosticStabilityQuery as r,
  stopDiagnosticStabilityRecorder as s,
  MAX_DIAGNOSTIC_STABILITY_LIMIT as t,
};
