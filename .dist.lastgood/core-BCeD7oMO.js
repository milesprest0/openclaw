...
import { r as buildChatChannelMetaById } from "./chat-meta-CUH0ZInO.js";
...
} from "./threading-helpers-COC41TkY.js";
import "./config-schema--9UsXYRo.js";
import "./plugin-entry-Yc8_SbjU.js";
import "./setup-helpers-BWYI0iQf.js";
import "./secret-file-DPekPhW_.js";
import "./tailscale-status-C9_s4RAF.js";
import "./persistent-bindings.resolve-DSvuTizA.js";
...
async function ensureConfiguredAcpBindingReady(params) {
  return (
    await import("./persistent-bindings.lifecycle-B4BPHOKZ.js")
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading)
    ...
    resolveReplyToMode = createScopedAccountReplyToModeResolver(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode,
  };
...
//#endregion
export {
  defineChannelPluginEntry as a,
  getChatChannelMeta as c,
  stripTargetKindPrefix as d,
  createChatChannelPlugin as i,
  recoverCurrentThreadSessionId as l,
  buildThreadAwareOutboundSessionRoute as n,
  defineSetupPluginEntry as o,
  createChannelPluginBase as r,
  ensureConfiguredAcpBindingReady as s,
  buildChannelOutboundSessionRoute as t,
  stripChannelTargetPrefix as u,
};
