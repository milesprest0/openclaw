...
import {
  i as listPluginDoctorLegacyConfigRules,
  n as collectRelevantDoctorPluginIds,
  r as collectRelevantDoctorPluginIdsForTouchedPaths,
} from "./doctor-contract-registry-dUz0Xw7s.js";
import {
  n as LEGACY_CONFIG_MIGRATION_RULES,
...
function shouldIncludeLegacyRuleForTouchedPaths(rulePath, touchedPaths) {
  ...
  return touchedPaths.some((touchedPath) => {
    ...
    for (let index = 0; index < sharedLength; index += 1)
      if (rulePath[index] !== touchedPath[index]) return false;
    return true;
  });
}
