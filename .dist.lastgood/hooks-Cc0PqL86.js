...
import { c as requestBodyErrorToText, o as readJsonBodyWithLimit } from "./http-body-D8UGuStR.js";
import { n as normalizeMessageChannel } from "./message-channel-core-VUC-himU.js";
import "./plugins-Dn-pJrhh.js";
import {
  n as resolveFunctionModuleExport,
  t as importFileModule,
} from "./module-loader-a7OGd01J.js";
import { s as resolveConfigPathCandidate } from "./paths-Cnwfh6dH.js";
import { i as listChannelPlugins } from "./registry-D3zb3mnd.js";
...
function resolveHookMappings(hooks, opts) {
  ...
  const transformsDir = resolveOptionalContainedPath(
    path.join(configDir, "hooks", "transforms"),
    hooks?.transformsDir,
    "Hook transformsDir",
  );
...
async function loadTransform(transform) {
  ...
  const fn = resolveTransformFn(
    await importFileModule({ modulePath: transform.modulePath }),
...
function resolveTemplateExpr(expr, ctx) {
  ...
  if (expr.startsWith("query."))
    return getByPath(Object.fromEntries(ctx.url.searchParams.entries()), expr.slice(6));
...
const getHookSessionKeyPrefixError = (prefixes) =>
...
//#endregion
export {
  resolveHooksConfig as _,
  isHookAgentAllowed as a,
  normalizeHookDispatchSessionKey as c,
  readJsonBody as d,
  resolveHookChannel as f,
  resolveHookTargetAgentId as g,
  resolveHookSessionKey as h,
  getHookSessionKeyPrefixError as i,
  normalizeHookHeaders as l,
  resolveHookIdempotencyKey as m,
  getHookAgentPolicyError as n,
  isSessionKeyAllowedByPrefix as o,
  resolveHookDeliver as p,
  getHookChannelError as r,
  normalizeAgentPayload as s,
  extractHookToken as t,
  normalizeWakePayload as u,
  applyHookMappings as v,
};
