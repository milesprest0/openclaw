...
import { l as resolveApiKeyForProvider$1 } from "./model-auth-Do8Bfz1M.js";
  ...
  return new Promise((resolve, reject) => {
    ...
    const server = createServer((req, res) => {
      try {
        ...
        res.end(
          `<!doctype html><html><head><meta charset='utf-8'/></head><body><h2>${escapedSuccessTitle}</h2><p>You can close this window and return to OpenClaw.</p></body></html>`,
        );
        finish(void 0, {
          code,
          state,
...
const RUNTIME_MODEL_AUTH_EXTENSIONS = [".js", ".ts", ".mjs", ".mts", ".cjs", ".cts"];
...
//#endregion
export {
  resolveApiKeyForProvider as a,
  provider_auth_runtime_exports as i,
  getRuntimeAuthForModel as n,
  waitForLocalOAuthCallback as o,
  parseOAuthCallbackInput as r,
