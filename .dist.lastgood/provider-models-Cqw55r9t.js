  ...
  try {
    ...
    try {
      ...
      for (const staticModel of staticModels)
        if (!discoveredIds.has(staticModel.id)) models.unshift(staticModel);
...
//#endregion
export {
  KILOCODE_DEFAULT_MODEL_ID as a,
  KILOCODE_MODELS_URL as c,
  discoverKilocodeModels as d,
  KILOCODE_DEFAULT_MAX_TOKENS as i,
  KILOCODE_MODEL_CATALOG as l,
  KILOCODE_DEFAULT_CONTEXT_WINDOW as n,
  KILOCODE_DEFAULT_MODEL_NAME as o,
  KILOCODE_DEFAULT_COST as r,
  KILOCODE_DEFAULT_MODEL_REF as s,
  KILOCODE_BASE_URL as t,
  buildKilocodeModelDefinition as u,
};
