...
import { o as requestHeartbeat } from "./heartbeat-wake-2F-mloyP.js";
import { s as isDeliverableMessageChannel } from "./message-channel-GRZIhFYD.js";
import { v as resolveStateDir } from "./paths-Cnwfh6dH.js";
import { o as parseAgentSessionKey } from "./session-key-utils-B3KPN8Ee.js";
import {
  n as requireNodeSqlite,
  t as configureSqliteWalMaintenance,
} from "./sqlite-wal-uDekKp3n.js";
...
import {
  a as sanitizeTaskStatusText,
  i as formatTaskStatusTitleText,
...
const FLOW_REGISTRY_SIDECAR_SUFFIXES = ["", "-shm", "-wal"];
...
function buildFlowRecord(params) {
  ...
  return {
    ...
    ...(normalizeJsonBlob(params.stateJson) !== void 0
      ? { stateJson: normalizeJsonBlob(params.stateJson) }
      : {}),
    ...(normalizeJsonBlob(params.waitJson) !== void 0
...
function applyFlowPatch(current, patch) {
  ...
  return {
    ...
    cancelRequestedAt:
      patch.cancelRequestedAt === void 0
...
function createTaskFlowForTask(params) {
  ...
  return createFlowRecord({
    ...
    blockedTaskId:
      terminalFlowStatus === "blocked" ? normalizeOptionalString(params.task.taskId) : void 0,
...
const TASK_REGISTRY_SIDECAR_SUFFIXES = ["", "-shm", "-wal"];
...
function assertTaskOwner(params) {
  if (!params.ownerKey.trim() && params.scopeKind !== "system")
...
function loadTaskRegistryDeliveryRuntime() {
  ...
  deliveryRuntimePromise ??= import("./task-registry-delivery-runtime-Dzuaht_r.js");
...
function updateTask(taskId, patch) {
  ...
  if (isTerminalTaskStatus(next.status) && typeof next.cleanupAfter !== "number")
    next.cleanupAfter =
      (next.endedAt ?? next.lastEventAt ?? Date.now()) + DEFAULT_TASK_RETENTION_MS;
...
function resolveTaskTerminalNotifyAt(task) {
  if (typeof task.lastEventAt === "number") return task.lastEventAt;
  if (typeof task.endedAt === "number") return task.endedAt;
  return Date.now();
}
...
export {
  failFlow as A,
  setFlowWaiting as B,
  resolveTaskForLookupToken as C,
  createManagedTaskFlow as D,
  updateTaskNotifyPolicyById as E,
  listTaskFlowRecords as F,
  listTaskFlowsForOwnerKey as I,
  requestFlowCancel as L,
  finishFlow as M,
  getTaskFlowById as N,
  createTaskFlowForTask as O,
  getTaskFlowRegistryRestoreFailure as P,
  resolveTaskFlowForLookupToken as R,
  reloadTaskRegistryFromStore as S,
  setTaskRunDeliveryStatusByRunId as T,
  updateFlowRecordByIdExpectedRevision as V,
  markTaskLostById as _,
  finalizeTaskRunByRunId as a,
  maybeDeliverTaskTerminalUpdate as b,
  hasActiveTaskForChildSessionKey as c,
  listTaskRecords as d,
  listTasksForAgentId as f,
  listTasksForSessionKey as g,
  listTasksForRelatedSessionKey as h,
  ensureTaskRegistryReady as i,
  findLatestTaskFlowForOwnerKey as j,
  deleteTaskFlowRecordById as k,
  isParentFlowLinkError as l,
  listTasksForOwnerKey as m,
  createTaskRecord as n,
  findTaskByRunId as o,
  listTasksForFlowId as p,
  deleteTaskRecordById as r,
  getTaskById as s,
  cancelTaskById as t,
  linkTaskToFlowById as u,
  markTaskRunningByRunId as v,
  setTaskCleanupAfterById as w,
  recordTaskProgressByRunId as x,
  markTaskTerminalById as y,
  resumeFlow as z,
};
