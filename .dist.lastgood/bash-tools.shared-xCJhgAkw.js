...
import { v as sliceUtf16Safe } from "./utils-BGRcpLKt.js";
...
async function resolveSandboxWorkdir(params) {
  ...
  try {
    ...
    if (!(await fs$1.stat(resolved.resolved)).isDirectory())
...
function sliceLogLines(text, offset, limit) {
  ...
  if (limit !== void 0 && offset === void 0)
    start = Math.max(totalLines - Math.max(0, Math.floor(limit)), 0);
  const end =
...
export {
  ...
  sliceLogLines as d,
  truncateMiddle as f,
  clampWithDefault as i,
  resolveSandboxWorkdir as l,
  buildSandboxEnv as n,
  deriveSessionName as o,
  chunkString as r,
  pad as s,
  buildDockerExecArgs as t,
  resolveWorkdir as u,
};
