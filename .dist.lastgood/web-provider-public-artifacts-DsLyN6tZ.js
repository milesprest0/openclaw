...
import { o as normalizePluginId } from "./config-state-BF1r9Z0v.js";
...
import {
  ...
  n as loadBundledWebSearchProviderEntriesFromDir,
  r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts,
  t as loadBundledWebFetchProviderEntriesFromDir,
} from "./web-provider-public-artifacts.explicit-CjQ-BUNt.js";
import {
  i as resolveBundledWebFetchResolutionConfig,
  l as resolveManifestDeclaredWebProviderCandidates,
  t as resolveBundledWebSearchResolutionConfig,
...
function filterAllowlistedBundledPluginIds(config, pluginIds) {
  ...
  if (config?.plugins?.bundledDiscovery === "compat" || !Array.isArray(allow) || allow.length === 0)
    return [...pluginIds];
...
function resolveBundledCandidatePluginIds(params) {
  if (params.onlyPluginIds !== void 0)
    return {
...
//#endregion
export {
  resolveBundledWebSearchProvidersFromPublicArtifacts as n,
  resolveBundledWebFetchProvidersFromPublicArtifacts as t,
};
