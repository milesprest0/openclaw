...
import {
  a as resolveZalouserAccountSync,
  i as resolveDefaultZalouserAccountId,
  r as listZalouserAccountIds,
  t as checkZcaAuthenticated,
} from "./accounts-eLOtOdpG.js";
import { l as createScopedDmSecurityResolver } from "./channel-config-helpers-DVht29vx.js";
...
import {
  ...
  o as createRawChannelSendResultAdapter,
...
import {
  a as resolveZalouserReactionMessageIds,
  o as buildZalouserGroupCandidates,
  s as findZalouserGroupEntry,
  t as getZalouserRuntime,
} from "./runtime-D-OGIaXd.js";
import {
  i as resolveZalouserOutboundSessionRoute,
  n as parseZalouserDirectoryGroupId,
  r as parseZalouserOutboundTarget,
  t as normalizeZalouserTarget,
} from "./session-route-CNqJY4ys.js";
import {
  n as zalouserSetupAdapter,
  r as writeQrDataUrlToTempFile,
...
import { n as createStaticReplyToModeResolver } from "./threading-helpers-COC41TkY.js";
//#region extensions/zalouser/src/channel.adapters.ts
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(
  () => import("./channel.runtime-vzUsbOoh.js"),
);
...
const zalouserSecurityAdapter = {
  ...
  collectAuditFindings: async (params) =>
    (await loadZalouserChannelRuntime$1()).collectZalouserSecurityAuditFindings(params),
};
...
async function listZalouserDirectoryGroupMembers(params, deps) {
  ...
  const rows = (await deps.listZaloGroupMembers(account.profile, normalizedGroupId)).map((member) =>
    mapUser$1({
      id: member.userId,
...
const ZALOUSER_STATUS_FIELDS = ["accountId", "enabled", "configured", "dmPolicy", "lastError"];
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(
  () => import("./channel.runtime-vzUsbOoh.js"),
);
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(
  async () => (await import("./setup-surface-DtI0JKHL.js")).zalouserSetupWizard,
);
  ...
  base: {
    ...
    directory: {
      self: async ({ cfg, accountId }) => {
        ...
        const parsed = await getZaloUserInfo(
          resolveZalouserAccountSync({
            cfg,
            accountId,
          }).profile,
    ...
    gateway: {
      startAccount: async (ctx) => {
        ...
        const { monitorZalouserProvider } = await import("./monitor-DLmCKMWm.js");
