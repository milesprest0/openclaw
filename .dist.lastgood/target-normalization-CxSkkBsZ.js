...
import { n as getActivePluginChannelRegistryVersion } from "./runtime-ChXyIFtl.js";
import {
...
function normalizeTargetForProvider(provider, raw) {
  ...
  return normalizeOptionalString(
    (providerId ? resolveTargetNormalizer(providerId) : void 0)?.(raw) ?? fallback,
  );
}
...
//#endregion
export {
  normalizeTargetForProvider as a,
  normalizeChannelTargetInput as i,
  looksLikeTargetId as n,
  resolveNormalizedTargetInput as o,
  maybeResolvePluginMessagingTarget as r,
  buildTargetResolverSignature as t,
};
