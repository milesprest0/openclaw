...
function resolveChannelConfigWritesShared(params) {
  ...
  return (
    (resolveChannelAccountConfig(channelConfig, params.accountId)?.configWrites ??
      channelConfig.configWrites) !== false
  );
}
...
//#endregion
export {
  authorizeConfigWriteShared as _,
  createHybridChannelConfigBase as a,
  resolveConfigWriteTargetFromPathShared as b,
  createScopedChannelConfigBase as c,
  createTopLevelChannelConfigBase as d,
  formatConfigWriteDeniedMessage as f,
  resolveOptionalConfigString as g,
  resolveChannelConfigWrites as h,
  createHybridChannelConfigAdapter as i,
  createScopedDmSecurityResolver as l,
  mapAllowFromEntries as m,
  authorizeConfigWrite as n,
  createScopedAccountConfigAccessors as o,
  formatTrimmedAllowFromEntries as p,
  canBypassConfigWritePolicy as r,
  createScopedChannelConfigAdapter as s,
  adaptScopedAccountAccessor as t,
  createTopLevelChannelConfigAdapter as u,
  canBypassConfigWritePolicyShared as v,
  formatConfigWriteDeniedMessageShared as y,
};
