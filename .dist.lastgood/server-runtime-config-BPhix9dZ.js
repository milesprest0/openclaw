import { t as assertGatewayAuthConfigured } from "./auth-D_VLzYQI.js";
...
import {
  i as isLoopbackHost,
  l as isValidIPv4,
  p as resolveGatewayBindHost,
  t as defaultGatewayBindMode,
} from "./net-BQYp2xgJ.js";
import { r as mergeGatewayTailscaleConfig } from "./startup-auth-D6PPTaYB.js";
...
async function resolveGatewayRuntimeConfig(params) {
  ...
  const bindMode =
    ...
    (tailscaleModeEarly !== "off" ? "loopback" : defaultGatewayBindMode());
