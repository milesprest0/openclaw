import {
  n as comparePrereleaseIdentifiers,
  r as normalizeLegacyDotBetaVersion,
...
function compareOpenClawVersions(a, b) {
  ...
  if (parsedA.revision != null && parsedB.revision != null && parsedA.revision !== parsedB.revision)
...
//#endregion
export {
  normalizeOpenClawVersionBase as n,
  shouldWarnOnTouchedVersion as r,
  compareOpenClawVersions as t,
};
