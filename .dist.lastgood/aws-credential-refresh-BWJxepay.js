...
async function loadSharedIniFileLoader() {
  ...
  return await import("./dist-cjs-DTfjYkUS.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
}
...
//#endregion
export {
  setAwsSharedIniFileLoaderForTest as n,
  shouldRefreshAwsSharedConfigCacheForBedrock as r,
  refreshAwsSharedConfigCacheForBedrock as t,
};
