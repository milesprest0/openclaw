import { n as entraIdAuthMethod, t as apiKeyAuthMethod } from "./auth-DU8urL42.js";
import { t as prepareFoundryRuntimeAuth } from "./runtime-CaC52IT2.js";
import {
  _ as resolveFoundryModelCapabilities,
  d as isFoundryProviderApi,
  i as PROVIDER_ID,
  l as buildFoundryProviderBaseUrl,
  o as applyFoundryProfileBinding,
  p as normalizeFoundryEndpoint,
  s as applyFoundryProviderConfig,
  u as extractFoundryEndpoint,
  v as resolveFoundryTargetProfileId,
  ...
  return {
    ...
    normalizeResolvedModel: ({ modelId, model }) => {
      ...
      const capabilities = resolveFoundryModelCapabilities(
        modelId,
        model.name,
        isFoundryProviderApi(model.api) ? model.api : void 0,
        model.input,
      );
      return {
        ...model,
