import { n as withResolvedRoomAction } from "./client-zsajgNip.js";
import "./string-coerce-runtime-Xx8DhtgQ.js";
import { r as isMatrixNotFoundError } from "./errors-DQ-r4gaL.js";
import {
  a as resolveMatrixMessageBody,
  c as resolveMatrixPollRootEventId,
  i as resolveMatrixMessageAttachment,
  o as fetchMatrixPollMessageSummary,
} from "./media-text-DmHp7WUL.js";
import { n as MATRIX_REACTION_EVENT_TYPE } from "./reaction-common-Dher7fo3.js";
import {
  a as sendMessageMatrix,
  h as isPollEventType,
  n as editMessageMatrix,
...
async function readPinnedEvents(client, roomId) {
  try {
    return (await client.getRoomStateEvent(roomId, EventType.RoomPinnedEvents, "")).pinned.filter(
      (id) => id.trim().length > 0,
    );
  } catch (err) {
...
async function editMatrixMessage(roomId, messageId, content, opts = {}) {
  ...
  return {
    eventId:
      (await editMessageMatrix(roomId, messageId, trimmed, {
        cfg: opts.cfg,
        accountId: opts.accountId ?? void 0,
        client: opts.client,
        timeoutMs: opts.timeoutMs,
...
//#endregion
export {
  fetchEventSummary as a,
  resolveMatrixActionLimit as c,
  sendMatrixMessage as i,
  editMatrixMessage as n,
  readPinnedEvents as o,
  readMatrixMessages as r,
  EventType as s,
  deleteMatrixMessage as t,
};
