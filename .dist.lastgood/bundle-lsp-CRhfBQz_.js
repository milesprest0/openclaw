...
import {
  a as loadEnabledBundleConfig,
  i as inspectBundleServerRuntimeSupport,
  o as readBundleJsonObject,
} from "./bundle-mcp-DDI2KSPG.js";
import {
...
function resolveBundleLspConfigPaths(params) {
  ...
  return mergeBundlePathLists(
    fs.existsSync(path.join(params.rootDir, ".lsp.json")) ? [".lsp.json"] : [],
    declared,
  );
}
