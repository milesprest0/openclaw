import {
  ...
  c as buildZaiCatalogModels,
  u as resolveZaiBaseUrl,
} from "./model-definitions-Dcog4FFD.js";
import "./text-runtime-lKuAtsoz.js";
import { u as applyProviderConfigWithModelCatalogPreset } from "./provider-onboard-kfCYjVQt.js";
...
function applyZaiConfig(cfg, params) {
  ...
  return applyZaiPreset(
    cfg,
    params,
    modelId === "glm-5.1" ? ZAI_DEFAULT_MODEL_REF : `zai/${modelId}`,
  );
}
//#endregion
