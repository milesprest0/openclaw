import {
  o as detachPluginConversationBinding,
  p as requestPluginConversationBinding,
  s as getCurrentPluginConversationBinding,
} from "./conversation-binding-C44M7Qbh.js";
import { t as resolveConversationBindingContext } from "./conversation-binding-context-CAnv5u9a.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { s as isOperatorScope, t as ADMIN_SCOPE } from "./operator-scopes-Codapd9g.js";
import { i as resolveReadOnlyChannelCommandDefaults } from "./read-only-command-defaults-8KNIJoKx.js";
...
import {
  A as pluginCommands,
  D as isTrustedReservedCommandOwner,
  M as setPluginCommandRegistryLocked,
  d as listPluginInvocationKeys,
  f as pluginCommandSupportsChannel,
...
function resolveBindingConversationFromCommand(params) {
  if (
    !getActivePluginChannelRegistry()?.channels.find((entry) => entry.plugin.id === params.channel)
      ?.plugin?.bindings?.resolveCommandConversation
  )
    return null;
...
async function executePluginCommand(params) {
  ...
  const ctx = {
    ...
    ...(diagnosticsUploadApprovedForCommand === void 0
      ? {}
      : { diagnosticsUploadApproved: diagnosticsUploadApprovedForCommand }),
    ...(diagnosticsPreviewOnlyForCommand === void 0
      ? {}
      : { diagnosticsPreviewOnly: diagnosticsPreviewOnlyForCommand }),
    ...(diagnosticsPrivateRoutedForCommand === void 0
      ? {}
...
//#endregion
export {
  getPluginCommandSpecs as a,
  matchPluginCommand as i,
  executePluginCommand as n,
  listProviderPluginCommandSpecs as o,
  listPluginCommands as r,
  __testing as t,
};
