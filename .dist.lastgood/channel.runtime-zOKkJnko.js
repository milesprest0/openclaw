...
import {
  _ as readMattermostError,
  a as MattermostPostSchema,
  c as createMattermostPost,
  f as fetchMattermostMe,
  g as normalizeMattermostBaseUrl,
  h as fetchMattermostUserTeams,
  i as resolveMattermostReplyToMode,
  l as deleteMattermostPost,
  o as createMattermostClient,
  p as fetchMattermostUser,
  r as resolveMattermostAccount,
  t as listMattermostAccountIds,
  u as fetchMattermostChannel,
  v as sendMattermostTyping,
  y as updateMattermostPost,
...
import { i as formatInboundFromLabel$1 } from "./envelope-DWEYsyXr.js";
...
import {
  i as normalizeMattermostAllowList,
  n as isMattermostSenderAllowed,
  r as normalizeMattermostAllowEntry,
  t as authorizeMattermostCommandInvocation,
} from "./monitor-auth-BO8-iP-j.js";
...
import { u as isReasoningReplyPayload } from "./reply-payload-D_-IJF8p.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-BZPcIR_E.js";
import "./extension-shared-B_zNy4Rm.js";
import { t as getMattermostRuntime } from "./runtime-4TfH6_i4.js";
...
import { d as resolveThreadSessionKeys$1 } from "./session-key-B4qUwRzq.js";
import "./webhook-ingress-BWEossCd.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DaDbzwlG.js";
import {
  C as resolveCallbackUrl,
  S as registerSlashCommands,
  _ as renderMattermostProviderPickerView,
  a as sendMessageMattermost,
  b as cleanupSlashCommands,
  c as computeInteractionCallbackUrl,
  d as setInteractionCallbackUrl,
  f as setInteractionSecret,
  g as renderMattermostModelsPickerView,
  h as parseMattermostModelPickerContext,
  l as createMattermostInteractionHandler,
  m as buildMattermostAllowedModelRefs,
  n as deactivateSlashCommands,
  o as resolveMattermostOpaqueTarget,
  p as deliverMattermostReplyPayload,
  r as getSlashCommandState,
  s as buildButtonProps,
  t as activateSlashCommands,
  u as resolveInteractionCallbackPath,
  v as resolveMattermostModelPickerCurrentModel,
  w as resolveSlashCommandConfig,
  x as isSlashCommandsEnabled,
  y as DEFAULT_COMMAND_SPECS,
} from "./slash-state-CyKmnRih.js";
import {
...
function buildMattermostToolStatusText(params) {
  return (
    formatChannelProgressDraftLineForEntry(
      ...
      params.detailMode ? { detailMode: params.detailMode } : void 0,
    ) ?? "Running tool..."
  );
}
function createMattermostDraftStream(params) {
  ...
  const sendOrEditStreamMessage = async (text) => {
    ...
    try {
      if (streamPostId)
        await updateMattermostPost(params.client, streamPostId, { message: normalized });
      else {
        const postId = (
...
async function processMattermostReplayGuardedPost(params) {
  ...
  for (const replayKey of replayKeys)
    if ((await replayGuard.claim(replayKey)).kind === "claimed") claimedKeys.push(replayKey);
...
async function monitorMattermostProvider(opts = {}) {
  ...
  const handlePost = async (post, payload, messageIds) => {
    ...
    if (
      (await processMattermostReplayGuardedPost({
        accountId: account.accountId,
        ...
        handlePost: async () => {
          ...
          const ctxPayload = core.channel.reply.finalizeInboundContext({
            ...
            MessageSidLast:
              allMessageIds.length > 1 ? allMessageIds[allMessageIds.length - 1] : void 0,
