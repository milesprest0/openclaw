import { r as describeWebhookAccountSnapshot } from "./account-helpers-DgSuSC4_.js";
...
import { s as createScopedChannelConfigAdapter } from "./channel-config-helpers-DVht29vx.js";
...
import { r as createRestrictSendersChannelSecurity } from "./channel-policy-y8E9wmaa.js";
import {
...
import { n as createEmptyChannelDirectoryAdapter } from "./directory-runtime-B764p6cP.js";
...
import { f as resolveOutboundMediaUrls } from "./reply-payload-D_-IJF8p.js";
import {
...
import {
  n as resolveLineOutboundMedia,
  t as createLineSendReceipt,
} from "./send-receipt-CtmEC5w6.js";
import {
  n as lineSetupAdapter,
  r as hasLineCredentials,
  t as lineSetupWizard,
} from "./setup-surface-aBvDPmTd.js";
import {
...
const lineBindingsAdapter = {
  ...
  resolveInboundConversation: ({ to, conversationId }) =>
    resolveLineInboundConversation({
      to,
      conversationId,
    }),
};
...
const loadLineProbeRuntime$1 = createLazyRuntimeModule(() => import("./probe.runtime-BJx3ZAA1.js"));
...
function hasLineSpecificMediaOptions(lineData) {
  return Boolean(
    ...
    (typeof lineData.durationMs === "number" ? lineData.durationMs : void 0) ??
  ...
  sendPayload: async ({ to, payload, accountId, cfg }) => {
    ...
    const sendMessageBatch = async (messages) => {
      ...
      for (let i = 0; i < messages.length; i += 5)
        lastResult = await sendBatch(to, messages.slice(i, i + 5), {
          verbose: false,
          cfg,
          accountId: accountId ?? void 0,
        });
...
const lineMessageAdapter = defineChannelMessageAdapter({
  ...
  send: {
    text: async ({ cfg, to, text, accountId }) => {
      return toLineMessageSendResult(
...
const loadLineProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-BJx3ZAA1.js"));
...
const loadLineChannelRuntime = createLazyRuntimeModule(
  () => import("./channel.runtime-phlasBrC.js"),
);
