...
import { n as getWindowsProgramFilesRoots } from "./windows-install-roots-BcoLinij.js";
...
function addCommonUserBinDirs(dirs, home, existsSync, includeMissingDefaults) {
  const addDefault = includeMissingDefaults
    ? (candidate) => dirs.push(candidate)
    : (candidate) => addExistingDir(dirs, candidate, existsSync);
...
export {
  ...
  normalizeServicePathEntry as c,
  buildServiceEnvironment as d,
  getMinimalServicePathPartsFromEnv as f,
  resolvePreferredNodePath as i,
  SERVICE_PROXY_ENV_KEYS as l,
  isVersionManagedNodePath as n,
  resolveSystemNodePath as o,
  renderSystemNodeWarning as r,
  isNonMinimalServicePathEntry as s,
  isSystemNodePath as t,
  buildNodeServiceEnvironment as u,
};
