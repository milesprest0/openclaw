import { t as normalizeModelCatalog } from "./normalize-C7P1Ynu1.js";
...
function buildManifestModelProviderConfig(params) {
  ...
  if (rawModelCount !== void 0 && rawModelCount !== catalog.models.length)
...
//#endregion
export {
  buildPairedProviderApiKeyCatalog as a,
  supportsNativeStreamingUsageCompat as i,
  buildManifestModelProviderConfig as n,
  buildSingleProviderApiKeyCatalog as o,
  readConfiguredProviderCatalogEntries as r,
  findCatalogTemplate as s,
  applyProviderNativeStreamingUsageCompat as t,
};
