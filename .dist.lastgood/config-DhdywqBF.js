...
import {
  ...
  M as DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS,
...
import {
  i as parseBooleanValue,
  n as deriveDefaultBrowserCdpPortRange,
  r as deriveDefaultBrowserControlPort,
} from "./sdk-config-CZ5LC61g.js";
...
function resolveBrowserConfig(cfg, rootConfig) {
  ...
  const extraArgs = Array.isArray(cfg?.extraArgs)
    ? cfg.extraArgs.filter((value) => typeof value === "string" && value.trim().length > 0)
    : [];
  return {
    enabled,
    evaluateEnabled,
...
//#endregion
export {
  DEFAULT_DOWNLOAD_DIR as a,
  resolveProfile as i,
  resolveBrowserConfig as n,
  DEFAULT_TRACE_DIR as o,
  resolveManagedBrowserHeadlessMode as r,
  DEFAULT_UPLOAD_DIR as s,
  getManagedBrowserMissingDisplayError as t,
};
