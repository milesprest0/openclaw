...
import { h as resolveNonEnvSecretRefApiKeyMarker } from "./model-auth-markers-CtsHE1k1.js";
...
function readLegacyGrokFallbackAuth(cfg) {
  ...
  const apiKey = readConfiguredOrManagedApiKey(
    grok && typeof grok === "object" ? grok.apiKey : void 0,
  );
  return apiKey
    ? {
        apiKey,
...
function readPluginXaiWebSearchApiKeyResult(cfg) {
  return readConfiguredRuntimeApiKey(
    resolveProviderWebSearchPluginConfig(cfg, "xai")?.apiKey,
