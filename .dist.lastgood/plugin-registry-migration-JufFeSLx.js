...
import {
  ...
  o as writePersistedInstalledPluginIndex,
...
function preflightPluginRegistryInstallMigration(params = {}) {
  ...
  if (hasEnvFlag(env, "OPENCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION"))
    return {
      action: "disabled",
      filePath,
      force,
  ...
  if (!force && pathExists(filePath)) {
    if (readPersistedInstalledPluginIndexSync(params))
      return {
...
//#endregion
export {
  preflightPluginRegistryInstallMigration as i,
  FORCE_PLUGIN_REGISTRY_MIGRATION_ENV as n,
  migratePluginRegistryForInstall as r,
  DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV as t,
};
