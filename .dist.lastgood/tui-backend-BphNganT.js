...
import {
  n as isYes,
  r as resolveCrestodianOperation,
  t as approvalQuestion,
} from "./dialogue-BE9EboBU.js";
import {
  i as isPersistentCrestodianOperation,
  n as executeCrestodianOperation,
} from "./operations-DkxdAyKV.js";
import {
  n as formatCrestodianStartupMessage,
  r as loadCrestodianOverview,
} from "./overview-BrhxgTRB.js";
import { r as buildAgentMainSessionKey } from "./session-key-B4qUwRzq.js";
import { h as runTui } from "./tui-C48Wp4GZ.js";
...
async function runCrestodianTui(opts, runtime) {
  ...
  for (;;) {
    const backend = new CrestodianTuiBackend(
      opts,
      formatCrestodianStartupMessage(await loadOverviewForTui(opts)),
    );
