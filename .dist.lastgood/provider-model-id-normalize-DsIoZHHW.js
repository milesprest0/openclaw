...
function normalizeGooglePreviewModelId(id) {
  if (id === "gemini-3-pro" || id === "gemini-3-pro-preview") return "~google/gemini-pro-latest";
  if (id === "gemini-3-flash") return "gemini-3-flash-preview";
  if (id === "gemini-3.1-pro" || id === "gemini-3.1-pro-preview")
...
//#endregion
export {
  normalizeGooglePreviewModelId as n,
  normalizeNativeXaiModelId as r,
  normalizeAntigravityPreviewModelId as t,
};
