...
import {
  n as resolveSubagentMaxConcurrent,
  t as resolveAgentMaxConcurrent,
} from "./agent-limits-DOpAybfz.js";
import { c as resolveDefaultAgentId, n as listAgentIds } from "./agent-scope-config-CXZGyKMl.js";
import { t as sanitizeForLog } from "./ansi-BiBWu5cu.js";
import { a as parseApiErrorInfo } from "./assistant-error-format-BsjMPFd_.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CYMhno0R.js";
import { p as setCommandLaneConcurrency } from "./command-queue-BtommWHg.js";
import "./agent-scope-9AmhTwki.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-4m7JJmD2.js";
import { r as emitFailoverEvent } from "./diagnostic-events-9isI4hMq.js";
import {
  m as isLikelyContextOverflowError,
  r as classifyProviderRuntimeFailureKind,
} from "./errors-D66M8xLa.js";
import { a as formatErrorMessage, t as SocketDropException } from "./errors-DZMrVkYL.js";
import { i as externalCliDiscoveryForProviders } from "./external-cli-discovery-DDK4LC8K.js";
import {
  a as isTimeoutError,
  i as isFailoverError,
...
import { r as resolveExplicitAgentSessionKey } from "./main-session-BttihmeO.js";
import {
...
import "./model-selection-cli-DuYeikT-.js";
import {
  f as stableStringify,
  o as getApiErrorPayloadFingerprint,
} from "./sanitize-user-facing-text-Cgbm6W76.js";
import { n as resolveSessionIdMatchSelection } from "./session-id-resolution-D6q4cQjl.js";
import {
...
import { f as normalizeThinkLevel, h as normalizeVerboseLevel } from "./thinking-C9_Z62px.js";
...
function resolveSessionKeyForRequest(opts) {
  ...
  let sessionKey =
    explicitSessionKey ?? (ctx ? resolveSessionKey(scope, ctx, mainKey, storeAgentId) : void 0);
...
function resolveSession(opts) {
  ...
  const fresh = sessionEntry
    ...
    : false;
  const sessionId =
    opts.sessionId?.trim() || (fresh ? sessionEntry?.sessionId : void 0) || crypto.randomUUID();
...
const modelFallbackAuthRuntimeLoader = createLazyImportLoader(
...
async function runFallbackAttempt(params) {
  ...
  if (runResult.ok) {
    const classifiedError = resolveResultClassificationError(
...
function throwFallbackFailureSummary(params) {
  ...
  throw new FallbackSummaryError(
    ...
    params.lastError instanceof Error ? params.lastError : void 0,
    params.attribution,
  );
}
...
function resolveCooldownDecision(params) {
  ...
  if (inferredReason === "auth" || inferredReason === "auth_permanent")
    return {
      type: "skip",
  ...
  for (let i = 0; i < candidates.length; i += 1) {
    ...
    if (authRuntime && authStore) {
      ...
      const isAnyProfileAvailable = profileIds.some(
        (id) => !authRuntime.isProfileInCooldown(authStore, id, void 0, candidate.model),
      );
    ...
    const err = attemptRun.error;
    {
      ...
      if (err instanceof SocketDropException && !err.safeToRetry) throw err;
      const normalized =
...
export {
  suspendSession as a,
  resolveSessionKeyForRequest as c,
  shouldAllowCooldownProbeForReason as d,
  buildApiErrorObservationFields as f,
  resolveSessionSuspensionReason as i,
  resolveStoredSessionKeyForSessionId as l,
  runWithImageModelFallback as n,
  buildExplicitSessionIdSessionKey as o,
  buildTextObservationFields as p,
  runWithModelFallback as r,
  resolveSession as s,
  isFallbackSummaryError as t,
  LiveSessionModelSwitchError as u,
};
