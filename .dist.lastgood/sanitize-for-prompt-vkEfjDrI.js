...
function wrapPromptDataBlockWithTag(params) {
  ...
  const escaped = (maxChars > 0 && trimmed.length > maxChars ? trimmed.slice(0, maxChars) : trimmed)
    .replace(/</g, "&lt;")
    .replace(/>/g, "&gt;");
  return [
...
//#endregion
export {
  wrapPromptDataBlock as n,
  wrapUntrustedPromptDataBlock as r,
  sanitizeForPromptLiteral as t,
};
