import {
  l as listBundledChannelPluginIds,
  n as getBundledChannelPlugin,
  p as setBundledChannelRuntime,
} from "./bundled-Ca60V8y0.js";
import { r as createCapturedPluginRegistration } from "./bundled-capability-runtime-CVwneU9i.js";
import { x as setActivePluginRegistry } from "./runtime-ChXyIFtl.js";
...
//#endregion
export {
  createOutboundTestPlugin as C,
  setDefaultChannelPluginRegistryForTests as S,
  createTypedRuntimeEnv as _,
  createSetupWizardAdapter as a,
  registerSingleProviderPlugin as b,
  resolveSetupWizardAllowFromEntries as c,
  runSetupWizardFinalize as d,
  runSetupWizardPrepare as f,
  createRuntimeEnv as g,
  createNonExitingTypedRuntimeEnv as h,
  createQueuedWizardPrompter as i,
  resolveSetupWizardGroupAllowlist as l,
  createNonExitingRuntimeEnv as m,
  createPluginSetupWizardConfigure as n,
  createTestWizardPrompter as o,
  selectFirstWizardOption as p,
  createPluginSetupWizardStatus as r,
  promptSetupWizardAllowFrom as s,
  createPluginSetupWizardAdapter as t,
  runSetupWizardConfigure as u,
  registerProviderPlugin as v,
  createTestRegistry as w,
  requireRegisteredProvider as x,
  registerProviderPlugins as y,
};
