...
import { s as emitAgentPlanEvent } from "./agent-events-c6-2eZvI.js";
import {
...
import { r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-CJM25NoR.js";
import { d as runAgentCleanupStep } from "./attempt.tool-run-context-DNKKeHVU.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-OCMIKXXt.js";
import { n as sleepWithAbort } from "./backoff-CW9s2Y7t.js";
import { r as buildAgentRuntimePlan } from "./build-BPMIpRAa.js";
import { n as extractAssistantTextForPhase } from "./chat-message-content-BLockgKs.js";
import { i as enqueueCommandInLane } from "./command-queue-BtommWHg.js";
import {
  d as sessionLikelyHasOversizedToolResults,
  f as truncateOversizedToolResultsInSession,
  u as resolveLiveToolResultMaxChars,
} from "./compaction-B6HM89B8.js";
import {
  n as resolveEmbeddedCompactionTarget,
  t as buildEmbeddedCompactionRuntimeContext,
} from "./compaction-runtime-context-CjeIjGez.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bikq46qJ.js";
import {
  c as shouldRotateCompactionTranscript,
  s as rotateTranscriptFileAfterCompaction,
} from "./context-budget-CZcqCu6a.js";
import { t as resolveContextEngineCapabilities } from "./context-engine-capabilities-Bcmv_lio.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-De8KJkwC.js";
import {
  a as resolveContextWindowInfo,
  i as formatContextWindowWarningMessage,
  n as evaluateContextWindowGuard,
  r as formatContextWindowBlockMessage,
} from "./context-window-guard-Bprmj3Gv.js";
import "./runs-CztEUxOL.js";
import {
  n as DEFAULT_MODEL,
...
import { r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-BmHJMNAW.js";
import { m as freezeDiagnosticTraceContext } from "./diagnostic-events-9isI4hMq.js";
import {
  a as formatAssistantErrorText,
  b as parseImageSizeError,
  c as isBillingAssistantError,
  f as isFailoverAssistantError,
  h as isRateLimitAssistantError,
  i as extractObservedOverflowTokenCount,
  m as isLikelyContextOverflowError,
  p as isFailoverErrorMessage,
  s as isAuthAssistantError,
  t as classifyFailoverReason,
  u as isCompactionFailureError,
  y as parseImageDimensionError,
} from "./errors-D66M8xLa.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import {
  n as coerceToFailoverError,
  r as describeFailoverError,
  s as resolveFailoverStatus,
  t as FailoverError,
} from "./failover-error-Dx3vQAkt.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-CDN8j5cn.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-Dx8N2J-j.js";
...
import { t as ensureContextEnginesInitialized } from "./init-DIipJtAF.js";
...
import {
  ...
  r as ensureSelectedAgentHarnessPlugin,
  t as clearLiveModelSwitchPending,
} from "./live-model-switch-GuLEgeev.js";
import { t as logDebug } from "./logger-BWdMCYqK.js";
import { t as log$1 } from "./logger-Ce0PtXjG.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-GRZIhFYD.js";
import {
...
import {
  c as captureCompactionCheckpointSnapshotAsync,
  h as resolveSessionCompactionCheckpointReason,
  l as cleanupCompactionCheckpointSnapshot,
  m as readSessionLeafIdFromTranscriptAsync,
  n as asCompactionHookRunner,
  p as persistSessionCompactionCheckpoint,
  s as runPostCompactionSideEffects,
  t as readPiModelContextTokens,
} from "./model-context-tokens-CNTskz5N.js";
import { n as resolveModelAsync } from "./model-Du5PofNQ.js";
import {
  a as suspendSession,
  c as resolveSessionKeyForRequest,
  d as shouldAllowCooldownProbeForReason,
  f as buildApiErrorObservationFields,
  i as resolveSessionSuspensionReason,
  l as resolveStoredSessionKeyForSessionId,
...
import {
  _ as isStrictAgenticExecutionContractActive,
...
import { t as markAuthProfileGood } from "./profiles-B4Bcz6fY.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-BsflYiD2.js";
import {
  f as sanitizeRuntimeProviderRequestOverrides,
  s as resolveProviderRequestConfig,
} from "./provider-request-config-B-kAAqy2.js";
import {
  X as resolveProviderAuthProfileId,
  x as prepareProviderRuntimeAuth,
} from "./provider-runtime-DueHRTen.js";
import { t as redactIdentifier } from "./redact-identifier-1BFYV1_1.js";
import {
  a as resolveContextEngineOwnerPluginId,
  i as resolveContextEngine,
} from "./registry-sQP5dNFn.js";
import { s as hasOutboundReplyContent } from "./reply-payload-D_-IJF8p.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-BNiVjvuQ.js";
import {
  l as isRawApiErrorPayload,
  n as formatBillingErrorMessage,
  o as getApiErrorPayloadFingerprint,
...
import {
  C as observeReplayMetadata,
  S as createEmbeddedRunReplayState,
  _ as resolveReasoningOnlyRetryInstruction,
  a as formatEmbeddedRunStageSummary,
  b as resolveSilentToolResultReplyPayload,
  c as STRICT_AGENTIC_BLOCKED_TEXT,
  d as resolveAckExecutionFastPathInstruction,
  f as resolveAttemptReplayMetadata,
  g as resolvePlanningOnlyRetryLimit,
  h as resolvePlanningOnlyRetryInstruction,
  i as createEmbeddedRunStageTracker,
  l as extractPlanningOnlyPlanDetails,
  m as resolveIncompleteTurnPayloadText,
  n as runAgentHarnessAttempt,
  o as shouldWarnEmbeddedRunStageSummary,
  p as resolveEmptyResponseRetryInstruction,
  r as selectAgentHarness,
  t as maybeCompactAgentHarnessSession,
  v as resolveReplayInvalidFlag,
  x as shouldTreatEmptyAssistantReplyAsSilent,
  y as resolveRunLivenessState,
} from "./selection-BcCvjGlJ.js";
import { i as isCronSessionKey } from "./session-key-utils-B3KPN8Ee.js";
import "./extra-params-DDMcNhQe.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-9hg03xJO.js";
import {
...
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-DZlUjkX3.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-DWz8lWRf.js";
import { t as formatToolAggregate } from "./tool-meta-DI7YbTn_.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-DOGn06lj.js";
import {
...
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-_XTrUIv2.js";
    ...
    enqueueGlobal(async () => {
      ...
      try {
        ...
        checkpointSnapshot = engineOwnsCompaction
          ? await captureCompactionCheckpointSnapshotAsync({ sessionFile: params.sessionFile })
          : null;
 ...
 */
function isRecoverableFailoverReason(reason) {
      ...
      if (
        ...
        return {
          ...
          error: new FailoverError(
            "The service is temporarily overloaded. Your uploaded files and request have been saved — please try again in a moment.",
            {
              reason: "overloaded",
...
function resolveAssistantMessageFamily(params) {
...
function buildUsageAgentMetaFields(params) {
  ...
  return {
    usage,
    lastCallUsage: sanitizePerCallCacheUsage({
      usage: normalizeUsage(params.lastAssistantUsage),
      promptTokens,
  ...
  if (
    ...
    for (const { toolName, meta } of params.toolMetas) {
      const {
        ...
        formatToolAggregate(toolName, meta ? [meta] : [], { markdown: useMarkdown }),
      );
      if (cleanedText)
        replyItems.push({
          text: cleanedText,
...
function resolveEffectiveRuntimeModel(params) {
  ...
  const runtimeBaseUrl =
    typeof params.runtimeModel.baseUrl === "string" ? params.runtimeModel.baseUrl : void 0;
  ...
  return enqueueSession(() => {
    ...
    return enqueueGlobal(async () => {
      ...
      const onUserMessagePersisted = (message) => {
        if (params.currentMessageId !== void 0)
      ...
      const maybeEscalateRateLimitProfileFallback = (params) => {
        ...
        throw new FailoverError(
          "The service is temporarily at capacity (rate-limited). Your uploaded files and request have been saved — please try again in a moment.",
          {
            reason: "rate_limit",
      ...
      const resolveRunAuthProfileFailureReason = (failoverReason) =>
      ...
      try {
        ...
        while (true) {
            ...
            if (
              ...
              if (compactResult.compacted) {
                ...
                if (preflightRecovery?.source === "mid-turn") continueFromCurrentTranscript();
                  ...
                  params.currentMessageId !== void 0 &&
            ...
            if (
              ...
              if (failedPromptProfileId && promptProfileFailureReason)
                maybeMarkAuthProfileFailure({
                  ...
                  log$1.warn(`deferred prompt profile failure mark failed: ${String(err)}`),
                );
              traceAttempts.push({
                provider,
                model: modelId,
          ...
          const agentMeta = {
            ...
            ...(reportedModelRef.servedModel ? { servedModel: reportedModelRef.servedModel } : {}),
            contextTokens: ctxInfo.tokens,
          ...
          if (
            ...
            const timeoutText = idleTimedOut
              ? "The service is taking longer than expected and timed out before a response was ready. Your uploaded files and request have been saved — please try again. (Operators: increase `models.providers.<id>.timeoutSeconds` for slow local or self-hosted providers.)"
              : "The service is temporarily unavailable and the request timed out before a response was ready. Your uploaded files and request have been saved — please try again in a moment. (Operators: increase `agents.defaults.timeoutSeconds` in your config for long multi-document turns.)";
          ...
          if (
            ...
            const planDetails = extractPlanningOnlyPlanDetails(
            ...
            log$1.warn(
              `planning-only turn detected: runId=${params.runId} sessionId=${params.sessionId} provider=${provider}/${modelId} contract=${executionContract} configured=${configuredExecutionContract} — retrying ${planningOnlyRetryAttempts}/${maxPlanningOnlyRetryAttempts} with act-now steer`,
            );
            continue;
          }
          if (
          ...
          if (!incompleteTurnText && nextPlanningOnlyRetryInstruction && strictAgenticActive) {
            log$1.warn(
              `strict-agentic run exhausted planning-only retries: runId=${params.runId} sessionId=${params.sessionId} provider=${provider}/${modelId} configured=${configuredExecutionContract} — surfacing blocked state`,
            );
            const replayInvalid = resolveReplayInvalidForAttempt(null);
          ...
          if (
            ...
            !timedOut &&
            sessionLastAssistant?.stopReason === "error" &&
            (sessionLastAssistant?.usage?.output ?? 0) === 0 &&
            ...
            emptyErrorRetries += 1;
            log$1.warn(
              `[empty-error-retry] stopReason=error output=0; resubmitting attempt=${emptyErrorRetries}/${MAX_EMPTY_ERROR_RETRIES} provider=${sessionLastAssistant?.provider ?? provider} model=${sessionLastAssistant?.model ?? model.id} sessionKey=${params.sessionKey ?? params.sessionId}`,
            );
            continue;
          }
          if (incompleteTurnText) {
            ...
            log$1.warn(
              `incomplete turn detected: runId=${params.runId} sessionId=${params.sessionId} stopReason=${incompleteStopReason} payloads=${payloadCount} — surfacing error to user`,
            );
            if (lastProfileId)
              await maybeMarkAuthProfileFailure({
                profileId: lastProfileId,
