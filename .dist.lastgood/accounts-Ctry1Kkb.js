...
import { n as resolveDiscordToken, r as selectDiscordRuntimeConfig } from "./token-DrAnwDDa.js";
...
function isDiscordAccountEnabledForRuntime(account, cfg) {
  return (
    account.enabled &&
    !resolveDiscordDuplicateTokenOwner({
      cfg,
      account,
    })
  );
...
//#endregion
export {
  mergeDiscordAccountConfig as a,
  resolveDiscordAccountAllowFrom as c,
  resolveDiscordAccountDmPolicy as d,
  resolveDiscordMaxLinesPerMessage as f,
  listEnabledDiscordAccounts as i,
  resolveDiscordAccountConfig as l,
  isDiscordAccountEnabledForRuntime as n,
  resolveDefaultDiscordAccountId as o,
  listDiscordAccountIds as r,
  resolveDiscordAccount as s,
  createDiscordActionGate as t,
  resolveDiscordAccountDisabledReason as u,
};
