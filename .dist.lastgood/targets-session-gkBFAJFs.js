...
import { s as channelRouteTargetsShareConversation } from "./channel-route-B9olp3tt.js";
...
import {
  n as normalizeMessageChannel,
  t as isDeliverableMessageChannel,
} from "./message-channel-core-VUC-himU.js";
...
import {
  n as resolveRouteTargetForLoadedChannel,
  t as parseExplicitTargetForLoadedChannel,
} from "./target-parsing-loaded-ClasI1Xo.js";
...
function resolveOutboundTargetWithPlugin(params) {
  if (params.target.channel === "webchat")
    return {
      ok: false,
...
function resolveSessionDeliveryTarget(params) {
  ...
  const sessionLastChannel =
    context?.channel && isDeliverableMessageChannel(context.channel) ? context.channel : void 0;
  ...
  const explicitPrefixedChannel =
    requestedChannel === "last" ? resolveTargetPrefixedChannel(rawExplicitTo) : void 0;
  let channel =
...
//#endregion
export {
  validateTargetProviderPrefix as i,
  resolveOutboundTargetWithPlugin as n,
  resolveTargetPrefixedChannel as r,
  resolveSessionDeliveryTarget as t,
};
