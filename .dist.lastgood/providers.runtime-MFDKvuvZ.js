import {
  r as withActivatedPluginIds,
  t as resolveBundledPluginCompatibleActivationInputs,
} from "./activation-context-lkE-qLhi.js";
...
import {
  n as buildPluginRuntimeLoadOptionsFromValues,
  r as createPluginRuntimeLoaderLogger,
} from "./load-context-CvRyUbBt.js";
import {
  l as loadOpenClawPlugins,
  o as getRuntimePluginRegistryForLoadOptions,
  s as isPluginRegistryLoadInFlight,
} from "./loader-BLowS1kl.js";
import { i as hasExplicitPluginIdScope } from "./package-state-probes-DwIK9Kbe.js";
import { r as normalizeProviderId } from "./provider-id-CG9pXYPs.js";
import {
  a as resolveDiscoveredProviderPluginIds,
  d as resolveOwningPluginIdsForProvider,
  f as withBundledProviderVitestCompat,
  i as resolveDiscoverableProviderOwnerPluginIds,
  n as resolveBundledProviderCompatPluginIds,
  o as resolveEnabledProviderPluginIds,
  t as resolveActivatableProviderOwnerPluginIds,
  u as resolveOwningPluginIdsForModelRefs,
} from "./providers-CWWim-ts.js";
import { c as getActivePluginRegistryWorkspaceDir } from "./runtime-ChXyIFtl.js";
  ...
  return {
    ...
    requestedPluginIds:
      ...
      modelOwnedPluginIds.length > 0
        ...
        : void 0,
    explicitOwnerPluginIds: dedupeSortedPluginIds([
      ...providerOwnedPluginIds,
      ...modelOwnedPluginIds,
    ]),
...
function resolveSetupProviderPluginLoadState(params, base) {
  const setupPluginIds = mergeExplicitOwnerPluginIds(
...
function resolveRuntimeProviderPluginLoadState(params, base) {
  ...
  const runtimeRequestedPluginIds =
    base.requestedPluginIds !== void 0
...
//#endregion
export {
  resolvePluginProviders as n,
  resolveProviderConfigApiOwnerHint as r,
  isPluginProvidersLoadInFlight as t,
};
