...
} from "./cli-auth-seam-CUo6pWRR.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-5iW0ARms.js";
import {
  n as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS,
  r as CLAUDE_CLI_DEFAULT_MODEL_REF,
  t as CLAUDE_CLI_BACKEND_ID,
} from "./cli-constants-9PIRZzLM.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-D8I4imRb.js";
...
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-BRCTRY4O.js";
...
import { a as fetchClaudeUsage } from "./provider-usage-DMzwZy0Z.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-Dag1lBgW.js";
import { t as buildReplayPolicy } from "./replay-policy-Di_YvRFi.js";
import { l as wrapAnthropicProviderStream } from "./stream-wrappers-DmFYCeW0.js";
...
const CLAUDE_CLI_CANONICAL_ALLOWLIST_REFS = CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS.map((ref) =>
  ref.startsWith(`claude-cli/`) ? `anthropic/${ref.slice(CLAUDE_CLI_BACKEND_ID.length + 1)}` : ref,
);
...
function resolveAnthropic46ForwardCompatModel(params) {
  ...
  return cloneFirstTemplateModel({
    ...
    ctx: params.ctx,
    patch:
      normalizeLowercaseStringOrEmpty(params.ctx.provider) === "claude-cli"
...
function buildAnthropicProvider() {
  ...
  return {
    ...
    resolveSyntheticAuth: ({ provider }) =>
      normalizeLowercaseStringOrEmpty(provider) === "claude-cli"
