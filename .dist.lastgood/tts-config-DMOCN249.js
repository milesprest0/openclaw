...
function resolveAccountTtsOverride(cfg, context) {
  ...
  return asTtsConfig(
    asObjectRecord(
      resolveRecordEntry(
        isPlainObject(channelConfig?.accounts) ? channelConfig.accounts : void 0,
        context.accountId,
        normalizeAccountId,
      ),
    )?.tts,
...
//#endregion
export {
  shouldCleanTtsDirectiveText as i,
  resolveEffectiveTtsConfig as n,
  shouldAttemptTtsPayload as r,
  resolveConfiguredTtsMode as t,
};
