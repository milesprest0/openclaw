import { n as resolveDiscordChannelInfoSafe } from "./channel-access-D9bNbJhi.js";
import { It as ComponentType, Wt as StickerFormatType } from "./discord-Do-Uybag.js";
import { r as fetchRemoteMedia } from "./fetch-CIuHGNdE.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { i as getFileExtension } from "./mime-CSQ-Gv-M.js";
  ...
  try {
    ...
    const timeoutPromise = new Promise((_, reject) => {
      timeoutHandle = setTimeout(() => {
        ...
        reject(
          /* @__PURE__ */ new Error(
            `discord media download timed out after ${params.totalTimeoutMs}ms`,
          ),
        );
...
function resolveDiscordMessageText(message, options) {
  ...
  const baseText = resolveDiscordMentions(
...
//#endregion
export {
  resolveForwardedMediaList as a,
  resolveDiscordChannelInfo as c,
  buildDiscordMediaPayload as i,
  resolveDiscordMessageChannelId as l,
  resolveDiscordForwardedMessagesTextFromSnapshots as n,
  resolveMediaList as o,
  resolveDiscordMessageText as r,
  hasDiscordMessageStickers as s,
  resolveDiscordEmbedText as t,
};
