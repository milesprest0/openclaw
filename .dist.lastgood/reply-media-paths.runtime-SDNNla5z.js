...
import {
  ...
  t as resolveAgentScopedOutboundMediaAccess,
...
import { t as MEDIA_MAX_BYTES } from "./store-N2etmi9e.js";
...
function createReplyMediaPathNormalizer(params) {
  ...
  const resolveMediaAccessForSource = (media) =>
  ...
  const resolveWorkspaceRelativeMedia = (media) => {
    return resolvePathFromInput(
      toRelativeWorkspacePath(params.workspaceDir, media, { cwd: params.workspaceDir }),
      params.workspaceDir,
    );
  };
