...
import {
  ...
  i as BlockType,
  n as BlockHeader,
  o as VorbisPictureToken,
  r as BlockStreamInfo,
  t as FlacParser,
} from "./FlacParser-BqvWmnIU.js";
import { i as EndOfStreamError } from "./lib-Dy7Qkhjs.js";
import { t as require_src } from "./src-Dce2BfHT.js";
import { a as getBit, u as trimRightNull } from "./Util-DouHaPQs.js";
...
var FlacStream = class {
  ...
  async parseFirstPage(_header, pageData) {
    ...
    if ((await FourCcToken.get(pageData, 9)).toString() !== "fLaC")
      ...
      do {
        ...
        if (
          ...
          !(
            ...
            [...this.streams.values()].find((stream) => stream.pageConsumer?.durationOnLastPage)
          )
        ) {
