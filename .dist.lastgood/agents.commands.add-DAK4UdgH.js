...
import {
  a as describeBinding,
  n as buildChannelBindings,
  r as parseBindingSpecs,
  t as applyAgentBindings,
} from "./agents.bindings-BNIQ-B9L.js";
import { r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-paEb5Fyv.js";
import "./agent-scope-9AmhTwki.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-b9CHLqOC.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CNNDBjZs.js";
import { t as buildPortableAuthProfileSecretsStoreForAgentCopy } from "./auth-profiles-BrCJ7JK3.js";
import { t as createClackPrompter } from "./clack-prompter-GJpmmrX5.js";
import {
  n as requireValidConfigSnapshot,
  t as requireValidConfigFileSnapshot$1,
} from "./config-validation-DPqhMlGD.js";
...
import { r as ensureWorkspaceAndSessions } from "./onboard-helpers-BBY5G06B.js";
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
  ...
  if (nonInteractive) {
    ...
    await ensureWorkspaceAndSessions(
      workspaceDir,
      opts.json ? createQuietRuntime(runtime) : runtime,
      {
        skipBootstrap: Boolean(bindingResult.config.agents?.defaults?.skipBootstrap),
        skipOptionalBootstrapFiles:
          bindingResult.config.agents?.defaults?.skipOptionalBootstrapFiles,
        agentId,
      },
    );
    const payload = {
        ...
        nameInput ??
          (await prompter.text({
            ...
            validate: (value) => {
              ...
              if (normalizeAgentId(value) === "main")
                return `"main" is reserved. Choose another name.`;
            },
          })),
      ) ?? "";
...
//#endregion
export {
  requireValidConfigFileSnapshot as i,
  createQuietRuntime as n,
  requireValidConfig as r,
  agentsAddCommand as t,
};
