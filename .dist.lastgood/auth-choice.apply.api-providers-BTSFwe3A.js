import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-DGJxQIqG.js";
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-DscmBbh5.js";
import { o as normalizeTokenProviderInput } from "./provider-auth-input-kX7gel6j.js";
...
function resolveProviderAuthChoiceByKind(params) {
  return resolveProviderMatch(
    ...
    params.providerId,
  )?.auth.find((method) => method.kind === params.kind)?.wizard?.choiceId;
}
