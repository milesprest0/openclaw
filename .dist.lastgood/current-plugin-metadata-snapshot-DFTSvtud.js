import {
  ...
  c as getCurrentPluginMetadataSnapshotState,
  l as setCurrentPluginMetadataSnapshotState,
  s as clearCurrentPluginMetadataSnapshotState,
...
function getCurrentPluginMetadataSnapshot(params = {}) {
  ...
  const requestedWorkspaceDir =
    params.workspaceDir ??
    (params.allowWorkspaceScopedSnapshot === true ? snapshot.workspaceDir : void 0);
  if (params.config) {
...
//#endregion
export {
  getCurrentPluginMetadataSnapshot as n,
  setCurrentPluginMetadataSnapshot as r,
  clearCurrentPluginMetadataSnapshot as t,
};
