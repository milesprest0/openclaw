...
import { n as isCompactionCheckpointTranscriptFileName } from "./artifacts-D7iplKs9.js";
...
import { m as resolveGatewaySessionStoreTarget } from "./session-utils-Dhg586UW.js";
...
async function readSessionLeafIdFromTranscriptAsync(
  sessionFile,
  ...
  try {
    ...
    while (readLength > 0) {
      ...
      const lines = (await readFileRangeAsync(fileHandle, readStart, readLength))
        .toString("utf-8")
        .split(/\r?\n/);
...
function estimateTokensAfterCompaction(params) {
  ...
  if (
    ...
    tokensAfter >
      (params.observedTokenCount !== void 0 ? sanityCheckBaseline : sanityCheckBaseline * 1.1)
  )
    return;
  return tokensAfter;
}
...
//#endregion
export {
  runAfterCompactionHooks as a,
  captureCompactionCheckpointSnapshotAsync as c,
  getSessionCompactionCheckpoint as d,
  listSessionCompactionCheckpoints as f,
  resolveSessionCompactionCheckpointReason as h,
  estimateTokensAfterCompaction as i,
  cleanupCompactionCheckpointSnapshot as l,
  readSessionLeafIdFromTranscriptAsync as m,
  asCompactionHookRunner as n,
  runBeforeCompactionHooks as o,
  persistSessionCompactionCheckpoint as p,
  buildBeforeCompactionHookMetrics as r,
  runPostCompactionSideEffects as s,
  readPiModelContextTokens as t,
  forkCompactionCheckpointTranscriptAsync as u,
};
