import { r as resetConfiguredBindingTargetInPlace } from "./binding-targets-DVGRSd-T.js";
import { t as clearBootstrapSnapshot } from "./bootstrap-cache-CYMhno0R.js";
import { t as clearAllCliSessions } from "./cli-session-FZWoj6wf.js";
import { t as emitResetCommandHooks } from "./commands-reset-hooks-GULw7tpK.js";
...
import "./commands-context-orVmMlkg.js";
...
import { n as resolveBoundAcpThreadSessionKey } from "./targets-UHVslzHg.js";
...
async function maybeHandleResetCommand(params) {
  ...
  if (softReset.matched) {
    ...
    if (
      boundAcpSessionKey && isAcpSessionKey(boundAcpSessionKey) ? boundAcpSessionKey.trim() : void 0
    )
      return {
    ...
    const previousSessionEntry =
      params.previousSessionEntry ?? (targetSessionEntry ? { ...targetSessionEntry } : void 0);
