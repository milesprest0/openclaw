...
var require_bignumber = /* @__PURE__ */ __commonJSMin((exports, module) => {
  (function (globalObject) {
    ...
    var BigNumber,
      ...
      POWS_TEN = [
        1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 0xe8d4a51000, 0x9184e72a000,
      ],
      SQRT_BASE = 1e7,
      MAX = 1e9;
    function clone(configObject) {
      ...
      function valueOf(n) {
        ...
        str = coeffToString(n.c);
        str =
          e <= TO_EXP_NEG || e >= TO_EXP_POS ? toExponential(str, e) : toFixedPoint(str, e, "0");
      ...
      P.squareRoot = P.sqrt = function () {
        var m,
          ...
          half = new BigNumber("0.5");
        if (s !== 1 || !c || !c[0])
          return new BigNumber(!s || (s < 0 && (!c || c[0])) ? NaN : c ? x : Infinity);
