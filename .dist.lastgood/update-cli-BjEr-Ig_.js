...
import "./daemon-cli-XQ1yu_ZP.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./channel-catalog-registry-uu7_tUkL.js";
import { n as resolveCliName, t as replaceCliName } from "./cli-name-DXjaVgxu.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-4E5k3WN1.js";
import { t as formatCliCommand } from "./command-format-yMavKibC.js";
import { n as inheritOptionFromParent } from "./command-options-BWuq_8aU.js";
import {
  i as installCompletion,
  n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV,
} from "./completion-runtime-CEQoOxOd.js";
import {
  c as resolveEffectiveEnableState,
  s as normalizePluginsConfig,
} from "./config-state-BF1r9Z0v.js";
import {
  r as ensureCompletionCacheExists,
  t as checkShellCompletionStatus,
} from "./doctor-completion-DjqEKpaQ.js";
import { t as doctorCommand } from "./doctor-DICbudaw.js";
...
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-Dqwpv1Qt.js";
import { t as formatHelpExamples } from "./help-format-ejZTKN6e.js";
import { n as runDaemonInstall } from "./install-B13nQGLF.js";
import {
  a as withPluginInstallRecords,
  o as withoutPluginInstallRecords,
} from "./installed-plugin-index-records-BD2sKB0z.js";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-YgBbP4mp.js";
import {
  F as asResolvedSourceConfig,
  I as asRuntimeConfig,
  u as readConfigFileSnapshot,
} from "./io-CEQSCTGy.js";
import { n as formatConfigIssueLines } from "./issue-format-DZoENRCj.js";
import { d as writeJson, i as readJsonIfExists } from "./json-files-DifBk3kt.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-DbB5jDZD.js";
import { t as formatDocsLink } from "./links-CNfoPWBd.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-DnaIfMcO.js";
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./mutate-IzL9dVFH.js";
...
import { n as readPackageName, r as readPackageVersion } from "./package-json-BqSklvpu.js";
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
import {
  d as resolveGatewayLaunchAgentLabel,
  m as resolveGatewayWindowsTaskName,
  p as resolveGatewaySystemdServiceName,
} from "./paths-D-SPS6K1.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-BeU7cwXO.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-1zaTwAzG.js";
import { t as selectStyled } from "./prompt-select-styled-xYn-xEzB.js";
import { n as stylePromptMessage } from "./prompt-style-ZgH7vAUU.js";
import {
  l as waitForGatewayHealthyRestart,
  o as renderRestartDiagnostics,
  s as terminateStaleGatewayPids,
} from "./restart-health-B4e32uo2.js";
import {
  a as shellEscapeRestartLogValue,
  i as resolveGatewayRestartLogPath,
  n as renderPosixRestartLogSetup,
} from "./restart-logs-DvjnXu8L.js";
import { u as trimLogTail } from "./restart-sentinel-CXl2NwhJ.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-KOGEujAp.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-vJnP437q.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-XaNrZpdz.js";
import {
...
import { n as renderTable, t as getTerminalTableWidth } from "./table-7FDfRO4i.js";
import { r as theme } from "./theme-CiH_wF8x.js";
import {
  i as updateNpmInstalledPlugins,
  n as resolveTrustedSourceLinkedOfficialNpmSpec,
  r as syncPluginsForUpdateChannel,
  t as resolveTrustedSourceLinkedOfficialClawHubSpec,
} from "./update-02X0g2as.js";
import {
  c as resolveEffectiveUpdateChannel,
  i as formatUpdateChannelLabel,
  l as resolveRegistryUpdateChannel,
  r as channelToNpmTag,
  s as normalizeUpdateChannel,
  u as resolveUpdateChannelDisplay,
} from "./update-channels-kLC68_fZ.js";
import {
  i as fetchNpmTagVersion,
  n as compareSemverStrings,
  o as resolveNpmChannelTag,
  r as fetchNpmPackageTargetStatus,
  t as checkUpdateStatus,
} from "./update-check-hxRluXkb.js";
import {
  a as cleanupGlobalRenameDirs,
  c as detectGlobalInstallManagerForRoot,
  d as resolveGlobalInstallTarget,
  f as resolvePnpmGlobalDirFromGlobalRoot,
  i as canResolveRegistryVersionForPackageTarget,
  l as globalInstallArgs,
  n as runGatewayUpdate,
  o as createGlobalInstallEnv,
  p as normalizePackageTagInput,
  r as runGlobalPackageUpdateSteps,
  s as detectGlobalInstallManagerByPresence,
  u as resolveGlobalInstallSpec,
} from "./update-runner-CyHcWvtq.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-BGRcpLKt.js";
...
async function ensureGitCheckout(params) {
  ...
  if (!(await isGitCheckout(params.dir))) {
    if (!(await isEmptyDir(params.dir)))
      throw new Error(
    ...
    if (!jsonMode) {
      const reason =
        result.error.code === "ETIMEDOUT"
          ? `timed out after ${COMPLETION_CACHE_WRITE_TIMEOUT_MS / 1e3}s`
          : String(result.error);
      defaultRuntime.log(
        theme.warn(
...
`;
      ...
      const escapedPlistPath = shellEscape(
...
`;
      ...
      const quotedLogPath = powerShellSingleQuote(
...
async function runRestartScript(scriptPath) {
  ...
  spawn(
    ...
    isWindows ? ["/d", "/s", "/c", quoteCmdScriptArg(scriptPath)] : [scriptPath],
    {
      detached: true,
      stdio: "ignore",
      windowsHide: true,
...
async function recoverLaunchAgentAndRecheckGatewayHealth(params) {
  ...
  const launchAgentRecovery = await (
...
async function resolvePackageRuntimePreflightError(params) {
  ...
  if (nodeVersionSatisfiesEngine(process.versions.node ?? null, status.nodeEngine) !== false)
    return null;
...
function resolvePostInstallDoctorEnv(params) {
  ...
  for (const key of POST_INSTALL_DOCTOR_SERVICE_ENV_KEYS)
    if (serviceEnv[key]?.trim()) resolvedEnv[key] = serviceEnv[key];
  return resolvedEnv;
}
...
async function runPackageInstallUpdate(params) {
  ...
  const packageName =
    (pkgRoot ? await readPackageName(pkgRoot) : await readPackageName(params.root)) ?? "openclaw";
  ...
  if (diskWarning)
    if (params.jsonMode) defaultRuntime.error(`Warning: ${diskWarning}`);
...
async function updatePluginsAfterCoreUpdate(params) {
  ...
  const onPluginIntegrityDrift = async (drift) => {
    ...
    if (!params.opts.json) {
      ...
      defaultRuntime.log(
        theme.warn(`Integrity drift detected for "${drift.pluginId}" (${specLabel})\nExpected: ${drift.expectedIntegrity}\nActual:   ${drift.actualIntegrity}
      ...
      if (!params.opts.json && restarted) {
        ...
        try {
          await doctorCommand(defaultRuntime, {
            nonInteractive: !(process.stdin.isTTY && !params.opts.json && params.opts.yes !== true),
          });
        } catch (err) {
...
async function persistRequestedUpdateChannel(params) {
  ...
  if (normalizeUpdateChannel(refreshed.config.update?.channel) === params.requestedChannel)
    return refreshed;
  const refreshedNext = {
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
  ...
  const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-C4TIw1F7.js");
  ...
  try {
    ...
    const childResult = await new Promise((resolve, reject) => {
      ...
      const resultPoll = setInterval(() => {
        readPostCorePluginUpdateResultFile(resultPath)
          .then((pluginUpdate) => {
...
async function updateCommand(opts) {
  ...
  const channel =
    requestedChannel ?? storedChannel ?? (updateInstallKind === "git" ? "dev" : "stable");
  const devTargetRef =
    channel === "dev" ? process.env.OPENCLAW_UPDATE_DEV_TARGET_REF?.trim() || void 0 : void 0;
