...
function readConnectErrorRecoveryAdvice(details) {
  ...
  const canRetryWithDeviceToken =
    typeof raw.canRetryWithDeviceToken === "boolean" ? raw.canRetryWithDeviceToken : void 0;
  const normalizedNextStep = normalizeOptionalString(raw.recommendedNextStep) ?? "";
  return {
    canRetryWithDeviceToken,
    recommendedNextStep: CONNECT_RECOVERY_NEXT_STEP_VALUES.has(normalizedNextStep)
      ? normalizedNextStep
      : void 0,
  };
}
...
//#endregion
export {
  buildPairingConnectRecoveryTitle as a,
  normalizePairingConnectRequestId as c,
  readConnectPairingRequiredMessage as d,
  readPairingConnectErrorDetails as f,
  buildPairingConnectErrorMessage as i,
  readConnectErrorDetailCode as l,
  resolveDeviceAuthConnectErrorDetailCode as m,
  buildPairingConnectCloseReason as n,
  describePairingConnectRequirement as o,
  resolveAuthConnectErrorDetailCode as p,
  buildPairingConnectErrorDetails as r,
  formatConnectErrorMessage as s,
  ConnectErrorDetailCodes as t,
  readConnectErrorRecoveryAdvice as u,
};
