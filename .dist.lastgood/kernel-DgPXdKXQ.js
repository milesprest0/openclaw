...
import { t as normalizeDeliverableOutboundChannel } from "./channel-resolution-PPtZ0iMr.js";
import { r as shouldIncludeSupplementalContext } from "./context-visibility-2FK_0ypA.js";
import { n as resolveOutboundDurableFinalDeliverySupport } from "./deliver-Dz9Dpt9U.js";
import { t as EMPTY_CHANNEL_TURN_DISPATCH_COUNTS } from "./dispatch-result-Cyoa53q0.js";
...
import { n as listMessageReceiptPlatformIds } from "./receipt-DxFe-lje.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-BZPcIR_E.js";
import { t as sendDurableMessageBatch } from "./send-X1AwnT-U.js";
...
function mediaTranscribedIndexes(media) {
  const indexes = media
    .map((item, index) => (item.transcribed ? index : void 0))
...
function clearPendingHistoryAfterTurn(params) {
  if (!params?.isGroup || !params.historyKey || !params.historyMap || params.limit === void 0)
    return;
...
async function runChannelTurn(params) {
  ...
  try {
    result = {
      ...(await dispatchResolvedChannelTurn(
...
//#endregion
export {
  runPreparedChannelTurn as a,
  filterChannelTurnSupplementalContext as c,
  isDurableInboundReplyDeliveryHandled as d,
  throwIfDurableInboundReplyDeliveryFailed as f,
  runChannelTurn as i,
  deliverDurableInboundReplyPayload as l,
  createNoopChannelTurnDeliveryAdapter as n,
  runResolvedChannelTurn as o,
  createChannelDeliveryResultFromReceipt as p,
  dispatchAssembledChannelTurn as r,
  buildChannelTurnContext as s,
  createChannelTurnReplyPipeline as t,
  deliverInboundReplyWithMessageSendContext as u,
};
