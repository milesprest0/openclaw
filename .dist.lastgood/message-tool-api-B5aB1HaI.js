import { a as resolveSlackAccount, t as listEnabledSlackAccounts } from "./accounts-Stz3jcMX.js";
...
function listSlackMessageActions(cfg, accountId) {
  ...
  const isActionEnabled = (key, defaultValue = true) => {
    for (const account of accounts)
      if (createActionGate(account.actions ?? cfg.channels?.slack?.actions)(key, defaultValue))
        return true;
    return false;
  };
