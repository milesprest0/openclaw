import { n as expandAllowFromWithAccessGroups } from "./access-groups-DtHOJBzi.js";
...
import { a as getSelfIdentity, o as getSenderIdentity } from "./identity-CG3p7vp1.js";
...
import { t as resolveWhatsAppRuntimeGroupPolicy } from "./runtime-group-policy-D7T2IrkY.js";
import "./session-store-runtime-CGNlDXYc.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import { x as resolveGroupSessionKey } from "./store-BpWdoYPF.js";
import { n as isSelfChatMode } from "./text-runtime-BMQLJDUy.js";
...
function isNormalizedSenderAllowed(allowEntries, sender) {
  ...
  return new Set(
    allowEntries.map((entry) => normalizeE164(entry)).filter((entry) => Boolean(entry)),
  ).has(normalizedSender);
}
...
function resolveWhatsAppInboundPolicy(params) {
  ...
  const groupAllowFrom =
    account.groupAllowFrom ?? (configuredAllowFrom.length > 0 ? configuredAllowFrom : void 0) ?? [];
...
async function resolveWhatsAppCommandAuthorized(params) {
  ...
  const isSenderAllowed = (senderId, allowEntries) =>
    isGroup
...
//#endregion
export {
  resolveWhatsAppInboundPolicy as i,
  checkInboundAccessControl as n,
  resolveWhatsAppCommandAuthorized as r,
  __testing as t,
};
