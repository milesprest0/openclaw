...
import { t as MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "./assistant-error-format-BsjMPFd_.js";
import {
  n as hasCopilotVisionInput,
  t as buildCopilotDynamicHeaders,
} from "./copilot-dynamic-headers-ALufaLHR.js";
import {
  _ as transformTransportMessages,
  c as coerceTransportToolCallArguments,
  d as failTransportStream,
  f as finalizeTransportStream,
  g as sanitizeTransportPayloadText,
  h as sanitizeNonEmptyTransportPayloadText,
  i as createOpenAIResponsesTransportStreamFn,
  l as createEmptyTransportUsage,
  n as createAzureOpenAIResponsesTransportStreamFn,
  p as mergeTransportHeaders,
  r as createOpenAICompletionsTransportStreamFn,
  u as createWritableTransportEventStream,
...
import { i as getModelProviderRequestTransport } from "./provider-request-config-B-kAAqy2.js";
import { M as resolveProviderStreamFn } from "./provider-runtime-DueHRTen.js";
...
function createAbortError(signal) {
  ...
  const error =
    reason === void 0
      ? /* @__PURE__ */ new Error("Request was aborted")
...
//#endregion
export {
  createOpenClawTransportStreamFnForModel as a,
  createBoundaryAwareStreamFnForModel as i,
  ensureCustomApiRegistered as n,
  prepareTransportAwareSimpleModel as o,
  buildTransportAwareSimpleStreamFn as r,
  registerProviderStreamForModel as t,
};
