...
import { s as logoutWeb } from "./auth-store-2Cym1SYy.js";
...
import {
  n as registerWhatsAppConnectionController,
  r as unregisterWhatsAppConnectionController,
} from "./connection-controller-registry-gWe3KErm.js";
...
import { d as DisconnectReason } from "./session.runtime-CiA-rRy6.js";
import { n as clamp } from "./utils-BGRcpLKt.js";
...
const WHATSAPP_LOGGED_OUT_QR_MESSAGE =
...
var WhatsAppConnectionController = class {
  ...
  normalizeCloseReason(reason) {
    const statusCode =
      (typeof reason === "object" && reason && "status" in reason ? reason.status : void 0) ??
      void 0;
    return {
      statusCode,
  ...
  resolveCloseDecision(reason) {
    ...
    if (current && Date.now() - current.startedAt > this.heartbeatSeconds * 1e3)
      this.reconnectAttempts = 0;
...
//#endregion
export {
  waitForWhatsAppLoginResult as a,
  resolveHeartbeatSeconds as c,
  closeWaSocketSoon as i,
  resolveReconnectPolicy as l,
  WhatsAppConnectionController as n,
  DEFAULT_RECONNECT_POLICY as o,
  closeWaSocket as r,
  newConnectionId as s,
  WHATSAPP_LOGGED_OUT_QR_MESSAGE as t,
};
