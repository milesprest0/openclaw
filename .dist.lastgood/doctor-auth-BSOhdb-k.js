...
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CDPDmmIi.js";
...
async function noteAuthProfileHealth(params) {
  if (Object.keys(params.cfg.auth?.profiles ?? {}).length === 0 && !hasAnyAuthProfileStoreSource())
    return;
