...
import { t as openPinnedFileSync } from "./pinned-open-BB65A_MD.js";
import { d as resolveHomeRelativePath } from "./secure-temp-dir-CCj3cY2B.js";
import {
  ...
  if (!opened.ok) {
    const error = normalizeSecretReadError(
      opened.reason === "validation"
        ? /* @__PURE__ */ new Error("security validation failed")
        : opened.error,
    );
    return {
      ok: false,
...
async function writeSecretFileAtomic(params) {
  ...
  try {
    ...
    if ((await fs$1.realpath(intendedParentDir)) !== parentDir)
...
//#endregion
export {
  tryReadSecretFileSync as a,
  readSecretFileSync as i,
  PRIVATE_SECRET_DIR_MODE as n,
  writeSecretFileAtomic as o,
  PRIVATE_SECRET_FILE_MODE as r,
  DEFAULT_SECRET_FILE_MAX_BYTES as t,
};
