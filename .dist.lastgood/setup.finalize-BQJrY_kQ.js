...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DH0TmslB.js";
import { t as attachChildProcessBridge } from "./child-process-bridge-DteIx6hs.js";
...
import { i as installCompletion } from "./completion-runtime-CEQoOxOd.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-CNEVbPNH.js";
import {
...
import { a as isSystemdUserServiceAvailable } from "./systemd-DKgtnjvB.js";
import { p as resolveUserPath, u as pathExists } from "./utils-BGRcpLKt.js";
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DvzHmVcJ.js";
...
async function resolveProfileHint(shell) {
  ...
  if (shell === "bash")
    return (await pathExists(path.join(home, ".bashrc"))) ? "~/.bashrc" : "~/.bash_profile";
...
function loadOnboardSearchModule() {
  onboardSearchModulePromise ??= import("./onboard-search-BK25Pl0q.js");
...
async function finalizeSetupWizard(options) {
  ...
  const explicitInstallDaemon =
    typeof opts.installDaemon === "boolean" ? opts.installDaemon : void 0;
  let installDaemon;
