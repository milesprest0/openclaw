...
import {
  ...
  o as waitForAgentRunsToDrain,
} from "./run-wait-BzfTmTHO.js";
import { n as isLikelyInterimCronMessage } from "./subagent-followup-hints-C0f9CDtC.js";
import { o as listDescendantRunsForRequester } from "./subagent-registry-read-Cr9HxsBK.js";
...
async function waitForDescendantSubagentSummary(params) {
  ...
  if (!(params.observedActiveDescendants === true || initialActiveRuns.length > 0))
    return initialReply;
  ...
  const resolveUsableLatestReply = async () => {
    ...
    if (
      latest &&
      latest.toUpperCase() !== "NO_REPLY".toUpperCase() &&
