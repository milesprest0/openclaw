...
function resolveTavilyApiKey(cfg) {
  return (
    normalizeConfiguredSecret(
      resolveTavilySearchConfig(cfg)?.apiKey,
...
function resolveTavilyBaseUrl(cfg) {
  return (
    (normalizeOptionalString(resolveTavilySearchConfig(cfg)?.baseUrl) ?? "") ||
    ...
    Object.assign(
      {
        ...
        rawContent:
          typeof r.raw_content === `string`
            ? wrapExternalContent(r.raw_content, {
                source: `web_fetch`,
      ...
      typeof r.content === `string`
        ? {
            content: wrapExternalContent(r.content, {
              source: `web_fetch`,
              includeWarning: false,
            }),
          }
