...
function resolveDiscordOwnerAccess(params) {
  ...
  const ownerAllowList = normalizeDiscordAllowList(
    ownerAllowFrom && ownerAllowFrom.length > 0 ? ownerAllowFrom : void 0,
    DISCORD_OWNER_ALLOWLIST_PREFIXES,
  );
  return {
    ownerAllowList,
    ownerAllowed: ownerAllowList
      ? allowListMatches(
          ownerAllowList,
          {
            id: params.sender.id,
...
function resolveDiscordChannelConfig(params) {
  ...
  return (
    resolveChannelMatchConfig(
      resolveDiscordChannelEntryMatch(channels, {
        id: channelId,
        name: channelName,
        slug: channelSlug,
      }),
...
function resolveDiscordChannelConfigWithFallback(params) {
  ...
  return (
    resolveChannelMatchConfig(
      resolveDiscordChannelEntryMatch(
        channels,
        {
          id: channelId,
          name: channelName,
...
function shouldEmitDiscordReactionNotification(params) {
  ...
  const accessGuildInfo =
    params.guildInfo ?? (params.allowlist ? { users: params.allowlist } : null);
...
//#endregion
export {
  resolveGroupDmAllow as _,
  normalizeDiscordSlug as a,
  resolveDiscordChannelConfigWithFallback as c,
  resolveDiscordGuildEntry as d,
  resolveDiscordMemberAccessState as f,
  resolveDiscordShouldRequireMention as g,
  resolveDiscordOwnerAllowFrom as h,
  normalizeDiscordDisplaySlug as i,
  resolveDiscordChannelPolicyCommandAuthorizer as l,
  resolveDiscordOwnerAccess as m,
  isDiscordGroupAllowedByPolicy as n,
  resolveDiscordAllowListMatch as o,
  resolveDiscordMemberAllowed as p,
  normalizeDiscordAllowList as r,
  resolveDiscordChannelConfig as s,
  allowListMatches as t,
  resolveDiscordCommandAuthorized as u,
  shouldEmitDiscordReactionNotification as v,
};
