...
function buildAccountScopedDmSecurityPolicy(params) {
  ...
  const defaultAccountConfig =
    params.inheritSharedDefaultsFromDefaultAccount && resolvedAccountId !== "default"
  ...
  const matchesAnyField = (config, fields) =>
    fields.some((field) => field != null && config?.[field] !== void 0);
  const basePath =
  ...
  const policyPath =
    params.policyPathSuffix != null ? `${basePath}${params.policyPathSuffix}` : void 0;
  return {
...
//#endregion
export {
  resolveChannelDefaultAccountId as i,
  formatPairingApproveHint as n,
  parseOptionalDelimitedEntries as r,
  buildAccountScopedDmSecurityPolicy as t,
};
