...
import {
  _ as resolveDispatchWrapperTrustPlan,
...
const DEFAULT_SAFE_BINS = ["cut", "uniq", "head", "tail", "tr", "wc"];
...
function normalizeSafeBinProfileFixture(fixture) {
  ...
  return {
    minPositional,
    maxPositional:
      minPositional !== void 0 && maxPositionalRaw !== void 0 && maxPositionalRaw < minPositional
        ? minPositional
        : maxPositionalRaw,
...
function normalizeMatchTarget(value) {
  if (process.platform === "win32")
    return normalizeLowercaseStringOrEmpty(value.replace(/^\\\\[?.]\\/, "").replace(/\\/g, "/"));
...
//#endregion
export {
  DEFAULT_SAFE_BINS as C,
  resolveSafeBinProfiles as E,
  resolveExecWrapperTrustPlan as S,
  normalizeSafeBinProfileFixtures as T,
  resolvePolicyTargetCandidatePath as _,
  validateSafeBinArgv as a,
  resolveExecutableFromPathEnv as b,
  matchAllowlist as c,
  resolveApprovalAuditCandidatePath as d,
  resolveCommandResolution as f,
  resolvePolicyAllowlistCandidatePath as g,
  resolveExecutionTargetResolution as h,
  normalizeTrustedSafeBinDirs as i,
  parseExecArgvToken as l,
  resolveExecutionTargetCandidatePath as m,
  isTrustedSafeBinPath as n,
  listRiskyConfiguredSafeBins as o,
  resolveCommandResolutionFromArgv as p,
  listWritableExplicitTrustedSafeBinDirs as r,
  normalizeSafeBinName as s,
  getTrustedSafeBinDirs as t,
  resolveAllowlistCandidatePath as u,
  resolvePolicyTargetResolution as v,
  SAFE_BIN_PROFILES as w,
  resolveExecutablePath as x,
  resolveExecutable as y,
};
