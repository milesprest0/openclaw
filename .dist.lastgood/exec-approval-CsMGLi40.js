import {
  a as resolvePendingApprovalRecord,
  i as isApprovalDecision,
  n as handleApprovalWaitDecision,
  o as respondPendingApprovalLookupError,
  r as handlePendingApprovalRequest,
  t as handleApprovalResolve,
} from "./approval-shared-CtMRU4UC.js";
import {
...
import { t as analyzeCommandForPolicy } from "./policy-DoWoODSF.js";
import {
  X as validateExecApprovalRequestParams,
  Y as validateExecApprovalGetParams,
  Z as validateExecApprovalResolveParams,
  gi as errorShape,
  hi as ErrorCodes,
  t as formatValidationErrors,
} from "./protocol-CUn5aLrV.js";
import "./extract-LxmMzjQi.js";
import {
  i as detectCommandCarrierArgv,
  o as detectInlineEvalInSegments,
} from "./risks-C_v3AkAH.js";
import { c as normalizeOptionalString } from "./string-coerce-BdEutqX5.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-Cja4Yzq-.js";
import {
  i as buildSystemRunApprovalEnvBinding,
      ...
      if (!validateExecApprovalGetParams(params)) {
        respond(
          ...
          errorShape(
            ...
            `invalid exec.approval.get params: ${formatValidationErrors(validateExecApprovalGetParams.errors)}`,
          ),
        );
        return;
      }
    ...
    "exec.approval.resolve": async ({ params, respond, client, context }) => {
      ...
      await handleApprovalResolve({
        ...
        validateDecision: (snapshot) => {
          return resolveExecApprovalRequestAllowedDecisions(snapshot.request).includes(decision)
            ? null
            : {
                message:
