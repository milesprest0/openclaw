...
function readStringValue(value) {
  ...
  if (value && typeof value === "object" && "value" in value)
    return normalizeOptionalString(value.value);
}
function resolveOllamaDiscoveryApiKey(params) {
  ...
  if (!isLocalOllamaBaseUrl(params.baseUrl))
    return envApiKey ?? (resolvedApiKey !== "ollama-local" ? resolvedApiKey : void 0);
  if (resolvedApiKey && resolvedApiKey !== envValue && resolvedApiKey !== "ollama-local")
...
//#endregion
export {
  shouldUseSyntheticOllamaAuth as i,
  OLLAMA_PROVIDER_ID as n,
  resolveOllamaDiscoveryResult as r,
  OLLAMA_DEFAULT_API_KEY as t,
};
