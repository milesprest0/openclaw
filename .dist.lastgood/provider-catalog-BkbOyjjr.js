import {
  n as ARCEE_MODEL_CATALOG,
  r as buildArceeModelDefinition,
  t as ARCEE_BASE_URL,
} from "./models-Dt3CYd9d.js";
...
function normalizeArceeOpenRouterBaseUrl(baseUrl) {
  ...
  if (normalized === "https://openrouter.ai/api/v1" || normalized === OPENROUTER_LEGACY_BASE_URL)
...
//#endregion
export {
  buildArceeProvider as a,
  buildArceeOpenRouterProvider as i,
  buildArceeCatalogModels as n,
  normalizeArceeOpenRouterBaseUrl as o,
  buildArceeOpenRouterCatalogModels as r,
  toArceeOpenRouterModelId as s,
  OPENROUTER_BASE_URL as t,
};
