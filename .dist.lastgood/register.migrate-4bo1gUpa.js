...
import {
  a as MIGRATION_SKILL_SELECTION_TOGGLE_ALL_ON,
  c as applyMigrationSkillSelection,
  d as getDefaultMigrationSkillSelectionValues,
  f as getMigrationSkillSelectionValue,
  g as resolveInteractiveMigrationSkillSelection,
  h as reconcileInteractiveMigrationSkillToggleValues,
  i as MIGRATION_SKILL_SELECTION_TOGGLE_ALL_OFF,
  l as formatMigrationSkillSelectionHint,
  m as reconcileInteractiveMigrationShortcutValues,
  n as runMigrationApply,
  o as applyMigrationPluginSelection,
  p as getSelectableMigrationSkillItems,
  r as MIGRATION_SKILL_SELECTION_SKIP,
  s as applyMigrationSelectedSkillItemIds,
  u as formatMigrationSkillSelectionLabel,
} from "./apply-FOKMxx6s.js";
import "./config-CMOdcWpc.js";
import { n as runCommandWithRuntime } from "./cli-utils-Ce4lxCq8.js";
import { t as buildMigrationContext } from "./context-Bkzpiuun.js";
import { t as formatHelpExamples } from "./help-format-ejZTKN6e.js";
import { i as getRuntimeConfig } from "./io-CEQSCTGy.js";
import { g as redactMigrationPlan } from "./migration-DAySQSKv.js";
import {
  n as resolvePluginMigrationProvider,
  r as resolvePluginMigrationProviders,
  t as ensureStandaloneMigrationProviderRegistryLoaded,
} from "./migration-provider-runtime-ELioNXt8.js";
import { r as formatMigrationPlan } from "./output-C1i7i6K-.js";
import { n as promptYesNo } from "./prompt-CiwliLzu.js";
import {
...
function formatOption(option, state) {
  ...
  switch (state) {
    ...
    case "disabled":
      return `${styleText("gray", S_CHECKBOX_INACTIVE)} ${styleText(["strikethrough", "gray"], label)}${option.hint ? ` ${styleText("dim", `(${option.hint})`)}` : ""}`;
    case "selected":
...
function promptMigrationSkillSelectionValues(opts) {
  ...
  const prompt = new MultiSelectPrompt({
    ...
    validate(value) {
      if (required && (value === void 0 || value.length === 0))
...
async function migratePlanCommand(runtime, opts) {
  ...
  const plan = selectMigrationItems(
    await createMigrationPlan(runtime, {
      ...opts,
      provider: providerId,
    }),
    opts,
