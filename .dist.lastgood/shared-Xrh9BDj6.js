...
import {
  a as resolveConversationBindingThreadIdFromMessage,
  n as resolveConversationBindingChannelFromMessage,
  r as resolveConversationBindingContextFromAcpCommand,
  t as resolveConversationBindingAccountIdFromMessage,
} from "./conversation-binding-input-vXPPKbVX.js";
import { n as toAcpRuntimeErrorText } from "./error-text-CTaVO-zG.js";
import {
  i as normalizeConversationText,
  r as normalizeConversationTargetRef,
} from "./session-binding-normalization-C5mpgnkR.js";
...
import { f as supportsAutomaticThreadBindingSpawn } from "./thread-bindings-policy-CD0S48SB.js";
//#region src/auto-reply/reply/commands-acp/context.ts
function resolveAcpCommandChannel(params) {
  return normalizeLowercaseStringOrEmpty(
    normalizeConversationText(
      resolveConversationBindingChannelFromMessage(params.ctx, params.command.channel),
    ),
  );
}
...
export {
  stopWithText as C,
  resolveAcpCommandConversationId as D,
  resolveAcpCommandBindingContext as E,
  resolveAcpCommandThreadId as O,
  resolveCommandRequestId as S,
  resolveAcpCommandAccountId as T,
  parseSingleValueCommandInput as _,
  ACP_PERMISSIONS_USAGE as a,
  resolveAcpAction as b,
  ACP_SET_MODE_USAGE as c,
  COMMAND as d,
  collectAcpErrorText as f,
  parseSetCommandInput as g,
  parseOptionalSingleTarget as h,
  ACP_MODEL_USAGE as i,
  ACP_STATUS_USAGE as l,
  formatRuntimeOptionsText as m,
  ACP_DOCTOR_USAGE as n,
  ACP_RESET_OPTIONS_USAGE as o,
  formatAcpCapabilitiesText as p,
  ACP_INSTALL_USAGE as r,
  ACP_SESSIONS_USAGE as s,
  ACP_CWD_USAGE as t,
  ACP_TIMEOUT_USAGE as u,
  parseSpawnInput as v,
  withAcpCommandErrorBoundary as w,
  resolveAcpHelpText as x,
  parseSteerInput as y,
};
