...
import "./repair-Dag1lBgW.js";
import { n as ensureAuthProfileStore } from "./store-9hg03xJO.js";
import "./profiles-B4Bcz6fY.js";
import "./provider-auth-input-kX7gel6j.js";
import "./provider-auth-helpers-DWjbCNVf.js";
import "./provider-api-key-auth-Bt32jqgH.js";
...
function parseCopilotTokenResponse(value) {
  ...
  if (typeof expiresAt === "number" && Number.isFinite(expiresAt))
    expiresAtMs = expiresAt < 1e11 ? expiresAt * 1e3 : expiresAt;
...
async function resolveCopilotApiToken(params) {
  ...
  return {
    ...
    baseUrl:
      deriveCopilotApiBaseUrlFromToken(payload.token) ?? "https://api.individual.githubcopilot.com",
  };
}
...
//#endregion
export {
  DEFAULT_COPILOT_API_BASE_URL as a,
  isProviderApiKeyConfigured as c,
  resolveCopilotApiToken as d,
  resolveProviderAuthProfileApiKey as f,
  resolveOpenClawAgentDir as g,
  toFormUrlEncoded as h,
  COPILOT_USER_AGENT as i,
  isProviderAuthProfileConfigured as l,
  generatePkceVerifierChallenge as m,
  COPILOT_EDITOR_VERSION as n,
  buildCopilotIdeHeaders as o,
  generateHexPkceVerifierChallenge as p,
  COPILOT_GITHUB_API_VERSION as r,
  deriveCopilotApiBaseUrlFromToken as s,
  COPILOT_EDITOR_PLUGIN_VERSION as t,
  listUsableProviderAuthProfileIds as u,
};
