...
function resolvePendingApprovalRecord(params) {
  ...
  if (!snapshot || snapshot.resolvedAtMs !== void 0)
    return {
      ok: false,
      response: "missing",
    };
  ...
  if (validationError) {
    params.respond(
      ...
      errorShape(
        ...
        validationError.details ? { details: validationError.details } : void 0,
      ),
    );
    return;
  }
...
//#endregion
export {
  resolvePendingApprovalRecord as a,
  isApprovalDecision as i,
  handleApprovalWaitDecision as n,
  respondPendingApprovalLookupError as o,
  handlePendingApprovalRequest as r,
  handleApprovalResolve as t,
};
