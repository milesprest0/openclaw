...
var import_ieee754 = /* @__PURE__ */ __toESM(
...
function utf8Encoder() {
  ...
  return _utf8Encoder !== null && _utf8Encoder !== void 0
    ? _utf8Encoder
    : (_utf8Encoder = new globalThis.TextEncoder());
}
const CHUNK = 32 * 1024;
...
var CouldNotDetermineFileTypeError = class extends makeParseError(
...
export {
  ...
  INT8 as g,
  INT64_LE as h,
  InternalParserError as i,
  textDecode as k,
  Float64_BE as l,
  INT64_BE as m,
  CouldNotDetermineFileTypeError as n,
  makeParseError as o,
  INT32_LE as p,
  FieldDecodingError as r,
  makeUnexpectedFileContentError as s,
  BasicParser as t,
  INT16_BE as u,
  UINT16_BE as v,
  UINT64_BE as w,
