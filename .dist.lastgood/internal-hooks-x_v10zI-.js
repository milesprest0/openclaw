...
const internalHooksEnabledState = resolveGlobalSingleton(
  Symbol.for("openclaw.internalHooksEnabled"),
  () => ({ enabled: true }),
);
...
//#endregion
export {
  isAgentBootstrapEvent as a,
  isMessageReceivedEvent as c,
  isSessionPatchEvent as d,
  registerInternalHook as f,
  unregisterInternalHook as h,
  hasInternalHookListeners as i,
  isMessageSentEvent as l,
  triggerInternalHook as m,
  createInternalHookEvent as n,
  isGatewayStartupEvent as o,
  setInternalHooksEnabled as p,
  getRegisteredEventKeys as r,
  isMessagePreprocessedEvent as s,
  clearInternalHooks as t,
  isMessageTranscribedEvent as u,
};
