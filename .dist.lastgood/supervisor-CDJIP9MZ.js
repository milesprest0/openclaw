...
import { n as getShellConfig } from "./shell-utils-BaRdb5e3.js";
import { c as normalizeOptionalString } from "./string-coerce-BdEutqX5.js";
import {
  i as createWindowsOutputDecoder,
  r as spawnWithFallback,
...
async function createChildAdapter(params) {
  ...
  if (stdinMode === "inherit") options.stdio = ["inherit", "pipe", "pipe"];
  else options.stdio = ["pipe", "pipe", "pipe"];
