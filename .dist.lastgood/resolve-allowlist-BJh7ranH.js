import { a as mapAllowlistResolutionInputs } from "./allow-from-BNON_Q4N.js";
...
async function resolveMSTeamsChannelAllowlist(params) {
  ...
  return await mapAllowlistResolutionInputs({
    ...
    mapInput: async (input) => {
      ...
      const teamId =
        teamChannels
          .find((ch) => normalizeOptionalLowercaseString(ch.displayName) === "general")
          ?.id?.trim() || graphTeamId;
      if (!channel)
        return {
          input,
...
//#endregion
export {
  parseMSTeamsTeamChannelInput as a,
  resolveMSTeamsUserAllowlist as c,
  parseMSTeamsConversationId as i,
  normalizeMSTeamsMessagingTarget as n,
  parseMSTeamsTeamEntry as o,
  normalizeMSTeamsUserInput as r,
  resolveMSTeamsChannelAllowlist as s,
  looksLikeMSTeamsTargetId as t,
};
