import {
  o as buildConfiguredAcpSessionKey,
  r as resolveConfiguredBindingRecord,
  s as normalizeBindingConfig,
} from "./binding-registry-CM9LsNMd.js";
import { n as listAcpBindings } from "./bindings-CWpQqxjp.js";
...
function resolveEffectiveResetTargetSessionKey(params) {
  ...
  const activeAcpSessionKey =
    activeSessionKey && isAcpSessionKey(activeSessionKey) ? activeSessionKey : void 0;
