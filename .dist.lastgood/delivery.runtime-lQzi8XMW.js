...
import {
  ...
  c as projectOutboundPayloadPlanForJson,
  i as formatOutboundPayloadLog,
  r as createOutboundPayloadPlan,
  t as deliverOutboundPayloads,
  u as projectOutboundPayloadPlanForOutbound,
} from "./deliver-Dz9Dpt9U.js";
import "./plugins-Dn-pJrhh.js";
import { n as isNestedAgentLane } from "./lanes-CEV2BIp0.js";
import { r as isInternalMessageChannel } from "./message-channel-GRZIhFYD.js";
...
async function deliverAgentCommandResult(params) {
  ...
  const outboundPayloadPlan = createOutboundPayloadPlan(
    deliver && !isInternalMessageChannel(deliveryChannel)
