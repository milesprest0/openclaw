...
function addCommandDescriptorsToProgram(
  program,
  descriptors,
...
//#endregion
export {
  sanitizeCommandDescriptorDescription as C,
  isNodeRuntime as D,
  isBunRuntime as E,
  normalizeCommandDescriptorName as S,
  isValueToken as T,
  getCoreCliCommandDescriptors as _,
  getPositiveIntFlagValue as a,
  addCommandDescriptorsToProgram as b,
  hasFlag as c,
  isRootHelpInvocation as d,
  isRootVersionInvocation as f,
  loadPrivateQaCliModule as g,
  getSubCliEntries as h,
  getFlagValue as i,
  hasRootVersionAlias as l,
  getSubCliCommandsWithSubcommands as m,
  getCommandPathWithRootOptions as n,
  getPrimaryCommand as o,
  shouldMigrateStateFromPath as p,
  getCommandPositionalsWithRootOptions as r,
  getVerboseFlag as s,
  buildParseArgv as t,
  isHelpOrVersionInvocation as u,
  getCoreCliCommandNames as v,
  consumeRootOptionToken as w,
  collectUniqueCommandDescriptors as x,
  getCoreCliCommandsWithSubcommands as y,
};
