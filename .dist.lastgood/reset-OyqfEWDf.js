...
import { p as resolveLoadedSessionThreadInfo } from "./store-load-BSFLPYqQ.js";
import {
...
function resolveSessionResetPolicy(params) {
  ...
  const typeReset = params.resetOverride
    ...
    : (sessionCfg?.resetByType?.[params.resetType] ??
      (params.resetType === "direct" ? sessionCfg?.resetByType?.dm : void 0));
...
function evaluateSessionFreshness(params) {
  ...
  const idleExpiresAt =
    params.policy.idleMinutes != null && params.policy.idleMinutes > 0
      ? lastInteractionAt + params.policy.idleMinutes * 6e4
      : void 0;
...
//#endregion
export {
  DEFAULT_RESET_MODE as a,
  resolveSessionResetPolicy as c,
  resolveThreadFlag as i,
  resolveChannelResetConfig as n,
  evaluateSessionFreshness as o,
  resolveSessionResetType as r,
  resolveDailyResetAtMs as s,
  isThreadSessionKey as t,
};
