...
import {
  a as emitAgentItemEvent,
  i as emitAgentEvent,
  n as emitAgentApprovalEvent,
  o as emitAgentPatchSummaryEvent,
  r as emitAgentCommandOutputEvent,
} from "./agent-events-c6-2eZvI.js";
import { n as resolveAgentHarnessPolicy } from "./agent-runtime-metadata-BO_xM0qW.js";
import { m as resolveSessionAgentIds } from "./agent-scope-9AmhTwki.js";
import { a as resolveAgentDir } from "./agent-scope-config-CXZGyKMl.js";
import {
  a as stripDowngradedToolCallText,
  l as hasOrphanReasoningCloseBoundary,
} from "./assistant-visible-text-DnuPT-bL.js";
import {
  a as prependSystemPromptAddition,
  c as resolvePromptBuildHookResult,
  d as shouldInjectHeartbeatPrompt,
  f as shouldWarnOnOrphanedUserRepair,
  i as mergeOrphanedTrailingUserPrompt,
  l as resolvePromptModeForSession,
  n as buildAfterTurnRuntimeContextFromUsage,
  o as resolveAttemptFsWorkspaceOnly,
  s as resolveAttemptPrependSystemContext,
  t as buildAfterTurnRuntimeContext,
  u as resolvePromptSubmissionSkipReason,
} from "./attempt.prompt-helpers-CJM25NoR.js";
import {
  i as shouldPersistCompletedBootstrapTurn,
  n as composeSystemPromptWithHookContext,
  o as shouldUseOpenAIWebSocketTransportForAttempt,
  r as resolveAttemptSpawnWorkspaceDir,
  t as appendAttemptCacheTtlIfNeeded,
} from "./attempt.thread-helpers-CPhQxp3A.js";
import {
  S as isMessagingToolSendAction,
  _ as isToolResultError,
  b as sanitizeToolResult,
  d as runAgentCleanupStep,
  f as extractMessagingToolSend,
  g as filterToolResultMediaUrls,
  h as extractToolResultText,
  ...
  p as extractToolErrorMessage,
  r as bootstrapHarnessContextEngine,
  t as buildEmbeddedAttemptToolRunContext,
  u as normalizeAgentRuntimeTools,
  v as isToolResultTimedOut,
  x as isMessagingTool,
  y as sanitizeToolArgs,
} from "./attempt.tool-run-context-DNKKeHVU.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BuUFK0A0.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-mt5Zw5l1.js";
import "./defaults-4m7JJmD2.js";
import "./config-CMOdcWpc.js";
import {
  a as buildBootstrapPromptWarningNotice,
  i as buildBootstrapPromptWarning,
  o as buildBootstrapTruncationReportMeta,
  r as buildBootstrapInjectionStats,
  t as analyzeBootstrapBudget,
} from "./bootstrap-budget-BBGdGMkr.js";
import {
  c as resolveHeartbeatPromptForSystemPrompt,
  i as makeBootstrapWarn,
  n as buildBootstrapContextForFiles,
  o as resolveBootstrapFilesForRun,
  r as hasCompletedBootstrapTurn,
  s as resolveContextInjectionMode,
  t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE,
} from "./bootstrap-files-C8WUuJVf.js";
import {
  n as extractTextFromChatContent,
  t as coerceChatContentText,
} from "./chat-content-DcUT1lrD.js";
import {
  a as isNonFinalAssistantMessage,
  l as resolveAssistantMessagePhase,
  s as parseAssistantTextSignature,
} from "./chat-message-content-BLockgKs.js";
import {
  _ as createPreparedEmbeddedPiSettingsManager,
  g as formatContextLimitTruncationNotice,
  p as truncateOversizedToolResultsInSessionManager,
  u as resolveLiveToolResultMaxChars,
} from "./compaction-B6HM89B8.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bikq46qJ.js";
import {
  $ as isZeroUsageEmptyStopAssistantTurn,
  A as buildEmbeddedMessageActionDiscoveryInput,
  B as resolveCompactionTimeoutMs,
  C as resolveEmbeddedAgentStreamFn,
  D as normalizeAssistantReplayContent,
  E as trackSessionManagerAccess,
  G as collectRuntimeChannelCapabilities,
  H as readLastCacheTtlTimestamp,
  K as createClientToolNameConflictError,
  M as limitHistoryTurns,
  N as buildEmbeddedExtensionFactories,
  O as sanitizeSessionHistory,
  Q as dropThinkingBlocks,
  S as resolveEmbeddedAgentBaseStreamFn,
  T as prewarmSessionFile,
  U as guardSessionManager,
  V as isCacheTtlEligibleProvider,
  W as repairSessionFileIfNeeded,
  X as assessLastAssistantMessage,
  Y as toClientToolDefinitions,
  Z as dropReasoningFromHistory,
  _ as applySystemPromptOverrideToSession,
  b as describeEmbeddedAgentStreamStrategy,
  c as shouldRotateCompactionTranscript,
  d as mapThinkingLevel,
  et as releaseWsSession,
  f as splitSdkTools,
  g as toSessionToolAllowlist,
  h as collectRegisteredToolNames,
  i as parseHistoryFrozenWatermark,
  j as getHistoryLimitFromSessionKey,
  k as validateReplayTurns,
  m as collectAllowedToolNames,
  n as applyContextBudgetGuard,
  o as rotateTranscriptAfterCompaction,
  p as PI_RESERVED_TOOL_NAMES,
  q as findClientToolNameConflicts,
  rt as isReasoningTagProvider,
  t as HISTORY_FROZEN_WATERMARK_SESSION_KEY,
  tt as buildStreamErrorAssistantMessage,
  u as flushPendingToolResultsAfterIdle,
  v as buildEmbeddedSystemPrompt,
  w as resolveEmbeddedRunSkillEntries,
  x as resolveEmbeddedAgentApiKey,
  y as createSystemPromptOverride,
} from "./context-budget-CZcqCu6a.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-De8KJkwC.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DFTSvtud.js";
import { p as parseReplyDirectives } from "./deliver-Dz9Dpt9U.js";
import {
  n as hasCommittedMessagingToolDeliveryEvidence,
  r as hasMessagingToolDeliveryEvidence,
} from "./delivery-evidence-BmHJMNAW.js";
import {
  i as diagnosticProviderRequestIdHash,
  n as diagnosticErrorFailureKind,
  t as diagnosticErrorCategory,
} from "./diagnostic-error-metadata-XbXBF9cO.js";
import {
  f as createDiagnosticTraceContextFromActiveScope,
  i as emitTrustedDiagnosticEvent,
  m as freezeDiagnosticTraceContext,
  p as formatDiagnosticTraceparent,
  u as createChildDiagnosticTraceContext,
} from "./diagnostic-events-9isI4hMq.js";
import {
  a as sanitizeSupportSnapshotValue,
  t as redactPathForSupport,
} from "./diagnostic-support-redaction-DSwEKsc9.js";
import { t as parseInlineDirectives } from "./directive-tags-91V02E1x.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-C8ABbQjT.js";
import {
...
} from "./env-overrides-DyQKAXcm.js";
import {
  a as formatAssistantErrorText,
  l as isCloudCodeAssistFormatError,
  t as classifyFailoverReason,
} from "./errors-D66M8xLa.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import {
  a as resolvePreparedExtraParams,
  i as resolveExtraParams,
  n as resolveAgentTransportOverride,
  r as resolveExplicitSettingsTransport,
  t as applyExtraParamsToAgent,
} from "./extra-params-DDMcNhQe.js";
import { a as isTimeoutError } from "./failover-error-Dx3vQAkt.js";
import { r as parseFenceSpans } from "./fences-CBcL-2k8.js";
import { d as parseBooleanValue } from "./frontmatter-BAgsU2iK.js";
import { t as parseGeminiAuth } from "./gemini-auth-BbHwDyVg.js";
import { n as resolveCommitHash } from "./git-commit-r_CW6ORc.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-C4iUAxlI.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-B7WZaEWz.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-9lfm3C_j.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-Dx8N2J-j.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CPo3uYXb.js";
import {
  l as fireAndForgetBoundedHook,
  s as resolveBlockMessage,
  t as getGlobalHookRunner,
} from "./hook-runner-global-DzzZF3B1.js";
import { t as detectAndLoadPromptImages } from "./images-CKpfqPx1.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-OI5EnRxZ.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-DfXSY94W.js";
import { X as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-CEQSCTGy.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import { t as log$4 } from "./logger-Ce0PtXjG.js";
import { t as getMachineDisplayName } from "./machine-name-Dpy3pFjR.js";
import { u as normalizeMessageChannel } from "./message-channel-GRZIhFYD.js";
import { m as MAX_IMAGE_BYTES } from "./mime-CSQ-Gv-M.js";
import { t as buildModelAliasLines } from "./model-alias-lines-NJdYRRCT.js";
import { u as resolveModelAuthMode } from "./model-auth-Do8Bfz1M.js";
import {
  f as buildApiErrorObservationFields,
  p as buildTextObservationFields,
} from "./model-fallback-fY3p6tiZ.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-CyVXHdEG.js";
import "./tts-DRYN86wU.js";
import {
  g as sanitizeTransportPayloadText,
  p as mergeTransportHeaders,
  v as buildGuardedModelFetch,
} from "./openai-transport-stream-BLrUwHeX.js";
import {
  a as resolveToolLoopDetectionConfig,
  b as isEmbeddedMode,
  v as isStrictAgenticSupportedProviderModel,
  y as stripProviderPrefix,
} from "./openclaw-tools-6wQ_ahnn.js";
import { t as resolveOsSummary } from "./os-summary-D86LrseF.js";
import { r as splitMediaFromOutput } from "./parse-DfFv_gEu.js";
...
import {
  ...
  n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES,
  o as resolveTrajectoryPointerOpenFlags,
} from "./paths-DISbbASd.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BY3xno4q.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-h3WW1aOv.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-_btntJtc.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CsOxWf1T.js";
import {
  a as isMessagingToolDuplicateNormalized,
  c as downgradeOpenAIFunctionCallReasoningPairs,
  g as resolveBootstrapTotalMaxChars,
  h as resolveBootstrapPromptTruncationWarningMode,
  l as downgradeOpenAIReasoningBlocks,
  m as resolveBootstrapMaxChars,
  n as validateGeminiTurns,
  o as normalizeTextForComparison,
  t as validateAnthropicTurns,
} from "./pi-embedded-helpers-BhGvpMlL.js";
import {
...
import {
  a as resolveEffectiveCompactionMode,
  i as isSilentOverflowProneModel,
  n as applyPiAutoCompactionGuard,
  r as applyPiCompactionSettingsFromConfig,
} from "./pi-settings-DhiihpH7.js";
import { t as createOpenClawCodingTools } from "./pi-tools-Xm5nmxui.js";
import {
  _ as resolveChannelReactionGuidance,
  h as resolveChannelMessageToolHints,
  m as listChannelSupportedActions,
...
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-C2hpt3LY.js";
import {
  i as createStreamIteratorWrapper,
  r as wrapStreamFnTextTransforms,
} from "./plugin-text-transforms-BqZpOTxV.js";
import {
  n as shouldPreemptivelyCompactBeforePrompt,
  t as PREEMPTIVE_OVERFLOW_ERROR_TEXT,
} from "./preemptive-compaction-DAy3SEWx.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-SP5uub3O.js";
import { r as normalizeProviderId } from "./provider-id-CG9pXYPs.js";
import {
  n as extractModelCompat,
  o as resolveToolCallArgumentsEncoding,
} from "./provider-model-compat-DIuSGYN-.js";
import {
  D as shouldPreserveThinkingBlocks,
  _ as streamWithPayloadPatch,
} from "./provider-model-shared-CmD-CscC.js";
import {
  F as resolveProviderTextTransforms,
  K as transformProviderSystemPrompt,
  P as resolveProviderSystemPromptContribution,
} from "./provider-runtime-DueHRTen.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CJoAN41d.js";
import "./pi-bundle-mcp-tools-D10hXSOR.js";
import {
  T as visitObjectContentBlocks,
  o as createHtmlEntityToolCallArgumentDecodingWrapper,
} from "./provider-stream-shared-wxMuvsGy.js";
import {
  b as isGooglePromptCacheEligible,
  x as resolveCacheRetention,
} from "./proxy-stream-wrappers-CGPIaW-n.js";
import { n as redactConfigObject } from "./redact-snapshot-DiercLAY.js";
import { a as listRegisteredAgentHarnesses } from "./registry-D11nh-V3.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-sQP5dNFn.js";
import { t as appendRegularFile } from "./regular-file-CoVHB-2u.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-D38mxo21.js";
import {
...
import {
  ...
  p as updateActiveEmbeddedRunSnapshot,
...
import {
  a as resolveRuntimeContextPromptParts,
  i as queueRuntimeContextForNextTurn,
  n as buildRuntimeContextSystemContext,
  t as buildCurrentTurnPromptContextSuffix,
} from "./runtime-context-prompt-BQv5qtMH.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-r0KsiafK.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-DhPc_YW4.js";
import { o as resolveSandboxContext } from "./sandbox-Cz0C2Qt-.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-D5XM2Jco.js";
import {
  f as stableStringify$1,
  h as parseExecApprovalResultText,
} from "./sanitize-user-facing-text-Cgbm6W76.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-B3KPN8Ee.js";
import {
  a as stripToolResultDetails,
  i as sanitizeToolUseResultPairing,
} from "./session-transcript-repair-BjkUYNeL.js";
import {
  c as resolveSessionWriteLockAcquireTimeoutMs,
  r as acquireSessionWriteLock,
  s as resolveSessionLockMaxHoldFromTimeout,
} from "./session-write-lock-DjdS_616.js";
import { t as detectRuntimeShell } from "./shell-utils-BaRdb5e3.js";
import {
  c as updateSessionStoreEntry,
  i as runQuotaSuspensionMaintenance,
...
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-Cq7GvFY6.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-B96oY8Cm.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-DaMSfBYL.js";
import "./tool-loop-detection-Drrg3FJa.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B5riyWdi.js";
import { t as appendAgentBootstrapSystemPromptSupplement } from "./system-prompt-vWC2MZis.js";
import { t as resolveAgentTimeoutMs } from "./timeout-06zKgWsk.js";
import {
  a as isSilentReplyText,
  i as isSilentReplyPrefixText,
  n as SILENT_REPLY_TOKEN,
  o as startsWithSilentToken,
  r as isSilentReplyPayloadText,
  s as stripLeadingSilentToken,
} from "./tokens-DWz8lWRf.js";
import {
  o as hasUnredactedSessionsSpawnAttachments,
  r as sanitizeToolCallIdsForCloudCodeAssist,
  t as extractToolCallsFromAssistant,
} from "./tool-call-id-Cdqs2Wrs.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-D8ZmIpdW.js";
import { t as formatToolAggregate } from "./tool-meta-DI7YbTn_.js";
import {
  i as isSameToolMutationAction,
  n as isLikelyMutatingToolName,
  t as buildToolMutationState,
} from "./tool-mutation-DOGn06lj.js";
import {
  c as expandPolicyWithPluginGroups,
  i as buildPluginToolGroups,
} from "./tool-policy-_3QUoIEC.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-c6IjbWPy.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-DsbREhoR.js";
import {
  n as resolveTranscriptPolicy,
  o as collectTextContentBlocks,
  r as shouldAllowProviderOwnedThinkingReplay,
  s as supportsModelTools,
} from "./tool-result-middleware-CJ4A8Wvz.js";
import { i as getPluginToolMeta } from "./tools-DcY_52BH.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-CfX4V8Mc.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-B6YlI8nn.js";
import {
...
import {
  a as makeZeroUsageSnapshot,
  i as hasNonzeroUsage,
  o as normalizeUsage,
  s as providerFamily,
} from "./usage-BOaLms3p.js";
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-BGRcpLKt.js";
import { n as VERSION } from "./version-BZr74W_5.js";
import {
  d as isWorkspaceBootstrapPending,
  n as DEFAULT_BOOTSTRAP_FILENAME,
} from "./workspace-DvzHmVcJ.js";
import { s as resolveSkillsPromptForRun } from "./workspace-FSRlf91o.js";
...
function getQueuedFileWriter(writers, filePath, options = {}) {
  ...
  const writer = {
    ...
    write: (line) => {
      ...
      if (options.maxQueuedBytes !== void 0 && queuedBytes + lineBytes > options.maxQueuedBytes)
        return "dropped";
      queuedBytes += lineBytes;
      queue = queue
        .then(() => ready)
        .then(() => (options.yieldBeforeWrite ? waitForImmediate() : void 0))
...
function createTrajectoryRuntimeRecorder(params) {
  ...
  const writer =
    params.writer ??
    getQueuedFileWriter(writers$2, filePath, {
...
const execApprovalReplyModuleLoader = createLazyImportLoader(
  () => import("./exec-approval-reply-VCRsOfrs.js"),
);
const hookRunnerGlobalModuleLoader = createLazyImportLoader(
  () => import("./hook-runner-global-D0QzDMlK.js"),
);
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CuaBUACX.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(
  () => import("./pi-tools.before-tool-call-CfYVgoA9.js"),
);
 ...
 * is side-effecting.
 */
function allActiveToolExecutionsReadOnly(runId) {
  const prefix = `${runId}:`;
  let sawActive = false;
  for (const [key, record] of toolStartData.entries()) {
    if (!key.startsWith(prefix)) continue;
    sawActive = true;
    if (!isReadOnlyToolName(record.toolName)) return false;
  }
  return sawActive;
}
...
function capLiveExecResult(result) {
  ...
  if (!execDetails || !("aggregated" in execDetails) || typeof execDetails.aggregated !== "string")
    return result;
...
function readApplyPatchSummary(result) {
  ...
  return {
    added: Array.isArray(summary.added)
      ? summary.added.filter((entry) => typeof entry === "string")
      : [],
    modified: Array.isArray(summary.modified)
      ? summary.modified.filter((entry) => typeof entry === "string")
      : [],
    deleted: Array.isArray(summary.deleted)
...
function collectMessagingMediaUrlsFromRecord(record) {
  ...
  if (Array.isArray(mediaUrls))
    for (const mediaUrl of mediaUrls) pushUniqueMediaUrl(urls, seen, mediaUrl);
  return urls;
}
...
async function emitToolResultOutput(params) {
  ...
  const hasStructuredMedia = Boolean(
    ...
    typeof (result.details?.media ?? void 0) === "object" &&
...
function handleToolExecutionStart(ctx, evt) {
  const continueAfterBlockReplyFlush = () => {
    ...
    if (isPromiseLike$1(onBlockReplyFlushResult))
  ...
  if (isPromiseLike$1(flushBlockReplyBufferResult))
...
async function handleToolExecutionEnd(ctx, evt) {
  ...
  if (hookRunnerAfter?.hasHooks("after_tool_call")) {
    ...
    const afterToolCallArgs =
      adjustedArgs && typeof adjustedArgs === "object" ? adjustedArgs : startArgs;
...
const hasRenderableContent = (parsed) =>
...
function buildAttemptReplayMetadata(params) {
  const hadPotentialSideEffects =
    params.toolMetas.some((t) => isLikelyMutatingToolName(t.toolName)) ||
...
function hasOnlySilentAssistantReply(assistantTexts) {
  ...
  return (
    ...
    nonEmptyTexts.every((text) => isSilentReplyPayloadText(text, "NO_REPLY"))
  );
}
...
function hasTrailingSilentToolResult(messages) {
  for (let i = messages.length - 1; i >= 0; i -= 1) {
    ...
    if (isToolResultRole(role)) {
      ...
      return isSilentReplyText(
        readMessageTextContent(message) ?? readToolResultAggregatedText(message),
        SILENT_REPLY_TOKEN,
      );
    }
...
function resolveRunLivenessState(params) {
  ...
  if (params.attempt.promptErrorSource === "compaction" || params.attempt.timedOutDuringCompaction)
    return "paused";
...
function hasStructuredPlanningOnlyFormat(text) {
  ...
  return (
    (PLANNING_ONLY_HEADING_RE.test(lines[0] ?? "") && hasPlanningCueLine) ||
...
function collectFencedJsonCandidates(text) {
  ...
  for (const match of text.matchAll(
    /```(?:json|tool|tool_call|function_call)?[^\n\r]*[\r\n]([\s\S]*?)```/gi,
  )) {
...
function isRegisteredToolName(toolName, registeredToolNames) {
  ...
  for (const registeredToolName of registeredToolNames)
    if (normalizeToolName(registeredToolName) === normalized) return true;
  return false;
}
...
function shouldSuppressAssistantVisibleOutput(params) {
  ...
  if (!suppressNonFinalAssistantText) return false;
...
function handleMessageUpdate(ctx, evt) {
  ...
  const assistantRecord =
    assistantEvent && typeof assistantEvent === "object" ? assistantEvent : void 0;
  ...
  if (shouldWithholdUnphasedAssistantStream) return;
  ...
  if (next) {
    ...
    const parsedStreamDirectives = mergeReplyDirectiveResults(
    ...
    if (shouldEmit) {
      ...
      if (ctx.params.onPartialReply && ctx.state.shouldEmitPartialReplies)
        ctx.params.onPartialReply(data);
    }
  }
  if (
...
function handleMessageEnd(ctx, evt) {
  ...
  const finalAssistantText =
    ctx.params.silentExpected && !isSilentReplyText(trimmedText, "NO_REPLY") ? "" : text;
  ...
  if (
    ...
    if (hasBufferedBlockReply && ctx.blockChunker?.hasBuffered()) {
      ...
      if (isPromiseLike$1(flushBlockReplyBufferResult))
        flushBlockReplyBufferResult.catch((err) => {
...
function handleCompactionEnd(ctx, evt) {
  ...
  if (hasResult && !wasAborted) {
    ...
    const tokensAfter =
      typeof evt.result === "object" && evt.result ? evt.result.tokensAfter : void 0;
...
function handleAgentEnd(ctx) {
  ...
  const replayInvalid =
    ctx.state.replayState.replayInvalid || incompleteTerminalAssistant ? true : void 0;
  ...
  if (isError && lastAssistant) {
    ...
    const safeErrorText =
      buildTextObservationFields(errorText, { provider: lastAssistant.provider }).textPreview ??
      "LLM request failed.";
  ...
  const flushPendingMediaAndChannel = () => {
    ...
    if (isPromiseLike$1(postMediaFlushResult))
  ...
  const emitLifecycleTerminalOnce = () => {
    ...
    if (isPromiseLike$1(beforeLifecycleTerminal))
  ...
  try {
    const flushBlockReplyBufferResult = ctx.flushBlockReplyBuffer();
    finalizeAgentEnd();
    const flushPendingMediaAndChannelResult = isPromiseLike$1(flushBlockReplyBufferResult)
      ? Promise.resolve(flushBlockReplyBufferResult).then(() => flushPendingMediaAndChannel())
      : flushPendingMediaAndChannel();
    if (isPromiseLike$1(flushPendingMediaAndChannelResult))
...
function subscribeEmbeddedPiSession(params) {
  ...
  const state = {
    ...
    suppressNonFinalAssistantText: params.suppressNonFinalAssistantText ?? true,
    deltaBuffer: "",
    blockBuffer: "",
    blockState: {
      thinking: false,
  ...
  const emitBlockReplySafely = (payload, options) => {
    ...
    try {
      const taggedPayload =
        options?.assistantMessageIndex !== void 0
  ...
  const resolveAssistantUsage = (usageLike) => {
    ...
    if (usageLike && typeof usageLike === "object") {
      ...
      const partial =
        record.partial && typeof record.partial === "object" ? record.partial : void 0;
      const message =
        record.message && typeof record.message === "object" ? record.message : void 0;
      candidates.push(
        record.usage,
        record.timings,
        record.partial,
  ...
  const emitToolSummary = (toolName, meta) => {
    emitToolResultMessage(
      toolName,
      formatToolAggregate(toolName, meta ? [meta] : void 0, { markdown: useMarkdown }),
    );
  };
  ...
  const emitBlockChunk = (text, options) => {
    ...
    if (
      isMessagingToolDuplicateNormalized(
        normalizeTextForComparison(chunk),
        messagingToolSentTextsNormalized,
      )
    ) {
      log$2.debug(
  ...
  return {
    ...
    getHeartbeatToolResponse: () =>
      state.heartbeatToolResponse ? { ...state.heartbeatToolResponse } : void 0,
...
function resolveManagedSystemPrompt(systemPrompt) {
  const sanitized = sanitizeTransportPayloadText(
...
function readLatestGooglePromptCacheEntry(sessionManager, matchKey) {
  try {
    ...
    for (let i = entries.length - 1; i >= 0; i -= 1) {
      ...
      if (
        buildGooglePromptCacheMatchKey({
...
async function ensureGooglePromptCache(params, deps) {
  ...
  if (latestEntry?.status === "ready" && latestEntry.cachedContent) {
    ...
    if (!(expiresAt !== null && expiresAt <= now)) {
      if (!(expiresAt !== null && expiresAt - now <= refreshWindowMs))
...
function emitGeminiImplicitCacheTelemetry(params) {
  if (params.provider !== "openrouter") return null;
  if (!params.modelId.toLowerCase().includes("google/gemini")) return null;
...
function replaceToolResultText(msg, text) {
  ...
  const replacementContent =
    typeof content === "string" || content === void 0
      ? text
      : [
          {
            type: "text",
  ...
  if (!rawText)
    return replaceToolResultText(
      ...
      formatContextLimitTruncationNotice(
        Math.max(1, estimateBudgetToTextBudget(Math.max(estimatedChars - maxChars, 1))),
      ),
    );
...
function hasNewToolResultAfterFence(params) {
  for (const message of params.messages.slice(params.prePromptMessageCount))
    if (isToolResultMessage(message)) return true;
  return false;
}
...
function installToolResultContextGuard(params) {
  ...
  const maxContextChars = Math.max(
    1024,
    Math.floor(contextWindowTokens * 4 * PREEMPTIVE_OVERFLOW_RATIO),
  );
  const maxSingleToolResultChars = Math.max(
    1024,
    Math.floor(contextWindowTokens * 2 * SINGLE_TOOL_RESULT_CONTEXT_SHARE),
  );
  const mutableAgent = params.agent;
  const originalTransformContext = mutableAgent.transformContext;
  let lastSeenLength = null;
  mutableAgent.transformContext = async (messages, signal) => {
    ...
    if (params.midTurnPrecheck?.enabled) {
      ...
      if (
        ...
        log$4.debug(
          `[context-overflow-midturn-precheck] tool-result-guard check route=${precheck.route} messages=${contextMessages.length} prePromptMessageCount=${prePromptMessageCount} estimatedPromptTokens=${precheck.estimatedPromptTokens} promptBudgetBeforeReserve=${precheck.promptBudgetBeforeReserve} overflowTokens=${precheck.overflowTokens}`,
        );
        if (request) {
...
function resolveCodingToolConstructionPlanForAllowlist(toolsAllow) {
  ...
  const normalized = expandToolGroups(toolsAllow)
...
//#endregion
//#region src/agents/pi-embedded-runner/run/thinking-eviction-plan.ts
function resolveThinkingEvictionPlan(params) {
...
function findCurrentAttemptAssistantMessage(params) {
  ...
  if (!latest) return;
  return latest.index >= Math.max(0, params.prePromptMessageCount) ? latest.message : void 0;
}
function findLatestAssistantMessage(messagesSnapshot) {
...
function hasProviderOrModelTag(assistant) {
  if (!assistant) return false;
  const maybeAssistant = assistant;
  return [
...
function resolveFamilyFromAssistantMessage(assistant) {
  if (!assistant) return;
  const maybeAssistant = assistant;
  const provider =
  ...
  return providerFamily([provider, model].filter((value) => Boolean(value)).join("/"));
}
...
function dropCacheFields(usage) {
  if (!usage) return;
  return {
    ...usage,
    cacheRead: void 0,
...
function resolveSafeLastCallUsage(params) {
  const usage = normalizeUsage(params.assistant?.usage);
  if (!usage) return;
  if (!(params.assistantIndex >= Math.max(0, params.prePromptMessageCount)))
    return dropCacheFields(usage);
  if (!hasProviderOrModelTag(params.assistant)) return usage;
  const assistantFamily = resolveFamilyFromAssistantMessage(params.assistant);
  const callFamily = resolveFamilyFromCallRef({
    provider: params.provider,
    model: params.model,
  });
...
function modelCallSizeTimingFields(state) {
  return {
    ...(state.requestPayloadBytes !== void 0
...
async function safeReturnIterator(iterator) {
  ...
  try {
    await Promise.race([
      Promise.resolve(returnResult).catch(() => void 0),
      new Promise((resolve) => {
...
function observeModelCallResult(result, eventBase, startedAt, state) {
  ...
  if (createIterator)
    return observeModelCallStream(result, createIterator, eventBase, startedAt, state);
  emitModelCallCompleted(eventBase, startedAt, state);
  return result;
}
...
function hasMeaningfulToolCallArgumentsInMessage(message, contentIndex) {
  ...
  return (
    ...
    Object.keys(typedBlock.arguments).length > 0
  );
}
...
function isReplaySafeThinkingTurn(content, allowedToolNames) {
  ...
  for (const block of content) {
    ...
    const resolvedName = resolveReplayToolCallName(
      typeof replayBlock.name === "string" ? replayBlock.name : "",
      toolCallId,
      allowedToolNames,
    );
...
function replayToolCallHasInput(block) {
  ...
  const hasArguments =
    "arguments" in block ? block.arguments !== void 0 && block.arguments !== null : false;
...
function isLocalProviderBaseUrl(baseUrl) {
  ...
  return (
    a === 127 ||
    a === 10 ||
    (a === 172 && b !== void 0 && b >= 16 && b <= 31) ||
    (a === 192 && b === 168) ||
    (a === 100 && b !== void 0 && b >= 64 && b <= 127)
  );
}
/**
...
function resolveLlmIdleTimeoutMs(params) {
  ...
  const clampImplicitTimeoutMs = (valueMs) =>
          ...
          return new Promise((_, reject) => {
            idleTimer = setTimeout(() => {
              const error = /* @__PURE__ */ new Error(
                `LLM idle timeout (${Math.floor(timeoutMs / 1e3)}s): no response from model`,
              );
              onIdleTimeout?.(error);
              reject(error);
            }, timeoutMs);
...
function sessionMessagesContainIdempotencyKey(messages, idempotencyKey) {
  return messages.some(
    (message) =>
      typeof message.idempotencyKey === "string" && message.idempotencyKey === idempotencyKey,
  );
}
...
function isMidTurnPrecheckAssistantError(message) {
  ...
  return (
    ...
    record.errorMessage === "Context overflow: prompt too large for the model (mid-turn precheck)."
  );
}
...
async function runEmbeddedAttempt(params) {
  ...
  try {
    const skillsSnapshotForRun =
      sandbox?.enabled && sandbox.workspaceAccess !== "rw" ? void 0 : params.skillsSnapshot;
    ...
    if (isRawModelRun && log$4.isEnabled("debug"))
      log$4.debug(
    ...
    const toolsRaw = !toolConstructionPlan.constructTools
      ...
      : (() => {
          const allTools = createOpenClawCodingTools({
            ...
            modelAuthMode: resolveModelAuthMode(params.model.provider, params.config, void 0, {
              workspaceDir: effectiveWorkspace,
            }),
    ...
    if (hookAdjustedBootstrapFiles.some((file) => file.name === "BOOTSTRAP.md" && !file.missing))
    ...
    const projectContextDietDiagnostics = [];
    ...
    try {
      ...
      const hadSessionFile = await fs$1
      ...
      const thinkingEvictionMode =
        params.config?.agents?.defaults?.experimental?.thinkingEviction ?? "off";
      const thinkingEvictionPlan = resolveThinkingEvictionPlan({
        mode: thinkingEvictionMode,
        evictionSafe: !shouldPreserveThinkingBlocks(params.model?.id ?? params.modelId),
      });
      ...
      const contextTokenBudgetForGuard = Math.max(
        1,
        Math.floor(
          params.contextTokenBudget ?? params.model.contextWindow ?? params.model.maxTokens ?? 2e5,
        ),
      );
      ...
      if (agentTransportOverride && activeSession.agent.transport !== agentTransportOverride) {
        ...
        log$4.debug(
          `embedded agent transport override: ${previousTransport} -> ${agentTransportOverride} (${params.provider}/${params.modelId})`,
        );
      }
      ...
      if (
        ...
        activeSession.agent.streamFn = (model, context, options) => {
          ...
          if (thinkingEvictionPlan.measure) {
            const evicted = dropReasoningFromHistory(sanitized);
            if (evicted !== sanitized) {
              ...
              log$4.info(
                `[thinking-eviction] mode=${thinkingEvictionMode} sessionKey=${params.sessionKey} provider=${params.provider}/${params.modelId} before=~${beforeEstTokens} after=~${afterEstTokens} savedTokens=~${savedTokens} savedPct=${savedPct.toFixed(1)}%`,
              );
              if (thinkingEvictionPlan.apply) sanitized = evicted;
            }
          }
      ...
      if (isOpenAIResponsesApi) {
        ...
        activeSession.agent.streamFn = (model, context, options) => {
          ...
          const sanitized = downgradeOpenAIFunctionCallReasoningPairs(
            downgradeOpenAIReasoningBlocks(messages),
          );
          if (sanitized === messages) return inner(model, context, options);
          return inner(
            model,
        ...
        abortTimer = setTimeout(
          () => {
            if (
              ...
              if (!isProbeSession)
                log$4.warn(
                  `embedded run timeout reached during compaction; extending deadline: runId=${params.runId} sessionId=${params.sessionId} extraMs=${compactionTimeoutMs}`,
                );
      ...
      try {
        ...
        if (leafEntry?.type === "message" && leafEntry.message.role === "user") {
          ...
          const orphanRepairMessage =
            `${orphanPromptMerge.removeLeaf ? (orphanPromptMerge.merged ? "Merged and removed" : "Removed already-queued") : "Preserved"} orphaned user message` +
        ...
        const effectiveTranscriptPrompt =
          params.transcriptPrompt === void 0
            ? void 0
            : isRawModelRun
        ...
        try {
          ...
          const persistBlockedBeforeAgentRun = async (block) => {
            ...
            try {
              ...
              log$4.warn(
                `before_agent_run block: failed to persist redacted user message: ${err?.message ?? String(err)}`,
              );
              return false;
            }
          };
          ...
          if (promptSkipReason) {
            ...
            if (promptSkipReason === "blank_user_prompt")
              log$4.warn(`embedded run prompt skipped: blank user prompt ${skipContext}`);
            else
              log$4.info(`embedded run prompt skipped: empty prompt/history/images ${skipContext}`);
          ...
          const contextBudgetGuard = (() => {
            try {
              ...
              log$4.warn(
                `[context-budget] guard failed open; using original transcript sessionKey=${params.sessionKey ?? params.sessionId} provider=${params.provider}/${params.modelId} error=${String(err)}`,
              );
              return {
                messages: activeSession.messages,
                estimatedTokens: 0,
            ...
            await updateSessionStoreEntry({
              ...
              update: async (entry) => {
                const previous = parseHistoryFrozenWatermark(
                  entry[HISTORY_FROZEN_WATERMARK_SESSION_KEY],
                );
                if (contextBudgetGuard.historyFrozenWatermark <= (previous ?? 0)) return null;
                return {
          ...
          if (contextBudgetGuard.applied) {
            ...
            log$4.info(
              `[context-budget] applied sessionKey=${params.sessionKey ?? params.sessionId} provider=${params.provider}/${params.modelId} estimated=${contextBudgetGuard.estimatedTokens} budget=${contextBudgetGuard.budgetBeforeReserve} imageBlocksPruned=${contextBudgetGuard.imageBlocksPruned} droppedTurns=${contextBudgetGuard.droppedTurns}`,
            );
            emitTrustedDiagnosticEvent({
          ...
          if (!skipPromptSubmission) {
            ...
            if (promptSubmission.runtimeOnly)
              await abortable$1(activeSession.prompt(promptForModel));
            else {
        ...
        try {
          ...
          if (
            ...
            if (!isProbeSession)
              log$4.warn(
                `compaction retry aggregate timeout (${COMPACTION_RETRY_AGGREGATE_TIMEOUT_MS}ms): proceeding with pre-compaction state runId=${params.runId} sessionId=${params.sessionId}`,
              );
          }
        } catch (err) {
        ...
        if (
          ...
          try {
            ...
            if (rotation.rotated) {
              ...
              log$4.info(
                `[compaction] rotated active transcript after automatic compaction (sessionKey=${params.sessionKey ?? params.sessionId})`,
              );
            }
          } catch (err) {
            log$4.warn("[compaction] automatic transcript rotation failed", {
      ...
      if (cacheObservabilityEnabled) {
        if (cacheBreak) {
          ...
          log$4.warn(
            `[prompt-cache] cache read dropped ${cacheBreak.previousCacheRead} -> ${cacheBreak.cacheRead} for ${params.provider}/${params.modelId} via ${streamStrategy}; ${changeSummary}`,
          );
    ...
    emitDiagnosticRunCompleted?.(
      ...
      promptError ?? /* @__PURE__ */ new Error("run exited before diagnostic completion"),
    );
    restoreSkillEnv?.();
  }
}
...
//#endregion
export {
  observeReplayMetadata as C,
  createEmbeddedRunReplayState as S,
  resolveReasoningOnlyRetryInstruction as _,
  formatEmbeddedRunStageSummary as a,
  resolveSilentToolResultReplyPayload as b,
  STRICT_AGENTIC_BLOCKED_TEXT as c,
  resolveAckExecutionFastPathInstruction as d,
  resolveAttemptReplayMetadata as f,
  resolvePlanningOnlyRetryLimit as g,
  resolvePlanningOnlyRetryInstruction as h,
  createEmbeddedRunStageTracker as i,
  extractPlanningOnlyPlanDetails as l,
  resolveIncompleteTurnPayloadText as m,
  runAgentHarnessAttempt as n,
  shouldWarnEmbeddedRunStageSummary as o,
  resolveEmptyResponseRetryInstruction as p,
  selectAgentHarness as r,
  resolveBootstrapMode as s,
  maybeCompactAgentHarnessSession as t,
  isLikelyExecutionAckPrompt as u,
  resolveReplayInvalidFlag as v,
  createTrajectoryRuntimeRecorder as w,
  shouldTreatEmptyAssistantReplyAsSilent as x,
  resolveRunLivenessState as y,
};
