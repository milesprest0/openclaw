import { t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-CaNC1eIn.js";
  ...
  if (options?.preferFirstProviderForSource) {
    ...
    if (providers) {
      for (const [providerName, provider] of Object.entries(providers))
        if (provider?.source === source) return providerName;
    }
  }
...
//#endregion
export {
  formatExecSecretRefIdValidationMessage as a,
  isValidSecretProviderAlias as c,
  validateExecSecretRefId as d,
  SINGLE_VALUE_FILE_REF_ID as i,
  resolveDefaultSecretProviderAlias as l,
  FILE_SECRET_REF_ID_INVALID_ESCAPE_JSON_SCHEMA_PATTERN as n,
  isValidExecSecretRefId as o,
  SECRET_PROVIDER_ALIAS_PATTERN as r,
  isValidFileSecretRefId as s,
  EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN as t,
  secretRefKey as u,
};
