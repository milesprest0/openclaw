...
import {
  f as buildPollResultsSummary,
  g as isPollStartType,
  h as isPollEventType,
  m as formatPollResultsAsText,
  p as formatPollAsText,
  v as parsePollStartContent,
  y as resolvePollReferenceEventId,
...
async function readAllPollRelations(client, roomId, pollEventId) {
  ...
  let nextBatch;
  do {
    const page = await client.getRelations(roomId, pollEventId, "m.reference", void 0, {
      from: nextBatch,
    });
...
//#endregion
export {
  resolveMatrixMessageBody as a,
  resolveMatrixPollRootEventId as c,
  resolveMatrixMessageAttachment as i,
  formatMatrixMediaUnavailableText as n,
  fetchMatrixPollMessageSummary as o,
  formatMatrixMessageText as r,
  fetchMatrixPollSnapshot as s,
  formatMatrixMediaTooLargeText as t,
};
