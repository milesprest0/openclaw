...
import { z } from "zod";
import {
  o as resolveInstalledPluginIndexStorePath,
...
import { t as discoverOpenClawPlugins } from "./discovery-bnS95tO3.js";
import { t as describePluginInstallSource } from "./install-source-info-CWCfqh7a.js";
import { n as saveJsonFile } from "./json-file-DY7oy2KR.js";
import { d as writeJson, l as tryReadJson, u as tryReadJsonSync } from "./json-files-DifBk3kt.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-DJ43wWua.js";
import { d as safeRealpathSync } from "./path-1liOXr_N.js";
import { t as isBlockedObjectKey } from "./prototype-keys-D58M68EP.js";
import { r as hasKind } from "./slots-DwcRLyGF.js";
import { o as resolveCompatibilityHostVersion } from "./version-BZr74W_5.js";
import { n as safeParseWithSchema } from "./zod-parse-CHWplZW-.js";
      ...
      entries: Object.fromEntries(
        Object.entries(normalized.entries)
          .flatMap(([pluginId, entry]) =>
            typeof entry.enabled === "boolean" ? [[pluginId, entry.enabled]] : [],
          )
...
function resolvePackageJsonRelativePath(rootDir, packageJsonPath) {
  ...
  return (path.relative(resolvedRootDir, packageJsonPath) || "package.json")
    .split(path.sep)
    .join("/");
}
...
function setCurrentPluginMetadataSnapshotState(
  snapshot,
  configFingerprint,
...
function parseInstalledPluginIndex(value) {
  ...
  const installRecords =
    ...
    copySafeInstallRecords(extractPluginInstallRecordsFromInstalledPluginIndex(parsed)) ??
    {};
  return {
...
async function readPersistedInstalledPluginIndex(options = {}) {
  return parseInstalledPluginIndex(
    await tryReadJson(resolveInstalledPluginIndexStorePath(options)),
  );
}
...
//#endregion
export {
  resolveInstalledPluginIndexPolicyHash as _,
  refreshPersistedInstalledPluginIndexSync as a,
  getCurrentPluginMetadataSnapshotState as c,
  isInstalledPluginEnabled as d,
  loadInstalledPluginIndex as f,
  isPluginEnabledByDefaultForPlatform as g,
  extractPluginInstallRecordsFromInstalledPluginIndex as h,
  refreshPersistedInstalledPluginIndex as i,
  setCurrentPluginMetadataSnapshotState as l,
  hasOptionalMissingPluginManifestFile as m,
  readPersistedInstalledPluginIndex as n,
  writePersistedInstalledPluginIndex as o,
  collectPluginManifestCompatCodes as p,
  readPersistedInstalledPluginIndexSync as r,
  clearCurrentPluginMetadataSnapshotState as s,
  inspectPersistedInstalledPluginIndex as t,
  getInstalledPluginRecord as u,
  fileSignatureMatches as v,
  hashJson as y,
};
