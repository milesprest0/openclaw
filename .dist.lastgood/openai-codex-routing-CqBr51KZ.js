...
import { t as normalizeEmbeddedAgentRuntime } from "./runtime-Bw2flyqr.js";
...
function hasOpenAICodexAuthProfileOverride(value) {
  return (
    typeof value === "string" &&
    normalizeOptionalLowercaseString(value)?.startsWith(`openai-codex:`) === true
  );
}
function shouldRouteOpenAIPiThroughCodexAuthProvider(params) {
  if (
    ...
    return false;
  if (normalizeEmbeddedAgentRuntime(params.agentHarnessId ?? params.harnessRuntime) !== "pi")
    return false;
...
//#endregion
export {
  openAIProviderUsesCodexRuntimeByDefault as a,
  modelSelectionShouldEnsureCodexPlugin as i,
  isOpenAICodexProvider as n,
  resolveOpenAIRuntimeProviderForPi as o,
  listOpenAIAuthProfileProvidersForAgentRuntime as r,
  shouldRouteOpenAIPiThroughCodexAuthProvider as s,
  OPENAI_CODEX_PROVIDER_ID as t,
};
