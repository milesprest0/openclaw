...
import { o as normalizeBaseUrl } from "./provider-request-config-B-kAAqy2.js";
...
async function runComfyWorkflow(params) {
  ...
  const promptId = normalizeOptionalString(
    (
      await readJsonResponse({
  ...
  const historyEntry = extractHistoryEntry(
    mode === "cloud"
      ? await (async () => {
...
//#endregion
export {
  runComfyWorkflow as a,
  isComfyCapabilityConfigured as i,
  _setComfyFetchGuardForTesting as n,
  getComfyConfig as r,
  DEFAULT_COMFY_MODEL as t,
};
