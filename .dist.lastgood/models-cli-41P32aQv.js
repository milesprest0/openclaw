import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-Ce4lxCq8.js";
...
function registerModelsCli(program) {
  ...
  models
    ...
    .action(async (opts) => {
      await runModelsCommand(async () => {
        const { modelsListCommand } = await import("./list.list-command-CRrxHVw0.js");
  ...
  models
    ...
    .action(async (model, _opts, command) => {
      ...
      await runModelsCommand(async () => {
        const { modelsSetCommand } = await import("./set-WVwOdKXC.js");
  ...
  models
    ...
    .action(async (model, _opts, command) => {
      ...
      await runModelsCommand(async () => {
        const { modelsSetImageCommand } = await import("./set-image-xD4v9k4K.js");
  ...
  aliases
    ...
    .action(async (opts) => {
      await runModelsCommand(async () => {
        const { modelsAliasesListCommand } = await import("./aliases-DJBwdgUO.js");
  ...
  aliases
    ...
    .action(async (alias, model) => {
      await runModelsCommand(async () => {
        const { modelsAliasesAddCommand } = await import("./aliases-DJBwdgUO.js");
  ...
  aliases
    ...
    .action(async (alias) => {
      await runModelsCommand(async () => {
        const { modelsAliasesRemoveCommand } = await import("./aliases-DJBwdgUO.js");
  ...
  fallbacks
    ...
    .action(async (opts) => {
      await runModelsCommand(async () => {
        const { modelsFallbacksListCommand } = await import("./fallbacks-L4nmtLEW.js");
  ...
  fallbacks
    ...
    .action(async (model) => {
      await runModelsCommand(async () => {
        const { modelsFallbacksAddCommand } = await import("./fallbacks-L4nmtLEW.js");
  ...
  fallbacks
    ...
    .action(async (model) => {
      await runModelsCommand(async () => {
        const { modelsFallbacksRemoveCommand } = await import("./fallbacks-L4nmtLEW.js");
  ...
  fallbacks
    ...
    .action(async () => {
      await runModelsCommand(async () => {
        const { modelsFallbacksClearCommand } = await import("./fallbacks-L4nmtLEW.js");
  ...
  imageFallbacks
    ...
    .action(async (opts) => {
      await runModelsCommand(async () => {
        const { modelsImageFallbacksListCommand } = await import("./image-fallbacks-CFP4ijnU.js");
  ...
  imageFallbacks
    ...
    .action(async (model) => {
      await runModelsCommand(async () => {
        const { modelsImageFallbacksAddCommand } = await import("./image-fallbacks-CFP4ijnU.js");
  ...
  imageFallbacks
    ...
    .action(async (model) => {
      await runModelsCommand(async () => {
        const { modelsImageFallbacksRemoveCommand } = await import("./image-fallbacks-CFP4ijnU.js");
  ...
  imageFallbacks
    ...
    .action(async () => {
      await runModelsCommand(async () => {
        const { modelsImageFallbacksClearCommand } = await import("./image-fallbacks-CFP4ijnU.js");
  ...
  models
    ...
    .action(async (opts) => {
      await runModelsCommand(async () => {
        const { modelsScanCommand } = await import("./scan-CIy40aTB.js");
  ...
  auth
    ...
    .action(async (opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent") ?? opts.agent;
      await runModelsCommand(async () => {
        const { modelsAuthListCommand } = await import("./auth-list-CWhy-QKB.js");
  ...
  auth
    ...
    .action(async (command) => {
      const agent =
        resolveOptionFromCommand(command, "agent") ?? resolveOptionFromCommand(auth, "agent");
      await runModelsCommand(async () => {
        const { modelsAuthAddCommand } = await import("./auth-5-Qacmy4.js");
  ...
  auth
    ...
    .action(async (opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent");
      await runModelsCommand(async () => {
        const { modelsAuthSetupTokenCommand } = await import("./auth-5-Qacmy4.js");
  ...
  auth
    ...
    .action(async (opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent");
      await runModelsCommand(async () => {
        const { modelsAuthPasteTokenCommand } = await import("./auth-5-Qacmy4.js");
  ...
  order
    ...
    .action(async (opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent") ?? opts.agent;
      await runModelsCommand(async () => {
        const { modelsAuthOrderGetCommand } = await import("./auth-order-m4BmFYeB.js");
  ...
  order
    ...
    .action(async (profileIds, opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent") ?? opts.agent;
      await runModelsCommand(async () => {
        const { modelsAuthOrderSetCommand } = await import("./auth-order-m4BmFYeB.js");
  ...
  order
    ...
    .action(async (opts, command) => {
      const agent = resolveOptionFromCommand(command, "agent") ?? opts.agent;
      await runModelsCommand(async () => {
        const { modelsAuthOrderClearCommand } = await import("./auth-order-m4BmFYeB.js");
