...
import { l as createThreadDiscord, s as sendWebhookMessageDiscord } from "./send-MjDHAxf5.js";
...
import { t as SYSTEM_MARK } from "./system-message-OiD4avN2.js";
import {
  i as REUSABLE_WEBHOOKS_BY_ACCOUNT_CHANNEL,
  k as toReusableWebhookKey,
  m as rememberReusableWebhook,
...
function resolveThreadBindingPersona(params) {
  return `${SYSTEM_MARK} ${normalizePersonaLabel(params.label) || normalizePersonaLabel(params.agentId) || "agent"}`.slice(
    0,
    THREAD_BINDING_PERSONA_MAX_CHARS,
  );
}
...
//#endregion
export {
  isThreadArchived as a,
  summarizeDiscordError as c,
  isDiscordThreadGoneError as i,
  resolveThreadBindingPersona as l,
  createWebhookForChannel as n,
  maybeSendBindingMessage as o,
  findReusableWebhook as r,
  resolveChannelIdForBinding as s,
  createThreadForBinding as t,
  resolveThreadBindingPersonaFromRecord as u,
};
