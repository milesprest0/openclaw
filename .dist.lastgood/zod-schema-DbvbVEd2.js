...
import {
  a as AgentSandboxSchema,
  c as MemorySearchSchema,
  d as AgentModelSchema,
  i as AgentRuntimePolicySchema,
  n as AgentEmbeddedHarnessSchema,
  o as ElevatedAllowFromSchema,
  r as AgentEntrySchema,
  s as HeartbeatSchema,
  t as AgentContextLimitsSchema,
  u as ToolsSchema,
} from "./zod-schema.agent-runtime-8YQcymYE.js";
import {
  C as SecretInputSchema,
  E as SecretsConfigSchema,
  F as VisibleRepliesSchema,
  P as TypingModeSchema,
  R as createAllowDenyChannelRulesSchema,
  _ as NativeCommandsSettingSchema,
  c as GroupChatSchema,
  d as HumanDelaySchema,
  g as ModelsConfigSchema,
  i as ContextVisibilityModeSchema,
  j as TtsConfigSchema,
  k as TranscribeAudioSchema,
  l as GroupPolicySchema,
  n as BlockStreamingCoalesceSchema,
  p as InboundDebounceSchema,
  r as CliBackendSchema,
  t as BlockStreamingChunkSchema,
  u as HexColorSchema,
  y as QueueSchema,
} from "./zod-schema.core-CkFaNmbg.js";
import { t as InstallRecordShape } from "./zod-schema.installs-BO_pQdgh.js";
import { l as ChannelHeartbeatVisibilitySchema } from "./zod-schema.providers-whatsapp-O9hejQx6.js";
...
function parseByteSize(raw, opts) {
  ...
  const multiplier =
    UNIT_MULTIPLIERS[normalizeLowercaseStringOrEmpty(m[2] ?? opts?.defaultUnit ?? "b")];
...
const AgentContextBudgetOverrideSchema = z
  ...
  .strict();
const SilentReplyPolicyConfigSchema = z
  .object({
  ...
  .strict();
const SilentReplyRewriteConfigSchema = z
  .object({
...
const AgentDefaultsSchema = z
  .object({
    ...
    contextBudget: z
      ...
      .strict()
      .optional(),
    toolExposure: z.object({ lazy: z.boolean().optional() }).strict().optional(),
...
const BroadcastSchema = z
  .object({ strategy: BroadcastStrategySchema.optional() })
...
const InternalHooksSchema = z
  .object({
    ...
    load: z
      .object({ extraDirs: z.array(z.string()).optional() })
      .strict()
      .optional(),
...
const ProxyConfigSchema = z
  .object({
    ...
    proxyUrl: z
      .url()
      .refine(isHttpProxyUrl, { message: "proxyUrl must use http://" })
      .register(sensitive)
      .optional(),
...
const SessionSchema = z
  .object({
    ...
    writeLock: z
      .object({ acquireTimeoutMs: z.number().int().positive().optional() })
      .strict()
      .optional(),
    agentToAgent: z
      .object({ maxPingPongTurns: z.number().int().min(0).max(5).optional() })
      .strict()
      .optional(),
    threadBindings: z
      .object({
...
const BrowserSnapshotDefaultsSchema = z
  .object({ mode: z.literal("efficient").optional() })
  .strict()
  .optional();
...
const TalkProviderEntrySchema = z
  .object({ apiKey: SecretInputSchema.optional().register(sensitive) })
  .catchall(z.unknown());
...
const OpenClawSchema = z
  .object({
    ...
    observability: z
      .object({
        promptInstrumentation: z.object({ enabled: z.boolean().optional() }).strict().optional(),
      })
      .strict()
      .optional(),
    logging: z
    ...
    discovery: z
      .object({
        wideArea: z
          ...
          .optional(),
        mdns: z
          .object({ mode: z.enum(["off", "minimal", "full"]).optional() })
          .strict()
          .optional(),
      })
      .strict()
    ...
    gateway: z
      .object({
        ...
        tools: z
          ...
          .optional(),
        webchat: z
          .object({ chatHistoryMaxChars: z.number().int().positive().max(5e5).optional() })
          .strict()
          .optional(),
              ...
              .object({
                chatCompletions: z
                  .object({
                    ...
                    images: z
                      .object({ ...ResponsesEndpointUrlFetchShape })
                      .strict()
                      .optional(),
                  })
                  .strict()
        ...
        nodes: z
          .object({
            browser: z
              ...
              .optional(),
            pairing: z
              .object({ autoApproveCidrs: z.array(z.string()).optional() })
              .strict()
              .optional(),
