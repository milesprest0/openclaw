...
import { a as normalizeHostOverrideEnvVarKey } from "./host-env-security-W4c-l4Zm.js";
import "./risks-C_v3AkAH.js";
import {
  T as normalizeExecutableToken,
  d as unwrapKnownShellMultiplexerInvocation,
  f as POSIX_INLINE_COMMAND_FLAGS,
  i as extractShellWrapperCommand,
  m as resolveInlineCommandMatch,
  o as hasEnvManipulationBeforeShellWrapper,
  p as POWERSHELL_INLINE_COMMAND_FLAGS,
  v as unwrapDispatchWrappersForResolution,
...
function argvMatches(expectedArgv, actualArgv) {
  ...
  for (let i = 0; i < expectedArgv.length; i += 1)
    if (expectedArgv[i] !== actualArgv[i]) return false;
  return true;
}
...
function hasTrailingPositionalArgvAfterInlineCommand(argv) {
  ...
  const inlineCommandIndex =
    wrapper === "powershell" || wrapper === "pwsh"
      ...
      : resolveInlineCommandMatch(wrapperArgv, POSIX_INLINE_COMMAND_FLAGS, { allowCombinedC: true })
          .valueTokenIndex;
...
//#endregion
export {
  matchSystemRunApprovalBinding as a,
  toSystemRunApprovalMismatchError as c,
  buildSystemRunApprovalEnvBinding as i,
  normalizeNonEmptyString as l,
  resolveSystemRunCommandRequest as n,
  missingSystemRunApprovalBinding as o,
  buildSystemRunApprovalBinding as r,
  normalizeSystemRunApprovalPlan as s,
  formatExecCommand as t,
  normalizeStringArray as u,
};
