...
function scanStalePluginConfigWithState(cfg, registryState) {
  ...
  if (slots)
    for (const slotKey of ["memory", "contextEngine"]) {
...
//#endregion
export {
  scanStalePluginConfig as i,
  isStalePluginAutoRepairBlocked as n,
  maybeRepairStalePluginConfig as r,
  collectStalePluginConfigWarnings as t,
};
