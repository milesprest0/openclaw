...
import {
  i as resolveSkillConfig,
  n as isConfigPathTruthy,
  r as resolveBundledAllowlist,
  t as isBundledSkillAllowed,
} from "./config-kFPSWjDy.js";
import { t as evaluateEntryRequirementsForCurrentPlatform } from "./entry-status-BbQX-hlH.js";
...
import {
  l as loadSkillsFromDirSafe,
  o as loadWorkspaceSkillEntries,
  u as resolveBundledSkillsDir,
...
function buildSkillStatus(entry, config, prefs, eligibility, bundledNames, agentSkillFilter) {
  ...
  const blockedByAgentFilter =
    agentSkillFilter !== void 0 && !agentSkillFilter.includes(entry.skill.name);
