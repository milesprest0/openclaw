...
import { n as formatMatrixErrorReason, t as formatMatrixErrorMessage } from "./errors-DQ-r4gaL.js";
  ...
  loadStoredRecoveryKey() {
    ...
    try {
      ...
      return {
        ...
        encodedPrivateKey:
          typeof parsed.encodedPrivateKey === "string" ? parsed.encodedPrivateKey : void 0,
...
//#endregion
export {
  MATRIX_IDB_SNAPSHOT_LOCK_OPTIONS as i,
  isRepairableSecretStorageAccessError as n,
  MATRIX_IDB_PERSIST_INTERVAL_MS as r,
  MatrixRecoveryKeyStore as t,
};
