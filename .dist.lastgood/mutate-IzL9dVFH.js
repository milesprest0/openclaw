...
import { r as INCLUDE_KEY } from "./includes-BzchArMU.js";
import {
  H as createInvalidConfigError,
  R as applyUnsetPathsForWrite,
  T as validateConfigObjectWithPlugins,
  U as formatInvalidConfigDetails,
  W as maintainConfigBackups,
  b as writeConfigFile,
  d as readConfigFileSnapshotForWrite,
  y as resolveConfigSnapshotHash,
  z as resolveManagedUnsetPathsForWrite,
} from "./io-CEQSCTGy.js";
...
function getChangedTopLevelKeys(base, next) {
  ...
  return [...new Set([...Object.keys(base), ...Object.keys(next)])].filter(
...
async function replaceConfigFile(params) {
  ...
  if (
    !(await tryWriteSingleTopLevelIncludeMutation({
      snapshot,
