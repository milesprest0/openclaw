...
} from "./doctor-contract-DmtGlBI6.js";
...
} from "./secret-contract-Cb_jyLOF.js";
import {
  n as googlechatSetupAdapter,
  t as googlechatSetupWizard,
} from "./setup-surface-hfCZ_LHs.js";
...
import "./runtime-api-BQ7_xRCl.js";
import {
  i as resolveGoogleChatOutboundSpace,
  n as isGoogleChatUserTarget,
  r as normalizeGoogleChatTarget,
  t as isGoogleChatSpaceTarget,
} from "./targets-CecuSsuX.js";
...
const loadGoogleChatChannelRuntime$2 = createLazyRuntimeNamedExport(
  () => import("./channel.runtime-DgOZp_a6.js"),
...
const formatAllowFromEntry = (entry) =>
  ...
  attachedResults: {
    ...
    sendMedia: async ({
      ...
      const effectiveMaxBytes =
        resolveChannelMediaMaxBytes({
          ...
          resolveChannelLimitMb: ({ cfg, accountId }) =>
            cfg.channels?.googlechat?.accounts?.[accountId]?.mediaMaxMb ??
            cfg.channels?.googlechat?.mediaMaxMb,
          accountId,
      ...
      const { sendGoogleChatMessage, uploadGoogleChatAttachment } =
        await loadGoogleChatChannelRuntime$2();
...
const collectGoogleChatMutableAllowlistWarnings =
...
const loadGoogleChatChannelRuntime$1 = createLazyRuntimeNamedExport(
  () => import("./channel.runtime-DgOZp_a6.js"),
  "googleChatChannelRuntime",
);
async function startGoogleChatGatewayAccount(ctx) {
  ...
  const { resolveGoogleChatWebhookPath, startGoogleChatMonitor } =
    await loadGoogleChatChannelRuntime$1();
  statusSink({
    running: true,
...
const googlechatActions = {
  ...
  handleAction: async (ctx) => {
    const { googlechatMessageActions } = await import("./actions-Ba3s0JcD.js");
