import { o as normalizeRateLimitClientIp } from "./auth-rate-limit-Es6mTeJX.js";
import {
...
import { c as readTailscaleWhoisIdentity } from "./tailscale-DxVPpgKm.js";
import "./auth-resolve-BevwYiIB.js";
...
async function authorizeGatewayConnect(params) {
  ...
  if (limiter && shouldAllowTailscaleHeaderAuth(authSurface) && auth.allowTailscale && !localDirect)
...
//#endregion
export {
  hasForwardedRequestHeaders as a,
  authorizeWsControlUiGatewayConnect as i,
  authorizeGatewayConnect as n,
  isLocalDirectRequest as o,
  authorizeHttpGatewayConnect as r,
  checkBrowserOrigin as s,
  assertGatewayAuthConfigured as t,
};
