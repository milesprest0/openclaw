...
import "./auth-rate-limit-Es6mTeJX.js";
import { t as pruneMapToMaxSize } from "./map-size-BTgIZSQN.js";
import "./http-body-D8UGuStR.js";
...
function createBoundedCounter(options) {
  ...
  const pruneIntervalMs = Math.max(
    1,
    Math.floor(options.pruneIntervalMs ?? (ttlMs > 0 ? ttlMs : 6e4)),
  );
...
//#endregion
export {
  createFixedWindowRateLimiter as a,
  createBoundedCounter as i,
  WEBHOOK_ANOMALY_STATUS_CODES as n,
  createWebhookAnomalyTracker as o,
  WEBHOOK_RATE_LIMIT_DEFAULTS as r,
  WEBHOOK_ANOMALY_COUNTER_DEFAULTS as t,
};
