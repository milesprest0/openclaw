...
import { a as shouldLogVerbose, t as danger } from "./globals-BdfwDi2E.js";
...
import {
  ...
  n as resolveCommandStdio,
  o as resolveWindowsConsoleEncoding,
  t as resolveWindowsCommandShim,
...
function resolveNpmArgvForWindows(argv) {
  ...
  if (!fs.existsSync(cliPath)) {
    ...
    return [
      normalizeLowercaseStringOrEmpty(path.extname(command)) ? command : `${command}.cmd`,
      ...argv.slice(1),
    ];
  }
...
//#endregion
export {
  shouldSpawnWithShell as a,
  runExec as i,
  resolveProcessExitCode as n,
  runCommandWithTimeout as r,
  resolveCommandEnv as t,
};
