...
var ThreadResumeResponse_default = {
  ...
  properties: {
    ...
    permissionProfile: {
      description:
        "Full active permissions for this thread. `activePermissionProfile` carries display/provenance metadata for this runtime profile.",
      default: null,
    ...
    sandbox: {
      description:
        "Legacy sandbox policy retained for compatibility. Experimental clients should prefer `permissionProfile` when they need exact runtime permissions.",
  ...
  definitions: {
    ...
    ThreadSource: {
      type: "string",
      enum: ["user", "subagent", "memory_consolidation"],
    },
    ThreadStatus: {
      oneOf: [
        {
...
//#endregion
export {
  readCodexErrorNotification as a,
  readCodexTurnCompletedNotification as c,
  readCodexDynamicToolCallParams as i,
  assertCodexThreadStartResponse as n,
  readCodexModelListResponse as o,
  assertCodexTurnStartResponse as r,
  readCodexTurn as s,
  assertCodexThreadResumeResponse as t,
};
