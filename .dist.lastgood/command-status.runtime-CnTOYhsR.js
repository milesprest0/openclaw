...
import { t as listAgentEntries } from "./agent-scope-config-CXZGyKMl.js";
...
import { t as resolveCurrentDirectiveLevels } from "./directive-handling.levels-BmxOmz9d.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-CyVXHdEG.js";
import { n as createModelSelectionState } from "./model-selection-oJf-VcPz.js";
...
async function resolveDirectStatusReplyForSession(params) {
  ...
  const sessionReasoningExplicitlySet =
    statusEntry?.reasoningLevel !== void 0 && statusEntry.reasoningLevel !== null;
  if (
    !(params.senderIsOwner || params.isAuthorizedSender) &&
    (sessionReasoningExplicitlySet || hasAgentReasoningDefault)
  )
