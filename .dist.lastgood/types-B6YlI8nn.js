...
const getState$1 = () =>
  resolveGlobalSingleton(PLUGIN_COMMAND_STATE_KEY, () => ({
    pluginCommands: /* @__PURE__ */ new Map(),
    registryLocked: false,
  }));
const getPluginCommandMap = () => getState$1().pluginCommands;
const pluginCommands = new Proxy(/* @__PURE__ */ new Map(), {
...
function clearPluginCommandsForPlugin(pluginId) {
  for (const [key, cmd] of pluginCommands.entries())
    if (cmd.pluginId === pluginId) pluginCommands.delete(key);
}
...
function validatePluginCommandDefinition(command, opts) {
  ...
  if (command.agentPromptGuidance !== void 0 && !Array.isArray(command.agentPromptGuidance))
...
export {
  pluginCommands as A,
  commitPluginInteractiveCallbackDedupe as C,
  isTrustedReservedCommandOwner as D,
  clearPluginCommandsForPlugin as E,
  setPluginCommandRegistryLocked as M,
  listRegisteredPluginAgentPromptGuidance as O,
  claimPluginInteractiveCallbackDedupe as S,
  clearPluginCommands as T,
  clearPluginInteractiveHandlersForPlugin as _,
  isConversationHookName as a,
  resolvePluginInteractiveNamespaceMatch as b,
  PLUGIN_PROMPT_MUTATION_RESULT_FIELDS as c,
  listPluginInvocationKeys as d,
  pluginCommandSupportsChannel as f,
  clearPluginInteractiveHandlers as g,
  validatePluginCommandDefinition as h,
  PluginApprovalResolutions as i,
  restorePluginCommands as j,
  listRegisteredPluginCommands as k,
  stripPromptMutationFieldsFromLegacyHookResult as l,
  validateCommandName as m,
  PLUGIN_HOOK_NAMES as n,
  isPluginHookName as o,
  registerPluginCommand as p,
  PROMPT_INJECTION_HOOK_NAMES as r,
  isPromptInjectionHookName as s,
  CONVERSATION_HOOK_NAMES as t,
  isReservedCommandName as u,
  listPluginInteractiveHandlers as v,
  releasePluginInteractiveCallbackDedupe as w,
  restorePluginInteractiveHandlers as x,
  registerPluginInteractiveHandler as y,
};
