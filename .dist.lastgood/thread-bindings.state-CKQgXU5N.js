...
function resolveThreadBindingsGlobalState() {
  if (!threadBindingsState) {
    ...
    threadBindingsState =
      globalStore[THREAD_BINDINGS_STATE_KEY] ?? createThreadBindingsGlobalState();
...
function normalizePersistedBinding(threadIdKey, raw) {
  ...
  const maxAgeMs =
    typeof value.maxAgeMs === "number" && Number.isFinite(value.maxAgeMs)
      ...
      : void 0;
  const metadata =
    value.metadata && typeof value.metadata === "object" ? { ...value.metadata } : void 0;
  ...
  if (migratedIdleTimeoutMs === void 0 && migratedMaxAgeMs === void 0 && legacyExpiresAt != null)
...
//#endregion
export {
  DEFAULT_THREAD_BINDING_IDLE_TIMEOUT_MS as A,
  resolveThreadBindingMaxAgeMs as C,
  shouldDefaultPersist as D,
  setBindingRecord as E,
  THREAD_BINDINGS_SWEEP_INTERVAL_MS as M,
  shouldPersistBindingMutations as O,
  resolveThreadBindingMaxAgeExpiresAt as S,
  saveBindingsToDisk as T,
  resetThreadBindingsForTests as _,
  THREAD_BINDING_TOUCH_PERSIST_MIN_INTERVAL_MS as a,
  resolveThreadBindingIdleTimeoutMs as b,
  getThreadBindingToken as c,
  normalizeThreadBindingDurationMs as d,
  normalizeThreadId as f,
  removeBindingRecord as g,
  rememberThreadBindingToken as h,
  REUSABLE_WEBHOOKS_BY_ACCOUNT_CHANNEL as i,
  DISCORD_UNKNOWN_CHANNEL_ERROR_CODE as j,
  toReusableWebhookKey as k,
  isRecentlyUnboundThreadWebhookMessage as l,
  rememberReusableWebhook as m,
  MANAGERS_BY_ACCOUNT_ID as n,
  ensureBindingsLoaded as o,
  rememberRecentUnboundWebhookEcho as p,
  PERSIST_BY_ACCOUNT_ID as r,
  forgetThreadBindingToken as s,
  BINDINGS_BY_THREAD_ID as t,
  normalizeTargetKind as u,
  resolveBindingIdsForSession as v,
  resolveThreadBindingsPath as w,
  resolveThreadBindingInactivityExpiresAt as x,
  resolveBindingRecordKey as y,
};
