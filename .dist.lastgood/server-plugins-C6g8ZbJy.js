...
import { r as createPluginRuntimeLoaderLogger } from "./load-context-CvRyUbBt.js";
import {
  l as loadOpenClawPlugins,
  r as clearActivatedPluginRuntimeState,
} from "./loader-BLowS1kl.js";
import { v as normalizeModelRef, y as parseModelRef } from "./model-selection-shared-D9oQINZ2.js";
...
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-CAPp41ue.js";
...
const getFallbackGatewayContextState = () =>
  resolveGlobalSingleton(FALLBACK_GATEWAY_CONTEXT_STATE_KEY, () => ({
    context: void 0,
...
const getPluginSubagentPolicyState = () =>
  resolveGlobalSingleton(PLUGIN_SUBAGENT_POLICY_STATE_KEY, () => ({ policies: {} }));
...
async function dispatchGatewayMethod(method, params, options) {
  ...
  const scopedClient = mergeGatewayClientInternal(
    scope?.client,
    pluginRuntimeOwnerId ? { pluginRuntimeOwnerId } : void 0,
  );
...
function loadGatewayPlugins(params) {
  ...
  const activationAutoEnabled =
    params.activationSourceConfig !== void 0 && params.autoEnabledReasons === void 0
...
//#endregion
export {
  setPluginSubagentOverridePolicies as a,
  setFallbackGatewayContextResolver as i,
  createGatewaySubagentRuntime as n,
  loadGatewayPlugins as r,
  createGatewayNodesRuntime as t,
};
