...
import { r as readLatestRecentSessionUsageFromTranscriptAsync } from "./session-utils.fs-z-7Kw0Lg.js";
...
async function readForkSourceTranscript(parentSessionFile) {
  const fileEntries = parseSessionEntries(
    (await readRegularFile({ filePath: parentSessionFile })).buffer.toString("utf-8"),
  );
