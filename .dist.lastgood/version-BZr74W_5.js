...
function resolveCompatibilityHostVersion(
  env = process.env,
  fallback = RUNTIME_SERVICE_VERSION_FALLBACK,
) {
...
//#endregion
export {
  resolveBinaryVersion as a,
  resolveUsableRuntimeVersion as c,
  readVersionFromPackageJsonForModuleUrl as i,
  resolveVersionFromModuleUrl as l,
  VERSION as n,
  resolveCompatibilityHostVersion as o,
  readVersionFromBuildInfoForModuleUrl as r,
  resolveRuntimeServiceVersion as s,
  RUNTIME_SERVICE_VERSION_FALLBACK as t,
};
