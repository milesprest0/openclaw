...
import { u as isHelpOrVersionInvocation, w as consumeRootOptionToken } from "./argv-DQxa_OA3.js";
  ...
  if (!globalState[CONTEXT_WINDOW_RUNTIME_STATE_KEY])
    globalState[CONTEXT_WINDOW_RUNTIME_STATE_KEY] = {
      ...
      modelsConfigRuntimeLoader: createLazyImportLoader(
        () => import("./agents/models-config.runtime.js"),
      ),
    };
...
const ANTHROPIC_1M_MODEL_PREFIXES = ["claude-opus-4", "claude-sonnet-4", "claude-sonnet-5"];
  ...
  CONTEXT_WINDOW_RUNTIME_STATE.loadPromise = (async () => {
    ...
    try {
      const { discoverAuthStorage, discoverModels } =
        await import("./agents/pi-model-discovery-runtime.js");
...
function shouldUseDiscoveredAnthropicOpus47ContextWindow(model) {
  const provider =
    typeof model.provider === "string" ? normalizeProviderId(model.provider) : void 0;
...
//#endregion
export {
  resolveContextTokensForModel as a,
  lookupContextTokens as i,
  applyConfiguredContextWindows as n,
  shouldEagerWarmContextWindowCache as o,
  applyDiscoveredContextWindows as r,
  resetContextWindowCacheForTest as s,
  ANTHROPIC_CONTEXT_1M_TOKENS as t,
};
