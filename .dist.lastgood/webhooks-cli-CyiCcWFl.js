...
import { y as resolveExecutable } from "./exec-safe-bin-trust-D3CIZbMH.js";
import { t as danger } from "./globals-BdfwDi2E.js";
import {
  C as normalizeServePath,
  S as normalizeHooksPath,
  T as resolveGmailHookRuntimeConfig,
  _ as buildGogWatchServeLogArgs,
  a as ensureTopic,
  b as generateHookToken,
  c as DEFAULT_GMAIL_LABEL,
  d as DEFAULT_GMAIL_SERVE_PATH,
  f as DEFAULT_GMAIL_SERVE_PORT,
  g as buildGogWatchServeArgs,
  h as buildDefaultHookUrl,
  i as ensureTailscaleEndpoint,
  l as DEFAULT_GMAIL_MAX_BYTES,
  m as DEFAULT_GMAIL_TOPIC,
  n as ensureGcloudAuth,
  o as resolveProjectIdFromGogCredentials,
  p as DEFAULT_GMAIL_SUBSCRIPTION,
  r as ensureSubscription,
  s as runGcloud,
  t as ensureDependency,
  u as DEFAULT_GMAIL_SERVE_BIND,
  v as buildGogWatchStartArgs,
  w as parseTopicPath,
  x as mergeHookPresets,
  y as buildTopicPath,
} from "./gmail-setup-utils-B7l7HuSm.js";
import {
...
async function startGmailWatch(cfg, fatal = false) {
  const result = await runCommandWithTimeout(
    [(gogBin ??= resolveExecutable("gog")), ...buildGogWatchStartArgs(cfg)],
    { timeoutMs: 12e4 },
  );
  if (result.code !== 0) {
...
function registerWebhooksCli(program) {
  ...
  gmail
    ...
    .option("--renew-minutes <n>", "Renew watch every N minutes", String(720))
