...
import {
  ...
  D as ToolsLinksSchema,
  O as ToolsMediaSchema,
...
const SandboxPruneSchema = z
  ...
  .strict()
  .optional();
const AgentContextLimitsSchema = z
  .object({
...
const AgentSkillsLimitsSchema = z
  .object({ maxSkillsPromptChars: z.number().int().min(0).optional() })
  .strict()
  .optional();
...
const ToolLoopPostCompactionGuardSchema = z
  .object({ windowSize: z.number().int().positive().optional() })
  .strict()
  .optional();
  ...
  .object({
    ...
    store: z
      .object({
        ...
        fts: z
          .object({ tokenizer: z.union([z.literal("unicode61"), z.literal("trigram")]).optional() })
          .strict()
          .optional(),
        vector: z
          .object({
...
const ToolsSchema = z
  .object({
    ...
    sessions: z
      .object({ visibility: z.enum(["self", "tree", "agent", "all"]).optional() })
      .strict()
      .optional(),
    loopDetection: ToolLoopDetectionSchema,
    message: z
...
//#endregion
export {
  AgentSandboxSchema as a,
  MemorySearchSchema as c,
  AgentModelSchema as d,
  AgentRuntimePolicySchema as i,
  ToolPolicySchema as l,
  AgentEmbeddedHarnessSchema as n,
  ElevatedAllowFromSchema as o,
  AgentEntrySchema as r,
  HeartbeatSchema as s,
  AgentContextLimitsSchema as t,
  ToolsSchema as u,
};
