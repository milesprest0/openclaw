...
function isSilentOverflowProneModel(model) {
  if (normalizeProviderId(typeof model.provider === "string" ? model.provider : "") === "zai")
    return true;
...
//#endregion
export {
  resolveEffectiveCompactionMode as a,
  isSilentOverflowProneModel as i,
  applyPiAutoCompactionGuard as n,
  MIN_PROMPT_BUDGET_RATIO as o,
  applyPiCompactionSettingsFromConfig as r,
  MIN_PROMPT_BUDGET_TOKENS as s,
  DEFAULT_PI_COMPACTION_RESERVE_TOKENS_FLOOR as t,
};
