...
const SESSIONS_LIST_TOOL_DISPLAY_SUMMARY =
  "List visible sessions with mailbox filters and optional previews.";
const SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY =
...
function buildCoreToolGroupMap() {
  ...
  return {
    "group:openclaw": CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInOpenClawGroup).map(
      (tool) => tool.id,
    ),
...
//#endregion
export {
  describeSessionsSendTool as C,
  describeSessionsListTool as S,
  describeUpdatePlanTool as T,
  SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY as _,
  resolveToolProfilePolicy as a,
  describeSessionStatusTool as b,
  listCoreToolSections as c,
  EXEC_TOOL_DISPLAY_SUMMARY as d,
  PROCESS_TOOL_DISPLAY_SUMMARY as f,
  SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY as g,
  SESSIONS_SEND_TOOL_DISPLAY_SUMMARY as h,
  normalizeToolName as i,
  resolveCoreToolProfiles as l,
  SESSIONS_LIST_TOOL_DISPLAY_SUMMARY as m,
  expandToolGroups as n,
  PROFILE_OPTIONS as o,
  SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY as p,
  normalizeToolList as r,
  isKnownCoreToolId as s,
  TOOL_GROUPS as t,
  CRON_TOOL_DISPLAY_SUMMARY as u,
  SESSION_STATUS_TOOL_DISPLAY_SUMMARY as v,
  describeSessionsSpawnTool as w,
  describeSessionsHistoryTool as x,
  UPDATE_PLAN_TOOL_DISPLAY_SUMMARY as y,
};
