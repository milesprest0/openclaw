...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-B331FvbS.js";
import { r as agentCommandFromIngress } from "./agent-command-bmrIHuJ_.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-DfYKNtYc.js";
import {
  n as resolveAgentOutboundTarget,
  t as resolveAgentDeliveryPlan,
} from "./agent-delivery-vU0pzRxY.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-c6-2eZvI.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-BO_xM0qW.js";
...
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-DpnyyyKB.js";
import {
  a as pruneAgentConfig,
  r as findAgentEntryIndex,
  t as applyAgentConfig,
} from "./agents.config-paEb5Fyv.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BlfNpcD9.js";
import { t as createAsyncLock } from "./async-lock-Cp5JQa-X.js";
import {
  a as resolveChatAttachmentMaxBytes,
  i as parseMessageWithAttachments,
  n as MediaOffloadError,
  t as normalizeRpcAttachmentsToChatAttachments,
} from "./attachment-normalize-D1-RooV9.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-ChFtt_mg.js";
import {
  n as resolveGatewayAuth,
  t as resolveEffectiveSharedGatewayAuth,
} from "./auth-resolve-BevwYiIB.js";
import "./auth-D_VLzYQI.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-C4gtMi_a.js";
import { t as buildChannelUiCatalog } from "./catalog-CLuOxtzZ.js";
import { t as getChannelActivity } from "./channel-activity-C42T8R8o.js";
import {
  n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS,
  r as evaluateChannelHealth,
  t as DEFAULT_CHANNEL_CONNECT_GRACE_MS,
} from "./channel-health-policy-DbJG9FMx.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-C9CG3lVz.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-PPtZ0iMr.js";
import { h as stringifyRouteThreadId } from "./channel-route-B9olp3tt.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-uDv4DTk3.js";
import "./config-CMOdcWpc.js";
import {
  i as resolveAgentRunExpiresAtMs,
  r as registerChatAbortController,
  t as abortChatRunById,
} from "./chat-abort-CMPpqF9g.js";
import {
  c as waitForTerminalGatewayDedupe,
  o as readTerminalSnapshotFromGatewayDedupe,
  r as chatHandlers,
  s as setGatewayDedupeEntry,
} from "./chat-Bw1HKGR0.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DyDPbDAx.js";
import { o as gatewayStartupUnavailableDetails } from "./client-BYqFLh-J.js";
import {
...
import {
  r as canonicalizeSpawnedByForAgent,
  t as loadCombinedSessionStoreForGateway,
} from "./combined-store-gateway-CtdiSumZ.js";
import { l as getTotalQueueSize } from "./command-queue-BtommWHg.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-DxJLSJ0J.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-COR74Rkl.js";
import { n as isRestartEnabled } from "./commands.flags-DSmuIKZj.js";
import { i as resolveSandboxConfigForAgent } from "./config-aLdl9MiY.js";
import {
  i as diffConfigPaths,
  t as buildGatewayReloadPlan,
} from "./config-reload-plan-B4RT5az3.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-vRwGhTbh.js";
import { r as DEFAULT_PROVIDER } from "./defaults-4m7JJmD2.js";
import {
  l as projectOutboundPayloadPlanForMirror,
  r as createOutboundPayloadPlan,
  t as deliverOutboundPayloads,
} from "./deliver-Dz9Dpt9U.js";
import {
  a as normalizeSessionDeliveryFields,
  i as normalizeDeliveryContext,
  r as mergeDeliveryContext,
  t as deliveryContextFromSession,
} from "./delivery-context.shared-mj-12Z6_.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-BkyfCXvN.js";
import { t as resolveDeliveryTarget } from "./delivery-target-CEHNt84O.js";
import { n as createOutboundSendDeps } from "./deps-C1pDH524.js";
import {
  a as finalizeTaskRunByRunId,
  r as createRunningTaskRun,
} from "./detached-task-runtime-CRxjrfaR.js";
import {
  a as publicKeyRawBase64UrlFromPem,
  r as loadOrCreateDeviceIdentity,
} from "./device-identity-BQp4SxLS.js";
import {
  d as rejectDevicePairing,
  f as removePairedDevice,
  g as summarizeDeviceTokens,
  h as rotateDeviceToken,
  i as formatDevicePairingForbiddenMessage,
  l as listDevicePairing,
  m as revokeDeviceToken,
  n as approveDevicePairing,
  o as getPendingDevicePairing,
...
} from "./diagnostic-stability-B9xLFdo7.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-C7_fCkMY.js";
import {
  G as resolveMemoryDreamingConfig,
  H as isSameMemoryDreamingDay,
  J as resolveMemoryDreamingWorkspaces,
  K as resolveMemoryDreamingPluginConfig,
  W as resolveMemoryDeepDreamingConfig,
  X as resolveMemoryRemDreamingConfig,
  Y as resolveMemoryLightDreamingConfig,
} from "./dreaming-BDr8qIGr.js";
import { a as formatErrorMessage, o as formatUncaughtError } from "./errors-DZMrVkYL.js";
import {
...
import { t as canExecRequestNode } from "./exec-defaults-C4RqVOp-.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DDK4LC8K.js";
import "./plugins-Dn-pJrhh.js";
import { a as isTimeoutError } from "./failover-error-Dx3vQAkt.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-Bc6xXkxi.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Dux0y1fS.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-2F-mloyP.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-BLJkDN4N.js";
import {
...
import { r as mergeIdentityMarkdownContent } from "./identity-file-Csvx_B8P.js";
import {
  n as annotateInterSessionPromptText,
  o as normalizeInputProvenance,
} from "./input-provenance-OI5EnRxZ.js";
import {
  i as hasInternalHookListeners,
  m as triggerInternalHook,
  n as createInternalHookEvent,
} from "./internal-hooks-x_v10zI-.js";
import {
  ...
  y as resolveConfigSnapshotHash,
} from "./io-CEQSCTGy.js";
import { n as formatConfigIssueLines } from "./issue-format-DZoENRCj.js";
import { n as applyJobPatch } from "./jobs-SDHRSbuQ.js";
import { d as writeJson, l as tryReadJson } from "./json-files-DifBk3kt.js";
import { g as patchPluginSessionExtension } from "./loader-BLowS1kl.js";
import { t as readConfiguredLogTail } from "./log-tail-C7O8b799.js";
import { a as logWarn, t as logDebug } from "./logger-BWdMCYqK.js";
import {
  i as resolveMainSessionKey,
  n as resolveAgentMainSessionKey,
  r as resolveExplicitAgentSessionKey,
} from "./main-session-BttihmeO.js";
import {
  c as repairDreamingArtifacts,
  i as previewRemHarness,
  l as writeBackfillDiaryEntries,
  n as dedupeDreamDiaryEntries,
  o as removeBackfillDiaryEntries,
  r as previewGroundedRemMarkdown,
  s as removeGroundedShortTermCandidates,
} from "./memory-core-bundled-runtime-D5Q_wGgy.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BfIZHpc8.js";
import { t as applyMergePatch } from "./merge-patch-Gj7xrHOG.js";
import {
  i as resolveOutboundSessionRoute,
  r as ensureOutboundSessionEntry,
  s as dispatchChannelMessageAction,
} from "./message-action-runner-C44vBHWX.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-VUC-himU.js";
import "./tts-DRYN86wU.js";
import {
  c as isGatewayMessageChannel,
  s as isDeliverableMessageChannel,
  u as normalizeMessageChannel,
} from "./message-channel-GRZIhFYD.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-DaDxLn4o.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BHnTVP9l.js";
import "./auth-profiles-BrCJ7JK3.js";
import {
  d as getSessionCompactionCheckpoint,
  f as listSessionCompactionCheckpoints,
  u as forkCompactionCheckpointTranscriptAsync,
} from "./model-context-tokens-CNTskz5N.js";
import { r as replaceConfigFile } from "./mutate-IzL9dVFH.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-AxDet15L.js";
import {
  n as isForegroundRestrictedPluginNodeCommand,
  o as resolveNodeCommandAllowlist,
  r as isNodeCommandAllowed,
} from "./node-command-policy-y9_MR0c9.js";
import {
  a as removePairedNode,
  i as rejectNodePairing,
  l as verifyNodeToken,
  o as renamePairedNode,
  r as listNodePairing,
  s as requestNodePairing,
  t as approveNodePairing,
} from "./node-pairing-BFA5m3xB.js";
import {
  n as respondUnavailableOnNodeInvokeError,
  r as respondUnavailableOnThrow,
  t as respondInvalidParams,
} from "./nodes.helpers-DSpmaAH8.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-B47pyy0b.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-B8M4cov-.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DDaGBMF_.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-Codapd9g.js";
import { r as readPackageVersion } from "./package-json-BqSklvpu.js";
import { p as FsSafeError } from "./path-1liOXr_N.js";
import {
  a as resolveSessionFilePathOptions,
  i as resolveSessionFilePath,
  l as resolveSessionTranscriptsDirForAgent,
} from "./paths-CfeECf6Z.js";
import { v as resolveStateDir } from "./paths-Cnwfh6dH.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-D_bdRDPs.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-BdujgZXP.js";
import "./target-resolver-_EpoEgO9.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DS5L8BzN.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DBf3GcqW.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-mS-g2wAV.js";
import { n as normalizePollInput } from "./polls-CNbHLDT1.js";
import {
  a as nodeWakeById,
  n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS,
  o as nodeWakeNudgeById,
  r as NODE_WAKE_RECONNECT_WAIT_MS,
  t as broadcastPresenceSnapshot,
} from "./presence-events-Clf6hG5O.js";
import { t as WizardCancelledError } from "./prompts-CGjOiPh-.js";
import {
  $ as validateExecApprovalsNodeGetParams,
  $t as validateSkillsDetailParams,
  A as validateConfigSchemaParams,
  An as validateToolsInvokeParams,
  B as validateDevicePairApproveParams,
  Bn as validateWizardCancelParams,
  Bt as validateSessionsDeleteParams,
  Cn as validateTalkSessionSubmitToolResultParams,
  D as validateConfigPatchParams,
  E as validateConfigGetParams,
  En as validateTalkSpeakParams,
  Et as validatePushTestParams,
  F as validateCronRemoveParams,
  Fi as COMMAND_DESCRIPTION_MAX_LENGTH,
  Fn as validateWebLoginWaitParams,
  Ft as validateSessionsCompactionBranchParams,
  G as validateDeviceTokenRotateParams,
  Gt as validateSessionsPatchParams,
  H as validateDevicePairRejectParams,
  Hn as validateWizardStartParams,
  Ht as validateSessionsListParams,
  I as validateCronRunParams,
  In as validateWebPushSubscribeParams,
  It as validateSessionsCompactionGetParams,
  Jt as validateSessionsResetParams,
  K as validateEnvironmentsListParams,
  Kt as validateSessionsPluginPatchParams,
  L as validateCronRunsParams,
  Ln as validateWebPushTestParams,
  Lt as validateSessionsCompactionListParams,
  Mn as validateUpdateStatusParams,
  Mt as validateSessionsAbortParams,
  N as validateCronAddParams,
  Nn as validateWakeParams,
  Nt as validateSessionsCleanupParams,
  O as validateConfigSchemaLookupParams,
  On as validateToolsCatalogParams,
  P as validateCronListParams,
  Pn as validateWebLoginStartParams,
  Pt as validateSessionsCompactParams,
  Q as validateExecApprovalsGetParams,
  Qt as validateSkillsBinsParams,
  R as validateCronStatusParams,
  Rn as validateWebPushUnsubscribeParams,
  Rt as validateSessionsCompactionRestoreParams,
  T as validateConfigApplyParams,
  Tt as validatePollParams,
  U as validateDevicePairRemoveParams,
  Un as validateWizardStatusParams,
  Ut as validateSessionsMessagesSubscribeParams,
  V as validateDevicePairListParams,
  Vn as validateWizardNextParams,
  Vt as validateSessionsDescribeParams,
  W as validateDeviceTokenRevokeParams,
  Wt as validateSessionsMessagesUnsubscribeParams,
  Xt as validateSessionsSendParams,
  Yt as validateSessionsResolveParams,
  Zt as validateSessionsUsageParams,
  _ as validateChannelsStatusParams,
  _n as validateTalkSessionCloseParams,
  _t as validateNodePendingAckParams,
  ...
  cn as validateTalkClientToolCallParams,
  ct as validateNodeInvokeParams,
  d as validateAgentsUpdateParams,
  dt as validateNodePairApproveParams,
  en as validateSkillsInstallParams,
  et as validateExecApprovalsNodeSetParams,
  f as validateArtifactsDownloadParams,
  ft as validateNodePairListParams,
  g as validateChannelsStartParams,
  gi as errorShape,
  gn as validateTalkSessionCancelTurnParams,
  gt as validateNodePairVerifyParams,
  h as validateChannelsLogoutParams,
  hi as ErrorCodes,
  hn as validateTalkSessionCancelOutputParams,
  ht as validateNodePairRequestParams,
  i as validateAgentWaitParams,
  in as validateTalkCatalogParams,
  it as validateModelsListParams,
  j as validateConfigSetParams,
  jn as validateUpdateRunParams,
  jt as validateSendParams,
  k as validateConfigSchemaLookupResult,
  kn as validateToolsEffectiveParams,
  l as validateAgentsFilesSetParams,
  lt as validateNodeInvokeResultParams,
  m as validateArtifactsListParams,
  mn as validateTalkSessionAppendAudioParams,
  mt as validateNodePairRemoveParams,
  n as validateAgentIdentityParams,
  nn as validateSkillsStatusParams,
  nt as validateLogsTailParams,
  o as validateAgentsDeleteParams,
  on as validateTalkClientCreateParams,
  ot as validateNodeEventParams,
  p as validateArtifactsGetParams,
  pn as validateTalkModeParams,
  pt as validateNodePairRejectParams,
  q as validateEnvironmentsStatusParams,
  qt as validateSessionsPreviewParams,
  r as validateAgentParams,
  rn as validateSkillsUpdateParams,
  rt as validateMessageActionParams,
  s as validateAgentsFilesGetParams,
  t as formatValidationErrors,
  tn as validateSkillsSearchParams,
  tt as validateExecApprovalsSetParams,
  u as validateAgentsListParams,
  un as validateTalkConfigParams,
  ut as validateNodeListParams,
  v as validateChannelsStopParams,
  vn as validateTalkSessionCreateParams,
  vt as validateNodePendingDrainParams,
  w as validateCommandsListParams,
  wn as validateTalkSessionTurnParams,
  wt as validatePluginsUiDescriptorsParams,
  xt as validateNodeRenameParams,
  yt as validateNodePendingEnqueueParams,
  z as validateCronUpdateParams,
  zn as validateWebPushVapidPublicKeyParams,
  zt as validateSessionsCreateParams,
} from "./protocol-CUn5aLrV.js";
...
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-DX6y2NsT.js";
import { t as loadProviderUsageSummary } from "./provider-usage-B02zhcgI.js";
import {
  n as PROVIDER_LABELS,
  o as resolveUsageProviderId,
} from "./provider-usage.shared-BhGN5s3U.js";
import {
  a as resolveApnsAuthConfigFromEnv,
  d as resolveApnsRelayConfigFromEnv,
  n as loadApnsRegistration,
  o as sendApnsAlert,
  r as normalizeApnsEnvironment,
  s as sendApnsBackgroundWake,
  t as clearApnsRegistrationIfCurrent,
  u as shouldClearStoredApnsRegistration,
} from "./push-apns-pGEfqt6M.js";
import { s as clearSessionQueues } from "./queue-m5o6nz1B.js";
import "./skills-DYy402QP.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BuYFJfzm.js";
import {
  i as restoreRedactedValues,
  n as redactConfigObject,
  r as redactConfigSnapshot,
} from "./redact-snapshot-DiercLAY.js";
import {
  a as normalizeChannelId,
  i as listChannelPlugins,
  t as getChannelPlugin,
} from "./registry-D3zb3mnd.js";
import "./commands-registry-8mCZwy9x.js";
import { i as resolveReplyToMode } from "./reply-threading-A0IAxIYj.js";
import {
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-BMF0Nrvt.js";
import {
  d as writeRestartSentinel,
  r as formatDoctorNonInteractiveHint,
  t as buildRestartSuccessContinuation,
} from "./restart-sentinel-CXl2NwhJ.js";
import {
  a as resolveCronRunLogPath,
  n as readCronRunLogEntriesPage,
  r as readCronRunLogEntriesPageAll,
} from "./run-log-C0aatsE-.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-uLckWPme.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-BurDsdaa.js";
import {
  h as waitForEmbeddedPiRunEnd,
  n as abortEmbeddedPiRun,
  o as isEmbeddedPiRunActive,
} from "./runs-CztEUxOL.js";
import {
  M as isPluginJsonValue,
  a as getActivePluginRegistry,
  n as getActivePluginChannelRegistryVersion,
  s as getActivePluginRegistryVersion,
} from "./runtime-ChXyIFtl.js";
import {
  a as prepareSecretsRuntimeSnapshot,
  i as getActiveSecretsRuntimeSnapshot,
} from "./runtime-DyGaG6oO.js";
import "./browser-maintenance-DPG0FPin.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import {
  r as lookupConfigSchema,
  t as loadGatewayRuntimeConfigSchema,
} from "./runtime-schema-JqLhlDGQ.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-B0aZX-OG.js";
import { o as root } from "./secure-temp-dir-CCj3cY2B.js";
import { n as resolveSendPolicy } from "./send-policy-BQXzC8_d.js";
...
} from "./server-restart-sentinel-BxL6et7e.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-CUfjCNaO.js";
import {
  i as setVoiceWakeTriggers,
  n as normalizeVoiceWakeTriggers,
  r as loadVoiceWakeConfig,
  t as formatError$1,
} from "./server-utils-DG0eP6xM.js";
import { t as buildOutboundSessionContext } from "./session-context-FWAwbTTu.js";
import {
  a as loadSessionCostSummaryFromCache,
  c as resolveExistingUsageSessionFile,
  o as loadSessionLogs,
  r as loadCostUsageSummaryFromCache,
  s as loadSessionUsageTimeSeries,
  t as discoverAllSessions,
} from "./session-cost-usage-sI8mpVrS.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-D6q4cQjl.js";
import {
  c as normalizeAgentId,
  h as toAgentStoreSessionKey,
  o as classifySessionKeyShape,
...
import {
  ...
  s as parseRawSessionConversationRef,
} from "./session-key-utils-B3KPN8Ee.js";
import { s as performGatewaySessionReset } from "./session-reset-service-6A9PSljn.js";
import {
  A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ,
  S as recordTalkObservabilityEvent,
  a as listRealtimeVoiceProviders,
  b as createTalkSessionController,
  c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME,
  n as resolveConfiguredRealtimeVoiceProvider,
  r as canonicalizeRealtimeVoiceProviderId,
  s as REALTIME_VOICE_AGENT_CONSULT_TOOL,
  t as createRealtimeVoiceBridgeSession,
  u as buildRealtimeVoiceAgentConsultChatMessage,
} from "./session-runtime-B8HmMzEf.js";
import {
  a as resolveSessionTranscriptCandidates,
  t as archiveFileOnDisk,
} from "./session-transcript-files.fs-D-z-Dnd7.js";
import {
  c as loadSessionEntry,
  d as resolveDeletedAgentIdFromSessionKey,
  f as resolveFreshestSessionEntryFromStoreKeys,
  g as resolveSessionDisplayModelIdentityRef,
  i as listAgentsForGateway,
  l as migrateAndPruneGatewaySessionStoreKey,
  m as resolveGatewaySessionStoreTarget,
  o as listSessionsFromStoreAsync,
  p as resolveGatewayModelSupportsImages,
  s as loadGatewaySessionRow,
  t as buildGatewaySessionRow,
  v as resolveSessionModelRef,
} from "./session-utils-Dhg586UW.js";
import {
  a as readRecentSessionMessagesWithStatsAsync,
  c as readSessionMessageCountAsync,
  o as readRecentSessionTranscriptLines,
  p as visitSessionMessagesAsync,
  u as readSessionPreviewItemsFromTranscript,
} from "./session-utils.fs-z-7Kw0Lg.js";
import {
  a as extractDeliveryInfo,
  c as resolveMainSessionKeyFromConfig,
  i as serializeSessionCleanupResult,
  r as runSessionsCleanup,
  s as resolveSessionLifecycleTimestamps,
  t as purgeAgentSessionStoreEntries,
} from "./sessions-Bdy1wToU.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-4InMUEX9.js";
import "./agent-B5WIvg3I.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DF0vjI0S.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DaDbzwlG.js";
import {
  i as updateSkillsFromClawHub,
  r as searchSkillsFromClawHub,
  t as installSkillFromClawHub,
} from "./skills-clawhub-DFMWo_zh.js";
import { t as installSkill } from "./skills-install-DVRibThI.js";
import "./server-constants-CI_c5cWv.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-CjCdFOxe.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DHJvQosg.js";
import {
  i as resolveIngressWorkspaceOverrideForSpawnedRun,
  r as normalizeSpawnedRunMetadata,
} from "./spawn-requester-origin-zGSeuSpR.js";
import { i as parseAbsoluteTimeMs } from "./stagger-D59LMhh_.js";
import {
  i as resolveBareSessionResetPromptState,
  n as shouldApplyStartupContext,
  r as resolveBareResetBootstrapFileAccess,
  t as buildSessionStartupContextPrelude,
} from "./startup-context-CiRsQsA0.js";
import { t as buildChannelAccountSnapshot } from "./status-B3gyOjOn.js";
import { t as getStatusSummary } from "./status.summary-D1WGeZUU.js";
import { n as ensureAuthProfileStore } from "./store-9hg03xJO.js";
import { s as updateSessionStore } from "./store-BpWdoYPF.js";
import { t as loadSessionStore } from "./store-load-BSFLPYqQ.js";
import {
  a as normalizeLowercaseStringOrEmpty,
  c as normalizeOptionalString$1,
...
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-Cr9HxsBK.js";
import { t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-BzPrp0Y4.js";
import {
  a as enqueueSystemEvent,
  s as isSystemEventContextChanged,
} from "./system-events-CttxBeh2.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-BpoE0fcb.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-Cja4Yzq-.js";
import {
  a as matchSystemRunApprovalBinding,
  c as toSystemRunApprovalMismatchError,
  n as resolveSystemRunCommandRequest,
  o as missingSystemRunApprovalBinding,
  r as buildSystemRunApprovalBinding,
} from "./system-run-command-C5E4go0-.js";
import {
  i as resolveActiveTalkProviderConfig,
  r as normalizeTalkSection,
  t as buildTalkConfigResponse,
} from "./talk-CZDwRYpg.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CflbqRzj.js";
import { r as resolveOutboundTarget } from "./targets-BqvQ_FF9.js";
import {
  i as validateTargetProviderPrefix,
  r as resolveTargetPrefixedChannel,
} from "./targets-session-gkBFAJFs.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CHGReR5Y.js";
import "./status-Rnzr_tHK.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-DvVBcOJ1.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-C9_Z62px.js";
import { t as resolveAgentTimeoutMs } from "./timeout-06zKgWsk.js";
import { r as setSafeTimeout } from "./timer-delay-DZlUjkX3.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Cv-eJjTG.js";
import { t as extractToolPayload } from "./tool-payload-CFuJ-o-I.js";
import {
  c as listCoreToolSections,
  l as resolveCoreToolProfiles,
  o as PROFILE_OPTIONS,
} from "./tool-policy-shared-DsbREhoR.js";
import {
  a as resolvePluginTools,
  i as getPluginToolMeta,
  r as ensureStandalonePluginToolRegistryLoaded,
  t as buildPluginToolMetadataKey,
} from "./tools-DcY_52BH.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CPI5yE2K.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-jxVqXAFr.js";
import "./heartbeat-runner-CPuhMMK_.js";
import { t as movePathToTrash } from "./trash-DdQBWsSt.js";
import {
  C as setTtsEnabled,
  E as setTtsProvider,
...
import { n as mergeSessionEntry } from "./types-C7lm-riv.js";
import { c as isSecretRef } from "./types.secrets-CaNC1eIn.js";
import { n as isAbortError } from "./unhandled-rejections-ChRE0RCv.js";
import { s as normalizeUpdateChannel } from "./update-channels-kLC68_fZ.js";
import {
  n as runGatewayUpdate,
  t as resolveUpdateInstallSurface,
} from "./update-runner-CyHcWvtq.js";
import { p as resolveUserPath } from "./utils-BGRcpLKt.js";
import {
  a as validateVoiceWakeRoutingConfigInput,
  i as setVoiceWakeRoutingConfig,
  n as normalizeVoiceWakeRoutingConfig,
  o as isRoleAuthorizedForMethod,
  r as resolveVoiceWakeRouteByTrigger,
  s as parseGatewayRole,
  t as loadVoiceWakeRoutingConfig,
} from "./voicewake-routing-NnvHosUx.js";
import {
  i as resolveCronDeliverySessionKey,
  r as isInvalidCronSessionTargetIdError,
} from "./webhook-url-CmRMvdiM.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-DZqNP2so.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BVHyO1HU.js";
import {
  a as DEFAULT_MEMORY_FILENAME,
  c as DEFAULT_USER_FILENAME,
  f as isWorkspaceSetupCompleted,
  i as DEFAULT_IDENTITY_FILENAME,
  l as ensureAgentWorkspace,
  n as DEFAULT_BOOTSTRAP_FILENAME,
  o as DEFAULT_SOUL_FILENAME,
  r as DEFAULT_HEARTBEAT_FILENAME,
  s as DEFAULT_TOOLS_FILENAME,
  t as DEFAULT_AGENTS_FILENAME,
} from "./workspace-DvzHmVcJ.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-FSRlf91o.js";
import { t as formatForLog } from "./ws-log-B_EDd3bo.js";
...
function pruneAgentRunCache(now = Date.now()) {
  for (const [runId, entry] of agentRunCache)
    if (now - entry.ts > AGENT_RUN_CACHE_TTL_MS) agentRunCache.delete(runId);
}
...
function resolveSenderIsOwnerFromClient(client) {
  return (Array.isArray(client?.connect?.scopes) ? client.connect.scopes : []).includes(
    ADMIN_SCOPE$1,
  );
}
...
function resolveTrustedGroupMetadata(params) {
  return {
    groupId:
      ...
      (params.spawnedBy ? resolveSessionKeyGroupId(params.spawnedBy) : void 0),
...
function dispatchAgentRunFromGateway(params) {
  ...
  agentCommandFromIngress(params.ingressOpts, defaultRuntime, params.context.deps)
    ...
    .finally(() => {
      if (
        params.context.chatAbortControllers.get(params.runId)?.controller === params.abortController
      )
...
const agentHandlers = {
  agent: async ({ params, respond, context, client, isWebchatConnect }) => {
    ...
    const requestedBestEffortDeliver =
      typeof request.bestEffortDeliver === "boolean" ? request.bestEffortDeliver : void 0;
    ...
    if (Object.prototype.hasOwnProperty.call(request, "voiceWakeTrigger") && canAutoRouteVoiceWake)
      try {
    ...
    if (resetCommandMatch && requestedSessionKey) {
      if (!canResetSession) {
        respond(
          false,
          void 0,
          errorShape(ErrorCodes.INVALID_REQUEST, `missing scope: ${ADMIN_SCOPE$1}`),
        );
        return;
      }
      const resetReason =
    ...
    if (requestedSessionKey) {
      ...
      const sessionId = usableRequestedSessionId
        ...
        : ((canReuseSession ? entry?.sessionId : void 0) ?? randomUUID());
      isNewSession =
        !entry ||
      ...
      const pluginOwnerId =
        entry === void 0
          ? normalizeOptionalString$1(client?.internal?.pluginRuntimeOwnerId)
          : normalizeOptionalString$1(entry.pluginOwnerId);
      ...
      if (
        ...
        resolvedGroupChannel =
          ...
          (trustRequestSelectors ? normalizedSpawned.groupChannel : void 0);
        resolvedGroupSpace =
          trustedGroup.groupSpace ??
          (trustRequestSelectors ? normalizedSpawned.groupSpace : void 0);
      }
      ...
      const effectiveDeliveryFields = normalizeSessionDeliveryFields({
        deliveryContext: mergeDeliveryContext(deliveryFields.deliveryContext, requestDeliveryHint),
      });
    ...
    const explicitTo =
      normalizeOptionalString$1(request.replyTo) ?? normalizeOptionalString$1(request.to);
    ...
    const originMessageChannel =
      (normalizedTurnSource && isGatewayMessageChannel(normalizedTurnSource)
        ...
        : void 0) ??
      (client?.connect && isWebchatConnect(client.connect) ? "webchat" : resolvedChannel);
    ...
    const activeRunAbort = registerChatAbortController({
      ...
      ownerDeviceId:
        typeof client?.connect?.device?.id === "string" ? client.connect.device.id : void 0,
      kind: "agent",
    });
    const accepted = {
      runId,
  ...
  "agent.wait": async ({ params, respond, context }) => {
    ...
    if (snapshot)
      if (first.source === "lifecycle") dedupeAbortController.abort();
...
async function writeWorkspaceFileOrRespond(params) {
  ...
  try {
    await (
      await agentsHandlerDeps.root(params.workspaceDir)
    ).write(params.name, params.content, { encoding: "utf8" });
  } catch (err) {
...
async function readWorkspaceFileContent(workspaceDir, name) {
  try {
    return (
      await (
        await agentsHandlerDeps.root(workspaceDir)
      ).read(name, {
        hardlinks: "reject",
...
async function buildIdentityMarkdownForWrite(params) {
  ...
  if (params.preferFallbackWorkspaceContent && params.fallbackWorkspaceDir) {
    ...
    baseContent = await readWorkspaceFileContent(params.workspaceDir, DEFAULT_IDENTITY_FILENAME);
    if (baseContent === void 0 && params.fallbackWorkspaceDir)
      baseContent = await readWorkspaceFileContent(
        params.fallbackWorkspaceDir,
        DEFAULT_IDENTITY_FILENAME,
      );
  ...
  "agents.delete": async ({ params, respond, context }) => {
    ...
    if (deleteFiles) {
      const deleteWorkspace =
        findOverlappingWorkspaceAgentIds(cfg, agentId, workspaceDir).length === 0;
      await Promise.all([
...
function resolveBlockDownload(block) {
  ...
  const mimeType =
    ...
    (dataUrl ? mimeFromDataUrl(dataUrl) : void 0);
...
const artifactsHandlers = {
  ...
  "artifacts.download": async ({ params, respond }) => {
    if (!assertValidParams(params, validateArtifactsDownloadParams, "artifacts.download", respond))
      return;
    if (!requireQueryable(params, respond)) return;
    const { artifact } = await findArtifact(params);
    if (!artifact) {
...
function resolveChannelGatewayAccountId(params) {
  return (
    normalizeOptionalString$1(params.accountId) ||
...
async function logoutChannelAccount(params) {
  ...
  if (typeof result.loggedOut === "boolean" ? result.loggedOut : cleared)
...
const channelsHandlers = {
  "channels.status": async ({ params, respond, context }) => {
    ...
    const resolveRuntimeSnapshot = (channelId, accountId, defaultAccountId) => {
      ...
      const raw =
        accounts?.[accountId] ?? (accountId === defaultAccountId ? defaultRuntime : void 0);
      if (!raw) return;
      return raw;
    };
    const isAccountEnabled = (plugin, account) =>
      plugin.config.isEnabled
        ? plugin.config.isEnabled(account, cfg)
        : !account || typeof account !== "object" || account.enabled !== false;
...
function serializeArg(arg) {
  ...
  const staticChoices = Array.isArray(arg.choices)
    ? arg.choices.slice(0, 50).map(normalizeChoice)
    : void 0;
  return {
...
const commandsHandlers = {
  "commands.list": ({ params, respond, context }) => {
    ...
    const resolved = resolveAgentIdOrRespondError$1(
      params.agentId,
      respond,
      context.getRuntimeConfig(),
    );
...
function summarizeConfigValidationIssues(issues) {
  const lines = formatConfigIssueLines(issues.slice(0, MAX_CONFIG_ISSUES_IN_ERROR_MESSAGE), "", {
    normalizeRoot: true,
  })
    .map((line) => line.trim())
    .filter(Boolean);
...
const configHandlers = {
  "config.get": async ({ params, respond }) => {
    ...
    respond(
      true,
      redactConfigSnapshot(await readConfigFileSnapshot(), loadSchemaWithPlugins().uiHints),
      void 0,
    );
  },
...
async function resolveManagedDreamingCronStatus(params) {
  ...
  try {
    const managed = (await params.context.cron.list({ includeDisabled: true }))
    ...
    respond(
      true,
      {
        ...
        removedShortTermEntries: (
          await removeGroundedShortTermCandidates({
            workspaceDir: resolveAgentWorkspaceDir(cfg, agentId),
          })
        ).removed,
      },
...
function resolveEffectiveLastSeen(params) {
  ...
  for (const candidate of candidates)
    if (!newest || candidate.atMs > newest.atMs) newest = candidate;
  if (!newest) return {};
  return {
...
function buildEffectiveKnownNode(entry) {
  ...
  return {
    ...
    commands: live
      ? uniqueSortedStrings$1(live.commands)
      : uniqueSortedStrings$1(nodePairing?.commands),
...
async function listEnvironments(context) {
  ...
  return listEnvironmentSummaries(
    listKnownNodes(
...
const healthHandlers = {
  ...
  status: async ({ respond, client, params, context }) => {
    const status = await getStatusSummary({
      includeSensitive: (Array.isArray(client?.connect?.scopes)
...
const modelsAuthStatusHandlers = {
  "models.authStatus": async ({ params, respond, context }) => {
    ...
    try {
      ...
      const result = {
        ts: now,
        providers: authHealth.providers.map((prov) =>
  ...
  const item = {
    ...
    expiresAtMs:
      typeof params.expiresInMs === "number" && Number.isFinite(params.expiresInMs)
        ? nowMs + Math.max(1e3, Math.trunc(params.expiresInMs))
        : null,
...
function parseScopes(client) {
  return Array.isArray(client?.connect?.scopes)
    ? client.connect.scopes.filter((scope) => typeof scope === "string")
    : [];
}
...
function evaluateSystemRunApprovalMatch(params) {
  ...
  if (!expectedBinding)
    return missingSystemRunApprovalBinding({ actualEnvKeys: actualBinding.envKeys });
...
function sanitizeSystemRunParamsForForwarding(opts) {
  ...
  if ((typeof opts.nowMs === "number" ? opts.nowMs : Date.now()) > snapshot.expiresAtMs)
    return systemRunApprovalGuardError({
  ...
  if (snapshotDeviceId) {
    ...
    !canBridgeNoDeviceApprovalFromBackend({
      snapshot,
      client: opts.client,
    })
  )
  ...
  if (
    snapshot.resolvedAtMs !== void 0 &&
    snapshot.decision === void 0 &&
...
function resolveAllowedPendingNodeActions(params) {
  ...
  if (allowed.length !== pending.length)
    if (allowed.length === 0) pendingNodeActionsById.delete(params.nodeId);
...
const nodeHandlers = {
  ...
  "node.pending.pull": async ({ params, respond, client, context }) => {
    ...
    const trimmedNodeId =
      normalizeOptionalString$1(client?.connect?.device?.id ?? client?.connect?.client?.id) ?? "";
    if (!trimmedNodeId) {
      respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "nodeId required"));
      return;
    }
  ...
  "node.pending.ack": async ({ params, respond, client }) => {
    ...
    const ackIds = Array.from(
      new Set(
        (params.ids ?? []).map((value) => normalizeOptionalString$1(value) ?? "").filter(Boolean),
      ),
    );
    respond(
      true,
  ...
  "node.invoke": async ({ params, respond, context, client, req }) => {
    ...
    await respondUnavailableOnThrow(respond, async () => {
      ...
      if (!nodeSession) {
        ...
        context.logGateway.info(
          `node wake stage=wake1 node=${nodeId} req=${wakeReqId} available=${wake.available} throttled=${wake.throttled} path=${wake.path} durationMs=${wake.durationMs} apnsStatus=${wake.apnsStatus ?? -1} apnsReason=${wake.apnsReason ?? "-"}`,
        );
        if (wake.available) {
          ...
          context.logGateway.info(
            `node wake stage=wait1 node=${nodeId} req=${wakeReqId} reconnected=${reconnected} timeoutMs=${waitTimeoutMs} durationMs=${waitDurationMs}`,
          );
        }
        ...
        if (!nodeSession && wake.available) {
          ...
          context.logGateway.info(
            `node wake stage=wake2 node=${nodeId} req=${wakeReqId} force=true available=${retryWake.available} throttled=${retryWake.throttled} path=${retryWake.path} durationMs=${retryWake.durationMs} apnsStatus=${retryWake.apnsStatus ?? -1} apnsReason=${retryWake.apnsReason ?? "-"}`,
          );
          if (retryWake.available) {
            ...
            const waitDurationMs = Math.max(0, Date.now() - waitStartedAtMs);
            context.logGateway.info(
              `node wake stage=wait2 node=${nodeId} req=${wakeReqId} reconnected=${reconnected} timeoutMs=${waitTimeoutMs} durationMs=${waitDurationMs}`,
            );
          }
          nodeSession = context.nodeRegistry.get(nodeId);
        }
        if (!nodeSession) {
          ...
          context.logGateway.info(
            `node wake nudge node=${nodeId} req=${wakeReqId} sent=${nudge.sent} throttled=${nudge.throttled} reason=${nudge.reason} durationMs=${nudge.durationMs} apnsStatus=${nudge.apnsStatus ?? -1} apnsReason=${nudge.apnsReason ?? "-"}`,
          );
          context.logGateway.warn(
            `node wake done node=${nodeId} req=${wakeReqId} connected=false reason=not_connected totalMs=${totalDurationMs}`,
          );
          respond(
            false,
            void 0,
      ...
      if (policyResult) {
        if (!policyResult.ok) {
          respond(
            ...
            void 0,
            errorShape(
              policyResult.unavailable ? ErrorCodes.UNAVAILABLE : ErrorCodes.INVALID_REQUEST,
        ...
        emitTalkPttNodeEvent({
          ...
          nodeId,
          command,
          payload: policyResult.payloadJSON
      ...
      if (!res.ok) {
        if (
          ...
          const wake = await maybeWakeNodeWithApns(nodeId, { cfg });
          context.logGateway.info(
            `node pending queued node=${nodeId} req=${req.id} command=${command} queuedId=${queued.id} wakePath=${wake.path} wakeAvailable=${wake.available}`,
          );
          respond(
            false,
            void 0,
    ...
    const payloadJSON =
      typeof p.payloadJSON === "string"
        ...
        : p.payload !== void 0
          ...
          : null;
    await respondUnavailableOnThrow(respond, async () => {
      const { handleNodeEvent } = await import("./server-node-events-BdgiqQOh.js");
  ...
  "node.pending.enqueue": async ({ params, respond, context }) => {
    ...
    await respondUnavailableOnThrow(respond, async () => {
      ...
      if (p.wake !== false && !queued.deduped && !context.nodeRegistry.get(p.nodeId)) {
        ...
        context.logGateway.info(
          `node pending wake stage=wake1 node=${p.nodeId} req=${wakeReqId} available=${wake.available} throttled=${wake.throttled} path=${wake.path} durationMs=${wake.durationMs} apnsStatus=${wake.apnsStatus ?? -1} apnsReason=${wake.apnsReason ?? "-"}`,
        );
        ...
        if (wake.available) {
          ...
          context.logGateway.info(
            `node pending wake stage=wait1 node=${p.nodeId} req=${wakeReqId} reconnected=${reconnected} timeoutMs=${NODE_WAKE_RECONNECT_WAIT_MS}`,
          );
        }
        if (!context.nodeRegistry.get(p.nodeId) && wake.available) {
          ...
          context.logGateway.info(
            `node pending wake stage=wake2 node=${p.nodeId} req=${wakeReqId} force=true available=${retryWake.available} throttled=${retryWake.throttled} path=${retryWake.path} durationMs=${retryWake.durationMs} apnsStatus=${retryWake.apnsStatus ?? -1} apnsReason=${retryWake.apnsReason ?? "-"}`,
          );
          if (retryWake.available) {
            const reconnected = await waitForNodeReconnect({
              nodeId: p.nodeId,
            ...
            context.logGateway.info(
              `node pending wake stage=wait2 node=${p.nodeId} req=${wakeReqId} reconnected=${reconnected} timeoutMs=${NODE_WAKE_RECONNECT_RETRY_WAIT_MS}`,
            );
          }
        }
        if (!context.nodeRegistry.get(p.nodeId)) {
          ...
          context.logGateway.info(
            `node pending wake nudge node=${p.nodeId} req=${wakeReqId} sent=${nudge.sent} throttled=${nudge.throttled} reason=${nudge.reason} durationMs=${nudge.durationMs} apnsStatus=${nudge.apnsStatus ?? -1} apnsReason=${nudge.apnsReason ?? "-"}`,
          );
          context.logGateway.warn(
...
async function loadState(baseDir) {
  return (
    (await tryReadJson(resolveWebPushStatePath(baseDir))) ?? { subscriptionsByEndpointHash: {} }
  );
}
...
async function sendPreparedWebPushNotification(webPush, subscription, payload) {
  ...
  try {
    ...
    const statusCode =
      typeof err === "object" && err !== null && "statusCode" in err ? err.statusCode : void 0;
    const message =
      typeof err === "object" && err !== null && "message" in err ? err.message : "unknown error";
    return {
      ok: false,
      subscriptionId: subscription.subscriptionId,
      statusCode,
...
const sendHandlers = {
  ...
  send: async ({ params, respond, context, client }) => {
    ...
    const mediaUrls = Array.isArray(request.mediaUrls)
      ? request.mediaUrls
          .map((entry) => normalizeOptionalString$1(entry))
      ...
      work: (async () => {
        try {
          ...
          const mirrorProjection = projectOutboundPayloadPlanForMirror(
            createOutboundPayloadPlan(outboundPayloads),
          );
          ...
          const shouldUseDerivedThreadSessionKey =
            channel === "slack" &&
            !!providedSessionKey &&
            !!normalizeOptionalString$1(derivedRoute?.threadId) &&
...
async function loadOptionalSessionsListModelCatalog(context) {
  ...
  try {
    const result = await Promise.race([
      context.loadGatewayModelCatalog().catch(() => void 0),
      timeoutPromise,
    ]);
    if (result === timedOut) {
  ...
  return {
    ...
    totalTokens:
      typeof params.totalTokens === "number" && Number.isFinite(params.totalTokens)
        ...
        : void 0,
    totalTokensFresh:
      typeof params.totalTokens === "number" && Number.isFinite(params.totalTokens) ? true : void 0,
...
function ensureSessionTranscriptFile(params) {
  try {
    const transcriptPath = resolveSessionFilePath(
      params.sessionId,
      params.sessionFile ? { sessionFile: params.sessionFile } : void 0,
...
const sessionsHandlers = {
  ...
  "sessions.preview": ({ params, respond, context }) => {
    ...
    const keys = (Array.isArray(p.keys) ? p.keys : [])
      .map((key) => normalizeOptionalString$1(key ?? ""))
  ...
  "sessions.create": async ({ req, params, respond, context, client, isWebchatConnect }) => {
    ...
    const agentId = normalizeAgentId(
      normalizeOptionalString$1(p.agentId) ?? resolveDefaultAgentId(cfg),
    );
    if (requestedKey) {
      ...
      if (
        ...
        normalizeOptionalString$1(p.agentId)
      ) {
        respond(
          false,
          void 0,
  ...
  "sessions.abort": async ({ req, params, respond, context, client, isWebchatConnect }) => {
    ...
    const keyCandidate =
      p.key ??
      (requestedRunId ? context.chatAbortControllers.get(requestedRunId)?.sessionKey : void 0) ??
      (requestedRunId ? resolveSessionKeyForRun(requestedRunId) : void 0);
      ...
      respond: (ok, payload, error, meta) => {
        ...
        const firstAbortedRunId =
          (payload && typeof payload === "object" && Array.isArray(payload.runIds)
            ? payload.runIds.filter((value) => Boolean(normalizeOptionalString$1(value)))
            : [])[0] ?? null;
  ...
  "sessions.pluginPatch": async ({ params, respond, context, client, isWebchatConnect }) => {
    ...
    if (
      ...
      respond(
        ...
        errorShape(
          ErrorCodes.INVALID_REQUEST,
          `sessions.pluginPatch requires gateway scope: ${ADMIN_SCOPE$1}`,
        ),
      );
      return;
    }
  ...
  "sessions.get": async ({ params, respond, context }) => {
    ...
    const entry = resolveFreshestSessionEntryFromStoreKeys(
  ...
  "sessions.compact": async ({ req, params, respond, context, client, isWebchatConnect }) => {
    ...
    if (maxLines === void 0) {
      ...
      const workspaceDir =
        normalizeOptionalString$1(entry?.spawnedWorkspaceDir) ||
...
const skillsHandlers = {
  "skills.status": ({ params, respond, context }) => {
    ...
    respond(
      true,
      buildWorkspaceSkillStatus(resolveAgentWorkspaceDir(cfg, agentId), {
        config: cfg,
        eligibility: {
    ...
    if (params && typeof params === "object" && "source" in params && params.source === "clawhub") {
      ...
      respond(
        ...
        result.ok
          ...
          : result,
        result.ok ? void 0 : errorShape(ErrorCodes.UNAVAILABLE, result.error),
      );
      return;
    }
    const p = params;
  ...
  "system-event": ({ params, respond, context }) => {
    ...
    if (text.startsWith("Node:")) {
      ...
      if (hostChanged || ipChanged || versionChanged || modeChanged || reasonChanged) {
        ...
        if (versionChanged)
          parts.push(`app ${normalizeOptionalString$1(next.version) ?? "unknown"}`);
        if (modeChanged) parts.push(`mode ${normalizeOptionalString$1(next.mode) ?? "unknown"}`);
        if (reasonChanged)
          parts.push(`reason ${normalizeOptionalString$1(reasonValue) ?? "event"}`);
...
function pruneExpiredRelaySessions(nowMs = Date.now()) {
  for (const session of relaySessions.values())
    if (nowMs > session.expiresAtMs) closeRelaySession(session, "completed");
}
...
function sendTalkRealtimeRelayAudio(params) {
  if (params.audioBase64.length > MAX_AUDIO_BASE64_BYTES$1)
...
function registerTalkRealtimeRelayAgentRun(params) {
  getRelaySession(params.relaySessionId, params.connId).activeAgentRuns.set(
    params.runId,
    params.sessionKey,
  );
}
...
function getVoiceCallRealtimeConfig(config) {
  const realtime = getRecord(
    getRecord(getRecord(getRecord(getRecord(config.plugins)?.entries)?.["voice-call"])?.config)
      ?.realtime,
  );
...
function buildTalkRealtimeConfig(config, requestedProvider) {
  ...
  return {
    provider:
      normalizeOptionalString$1(requestedProvider) ??
      normalizeOptionalString$1(talkRealtime?.provider) ??
...
function resolveConfiguredRealtimeTranscriptionProvider(params) {
  ...
  const orderedProviders = normalizedConfigured
    ...
    : providers.toSorted((a, b) => (a.autoSelectOrder ?? 1e3) - (b.autoSelectOrder ?? 1e3));
...
async function startRealtimeToolCallAgentConsult(params) {
  ...
  const runId =
    normalizeOptionalString$1(asOptionalRecord(chatResponse.result)?.runId) ?? idempotencyKey;
...
function joinTalkHandoff(id, token, opts = {}) {
  ...
  const replacedClientId =
    previousClientId && previousClientId !== opts.clientId ? previousClientId : void 0;
...
function pruneExpiredTranscriptionSessions(nowMs = Date.now()) {
  for (const session of transcriptionSessions.values())
    if (nowMs > session.expiresAtMs) closeTranscriptionSession(session, "completed");
}
      ...
      if (transport === "managed-room") {
        if (brain === "direct-tools" && !canUseTalkDirectTools(client)) {
          respond(
            ...
            errorShape(
              ErrorCodes.INVALID_REQUEST,
              `talk.session.create brain="direct-tools" requires gateway scope: ${ADMIN_SCOPE$1}`,
            ),
          );
          return;
        }
...
function asStringRecord(value) {
  ...
  for (const [key, entryValue] of Object.entries(record))
    if (typeof entryValue === "string") next[key] = entryValue;
...
function resolveTalkVoiceId(providerConfig, requested) {
  ...
  for (const [alias, voiceId] of Object.entries(aliases))
    if (normalizeAliasKey(alias) === normalizedRequested) return voiceId;
  return requested;
}
...
function buildTalkCatalog(config) {
  ...
  const activeSpeechProvider = canonicalizeSpeechProviderId(
    resolveActiveTalkProviderConfig(config.talk)?.provider,
    config,
  );
  const streamingConfig = getVoiceCallStreamingConfig(config);
  ...
  return {
    ...
    realtime: {
      ...
      providers: listRealtimeVoiceProviders(config).map((provider) => {
        ...
        if (capabilities?.supportsBargeIn !== void 0)
          entry.supportsBargeIn = capabilities.supportsBargeIn;
        if (capabilities?.supportsToolCalls !== void 0)
          entry.supportsToolCalls = capabilities.supportsToolCalls;
        if (capabilities?.supportsVideoFrames !== void 0)
          entry.supportsVideoFrames = capabilities.supportsVideoFrames;
        if (capabilities?.supportsSessionResumption !== void 0)
...
function resolveTalkSpeed(params) {
  ...
  if (resolved <= 0.5 || resolved >= 2) return;
  return resolved;
}
function buildTalkSpeakOverrides(provider, providerConfig, config, params) {
  ...
  const resolvedVoiceId = resolveTalkVoiceId(
    providerConfig,
    normalizeOptionalString$1(params.voiceId),
  );
...
function resolveTalkResponseFromConfig(params) {
  ...
  const provider = canonicalizeSpeechProviderId(
    sourceResolved?.provider ?? runtimeResolved?.provider,
  ...
  const responseConfig =
    sourceProviderConfig.apiKey === void 0
      ? resolvedConfig
      : {
          ...resolvedConfig,
...
function buildPluginGroups(params) {
  ...
  for (const tool of pluginTools) {
    ...
    existing.tools.push({
      id: tool.name,
      label:
        normalizeOptionalString$1(ownedMetadata?.displayName) ??
        normalizeOptionalString$1(tool.label) ??
        tool.name,
  ...
  for (const entry of activeRegistry?.tools ?? []) {
    ...
    for (const name of names) {
      ...
      existing.tools.push({
        ...
        description:
          summarizeToolDescriptionText({ rawDescription: ownedMetadata?.description }) ||
  ...
  "tools.effective": async ({ params, respond, client, context }) => {
    ...
    const trustedContext = resolveTrustedToolsEffectiveContext({
      ...
      senderIsOwner: Array.isArray(client?.connect?.scopes)
        ? client.connect.scopes.includes(ADMIN_SCOPE$1)
        : false,
      respond,
    });
...
const ttsHandlers = {
  ...
  "tts.setProvider": async ({ params, respond, context }) => {
    const cfg = context.getRuntimeConfig();
    const provider = canonicalizeSpeechProviderId(
      normalizeOptionalString$1(params.provider) ?? "",
      cfg,
    );
...
const getTodayStartMs = (now, interpretation) => {
  ...
  if (interpretation.mode === "specific") {
    ...
    return (
      ...
      interpretation.utcOffsetMinutes * 60 * 1e3
    );
  }
...
function mergeSessionUsageInto(target, source) {
  ...
  target.firstActivity =
    target.firstActivity === void 0
      ? source.firstActivity
      : source.firstActivity === void 0
        ? target.firstActivity
        : Math.min(target.firstActivity, source.firstActivity);
  target.lastActivity =
    target.lastActivity === void 0
      ? source.lastActivity
      : source.lastActivity === void 0
        ? target.lastActivity
        : Math.max(target.lastActivity, source.lastActivity);
  if (target.firstActivity !== void 0 && target.lastActivity !== void 0)
...
function mergeUsageCacheStatus(target, source) {
  ...
  return {
    ...
    refreshedAt:
      target.refreshedAt === void 0
        ? source.refreshedAt
        : source.refreshedAt === void 0
          ? target.refreshedAt
...
const voicewakeRoutingHandlers = {
  ...
  "voicewake.routing.set": async ({ params, respond, context }) => {
    ...
    try {
      const config = await setVoiceWakeRoutingConfig(
        normalizeVoiceWakeRoutingConfig(params.config),
      );
  ...
  "web.login.wait": async ({ params, respond, context }) => {
    ...
    try {
      ...
      const result = await provider.gateway.loginWithQrWait({
        ...
        accountId,
        currentQrDataUrl:
          typeof params.currentQrDataUrl === "string" ? params.currentQrDataUrl : void 0,
      });
      if (result.connected) await context.startChannel(provider.id, accountId);
      respond(true, result, void 0);
    } catch (err) {
