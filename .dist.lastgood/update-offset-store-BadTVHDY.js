...
function safeParseState(parsed) {
  try {
    ...
    if (state.version === STORE_VERSION && state.botId !== null && typeof state.botId !== "string")
      return null;
    return {
...
//#endregion
export {
  readTelegramUpdateOffset as n,
  writeTelegramUpdateOffset as r,
  deleteTelegramUpdateOffset as t,
};
