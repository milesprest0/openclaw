...
import { i as resolveSlackChannelId, r as parseSlackTarget } from "./target-parsing-CoqR8Hoa.js";
...
function loadSlackActionsRuntime() {
  slackActionsRuntimePromise ??= import("./actions.runtime-BCfCCUrl.js");
  return slackActionsRuntimePromise;
}
function loadSlackAccountsRuntime() {
  slackAccountsRuntimePromise ??= import("./accounts.runtime-_kvU7-5c.js");
...
async function handleSlackAction(params, cfg, context) {
  const resolveChannelId = () =>
    resolveSlackChannelId(readStringParam(params, "channelId", { required: true }));
