...
async function resolveAgentId(params) {
  ...
  const { resolveDefaultAgentId } = await import("./agent-scope-Bm8ZjMdO.js");
...
function buildUsage(params) {
  ...
  return {
    ...
    ...(params.normalized?.cacheRead !== void 0
      ? { cacheReadTokens: params.normalized.cacheRead }
      : {}),
    ...(params.normalized?.cacheWrite !== void 0
...
function resolveAuthorityModelPolicy(authority) {
  if (
    ...
    authority?.allowedModels === void 0
  )
    return;
  ...
  return {
    complete: async (params) => {
      ...
      const [
        ...
        import("./simple-completion-runtime-DDe_gAdm.js"),
      ...
      if (requestedModel) {
        ...
        assertAllowedModelOverride({
          resolvedModelRef: normalizedSelection
