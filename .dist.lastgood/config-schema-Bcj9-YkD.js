...
import { a as MSTeamsConfigSchema } from "./zod-schema.providers-whatsapp-O9hejQx6.js";
import "./bundled-channel-config-schema-Bjz3wbg7.js";
//#endregion
//#region extensions/msteams/src/config-schema.ts
const MSTeamsChannelConfigSchema = buildChannelConfigSchema(MSTeamsConfigSchema, {
  uiHints: {
    "": {
      label: "MS Teams",
