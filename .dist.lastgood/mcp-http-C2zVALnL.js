...
import { s as checkBrowserOrigin } from "./auth-D_VLzYQI.js";
import { t as isTruthyEnvValue } from "./env-GyTZ5xFK.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { a as getHeader } from "./http-auth-utils-QDjCKoNp.js";
...
import { r as isLoopbackAddress } from "./net-BQYp2xgJ.js";
import { c as runBeforeToolCallHook } from "./pi-tools.before-tool-call-KxT3QmrR.js";
...
import { t as resolveGatewayScopedTools } from "./tool-resolution-CoB4RZPb.js";
  ...
  switch (method) {
    ...
    case "tools/call": {
      ...
      try {
        ...
        return jsonRpcResult(id, {
          content: normalizeToolCallContent(
            await tool.execute(toolCallId, hookResult.params, params.signal),
          ),
          isError: false,
        });
      } catch (error) {
...
function resolveMcpRequestContext(req, cfg, auth) {
  return {
    ...
    messageProvider:
      normalizeMessageChannel(getHeader(req, "x-openclaw-message-channel")) ?? void 0,
...
var McpLoopbackToolCache = class {
  ...
  resolve(params) {
    ...
    for (const [key, entry] of this.#entries)
      if (now - entry.time >= TOOL_CACHE_TTL_MS) this.#entries.delete(key);
    return nextEntry;
  }
};
//#endregion
...
async function closeMcpLoopbackServer() {
  const server =
    ...
    (activeMcpLoopbackServerPromise ? await activeMcpLoopbackServerPromise : void 0);
  if (!server) return;
...
//#endregion
export {
  getActiveMcpLoopbackRuntime as a,
  createMcpLoopbackServerConfig as i,
  ensureMcpLoopbackServer as n,
  startMcpLoopbackServer as r,
  closeMcpLoopbackServer as t,
};
