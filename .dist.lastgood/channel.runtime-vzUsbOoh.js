...
import { t as collectZalouserSecurityAuditFindings } from "./security-audit-Cp6OkmZw.js";
import { a as sendReactionZalouser, i as sendMessageZalouser } from "./send-BoM09TMf.js";
import {
  ...
  try {
    const user = timeoutMs
      ? await Promise.race([
          ...
          new Promise((resolve) => setTimeout(() => resolve(null), Math.max(timeoutMs, 1e3))),
        ])
