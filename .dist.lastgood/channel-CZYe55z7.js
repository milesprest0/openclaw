...
import { i as createHybridChannelConfigAdapter } from "./channel-config-helpers-DVht29vx.js";
...
} from "./doctor-contract-Cnjt0ZqS.js";
...
import {
  a as tlonSetupAdapter,
  d as formatTargetHint,
  f as normalizeShip,
  h as resolveTlonOutboundTarget,
  l as listTlonAccountIds,
  m as parseTlonTarget,
  n as createTlonSetupWizardBase,
  u as resolveTlonAccount,
} from "./setup-core-CZX2V6Pa.js";
import {
...
const TlonAuthorizationSchema = zod_exports.z.object({
  channelRules: zod_exports.z.record(zod_exports.z.string(), TlonChannelRuleSchema).optional(),
});
const TlonNetworkSchema = zod_exports.z
...
const tlonChannelConfigSchema = buildChannelConfigSchema(
...
const loadTlonChannelRuntime = createLazyRuntimeModule(
  () => import("./channel.runtime-xZtAJNyP.js"),
);
