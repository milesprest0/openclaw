...
import { i as emitAgentEvent, l as onAgentEvent } from "./agent-events-c6-2eZvI.js";
import { J as isClientToolNameConflictError } from "./context-budget-CZcqCu6a.js";
import { t as createDefaultDeps } from "./deps-C1pDH524.js";
import { i as wrapExternalContent } from "./external-content-BCW9yxs8.js";
import { t as renderFileContextBlock } from "./file-context-C-dgJaIS.js";
import {
  a as getHeader,
  i as getBearerToken,
...
import {
  c as watchClientDisconnect,
  i as sendJson,
  l as writeDone,
  s as setSseHeaders,
} from "./http-common-CyzMuYsM.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-DdgG-3bY.js";
import {
  a as resolveGatewayRequestContext,
  o as resolveOpenAiCompatModelOverride,
  r as resolveAgentIdForRequest,
} from "./http-utils-Bf9U2GTJ.js";
import {
  n as buildAgentMessageFromConversationEntries,
  r as resolveAssistantStreamDeltaText,
  t as normalizeInputHostnameAllowlist,
} from "./input-allowlist-Dzxf53sO.js";
import {
  a as extractImageContentFromSource,
  c as resolveInputFileLimits,
  i as extractFileContentFromSource,
  n as DEFAULT_INPUT_IMAGE_MIMES,
  o as normalizeMimeList,
} from "./input-files-CRNqZpKn.js";
...
const MessageItemSchema = z
  ...
  .superRefine((value, ctx) => {
    if (value.phase !== void 0 && value.role !== "assistant")
      ctx.addIssue({
...
const CreateResponseBodySchema = z
  .object({
    model: z.string(),
        ...
        if (item.type === "message" && typeof item.content !== "string")
          for (const part of item.content) {
            if (part.type === "input_image") {
              ...
              const sourceType =
                source.type === "base64" || source.type === "url" ? source.type : void 0;
              if (!sourceType)
