...
function respondUnavailableOnNodeInvokeError(respond, res) {
  ...
  respond(
    false,
    void 0,
    errorShape(ErrorCodes.UNAVAILABLE, message, { details: { nodeError: res.error ?? null } }),
  );
  return false;
}
//#endregion
export {
  respondUnavailableOnNodeInvokeError as n,
  respondUnavailableOnThrow as r,
  respondInvalidParams as t,
};
