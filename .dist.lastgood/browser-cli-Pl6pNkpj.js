...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-DxSkwxV7.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-DjTKEsJd.js";
...
import { i as registerCommandGroups } from "./register-command-groups-D7CQZkOy.js";
...
const browserCommandGroupDefinitions = [
  {
    ...
    register: async (args) => {
      (await import("./browser-cli-manage-CPNXDwVl.js")).registerBrowserManageCommands(
        args.browser,
        args.parentOpts,
      );
    },
  },
  {
    ...
    register: async (args) => {
      (await import("./browser-cli-inspect-DQ_kYaeK.js")).registerBrowserInspectCommands(
        args.browser,
        args.parentOpts,
      );
    },
  },
  {
    ...
    register: async (args) => {
      (await import("./browser-cli-actions-input-BpUQKpRy.js")).registerBrowserActionInputCommands(
        args.browser,
        args.parentOpts,
      );
    },
  },
  {
    ...
    register: async (args) => {
      (
        await import("./browser-cli-actions-observe-LSax-Thn.js")
      ).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
    },
  },
  {
    placeholders: [
    ...
    register: async (args) => {
      (await import("./browser-cli-debug-Djzvwmfe.js")).registerBrowserDebugCommands(
        args.browser,
        args.parentOpts,
      );
    },
  },
  {
    ...
    register: async (args) => {
      (await import("./browser-cli-state-CCW6Mq8Y.js")).registerBrowserStateCommands(
        args.browser,
        args.parentOpts,
      );
    },
