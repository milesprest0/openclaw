...
function externalCliDiscoveryExisting(params) {
  return {
    mode: "existing",
    ...(params?.allowKeychainPrompt !== void 0
...
//#endregion
export {
  externalCliDiscoveryNone as a,
  externalCliDiscoveryForProviders as i,
  externalCliDiscoveryForConfigStatus as n,
  externalCliDiscoveryScoped as o,
  externalCliDiscoveryForProviderAuth as r,
  externalCliDiscoveryExisting as t,
};
