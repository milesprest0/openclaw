...
function listAvailableManifestContractValues(params) {
  ...
  for (const plugin of listAvailableManifestContractPlugins(params))
    for (const value of plugin.contracts?.[params.contract] ?? []) values.add(value);
...
//#endregion
export {
  loadManifestContractSnapshot as a,
  listAvailableManifestContractValues as i,
  isManifestPluginAvailableForControlPlane as n,
  loadManifestMetadataRegistry as o,
  listAvailableManifestContractPlugins as r,
  loadManifestMetadataSnapshot as s,
  hasManifestContractValue as t,
};
