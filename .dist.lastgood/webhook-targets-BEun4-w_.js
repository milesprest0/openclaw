...
import { i as beginWebhookRequestPipelineOrReject } from "./webhook-request-guards-B2YGM1vD.js";
...
async function resolveWebhookTargetWithAuthOrReject(params) {
  return resolveWebhookTargetMatchOrReject(
    params,
    await resolveSingleWebhookTargetAsync(params.targets, async (target) => params.isMatch(target)),
  );
}
...
function resolveWebhookTargetWithAuthOrRejectSync(params) {
  return resolveWebhookTargetMatchOrReject(
    params,
    resolveSingleWebhookTarget(params.targets, params.isMatch),
  );
}
...
//#endregion
export {
  resolveSingleWebhookTargetAsync as a,
  resolveWebhookTargets as c,
  resolveSingleWebhookTarget as i,
  withResolvedWebhookRequestPipeline as l,
  registerWebhookTargetWithPluginRoute as n,
  resolveWebhookTargetWithAuthOrReject as o,
  rejectNonPostWebhookRequest as r,
  resolveWebhookTargetWithAuthOrRejectSync as s,
  registerWebhookTarget as t,
};
