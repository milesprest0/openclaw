import { t as applyModelCompatPatch } from "./provider-model-compat-DIuSGYN-.js";
  ...
  for (const [key, value] of Object.entries(record)) {
    const next = OPENAI_STRICT_COMPAT_SCHEMA_MAP_KEYS.has(key)
      ...
      : OPENAI_STRICT_COMPAT_SCHEMA_NESTED_KEYS.has(key)
        ? normalizeOpenAIStrictCompatSchemaRecursive(value, { promoteEmptyObject: false })
        : value;
    normalized[key] = next;
    changed ||= next !== value;
  }
...
//#endregion
export {
  buildProviderToolCompatFamilyHooks as a,
  inspectGeminiToolSchemas as c,
  normalizeOpenAIToolSchemas as d,
  resolveXaiModelCompatPatch as f,
  cleanSchemaForGemini as g,
  GEMINI_UNSUPPORTED_SCHEMA_KEYWORDS as h,
  applyXaiModelCompat as i,
  inspectOpenAIToolSchemas as l,
  stripXaiUnsupportedKeywords as m,
  XAI_TOOL_SCHEMA_PROFILE as n,
  findOpenAIStrictSchemaViolations as o,
  stripUnsupportedSchemaKeywords as p,
  XAI_UNSUPPORTED_SCHEMA_KEYWORDS as r,
  findUnsupportedSchemaKeywords as s,
  HTML_ENTITY_TOOL_CALL_ARGUMENTS_ENCODING as t,
  normalizeGeminiToolSchemas as u,
};
