...
const PROFILE_CANDIDATES = [".profile", ".zprofile", ".zshrc", ".bashrc"];
const LEGACY_TALK_FIELD_KEYS = ["voiceId", "voiceAliases", "modelId", "outputFormat", "apiKey"];
...
//#endregion
export {
  migrateElevenLabsLegacyTalkConfig as n,
  resolveElevenLabsApiKeyWithProfileFallback as r,
  ELEVENLABS_TALK_PROVIDER_ID as t,
};
