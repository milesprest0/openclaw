...
import { t as buildPluginApi } from "./api-builder-BOwvO8iy.js";
import {
  C as sanitizeCommandDescriptorDescription,
  S as normalizeCommandDescriptorName,
} from "./argv-DQxa_OA3.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-DDI2KSPG.js";
import { m as normalizeChannelMeta } from "./bundled-Ca60V8y0.js";
import { r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-uu7_tUkL.js";
import { n as listChatChannels } from "./chat-meta-CUH0ZInO.js";
import "./boundary-file-read-CkGowAmx.js";
import {
  a as resolveSessionStoreKey,
  i as resolveSessionStoreAgentId,
...
} from "./detached-task-runtime-state-CRuVyWwI.js";
import {
  P as shouldRejectHardlinkedPluginFiles,
  t as discoverOpenClawPlugins,
} from "./discovery-bnS95tO3.js";
import {
  G as resolveMemoryDreamingConfig,
  K as resolveMemoryDreamingPluginConfig,
  _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID,
} from "./dreaming-BDr8qIGr.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-CwlQAnfR.js";
import { r as withPluginRuntimePluginIdScope } from "./gateway-request-scope-Bc6xXkxi.js";
...
import { i as normalizeSessionEntrySlotKey } from "./host-hook-cleanup-BITs3oqS.js";
import "./installed-plugin-index-records-BD2sKB0z.js";
import {
  n as normalizePluginHttpPath,
  t as findOverlappingPluginHttpRoute,
} from "./http-route-overlap-DL7a1slB.js";
import {
  g as isPluginEnabledByDefaultForPlatform,
  p as collectPluginManifestCompatCodes,
} from "./installed-plugin-index-store-YgBbP4mp.js";
import {
  f as registerInternalHook,
  h as unregisterInternalHook,
} from "./internal-hooks-x_v10zI-.js";
import { f as writeJsonSync, u as tryReadJsonSync } from "./json-files-DifBk3kt.js";
import {
  a as resolveSetupChannelRegistration,
  i as resolveBundledRuntimeChannelRegistration,
  n as loadBundledRuntimeChannelPlugin,
  o as shouldLoadChannelPluginInSetupRuntime,
  r as mergeSetupRuntimeChannelPlugin,
  t as channelPluginIdBelongsToManifest,
} from "./loader-channel-setup-B38q2cQe.js";
import { n as resolveAgentMainSessionKey } from "./main-session-BttihmeO.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-DJ43wWua.js";
import {
  a as listRegisteredMemoryEmbeddingProviders,
  o as registerMemoryEmbeddingProvider,
  r as getRegisteredMemoryEmbeddingProvider,
  s as restoreRegisteredMemoryEmbeddingProviders,
  t as clearMemoryEmbeddingProviders,
} from "./memory-embedding-providers-qSONi9MJ.js";
import {
  S as restoreMemoryPluginState,
  _ as registerMemoryPromptSectionForPlugin,
  b as registerMemoryRuntimeForPlugin,
  d as listMemoryPromptSupplements,
  f as registerMemoryCapability,
  h as registerMemoryFlushPlanResolverForPlugin,
  ...
  v as registerMemoryPromptSupplement,
} from "./memory-state-BfIgqH24.js";
import { t as unwrapDefaultModuleExport } from "./module-export-CpPaSiil.js";
import {
  i as NODE_SYSTEM_RUN_COMMANDS,
  n as NODE_EXEC_APPROVALS_COMMANDS,
  r as NODE_SYSTEM_NOTIFY_COMMAND,
} from "./node-commands-QY1Hbd8Q.js";
import { s as isOperatorScope } from "./operator-scopes-Codapd9g.js";
import {
  i as hasExplicitPluginIdScope,
  o as normalizePluginIdScope,
  r as createPluginIdScopeSet,
  s as serializePluginIdScope,
} from "./package-state-probes-DwIK9Kbe.js";
import { d as safeRealpathSync, f as safeStatSync, i as isPathInside } from "./path-1liOXr_N.js";
import { u as resolveStorePath } from "./paths-CfeECf6Z.js";
import { t as PluginLruCache } from "./plugin-cache-primitives-BzJqZ6Iq.js";
import { i as withProfile } from "./plugin-load-profile-ByUHrmZ9.js";
import {
  i as fingerprintPluginDiscoveryContext,
  o as resolvePluginDiscoveryContext,
} from "./plugin-metadata-snapshot-C2hpt3LY.js";
import {
  n as getCachedPluginModuleLoader,
  s as toSafeImportPath,
  t as createPluginModuleLoaderCache,
} from "./plugin-module-loader-cache-7MZ9xfuO.js";
import { t as createPluginStateKeyedStore } from "./plugin-state-store-CQXPZ-Hk.js";
import {
  a as listRegisteredAgentHarnesses,
  c as restoreRegisteredAgentHarnesses,
  o as registerAgentHarness,
  r as getRegisteredAgentHarness,
  t as clearAgentHarnesses,
} from "./registry-D11nh-V3.js";
import {
  r as registerContextEngineForOwner,
  t as clearContextEnginesForOwner,
} from "./registry-sQP5dNFn.js";
import { i as openRootFileSync } from "./root-file-B8t_jFqF.js";
import {
  A as buildPluginAgentTurnPrepareContext,
  E as getPluginSessionSchedulerJobGeneration,
  M as isPluginJsonValue,
  O as registerPluginSessionSchedulerJob,
  P as createEmptyPluginRegistry,
  S as isPluginRegistryRetired,
  T as getPluginRunContext,
  a as getActivePluginRegistry,
  j as normalizePluginHostHookId,
  k as setPluginRunContext,
  l as getActivePluginRuntimeSubagentMode,
  o as getActivePluginRegistryKey,
  p as recordImportedPluginId,
  w as clearPluginRunContext,
  x as setActivePluginRegistry,
...
import { t as validateJsonSchemaValue } from "./schema-validator-B-Gm6l2v.js";
import {
  a as listPluginSdkAliasCandidates,
  c as resolveExtensionApiAlias,
  f as resolvePluginRuntimeModulePath,
  g as shouldPreferNativeModuleLoad,
  h as resolvePluginSdkScopedAliasMap,
  m as resolvePluginSdkAliasFile,
  n as buildPluginLoaderJitiOptions,
  o as listPluginSdkExportedSubpaths,
  p as resolvePluginSdkAliasCandidateOrder,
  t as buildPluginLoaderAliasMap,
} from "./sdk-alias-B6hytWos.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-DwcRLyGF.js";
...
import { l as normalizeTrimmedStringList } from "./string-normalization-B6JUy5-Y.js";
import { t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
import { r as resolveAllAgentSessionStoreTargetsSync } from "./targets-CSZl-lN0.js";
import {
  a as normalizeAgentToolResultMiddlewareRuntimeIds,
  n as normalizePluginToolContractNames,
  o as normalizeAgentToolResultMiddlewareRuntimes,
  r as normalizePluginToolNames,
  t as findUndeclaredPluginToolNames,
} from "./tool-contracts-Bt9vhWFl.js";
import {
  A as pluginCommands,
  ...
  j as restorePluginCommands,
  k as listRegisteredPluginCommands,
  ...
  u as isReservedCommandName,
  v as listPluginInteractiveHandlers,
...
function findStoreKeysIgnoreCase(store, targetKey) {
  ...
  for (const key of Object.keys(store))
    if (normalizeLowercaseStringOrEmpty(key) === lowered) matches.push(key);
  return matches;
}
...
async function patchPluginSessionExtension(params) {
  ...
  const registration = (getActivePluginRegistry()?.sessionExtensions ?? []).find(
...
function normalizeOnboardingScopes(values) {
  const normalized = Array.from(
    new Set(
      (values ?? []).filter((value) => value === "text-inference" || value === "image-generation"),
    ),
  );
  return normalized.length > 0 ? normalized : void 0;
}
...
function createPluginRegistry(registryParams) {
  ...
  const normalizeHostHookString = (value) =>
...
const fullWorkspacePluginLoaderCacheState = new PluginLoaderCacheState(
  ...
  try {
    ...
    if (shouldActivate && options.mode !== "validate") {
      ...
      if (failedPlugins.length > 0)
        logger.warn(
          `[plugins] ${failedPlugins.length} plugin(s) failed to initialize (${formatPluginFailureSummary(failedPlugins)}). Run 'openclaw plugins list' for details.`,
        );
    }
    if (cacheEnabled)
...
export {
  ...
  clearPluginRegistryLoadCache as a,
  getCompactionProvider as b,
  loadOpenClawPluginCliRegistry as c,
  resolvePluginRegistryLoadCacheKey as d,
  resolveRuntimePluginRegistry as f,
  patchPluginSessionExtension as g,
  getPluginSessionExtensionStateSync as h,
  clearPluginLoaderCache as i,
  loadOpenClawPlugins as l,
  drainPluginNextTurnInjectionContext as m,
  __testing as n,
  getRuntimePluginRegistryForLoadOptions as o,
  createPluginRegistry as p,
  clearActivatedPluginRuntimeState as r,
  isPluginRegistryLoadInFlight as s,
  PluginLoadFailureError as t,
  resolveCompatibleRuntimePluginRegistry as u,
  listCodexAppServerExtensionFactories as v,
  resolvePluginActivationSourceConfig as x,
  PluginLoadReentryError as y,
};
