...
const TextFieldSchema = objectType({
  ...
  textFieldType: enumType(["shortText", "number", "date", "longText"]).optional(),
...
const h$2 = e$6(r$2),
  m$1 =
    ...
    (t, ...m) =>
      o(
        t,
        ...m.map((o) => (o instanceof Signal.State || o instanceof Signal.Computed ? h$2(o) : o)),
      );
m$1(b);
m$1(w);
Signal.State;
...
const markdown$1 = e$6(
  class MarkdownDirective extends i$5 {
    ...
    render(value, markdownRenderer, markdownOptions) {
      if (markdownRenderer)
        return m(
          markdownRenderer(value, markdownOptions).then((value) => {
            return o(value);
          }),
