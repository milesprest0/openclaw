...
import { t as require_src$1 } from "./src-Dce2BfHT.js";
...
var require_base64url$1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  if (buffer_1$5.Buffer.isEncoding("base64url"))
    exports.encode = (input) => buffer_1$5.Buffer.from(input).toString("base64url");
  else
    exports.encode = (input) =>
      buffer_1$5.Buffer.from(input)
        .toString("base64")
        .replace(/=/g, "")
        .replace(/\+/g, "-")
        .replace(/\//g, "_");
...
var require_errors$1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.JWSSignatureVerificationFailed =
    exports.JWKSTimeout =
    exports.JWKSMultipleMatchingKeys =
    exports.JWKSNoMatchingKey =
    exports.JWKSInvalid =
    exports.JWKInvalid =
    exports.JWTInvalid =
    exports.JWSInvalid =
    exports.JWEInvalid =
    exports.JWEDecompressionFailed =
    exports.JWEDecryptionFailed =
    exports.JOSENotSupported =
    exports.JOSEAlgNotAllowed =
    exports.JWTExpired =
    exports.JWTClaimValidationFailed =
    exports.JOSEError =
      void 0;
...
var require_is_key_object = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.default = util$1.types.isKeyObject
    ? (obj) => util$1.types.isKeyObject(obj)
    : (obj) => obj != null && obj instanceof crypto_1$15.KeyObject;
});
//#endregion
  ...
  const checkCekLength = (enc, cek) => {
    ...
    switch (enc) {
      ...
      case "A256GCM":
        ...
        break;
      default:
        throw new errors_js_1.JOSENotSupported(
    ...
    if (cek instanceof Uint8Array) {
      ...
      if (actual !== expected)
        throw new errors_js_1.JWEInvalid(
...
var require_cbc_tag = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function cbcTag(aad, iv, ciphertext, macSize, macKey, keySize) {
    const macData = (0, buffer_utils_js_1.concat)(
      aad,
      iv,
      ciphertext,
      (0, buffer_utils_js_1.uint64be)(aad.length << 3),
    );
...
var require_is_key_like = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const is_key_object_js_1 = require_is_key_object();
  exports.default = (key) =>
    (0, is_key_object_js_1.default)(key) || (0, webcrypto_js_1.isCryptoKey)(key);
  const types = ["KeyObject"];
  exports.types = types;
  if (
    globalThis.CryptoKey ||
    (webcrypto_js_1.default === null || webcrypto_js_1.default === void 0
      ? void 0
      : webcrypto_js_1.default.CryptoKey)
  )
...
var require_decrypt$4 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const decrypt = (enc, cek, ciphertext, iv, tag, aad) => {
    ...
    if ((0, webcrypto_js_1.isCryptoKey)(cek)) {
      ...
      throw new TypeError(
        (0, invalid_key_input_js_1.default)(cek, ...is_key_like_js_1.types, "Uint8Array"),
      );
...
var require_zlib = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const inflate = (input) =>
    inflateRaw(input, { maxOutputLength: 25e4 }).catch(() => {
...
var require_aeskw = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function ensureKeyObject(key, alg, usage) {
    ...
    throw new TypeError(
      (0, invalid_key_input_js_1.default)(key, ...is_key_like_js_1.types, "Uint8Array"),
    );
  }
  const wrap = (alg, key, cek) => {
    ...
    const cipher = (0, crypto_1$11.createCipheriv)(
      algorithm,
      keyObject,
      buffer_1$4.Buffer.alloc(8, 166),
    );
  ...
  const unwrap = (alg, key, encryptedKey) => {
    ...
    checkKeySize(keyObject, alg);
    const cipher = (0, crypto_1$11.createDecipheriv)(
      algorithm,
      keyObject,
      buffer_1$4.Buffer.alloc(8, 166),
    );
...
var require_get_named_curve = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const invalid_key_input_js_1 = require_invalid_key_input();
  const is_key_like_js_1 = require_is_key_like();
  const p256 = buffer_1$3.Buffer.from([42, 134, 72, 206, 61, 3, 1, 7]);
  const p384 = buffer_1$3.Buffer.from([43, 129, 4, 0, 34]);
  const p521 = buffer_1$3.Buffer.from([43, 129, 4, 0, 35]);
  const secp256k1 = buffer_1$3.Buffer.from([43, 129, 4, 0, 10]);
  ...
  const getNamedCurve = (kee, raw) => {
    ...
    switch (key.asymmetricKeyType) {
      ...
      case "ec": {
        ...
        let namedCurve =
          (_a = key.asymmetricKeyDetails) === null || _a === void 0 ? void 0 : _a.namedCurve;
        if (!namedCurve && key.type === "private")
          namedCurve = getNamedCurve((0, crypto_1$10.createPublicKey)(key), true);
        else if (!namedCurve) {
...
var require_ecdhes = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function deriveKey(
    ...
    if ((0, webcrypto_js_1.isCryptoKey)(publicKee)) {
      ...
      throw new TypeError(
        (0, invalid_key_input_js_1.default)(publicKee, ...is_key_like_js_1.types),
      );
    let privateKey;
    if ((0, webcrypto_js_1.isCryptoKey)(privateKee)) {
      ...
      throw new TypeError(
        (0, invalid_key_input_js_1.default)(privateKee, ...is_key_like_js_1.types),
      );
    const value = (0, buffer_utils_js_1.concat)(
      (0, buffer_utils_js_1.lengthAndInput)(buffer_utils_js_1.encoder.encode(algorithm)),
      (0, buffer_utils_js_1.lengthAndInput)(apu),
      (0, buffer_utils_js_1.lengthAndInput)(apv),
      (0, buffer_utils_js_1.uint32be)(keyLength),
    );
  ...
  async function generateEpk(kee) {
    ...
    switch (key.asymmetricKeyType) {
      ...
      case "ec":
        return generateKeyPair("ec", { namedCurve: (0, get_named_curve_js_1.default)(key) });
      default:
  ...
  const ecdhAllowed = (key) =>
    ["P-256", "P-384", "P-521", "X25519", "X448"].includes((0, get_named_curve_js_1.default)(key));
...
var require_pbes2kw = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const encrypt = async (
    ...
    cek,
    p2c = 2048,
    p2s = (0, random_js_1.default)(new Uint8Array(16)),
  ) => {
...
var require_check_modulus_length = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const getModulusLength = (key) => {
    ...
    const modulusLength =
      (_b =
        (_a = key.asymmetricKeyDetails) === null || _a === void 0 ? void 0 : _a.modulusLength) !==
        null && _b !== void 0
        ? _b
        : (getLengthOfSeqIndex(
            key.export({
...
var require_asn1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const fromPKCS8 = (pem) =>
    (0, crypto_1$6.createPrivateKey)({
      key: buffer_1$2.Buffer.from(
...
var require_jwk_to_key = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const parse = (jwk) => {
    ...
    switch (jwk.kty) {
      case "oct":
        return (0, crypto_1$5.createSecretKey)((0, base64url_js_1.decode)(jwk.k));
      case "RSA": {
        ...
        const keyObject = isPrivate
          ? (0, crypto_1$5.createPrivateKey)(createInput)
          : (0, crypto_1$5.createPublicKey)(createInput);
...
var require_check_key_type = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const symmetricTypeCheck = (alg, key) => {
    ...
    if (!(0, is_key_like_js_1.default)(key))
      throw new TypeError(
        (0, invalid_key_input_js_1.withAlg)(alg, key, ...is_key_like_js_1.types, "Uint8Array"),
      );
    if (key.type !== "secret")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for symmetric algorithms must be of type "secret"`,
      );
  };
  const asymmetricTypeCheck = (alg, key, usage) => {
    ...
    if (key.type === "secret")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for asymmetric algorithms must not be of type "secret"`,
      );
    if (usage === "sign" && key.type === "public")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for asymmetric algorithm signing must be of type "private"`,
      );
    if (usage === "decrypt" && key.type === "public")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for asymmetric algorithm decryption must be of type "private"`,
      );
    if (key.algorithm && usage === "verify" && key.type === "private")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for asymmetric algorithm verifying must be of type "public"`,
      );
    if (key.algorithm && usage === "encrypt" && key.type === "private")
      throw new TypeError(
        `${is_key_like_js_1.types.join(" or ")} instances for asymmetric algorithm encryption must be of type "public"`,
      );
  };
...
var require_aesgcmkw = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function wrap(alg, key, cek, iv) {
    ...
    const { ciphertext: encryptedKey, tag } = await (0, encrypt_js_1.default)(
      jweAlgorithm,
      cek,
      key,
      iv,
    ...
    switch (alg) {
      ...
      case "ECDH-ES+A256KW": {
        ...
        const sharedSecret = await ECDH.deriveKey(
          ...
          alg === "ECDH-ES"
            ? (0, cek_js_1.bitLength)(joseHeader.enc)
      ...
      case "PBES2-HS512+A256KW": {
        ...
        const p2cLimit =
          (options === null || options === void 0 ? void 0 : options.maxPBES2Count) || 1e4;
...
var require_decrypt$3 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function flattenedDecrypt(jwe, key, options) {
    ...
    (0, validate_crit_js_1.default)(
      errors_js_1.JWEInvalid,
      /* @__PURE__ */ new Map(),
    ...
    const keyManagementAlgorithms =
      options &&
      (0, validate_algorithms_js_1.default)(
    ...
    if (contentEncryptionAlgorithms && !contentEncryptionAlgorithms.has(enc))
      throw new errors_js_1.JOSEAlgNotAllowed(
    ...
    let cek;
    try {
      cek = await (0, decrypt_key_management_js_1.default)(
        alg,
        key,
        encryptedKey,
        joseHeader,
      ...
      if (
        ...
        err instanceof errors_js_1.JWEInvalid ||
        err instanceof errors_js_1.JOSENotSupported
      )
        throw err;
    ...
    const protectedHeader = buffer_utils_js_1.encoder.encode(
      (_a = jwe.protected) !== null && _a !== void 0 ? _a : "",
    );
    let additionalData;
    if (jwe.aad !== void 0)
      additionalData = (0, buffer_utils_js_1.concat)(
        protectedHeader,
        buffer_utils_js_1.encoder.encode("."),
        buffer_utils_js_1.encoder.encode(jwe.aad),
      );
    ...
    if (joseHeader.zip === "DEF")
      plaintext = await (
        (options === null || options === void 0 ? void 0 : options.inflateRaw) || zlib_js_1.inflate
      )(plaintext);
    ...
    switch (alg) {
      ...
      case "ECDH-ES+A256KW": {
        ...
        const sharedSecret = await ECDH.deriveKey(
          ...
          ephemeralKey,
          alg === "ECDH-ES" ? enc : alg,
          alg === "ECDH-ES" ? (0, cek_js_1.bitLength)(enc) : parseInt(alg.slice(-5, -2), 10),
          apu,
          apv,
        );
        parameters = {
      ...
      case "PBES2-HS512+A256KW": {
        ...
        ({ encryptedKey, ...parameters } = await (0, pbes2kw_js_1.encrypt)(
          alg,
          key,
          cek,
          p2c,
...
var require_encrypt$3 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var FlattenedEncrypt = class {
    ...
    async encrypt(key, options) {
      ...
      {
        let parameters;
        ({ cek, encryptedKey, parameters } = await (0, encrypt_key_management_js_1.default)(
          alg,
          enc,
          key,
          this._cek,
      ...
      if (this._protectedHeader)
        protectedHeader = buffer_utils_js_1.encoder.encode(
          (0, base64url_js_1.encode)(JSON.stringify(this._protectedHeader)),
        );
      ...
      if (this._aad) {
        ...
        additionalData = (0, buffer_utils_js_1.concat)(
          protectedHeader,
          buffer_utils_js_1.encoder.encode("."),
          buffer_utils_js_1.encoder.encode(aadMember),
        );
      } else additionalData = protectedHeader;
      let ciphertext;
      let tag;
      if (joseHeader.zip === "DEF") {
        const deflated = await (
          (options === null || options === void 0 ? void 0 : options.deflateRaw) ||
          zlib_js_1.deflate
        )(this._plaintext);
        ({ ciphertext, tag } = await (0, encrypt_js_1.default)(
          enc,
          deflated,
          cek,
          this._iv,
  ...
  var GeneralEncrypt = class {
    ...
    async encrypt(options) {
      ...
      for (let i = 0; i < this._recipients.length; i++) {
        ...
        const { encryptedKey, parameters } = await (0, encrypt_key_management_js_1.default)(
          ((_a = recipient.unprotectedHeader) === null || _a === void 0 ? void 0 : _a.alg) ||
            ((_b = this._protectedHeader) === null || _b === void 0 ? void 0 : _b.alg) ||
            ((_c = this._unprotectedHeader) === null || _c === void 0 ? void 0 : _c.alg),
          enc,
          recipient.key,
          cek,
          { p2c },
...
var require_sign$4 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const sign = async (alg, key, data) => {
    ...
    return oneShotSign(
      (0, dsa_digest_js_1.default)(alg),
      data,
      (0, node_key_js_1.default)(alg, keyObject),
    );
  };
...
var require_verify$4 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  if (crypto.verify.length > 4 && flags_js_1.oneShotCallback)
    oneShotVerify = (0, util_1$1.promisify)(crypto.verify);
...
var require_verify$3 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function flattenedVerify(jws, key, options) {
    ...
    if (jws.protected === void 0 && jws.header === void 0)
      throw new errors_js_1.JWSInvalid(
    ...
    const extensions = (0, validate_crit_js_1.default)(
      errors_js_1.JWSInvalid,
      new Map([["b64", true]]),
      options === null || options === void 0 ? void 0 : options.crit,
      parsedProt,
      joseHeader,
    ...
    const algorithms =
      options && (0, validate_algorithms_js_1.default)("algorithms", options.algorithms);
    ...
    const data = (0, buffer_utils_js_1.concat)(
      buffer_utils_js_1.encoder.encode((_a = jws.protected) !== null && _a !== void 0 ? _a : ""),
      buffer_utils_js_1.encoder.encode("."),
      typeof jws.payload === "string" ? buffer_utils_js_1.encoder.encode(jws.payload) : jws.payload,
    );
    let signature;
    try {
    ...
    if (!(await (0, verify_js_1.default)(alg, key, signature, data)))
...
var require_jwt_claims_set = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.default = (protectedHeader, encodedPayload, options = {}) => {
    ...
    if (
      ...
      throw new errors_js_1.JWTClaimValidationFailed(
    ...
    if (payload.exp !== void 0) {
      ...
      if (payload.exp <= now - tolerance)
        throw new errors_js_1.JWTExpired(
    ...
    if (maxTokenAge) {
      ...
      const max =
        typeof maxTokenAge === "number" ? maxTokenAge : (0, secs_js_1.default)(maxTokenAge);
...
var require_verify = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function jwtVerify(jwt, key, options) {
    ...
    if (
      ((_a = verified.protectedHeader.crit) === null || _a === void 0
        ? void 0
        : _a.includes("b64")) &&
    ...
    const result = {
      payload: (0, jwt_claims_set_js_1.default)(
...
var require_decrypt = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function jwtDecrypt(jwt, key, options) {
    ...
    const payload = (0, jwt_claims_set_js_1.default)(
...
var require_sign = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var SignJWT = class extends produce_js_1.ProduceJWT {
    ...
    async sign(key, options) {
      var _a;
      const sig = new sign_js_1.CompactSign(
        buffer_utils_js_1.encoder.encode(JSON.stringify(this._payload)),
      );
      sig.setProtectedHeader(this._protectedHeader);
      if (
        Array.isArray((_a = this._protectedHeader) === null || _a === void 0 ? void 0 : _a.crit) &&
...
var require_encrypt = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var EncryptJWT = class extends produce_js_1.ProduceJWT {
    ...
    async encrypt(key, options) {
      const enc = new encrypt_js_1.CompactEncrypt(
        buffer_utils_js_1.encoder.encode(JSON.stringify(this._payload)),
      );
...
var require_local = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function isJWKSLike(jwks) {
    return (
      jwks && typeof jwks === "object" && Array.isArray(jwks.keys) && jwks.keys.every(isJWKLike)
    );
  }
...
var require_fetch_jwks = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const fetchJwks = async (url, timeout, options) => {
    ...
    const [response] = await Promise.race([
      (0, events_1$2.once)(req, "response"),
      (0, events_1$2.once)(req, "timeout"),
    ]);
    if (!response) {
      req.destroy();
  ...
  var RemoteJWKSet = class extends local_js_1.LocalJWKSet {
    constructor(url, options) {
      ...
      this._timeoutDuration =
        typeof (options === null || options === void 0 ? void 0 : options.timeoutDuration) ===
        "number"
      ...
      this._cooldownDuration =
        typeof (options === null || options === void 0 ? void 0 : options.cooldownDuration) ===
        "number"
          ? options === null || options === void 0
            ? void 0
          ...
          : 3e4;
      this._cacheMaxAge =
        typeof (options === null || options === void 0 ? void 0 : options.cacheMaxAge) === "number"
          ? options === null || options === void 0
            ? void 0
            : options.cacheMaxAge
          : 6e5;
    ...
    async reload() {
      ...
      this._pendingFetch ||
        (this._pendingFetch = (0, fetch_jwks_js_1.default)(
          this._url,
          this._timeoutDuration,
          this._options,
        )
  ...
  function decodeProtectedHeader(token) {
    ...
    try {
      ...
      const result = JSON.parse(
        buffer_utils_js_1.decoder.decode((0, base64url_js_1.decode)(protectedB64u)),
      );
...
var require_decode_jwt = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function decodeJwt(jwt) {
    if (typeof jwt !== "string")
      throw new errors_js_1.JWTInvalid(
...
var require_generate = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function generateKeyPair(alg, options) {
    ...
    switch (alg) {
      ...
      case "RSA1_5": {
        const modulusLength =
          (_a = options === null || options === void 0 ? void 0 : options.modulusLength) !== null &&
          _a !== void 0
            ? _a
            : 2048;
      ...
      case "ECDH-ES+A256KW":
        const crv =
          (_b = options === null || options === void 0 ? void 0 : options.crv) !== null &&
          _b !== void 0
            ? _b
            : "P-256";
        switch (crv) {
...
var require_cjs = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.cryptoRuntime =
    exports.base64url =
    exports.generateSecret =
    exports.generateKeyPair =
    exports.errors =
    exports.decodeJwt =
    exports.decodeProtectedHeader =
    exports.importJWK =
    exports.importX509 =
    exports.importPKCS8 =
    exports.importSPKI =
    ...
    exports.exportSPKI =
    exports.exportPKCS8 =
    exports.UnsecuredJWT =
    exports.createRemoteJWKSet =
    exports.createLocalJWKSet =
    exports.EmbeddedJWK =
    exports.calculateJwkThumbprintUri =
    exports.calculateJwkThumbprint =
    exports.EncryptJWT =
    exports.SignJWT =
    exports.GeneralSign =
    exports.FlattenedSign =
    exports.CompactSign =
    exports.FlattenedEncrypt =
    exports.CompactEncrypt =
    exports.jwtDecrypt =
    exports.jwtVerify =
    exports.generalVerify =
    exports.flattenedVerify =
    exports.compactVerify =
    exports.GeneralEncrypt =
    exports.generalDecrypt =
    exports.flattenedDecrypt =
    exports.compactDecrypt =
      void 0;
...
var require_lodash_clonedeep = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function baseIsNative(value) {
    ...
    return (isFunction(value) || isHostObject(value) ? reIsNative : reIsHostCtor).test(
      toSource(value),
    );
  }
  /**
  ...
  function cloneMap(map, isDeep, cloneFunc) {
    return arrayReduce(
      isDeep ? cloneFunc(mapToArray(map), true) : mapToArray(map),
      addMapEntry,
      new map.constructor(),
    );
  }
  ...
  function cloneSet(set, isDeep, cloneFunc) {
    return arrayReduce(
      isDeep ? cloneFunc(setToArray(set), true) : setToArray(set),
      addSetEntry,
      new set.constructor(),
    );
  }
...
var require_sync = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function syncMemoizer(options) {
    ...
    function processResult(result) {
      var res = result;
      if (clone)
        if (isPromise(res)) res = res.then(lodash_clonedeep_1.default);
        else res = lodash_clonedeep_1.default(res);
      if (freeze)
        if (isPromise(res)) res = res.then(freeze_1.deepFreeze);
...
var require_async = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function asyncMemoizer(options) {
    ...
    function runCallbacks(callbacks, args) {
      ...
      try {
        for (
          var callbacks_1 = __values(callbacks), callbacks_1_1 = callbacks_1.next();
          !callbacks_1_1.done;
...
var require_JwksClient = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const { request, cacheSigningKey, rateLimitSigningKey, getKeysInterceptor, callbackSupport } =
    require_wrappers();
  const JwksError = require_JwksError();
  ...
  module.exports.hapiJwt2Key = function (options) {
    ...
    return function secretProvider(decoded, cb) {
      if (!decoded || !decoded.header)
        return cb(
          /* @__PURE__ */ new Error("Cannot find a signing certificate if there is no header"),
          null,
          null,
        );
      if (!supportedAlg.includes(decoded.header.alg))
        return cb(
          /* @__PURE__ */ new Error("Unsupported algorithm " + decoded.header.alg + " supplied."),
          null,
          null,
        );
      client
    ...
    return function secretProvider({ alg, kid } = {}) {
      return new Promise((resolve, reject) => {
        if (!supportedAlg.includes(alg))
          return reject(/* @__PURE__ */ new Error("Missing / invalid token algorithm"));
        client
          .getSigningKey(kid)
          .then((key) => {
