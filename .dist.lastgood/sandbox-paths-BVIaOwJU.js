...
import { l as assertNoPathAliasEscape } from "./secure-temp-dir-CCj3cY2B.js";
...
function isManagedMediaPathUnderRoot(candidate) {
  ...
  if (resolvedExpanded === resolvedMediaRoot || !isPathInside(resolvedMediaRoot, resolvedExpanded))
    return false;
...
//#endregion
export {
  resolveSandboxPath as a,
  resolveSandboxInputPath as i,
  assertSandboxPath as n,
  resolveSandboxedMediaSource as o,
  resolveAllowedManagedMediaPath as r,
  assertMediaNotDataUrl as t,
};
