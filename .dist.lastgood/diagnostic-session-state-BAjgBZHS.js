...
function mergeSessionState(target, source) {
  ...
  target.lastStuckWarnAgeMs =
    target.lastStuckWarnAgeMs === void 0 || source.lastStuckWarnAgeMs === void 0
      ? void 0
      : Math.max(target.lastStuckWarnAgeMs, source.lastStuckWarnAgeMs);
  target.lastLongRunningWarnAgeMs =
    target.lastLongRunningWarnAgeMs === void 0 || source.lastLongRunningWarnAgeMs === void 0
      ? void 0
...
function peekDiagnosticSessionState(ref) {
  ...
  return (
    ...
    (ref.sessionId ? findStateEntryBySessionId(ref.sessionId)?.[1] : void 0)
  );
}
...
function isDiagnosticSessionStateCurrent(params) {
  ...
  return (
    ...
    (params.state === void 0 || state.state === params.state)
  );
}
//#endregion
export {
  pruneDiagnosticSessionStates as a,
  isDiagnosticSessionStateCurrent as i,
  getDiagnosticSessionState as n,
  resetDiagnosticSessionStateForTest as o,
  getDiagnosticSessionStateCountForTest as r,
  diagnosticSessionStates as t,
};
