...
import {
  i as loadUndiciGlobalDispatcherDeps,
  o as createUndiciAutoSelectFamilyConnectOptions,
  s as resolveUndiciAutoSelectFamily,
...
function resolveDispatcherKey(params) {
  const autoSelectToken =
    params.autoSelectFamily === void 0 ? "na" : params.autoSelectFamily ? "on" : "off";
...
//#endregion
export {
  ensureGlobalUndiciStreamTimeouts as a,
  ensureGlobalUndiciEnvProxyDispatcher as i,
  _globalUndiciStreamTimeoutMs as n,
  forceResetGlobalDispatcher as o,
  ensureGlobalUndiciDispatcherStreamTimeouts as r,
  resetGlobalUndiciStreamTimeoutsForTests as s,
  DEFAULT_UNDICI_STREAM_TIMEOUT_MS as t,
};
