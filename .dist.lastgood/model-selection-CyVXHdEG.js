...
import {
  ...
  _ as modelKey,
  a as getModelRefStatusWithFallbackModels,
  c as normalizeModelSelection,
  f as resolveConfiguredModelRef,
  g as legacyModelKey,
  h as resolveModelRefFromString,
  i as buildModelAliasIndex,
  l as resolveAllowedModelRefFromAliasIndex,
  p as resolveConfiguredOpenRouterCompatAlias,
  t as buildAllowedModelSetWithFallbacks,
  u as resolveAllowlistModelKey$1,
  y as parseModelRef,
...
import { s as resolveThinkingDefaultForModel } from "./thinking-C9_Z62px.js";
...
function resolveThinkingDefault(params) {
  ...
  const normalizedPrimarySelection = normalizeOptionalLowercaseString(
...
function resolveSubagentSpawnModelSelection(params) {
  ...
  return resolveModelThroughAliases(
...
//#endregion
export {
  resolveAllowedModelRef as a,
  resolvePersistedModelRef as c,
  resolveReasoningDefault as d,
  resolveSubagentConfiguredModelSelection as f,
  normalizeStoredOverrideModel as i,
  resolvePersistedOverrideModelRef as l,
  resolveThinkingDefault as m,
  canonicalizeCaseOnlyCatalogModelRef as n,
  resolveAllowlistModelKey as o,
  resolveSubagentSpawnModelSelection as p,
  getModelRefStatus as r,
  resolveDefaultModelForAgent as s,
  buildAllowedModelSet as t,
  resolvePersistedSelectedModelRef as u,
};
