...
import { n as claudeCliSessionTranscriptHasContent } from "./attempt-execution.helpers-WZ9zY_9l.js";
...
import { n as composeSystemPromptWithHookContext } from "./attempt.thread-helpers-CPhQxp3A.js";
import {
...
import { t as extractMcpServerMap } from "./bundle-mcp-DDI2KSPG.js";
import { a as hashCliSessionText, o as resolveCliSessionReuse } from "./cli-session-FZWoj6wf.js";
import {
  n as loadMergedBundleMcpConfig,
  r as toCliBundleMcpServerConfig,
} from "./embedded-pi-mcp-S06qG8M1.js";
import { r as externalCliDiscoveryForProviderAuth } from "./external-cli-discovery-DDK4LC8K.js";
import { r as loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader-CMzIS_Ut.js";
import "./model-selection-CyVXHdEG.js";
import {
  i as normalizeCliModel,
  n as buildSystemPrompt,
  p as serializeTomlInlineValue,
} from "./helpers-B5vMZFlJ.js";
...
import { r as cliBackendLog } from "./log-k07DAhZg.js";
import "./skills-DYy402QP.js";
import {
  a as getActiveMcpLoopbackRuntime,
  i as createMcpLoopbackServerConfig,
  n as ensureMcpLoopbackServer,
} from "./mcp-http-C2zVALnL.js";
import { t as applyMergePatch } from "./merge-patch-Gj7xrHOG.js";
import { n as resolveRuntimeCliBackends } from "./model-selection-cli-DuYeikT-.js";
import {
...
import { J as resolveRuntimeTextTransforms } from "./provider-runtime-DueHRTen.js";
import {
  n as loadCliSessionHistoryMessages,
  r as loadCliSessionReseedMessages,
  t as buildCliSessionHistoryPrompt,
} from "./session-history-Bs64fdO5.js";
import { r as resolvePluginSetupCliBackend } from "./setup-registry-CnJdT1HM.js";
import {
  A as readGeminiCliCredentialsCached,
  O as readClaudeCliCredentialsCached,
  k as readCodexCliCredentialsCached,
...
function hasOAuthAccountIdentity(credential) {
  return (
    ...
    (normalizeOptionalString(credential.accountId) !== void 0 ||
      normalizeOptionalString(credential.email) !== void 0)
  );
}
...
async function resolveCliAuthEpoch(params) {
  ...
  if (authProfileId) {
    const credential = getAuthProfileCredential(
      cliAuthEpochDeps.loadAuthProfileStoreForRuntime(void 0, {
        readOnly: true,
        allowKeychainPrompt: false,
      }),
      authProfileId,
...
const prepareDeps = {
  ...
  resolveOpenClawReferencePaths: async (params) =>
    (await import("./docs-path-C95dVguP.js")).resolveOpenClawReferencePaths(params),
...
async function prepareCliRunContext(params) {
  ...
  const effectiveAuthProfileId =
    (params.authProfileId?.trim() || void 0) ??
    backendResolved.defaultAuthProfileId?.trim() ??
    void 0;
  let authCredential;
  if (effectiveAuthProfileId)
    authCredential = loadAuthProfileStoreForRuntime(agentDir, {
      readOnly: true,
  ...
  const extraSystemPromptHash =
    params.extraSystemPromptStatic !== void 0
      ? hashCliSessionText(params.extraSystemPromptStatic.trim() || void 0)
  ...
  const candidateClaudeCliSessionId =
    params.cliSessionBinding?.sessionId?.trim() || params.cliSessionId?.trim() || void 0;
  const reusableCliSession =
    candidateClaudeCliSessionId !== void 0 &&
