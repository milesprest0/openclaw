...
import {
  i as setGatewaySubagentRuntime,
  n as gatewaySubagentState,
  r as setGatewayNodesRuntime,
  t as clearGatewaySubagentRuntime,
} from "../../gateway-bindings-CxfBXsnl.js";
...
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-B3yygUDw.js";
...
import { i as getChildLogger, y as normalizeLogLevel } from "../../logger-BU4ooQvN.js";
import { a as logWarn } from "../../logger-BWdMCYqK.js";
import "../../logging-CG1_glIK.js";
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-CSQ-Gv-M.js";
import { m as resolveThinkingDefault } from "../../model-selection-CyVXHdEG.js";
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-D9oQINZ2.js";
import { n as mutateConfigFile, r as replaceConfigFile } from "../../mutate-IzL9dVFH.js";
import {
  n as generateMusic,
  r as listRuntimeMusicGenerationProviders,
...
import { t as createRuntimeChannel } from "../../runtime-channel-DRqK_Iuh.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-CNEVbPNH.js";
import {
  n as listRuntimeVideoGenerationProviders,
  t as generateVideo,
} from "../../runtime-CqTJyZYU.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-CLrz_6T1.js";
import {
...
import {
  _ as resolveTaskFlowForLookupTokenForOwner,
  g as listTaskFlowsForOwner,
  h as getTaskFlowByIdForOwner,
  l as getFlowTaskSummary,
  m as findLatestTaskFlowForOwner,
  t as cancelDetachedTaskRunById,
} from "../../task-executor-BWbtTr8-.js";
import {
  a as getTaskByIdForOwner,
  o as listTasksForRelatedSessionKeyForOwner,
  r as findLatestTaskForRelatedSessionKeyForOwner,
  s as resolveTaskForLookupTokenForOwner,
} from "../../task-owner-access-mqSx5td5.js";
import { p as listTasksForFlowId } from "../../task-registry-Bkiwt9Td.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-CQb4cS4d.js";
import { c as resolveThinkingProfile, f as normalizeThinkLevel } from "../../thinking-C9_Z62px.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(
  () => import("../../runtime-embedded-pi.runtime-Dhw86Tbj.js"),
);
...
function createRuntimeAgent() {
  const agentRuntime = {
    ...
    resolveThinkingPolicy: (params) => {
      ...
      const policy = {
        levels: profile.levels.map(({ id, label }) => ({
          id,
          label,
        })),
      };
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(
  createLazyRuntimeModule(() => import("../../heartbeat-runner-Cj-ZMCFA.js")),
  (runtime) => runtime.runHeartbeatOnce,
);
function createRuntimeSystem() {
  const requestHeartbeatNow = (opts) =>
    requestHeartbeat({
...
function createBoundTaskFlowsRuntime(params) {
  ...
  return {
    ...
    list: () =>
      listTaskFlowsForOwner({ callerOwnerKey: ownerKey }).map((flow) => mapTaskFlowView(flow)),
    findLatest: () => {
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-CGJnUvF4.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(
  () => import("../../runtime-CJe8HypX.js"),
);
const loadModelAuthRuntime = createLazyRuntimeModule(
  () => import("../../runtime-model-auth.runtime-9MOocOLf.js"),
);
...
function createRuntimeLlmFacade() {
  const loadLlm = createLazyRuntimeSurface(
    () => import("../../runtime-llm.runtime-DuDFr04O.js"),
    (m) =>
      m.createRuntimeLlm({
