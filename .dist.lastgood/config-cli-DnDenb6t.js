...
import { n as info, o as success, t as danger } from "./globals-BdfwDi2E.js";
import {
  C as validateConfigObjectRaw,
  u as readConfigFileSnapshot,
  x as collectUnsupportedSecretRefPolicyIssues,
} from "./io-CEQSCTGy.js";
import {
  n as formatConfigIssueLines,
  o as normalizeConfigIssues,
} from "./issue-format-DZoENRCj.js";
import { n as setCommandJsonMode } from "./json-mode-YCvmk_ys.js";
...
import {
  ...
  d as validateExecSecretRefId,
  o as isValidExecSecretRefId,
  s as isValidFileSecretRefId,
  u as secretRefKey,
} from "./ref-contract-PE7UucMZ.js";
import { a as resolveSecretRefValue } from "./resolve-BZt0Bv7Z.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-kqN0Yohi.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-JqLhlDGQ.js";
import {
...
import {
  ...
  s as resolveConfigSecretTargetByPath,
...
function parseBatchEntries(raw, sourceLabel) {
  ...
  for (const [index, entry] of parsed.entries()) {
    ...
    if (Number(hasValue) + Number(hasRef) + Number(hasProvider) !== 1)
      throw new Error(
...
const GATEWAY_AUTH_MODE_PATH = ["gateway", "auth", "mode"];
...
function buildApplyValueOperation(params) {
  if (isPlainRecord(params.value) ? coerceSecretRef(params.value) : null)
    return {
      ...buildRefAssignmentOperation({
...
function registerConfigCli(program) {
  const cmd = program
    ...
    .action(async (opts) => {
      const { configureCommandFromSectionsArg } = await import("./configure-BLHl1d4f.js");
