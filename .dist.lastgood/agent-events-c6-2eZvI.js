...
import { n as registerListener, t as notifyListeners } from "./listeners-D4L2hlkD.js";
...
function registerAgentRunContext(runId, context) {
  ...
  if (context.isControlUiVisible !== void 0)
    existing.isControlUiVisible = context.isControlUiVisible;
  if (context.isHeartbeat !== void 0 && existing.isHeartbeat !== context.isHeartbeat)
...
function emitAgentEvent(event) {
  ...
  const eventSessionKey =
    typeof event.sessionKey === "string" && event.sessionKey.trim() ? event.sessionKey : void 0;
  const sessionKey =
...
//#endregion
export {
  emitAgentItemEvent as a,
  getAgentRunContext as c,
  resetAgentEventsForTest as d,
  sweepStaleRunContexts as f,
  emitAgentEvent as i,
  onAgentEvent as l,
  emitAgentApprovalEvent as n,
  emitAgentPatchSummaryEvent as o,
  emitAgentCommandOutputEvent as r,
  emitAgentPlanEvent as s,
  clearAgentRunContext as t,
  registerAgentRunContext as u,
};
