...
import { d as sanitizeUserFacingText } from "./sanitize-user-facing-text-Cgbm6W76.js";
...
function extractAssistantTextForPhase(msg, phase) {
  ...
  return {
    text: finalizeAssistantExtraction(
      msg,
...
function extractAssistantText(msg) {
  return finalizeAssistantExtraction(
    msg,
...
const THINKING_TAG_SCAN_RE = new RegExp(
  String.raw`<\s*(\/?)\s*${THINKING_TAG_NAME_PATTERN}\s*>`,
  "gi",
);
...
//#endregion
export {
  extractThinkingFromTaggedStream as a,
  inferToolMetaFromArgs as c,
  splitThinkingTaggedText as d,
  stripThinkingTagsFromText as f,
  extractAssistantVisibleText as i,
  isAssistantMessage as l,
  extractAssistantText as n,
  extractThinkingFromTaggedText as o,
  extractAssistantThinking as r,
  formatReasoningMessage as s,
  THINKING_TAG_SCAN_RE as t,
  promoteThinkingTagsToBlocks as u,
};
