...
import { i as getOrCreateClientManager, n as stripMarkdownForTwitch } from "./markdown-BbSDjQCW.js";
import "./text-runtime-lKuAtsoz.js";
import "./error-runtime-CdKGkPCx.js";
import { t as getTwitchRuntime } from "./runtime-D87Q5K8G.js";
...
function checkTwitchAccessControl(params) {
  ...
  if (account.requireMention ?? true) {
    if (!extractMentions(message.message).includes(normalizeLowercaseStringOrEmpty(botUsername)))
      return {
        allowed: false,
