...
import { n as isZaloSenderAllowed, t as evaluateZaloGroupAccess } from "./group-access-DyJCc1xq.js";
...
import {
  ...
  r as deleteWebhook,
  s as sendChatAction,
  t as resolveZaloProxyFetch,
  u as setWebhook,
} from "./proxy-CEVjzmJk.js";
import {
  i as deliverTextOrMediaReply,
  m as resolveSendableOutboundReplyParts,
} from "./reply-payload-D_-IJF8p.js";
import { t as getZaloRuntime } from "./runtime-CxTp1XXB.js";
import "node:fs";
import {
...
async function deleteHostedZaloMediaEntry(id) {
  await Promise.all([
    unlink(resolveHostedZaloMediaMetadataPath(id)).catch(() => void 0),
    unlink(resolveHostedZaloMediaBufferPath(id)).catch(() => void 0),
  ]);
}
...
function loadZaloWebhookModule() {
  zaloWebhookModulePromise ??= import("./monitor.webhook-BZmLKG4y.js");
