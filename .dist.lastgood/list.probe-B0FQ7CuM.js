...
import { o as externalCliDiscoveryScoped } from "./external-cli-discovery-DDK4LC8K.js";
import { r as describeFailoverError } from "./failover-error-Dx3vQAkt.js";
import { f as redactSecrets } from "./format-BCQX6-Ub.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import { c as hasUsableCustomProviderApiKey } from "./model-auth-Do8Bfz1M.js";
...
import { r as formatMs } from "./shared-BbHHdmwP.js";
...
const embeddedRunnerModuleLoader = createLazyImportLoader(
  () => import("./pi-embedded-6CIIAYDg.js"),
);
    ...
    if (filteredProfiles.length > 0) {
      for (const profileId of filteredProfiles) {
        ...
        if (allowedProfiles && !allowedProfiles.has(profileId)) {
          const reasonCode = mapEligibilityReasonToProbeReasonCode(
