...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-HHHAstzN.js";
import { n as LogService } from "./logger-DwhV1i8m.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-gz1WDgpo.js";
...
async function loadMatrixCreateClientDeps() {
  matrixCreateClientDepsPromise ??= import("./create-client-24CUZwbv.js").then((runtime) => ({
...
//#endregion
export {
  stopSharedClient as a,
  resolveSharedMatrixClient as i,
  releaseSharedClientInstance as n,
  stopSharedClientForAccount as o,
  removeSharedClientInstance as r,
  stopSharedClientInstance as s,
  acquireSharedMatrixClient as t,
};
