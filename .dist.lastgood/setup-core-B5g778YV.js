...
import { i as resolveZaloAccount, r as resolveDefaultZaloAccountId } from "./accounts-K08f0yML.js";
...
async function promptZaloAllowFrom(params) {
  ...
  const unique = mergeAllowFromEntries(existingAllowFrom, [
    (
      await prompter.text({
...
const zaloDmPolicy = {
  ...
  resolveConfigKeys: (cfg, accountId) =>
    (accountId ?? resolveDefaultZaloAccountId(cfg)) !== "default"
      ? {
...
//#endregion
export {
  promptZaloAllowFrom as a,
  noteZaloTokenHelp as i,
  zaloDmPolicy as n,
  zaloSetupAdapter as r,
  createZaloSetupWizardProxy as t,
};
