...
import { n as assertSafeCronSessionTargetId } from "./webhook-url-CmRMvdiM.js";
...
function hasAgentTurnPayloadHint(payload) {
  return (
    ...
    normalizeTrimmedStringArray(payload.fallbacks) !== void 0 ||
    normalizeTrimmedStringArray(payload.toolsAllow, { allowNull: true }) !== void 0 ||
  ...
  if (options.applyDefaults) {
    ...
    if ("schedule" in next && isRecord(next.schedule) && next.schedule.kind === "cron") {
      ...
      if (explicit !== void 0) schedule.staggerMs = explicit;
        ...
        const defaultStaggerMs = resolveDefaultCronStaggerMs(
    ...
    if (
      !("delivery" in next && next.delivery !== void 0) &&
      isIsolatedAgentTurn &&
