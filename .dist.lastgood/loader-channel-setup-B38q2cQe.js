...
function resolveSetupChannelRegistration(moduleExport) {
    ...
    try {
      ...
      const loadedSecrets =
        typeof setupEntryRecord.loadSetupSecrets === "function"
          ? setupEntryRecord.loadSetupSecrets()
          : void 0;
  ...
  return {
    ...
    ...(typeof setup.setChannelRuntime === "function"
      ? { setChannelRuntime: setup.setChannelRuntime }
      : {}),
  };
}
...
//#endregion
export {
  resolveSetupChannelRegistration as a,
  resolveBundledRuntimeChannelRegistration as i,
  loadBundledRuntimeChannelPlugin as n,
  shouldLoadChannelPluginInSetupRuntime as o,
  mergeSetupRuntimeChannelPlugin as r,
  channelPluginIdBelongsToManifest as t,
};
