...
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DMF48Itz.js";
import {
  _ as recoverConfigFromLastKnownGood,
  g as recoverConfigFromJsonRootSuffix,
  u as readConfigFileSnapshot,
} from "./io-CEQSCTGy.js";
import { n as formatConfigIssueLines } from "./issue-format-DZoENRCj.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-BBzcy1Rk.js";
...
async function runDoctorConfigPreflight(options = {}) {
  if (options.migrateState !== false) {
    const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DFzJOGJ1.js");
