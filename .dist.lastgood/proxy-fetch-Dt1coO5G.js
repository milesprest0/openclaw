...
import { t as normalizeHeadersInitForFetch } from "./fetch-headers-CorjpjhG.js";
import { a as logWarn } from "./logger-BWdMCYqK.js";
import { o as resolveEnvHttpProxyAgentOptions } from "./proxy-env-C3VNcjQ7.js";
...
function makeProxyFetch(proxyUrl) {
  const {
    ProxyAgent,
    FormData: UndiciFormData = globalThis.FormData,
    fetch: undiciFetch,
...
//#endregion
export {
  resolveProxyFetchFromEnv as i,
  getProxyUrlFromFetch as n,
  makeProxyFetch as r,
  PROXY_FETCH_PROXY_URL as t,
};
