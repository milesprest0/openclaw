...
import { t as IrcChannelConfigSchema } from "./config-schema-VojwEwlr.js";
...
import { h as runStoppablePassiveMonitor } from "./extension-shared-B_zNy4Rm.js";
...
import {
  _ as listIrcAccountIds,
  a as resolveIrcRequireMention,
  c as looksLikeIrcTargetId,
  d as normalizeIrcMessagingTarget,
  l as normalizeIrcAllowEntry,
  m as connectIrcClient,
  n as resolveIrcGroupMatch,
  o as sendMessageIrc,
  p as buildIrcConnectOptions,
  s as isChannelTarget,
  v as resolveDefaultIrcAccountId,
  y as resolveIrcAccount,
} from "./policy-DB_nrBW1.js";
...
} from "./secret-contract-D_STpKLz.js";
...
import {
  ...
  d as createPromptParsedAllowFromForAccount,
  f as createStandardChannelSetupStatus,
  h as createTopLevelChannelDmPolicySetter,
  p as createTopLevelChannelAllowFromSetter,
...
const collectIrcMutableAllowlistWarnings =
...
async function loadIrcChannelRuntime$1() {
  ircChannelRuntimePromise$1 ??= import("./channel-runtime-8jBVLO01.js");
...
async function loadIrcChannelRuntime() {
  ircChannelRuntimePromise ??= import("./channel-runtime-8jBVLO01.js");
    ...
    directory: createChannelDirectoryAdapter({
      ...
      listGroups: async (params) => {
        return (await listIrcDirectoryGroupsFromConfig(params)).map((entry) =>
          Object.assign({}, entry, { name: entry.id }),
        );
      },
    }),
