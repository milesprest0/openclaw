...
async function probeDiscord(token, timeoutMs, opts) {
  ...
  try {
    ...
    if (includeApplication)
      result.application =
        (await fetchDiscordApplicationSummary(normalized, timeoutMs, fetcher)) ?? void 0;
    return {
      ...result,
      elapsedMs: Date.now() - started,
    };
...
//#endregion
export {
  resolveDiscordPrivilegedIntentsFromFlags as a,
  probeDiscord as i,
  fetchDiscordApplicationSummary as n,
  parseApplicationIdFromToken as r,
  fetchDiscordApplicationId as t,
};
