...
import {
  n as hasSensitiveUrlHintTag,
  o as redactSensitiveUrlLikeString,
  r as isSensitiveUrlConfigPath,
} from "./redact-sensitive-url-Bu3cghBT.js";
import {
  n as redactSecretRefId,
  t as isSecretRefShape,
} from "./redact-snapshot.secret-ref-Zol6tFcs.js";
...
var RedactionError = class extends Error {
  constructor(key, humanReadableMessage) {
    ...
    this.humanReadableMessage =
      ...
      `Sentinel value "__OPENCLAW_REDACTED__" in key ${key} is not valid as real data`;
...
function maybeRestoreSecretRefId(params) {
  ...
  if (!isSecretRefShape(incomingObj) || incomingObj.id !== "__OPENCLAW_REDACTED__")
...
function restoreRedactedEntryGuessing(params) {
  ...
  if (params.value === "__OPENCLAW_REDACTED__" && canRestoreSecretRef)
...
//#endregion
export {
  isSensitiveConfigPath as a,
  restoreRedactedValues as i,
  redactConfigObject as n,
  redactConfigSnapshot as r,
  REDACTED_SENTINEL as t,
};
