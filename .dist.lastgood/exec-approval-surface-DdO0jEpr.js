...
function resolveExecApprovalInitiatingSurfaceState(params) {
  ...
  if (!channel || channel === "webchat" || channel === "tui")
    return {
      kind: "enabled",
      channel,
      channelLabel,
...
//#endregion
export {
  supportsNativeExecApprovalClient as i,
  listNativeExecApprovalClientLabels as n,
  resolveExecApprovalInitiatingSurfaceState as r,
  describeNativeExecApprovalClientSetup as t,
};
