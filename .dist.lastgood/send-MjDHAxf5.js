...
import { s as resolveDiscordAccount } from "./accounts-Ctry1Kkb.js";
import { n as recordChannelActivity } from "./channel-activity-C42T8R8o.js";
import {
  $ as createThread,
  At as removeGuildMember,
  Ct as listGuildActiveThreads,
  Dt as listGuildScheduledEvents,
  Et as listGuildRoles,
  Ft as ChannelType,
  Mt as timeoutGuildMember,
  Ot as moveGuildChannels,
  Q as createChannelMessage,
  St as getGuildVoiceState,
  Tt as listGuildEmojis,
  X as deleteOwnMessageReaction,
  Y as createOwnMessageReaction,
  Z as listMessageReactionUsers,
  _ as readRetryAfter,
  _t as createGuildScheduledEvent,
  at as getChannelMessage,
  ct as listChannelPins,
  dt as sendChannelTyping,
  et as deleteChannel,
  ft as unpinChannelMessage,
  g as readDiscordMessage,
  gt as createGuildEmoji,
  h as readDiscordCode,
  ht as createGuildChannel,
  it as getChannel,
  jt as removeGuildMemberRole,
  kt as putChannelPermission,
  lt as pinChannelMessage,
  m as RateLimitError,
  mt as createGuildBan,
  nt as editChannel,
  ot as listChannelArchivedThreads,
  p as DiscordError,
  pt as addGuildMemberRole,
  rt as editChannelMessage,
  st as listChannelMessages,
  tt as deleteChannelMessage,
  ut as searchGuildMessages,
  vt as createGuildSticker,
  wt as listGuildChannels,
  xt as getGuildMember,
  yt as deleteChannelPermission,
...
import { c as unlinkIfExists } from "./media-runtime-Cj72foO4.js";
import { n as rewriteDiscordKnownMentions } from "./mentions-xt4LMiW0.js";
import "./web-media-Bwh5GBGF.js";
import "./ssrf-runtime-BhFjkd3c.js";
import { g as maxBytesForKind, r as extensionForMime } from "./mime-CSQ-Gv-M.js";
import "./security-runtime-6Bn2Pszp.js";
import { t as requireRuntimeConfig } from "./plugin-config-runtime-OXf9zy-H.js";
import { t as tempWorkspace } from "./private-temp-workspace-DKvr8oLR.js";
import {
  c as parseFfprobeCodecAndSampleRate,
  d as runFfprobe,
  f as MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS,
  u as runFfmpeg,
} from "./runner.entries-BWDlqt3w.js";
import { n as createDiscordSendResult } from "./send.receipt-CkuBBjk4.js";
import {
  F as resolveDiscordClientAccountContext,
  I as resolveDiscordRest,
  M as createDiscordClient,
  S as DISCORD_MAX_STICKER_BYTES,
  b as DISCORD_MAX_EMOJI_BYTES,
  i as formatReactionEmoji,
  k as parseAndResolveRecipient,
  l as resolveChannelId,
  o as normalizeEmojiName,
  r as buildReactionIdentifier,
  s as normalizeReactionEmoji,
  t as buildDiscordSendError,
  x as DISCORD_MAX_EVENT_COVER_BYTES,
} from "./send.shared-DW2ozbKR.js";
import "./send.outbound-8Xjee9fn.js";
import {
...
import { n as loadWebMediaRaw } from "./web-media-E6nAhoMh.js";
...
async function kickMemberDiscord(payload, opts) {
  await removeGuildMember(resolveDiscordRest(opts), payload.guildId, payload.userId, {
    headers: payload.reason ? { "X-Audit-Log-Reason": encodeURIComponent(payload.reason) } : void 0,
  });
  return { ok: true };
}
...
async function editMessageDiscord(channelId, messageId, payload, opts) {
  return await editChannelMessage(resolveDiscordRest(opts), channelId, messageId, {
...
async function searchMessagesDiscord(query, opts) {
  ...
  if (query.channelIds?.length)
    for (const channelId of query.channelIds) params.append("channel_id", channelId);
  if (query.authorIds?.length)
    for (const authorId of query.authorIds) params.append("author_id", authorId);
  if (query.limit) {
...
function createRateLimitError(response, body, request) {
  return new RateLimitError(
    ...
    body,
    request ??
      new Request("https://discord.com/api/v10/channels/voice/messages", { method: "POST" }),
  );
}
/**
...
async function ensureOggOpus(filePath) {
  ...
  if (normalizeLowercaseStringOrEmpty(path.extname(filePath)) === ".ogg")
    try {
      const { codec, sampleRateHz } = parseFfprobeCodecAndSampleRate(
        await runFfprobe([
          "-v",
          "error",
          "-select_streams",
...
async function sendDiscordVoiceMessage(
  ...
  return await request(
    () => rest.post(`/channels/${channelId}/messages`, { body: messagePayload }),
    "voice-message",
  );
}
//#endregion
...
async function fetchReactionsDiscord(channelId, messageId, opts) {
  ...
  for (const reaction of reactions) {
    ...
    const users = await listMessageReactionUsers(
      rest,
      channelId,
      messageId,
...
//#endregion
export {
  resolveEventCoverImage as A,
  setChannelPermissionDiscord as B,
  fetchMemberInfoDiscord as C,
  listGuildChannelsDiscord as D,
  kickMemberDiscord as E,
  createChannelDiscord as F,
  deleteChannelDiscord as I,
  editChannelDiscord as L,
  listGuildEmojisDiscord as M,
  uploadEmojiDiscord as N,
  listScheduledEventsDiscord as O,
  uploadStickerDiscord as P,
  moveChannelDiscord as R,
  fetchChannelInfoDiscord as S,
  fetchVoiceStatusDiscord as T,
  searchMessagesDiscord as _,
  sendTypingDiscord as a,
  banMemberDiscord as b,
  DiscordThreadInitialMessageError as c,
  editMessageDiscord as d,
  fetchMessageDiscord as f,
  readMessagesDiscord as g,
  pinMessageDiscord as h,
  removeReactionDiscord as i,
  timeoutMemberDiscord as j,
  removeRoleDiscord as k,
  createThreadDiscord as l,
  listThreadsDiscord as m,
  reactMessageDiscord as n,
  sendVoiceMessageDiscord as o,
  listPinsDiscord as p,
  removeOwnReactionsDiscord as r,
  sendWebhookMessageDiscord as s,
  fetchReactionsDiscord as t,
  deleteMessageDiscord as u,
  unpinMessageDiscord as v,
  fetchRoleInfoDiscord as w,
  createScheduledEventDiscord as x,
  addRoleDiscord as y,
  removeChannelPermissionDiscord as z,
};
