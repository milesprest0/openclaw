...
import "./onboard-helpers-BBY5G06B.js";
...
function validateGatewayWebSocketUrl(value) {
  ...
  if (
    ...
    return "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: OPENCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.";
}
async function promptRemoteGatewayConfig(cfg, prompter, options) {
  ...
  const pinnedDiscoveryFingerprint =
    discoveryTlsFingerprint && url === trustedDiscoveryUrl ? discoveryTlsFingerprint : void 0;
