...
import { n as createFileLockManager } from "./file-lock-8rPRjF2F.js";
import { n as isPidAlive, t as getProcessStartTime } from "./pid-alive-vlUbRgZw.js";
import { t as SessionWriteLockTimeoutError } from "./session-write-lock-error-CKc75XRU.js";
...
function shouldTreatAsOrphanSelfLock(params) {
  if ((isValidLockNumber(params.payload?.pid) ? params.payload.pid : null) !== process.pid)
    return false;
...
async function acquireSessionWriteLock(params) {
  ...
  while (true)
    try {
      return {
        release: (
          await SESSION_LOCKS.acquire(sessionFile, {
            staleMs,
            timeoutMs,
            retry: {
              minTimeout: 50,
...
//#endregion
export {
  drainSessionWriteLockStateForTest as a,
  resolveSessionWriteLockAcquireTimeoutMs as c,
  cleanStaleLockFiles as i,
  __testing as n,
  resetSessionWriteLockStateForTest as o,
  acquireSessionWriteLock as r,
  resolveSessionLockMaxHoldFromTimeout as s,
  DEFAULT_SESSION_WRITE_LOCK_ACQUIRE_TIMEOUT_MS as t,
};
