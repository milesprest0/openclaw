...
import { g as stripEnvelopeFromMessages } from "./session-utils.fs-z-7Kw0Lg.js";
...
function projectAssistantTextFromMixedToolContent(content, maxChars) {
  ...
  for (const block of content) {
    ...
    const truncated = truncateChatHistoryText(
      stripInlineDirectiveTagsForDisplay(entry.text).text,
      maxChars,
    );
  ...
  return filterVisibleProjectedHistoryMessages(
    toProjectedMessages(
      sanitizeChatHistoryMessages(
        options?.stripEnvelope === false ? messages : stripEnvelopeFromMessages(messages),
...
//#endregion
export {
  projectRecentChatDisplayMessages as a,
  projectChatDisplayMessages as i,
  isToolHistoryBlockType as n,
  resolveEffectiveChatHistoryMaxChars as o,
  projectChatDisplayMessage as r,
  DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS as t,
};
