...
import {
  a as buildPairingConnectRecoveryTitle,
  o as describePairingConnectRequirement,
} from "./connect-error-details-BXtaJDEs.js";
import { n as formatTimeAgo } from "./format-relative-Dc5mB_gw.js";
import { l as buildStatusOverviewRowsFromSurface } from "./status-runtime-shared-CyJdhB2r.js";
import "./format-BCQX6-Ub.js";
...
function formatSessionModelLabel(session) {
  const requestedModel = session.model ?? "unknown";
  const servedModel = session.servedModel ?? null;
  if (!servedModel || servedModel === requestedModel) return requestedModel;
...
function buildStatusMemoryValue(params) {
  ...
  if (params.memory.vector) {
    const vector =
      params.memory.backend === "builtin" && params.memory.vector.storeAvailable !== void 0
        ? {
...
//#endregion
export {
  statusHealthColumns as S,
  buildStatusPluginCompatibilityLines as _,
  buildStatusChannelsSection as a,
  buildStatusSystemEventsRows as b,
  buildStatusOverviewSection as c,
  buildStatusUsageSection as d,
  buildStatusAllOverviewRows as f,
  buildStatusPairingRecoveryLines as g,
  buildStatusHealthRows as h,
  buildStatusChannelDetailsSections as i,
  buildStatusSessionsSection as l,
  buildStatusFooterLines as m,
  appendStatusSectionHeading as n,
  buildStatusChannelsTableSection as o,
  buildStatusCommandOverviewRows as p,
  buildStatusAgentsSection as r,
  buildStatusHealthSection as s,
  appendStatusReportSections as t,
  buildStatusSystemEventsSection as u,
  buildStatusSecurityAuditLines as v,
  buildStatusSystemEventsTrailer as x,
  buildStatusSessionsRows as y,
};
