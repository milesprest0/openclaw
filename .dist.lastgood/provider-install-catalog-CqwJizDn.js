...
import { E as loadOpenClawProviderIndex } from "./discovery-bnS95tO3.js";
import { t as describePluginInstallSource } from "./install-source-info-CWCfqh7a.js";
import {
  c as resolveOfficialExternalPluginInstall,
  o as listOfficialExternalProviderCatalogEntries,
  r as getOfficialExternalPluginCatalogManifest,
} from "./official-external-plugin-catalog-BYIstKqF.js";
import { p as loadPluginRegistrySnapshot } from "./plugin-registry-CWiNK0Xv.js";
import { i as resolveManifestProviderAuthChoices } from "./provider-auth-choices-D-oJr9Ew.js";
...
function resolveInstallInfoFromPackageSource(params) {
  const npmSpec =
    params.origin === "bundled" || params.origin === "config" ? params.source?.npm?.spec : void 0;
  const clawhubSpec =
  ...
  for (const provider of Object.values(index.providers)) {
    ...
    for (const choice of provider.authChoices ?? []) {
      ...
      entries.push({
        ...
        ...(choice.assistantPriority !== void 0
...
function resolveProviderInstallCatalogEntries(params) {
  const { installedPluginIds, installsByPluginId } = resolvePreferredInstallsByPluginId(
    params ?? {},
  );
