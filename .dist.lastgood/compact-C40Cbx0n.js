...
import { a as shouldUseOpenAIWebSocketTransport } from "./attempt.thread-helpers-CPhQxp3A.js";
...
import { _ as createPreparedEmbeddedPiSettingsManager } from "./compaction-B6HM89B8.js";
import { n as resolveEmbeddedCompactionTarget } from "./compaction-runtime-context-CjeIjGez.js";
import {
  ...
  F as isRealConversationMessage,
  G as collectRuntimeChannelCapabilities,
  L as consumeCompactionSafeguardCancelReason,
  M as limitHistoryTurns,
  N as buildEmbeddedExtensionFactories,
  O as sanitizeSessionHistory,
  P as hasMeaningfulConversationContent,
  R as setCompactionSafeguardCancelReason,
  ...
  l as dedupeDuplicateUserMessagesForCompaction,
...
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-DxCLirTp.js";
import {
...
import { t as applyExtraParamsToAgent } from "./extra-params-DDMcNhQe.js";
import {
...
import { X as resolveOwnerDisplaySetting } from "./io-CEQSCTGy.js";
...
import {
  ...
  o as runBeforeCompactionHooks,
  p as persistSessionCompactionCheckpoint,
  r as buildBeforeCompactionHookMetrics,
...
import { n as resolveAgentModelFallbackValues } from "./model-input-C-vWoAxX.js";
...
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-h3WW1aOv.js";
...
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BqZpOTxV.js";
import { n as extractModelCompat } from "./provider-model-compat-DIuSGYN-.js";
import {
...
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-B3KPN8Ee.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-BjkUYNeL.js";
import {
...
import { c as updateSessionStoreEntry } from "./store-BpWdoYPF.js";
...
import { s as supportsModelTools } from "./tool-result-middleware-CJ4A8Wvz.js";
import {
...
function prepareCompactionSessionAgent(params) {
  ...
  return applyExtraParamsToAgent(
    ...
    params.agentDir,
    void 0,
    preparedRuntimeExtraParams ? { preparedExtraParams: preparedRuntimeExtraParams } : void 0,
  );
}
...
async function compactEmbeddedPiSessionDirectOnce(params) {
  ...
  try {
    ...
    const { contextFiles } =
      resolveContextInjectionMode(params.config) === "never"
        ? { contextFiles: [] }
    ...
    const toolsRaw = createOpenClawCodingTools({
      ...
      modelAuthMode: resolveModelAuthMode(model.provider, params.config, void 0, {
        workspaceDir: effectiveWorkspace,
      }),
    });
      ...
      while (true) {
        ...
        try {
          ...
          if (contextBudgetGuard.applied)
            log.info(
              `[context-budget] bounded compaction input sessionKey=${params.sessionKey ?? params.sessionId} estimated=${contextBudgetGuard.estimatedTokens} budget=${contextBudgetGuard.budgetBeforeReserve} imageBlocksPruned=${contextBudgetGuard.imageBlocksPruned} droppedTurns=${contextBudgetGuard.droppedTurns}`,
            );
          const boundedHistory = contextBudgetGuard.messages;
          if (boundedHistory.length > 0) session.agent.state.messages = boundedHistory;
