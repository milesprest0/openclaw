...
import { s as readSecureFile } from "./fs-safe-CgBWiL92.js";
import { n as readJsonPointer } from "./json-pointer-Df0ko4-8.js";
import { i as isPathInside, p as FsSafeError } from "./path-1liOXr_N.js";
import "./audit-fs-DXgShSpT.js";
import "./scan-paths-BLf-vGUd.js";
import { a as inspectPathPermissions, d as safeStat } from "./permissions-DkQuD-Po.js";
import {
...
import { n as isNonEmptyString, r as normalizePositiveInt } from "./shared-Dp_cRzjX.js";
  ...
  if (params.trustedDirs && params.trustedDirs.length > 0) {
    if (
      !params.trustedDirs
        ...
        .some((dir) => isPathInside(dir, effectivePath))
    )
...
//#endregion
export {
  resolveSecretRefValue as a,
  resolveSecretRefString as i,
  SecretRefResolutionError as n,
  resolveSecretRefValues as o,
  isProviderScopedSecretResolutionError as r,
  SecretProviderResolutionError as t,
};
