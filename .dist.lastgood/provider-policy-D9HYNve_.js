import {
  n as normalizeGoogleModelId,
  t as normalizeAntigravityModelId,
} from "./model-id-Biu4vtma.js";
...
function normalizeGoogleApiBaseUrl(baseUrl) {
  const raw = trimTrailingSlashes(
    normalizeOptionalString(baseUrl) || "https://generativelanguage.googleapis.com/v1beta",
  );
  try {
    ...
    if (isGoogleGenerativeAiUrl(url))
      url.pathname = trimTrailingSlashes(url.pathname || "") || "/v1beta";
...
//#endregion
export {
  normalizeGoogleProviderConfig as a,
  shouldNormalizeGoogleGenerativeAiProviderConfig as c,
  normalizeGoogleGenerativeAiBaseUrl as i,
  shouldNormalizeGoogleProviderConfig as l,
  isGoogleGenerativeAiApi as n,
  resolveGoogleGenerativeAiApiOrigin as o,
  normalizeGoogleApiBaseUrl as r,
  resolveGoogleGenerativeAiTransport as s,
  DEFAULT_GOOGLE_API_BASE_URL as t,
};
