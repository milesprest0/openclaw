...
import { t as WhatsAppConfigSchema } from "./zod-schema.providers-whatsapp-O9hejQx6.js";
import "./bundled-channel-config-schema-Bjz3wbg7.js";
//#endregion
//#region extensions/whatsapp/src/config-schema.ts
const WhatsAppChannelConfigSchema = buildChannelConfigSchema(WhatsAppConfigSchema, {
  uiHints: {
    "": {
      label: "WhatsApp",
