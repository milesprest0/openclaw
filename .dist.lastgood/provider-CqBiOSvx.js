...
import {
  n as resolveDiscordVoiceEnabled,
  t as authorizeDiscordVoiceIngress,
} from "./access-Bc9dYjka.js";
import { n as normalizeAccountId } from "./account-id-BGKP_Par.js";
import {
  c as resolveDiscordAccountAllowFrom,
  d as resolveDiscordAccountDmPolicy,
  f as resolveDiscordMaxLinesPerMessage,
  s as resolveDiscordAccount,
} from "./accounts-Ctry1Kkb.js";
import {
  c as buildAllowlistResolutionSummary,
  d as patchAllowlistUsersInConfigEntries,
  f as summarizeMapping,
  l as canonicalizeAllowlistWithResolvedIds,
...
import {
  ...
  f as resolveDiscordMemberAccessState,
  i as normalizeDiscordDisplaySlug,
  l as resolveDiscordChannelPolicyCommandAuthorizer,
  m as resolveDiscordOwnerAccess,
  n as isDiscordGroupAllowedByPolicy,
  o as resolveDiscordAllowListMatch,
  r as normalizeDiscordAllowList,
  v as shouldEmitDiscordReactionNotification,
} from "./allow-list-Jocmm0YN.js";
import {
  a as summarizeDiscordResponseBody,
  i as isDiscordRateLimitResponseBody,
} from "./api-CBB6yRJS.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-runtime-D-taYEKY.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CEmfb1ag.js";
import {
...
import {
  i as resolveDiscordChannelParentIdSafe,
  n as resolveDiscordChannelInfoSafe,
  o as resolveDiscordChannelTopicSafe,
  r as resolveDiscordChannelNameSafe,
  t as resolveDiscordChannelIdSafe,
} from "./channel-access-D9bNbJhi.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-Tw2QazlD.js";
import { r as registerChannelRuntimeContext } from "./channel-runtime-context-BsruUUWt.js";
import { v as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DxCQl0Kn.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-aBEwc7QQ.js";
import { t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-BAZRoOCR.js";
import { t as resolveDirectStatusReplyForSession } from "./command-status-runtime-DojEEHxu.js";
import {
...
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-Cgp5ICBe.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-CiHtAU2a.js";
import {
  B as StringSelectMenu,
  Bt as GatewayOpcodes,
  E as Modal,
  Ft as ChannelType,
  It as ComponentType,
  L as Row,
  Lt as GatewayCloseCodes,
  Nt as ApplicationCommandOptionType,
  Pt as ButtonStyle,
  Rt as GatewayDispatchEvents,
  S as User,
  V as TextDisplay,
  W as BaseMessageInteractiveComponent,
  a as PresenceUpdateListener,
  b as Guild,
  c as ThreadUpdateListener,
  d as Plugin,
  i as MessageReactionRemoveListener,
  j as Container,
  k as Button,
  m as RateLimitError,
  n as MessageCreateListener,
  o as ReadyListener,
  r as MessageReactionAddListener,
  t as InteractionCreateListener,
  u as Client,
  v as Command,
  x as Message,
  y as CommandWithSubcommands,
  z as Separator,
  zt as GatewayIntentBits,
} from "./discord-Do-Uybag.js";
import {
...
import {
  i as resolveEffectiveDebugProxyUrl,
...
import { n as wrapFetchWithAbortSignal } from "./fetch-Cwtbr1ux.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-jcadyt5o.js";
import { a as withFileLock } from "./file-lock-C5nUdr1w.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-C7NoGYAq.js";
import { i as formatDurationSeconds } from "./format-duration-DV-29w1K.js";
...
import "./conversation-binding-runtime-Cw_2CVI8.js";
import "./conversation-runtime-CDBIORy7.js";
import { t as formatMention } from "./mentions-xt4LMiW0.js";
import "./agent-runtime-CG9i2LmY.js";
import { c as resolveDiscordChannelInfo } from "./message-utils-DmLq_iNk.js";
...
import { a as chunkDiscordTextWithMode } from "./normalize-CwaFR3SN.js";
import "./channel-inbound-3vUekbSs.js";
import "./channel-message-Do1b_D-M.js";
import { c as isProfileInCooldown, i as clearExpiredCooldowns } from "./order-2B7dbn6U.js";
...
import "./native-command-registry-B2PPJGN9.js";
import "./state-paths-DqC2qKuH.js";
import { d as upsertChannelPairingRequest } from "./pairing-store-CzWw0BEc.js";
...
import {
  n as buildDirectLabel,
  r as buildGuildLabel,
  t as deliverDiscordReply,
} from "./reply-delivery-DFnNZ5O6.js";
import { n as dispatchReplyWithDispatcher } from "./reply-dispatch-runtime-fx6x-aY8.js";
import {
...
import { t as resolveRequestUrl } from "./request-url-CPvggaNn.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-DXObv-GJ.js";
import { i as resolveAgentRoute } from "./resolve-route-mwkm9MN4.js";
import "./approval-native-C2QVOTRl.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-l3avRb8a.js";
import {
  c as resolveDiscordDmAccessGroupEntries,
  i as resolveDiscordEffectiveRoute,
  n as resolveDiscordBoundConversationRoute,
  o as handleDiscordDmCommandDecision,
  s as resolveDiscordDmCommandAccess,
} from "./route-resolution-CPnNSuTg.js";
import { n as captureWsEvent, t as captureHttpExchange } from "./runtime-CIhJIx2w.js";
import {
...
import {
  a as resolveDiscordModalEntryWithPersistence,
  i as resolveDiscordComponentEntryWithPersistence,
  t as editDiscordComponentMessage,
} from "./send.components-Bn4ZeGKu.js";
import {
  L as DISCORD_REST_TIMEOUT_MS,
  N as createDiscordRestClient,
  R as validateDiscordProxyUrl,
  z as withValidatedDiscordProxy,
} from "./send.shared-DW2ozbKR.js";
import { t as resolveDiscordSenderIdentity } from "./sender-identity-CH3eO8XB.js";
...
import { n as readSessionUpdatedAt, s as updateSessionStore } from "./store-BpWdoYPF.js";
...
import "./approval-handler.runtime-Df-purl_.js";
import { s as normalizeStringEntries } from "./string-normalization-B6JUy5-Y.js";
import { t as summarizeStringEntries } from "./string-sample-DP6WVSCT.js";
...
import { n as chunkItems } from "./text-runtime-lKuAtsoz.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DyjCuJxS.js";
import { a as isThreadArchived } from "./thread-bindings.discord-api-P_KqfyL6.js";
import { s as resolveDiscordThreadParentInfo } from "./threading-BVg6zz2u.js";
import { o as raceWithTimeout, s as withAbortTimeout } from "./timeouts-B4h4bmv9.js";
import { t as normalizeDiscordToken } from "./token-DrAnwDDa.js";
import { s as resolveProfilesUnavailableReason } from "./usage-BOP5ZbfL.js";
...
async function handleDiscordReactionEvent(params) {
  try {
    ...
    const memberRoleIds = Array.isArray(data.rawMember?.roles)
      ? data.rawMember.roles.map((roleId) => roleId)
      : [];
...
var DiscordInteractionListener = class extends InteractionCreateListener {
  ...
  async handle(data, client) {
    ...
    Promise.resolve()
      ...
      .catch((err) => {
        (this.logger ?? discordEventQueueLog).error(
          danger(`discord interaction handler failed: ${String(err)}`),
        );
      });
  }
};
  ...
  const dispatchResult = await nativeCommandRuntime.dispatchReplyWithDispatcher({
    ...
    replyOptions: {
      ...
      disableBlockStreaming:
        typeof blockStreamingEnabled === "boolean" ? !blockStreamingEnabled : void 0,
      onModelSelected,
    },
  });
  if (
...
function resolveDiscordNativeCommandAllowlistAccess(params) {
  ...
  if (guildId)
    for (const entry of rawAllowList) {
      ...
      if (text.startsWith("guild:") && text.slice(6) === guildId)
        return {
          configured: true,
          allowed: true,
        };
...
async function resolveDiscordNativeAutocompleteAuthorized(params) {
  ...
  const memberRoleIds = Array.isArray(interaction.rawData.member?.roles)
    ? interaction.rawData.member.roles.map((roleId) => roleId)
    : [];
...
async function handleDiscordCommandArgInteraction(params) {
  ...
  const clearWithMessage = async (content) =>
...
function sanitizePreferenceEntries(entries) {
  ...
  for (const [key, value] of Object.entries(entries)) {
    ...
    normalizedEntries[key] = {
      recent: Array.isArray(typedValue.recent)
        ? typedValue.recent.filter((item) => typeof item === "string")
        : [],
...
async function resolveDiscordNativeChoiceContext(params) {
  try {
    ...
    const sessionStore = loadSessionStore(
      resolveStorePath(params.cfg.session?.store, { agentId: route.agentId }),
    );
  ...
  try {
    const sessionRuntime = normalizeOptionalString(
      loadSessionStore(
        resolveStorePath(params.cfg.session?.store, { agentId: params.route.agentId }),
        { skipCache: true },
      )[params.route.sessionKey]?.agentRuntimeOverride,
    );
...
async function handleDiscordModelPickerInteraction(params) {
  ...
  if (parsed.action === "submit" || parsed.action === "reset" || parsed.action === "quick") {
    ...
    const selectionCommand = buildDiscordModelPickerSelectionCommand({
      ...
      runtime:
        normalizeOptionalString(parsed.runtime) ??
        (currentRuntime !== "auto" && currentRuntime !== "default" ? currentRuntime : void 0),
    });
    if (!selectionCommand) {
  ...
  if (parsed.action === "cancel")
    await showNotice(`ℹ️ Model kept as ${currentModelRef ?? "default"}.`);
}
    ...
    const autocomplete =
      ...
      (resolvedChoices.length > 0 &&
        ...
        ? async (interaction) => {
            ...
            const focusValue = normalizeLowercaseStringOrEmpty(
              interaction.options.getFocused()?.value,
            );
            const context =
...
function createDiscordNativeCommand(params) {
  ...
  return new (class extends Command {
    ...
    async run(interaction) {
      if (
        (await safeDiscordInteractionCall("interaction defer", () =>
...
function mapGatewayDispatchData(client, type, data) {
  ...
  if (type === reactionAdd || type === reactionRemove)
    return createReactionDispatchData(client, data);
  return data;
}
...
function readGuildId(data) {
  return data && typeof data === "object" && typeof data.guild_id === "string"
    ? data.guild_id
    : void 0;
}
//#endregion
...
var GatewayPlugin = class extends Plugin {
  constructor(options, gatewayInfo) {
    ...
    this.outboundLimiter = new GatewaySendLimiter(
    ...
    switch (payload.op) {
      case GatewayOpcodes.Hello:
        ...
        if (resume && this.sessionId)
          ...
          this.identifyWithConcurrency().catch((error) => {
            this.emitter.emit(
              "error",
  ...
  async identifyWithConcurrency() {
    ...
    if (!socket || socket.readyState !== READY_STATE_OPEN) {
      const error = /* @__PURE__ */ new Error(
        "Discord gateway socket closed before IDENTIFY could be sent",
      );
      this.emitter.emit("error", error);
  ...
  send(payload, skipRateLimit = false) {
    ...
    if (
      (typeof Buffer !== "undefined"
        ...
        : new TextEncoder().encode(serialized).byteLength) > DISCORD_GATEWAY_PAYLOAD_LIMIT_BYTES
    )
      throw new Error(
  ...
  scheduleReconnect(resume, closeCode, minDelayMs = 0) {
    ...
    if (this.reconnectAttempts > (this.options.reconnect?.maxAttempts ?? 50)) {
      ...
      this.emitter.emit(
        "error",
        /* @__PURE__ */ new Error(
          `Max reconnect attempts (${maxAttempts}) reached${closeCode !== void 0 ? ` after close code ${closeCode}` : ""}`,
        ),
      );
      return;
    }
    const delay = Math.max(
      minDelayMs,
      Math.min(3e4, 1e3 * 2 ** Math.min(this.reconnectAttempts, 5)),
    );
...
function createDiscordDnsLookup() {
  return (hostname, options, callback) => {
    ...
    const lookupOptions =
      typeof options === "number" ? { family: options } : options === void 0 ? {} : { ...options };
    ...
    dns.lookup(
      ...
      (err, addresses) => {
        ...
        if (!Array.isArray(addresses)) {
          callback(
            /* @__PURE__ */ new Error("Expected all lookup addresses to be an array"),
            "",
            4,
          );
          return;
...
function createDiscordGatewayPlugin(params) {
  ...
  if (proxy)
    try {
      ...
      wsAgent = new (params.__testing?.HttpsProxyAgentCtor ?? httpsProxyAgent.HttpsProxyAgent)(
        proxy,
      );
...
var DiscordGatewayLifecycleError = class extends Error {
  constructor(event) {
    super(`discord gateway ${event.type}: ${event.message}`, {
      cause: event.err instanceof Error ? event.err : void 0,
    });
...
function createDiscordGatewaySupervisor(params) {
  ...
  const logLateEvent = (state) => (event) => {
    ...
    params.runtime.error?.(
      danger(
        `discord: suppressed late gateway ${event.type} error ${state === "disposed" ? "after dispose" : "during teardown"}: ${event.message}`,
      ),
    );
  };
...
function classifyAcpStatusProbeError(params) {
  ...
  if (isLegacyMissingSessionError(formatErrorMessage(params.error)))
    return {
      status: "stale",
...
async function resolveGuildEntriesByChannelAllowlist(params) {
  ...
  try {
    ...
    summarizeMapping(
      "discord channels",
      [...mappingByTarget.values()].map((group) => formatDiscordChannelResolvedGroup(group)),
      unresolved,
      params.runtime,
    );
    return nextGuilds;
...
function resolveDiscordRejectedDeployEntriesSource(rawBody) {
  ...
  const source =
    (payload.errors && typeof payload.errors === "object" ? payload.errors : void 0) ?? rawBody;
...
function formatDiscordDeployErrorMessage(err) {
  ...
  if (
    !(
      requestMs !== void 0 ||
      timeoutMs !== void 0 ||
      deployErr.deployRestMethod !== void 0 ||
      deployErr.deployRestPath !== void 0
    )
  )
  ...
  if (timeoutMs !== void 0 && requestMs !== void 0 && requestMs >= timeoutMs)
...
function formatDiscordDeployRateLimitDetails(err) {
  ...
  if (typeof rateLimit.retryAfterMs === "number")
    details.push(`retryAfter=${formatDurationSeconds(rateLimit.retryAfterMs, { decimals: 1 })}`);
...
function formatDiscordDeployRateLimitWarning(err, accountId) {
  ...
  if (typeof rateLimit.retryAfterMs === "number")
    parts.push(`retry after ${formatDurationSeconds(rateLimit.retryAfterMs, { decimals: 1 })}`);
...
function formatDiscordRejectedDeployEntries(params) {
  ...
  return Object.entries(rejectedEntriesSource)
    .filter(([key]) => /^\d+$/.test(key))
    .slice(0, DISCORD_DEPLOY_REJECTED_ENTRY_LIMIT)
    .flatMap(([key, value]) => {
...
async function ensureDmComponentAuthorized(params) {
  ...
  const resolveAllowMatchWithAccessGroups = async (entries) => {
    ...
    return (
      await resolveDiscordDmAccessGroupEntries({
        cfg: ctx.cfg,
        allowFrom: entries,
        sender: { id: user.id },
        accountId: ctx.accountId,
...
async function resolveInteractionContextWithDmAuth(params) {
  ...
  if (interactionCtx.isGroupDm) {
    if (
      !(await ensureGroupDmComponentAuthorized({
        ctx: params.ctx,
        interaction: params.interaction,
...
async function loadTypingRuntime() {
  typingRuntimePromise ??= import("./typing-tT0xJ4ha.js");
...
async function loadComponentsRuntime() {
  componentsRuntimePromise ??= import("./components-B_GsPzu6.js");
...
const createDiscordComponentMentionableSelectControl = bindSelectControl(
...
async function runDiscordGatewayLifecycle(params) {
  ...
  const onGatewayTransportActivity = (event) => {
    ...
    if (
      lastTransportActivityStatusAt !== void 0 &&
...
async function loadDiscordProviderSessionRuntime() {
  ...
  try {
    ...
    if (discordProviderSessionRuntimePromise === promise)
      discordProviderSessionRuntimePromise = void 0;
    throw error;
  }
}
...
//#endregion
export {
  createDiscordNativeCommand as a,
  waitForDiscordGatewayPluginRegistration as i,
  createDiscordGatewayPlugin as n,
  registerDiscordListener as o,
  resolveDiscordGatewayIntents as r,
  monitorDiscordProvider as t,
};
