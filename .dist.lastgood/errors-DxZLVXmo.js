...
function toAcpRuntimeError(params) {
  ...
  if (params.error instanceof Error)
    return new AcpRuntimeError(params.fallbackCode, params.error.message, { cause: params.error });
...
//#endregion
export {
  withAcpRuntimeErrorBoundary as a,
  toAcpRuntimeError as i,
  AcpRuntimeError as n,
  isAcpRuntimeError as r,
  ACP_ERROR_CODES as t,
};
