...
var SocketDropException = class extends Error {
  constructor(message, safeToRetry, options) {
...
//#endregion
export {
  formatErrorMessage as a,
  isErrno as c,
  extractErrorCode as i,
  readErrorName as l,
  collectErrorGraphCandidates as n,
  formatUncaughtError as o,
  detectErrorKind as r,
  hasErrnoCode as s,
  SocketDropException as t,
};
