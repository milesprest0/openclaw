  ...
  return {
    ...
    collectWarnings: createAllowlistProviderRestrictSendersWarningCollector({
      providerConfigPresent:
        params.providerConfigPresent ?? ((cfg) => cfg.channels?.[params.channelKey] !== void 0),
...
//#endregion
export {
  createOpenProviderGroupPolicyWarningCollector as C,
  projectConfigWarningCollector as D,
  projectConfigAccountIdWarningCollector as E,
  projectWarningCollector as O,
  createOpenProviderConfiguredRouteWarningCollector as S,
  projectAccountWarningCollector as T,
  createAllowlistProviderOpenWarningCollector as _,
  buildOpenGroupPolicyConfigureRouteAllowlistWarning as a,
  createConditionalWarningCollector as b,
  collectAllowlistProviderGroupPolicyWarnings as c,
  collectOpenGroupPolicyRestrictSendersWarnings as d,
  collectOpenGroupPolicyRouteAllowlistWarnings as f,
  createAllowlistProviderGroupPolicyWarningCollector as g,
  composeWarningCollectors as h,
  normalizeAllowFromList as i,
  collectAllowlistProviderRestrictSendersWarnings as l,
  composeAccountWarningCollectors as m,
  createDangerousNameMatchingMutableAllowlistWarningCollector as n,
  buildOpenGroupPolicyRestrictSendersWarning as o,
  collectOpenProviderGroupPolicyWarnings as p,
  createRestrictSendersChannelSecurity as r,
  buildOpenGroupPolicyWarning as s,
  coerceNativeSetting as t,
  collectOpenGroupPolicyConfiguredRouteWarnings as u,
  createAllowlistProviderRestrictSendersWarningCollector as v,
  projectAccountConfigWarningCollector as w,
  createOpenGroupPolicyRestrictSendersWarningCollector as x,
  createAllowlistProviderRouteAllowlistWarningCollector as y,
};
