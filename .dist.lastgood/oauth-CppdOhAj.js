...
import { p as generateHexPkceVerifierChallenge } from "./provider-auth-D0H8jtwm.js";
...
async function waitForGoogleMeetAuthCode(params) {
  ...
  if (params.manual) {
    const parsed = parseOAuthCallbackInput(
      await params.promptInput("Paste the full redirect URL here: "),
      {
  ...
  return (
    await waitForLocalOAuthCallback({
...
//#endregion
export {
  refreshGoogleMeetAccessToken as a,
  exchangeGoogleMeetAuthCode as i,
  createGoogleMeetOAuthState as n,
  resolveGoogleMeetAccessToken as o,
  createGoogleMeetPkce as r,
  waitForGoogleMeetAuthCode as s,
  buildGoogleMeetAuthUrl as t,
};
