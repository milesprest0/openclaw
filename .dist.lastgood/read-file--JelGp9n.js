...
import {
  ...
  o as resolveMemorySearchConfig,
} from "./config-utils-CfeWwoBk.js";
import { t as isFileMissingError } from "./fs-utils-Bbrc6fw7.js";
import { c as normalizeExtraMemoryPaths, o as isMemoryPath } from "./internal-BUtLJk16.js";
...
async function readMemoryFile(params) {
  ...
  if ((await statRegularFile(absPath)).missing)
    return {
      text: "",
      path: relPath,
    };
...
//#endregion
export {
  buildMemoryReadResult as a,
  DEFAULT_MEMORY_READ_MAX_CHARS as i,
  readMemoryFile as n,
  buildMemoryReadResultFromSlice as o,
  DEFAULT_MEMORY_READ_LINES as r,
  readAgentMemoryFile as t,
};
