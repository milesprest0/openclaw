...
import { t as require_dist_cjs } from "./dist-cjs-CgxxQY81.js";
            ...
            for (const [name, member] of eventStreamSchema.structIterator()) {
              ...
              if (eventPayload) {
                if (member.isBlobSchema()) out[name] = body;
                  ...
                  out[name] = (this.serdeContext?.utf8Encoder ?? import_dist_cjs.toUtf8)(body);
      ...
      return {
        body:
          typeof messageSerialization === "string"
            ? (this.serdeContext?.utf8Decoder ?? import_dist_cjs.fromUtf8)(messageSerialization)
