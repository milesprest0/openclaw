import { t as runGeminiEmbeddingBatches } from "./embedding-batch-MuvRBttl.js";
import {
  a as createGeminiEmbeddingProvider,
  r as buildGeminiEmbeddingRequest,
  t as DEFAULT_GEMINI_EMBEDDING_MODEL,
} from "./embedding-provider-LGg24U4K.js";
import { f as hasNonTextEmbeddingParts } from "./internal-BUtLJk16.js";
import {
      ...
      runtime: {
        ...
        batchEmbed: async (batch) => {
          if (batch.chunks.some((chunk) => hasNonTextEmbeddingParts(chunk.embeddingInput)))
            return null;
          return mapBatchEmbeddingsByIndex(
