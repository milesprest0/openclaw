...
import {
  C as withRemoteHttpResponse,
  D as sanitizeAndNormalizeEmbedding,
  S as buildRemoteBaseUrlPolicy,
  o as debugEmbeddingsLog,
} from "./memory-core-host-engine-embeddings-C_57wmJ1.js";
...
import "./image-generation-core-C8o3HP_t.js";
...
const GEMINI_EMBEDDING_2_VALID_DIMENSIONS = [768, 1536, 3072];
...
async function createGeminiEmbeddingProvider(options) {
  ...
  const embedQuery = async (text) => {
    ...
    return sanitizeAndNormalizeEmbedding(
      (
        await fetchGeminiEmbeddingPayload({
          client,
          endpoint: embedUrl,
...
//#endregion
export {
  createGeminiEmbeddingProvider as a,
  resolveGeminiOutputDimensionality as c,
  buildGeminiTextEmbeddingRequest as i,
  GEMINI_EMBEDDING_2_MODELS as n,
  isGeminiEmbedding2Model as o,
  buildGeminiEmbeddingRequest as r,
  normalizeGeminiModel as s,
  DEFAULT_GEMINI_EMBEDDING_MODEL as t,
};
