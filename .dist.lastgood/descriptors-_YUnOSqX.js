...
const DIR_LIST_TOOL_DESCRIPTOR = {
  ...
  parameters: Type.Object({
    ...
    maxEntries: Type.Optional(
      Type.Number({
        description: `Max entries per page. Default 200, hard ceiling ${DIR_LIST_HARD_MAX_ENTRIES}.`,
      }),
    ),
    gatewayUrl: Type.Optional(Type.String()),
    gatewayToken: Type.Optional(Type.String()),
...
const DIR_FETCH_TOOL_DESCRIPTOR = {
  ...
  parameters: Type.Object({
    ...
    path: Type.String({
      description:
        "Absolute path to the directory on the node to fetch. Canonicalized server-side.",
    }),
    maxBytes: Type.Optional(
      Type.Number({
        description:
...
const FILE_WRITE_TOOL_DESCRIPTOR = {
  ...
  parameters: Type.Object({
    ...
    contentBase64: Type.Optional(
      Type.String({ description: "Base64-encoded bytes to write. Maximum 16 MB after decode." }),
    ),
    ...
    mimeType: Type.Optional(
      Type.String({ description: "Content type hint. Not validated against the content." }),
    ),
...
//#endregion
export {
  DIR_LIST_TOOL_DESCRIPTOR as a,
  FILE_FETCH_TOOL_DESCRIPTOR as c,
  FILE_WRITE_TOOL_DESCRIPTOR as d,
  appendFileTransferAudit as f,
  DIR_LIST_HARD_MAX_ENTRIES as i,
  FILE_TRANSFER_SUBDIR as l,
  DIR_FETCH_HARD_MAX_BYTES as n,
  FILE_FETCH_DEFAULT_MAX_BYTES as o,
  DIR_FETCH_TOOL_DESCRIPTOR as r,
  FILE_FETCH_HARD_MAX_BYTES as s,
  DIR_FETCH_DEFAULT_MAX_BYTES as t,
  FILE_WRITE_HARD_MAX_BYTES as u,
};
