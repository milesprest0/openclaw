...
import {
  S as markDiagnosticEmbeddedRunStarted,
  i as logMessageQueued,
  s as logSessionStateChange,
  x as markDiagnosticEmbeddedRunEnded,
} from "./diagnostic-TRyCbvnu.js";
import {
  _ as waitForReplyRunEndBySessionId,
  a as EMBEDDED_RUN_WAITERS,
  c as abortActiveReplyRuns,
  d as forceClearReplyRunBySessionId,
  f as isReplyRunActiveForSessionId,
  g as resolveActiveReplyRunSessionId,
  i as EMBEDDED_RUN_MODEL_SWITCH_REQUESTS,
  l as abortReplyRunBySessionId,
  m as queueReplyRunMessage,
  n as ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_KEY,
  o as getActiveEmbeddedRunCount,
  p as isReplyRunStreamingForSessionId,
  r as ACTIVE_EMBEDDED_RUN_SNAPSHOTS,
  t as ACTIVE_EMBEDDED_RUNS,
...
function clearActiveRunSessionKeys(sessionId, sessionKey) {
  ...
  for (const [key, activeSessionId] of ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_KEY)
    if (activeSessionId === sessionId) ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_KEY.delete(key);
}
...
function forceClearEmbeddedPiRun(sessionId, sessionKey, reason = "stuck_recovery") {
  ...
  return (
    forceClearReplyRunBySessionId(
      sessionId,
      /* @__PURE__ */ new Error(`Embedded run force-cleared by ${reason}`),
    ) || cleared
  );
}
//#endregion
export {
  getActiveEmbeddedRunSnapshot as a,
  isEmbeddedPiRunStreaming as c,
  resolveActiveEmbeddedRunSessionId as d,
  setActiveEmbeddedRun as f,
  waitForEmbeddedPiRunEnd as h,
  forceClearEmbeddedPiRun as i,
  queueEmbeddedPiMessage as l,
  waitForActiveEmbeddedRuns as m,
  abortEmbeddedPiRun as n,
  isEmbeddedPiRunActive as o,
  updateActiveEmbeddedRunSnapshot as p,
  clearActiveEmbeddedRun as r,
  isEmbeddedPiRunHandleActive as s,
  abortAndDrainEmbeddedPiRun as t,
  resolveActiveEmbeddedRunHandleSessionId as u,
};
