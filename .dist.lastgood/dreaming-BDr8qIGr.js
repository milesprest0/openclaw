...
const DEFAULT_MEMORY_DEEP_DREAMING_MIN_SCORE = 0.8;
...
function resolveMemoryDreamingPluginId(cfg) {
  const configuredSlot = normalizeTrimmedString(
    asNullableRecord(asNullableRecord(asNullableRecord(cfg)?.plugins)?.slots)?.memory,
  );
...
function resolveMemoryDreamingWorkspaces(cfg, options = {}) {
  ...
  addWorkspace(
    options.primaryWorkspaceDir ?? void 0,
...
//#endregion
export {
  DEFAULT_MEMORY_REM_DREAMING_LOOKBACK_DAYS as A,
  MEMORY_DREAMING_SYSTEM_EVENT_TEXT as B,
  DEFAULT_MEMORY_DREAMING_VERBOSE_LOGGING as C,
  DEFAULT_MEMORY_LIGHT_DREAMING_LOOKBACK_DAYS as D,
  DEFAULT_MEMORY_LIGHT_DREAMING_LIMIT as E,
  LEGACY_MEMORY_REM_DREAMING_CRON_NAME as F,
  resolveMemoryDreamingConfig as G,
  isSameMemoryDreamingDay as H,
  LEGACY_MEMORY_REM_DREAMING_CRON_TAG as I,
  resolveMemoryDreamingWorkspaces as J,
  resolveMemoryDreamingPluginConfig as K,
  LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT as L,
  LEGACY_MEMORY_LIGHT_DREAMING_CRON_NAME as M,
  LEGACY_MEMORY_LIGHT_DREAMING_CRON_TAG as N,
  DEFAULT_MEMORY_REM_DREAMING_CRON_EXPR as O,
  LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT as P,
  MANAGED_MEMORY_DREAMING_CRON_NAME as R,
  DEFAULT_MEMORY_DREAMING_TIMEZONE as S,
  DEFAULT_MEMORY_LIGHT_DREAMING_DEDUPE_SIMILARITY as T,
  resolveMemoryCorePluginConfig as U,
  formatMemoryDreamingDay as V,
  resolveMemoryDeepDreamingConfig as W,
  resolveMemoryRemDreamingConfig as X,
  resolveMemoryLightDreamingConfig as Y,
  DEFAULT_MEMORY_DREAMING_PLUGIN_ID as _,
  DEFAULT_MEMORY_DEEP_DREAMING_MIN_SCORE as a,
  DEFAULT_MEMORY_DREAMING_STORAGE_MODE as b,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_AUTO_WRITE_MIN_CONFIDENCE as c,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_MAX_CANDIDATES as d,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_MIN_CONFIDENCE as f,
  DEFAULT_MEMORY_DREAMING_FREQUENCY as g,
  DEFAULT_MEMORY_DREAMING_ENABLED as h,
  DEFAULT_MEMORY_DEEP_DREAMING_MIN_RECALL_COUNT as i,
  DEFAULT_MEMORY_REM_DREAMING_MIN_PATTERN_STRENGTH as j,
  DEFAULT_MEMORY_REM_DREAMING_LIMIT as k,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_ENABLED as l,
  DEFAULT_MEMORY_DREAMING_BUDGET as m,
  DEFAULT_MEMORY_DEEP_DREAMING_LIMIT as n,
  DEFAULT_MEMORY_DEEP_DREAMING_MIN_UNIQUE_QUERIES as o,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_TRIGGER_BELOW_HEALTH as p,
  resolveMemoryDreamingPluginId as q,
  DEFAULT_MEMORY_DEEP_DREAMING_MAX_AGE_DAYS as r,
  DEFAULT_MEMORY_DEEP_DREAMING_RECENCY_HALF_LIFE_DAYS as s,
  DEFAULT_MEMORY_DEEP_DREAMING_CRON_EXPR as t,
  DEFAULT_MEMORY_DEEP_DREAMING_RECOVERY_LOOKBACK_DAYS as u,
  DEFAULT_MEMORY_DREAMING_SEPARATE_REPORTS as v,
  DEFAULT_MEMORY_LIGHT_DREAMING_CRON_EXPR as w,
  DEFAULT_MEMORY_DREAMING_THINKING as x,
  DEFAULT_MEMORY_DREAMING_SPEED as y,
  MANAGED_MEMORY_DREAMING_CRON_TAG as z,
};
