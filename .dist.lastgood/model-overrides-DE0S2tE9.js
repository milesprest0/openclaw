...
import {
  n as resolveSessionConversationRef,
  t as resolveSessionConversation,
} from "./session-conversation-YLqp8hUs.js";
import {
...
function buildChannelCandidates(params) {
  ...
  const groupConversationKind =
    normalizeChatType(params.groupChatType ?? void 0) === "channel"
      ? "channel"
