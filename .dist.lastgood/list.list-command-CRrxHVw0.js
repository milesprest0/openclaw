...
import { n as formatErrorWithStack } from "./list.errors-hztL3tO6.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-BeMcDQgH.js";
import { n as loadModelsConfigWithSource } from "./load-config-CalVktbI.js";
import {
...
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-DOaXxoUi.js";
import {
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-BsflYiD2.js";
import { i as normalizeProviderIdForAuth } from "./provider-id-CG9pXYPs.js";
import { r as writeRuntimeJson } from "./runtime-kqN0Yohi.js";
import { t as sanitizeTerminalText } from "./safe-text-DZ5FuuJY.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-BbHHdmwP.js";
...
const registryLoadModuleLoader = createLazyImportLoader(
  () => import("./list.registry-load-pLzUU7uG.js"),
);
const rowSourcesModuleLoader = createLazyImportLoader(
  () => import("./list.row-sources-CXOTsIqO.js"),
);
const sourcePlanModuleLoader = createLazyImportLoader(
  () => import("./list.source-plan-BAtTdJvz.js"),
);
...
async function modelsListCommand(opts, runtime) {
  ...
  const [
    ...
    import("./store-BojU6pEf.js"),
    import("./agent-scope-Bm8ZjMdO.js"),
    import("./workspace-96uq49t6.js"),
  ]);
