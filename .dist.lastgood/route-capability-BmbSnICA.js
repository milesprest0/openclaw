import { l as resolvePluginNodeCapabilityTtlMs } from "./plugin-node-capability-mS-g2wAV.js";
import { t as findMatchingPluginHttpRoutes } from "./route-match-DIDN4VN8.js";
...
function findMatchingPluginNodeCapabilityRoutes(registry, context) {
  return findMatchingPluginHttpRoutes(registry, context)
    ...
    .map((route) =>
      Object.assign({}, route, { nodeCapability: resolvePluginNodeCapabilityRouteSurface(route) }),
    );
}
...
//#endregion
export {
  findMatchingPluginNodeCapabilityRoutes as n,
  listPluginNodeCapabilities as r,
  findMatchingPluginNodeCapabilityRoute as t,
};
