...
import { n as registerGoogleGeminiCliProvider } from "../../gemini-cli-provider-BaNsvIhb.js";
import "../../text-runtime-lKuAtsoz.js";
import { t as createGeminiWebSearchProvider } from "../../gemini-web-search-provider-DZtuuVNH.js";
import "../../secret-input-Bz1bMixv.js";
import {
  c as createGoogleMusicGenerationProviderMetadata,
  l as createGoogleVideoGenerationProviderMetadata,
} from "../../generation-provider-metadata-DRAWG0JN.js";
import { t as geminiMemoryEmbeddingProviderAdapter } from "../../memory-embedding-adapter-DfVpEP0y.js";
import { t as definePluginEntry } from "../../plugin-entry-Yc8_SbjU.js";
import { n as registerGoogleProvider } from "../../provider-registration-CJ_D9YbM.js";
import { n as buildGoogleSpeechProvider } from "../../speech-provider-k-ib_3MP.js";
...
function resolveGoogleRealtimeProviderConfig(rawConfig, cfg) {
  ...
  return {
    ...raw,
    ...(raw.apiKey === void 0
      ? cfg?.models?.providers?.google?.apiKey === void 0
        ? {}
        : {
