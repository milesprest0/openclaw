...
import { t as createFirecrawlWebFetchProvider } from "../../firecrawl-fetch-provider-CPhtzlFU.js";
import { t as createFirecrawlWebSearchProvider } from "../../firecrawl-search-provider-CN_jDliH.js";
import { t as definePluginEntry } from "../../plugin-entry-Yc8_SbjU.js";
import { r as optionalStringEnum } from "../../typebox-DifzaH7c.js";
...
const FirecrawlScrapeToolSchema = Type.Object(
  {
    ...
    extractMode: optionalStringEnum(["markdown", "text"], {
    ...
    onlyMainContent: Type.Optional(
      Type.Boolean({ description: "Keep only main content when Firecrawl supports it." }),
    ),
    ...
    proxy: optionalStringEnum(["auto", "basic", "stealth"], {
      description: 'Firecrawl proxy mode ("auto", "basic", or "stealth").',
    }),
    storeInCache: Type.Optional(
      Type.Boolean({ description: "Whether Firecrawl should store the scrape in its cache." }),
    ),
...
function createFirecrawlScrapeTool(api) {
  return {
    ...
    execute: async (_toolCallId, rawParams) => {
      ...
      const proxy =
        proxyRaw === "basic" || proxyRaw === "stealth" || proxyRaw === "auto" ? proxyRaw : void 0;
      const onlyMainContent =
        typeof rawParams.onlyMainContent === "boolean" ? rawParams.onlyMainContent : void 0;
      const storeInCache =
        typeof rawParams.storeInCache === "boolean" ? rawParams.storeInCache : void 0;
      return jsonResult(
...
const FirecrawlSearchToolSchema = Type.Object(
  {
    ...
    scrapeResults: Type.Optional(
      Type.Boolean({ description: "Include scraped result content when Firecrawl returns it." }),
    ),
    timeoutSeconds: Type.Optional(
      Type.Number({
