...
} from "../../accounts-Cy8a_3aQ.js";
import { t as firstDefined } from "../../allow-from-REahseRU.js";
import {
  a as createListCard,
  i as createInfoCard,
  n as createCarousel,
  o as createNotificationBubble,
  r as createImageCard,
  t as createActionCard,
} from "../../basic-cards-YEzJpnBJ.js";
...
import { r as logVerbose, t as danger } from "../../globals-BdfwDi2E.js";
...
import {
  A as createButtonMenu,
  B as datetimePickerAction,
  C as pushTemplateMessage,
  D as showLoadingAnimation,
  E as sendMessageLine,
  F as createImageCarouselColumn,
  H as postbackAction,
  I as createLinkMenu,
  L as createProductCarousel,
  M as createCarouselColumn,
  N as createConfirmTemplate,
  O as resolveLineChannelAccessToken,
  P as createImageCarousel,
  R as createTemplateCarousel,
...
import "../../media-mime-B7p6DkBc.js";
import { t as MessagingApiClient } from "../../messagingApiClient-lBgXDOrE.js";
import { l as mimeTypeFromFilePath } from "../../mime-CSQ-Gv-M.js";
import {
  a as validateLineSignature,
  c as isSenderAllowed,
  i as parseLineWebhookBody,
  l as normalizeAllowFrom,
  n as createLineNodeWebhookHandler,
  o as downloadLineMedia,
  r as readLineWebhookRequestBody,
  s as MessagingApiBlobClient,
  t as monitorLineProvider,
  u as normalizeDmAllowFromWithStore,
} from "../../monitor-mX2SLNtV.js";
import { t as probeLineBot } from "../../probe--tcI3_mf.js";
import {
  a as resolveLineGroupConfigEntry,
  i as resolveExactLineGroupConfigKey,
  o as resolveLineGroupLookupIds,
  r as setLineRuntime,
  s as resolveLineGroupsConfig,
} from "../../quick-reply-fallback-DtLI7aqg.js";
import {
  a as createMediaPlayerCard,
  i as createDeviceControlCard,
  n as parseLineDirectives,
  o as LineChannelConfigSchema,
  r as createAppleTvRemoteCard,
  s as LineConfigSchema,
  t as hasLineDirectives,
} from "../../reply-payload-transform-B4OE-iPt.js";
import {
  n as createEventCard,
  r as createReceiptCard,
  t as createAgendaCard,
} from "../../schedule-cards-boCxOP_u.js";
import {
...
import { r as stripMarkdown } from "../../text-runtime-lKuAtsoz.js";
...
function readRawBody(req) {
  const rawBody =
    req.rawBody ?? (typeof req.body === "string" || Buffer.isBuffer(req.body) ? req.body : null);
...
function getClient(opts) {
  ...
  return new MessagingApiClient({
    channelAccessToken: resolveLineChannelAccessToken(opts.channelAccessToken, account),
  });
}
