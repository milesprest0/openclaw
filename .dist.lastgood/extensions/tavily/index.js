...
import { n as runTavilyExtract, r as runTavilySearch } from "../../tavily-client-CCB5Axmr.js";
import { t as createTavilyWebSearchProvider } from "../../tavily-search-provider-CFinYhep.js";
...
const TavilyExtractToolSchema = Type.Object(
  {
    ...
    extract_depth: optionalStringEnum(["basic", "advanced"], {
    ...
    include_images: Type.Optional(
      Type.Boolean({ description: "Include image URLs in extraction results." }),
    ),
  },
...
function createTavilyExtractTool(api, ctx) {
  return {
    ...
    execute: async (_toolCallId, rawParams) => {
      ...
      if (chunksPerSource !== void 0 && !query)
...
const TavilySearchToolSchema = Type.Object(
  {
    ...
    topic: optionalStringEnum(["general", "news", "finance"], {
    ...
    include_answer: Type.Optional(
      Type.Boolean({ description: "Include an AI-generated answer summary (default: false)." }),
    ),
    time_range: optionalStringEnum(["day", "week", "month", "year"], {
  ...
  return {
    ...
    execute: async (_toolCallId, rawParams) => {
      ...
      const includeDomains = Array.isArray(rawParams.include_domains)
        ? rawParams.include_domains.filter(Boolean)
        : void 0;
      const excludeDomains = Array.isArray(rawParams.exclude_domains)
        ? rawParams.exclude_domains.filter(Boolean)
        : void 0;
      return jsonResult(
