...
import "../../json-schema-runtime-DzNs2rk7.js";
import "../../agent-runtime-CG9i2LmY.js";
import "../../api-Bv2XzvGt.js";
...
function createLlmTaskTool(api) {
  return {
    ...
    async execute(_id, params) {
      ...
      const primaryModel =
        typeof primary === "string" ? primary.split("/").slice(1).join("/") : void 0;
      ...
      const thinkingRaw =
        typeof params.thinking === "string" && params.thinking.trim() ? params.thinking : void 0;
