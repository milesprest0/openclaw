import { t as buildCloudflareAiGatewayCatalogProvider } from "../../catalog-provider--TlRWimz.js";
import { n as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF } from "../../models-CtV1W4Rv.js";
import { t as normalizeOptionalSecretInput } from "../../normalize-secret-input-B8M4cov-.js";
import {
  r as buildCloudflareAiGatewayConfigPatch,
  t as applyCloudflareAiGatewayConfig,
} from "../../onboard-CPu3Tdpn.js";
...
import { r as wrapCloudflareAiGatewayProviderStream } from "../../stream-wrappers-BhjXKxVj.js";
...
async function resolveCloudflareGatewayMetadataInteractive(ctx) {
  ...
  if (!accountId)
    accountId = readRequiredTextInput(
  ...
  if (!gatewayId)
    gatewayId = readRequiredTextInput(
      await ctx.prompter.text({
  ...
  register(api) {
    api.registerProvider({
      ...
      auth: [
        {
          ...
          runNonInteractive: async (ctx) => {
            ...
            return applyCloudflareAiGatewayConfig(
      ...
      classifyFailoverReason: ({ errorMessage }) =>
        /\bworkers?_ai\b.*\b(?:rate|limit|quota)\b/i.test(errorMessage) ? "rate_limit" : void 0,
