...
import { t as buildOpenRouterImageGenerationProvider } from "../../image-generation-provider-B_-vmF5U.js";
import { t as openrouterMediaUnderstandingProvider } from "../../media-understanding-provider-P1-HJUHc.js";
import {
  n as applyOpenrouterConfig,
  t as OPENROUTER_DEFAULT_MODEL_REF,
} from "../../onboard-4SsnPf-x.js";
...
import {
  i as normalizeOpenRouterBaseUrl,
  n as buildOpenrouterProvider,
  r as isOpenRouterProxyReasoningUnsupportedModel,
  t as OPENROUTER_BASE_URL,
} from "../../provider-catalog-CAgucFoU.js";
...
import { t as wrapOpenRouterProviderStream } from "../../stream-Ba8B0RBM.js";
import {
  n as supportsOpenRouterXHighThinking,
  t as resolveOpenRouterThinkingProfile,
} from "../../thinking-policy-P88IzjiZ.js";
import { t as buildOpenRouterVideoGenerationProvider } from "../../video-generation-provider-LwID2FJh.js";
...
function normalizeOpenRouterResolvedModel(model) {
  ...
  if ((!normalizedBaseUrl || normalizedBaseUrl === model.baseUrl) && reasoning === model.reasoning)
    return;
  return {
    ...model,
