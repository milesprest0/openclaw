import {
  i as VLLM_PROVIDER_LABEL,
  n as VLLM_DEFAULT_BASE_URL,
  r as VLLM_MODEL_PLACEHOLDER,
  t as VLLM_DEFAULT_API_KEY_ENV_VAR,
} from "../../defaults-B_0J_3sY.js";
import { t as buildVllmProvider } from "../../models-C-CY-cra.js";
import { t as definePluginEntry } from "../../plugin-entry-Yc8_SbjU.js";
import { r as wrapVllmProviderStream } from "../../stream-B4E4ipLZ.js";
import "../../api-BQAKJgsS.js";
  ...
  register(api) {
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        'vLLM requires authentication to be registered as a provider. Set VLLM_API_KEY (any value works) or run "openclaw configure". See: https://docs.openclaw.ai/providers/vllm',
