import { t as buildQwenMediaUnderstandingProvider } from "../../media-understanding-provider-BSNVbR51.js";
import {
  A as isQwenCodingPlanBaseUrl,
  h as QWEN_DEFAULT_MODEL_REF,
  u as QWEN_36_PLUS_MODEL_ID,
  x as applyQwenNativeStreamingUsageCompat,
} from "../../models-npOf4c2S.js";
import {
  d as applyQwenStandardConfig,
  f as applyQwenStandardConfigCn,
  l as applyQwenConfig,
  u as applyQwenConfigCn,
} from "../../onboard-MZP1Gw7S.js";
import { n as buildQwenProvider } from "../../provider-catalog-Bb_NAE0w.js";
import "../../api-C2QkOnsI.js";
import { t as defineSingleProviderPluginEntry } from "../../provider-entry-C_PdVEwP.js";
import { n as wrapQwenProviderStream } from "../../stream-CtcU5h7r.js";
import { t as buildQwenVideoGenerationProvider } from "../../video-generation-provider-B_6rgZld.js";
      ...
      run: async (ctx) => {
        ...
        return {
          provider: {
            ...buildQwenProvider({
              baseUrl:
                resolveConfiguredQwenBaseUrl(ctx.config) ??
