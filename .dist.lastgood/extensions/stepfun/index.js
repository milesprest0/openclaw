import {
  i as applyStepFunStandardConfigCn,
  n as applyStepFunPlanConfigCn,
  r as applyStepFunStandardConfig,
  t as applyStepFunPlanConfig,
} from "../../onboard-DL70CVGM.js";
...
import {
  a as STEPFUN_PLAN_PROVIDER_ID,
  c as STEPFUN_STANDARD_INTL_BASE_URL,
  i as STEPFUN_PLAN_INTL_BASE_URL,
  l as buildStepFunPlanProvider,
  n as STEPFUN_PLAN_CN_BASE_URL,
  o as STEPFUN_PROVIDER_ID,
  r as STEPFUN_PLAN_DEFAULT_MODEL_REF,
  s as STEPFUN_STANDARD_CN_BASE_URL,
  t as STEPFUN_DEFAULT_MODEL_REF,
  u as buildStepFunProvider,
} from "../../provider-catalog-BQQ3zI6O.js";
...
function trimExplicitBaseUrl(ctx, providerId) {
  ...
  return (
    (typeof explicitProvider?.baseUrl === "string" ? explicitProvider.baseUrl.trim() : "") || void 0
  );
}
...
function inferRegionFromExplicitBaseUrls(ctx) {
  return (
    inferRegionFromBaseUrl(trimExplicitBaseUrl(ctx, "stepfun")) ??
    inferRegionFromBaseUrl(trimExplicitBaseUrl(ctx, "stepfun-plan"))
  );
}
