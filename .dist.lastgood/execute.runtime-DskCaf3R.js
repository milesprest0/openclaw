...
import { n as appendBootstrapPromptWarning } from "./bootstrap-budget-BBGdGMkr.js";
import {
  a as createCliJsonlStreamingParser,
  i as shouldUseClaudeLiveSession,
  o as extractCliErrorMessage,
  r as runClaudeLiveSessionTurn,
  s as parseCliOutput,
} from "./claude-live-session-BVqlJhVg.js";
import { t as isTruthyEnvValue } from "./env-GyTZ5xFK.js";
import { n as applySkillEnvOverridesFromSnapshot } from "./env-overrides-DyQKAXcm.js";
import { t as classifyFailoverReason } from "./errors-D66M8xLa.js";
import { s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Dx3vQAkt.js";
...
import {
  a as prepareCliPromptImagePayload,
  c as resolveSessionIdToSend,
  d as buildCliSupervisorScopeKey,
  f as resolveCliNoOutputTimeoutMs,
  l as resolveSystemPromptUsage,
  o as resolveCliRunQueueKey,
  r as enqueueCliRun,
  s as resolvePromptInput,
  t as buildCliArgs,
  u as writeCliSystemPromptFile,
...
import { t as applyPluginTextReplacements } from "./plugin-text-transforms-BqZpOTxV.js";
    ...
    return await enqueueCliRun(queueKey, async () => {
      ...
      try {
        ...
        const logOutputText =
          ...
          isTruthyEnvValue(process.env["OPENCLAW_CLAUDE_CLI_LOG_OUTPUT"]);
        const env = (() => {
        ...
        if (result.exitCode !== 0 || result.reason !== "exit") {
          ...
          if (result.reason === "overall-timeout")
            throw new FailoverError(
              `CLI exceeded timeout (${Math.round(params.timeoutMs / 1e3)}s) and was terminated.`,
              {
                reason: "timeout",
                provider: params.provider,
                model: context.modelId,
