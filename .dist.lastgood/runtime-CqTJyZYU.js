import {
  ...
  n as resolveVideoGenerationSupportedDurations,
  t as normalizeVideoGenerationDuration,
...
} from "./provider-registry-CqXj74qk.js";
import {
...
const VIDEO_RESOLUTION_ORDER = ["480P", "720P", "768P", "1080P"];
  ...
  for (const candidate of candidates) {
    ...
    if (
      ...
      const declaredOptions =
        optCaps?.providerOptions ?? provider.capabilities.providerOptions ?? void 0;
