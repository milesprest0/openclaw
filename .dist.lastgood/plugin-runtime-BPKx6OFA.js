...
import "./gateway-request-scope-Bc6xXkxi.js";
import {
  C as commitPluginInteractiveCallbackDedupe,
  S as claimPluginInteractiveCallbackDedupe,
  b as resolvePluginInteractiveNamespaceMatch,
  w as releasePluginInteractiveCallbackDedupe,
} from "./types-B6YlI8nn.js";
import "./commands-DxJLSJ0J.js";
import "./http-registry-Mvw1TAd4.js";
...
async function startLazyPluginServiceModule(params) {
  ...
  const stop =
    params.stopExportNames && params.stopExportNames.length > 0
      ? resolveExport(mod, params.stopExportNames)
      : null;
  await start();
...
//#endregion
export {
  createInteractiveConversationBindingHelpers as i,
  startLazyPluginServiceModule as n,
  dispatchPluginInteractiveHandler as r,
  defaultLoadOverrideModule as t,
};
