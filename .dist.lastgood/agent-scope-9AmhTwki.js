...
function resolveAgentModelFallbacksOverride(cfg, agentId) {
  ...
  if (!Object.hasOwn(raw, "fallbacks"))
    return Object.hasOwn(raw, "primary") && resolvePrimaryStringValue(raw) ? [] : void 0;
...
//#endregion
export {
  resolveAgentIdByWorkspacePath as a,
  resolveAgentModelPrimary as c,
  resolveFallbackAgentId as d,
  resolveRunModelFallbacksOverride as f,
  setAgentEffectiveModelPrimary as h,
  resolveAgentExplicitModelPrimary as i,
  resolveAgentSkillsFilter as l,
  resolveSessionAgentIds as m,
  resolveAgentEffectiveModelPrimary as n,
  resolveAgentIdsByWorkspacePath as o,
  resolveSessionAgentId as p,
  resolveAgentExecutionContract as r,
  resolveAgentModelFallbacksOverride as s,
  hasConfiguredModelFallbacks as t,
  resolveEffectiveModelFallbacks as u,
};
