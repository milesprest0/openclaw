...
async function expandAllowFromWithAccessGroups(params) {
  ...
  if (
    (
      await resolveAccessGroupAllowFromMatches({
        cfg: params.cfg,
        allowFrom,
        channel: params.channel,
        accountId: params.accountId,
...
//#endregion
export {
  resolveAccessGroupAllowFromMatches as i,
  expandAllowFromWithAccessGroups as n,
  parseAccessGroupAllowFromEntry as r,
  ACCESS_GROUP_ALLOW_FROM_PREFIX as t,
};
