...
function createNpmProjectInstallEnv(env, options = {}) {
  ...
  for (const key of Object.keys(nextEnv))
    if (NPM_CONFIG_KEYS_TO_RESET.has(key.toLowerCase())) delete nextEnv[key];
  const installEnv = {
    ...nextEnv,
...
//#endregion
export {
  resolvePosixNpmScriptShell as i,
  createNpmProjectInstallEnv as n,
  hasNpmScriptShellSetting as r,
  applyPosixNpmScriptShellEnv as t,
};
