...
function stripInboundMetadata(text) {
  ...
  const strippedLeadingPrefixLines = stripActiveMemoryPromptPrefixBlocks(
...
//#endregion
export {
  stripInboundMetadata as n,
  stripLeadingInboundMetadata as r,
  extractInboundSenderLabel as t,
};
