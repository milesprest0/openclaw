...
import { o as resolveAgentWorkspaceDir } from "./agent-scope-config-CXZGyKMl.js";
...
import {
  ...
  r as UnsupportedAttachmentError,
  t as normalizeRpcAttachmentsToChatAttachments,
} from "./attachment-normalize-D1-RooV9.js";
import {
  n as isChatStopCommandText,
  r as registerChatAbortController,
  t as abortChatRunById,
} from "./chat-abort-CMPpqF9g.js";
import {
  a as projectRecentChatDisplayMessages,
  n as isToolHistoryBlockType,
  o as resolveEffectiveChatHistoryMaxChars,
  r as projectChatDisplayMessage,
} from "./chat-display-projection-BE1OTzu2.js";
import { t as augmentChatHistoryWithCliSessionImports } from "./cli-session-history-Dv56DP5l.js";
import {
...
import { n as isSuppressedControlReplyText } from "./control-reply-text-CEeS0DFU.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-C44M7Qbh.js";
import { o as normalizeReplyPayloadsForDelivery } from "./deliver-Dz9Dpt9U.js";
import "./method-scopes-DaDxLn4o.js";
import { t as logLargePayload } from "./diagnostic-payload-Cj36HzcW.js";
import {
  i as stripInlineDirectiveTagsForDisplay,
  n as sanitizeReplyDirectiveId,
} from "./directive-tags-91V02E1x.js";
import "./sessions-Bdy1wToU.js";
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-24GR7qbj.js";
import { a as formatErrorMessage, o as formatUncaughtError } from "./errors-DZMrVkYL.js";
import { C as safeFileURLToPath, y as assertNoWindowsNetworkPath } from "./fs-safe-CgBWiL92.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DzzZF3B1.js";
import { o as normalizeInputProvenance } from "./input-provenance-OI5EnRxZ.js";
import {
...
import {
  ...
  t as appendLocalMediaParentRoots,
} from "./local-roots-CCSkqO59.js";
import {
  i as createManagedOutgoingImageBlocks,
  n as attachManagedOutgoingImagesToMessage,
  r as cleanupManagedOutgoingImageRecords,
} from "./managed-image-attachments-BdLBBQGV.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-VUC-himU.js";
import "./local-file-access-KUGx5XDy.js";
import {
  a as isOperatorUiClient,
  n as isGatewayCliClient,
  o as isWebchatClient,
  u as normalizeMessageChannel,
} from "./message-channel-GRZIhFYD.js";
import { o as isAudioFileName } from "./mime-CSQ-Gv-M.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Codapd9g.js";
import { i as resolveSessionFilePath } from "./paths-CfeECf6Z.js";
import {
  l as measureDiagnosticsTimelineSpan,
  u as measureDiagnosticsTimelineSpanSync,
} from "./plugin-metadata-snapshot-C2hpt3LY.js";
import {
  C as validateChatSendParams,
  S as validateChatInjectParams,
  gi as errorShape,
  hi as ErrorCodes,
  t as formatValidationErrors,
  x as validateChatHistoryParams,
  y as validateChatAbortParams,
} from "./protocol-CUn5aLrV.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-SDNNla5z.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-Cz0C2Qt-.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-CCj3cY2B.js";
...
import {
  ...
  h as resolveGatewaySessionThinkingDefault,
  p as resolveGatewayModelSupportsImages,
  v as resolveSessionModelRef,
} from "./session-utils-Dhg586UW.js";
import {
  C as jsonUtf8Bytes,
  h as stripEnvelopeFromMessage,
  i as readRecentSessionMessagesAsync,
  m as readSessionTranscriptIndex,
  n as capArrayByJsonBytes,
} from "./session-utils.fs-z-7Kw0Lg.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-BpzkawU-.js";
import {
  h as releaseInboundMedia,
  i as deleteMediaBuffer,
  m as pinInboundMedia,
  p as DEFAULT_INBOUND_RETENTION_GRACE_MS,
  t as MEDIA_MAX_BYTES,
  u as saveMediaBuffer,
} from "./store-N2etmi9e.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-BdEutqX5.js";
import { d as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-BNkDK1si.js";
...
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BMgIxJ7i.js";
...
function buildActiveChatSendDedupeKey(params) {
  ...
  if (
    ...
    normalizeMessageChannel(params.originatingChannel) !== "webchat"
  )
    return null;
  return `${ACTIVE_CHAT_SEND_DEDUPE_PREFIX}:${createHash("sha256")
...
function isManagedOutgoingImageUrl(value) {
  ...
  try {
    return new URL(value, "http://localhost").pathname.startsWith(
...
function resolveChatSendOriginatingRoute(params) {
  ...
  if (params.sessionKey.length > 512)
    return {
      originatingChannel: INTERNAL_MESSAGE_CHANNEL,
      explicitDeliverRoute: false,
    };
  const sessionScopeParts = (parseAgentSessionKey(params.sessionKey)?.rest ?? params.sessionKey)
    .split(":", 3)
    .filter(Boolean);
  ...
  try {
    ...
    if (oversizedForSandbox.length > 0)
      throw new UnsupportedAttachmentError(
        ...
        `attachments exceed sandbox staging limit (${MEDIA_MAX_BYTES} bytes): ${oversizedForSandbox.map((ref) => `${ref.label} (${ref.sizeBytes} bytes)`).join(", ")}`,
      );
    const stagingCtx = {
...
function extractTranscriptUserText(content) {
  ...
  const textBlocks = content
    .map((block) => (block && typeof block === "object" && "text" in block ? block.text : void 0))
...
async function rewriteChatSendUserTurnMediaPaths(params) {
  ...
  const target = (await readSessionTranscriptIndex(params.transcriptPath))?.entries
    .toReversed()
    .find((entry) => {
  ...
  if (
    !baseContent.some((block) => {
      ...
      return (
        ...
        ((typed.preview.viewId && typed.preview.viewId === preview.viewId) ||
          (typed.preview.url && typed.preview.url === preview.url))
      );
    })
  )
    baseContent.push({
...
function normalizeExplicitChatSendOrigin(params) {
  ...
  if (!Boolean(originatingChannel || originatingTo || accountId || messageThreadId))
    return { ok: true };
...
const chatHandlers = {
  ...
  "chat.send": async ({ params, respond, context, client }) => {
    ...
    try {
      ...
      const commandBody = Boolean(p.thinking && trimmedMessage && !trimmedMessage.startsWith("/"))
      ...
      const appendWebchatAgentMediaTranscriptIfNeeded = async (payload) => {
        ...
        const mediaLocalRoots = appendLocalMediaParentRoots(
          ...
          resolvedTranscriptPath ? [resolvedTranscriptPath] : void 0,
        );
              ...
              if (!agentRunStarted) {
                ...
                if (btwReplies.length > 0 && btwText) {
                  ...
                  const finalPayloads = await normalizeWebchatReplyMediaPathsForDisplay({
                    ...
                    agentId,
                    accountId,
                    payloads: appendedWebchatAgentMedia
                      ? []
                      : deliveredReplies
...
//#endregion
export {
  replaceOversizedChatHistoryMessages as a,
  waitForTerminalGatewayDedupe as c,
  enforceChatHistoryFinalBudget as i,
  augmentChatHistoryWithCanvasBlocks as n,
  readTerminalSnapshotFromGatewayDedupe as o,
  chatHandlers as r,
  setGatewayDedupeEntry as s,
  CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES as t,
};
