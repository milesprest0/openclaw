import {
  ...
  r as hasVisibleChannelTurnDispatch,
...
const dispatchChannelMessageReplyWithBase = async (...args) => {
  return await (
    await import("./plugin-sdk/inbound-reply-dispatch.js")
  ).dispatchChannelMessageReplyWithBase(...args);
};
const recordChannelMessageReplyDispatch = async (...args) => {
  return await (
    await import("./plugin-sdk/inbound-reply-dispatch.js")
  ).recordChannelMessageReplyDispatch(...args);
};
const deliverInboundReplyWithMessageSendContext = async (...args) => {
  return await (
    await import("./kernel-DMLaSO2Y.js")
  ).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
  return await (await import("./runtime-Bqd5k57V.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
  return await (await import("./runtime-Bqd5k57V.js")).withDurableMessageSendContext(params, run);
}
...
//#endregion
export {
  verifyChannelMessageLiveCapabilityProofs as C,
  verifyDurableFinalCapabilityProofs as D,
  verifyChannelMessageReceiveAckPolicyProofs as E,
  verifyLivePreviewFinalizerCapabilityProofs as O,
  verifyChannelMessageLiveCapabilityAdapterProofs as S,
  verifyChannelMessageReceiveAckPolicyAdapterProofs as T,
  listDeclaredChannelMessageLiveCapabilities as _,
  deliverInboundReplyWithMessageSendContext as a,
  listDeclaredReceiveAckPolicies as b,
  hasVisibleChannelMessageReplyDispatch as c,
  sendDurableMessageBatch as d,
  withDurableMessageSendContext as f,
  shouldAckMessageAfterStage as g,
  createMessageReceiveContext as h,
  deliverDurableInboundReplyPayload as i,
  createChannelMessageAdapterFromOutbound as k,
  recordChannelMessageReplyDispatch as l,
  createDurableMessageStateRecord as m,
  createChannelTurnReplyPipeline as n,
  dispatchChannelMessageReplyWithBase as o,
  classifyDurableSendRecoveryState as p,
  defineChannelMessageAdapter as r,
  hasFinalChannelMessageReplyDispatch as s,
  buildChannelMessageReplyDispatchBase as t,
  resolveChannelMessageReplyDispatchCounts as u,
  listDeclaredDurableFinalCapabilities as v,
  verifyChannelMessageLiveFinalizerProofs as w,
  verifyChannelMessageAdapterCapabilityProofs as x,
  listDeclaredLivePreviewFinalizerCapabilities as y,
};
