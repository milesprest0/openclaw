...
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-c6-2eZvI.js";
import {
  a as resolveQueuedReplyExecutionConfig,
  c as resolveRunAuthProfile,
  i as isBunFetchSocketError,
  o as resolveQueuedReplyRuntimeConfig,
  r as formatBunFetchSocketError,
  s as resolveModelFallbackOptions,
  t as buildEmbeddedRunExecutionParams,
} from "./agent-runner-utils-mfAxMkYt.js";
...
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-BsjMPFd_.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-DnuPT-bL.js";
import "./defaults-4m7JJmD2.js";
import {
  n as createBlockReplyContentKey,
  r as createBlockReplyPipeline,
  t as createAudioAsVoiceBuffer,
} from "./block-reply-pipeline-BRNo7fsu.js";
import "./config-CMOdcWpc.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DC6SDJSU.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BBGdGMkr.js";
import {
  n as buildAgentRuntimeOutcomePlan,
  t as buildAgentRuntimeDeliveryPlan,
} from "./build-BPMIpRAa.js";
import { t as runCliAgent } from "./cli-runner-C0zz1uM6.js";
import {
  c as setCliSessionId,
  r as getCliSessionBinding,
  s as setCliSessionBinding,
} from "./cli-session-FZWoj6wf.js";
import {
  n as GatewayDrainingError,
  t as CommandLaneClearedError,
} from "./command-queue-BtommWHg.js";
import { i as estimateMessagesTokens } from "./compaction-B6HM89B8.js";
import { i as resolveSandboxConfigForAgent } from "./config-aLdl9MiY.js";
import "./sessions-Bdy1wToU.js";
import { a as resolveContextTokensForModel } from "./context-BNAuEVrI.js";
import {
  I as readPostCompactionContext,
  a as resolveContextBudget,
  r as isLikelyOverBudget,
...
import {
  _ as isTransientHttpError,
  d as isContextOverflowError,
  m as isLikelyContextOverflowError,
  u as isCompactionFailureError,
} from "./errors-D66M8xLa.js";
import { a as formatErrorMessage, t as SocketDropException } from "./errors-DZMrVkYL.js";
import {
  i as isOverloadedErrorMessage,
  o as isRateLimitErrorMessage,
  r as isBillingErrorMessage,
} from "./failover-matches-CDN8j5cn.js";
...
import { x as resolveMemoryFlushPlan } from "./memory-state-BfIgqH24.js";
import {
  f as resolveMessageChannel,
  i as isMarkdownCapableMessageChannel,
  r as isInternalMessageChannel,
} from "./message-channel-GRZIhFYD.js";
import { o as isAudioFileName } from "./mime-CSQ-Gv-M.js";
import { u as resolveModelAuthMode } from "./model-auth-Do8Bfz1M.js";
import {
  r as runWithModelFallback,
  t as isFallbackSummaryError,
  u as LiveSessionModelSwitchError,
} from "./model-fallback-fY3p6tiZ.js";
import { i as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-BTwCXkkK.js";
import { t as formatProviderModelRef } from "./model-runtime-D7UoNxI6.js";
import { t as isCliProvider } from "./model-selection-cli-DuYeikT-.js";
import "./pi-embedded-helpers-BhGvpMlL.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-D9oQINZ2.js";
import {
  n as classifyOAuthRefreshFailure,
  t as buildOAuthRefreshFailureLoginCommand,
} from "./oauth-refresh-failure-BP623TH9.js";
import { o as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-CqBr51KZ.js";
import {
  n as resolveOriginMessageProvider,
  r as resolveOriginMessageTo,
  t as resolveOriginAccountId,
} from "./origin-routing-Dp7tWtVT.js";
import {
  a as resolveSessionFilePathOptions,
  i as resolveSessionFilePath,
  o as resolveSessionTranscriptPath,
} from "./paths-CfeECf6Z.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-D_bdRDPs.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-C2hpt3LY.js";
import {
  a as enqueueFollowupRun,
  c as scheduleFollowupDrain,
  l as refreshQueuedFollowupSession,
  n as resolvePiSteeringModeForQueueMode,
} from "./queue-m5o6nz1B.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-SDNNla5z.js";
import {
  i as setReplyPayloadMetadata,
  r as markReplyPayloadForSourceSuppressionDelivery,
  t as copyReplyPayloadMetadata,
} from "./reply-payload-D38mxo21.js";
import {
  m as resolveSendableOutboundReplyParts,
  s as hasOutboundReplyContent,
} from "./reply-payload-D_-IJF8p.js";
import {
  n as filterMessagingToolMediaDuplicates,
  r as resolveMessagingToolPayloadDedupe,
  t as filterMessagingToolDuplicates,
} from "./reply-payloads-dedupe-BKv1pe4T.js";
import {
  i as resolveReplyToMode,
  t as createReplyToModeFilterForChannel,
} from "./reply-threading-A0IAxIYj.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DsTHhNFd.js";
import {
  h as replyRunRegistry,
  s as ReplyRunAlreadyActiveError,
  u as createReplyOperation,
} from "./run-state-uLckWPme.js";
import { l as queueEmbeddedPiMessage } from "./runs-CztEUxOL.js";
import { r as enqueueCommitmentExtraction } from "./runtime-BSobAMFU.js";
...
import {
  d as sanitizeUserFacingText,
  i as formatRateLimitOrOverloadedErrorCopy,
  t as BILLING_ERROR_USER_MESSAGE,
} from "./sanitize-user-facing-text-Cgbm6W76.js";
import { a as generateSecureUuid } from "./secure-random-Ck_jpq4r.js";
import "./sandbox-Cz0C2Qt-.js";
import { u as isLikelyExecutionAckPrompt } from "./selection-BcCvjGlJ.js";
...
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-D-z-Dnd7.js";
import { n as incrementCompactionCount } from "./session-updates-CBcC0sMs.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-z-7Kw0Lg.js";
import {
  a as applyReplyThreading,
  i as applyReplyTagsToPayload,
  s as isRenderablePayload,
} from "./silent-reply-B9HyBycr.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-BejFwJbn.js";
import {
  c as updateSessionStoreEntry,
  s as updateSessionStore,
  x as resolveGroupSessionKey,
} from "./store-BpWdoYPF.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-CuwH2dda.js";
...
import { a as enqueueSystemEvent } from "./system-events-CttxBeh2.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-C9_Z62px.js";
import {
...
import {
  c as resolveSessionPluginTraceLines,
  o as resolveFreshSessionTotalTokens,
  s as resolveSessionPluginStatusLines,
} from "./types-C7lm-riv.js";
import {
  r as resolveActiveRunQueueAction,
  t as createTypingSignaler,
} from "./typing-mode-BnBEhBdf.js";
import {
  c as sanitizePerCallCacheUsage,
  i as hasNonzeroUsage,
  n as derivePromptTokens,
  o as normalizeUsage,
  r as deriveSessionTotalTokens,
  s as providerFamily,
  t as deriveContextPromptTokens,
    ...
    const taggedPayload = applyReplyTagsToPayload(
      {
        ...
        replyToId:
          payload.replyToId ?? (implicitCurrentMessageAllowed ? params.currentMessageId : void 0),
      },
...
function buildKnownAgentRunFailureReplyPayload(params) {
  ...
  if (isFallbackSummary ? isPureBillingSummary(params.err) : isBillingErrorMessage(message))
    return markAgentRunFailureReplyPayload({
      text: resolveExternalRunFailureTextForConversation({
...
function resolveRestartLifecycleError(err) {
  ...
  while (pendingIndex < pending.length) {
    ...
    if (isFallbackSummaryError(candidate))
      for (const attempt of candidate.attempts) pending.push(attempt.error);
...
async function runAgentTurnWithFallback(params) {
  ...
  const persistFallbackCandidateSelection = async (provider, model) => {
    ...
    if (
      ...
      (activeSessionEntry.modelOverrideSource === void 0 &&
    ...
    return async () => {
      if (rollbackFallbackSelectionStateIfUnchanged(activeSessionEntry, nextState, previousState))
        params.activeSessionStore[params.sessionKey] = activeSessionEntry;
  ...
  while (true)
    try {
      const normalizeStreamingText = (payload) => {
        ...
        if (
          isSilentReplyPrefixText(text, "NO_REPLY") ||
          isSilentReplyPrefixText(text, "HEARTBEAT_OK")
        )
          return { skip: true };
        if (text && startsWithSilentToken(text, "NO_REPLY"))
                ...
                onAgentEvent: async (evt) => {
                  ...
                  if (evt.stream === "plan")
                    await params.opts?.onPlanUpdate?.({
                      ...
                      steps: Array.isArray(evt.data.steps)
                        ? evt.data.steps.filter((step) => typeof step === "string")
                        : void 0,
                    ...
                    await params.opts?.onCommandOutput?.({
                      ...
                      exitCode:
                        typeof evt.data.exitCode === "number" || evt.data.exitCode === null
                          ...
                          : void 0,
                      durationMs:
                        typeof evt.data.durationMs === "number" ? evt.data.durationMs : void 0,
                  ...
                  if (evt.stream === "patch")
                    await params.opts?.onPatchSummary?.({
                      ...
                      added: Array.isArray(evt.data.added)
                        ? evt.data.added.filter((entry) => typeof entry === "string")
                        : void 0,
                      modified: Array.isArray(evt.data.modified)
                        ? evt.data.modified.filter((entry) => typeof entry === "string")
                        : void 0,
                      deleted: Array.isArray(evt.data.deleted)
                        ? evt.data.deleted.filter((entry) => typeof entry === "string")
                        : void 0,
                      summary: readStringValue(evt.data.summary),
                    });
                  if (evt.stream === "compaction") {
                    ...
                    if (phase === "start") {
                      ...
                      else if (!params.opts?.onCompactionStart && shouldNotifyUserAboutCompaction)
                    ...
                    if (phase === "end") {
                      if (evt.data?.completed === true) {
                        ...
                        if (hookMessages.length > 0) await sendCompactionHookMessages(hookMessages);
                        else if (!params.opts?.onCompactionEnd && shouldNotifyUserAboutCompaction)
      ...
      if (err instanceof LiveSessionModelSwitchError) {
        ...
        if (liveModelSwitchRetries > 2) {
          defaultRuntime.error(
            `Live model switch failed after 2 retries (${sanitizeForLog(err.provider)}/${sanitizeForLog(err.model)}). The requested model may be unavailable.`,
          );
...
const signalTypingIfNeeded = async (payloads, typingSignals) => {
  if (payloads.some((payload) => hasOutboundReplyContent(payload, { trimText: true })))
...
function resolveMemoryFlushGateState(params) {
  ...
  const totalTokens =
    resolvePositiveTokenCount$1(params.tokenCount) ?? resolveFreshSessionTotalTokens(params.entry);
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-6CIIAYDg.js"));
  ...
  if (params.includeUsage)
    try {
      snapshot.usage = deriveTranscriptUsageSnapshot(
        await readLastNonzeroUsageFromSessionLog(logPath),
      );
    } catch {
...
async function runPreflightCompactionIfNeeded(params) {
  ...
  let entry =
    params.sessionEntry ?? (params.sessionKey ? params.sessionStore?.[params.sessionKey] : void 0);
  ...
  const tokenCountForCompaction =
    Number.isFinite(projectedTokenCount) && projectedTokenCount > 0 ? projectedTokenCount : void 0;
  const threshold = contextWindowTokens - reserveTokensFloor - softThresholdTokens;
  logVerbose(
    `preflightCompaction check: sessionKey=${params.sessionKey} tokenCount=${tokenCountForCompaction ?? freshPersistedTokens ?? "undefined"} contextWindow=${contextWindowTokens} threshold=${threshold} isHeartbeat=${params.isHeartbeat} isCli=${isCli} persistedFresh=${entry?.totalTokensFresh === true} transcriptPromptTokens=${transcriptPromptTokens ?? "undefined"} promptTokensEst=${promptTokenEstimate ?? "undefined"} activeTranscriptBytes=${activeTranscriptBytes ?? "undefined"} maxActiveTranscriptBytes=${maxActiveTranscriptBytes ?? "undefined"} sizeTrigger=${shouldCompactByTranscriptBytes} contextBudgetEnabled=${contextBudget.enabled} maxAssembledTokens=${contextBudget.maxAssembledTokens} budgetTrigger=${shouldCompactByContextBudget}`,
  );
  ...
  if (!(shouldCompactByTokens || shouldCompactByTranscriptBytes || shouldCompactByContextBudget))
    return entry ?? params.sessionEntry;
  const compactionTrigger = shouldCompactByTranscriptBytes
    ...
    : shouldCompactByContextBudget && !shouldCompactByTokens
      ...
      : "tokens";
  logVerbose(
    `preflightCompaction triggered: sessionKey=${params.sessionKey} tokenCount=${tokenCountForCompaction ?? freshPersistedTokens ?? "undefined"} threshold=${threshold} trigger=${compactionTrigger} activeTranscriptBytes=${activeTranscriptBytes ?? "undefined"} maxActiveTranscriptBytes=${maxActiveTranscriptBytes ?? "undefined"}`,
  );
  ...
  const result = await memoryDeps.compactEmbeddedPiSession({
    ...
    agentHarnessId:
      entry.sessionId === params.followupRun.run.sessionId ? entry.agentHarnessId : void 0,
    thinkLevel: params.followupRun.run.thinkLevel,
...
async function runMemoryFlushIfNeeded(params) {
  ...
  if (
    ...
    (!hasFreshPersistedPromptTokens || (transcriptPromptTokens ?? 0) > (persistedPromptTokens ?? 0))
  ) {
    const nextEntry = {
      ...entry,
  ...
  const projectedTokenCount =
    promptTokensSnapshot > 0 && (hasFreshPersistedPromptTokens || hasReliableTranscriptPromptTokens)
      ? resolveEffectivePromptTokens(
  ...
  let bootstrapPromptWarningSignaturesSeen = resolveBootstrapWarningSignaturesSeen(
    activeSessionEntry?.systemPromptReport ??
      (params.sessionKey ? activeSessionStore?.[params.sessionKey]?.systemPromptReport : void 0),
  );
    ...
    await memoryDeps.runWithModelFallback({
      ...
      run: async (provider, model, runOptions) => {
        ...
        const result = await memoryDeps.runEmbeddedPiAgent({
          ...
          onAgentEvent: (evt) => {
            if (evt.stream === "compaction") {
              if ((typeof evt.data.phase === "string" ? evt.data.phase : "") === "end")
...
async function normalizeSentMediaUrlsForDedupe(params) {
  ...
  for (const raw of params.sentMediaUrls) {
    ...
    try {
      const normalizedMediaUrls = resolveSendableOutboundReplyParts(
        await params.normalizeMediaPaths({
          mediaUrl: trimmed,
          mediaUrls: [trimmed],
        }),
      ).mediaUrls;
...
async function buildReplyPayloads(params) {
  ...
  const isDirectlySentBlockPayload = (payload) =>
  ...
  for (const payload of filteredPayloads)
    if (isRenderablePayload(payload)) replyPayloads.push(payload);
  return {
    replyPayloads,
    didLogHeartbeatStrip,
  };
...
function resolveFollowupDeliveryPayloads(params) {
  ...
  const mediaFilteredPayloads = messagingToolPayloadDedupe.shouldDedupePayloads
    ...
    : replyTaggedPayloads;
  return messagingToolPayloadDedupe.shouldDedupePayloads
...
//#endregion
//#region src/logging/token-usage-log.ts
 ...
 */
function resolveTokenUsageLogPath(date = /* @__PURE__ */ new Date()) {
...
function tokenUsageLogEnabled(config) {
  return config?.logging?.tokenUsageLog !== false;
}
function promptInstrumentationEnabled(config) {
 ...
 */
async function logTokenUsageRecord(record, config) {
  if (!tokenUsageLogEnabled(config)) return;
 ...
 */
async function logPromptInstrumentationRecord(record, config) {
  if (!promptInstrumentationEnabled(config)) return;
  if (!canUseNodeFs()) return;
  try {
    const filePath = resolveTokenUsageLogPath();
    await mkdir(path.dirname(filePath), { recursive: true });
...
function buildPctFull(totalTokens, contextMax) {
  if (
    ...
    return Math.round((totalTokens / contextMax) * 1e4) / 1e4;
}
//#endregion
...
function resolveCallFamily(params) {
...
function buildPromptInstrumentationRecord(params) {
  ...
  return {
    ...
    tools: { schemaChars: params.report.tools.schemaChars },
    skills: { promptChars: params.report.skills.promptChars },
      ...
      await updateSessionStoreEntry({
        ...
        update: async (entry) => {
          ...
          const usageForContext =
            ...
            (params.usageIsContextSnapshot === true ? params.usage : void 0);
      ...
      if (deliveryRoute === "origin" && isRoutableChannel(originatingChannel) && originatingTo) {
        ...
        if (!result.ok) {
          ...
          if (opts?.onBlockReply)
            if (origin && origin === provider) await opts.onBlockReply(payload);
    ...
    try {
          ...
          run: async (provider, model, runOptions) => {
            ...
            try {
              const result = await runEmbeddedPiAgent({
                ...
                currentThreadTs:
                  queued.originatingThreadId != null ? String(queued.originatingThreadId) : void 0,
                groupId: run.groupId,
      ...
      if (autoCompactionCount > 0) {
        ...
        const refreshedSessionEntry =
          sessionKey && sessionStore ? sessionStore[sessionKey] : void 0;
        ...
        if (run.verboseLevel && run.verboseLevel !== "off")
          deliveryPayloads = [
            {
              text: `🧹 Auto-compaction complete${typeof count === "number" ? ` (count ${count})` : ""}.`,
            },
            ...finalPayloads,
          ];
      }
...
async function drainPendingToolTasks({
  tasks,
    ...
    .map((attempt, index) =>
      [
        ...
        ...(typeof attempt.elapsedMs === "number"
          ? [`   elapsed=${(attempt.elapsedMs / 1e3).toFixed(1)}s`]
          : []),
        ...(typeof attempt.status === "number" ? [`   status=${attempt.status}`] : []),
      ].join("\n"),
    )
...
function enqueueCommitmentExtractionForTurn(params) {
  ...
  enqueueCommitmentExtraction({
    ...
    ...(to ? { to } : {}),
    ...(params.sessionCtx.MessageThreadId !== void 0
...
async function runReplyAgent(params) {
  ...
  const traceAgentPhase = (name, run) =>
  ...
  if (effectiveShouldSteer && isStreaming) {
    if (
      queueEmbeddedPiMessage(
        (sessionKey ? replyRunRegistry.resolveSessionId(sessionKey) : void 0) ??
  ...
  try {
    ...
    const resetSession = async ({ failureLabel, buildLogMessage, cleanupTranscripts }) =>
      await resetReplyRunSession({
        ...
        storePath,
        messageThreadId:
          typeof sessionCtx.MessageThreadId === "string" ? sessionCtx.MessageThreadId : void 0,
        followupRun,
    ...
    if (runOutcome.kind === "final") {
      if (!replyOperation.result)
        replyOperation.fail(
          "run_failed",
          /* @__PURE__ */ new Error("reply operation exited with final payload"),
        );
    ...
    const fallbackStateEntry =
      activeSessionEntry ?? (sessionKey ? activeSessionStore?.[sessionKey] : void 0);
    ...
    if (responseUsageMode !== "off" && hasNonzeroUsage(usage)) {
      const showCost =
        resolveModelAuthMode(providerUsed, cfg, void 0, {
          workspaceDir: followupRun.run.workspaceDir,
        }) === "api-key";
    ...
    if (autoCompactionCount > 0) {
      ...
      const refreshedSessionEntry =
        sessionKey && activeSessionStore ? activeSessionStore[sessionKey] : void 0;
      if (refreshedSessionEntry) {
      ...
      if (sessionKey)
        readPostCompactionContext(process.cwd(), {
          cfg,
