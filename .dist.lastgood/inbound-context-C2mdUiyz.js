...
import {
  n as sanitizeInboundSystemTags,
  t as normalizeInboundTextNewlines,
} from "./inbound-text-Uelx5Y74.js";
...
function finalizeInboundContext(ctx, opts = {}) {
  ...
  if (Array.isArray(normalized.UntrustedContext))
    normalized.UntrustedContext = normalized.UntrustedContext.map((entry) =>
  ...
  if (mediaCount > 0) {
    ...
    const normalizedMediaTypes = (
      Array.isArray(normalized.MediaTypes) ? normalized.MediaTypes : void 0
