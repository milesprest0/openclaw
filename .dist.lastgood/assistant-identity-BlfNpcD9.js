...
import { i as loadAgentIdentity } from "./agents.config-paEb5Fyv.js";
import {
  a as isAvatarImageDataUrl,
  i as isAvatarHttpUrl,
  u as looksLikeAvatarPath,
...
function resolveAssistantIdentity(params) {
  ...
  return {
    ...
    name,
    avatar:
      (isDefaultAgent ? [uiAvatar, ...agentAvatarCandidates] : [...agentAvatarCandidates, uiAvatar])
