...
import {
  n as createOutboundSendDepsFromCliSource,
  t as CLI_OUTBOUND_SEND_FACTORY,
} from "./outbound-send-mapping-D_dYFLfU.js";
...
function createDefaultDeps() {
  const deps = {};
  const resolveSender = (channelId) =>
    createLazySender(channelId, async () => {
      const { createChannelOutboundRuntimeSend } =
        await import("./channel-outbound-send-C02gpGAn.js");
      return {
