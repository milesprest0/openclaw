import { t as listOpenClawPluginManifestMetadata } from "./manifest-metadata-scan-D8xvnM1x.js";
import {
  a as resolveProviderAuthEnvVarCandidates,
  n as listKnownProviderAuthEnvVarNames,
  o as resolveProviderAuthEvidence,
...
//#endregion
export {
  resolveOAuthApiKeyMarker as _,
  OAUTH_API_KEY_MARKER_PREFIX as a,
  resolveProviderEnvAuthEvidence as b,
  isAwsSdkAuthMarker as c,
  isOAuthApiKeyMarker as d,
  isSecretRefHeaderValueMarker as f,
  resolveNonEnvSecretRefHeaderValueMarker as g,
  resolveNonEnvSecretRefApiKeyMarker as h,
  NON_ENV_SECRETREF_MARKER as i,
  isKnownEnvApiKeyMarker as l,
  resolveEnvSecretRefHeaderValueMarker as m,
  GCP_VERTEX_CREDENTIALS_MARKER as n,
  OLLAMA_LOCAL_AUTH_MARKER as o,
  listKnownNonSecretApiKeyMarkers as p,
  MINIMAX_OAUTH_MARKER as r,
  SECRETREF_ENV_HEADER_MARKER_PREFIX as s,
  CUSTOM_LOCAL_AUTH_MARKER as t,
  isNonSecretApiKeyMarker as u,
  listProviderEnvAuthLookupKeys as v,
  resolveProviderEnvApiKeyCandidates as y,
};
