  ...
  for (const [key, value] of Object.entries(entries)) {
    ...
    const normalizedHooks =
      ...
      (typeof hooks.allowPromptInjection === "boolean" ||
        ...
        hooks.timeoutMs !== void 0 ||
        hooks.timeouts !== void 0)
        ? {
            ...(typeof hooks.allowPromptInjection === "boolean"
...
//#endregion
export {
  createEffectiveEnableStateResolver as a,
  resolvePluginActivationDecisionShared as c,
  normalizePluginsConfigWithResolver as i,
  toPluginActivationState as l,
  identityNormalizePluginId as n,
  createPluginEnableStateResolver as o,
  isBundledChannelEnabledByChannelConfig as r,
  resolveMemorySlotDecisionShared as s,
  hasExplicitPluginConfig as t,
};
