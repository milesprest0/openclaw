...
function setAccountEnabledInConfigSection(params) {
  ...
  if (params.allowTopLevel && accountKey === "default" && !hasAccounts)
    return {
      ...params.cfg,
      channels: {
        ...params.cfg.channels,
...
function deleteAccountFromConfigSection(params) {
  ...
  const baseAccounts =
    base.accounts && typeof base.accounts === "object" ? { ...base.accounts } : void 0;
  ...
  if (baseAccounts && Object.keys(baseAccounts).length > 0) {
    ...
    for (const field of params.clearBaseFields ?? [])
      if (field in baseRecord) baseRecord[field] = void 0;
    return {
      ...params.cfg,
      channels: {
        ...params.cfg.channels,
...
function clearAccountEntryFields(params) {
  const accountKey = params.accountId || "default";
  const baseAccounts =
    params.accounts && typeof params.accounts === "object" ? { ...params.accounts } : void 0;
  ...
  if (!params.fields.some((field) => field in nextEntry))
    return {
      nextAccounts: baseAccounts,
      changed: false,
      cleared: false,
...
//#endregion
export {
  deleteAccountFromConfigSection as n,
  setAccountEnabledInConfigSection as r,
  clearAccountEntryFields as t,
};
