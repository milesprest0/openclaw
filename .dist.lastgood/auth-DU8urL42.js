import {
  c as listSubscriptions,
  o as getLoggedInAccount,
  s as isAzCliInstalled,
} from "./cli-DUdjFKM1.js";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-B8M4cov-.js";
import {
  a as promptApiKeyEndpointAndModel,
  c as selectFoundryDeployment,
  i as loginWithTenantFallback,
  l as selectFoundryResource,
  o as promptEndpointAndModelManually,
  r as listResourceDeployments,
  s as promptTenantId,
  u as testFoundryConnection,
} from "./onboard-DKOsfSCB.js";
...
import {
  c as buildFoundryAuthResult,
  f as listConfiguredFoundryProfileIds,
  g as resolveFoundryApi,
  h as resolveConfiguredModelNameHint,
  i as PROVIDER_ID,
...
const apiKeyAuthMethod = {
  ...
  run: async (ctx) => {
    const existing = ensureAuthProfileStore(ctx.agentDir, { allowKeychainPrompt: false }).profiles[
      `${PROVIDER_ID}:default`
    ];
