...
import { t as encodeJsonPointerToken } from "./json-pointer-Df0ko4-8.js";
...
import { l as isValidEnvSecretRefId } from "./types.secrets-CaNC1eIn.js";
//#region src/plugins/provider-auth-ref.ts
const secretResolveLoader = createLazyImportLoader(() => import("./resolve-cqeGU0xq.js"));
  ...
  const id =
    normalizeStringifiedOptionalString(
      await params.prompter.text({
        ...
        placeholder:
          providerEntry.source === "file" ? "/providers/openai/apiKey" : "openai/api-key",
        validate: (value) => {
          const candidate = value.trim();
...
//#endregion
export {
  promptSecretRefForSetup as n,
  resolveRefFallbackInput as r,
  extractEnvVarFromSourceLabel as t,
};
