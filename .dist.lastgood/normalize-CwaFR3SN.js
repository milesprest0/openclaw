...
function chunkDiscordText(text, opts = {}) {
  ...
  for (const originalLine of lines) {
    ...
    const segments = splitLongLine(originalLine, Math.max(1, charLimit - prefixLen), {
...
//#endregion
export {
  chunkDiscordTextWithMode as a,
  normalizeDiscordOutboundTarget as i,
  looksLikeDiscordTargetId as n,
  parseDiscordTarget as o,
  normalizeDiscordMessagingTarget as r,
  resolveDiscordChannelId as s,
  allowFromContainsDiscordUserId as t,
};
