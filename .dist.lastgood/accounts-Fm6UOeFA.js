...
import {
  n as credentialsMatchConfig,
  r as loadMatrixCredentials,
} from "./credentials-read-BCr6Wm5q.js";
import {
...
function resolveMatrixAccount(params) {
  ...
  const explicitAuthConfig =
    accountId === "default" ? base : (findMatrixAccountConfig(params.cfg, accountId) ?? {});
...
//#endregion
export {
  resolveMatrixAccount as i,
  resolveConfiguredMatrixBotUserIds as n,
  resolveDefaultMatrixAccountId as r,
  listMatrixAccountIds as t,
};
