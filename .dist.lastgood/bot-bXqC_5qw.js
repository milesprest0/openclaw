...
import { t as mergeTelegramAccountConfig } from "./account-config-BoAqzQvd.js";
...
import { t as firstDefined } from "./allow-from-REahseRU.js";
import {
  f as findCodeRegions,
  p as isInsideCode,
  u as stripReasoningTagsFromText,
...
} from "./binding-routing-BUtBDbgl.js";
import {
  a as buildPluginTelegramMenuCommands,
  i as buildCappedTelegramMenuCommands,
  n as resolveTelegramExecApproval,
  o as syncTelegramMenuCommands,
  r as createTelegramDraftStream,
  t as defaultTelegramBotDeps,
} from "./bot-deps-DWUl8ks7.js";
...
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-DVht29vx.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-CsnyeWms.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-3vUekbSs.js";
import { h as createMessageReceiveContext } from "./channel-message-Do1b_D-M.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-Tw2QazlD.js";
import {
  C as resolveChannelStreamingPreviewToolProgress,
  ...
  v as resolveChannelStreamingBlockEnabled,
} from "./channel-streaming-DxCQl0Kn.js";
import {
...
import { n as buildCommandsMessagePaginated } from "./command-status-builders-CO-ZMsTv.js";
import {
  d as buildModelsKeyboard,
  g as resolveModelSelection,
  h as parseModelCallbackData,
  m as getModelsPageSize,
  o as buildTelegramModelsMenuButtons,
...
import { a as getPluginCommandSpecs } from "./commands-DxJLSJ0J.js";
import { n as formatModelsAvailableHeader } from "./commands-models-BgA34Ll2.js";
import {
...
import { n as listChatCommands } from "./commands-registry-list-COR74Rkl.js";
import {
...
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-2FK_0ypA.js";
import {
  f as parsePluginBindingApprovalCustomId,
  i as buildPluginBindingResolvedText,
  m as resolvePluginConversationBindingApproval,
} from "./conversation-binding-C44M7Qbh.js";
...
import {
  ...
  s as projectOutboundPayloadPlanForDelivery,
} from "./deliver-Dz9Dpt9U.js";
import {
  n as deliverReplies,
  r as emitInternalMessageSentHook,
  t as resolveMedia,
} from "./delivery-auwvse51.js";
import {
...
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-BPlmHS3G.js";
import {
...
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-BsuRcQog.js";
import { n as MediaFetchError } from "./fetch-CIuHGNdE.js";
import {
  A as resolveTelegramReplyId,
  B as hasBotMention,
  C as isTelegramCommandsAllowFromConfigured,
  D as resolveTelegramForumFlag,
  E as resolveTelegramDirectPeerId,
  F as buildSenderLabel,
  G as expandTelegramAllowFromWithAccessGroups,
  H as normalizeForwardedContext,
  I as buildSenderName,
  J as normalizeAllowFrom,
  K as resolveTelegramDmAllow,
  L as expandTextLinks,
  M as resolveTelegramThreadSpec,
  N as shouldUseTelegramDmThreadSession,
  ...
  T as resolveTelegramCommandAuthorization,
  W as resolveTelegramPrimaryMedia,
  X as resolveSenderAllowMatch,
  Y as normalizeDmAllowFromWithStore,
  Z as resolveTelegramEffectiveDmPolicy,
  _ as buildTelegramParentPeer,
  b as buildTypingThreadParams,
  g as buildTelegramGroupPeerId,
  h as buildTelegramGroupFrom,
  i as renderTelegramHtmlText,
  j as resolveTelegramStreamMode,
  k as resolveTelegramGroupAllowFromContext,
  m as buildGroupLabel,
  p as tagTelegramNetworkError,
  q as isSenderAllowed,
  t as markdownToTelegramChunks,
...
import {
  n as evaluateTelegramGroupPolicyAccess,
  t as evaluateTelegramGroupBaseAccess,
} from "./group-access-PQD8PP2f.js";
import {
...
import { u as fireAndForgetHook } from "./hook-runner-global-DzzZF3B1.js";
import { t as resolveAckReaction } from "./identity-BfuOtf2o.js";
import {
  n as resolveInboundDebounceMs,
  t as createInboundDebouncer,
} from "./inbound-debounce-A6RXlMbt.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-BaAUAC_q.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-Db29TCX8.js";
import "./channel-policy-y8E9wmaa.js";
import "./reply-history-BYCu-BJA.js";
import "./runtime-env-B60JdRoI.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-CG9H1O6u.js";
import "./approval-reply-runtime-Bu2ZsUtz.js";
import {
...
import "./config-mutation-C54Rwe7L.js";
import { n as createPreviewMessageReceipt } from "./live-CawdYLv5.js";
...
import { i as getChildLogger } from "./logger-BU4ooQvN.js";
import "./reply-chunking-D9l7MwoT.js";
import {
  n as logInboundDrop,
  r as logTypingFailure,
  t as logAckFailure,
} from "./logging-ChWKeerl.js";
import "./outbound-runtime-DIb149kM.js";
import "./runtime-config-snapshot-nxqZdkUb.js";
import "./model-session-runtime-2ddycmth.js";
...
import "./hook-runtime-H-x6MkQd.js";
import "./markdown-table-runtime-BCjMTkw7.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-CX9MvOD0.js";
import "./command-auth-C7cr8cwH.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-NjOeo4xK.js";
...
import "./command-auth-native-BtpsItp5.js";
import "./command-primitives-runtime-_zhJ_43S.js";
import "./command-status-CMkXYCiq.js";
import "./command-detection-qlO4eX7t.js";
import "./command-surface-CSW6ap-7.js";
import {
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-CfeECf6Z.js";
import "./session-store-runtime-CGNlDXYc.js";
import "./models-provider-runtime-B2OIF-kj.js";
import "./skill-commands-runtime-C0hXV6ij.js";
import "./native-command-config-runtime-BHnCF9jG.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-DwjIPr7W.js";
import {
  i as createInteractiveConversationBindingHelpers,
  r as dispatchPluginInteractiveHandler,
} from "./plugin-runtime-BPKx6OFA.js";
import { r as replaceFileAtomicSync } from "./replace-file-8cLr_oo0.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-fx6x-aY8.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-D_-IJF8p.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-BZPcIR_E.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-B6nwfY1u.js";
import {
  i as resolveAgentRoute,
  n as deriveLastRoutePolicy,
  t as buildAgentSessionKey,
} from "./resolve-route-mwkm9MN4.js";
import { t as createNonExitingRuntime } from "./runtime-kqN0Yohi.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-B0aZX-OG.js";
import {
  C as withTelegramApiErrorLogging,
  a as editMessageTelegram,
  g as recordSentMessage,
  x as buildInlineKeyboard,
} from "./send-WFJDNput.js";
import { t as resolveAndPersistSessionFile } from "./session-file-CJZrDuFk.js";
import {
...
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-B9mKZWry.js";
import { f as resolveSessionStoreEntry, s as updateSessionStore } from "./store-BpWdoYPF.js";
...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-CUBC5yI2.js";
import {
...
async function loadTelegramSendRuntime() {
  telegramSendRuntimePromise ??= import("./send-D8dh-Ptf.js");
...
async function resolveTelegramCommandAuth(params) {
  ...
  const { chatId, isGroup, isForum, messageThreadId, threadParams } =
    await resolveTelegramNativeCommandThreadContext({
      msg,
      bot,
    });
  ...
  const requireTopic =
    !isGroup && groupConfig && "requireTopic" in groupConfig ? groupConfig.requireTopic : void 0;
...
const registerTelegramNativeCommands = ({
  ...
  if (overflowCount > 0)
    runtime.log?.(
      `Telegram limits bots to ${maxCommands} commands. ${totalCommands} configured; registering first ${maxCommands}. Use channels.telegram.commands.native: false to disable, or reduce plugin/skill/custom commands.`,
    );
  ...
  const resolveCommandRuntimeContext = async (params) => {
    ...
    return {
      ...
      threadSpec,
      route,
      mediaLocalRoots: nativeCommandRuntime.getAgentScopedMediaLocalRoots(
        runtimeCfg,
        route.agentId,
      ),
    ...
    for (const pluginCommand of pluginCatalog.commands)
      bot.command(pluginCommand.command, async (ctx) => {
        ...
        const deliverableResult = hasRenderableTelegramNativeReplyPayload(result)
          ? result
          : { text: EMPTY_RESPONSE_FALLBACK$1 };
...
function readPersistedMessages(filePath, maxMessages) {
  ...
  try {
    ...
    for (const entry of parsed.slice(-maxMessages)) {
      if (!isRecord(entry) || !isString(entry.key)) continue;
      const node = parsePersistedNode(entry.node);
      if (node) messages.set(entry.key, node);
    }
  } catch (error) {
...
function resolveMessageCacheBucket(params) {
  ...
  if (!persistedPath) return { messages: /* @__PURE__ */ new Map() };
  const existing = persistedMessageCacheBuckets.get(persistedPath);
  if (existing) {
    if (!fs.existsSync(persistedPath)) existing.messages.clear();
    return existing;
  }
  const bucket = { messages: readPersistedMessages(persistedPath, maxMessages) };
...
const registerTelegramHandlers = ({
  ...
  const resolveTelegramSessionState = (params) => {
    ...
    const store = loadSessionStore(
      telegramDeps.resolveStorePath(runtimeCfg.session?.store, { agentId: route.agentId }),
    );
    const entry = resolveSessionStoreEntry({
      store,
      sessionKey,
  ...
  const processMediaGroup = async (entry) => {
    try {
      ...
      const primaryEntry =
        entry.messages.find((m) => m.msg.caption || m.msg.text) ?? entry.messages[0];
      const allMedia = [];
  ...
  const recordMessageForReplyChain = (msg, threadId) =>
    messageCache.record({
      accountId,
      chatId: msg.chat.id,
      msg,
  ...
  const buildReplyChainForMessage = (msg) =>
  ...
  const processMessageWithReplyChain = async (ctx, msg, allMedia, storeAllowFrom, options) => {
    const { replyMedia, replyChain } = await resolveReplyMediaForChain(
      ctx,
      buildReplyChainForMessage(msg),
    );
    await processMessage(ctx, allMedia, storeAllowFrom, options, replyMedia, replyChain);
  };
  const isAllowlistAuthorized = (allow, senderId, senderUsername) =>
    allow.hasWildcard ||
    (allow.hasEntries &&
      isSenderAllowed({
        allow,
  ...
  const isPermanentTelegramCallbackEditError = (err) =>
  ...
  const authorizeTelegramEventSender = async (params) => {
    ...
    const {
      ...
      deniedDmReason,
      deniedGroupReason,
    } = TELEGRAM_EVENT_AUTH_RULES[mode];
    if (
    ...
    if (!isGroup && enforceDirectAuthorization) {
      ...
      if (
        !(dmPolicy === "open" && effectiveDmAllow.hasWildcard) &&
      ...
      if (existing) {
        ...
        if (
          ...
          const nextTotalChars =
            existing.messages.reduce((sum, m) => sum + (m.msg.text?.length ?? 0), 0) + text.length;
          if (
  ...
  bot.on("callback_query", async (ctx) => {
    ...
    try {
      ...
      const clearCallbackButtons = async () => {
        ...
        if (typeof bot.api.editMessageReplyMarkup === "function")
      ...
      if (
        (
          await dispatchTelegramPluginInteractiveHandler({
            data,
            ...
            respond: {
              reply: async ({ text, buttons }) => {
                await replyToCallbackChat(
                  text,
                  buttons ? { reply_markup: buildInlineKeyboard(buttons) } : void 0,
                );
              },
      ...
      if (paginationMatch) {
        ...
        let result;
        try {
          result = buildCommandsMessagePaginated(
            runtimeCfg,
            telegramDeps.listSkillCommandsForAgents({
              cfg: runtimeCfg,
              agentIds: [agentId],
      ...
      if (modelCallback) {
        ...
        if (modelCallback.type === "providers" || modelCallback.type === "back") {
          ...
          const buttons = buildTelegramModelsMenuButtons({
  ...
  const handleInboundMessageLike = async (event) => {
    try {
      ...
      const {
        ...
        effectiveGroupAllow,
        hasGroupAllowOverride,
      } = await resolveTelegramEventAuthorizationContext({
        chatId: event.chatId,
...
async function resolveTelegramInboundBody(params) {
  ...
  const stickerSupportsVision = msg.sticker
    ? await resolveStickerVisionSupport$1({
        cfg,
  ...
  if (allMedia.length === 0 && placeholder && rawBody !== placeholder)
    bodyText =
      `${primaryMedia?.fileRef.file_id ? `${placeholder} [file_id:${primaryMedia.fileRef.file_id}]` : placeholder}\n${bodyText}`.trim();
    ...
    try {
      ...
      preflightTranscript = await transcribeFirstAudio({
        ctx: {
          ...
          MediaTypes:
            allMedia.length > 0 ? allMedia.map((m) => m.contentType).filter(Boolean) : void 0,
        },
        cfg,
        agentDir: void 0,
      });
  ...
  if (isGroup && requireMention && canDetectMention && mentionDecision.shouldSkip) {
    ...
    if (
      (topicConfig?.ingest ??
        ...
        telegramGroupPolicy.defaultConfig?.ingest) === true &&
      sessionKey
    )
      fireAndForgetHook(
        triggerInternalHook(
  ...
  return {
    ...
    ...(audioTranscribedMediaIndex !== void 0 && audioTranscribedMediaIndex >= 0
...
async function resolveTelegramMessageContextStorePath(params) {
  return (await loadTelegramMessageContextSessionRuntime(params.sessionRuntime)).resolveStorePath(
...
function replyTargetToChainEntry(replyTarget) {
  return {
    ...
    ...(replyTarget.forwardedFrom?.date
      ? { forwardedDate: replyTarget.forwardedFrom.date * 1e3 }
      : {}),
  };
}
...
function formatReplyChainEntry(entry, index) {
  ...
  const bodyLines = [
    entry.forwardedFrom
      ? `[Forwarded from ${entry.forwardedFrom}${entry.forwardedDate ? ` at ${new Date(entry.forwardedDate).toISOString()}` : ""}]`
      : void 0,
...
async function buildTelegramInboundContextPayload(params) {
  ...
  const visibleReplyChain = (
    ...
    return [
      ...
      shouldIncludeGroupSupplementalContext({
        ...
        ? visibleEntry
        : stripReplyChainForwarded(visibleEntry),
    ];
  });
  ...
  const forwardPrefix = visibleForwardOrigin
    ? `[Forwarded from ${visibleForwardOrigin.from}${visibleForwardOrigin.date ? ` at ${/* @__PURE__ */ new Date(visibleForwardOrigin.date * 1e3).toISOString()}` : ""}]\n`
    : "";
  ...
  const ctxPayload = sessionRuntime.finalizeInboundContext({
    ...
    ReplyToForwardedDate: visibleReplyTarget?.forwardedFrom?.date
      ? visibleReplyTarget.forwardedFrom.date * 1e3
      : void 0,
    ...
    MediaTypes:
      contextMedia.length > 0 ? contextMedia.map((m) => m.contentType).filter(Boolean) : void 0,
    ...(audioTranscribedMediaIndex !== void 0
...
function resolveTelegramReactionVariant(params) {
  ...
  const variants = toUniqueNonEmpty([
    ...(params.variantsByRequestedEmoji.get(requestedEmoji) ?? [requestedEmoji]),
    ...TELEGRAM_GENERIC_REACTION_FALLBACKS,
  ]);
  for (const candidate of variants) {
    if (!isTelegramSupportedReactionEmoji(candidate)) continue;
    if (params.allowedEmojiReactions == null || params.allowedEmojiReactions.has(candidate))
      return candidate;
  }
}
//#endregion
...
function readPersistedTopicNames(persistedPath) {
  ...
  try {
    ...
    const entries = Object.entries(parsed)
      .filter((entry) => isTopicEntry(entry[1]))
...
const buildTelegramMessageContext = async ({
  ...
  const ackReactionEmoji =
    ackReaction && isTelegramSupportedReactionEmoji(ackReaction) ? ackReaction : void 0;
  ...
  const { ctxPayload, skillFilter, turn } = await buildTelegramInboundContextPayload({
    ...
    effectiveWasMentioned: bodyResult.effectiveWasMentioned,
    ...(bodyResult.audioTranscribedMediaIndex !== void 0
...
function resolveTelegramConfigReasoningDefault(cfg, agentId) {
  ...
  return (
    cfg.agents?.list?.find((entry) => normalizeAgentId(entry?.id) === id)?.reasoningDefault ??
...
function pruneExpiredCooldowns(messageStore, now) {
  for (const [message, expiresAt] of messageStore)
    if (expiresAt <= now) messageStore.delete(message);
}
function resolveTelegramErrorPolicy(params) {
  const configs = [params.accountConfig, params.groupConfig, params.topicConfig];
  let policy = "always";
...
function createLaneTextDeliverer(params) {
  const followUpPayload = (payload, text) =>
  ...
  const streamText = async (laneName, lane, text, payload, isFinal, buttons) => {
    ...
    if (isFinal && deliveredStreamText !== void 0 && deliveredStreamText !== firstChunk.trimEnd())
      return;
    params.markDelivered();
    if (buttons)
      try {
...
function createTelegramReasoningStepState() {
  ...
  const takeBufferedFinalAnswer = (currentGeneration) => {
    if (
      currentGeneration !== void 0 &&
      bufferedFinalAnswer?.bufferedGeneration !== void 0 &&
...
const dispatchTelegramMessage = async ({
  ...
  const telegramDeps =
    injectedTelegramDeps ?? (await import("./bot-deps-lqBF0Kkc.js")).defaultTelegramBotDeps;
  const {
    ctxPayload,
    msg,
    chatId,
  ...
  const replyQuoteText = ctxPayload.ReplyToIsQuote
    ? rawReplyQuoteText?.trim()
      ? rawReplyQuoteText
      : ctxPayload.ReplyToBody?.trim() || void 0
    : void 0;
  ...
  const canStreamAnswerDraft =
    ...
    !(replyToMode !== "off" && replyQuoteText != null) &&
  ...
  const pushStreamToolProgress = async (line, options) => {
    ...
    if (options?.toolName !== void 0 && !isChannelProgressDraftWorkToolName(options.toolName))
      return;
    ...
    if (streamToolProgressEnabled && !streamToolProgressSuppressed && normalized) {
      if (streamToolProgressLines.at(-1) !== normalized)
        streamToolProgressLines = [...streamToolProgressLines, normalized].slice(
          -resolveChannelProgressDraftMaxLines(telegramCfg),
        );
    }
  ...
  const enqueueDraftLaneEvent = (task) => {
    draftLaneEventQueue = draftLaneEventQueue
      .then(async () => {
  ...
  const splitTextIntoLaneSegments = (text, isReasoning) => {
  ...
  const ingestDraftLaneSegments = async (text, isReasoning) => {
  ...
  const implicitQuoteReplyTargetId =
    replyQuoteMessageId != null ? String(replyQuoteMessageId) : void 0;
  const currentMessageIdForQuoteReply =
    implicitQuoteReplyTargetId && ctxPayload.MessageSid ? ctxPayload.MessageSid : void 0;
  const replyQuotePosition =
    typeof ctxPayload.ReplyToQuotePosition === "number" ? ctxPayload.ReplyToQuotePosition : void 0;
  ...
  try {
    ...
    const splitFinalTextForStream = (text) => {
      return (
        chunkMode === "newline" ? chunkMarkdownTextWithMode(text, draftMaxChars, chunkMode) : [text]
      ).flatMap((chunk) =>
    ...
    if (isDmTopic)
      try {
        ...
        if (sessionKey)
          isFirstTurnInSession = !resolveSessionStoreEntry({
            store,
            sessionKey,
          }).existing?.systemSent;
    ...
    const { onModelSelected, ...replyPipeline } = (
      telegramDeps.createChannelMessageReplyPipeline ?? createChannelReplyPipeline
    )({
      cfg,
      agentId: route.agentId,
      channel: "telegram",
...
const createTelegramMessageProcessor = (deps) => {
  ...
  return async (primaryCtx, allMedia, storeAllowFrom, options, replyMedia, replyChain) => {
    ...
    if (ingressDebugEnabled && ingressReceivedAtMs && ingressContextStartMs)
      logVerbose(
        `telegram ingress: chatId=${context.chatId} contextReadyMs=${Date.now() - ingressReceivedAtMs} preDispatchMs=${Date.now() - ingressContextStartMs}` +
          (options?.ingressBuffer ? ` buffer=${options.ingressBuffer}` : ""),
      );
  ...
  const finishUpdate = (update, finish) => {
    ...
    if (typeof update.updateId === "number") {
      ...
      if (finish.completed) {
        ...
        update.receiveContext
          ?.nack(/* @__PURE__ */ new Error("Telegram update handler did not complete"))
          .catch((err) => {
            options.onPersistError?.(err);
          });
      }
...
function createTelegramSendChatActionHandler({ sendChatActionFn, logger, maxConsecutive401 = 10 }) {
  ...
  const sendChatAction = async (chatId, action, threadParams) => {
    ...
    if (consecutive401Failures > 0) {
      ...
      logger(
        `sendChatAction backoff: waiting ${backoffMs}ms before retry (failure ${consecutive401Failures}/${maxConsecutive401})`,
      );
    ...
    try {
      ...
      if (is401Error(error)) {
        ...
        if (consecutive401Failures >= maxConsecutive401) {
          suspended = true;
          logger(
            `CRITICAL: sendChatAction suspended after ${consecutive401Failures} consecutive 401 errors. Bot token is likely invalid. Telegram may DELETE the bot if requests continue. Replace the token and restart: openclaw channels restart telegram`,
          );
        } else
          logger(
            `sendChatAction 401 error (${consecutive401Failures}/${maxConsecutive401}). Retrying with exponential backoff.`,
          );
      }
      throw error;
    }
...
function resolveStatusCommandControlLane(params) {
  const alias = maybeResolveTextAlias(
    normalizeCommandBody(
      params.rawText?.trim() ?? "",
      params.botUsername ? { botUsername: params.botUsername } : void 0,
    ),
  );
...
function getTelegramSequentialKey(ctx) {
  ...
  if (
    resolveStatusCommandControlLane({
      rawText,
      botUsername,
    })
  ) {
...
function extractTelegramApiMethod(input) {
  ...
  try {
    ...
    return (
      normalizeOptionalLowercaseString(segments.length > 0 ? (segments.at(-1) ?? null) : null) ??
      null
    );
  } catch {
    return null;
...
function createTelegramBotCore(opts) {
  ...
  const telegramTransport =
    ...
    resolveTelegramTransport(opts.proxyFetch, { network: telegramCfg.network });
      ...
      const runFetch = async () => {
        ...
        const timeoutError =
          requestTimeoutMs !== void 0
            ? /* @__PURE__ */ new Error(`Telegram ${method} timed out after ${requestTimeoutMs}ms`)
            : void 0;
  ...
  const historyLimit = Math.max(
    0,
    telegramCfg.historyLimit ?? cfg.messages?.groupChat?.historyLimit ?? 50,
  );
  ...
  const resolveGroupPolicy = (chatId) =>
  ...
  const resolveTelegramGroupConfig = (chatId, messageThreadId) => {
    ...
    if (!chatIdStr.startsWith("-")) {
      ...
      if (directConfig)
        return {
          ...
          topicConfig:
            messageThreadId != null ? directConfig.topics?.[String(messageThreadId)] : void 0,
        };
      return {
        groupConfig: void 0,
        topicConfig: void 0,
    ...
    return {
      groupConfig,
      topicConfig:
        messageThreadId != null ? groupConfig?.topics?.[String(messageThreadId)] : void 0,
    };
  };
