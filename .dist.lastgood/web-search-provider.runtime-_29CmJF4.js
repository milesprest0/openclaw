...
import { t as normalizeXaiModelId } from "./model-id-CMw35b8-.js";
import { n as resolveWebSearchProviderCredential } from "./provider-web-search-C9K0OI1i.js";
import {
  a as resolveXaiResponseTextCitationsAndInline,
  n as buildXaiResponsesToolBody,
  o as resolveXaiResponsesEndpoint,
  r as extractXaiWebSearchContent,
} from "./responses-tool-shared-CjAjEPTO.js";
import { c as isRecord } from "./utils-BGRcpLKt.js";
import { u as postTrustedWebToolsJson } from "./web-search-provider-common-DvgMsTTY.js";
import {
  i as resolveProviderWebSearchPluginConfig,
  r as mergeScopedSearchConfig,
  t as getScopedCredentialValue,
} from "./web-search-provider-config-DGGjdfk5.js";
import "./tool-config-shared-b6lJarR6.js";
import {
  i as readCache,
  l as writeCache,
...
import {
  n as setPluginXSearchConfigValue,
  t as resolveEffectiveXSearchConfig,
} from "./x-search-config-Bb5KJIDi.js";
import { t as XAI_DEFAULT_X_SEARCH_MODEL } from "./x-search-shared-CIe91p-E.js";
...
async function requestXaiWebSearch(params) {
  return await postTrustedWebToolsJson(
    ...
    async (response) => {
      return resolveXaiResponseTextCitationsAndInline(
        await response.json(),
