...
import { i as resolvePluginCacheInputs } from "./discovery-bnS95tO3.js";
...
import {
  n as resolveInstalledManifestRegistryIndexFingerprint,
  t as loadPluginManifestRegistryForInstalledIndex,
} from "./manifest-registry-installed-DnaIfMcO.js";
import {
  g as createPluginRegistryIdNormalizer,
  m as loadPluginRegistrySnapshotWithMetadata,
} from "./plugin-registry-CWiNK0Xv.js";
import { n as appendRegularFileSync } from "./regular-file-CoVHB-2u.js";
...
function resolvePluginControlPlaneContext(params = {}) {
  const inventoryFingerprint =
    ...
    (params.index ? resolveInstalledManifestRegistryIndexFingerprint(params.index) : void 0);
  return {
...
function buildPluginMetadataOwnerMaps(plugins) {
  ...
  for (const plugin of plugins) {
    ...
    for (const [contract, values] of Object.entries(plugin.contracts ?? {}))
      if (Array.isArray(values) && values.length > 0) appendOwner(contracts, contract, plugin.id);
  }
  return {
...
//#endregion
export {
  resolvePluginControlPlaneFingerprint as a,
  isDiagnosticsTimelineEnabled as c,
  fingerprintPluginDiscoveryContext as i,
  measureDiagnosticsTimelineSpan as l,
  listPluginOriginsFromMetadataSnapshot as n,
  resolvePluginDiscoveryContext as o,
  loadPluginMetadataSnapshot as r,
  emitDiagnosticsTimelineEvent as s,
  isPluginMetadataSnapshotCompatible as t,
  measureDiagnosticsTimelineSpanSync as u,
};
