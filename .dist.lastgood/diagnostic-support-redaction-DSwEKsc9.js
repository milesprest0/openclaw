...
import { i as isSensitiveUrlQueryParamName } from "./redact-sensitive-url-Bu3cghBT.js";
import { t as isSecretRefShape } from "./redact-snapshot.secret-ref-Zol6tFcs.js";
...
function redactUrlSecretsForSupport(value) {
  return value
    .replace(URL_USERINFO_RE, (_match, scheme, _username, password) =>
      password ? `${scheme}<redacted>:<redacted>@` : `${scheme}<redacted>@`,
    )
    .replace(URL_PARAM_RE, (match, prefix, key) =>
...
//#endregion
export {
  sanitizeSupportSnapshotValue as a,
  sanitizeSupportConfigValue as i,
  redactSupportString as n,
  redactTextForSupport as r,
  redactPathForSupport as t,
};
