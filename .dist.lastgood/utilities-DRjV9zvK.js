...
const t = (t, n = 4294967295, e = 79764919) => {
  ...
  e = (n, e = t) => {
    const r = (t) =>
        new Uint8Array(t.length / 2).map((n, e) => parseInt(t.substring(2 * e, 2 * (e + 1)), 16)),
      o = (t) => r(t)[0],
      s = /* @__PURE__ */ new Map();
    [
      ,
    ...
    p &&
      ...
      1 === a &&
        ((u += 8), (l = ((t) => new DataView(r(t).buffer).getInt32(0, !0))(n.substring(13, u)))));
    const d = 256 - h;
...
function WASMAudioDecoderCommon() {
      ...
      getModule: {
        value(Ref, wasmString) {
          ...
          if (!module) {
            if (!wasmString) {
              wasmString = Ref.wasm;
              module = WASMAudioDecoderCommon.inflateDynEncodeString(wasmString).then((data) =>
  ...
  this.getOutputChannels = (outputData, channelsDecoded, samplesDecoded) => {
    ...
    while (i < channelsDecoded)
      output.push(outputData.slice(i * samplesDecoded, i++ * samplesDecoded + samplesDecoded));
    return output;
  };
...
var import_node = /* @__PURE__ */ __toESM(
...
var WASMAudioDecoderWorker = class extends getWorker() {
  constructor(options, name, Decoder, EmscriptenWASM) {
    ...
    if (!source) {
      ...
      source = isNode
        ? `data:${type};base64,${Buffer.from(webworkerSourceCode).toString("base64")}`
