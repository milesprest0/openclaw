...
import { i as listBundledChannelIds } from "./bootstrap-registry-BWOCdZvF.js";
import { i as hasNonEmptyString } from "./channel-target-BNd4ALAB.js";
import {
  n as listBundledChannelIdsForPackageState,
  t as hasBundledChannelPackageState,
...
function listPotentialConfiguredChannelPresenceSignals(cfg, env = process.env, options = {}) {
  ...
  const channelEnvPrefixes = listChannelEnvPrefixes(
    options.channelIds ?? listBundledChannelIds(env),
  );
  const channels = isRecord(cfg.channels) ? cfg.channels : null;
  if (channels)
...
//#endregion
export {
  listPotentialConfiguredChannelPresenceSignals as a,
  listPotentialConfiguredChannelIds as i,
  hasPotentialConfiguredChannels as n,
  listExplicitlyDisabledChannelIdsForConfig as r,
  hasMeaningfulChannelConfig as t,
};
