...
import { p as describeControlFailure, t as requestCodexAppServerJson } from "./request-BC8expe9.js";
...
async function resolveMarketplaceRef(params) {
  ...
  if (params.config.marketplaceSource && params.allowAdd) {
    const added = await params.request("marketplace/add", {
  ...
  if (params.config.marketplacePath)
    return {
      marketplace: preferredMarketplaceName
        ? {
            kind: "local",
...
function abortError(signal) {
  ...
  return reason instanceof Error
    ? reason
    : /* @__PURE__ */ new Error("Computer Use setup was aborted.");
}
...
function createComputerUseRequest(params) {
  ...
  if (params.client)
    return async (method, requestParams) =>
      await params.client.request(method, requestParams, {
...
//#endregion
export {
  readCodexComputerUseStatus as a,
  installCodexComputerUse as i,
  rememberCodexRateLimits as n,
  ensureCodexComputerUse as r,
  readRecentCodexRateLimits as t,
};
