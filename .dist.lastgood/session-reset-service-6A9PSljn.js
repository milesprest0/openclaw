...
import { r as stopSubagentsForRequester } from "./abort-CkvPjBug.js";
import {
  c as resolveDefaultAgentId,
  o as resolveAgentWorkspaceDir,
} from "./agent-scope-config-CXZGyKMl.js";
import { t as clearBootstrapSnapshot } from "./bootstrap-cache-CYMhno0R.js";
...
import { r as runPluginHostCleanup } from "./host-hook-cleanup-BITs3oqS.js";
...
import { n as getAcpRuntimeBackend } from "./registry-C6ubc_kk.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun } from "./runs-CztEUxOL.js";
...
import { i as upsertAcpSessionMeta, n as readAcpSessionEntry } from "./session-meta-rwd0ZmpO.js";
import {
  n as resolveResetPreservedSelection,
  t as clearSessionResetRuntimeState,
} from "./session-reset-cleanup-uoK0J3yh.js";
import {
  o as resolveStableSessionEndTranscript,
  r as archiveSessionTranscriptsDetailed,
...
import { s as updateSessionStore, y as snapshotSessionOrigin } from "./store-BpWdoYPF.js";
...
async function performGatewaySessionReset(params) {
  ...
  const workspaceDir = resolveAgentWorkspaceDir(
    cfg,
    normalizeAgentId(target.agentId ?? resolveDefaultAgentId(cfg)),
  );
  await triggerInternalHook(
    createInternalHookEvent("command", params.reason, target.canonicalKey ?? params.key, {
      sessionEntry: entry,
  ...
  const next = await updateSessionStore(storePath, (store) => {
    ...
    const sessionAgentId = normalizeAgentId(
      parseAgentSessionKey(primaryKey)?.agentId ?? resolveDefaultAgentId(cfg),
    );
    ...
    const nextEntry = {
      ...
      sessionFile: resolveSessionFilePath(
        nextSessionId,
        currentEntry?.sessionFile ? { sessionFile: currentEntry.sessionFile } : void 0,
...
//#endregion
export {
  emitGatewaySessionStartPluginHook as a,
  emitGatewaySessionEndPluginHook as i,
  cleanupSessionBeforeMutation as n,
  emitSessionUnboundLifecycleEvent as o,
  emitGatewayBeforeResetPluginHook as r,
  performGatewaySessionReset as s,
  archiveSessionTranscriptsForSessionDetailed as t,
};
