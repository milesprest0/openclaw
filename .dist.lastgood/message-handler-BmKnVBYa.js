...
import {
  a as hasForwardedRequestHeaders,
  i as authorizeWsControlUiGatewayConnect,
  o as isLocalDirectRequest,
  r as authorizeHttpGatewayConnect,
  s as checkBrowserOrigin,
} from "./auth-D_VLzYQI.js";
import {
  i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET,
  n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN,
} from "./auth-rate-limit-Es6mTeJX.js";
import {
  c as buildDeviceAuthPayloadV3,
  o as gatewayStartupUnavailableDetails,
  s as buildDeviceAuthPayload,
} from "./client-BYqFLh-J.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BBJMHWvK.js";
import { t as truncateCloseReason } from "./close-reason-Sn7_rQTx.js";
import {
  i as buildPairingConnectErrorMessage,
  m as resolveDeviceAuthConnectErrorDetailCode,
  n as buildPairingConnectCloseReason,
  p as resolveAuthConnectErrorDetailCode,
  r as buildPairingConnectErrorDetails,
  t as ConnectErrorDetailCodes,
} from "./connect-error-details-BXtaJDEs.js";
import {
  a as redeemDeviceBootstrapTokenProfile,
  n as getBoundDeviceBootstrapProfile,
  o as revokeDeviceBootstrapToken,
  r as getDeviceBootstrapTokenProfile,
  s as verifyDeviceBootstrapToken,
} from "./device-bootstrap-CvlHJ2e9.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-BPv-hU36.js";
import {
  i as normalizeDevicePublicKeyBase64Url,
  s as verifyDeviceSignature,
  t as deriveDeviceIdFromPublicKey,
} from "./device-identity-BQp4SxLS.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-RrgoRUye.js";
import {
  _ as updatePairedDeviceMetadata,
  a as getPairedDevice,
  c as listApprovedPairedDeviceRoles,
  l as listDevicePairing,
  n as approveDevicePairing,
  p as requestDevicePairing,
  r as ensureDeviceToken,
  s as hasEffectivePairedDeviceRole,
  t as approveBootstrapDevicePairing,
  u as listEffectivePairedDeviceRoles,
  v as verifyDeviceToken,
...
import {
  ...
  t as isBrowserOperatorUiClient,
} from "./message-channel-GRZIhFYD.js";
import {
  a as isPrivateOrLoopbackAddress,
  c as isTrustedProxyAddress,
  f as resolveClientIp,
  h as resolveHostName,
  i as isLoopbackHost,
  n as isLocalishHost,
  o as isPrivateOrLoopbackHost,
  r as isLoopbackAddress,
} from "./net-BQYp2xgJ.js";
import {
  a as normalizeDeclaredNodeCommands,
  o as resolveNodeCommandAllowlist,
} from "./node-command-policy-y9_MR0c9.js";
import {
  c as updatePairedNodeMetadata,
  n as getPairedNode,
  s as requestNodePairing,
} from "./node-pairing-BFA5m3xB.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-Codapd9g.js";
import { l as roleScopesAllow } from "./pairing-token-BUAmIw7n.js";
import {
  a as indexPluginNodeCapabilitySurfaces,
  l as resolvePluginNodeCapabilityTtlMs,
  o as mintPluginNodeCapabilityToken,
  r as buildPluginNodeCapabilityScopedHostUrl,
  u as setClientPluginNodeCapability,
} from "./plugin-node-capability-mS-g2wAV.js";
import {
  Dt as validateRequestFrame,
  M as validateConnectParams,
  gi as errorShape,
  hi as ErrorCodes,
  t as formatValidationErrors,
} from "./protocol-CUn5aLrV.js";
import {
  a as MAX_PAYLOAD_BYTES,
  i as MAX_BUFFERED_BYTES,
  o as MAX_PREAUTH_PAYLOAD_BYTES,
  s as TICK_INTERVAL_MS,
} from "./server-constants-CI_c5cWv.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DG0eP6xM.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-CjCdFOxe.js";
import {
  a as normalizeLowercaseStringOrEmpty,
  c as normalizeOptionalString,
} from "./string-coerce-BdEutqX5.js";
import { r as upsertPresence } from "./system-presence-BpoE0fcb.js";
import { s as resolveRuntimeServiceVersion } from "./version-BZr74W_5.js";
import {
  c as roleCanSkipDeviceIdentity,
...
import { n as logWs, t as formatForLog } from "./ws-log-B_EDd3bo.js";
...
async function reconcileNodePairingOnConnect(params) {
  ...
  if (!params.pairedNode)
    return {
      ...
      pendingPairing: await params.requestPairing(
  ...
  if (declared.some((command) => !approvedCommands.includes(command)))
    return {
      nodeId,
...
async function resolveConnectAuthDecision(params) {
  ...
  if (!deviceTokenRateLimited)
    if (
      (
        await params.verifyDeviceToken({
          deviceId: params.deviceId,
...
function shouldSkipControlUiPairing(
  policy,
  role,
...
function attachGatewayWsMessageHandler(params) {
  ...
  if (!hostIsLocalish && isLoopbackAddress(remoteAddr) && !hasProxyHeaders)
    logWsControl.warn(
      "Loopback connection with non-local Host header. Treating it as remote. If you're behind a reverse proxy, set gateway.trustedProxies and forward X-Forwarded-For/X-Real-IP.",
    );
  ...
  const handleMessage = async (data) => {
    ...
    try {
      ...
      if (!client) {
        ...
        if (authMethod === "token" || authMethod === "password" || authMethod === "trusted-proxy") {
          ...
          const requiredSharedGatewaySessionGeneration =
            getRequiredSharedGatewaySessionGeneration?.();
          if (
            requiredSharedGatewaySessionGeneration !== void 0 &&
        ...
        if (device && devicePublicKey) {
          ...
          const requirePairing = async (reason, existingPairedDevice = null) => {
            ...
            const resolveLivePendingRequestId = async () => {
              ...
              return pendingList.pending.find(
                (pending) =>
        ...
        if (authMethod === "bootstrap-token" && bootstrapTokenCandidate && device)
          try {
            if (handoffBootstrapProfile) {
              if (!(await revokeDeviceBootstrapToken({ token: bootstrapTokenCandidate })).removed)
                logGateway.warn(
              ...
              if (
                (
                  await redeemDeviceBootstrapTokenProfile({
                    token: bootstrapTokenCandidate,
                    role,
                    scopes,
                  })
        ...
        refreshHealthSnapshot({ probe: true }).catch((err) =>
      ...
      (async () => {
        const { handleGatewayRequest } = await import("./server-methods-CMofdzPL.js");
