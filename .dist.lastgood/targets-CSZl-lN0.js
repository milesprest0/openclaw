...
import {
  n as resolveAgentsDirFromSessionStorePath,
  u as resolveStorePath,
} from "./paths-CfeECf6Z.js";
import { v as resolveStateDir } from "./paths-Cnwfh6dH.js";
import {
  n as resolveAgentSessionDirsFromAgentsDir,
  r as resolveAgentSessionDirsFromAgentsDirSync,
} from "./session-dirs-B9NgFY0D.js";
...
async function resolveValidatedDiscoveredStorePath(params) {
  ...
  try {
    ...
    return isWithinRoot(
      realStorePath,
      params.realAgentsRoot ?? (await fs$1.realpath(params.agentsRoot)),
    )
      ? realStorePath
      : void 0;
  } catch (err) {
...
function resolveSessionStoreTargets(cfg, opts, params = {}) {
  ...
  if (allAgents)
    return dedupeTargetsByStorePath(
...
//#endregion
export {
  resolveSessionStoreTargets as i,
  resolveAllAgentSessionStoreTargets as n,
  resolveAllAgentSessionStoreTargetsSync as r,
  resolveAgentSessionStoreTargetsSync as t,
};
