...
import { n as repairMissingPluginInstallsForIds } from "./missing-configured-plugin-install-Bg78isLQ.js";
...
import { t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-BYIstKqF.js";
import { r as detectPluginAutoEnableCandidates } from "./plugin-auto-enable-DBf3GcqW.js";
...
import { t as compareOpenClawVersions } from "./version-wG74WA1x.js";
...
function collectBlockedPluginIds(cfg) {
  ...
  for (const [pluginId, entry] of Object.entries(entries ?? {}))
    if (asObjectRecord(entry)?.enabled === false && pluginId.trim()) ids.add(pluginId.trim());
...
function collectSlotPluginIds(cfg) {
  ...
  return ["memory", "contextEngine"]
    ...
    .filter((pluginId) => !!pluginId && pluginId.toLowerCase() !== "none");
}
