...
import { i as resolveZaloAccount } from "./accounts-K08f0yML.js";
import {
  a as promptZaloAllowFrom,
  i as noteZaloTokenHelp,
  n as zaloDmPolicy,
} from "./setup-core-B5g778YV.js";
...
const zaloSetupWizard = {
  ...
  finalize: async ({ cfg, accountId, forceAllowFrom, options, prompter }) => {
    ...
    next = (
      await runSingleChannelSecretStep({
        cfg: next,
        prompter,
        providerHint: "zalo",
    ...
    if (
      ...
      const webhookUrl = (
        await prompter.text({
          ...
          validate: (value) =>
            value?.trim()?.startsWith("https://") ? void 0 : "HTTPS URL required",
        })
      ).trim();
      const defaultPath = (() => {
        try {
