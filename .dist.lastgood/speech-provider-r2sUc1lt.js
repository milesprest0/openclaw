...
import {
  a as isDebugProxyGlobalFetchPatchInstalled,
  t as captureHttpExchange,
} from "./runtime-CIhJIx2w.js";
...
import { n as inferEdgeExtension, t as edgeTTS } from "./tts-BodJlVTw.js";
    ...
    return Array.isArray(voices)
      ? voices
          .map((voice) => ({
            ...
            name:
              normalizeOptionalString(voice.FriendlyName) ??
              normalizeOptionalString(voice.ShortName),
  ...
  return {
    ...
    resolveTalkConfig: ({ baseTtsConfig, talkProviderConfig }) => {
      return {
        ...
        ...(normalizeOptionalString(talkProviderConfig.languageCode) == null
          ? {}
          : { lang: normalizeOptionalString(talkProviderConfig.languageCode) }),
        ...(normalizeOptionalString(talkProviderConfig.outputFormat) == null
          ? {}
          : { outputFormat: normalizeOptionalString(talkProviderConfig.outputFormat) }),
        ...(normalizeOptionalString(talkProviderConfig.pitch) == null
          ? {}
          : { pitch: normalizeOptionalString(talkProviderConfig.pitch) }),
        ...(normalizeOptionalString(talkProviderConfig.rate) == null
          ? {}
          : { rate: normalizeOptionalString(talkProviderConfig.rate) }),
        ...(normalizeOptionalString(talkProviderConfig.volume) == null
          ? {}
          : { volume: normalizeOptionalString(talkProviderConfig.volume) }),
        ...(normalizeOptionalString(talkProviderConfig.proxy) == null
          ? {}
          : { proxy: normalizeOptionalString(talkProviderConfig.proxy) }),
    ...
    synthesize: async (req) => {
      ...
      let outputFormat =
        normalizeOptionalString(req.providerOverrides?.outputFormat) ?? config.outputFormat;
      const fallbackOutputFormat =
        outputFormat !== DEFAULT_EDGE_OUTPUT_FORMAT ? DEFAULT_EDGE_OUTPUT_FORMAT : void 0;
