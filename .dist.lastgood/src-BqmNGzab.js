...
import { n as init_dist_node, t as dist_node_exports } from "./dist-node-BBMZ96-D.js";
    ...
    constructor() {
      ...
      if (init instanceof Headers) {
        ...
        for (const headerName of headerNames)
          for (const value of rawHeaders[headerName]) this.append(headerName, value);
        return;
      }
      if (init == null);
      ...
      if (this.response) {
        try {
          this.response.data = translateData(
            ...
            (_b = this.response) === null || _b === void 0 ? void 0 : _b.data,
          );
        } catch (_c) {}
...
var require_retry = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function shouldRetryRequest(err) {
    ...
    if (
      err.name === "AbortError" ||
      ((_a = err.error) === null || _a === void 0 ? void 0 : _a.name) === "AbortError"
    )
      return false;
  ...
  function getNextRetryDelay(config) {
    ...
    const calculatedDelay =
      (config.currentRetryAttempt
        ? 0
        : (_a = config.retryDelay) !== null && _a !== void 0
          ? _a
          : 100) +
...
var require_gaxios = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Gaxios = class {
     ...
     */
    async request(opts = {}) {
      opts = await __classPrivateFieldGet(
        this,
        _Gaxios_instances,
        "m",
        _Gaxios_prepareRequest,
    ...
    async _request(opts = {}) {
      ...
      try {
        ...
        if (!opts.validateStatus(translatedResponse.status)) {
          if (opts.responseType === "stream") {
            ...
            await new Promise((resolve) => {
              (translatedResponse === null || translatedResponse === void 0
                ? void 0
          ...
          throw new common_1.GaxiosError(
        ...
        const err =
          e instanceof common_1.GaxiosError
            ? e
            : new common_1.GaxiosError(e.message, opts, void 0, e);
  ...
  ((_a = Gaxios),
    (_Gaxios_instances = /* @__PURE__ */ new WeakSet()),
    (_Gaxios_urlMayUseProxy = function _Gaxios_urlMayUseProxy(url, noProxy = []) {
      var _b, _c;
      const candidate = new url_1.URL(url);
      const noProxyList = [...noProxy];
      const noProxyEnvList =
        ((_c =
          (_b = process.env.NO_PROXY) !== null && _b !== void 0 ? _b : process.env.no_proxy) ===
          null || _c === void 0
          ? void 0
          : _c.split(",")) || [];
    ...
    (_Gaxios_applyResponseInterceptors = async function _Gaxios_applyResponseInterceptors(
      response,
    ) {
    ...
    (_Gaxios_prepareRequest = async function _Gaxios_prepareRequest(options) {
      ...
      const proxy =
        ...
        _c === void 0
          ? void 0
          : _c.https_proxy) ||
        ((_d = process === null || process === void 0 ? void 0 : process.env) === null ||
        _d === void 0
          ? void 0
          : _d.HTTP_PROXY) ||
        ((_e = process === null || process === void 0 ? void 0 : process.env) === null ||
        _e === void 0
          ? void 0
          : _e.http_proxy);
      const urlMayUseProxy = __classPrivateFieldGet(
        this,
        _Gaxios_instances,
        "m",
        _Gaxios_urlMayUseProxy,
      ).call(this, opts.url, opts.noProxy);
      if (opts.agent) {
    ...
    (_Gaxios_getProxyAgent = async function _Gaxios_getProxyAgent() {
      __classPrivateFieldSet(
        this,
        _a,
        __classPrivateFieldGet(this, _a, "f", _Gaxios_proxyAgent) ||
          (await Promise.resolve().then(() => __importStar(__require("https-proxy-agent"))))
            .HttpsProxyAgent,
        "f",
        _Gaxios_proxyAgent,
      );
