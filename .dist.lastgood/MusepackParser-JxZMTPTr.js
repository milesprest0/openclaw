...
import { i as FourCcToken, r as tryParseApeHeader } from "./APEv2Parser-B7oX-NFw.js";
import {
  C as UINT32_LE,
  E as UINT8,
  _ as StringType,
...
import { o as getBitAllignedNumber, s as isBitSet } from "./Util-DouHaPQs.js";
...
var MpcSv8Parser = class extends BasicParser {
  ...
  async parse() {
    if ((await this.tokenizer.readToken(FourCcToken)) !== "MPCK")
