...
//#endregion
export {
  SANDBOX_STATE_DIR as C,
  SANDBOX_REGISTRY_PATH as S,
  SANDBOX_AGENT_WORKSPACE_MOUNT as _,
  DEFAULT_SANDBOX_BROWSER_NOVNC_PORT as a,
  SANDBOX_BROWSER_SECURITY_HASH_EPOCH as b,
  DEFAULT_SANDBOX_COMMON_IMAGE as c,
  DEFAULT_SANDBOX_IMAGE as d,
  DEFAULT_SANDBOX_MAX_AGE_DAYS as f,
  DEFAULT_TOOL_DENY as g,
  DEFAULT_TOOL_ALLOW as h,
  DEFAULT_SANDBOX_BROWSER_NETWORK as i,
  DEFAULT_SANDBOX_CONTAINER_PREFIX as l,
  DEFAULT_SANDBOX_WORKSPACE_ROOT as m,
  DEFAULT_SANDBOX_BROWSER_CDP_PORT as n,
  DEFAULT_SANDBOX_BROWSER_PREFIX as o,
  DEFAULT_SANDBOX_WORKDIR as p,
  DEFAULT_SANDBOX_BROWSER_IMAGE as r,
  DEFAULT_SANDBOX_BROWSER_VNC_PORT as s,
  DEFAULT_SANDBOX_BROWSER_AUTOSTART_TIMEOUT_MS as t,
  DEFAULT_SANDBOX_IDLE_HOURS as u,
  SANDBOX_BROWSERS_DIR as v,
  SANDBOX_CONTAINERS_DIR as x,
  SANDBOX_BROWSER_REGISTRY_PATH as y,
};
