...
import {
  a as listInworldVoices,
  i as inworldTTS,
  o as normalizeInworldBaseUrl,
  r as INWORLD_TTS_MODELS,
} from "./tts-C3YE-Mgt.js";
    ...
    resolveTalkConfig: ({ baseTtsConfig, talkProviderConfig }) => {
      ...
      return {
        ...
        ...(normalizeOptionalString(talkProviderConfig.baseUrl) == null
          ? {}
          : {
              baseUrl: normalizeInworldBaseUrl(normalizeOptionalString(talkProviderConfig.baseUrl)),
            }),
