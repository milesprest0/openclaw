...
import { T as evaluateStoredCredentialEligibility } from "./store-9hg03xJO.js";
...
function providerAllowsAwsSdkAuth(cfg, provider) {
  ...
  return (
    authMode === "aws-sdk" ||
    (authMode === void 0 && normalizeProviderId(provider) === "amazon-bedrock")
  );
}
...
export {
  ...
  isProfileInCooldown as c,
  clearExpiredCooldowns as i,
  resolveProfileUnusableUntil as l,
  resolveAuthProfileEligibility as n,
  isActiveUnusableWindow as o,
  resolveAuthProfileOrder as r,
  isAuthCooldownBypassedForProvider as s,
  isConfiguredAwsSdkAuthProfileForProvider as t,
};
