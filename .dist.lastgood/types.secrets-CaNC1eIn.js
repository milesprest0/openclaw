...
function parseLegacySecretRefEnvMarker(value, provider = DEFAULT_SECRET_PROVIDER_ALIAS) {
  ...
  const prefix = trimmed.startsWith("secretref-env:")
    ? LEGACY_SECRETREF_ENV_MARKER_PREFIX
    : trimmed.startsWith("__env__:")
...
//#endregion
export {
  assertSecretInputResolved as a,
  isSecretRef as c,
  normalizeSecretInputString as d,
  parseEnvTemplateSecretRef as f,
  resolveSecretInputString as h,
  LEGACY_SECRETREF_ENV_MARKER_PREFIX as i,
  isValidEnvSecretRefId as l,
  resolveSecretInputRef as m,
  ENV_SECRET_REF_ID_RE as n,
  coerceSecretRef as o,
  parseLegacySecretRefEnvMarker as p,
  LEGACY_DOUBLE_UNDERSCORE_ENV_MARKER_PREFIX as r,
  hasConfiguredSecretInput as s,
  DEFAULT_SECRET_PROVIDER_ALIAS as t,
  normalizeResolvedSecretInputString as u,
};
