...
import { n as normalizeStructuredPromptSection } from "./prompt-cache-stability-CYa4MYXQ.js";
...
function hasExplicitSseTransport(sources) {
  return sources.some((source) => {
    return (
      (typeof source?.transport === "string" ? source.transport : "").trim().toLowerCase() === "sse"
    );
  });
}
...
//#endregion
export {
  shouldUseOpenAIWebSocketTransport as a,
  shouldPersistCompletedBootstrapTurn as i,
  composeSystemPromptWithHookContext as n,
  shouldUseOpenAIWebSocketTransportForAttempt as o,
  resolveAttemptSpawnWorkspaceDir as r,
  appendAttemptCacheTtlIfNeeded as t,
};
