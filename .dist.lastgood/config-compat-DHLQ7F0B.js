import { t as VoiceCallConfigSchema } from "./config-Dbj1icPs.js";
import "./text-runtime-lKuAtsoz.js";
import { i as asOptionalRecord, o as readStringField } from "./record-coerce-BuYFJfzm.js";
...
function migrateVoiceCallLegacyConfigInput(params) {
  ...
  if (streamingSilenceDurationMs !== void 0)
  ...
  if (streamingVadThreshold !== void 0)
...
//#endregion
export {
  parseVoiceCallPluginConfig as i,
  migrateVoiceCallLegacyConfigInput as n,
  normalizeVoiceCallLegacyConfigInput as r,
  formatVoiceCallLegacyConfigWarnings as t,
};
