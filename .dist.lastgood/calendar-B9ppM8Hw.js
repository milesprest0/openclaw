import { _ as googleApiError } from "./chrome-create-SD1kQYWf.js";
...
async function fetchGoogleCalendarEvents(params) {
  ...
  try {
    ...
    if (payload.items !== void 0 && !Array.isArray(payload.items))
...
//#endregion
export {
  findGoogleMeetCalendarEvent as n,
  listGoogleMeetCalendarEvents as r,
  buildGoogleMeetCalendarDayWindow as t,
};
