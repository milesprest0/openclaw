...
import { t as formatError } from "./session-errors-Cqfz8ejf.js";
...
function normalizeWhatsAppPayloadTextPreservingIndentation(text) {
  const normalized = stripLeadingBlankLines(
    finalizeWhatsAppVisibleText(
      sanitizeAssistantVisibleTextWithProfile(stripLeadingBlankLines(text ?? ""), "history"),
    ),
  );
...
//#endregion
export {
  resolveWhatsAppOutboundMediaUrls as a,
  prepareWhatsAppOutboundMedia as i,
  normalizeWhatsAppPayloadText as n,
  sendWhatsAppOutboundWithRetry as o,
  normalizeWhatsAppPayloadTextPreservingIndentation as r,
  normalizeWhatsAppOutboundPayload as t,
};
