...
import { t as LITELLM_BASE_URL } from "./onboard-B2Gzj8UQ.js";
...
function resolveConfiguredLitellmBaseUrl(cfg) {
  return (
    normalizeOptionalString(resolveLitellmProviderConfig(cfg)?.baseUrl) ?? "http://localhost:4000"
  );
}
...
function buildLitellmImageGenerationProvider() {
  return createOpenAiCompatibleImageGenerationProvider({
    ...
    resolveAllowPrivateNetwork: ({ baseUrl }) =>
      shouldAutoAllowPrivateLitellmEndpoint(baseUrl) ? true : void 0,
