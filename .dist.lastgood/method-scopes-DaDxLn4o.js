import { n as resolveReservedGatewayMethodScope } from "./gateway-method-policy-CwlQAnfR.js";
import {
  a as TALK_SECRETS_SCOPE,
  i as READ_SCOPE,
...
import { r as getPluginRegistryState } from "./runtime-state-CQLzHhNR.js";
...
const METHOD_SCOPE_BY_NAME = new Map(
  Object.entries({
    [APPROVALS_SCOPE]: [
      "exec.approval.get",
      "exec.approval.list",
...
function authorizeOperatorScopesForMethod(method, scopes) {
  ...
  if (requiredScope === "operator.read") {
    if (scopes.includes("operator.read") || scopes.includes("operator.write"))
      return { allowed: true };
    return {
      allowed: false,
...
//#endregion
export {
  isGatewayMethodClassified as a,
  isReadMethod as c,
  resolveRequiredOperatorScopeForMethod as d,
  isApprovalMethod as i,
  isWriteMethod as l,
  authorizeOperatorScopesForMethod as n,
  isNodeRoleMethod as o,
  isAdminOnlyMethod as r,
  isPairingMethod as s,
  CLI_DEFAULT_OPERATOR_SCOPES as t,
  resolveLeastPrivilegeOperatorScopesForMethod as u,
};
