...
import { f as resolveDiscordMaxLinesPerMessage } from "./accounts-Ctry1Kkb.js";
import { i as shouldAckReaction } from "./ack-reactions-Chyt3s4c.js";
import {
...
import {
  a as createStatusReactionController,
  r as DEFAULT_TIMING,
} from "./channel-feedback-CsnyeWms.js";
import { r as createFinalizableDraftLifecycle } from "./channel-lifecycle-BBBTbPMe.js";
import {
  ...
  w as resolveChannelStreamingSuppressDefaultToolProgressMessages,
...
import { i as resolveTimestampMs } from "./format-C7NoGYAq.js";
import { a as shouldLogVerbose, r as logVerbose, t as danger } from "./globals-BdfwDi2E.js";
import { o as buildPendingHistoryContextFromMap } from "./history-CiK0qvRj.js";
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-BfuOtf2o.js";
import { t as finalizeInboundContext } from "./inbound-context-C2mdUiyz.js";
import {
  n as buildDiscordInboundAccessContext,
  r as createDiscordSupplementalContextAccessChecker,
...
import { r as logTypingFailure, t as logAckFailure } from "./logging-ChWKeerl.js";
...
import {
  a as resolveForwardedMediaList,
  i as buildDiscordMediaPayload,
  o as resolveMediaList,
  r as resolveDiscordMessageText,
} from "./message-utils-DmLq_iNk.js";
import "./reply-dispatch-runtime-fx6x-aY8.js";
import "./reply-chunking-D9l7MwoT.js";
import {
  a as chunkDiscordTextWithMode,
...
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-DH8NSfGw.js";
...
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-Bk-xpKsZ.js";
import {
  i as resolveReplyContext,
...
import {
  ...
  P as createDiscordRuntimeAccountContext,
  d as resolveDiscordTargetChannelId,
...
import { t as sendTyping } from "./typing-CHcZ3t_m.js";
...
async function buildDiscordMessageProcessContext(params) {
  ...
  const ctxPayload = finalizeInboundContext({
    ...
    ModelParentSessionKey:
      autoThreadContext?.ModelParentSessionKey ?? modelParentSessionKey ?? void 0,
...
function resolveDiscordDraftStreamingChunking(cfg, accountId) {
  ...
  const draftCfg =
    resolveChannelStreamingPreviewChunk(
      resolveAccountEntry(cfg?.channels?.discord?.accounts, normalizedAccountId),
  ...
  const sendOrEditStreamMessage = async (text) => {
    ...
    try {
      ...
      const messageReference = replyToMessageId
        ...
        : void 0;
      const sentMessageId = (
        await createChannelMessage(rest, channelId, {
          body: {
            content: trimmed,
            allowed_mentions: DISCORD_PREVIEW_ALLOWED_MENTIONS,
...
function createDiscordDraftPreviewController(params) {
  ...
  const draftStream =
    !params.sourceRepliesAreToolOnly && discordStreamMode !== "off" && !accountBlockStreamingEnabled
  ...
  return {
    ...
    async pushToolProgress(line, options) {
      ...
      if (previewToolProgressEnabled && !previewToolProgressSuppressed && normalized) {
        if (normalizeProgressLineIdentity(previewToolProgressLines.at(-1)) !== normalized)
          previewToolProgressLines = [...previewToolProgressLines, progressLine].slice(
            -resolveChannelProgressDraftMaxLines(params.discordConfig),
          );
      }
...
function formatDiscordReplyDeliveryFailure(params) {
  const context = [
    `target=${params.target}`,
    params.sessionKey ? `session=${params.sessionKey}` : void 0,
  ]
    .filter(Boolean)
    .join(" ");
...
async function processDiscordMessage(ctx, observer) {
  ...
  try {
          ...
          runDispatch: async () => {
            return await dispatchInboundMessage({
              ...
              replyOptions: {
                ...
                onModelSelected,
                suppressDefaultToolProgressMessages:
                  draftPreview.suppressDefaultToolProgressMessages ? true : void 0,
    ...
    if (statusReactionsActive)
      ...
      removeReactionDiscord(messageChannelId, message.id, ackReaction, ackReactionContext).catch(
        (err) => {
          logAckFailure({
            log: logVerbose,
            channel: "discord",
