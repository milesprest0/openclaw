...
async function handleFileWrite(params) {
  ...
  const expectedSha256 =
    typeof params?.expectedSha256 === "string" ? params.expectedSha256 : void 0;
  ...
  if (!parentExists) {
    ...
    try {
      ...
      return err(
        "WRITE_ERROR",
        `failed to create parent directories: ${mkdirErr instanceof Error ? mkdirErr.message : String(mkdirErr)}`,
      );
    }
  }
  try {
