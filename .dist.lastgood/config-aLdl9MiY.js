...
import { m as DEFAULT_SANDBOX_WORKSPACE_ROOT } from "./constants-DcbmEUTo.js";
...
function resolveSandboxDockerConfig(params) {
  ...
  return {
    ...
    containerPrefix:
      agentDocker?.containerPrefix ?? globalDocker?.containerPrefix ?? "openclaw-sbx-",
...
function resolveSandboxBrowserConfig(params) {
  ...
  return {
    ...
    containerPrefix:
      agentBrowser?.containerPrefix ?? globalBrowser?.containerPrefix ?? "openclaw-sbx-browser-",
    ...
    autoStartTimeoutMs:
      agentBrowser?.autoStartTimeoutMs ?? globalBrowser?.autoStartTimeoutMs ?? 12e3,
...
//#endregion
export {
  resolveSandboxDockerConfig as a,
  resolveSandboxSshConfig as c,
  resolveSandboxConfigForAgent as i,
  resolveSandboxBrowserConfig as n,
  resolveSandboxPruneConfig as o,
  resolveSandboxBrowserDockerCreateConfig as r,
  resolveSandboxScope as s,
  DANGEROUS_SANDBOX_DOCKER_BOOLEAN_KEYS as t,
};
