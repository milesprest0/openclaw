...
const PLUGIN_SDK_SOURCE_CANDIDATE_EXTENSIONS = [".ts", ".mts", ".js", ".mjs", ".cts", ".cjs"];
...
function hasPluginSdkSubpathArtifact(packageRoot, subpath) {
  if (isUsableDistPluginSdkArtifact(path.join(packageRoot, "dist", "plugin-sdk", `${subpath}.js`)))
    return true;
...
const JITI_ALIAS_ROOT_SENTINELS = new Set(["/", "\\", void 0]);
...
//#endregion
export {
  listPluginSdkAliasCandidates as a,
  resolveExtensionApiAlias as c,
  resolvePluginLoaderTryNative as d,
  resolvePluginRuntimeModulePath as f,
  shouldPreferNativeModuleLoad as g,
  resolvePluginSdkScopedAliasMap as h,
  isBundledPluginExtensionPath as i,
  resolveLoaderPackageRoot as l,
  resolvePluginSdkAliasFile as m,
  buildPluginLoaderJitiOptions as n,
  listPluginSdkExportedSubpaths as o,
  resolvePluginSdkAliasCandidateOrder as p,
  createPluginLoaderModuleCacheKey as r,
  normalizeJitiAliasTargetPath as s,
  buildPluginLoaderAliasMap as t,
  resolvePluginLoaderModuleConfig as u,
};
