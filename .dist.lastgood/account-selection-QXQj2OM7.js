...
function resolveDefaultTelegramAccountSelection(cfg) {
  ...
  return {
    ...
    shouldWarnMissingDefault:
      resolved === accountIds[0] && !accountIds.includes("default") && accountIds.length > 1,
  };
}
...
//#endregion
export {
  resolveDefaultTelegramAccountId as n,
  resolveDefaultTelegramAccountSelection as r,
  listTelegramAccountIds as t,
};
