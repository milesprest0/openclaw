...
import {
  l as resolveProfileUnusableUntil,
  o as isActiveUnusableWindow,
  s as isAuthCooldownBypassedForProvider,
...
function resolveWhamResetMs(window, now) {
  ...
  if (
    ...
    return window.reset_after_seconds * 1e3;
  if (
    typeof window.reset_at === "number" &&
    Number.isFinite(window.reset_at) &&
    window.reset_at > 0
  )
    return Math.max(0, window.reset_at * 1e3 - now);
  return null;
}
  ...
  if (disabledFailureReason) {
    ...
    if (
      ...
      if (
        ...
        updatedStats.cooldownModel = void 0;
...
//#endregion
export {
  markAuthProfileUsed as a,
  markAuthProfileFailure as i,
  clearAuthProfileCooldown as n,
  resolveProfileUnusableUntilForDisplay as o,
  markAuthProfileCooldown as r,
  resolveProfilesUnavailableReason as s,
  calculateAuthProfileCooldownMs as t,
};
