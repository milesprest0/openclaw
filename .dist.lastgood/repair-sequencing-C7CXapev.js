...
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-C2BSRPr2.js";
import {
  a as collectChannelDoctorRepairMutations,
  s as createChannelDoctorEmptyAllowlistPolicyHooks,
} from "./channel-doctor-Cz_i63YQ.js";
import { n as maybeRepairCodexRoutes } from "./codex-route-warnings-DamDpeAa.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-B4v-ZwMJ.js";
import { s as setCanonicalDmAllowFrom } from "./dm-access-CkqmJvoT.js";
import { n as maybeRepairStaleManagedNpmBundledPlugins } from "./doctor-plugin-registry-CNGks4YT.js";
import {
  n as hasAllowFromEntries,
  t as scanEmptyAllowlistPolicyWarnings,
} from "./empty-allowlist-scan-6Lfw4Nrc.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-BKu76Mcj.js";
import { r as normalizeChatChannelId } from "./ids-D_WQYNuU.js";
import { T as validateConfigObjectWithPlugins } from "./io-CEQSCTGy.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-DevYc1Z9.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-Bg78isLQ.js";
import { t as asObjectRecord } from "./object-CFkMKtRh.js";
import {
  n as maybeRepairOpenPolicyAllowFrom,
  r as resolveAllowFromMode,
} from "./open-policy-allowfrom-9KO0RKsl.js";
...
import { r as removeStalePluginRuntimeSymlinks } from "./plugin-runtime-symlinks-BnNXlnhc.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-BGy7YVVt.js";
...
async function collectDirectChildren(root) {
  return (await fs.readdir(root, { withFileTypes: true }).catch(() => [])).map((entry) =>
