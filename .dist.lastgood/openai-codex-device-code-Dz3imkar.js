import { t as resolveCodexAccessTokenExpiry } from "./openai-codex-auth-identity-DkWwPrEp.js";
import { t as trimNonEmptyString } from "./openai-codex-shared-CBYBLqa6.js";
...
function normalizeTokenLifetimeMs(value) {
  if (typeof value === "number" && Number.isFinite(value) && value > 0)
    return Math.trunc(value * 1e3);
  if (typeof value === "string" && /^\d+$/.test(value.trim()))
    return Number.parseInt(value.trim(), 10) * 1e3;
}
