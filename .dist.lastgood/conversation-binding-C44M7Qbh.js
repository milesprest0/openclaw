...
import { n as resolveGlobalSingleton, t as resolveGlobalMap } from "./global-singleton-mDk73q05.js";
...
const pluginBindingGlobalState = resolveGlobalSingleton(
...
async function bindConversationNow(params) {
  const ref = toConversationRef(params.conversation);
  const binding = toPluginConversationBinding(
...
//#endregion
export {
  getConversationBindingCapabilities as _,
  buildPluginBindingUnavailableText as a,
  touchConversationBindingRecord as b,
  hasShownPluginBindingFallbackNotice as c,
  markPluginBindingFallbackNoticeShown as d,
  parsePluginBindingApprovalCustomId as f,
  createConversationBindingRecord as g,
  toPluginConversationBinding as h,
  buildPluginBindingResolvedText as i,
  isPluginOwnedBindingMetadata as l,
  resolvePluginConversationBindingApproval as m,
  buildPluginBindingDeclinedText as n,
  detachPluginConversationBinding as o,
  requestPluginConversationBinding as p,
  buildPluginBindingErrorText as r,
  getCurrentPluginConversationBinding as s,
  buildPluginBindingApprovalCustomId as t,
  isPluginOwnedSessionBindingRecord as u,
  listSessionBindingRecords as v,
  unbindConversationBindingRecord as x,
  resolveConversationBindingRecord as y,
};
