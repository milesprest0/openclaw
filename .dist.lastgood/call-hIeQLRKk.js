...
import "./credentials-FOmsSSJ3.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-CZR2KRBD.js";
import { a as trimToUndefined } from "./credential-planner-CcCVplQO.js";
import { t as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-CjqYHjKS.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-BQp4SxLS.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-CwetPkTT.js";
import "./message-channel-GRZIhFYD.js";
import { t as loadGatewayTlsRuntime } from "./gateway-Vqo11IHR.js";
import { n as resolvePreauthHandshakeTimeoutMs } from "./handshake-timeouts-BWfTnhrv.js";
...
import {
  a as isGatewayMethodClassified,
  t as CLI_DEFAULT_OPERATOR_SCOPES,
  u as resolveLeastPrivilegeOperatorScopesForMethod,
} from "./method-scopes-DaDxLn4o.js";
import {
...
function resolveGatewayConfigPath(env) {
  return (
    typeof gatewayCallDeps.resolveConfigPath === "function"
      ...
      : resolveConfigPath
  )(env, resolveGatewayStateDir(env));
}
...
function resolveGatewayCallTimeout(timeoutValue, configuredHandshakeTimeoutMs) {
  ...
  const timeoutMs =
    typeof timeoutValue === "number" && Number.isFinite(timeoutValue)
      ? timeoutValue
      : typeof resolvedHandshakeTimeoutMs === "number" && resolvedHandshakeTimeoutMs > 1e4
...
async function resolveGatewayTlsFingerprint(params) {
  ...
  return (
    ...
    (tlsRuntime?.enabled ? tlsRuntime.fingerprintSha256 : void 0)
  );
}
function formatGatewayCloseError(code, reason, connectionDetails) {
  ...
  const hint =
    code === 1006 ? "abnormal closure (no close frame)" : code === 1e3 ? "normal closure" : "";
...
export {
  callGatewayCli as a,
  ensureExplicitGatewayAuth as c,
  resolveExplicitGatewayAuth as d,
  callGateway as i,
  isGatewayTransportError as l,
  __testing as n,
  callGatewayLeastPrivilege as o,
  buildGatewayConnectionDetails as r,
  callGatewayScoped as s,
  GatewayTransportError as t,
  randomIdempotencyKey as u,
};
