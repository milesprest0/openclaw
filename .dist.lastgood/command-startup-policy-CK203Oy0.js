...
function resolveCliStartupPolicy(params) {
  ...
  return {
    ...
    hideBanner:
      isTruthyEnvValue((params.env ?? process.env).OPENCLAW_HIDE_BANNER) ||
      commandPolicy.hideBanner,
...
//#endregion
export {
  shouldLoadPluginsForCommandPath as a,
  shouldHideCliBannerForCommandPath as i,
  shouldBypassConfigGuardForCommandPath as n,
  shouldSkipRouteConfigGuardForCommandPath as o,
  shouldEnsureCliPathForCommandPath as r,
  resolveCliStartupPolicy as t,
};
