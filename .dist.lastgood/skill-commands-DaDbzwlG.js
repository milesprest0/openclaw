...
import { l as resolveAgentSkillsFilter } from "./agent-scope-9AmhTwki.js";
import { n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-CXZGyKMl.js";
import { t as canExecRequestNode } from "./exec-defaults-C4RqVOp-.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { t as listReservedChatSlashCommandNames } from "./skill-commands-base-BdNIErH7.js";
import { n as buildWorkspaceSkillCommandSpecs } from "./skills-DYy402QP.js";
...
function listSkillCommandsForAgents(params) {
  ...
  for (const { workspaceDir, skillFilter } of workspaceFilters.values()) {
    const commands = buildWorkspaceSkillCommandSpecs(workspaceDir, {
      ...
      eligibility: {
        remote: getRemoteSkillEligibility({
          advertiseExecNode: canExecRequestNode({ cfg: params.cfg }),
        }),
      },
      reservedNames: used,
    });
