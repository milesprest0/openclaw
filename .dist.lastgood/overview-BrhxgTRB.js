...
import {
  i as resolveOpenClawReferencePaths,
  n as OPENCLAW_SOURCE_URL,
  t as OPENCLAW_DOCS_URL,
} from "./docs-path-C8ABbQjT.js";
...
async function loadCrestodianOverview(opts = {}) {
  ...
  try {
    const details = (
      ...
      (await import("./call-DryNwhyi.js")).buildGatewayConnectionDetails
    )({
      config: cfg,
      configPath,
    });
...
//#endregion
export {
  formatCrestodianStartupMessage as n,
  loadCrestodianOverview as r,
  formatCrestodianOverview as t,
};
