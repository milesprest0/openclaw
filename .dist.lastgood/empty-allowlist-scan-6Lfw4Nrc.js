...
import { l as shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning } from "./channel-doctor-Cz_i63YQ.js";
...
function isDisabledRecord(value) {
  return (
    Boolean(value && typeof value === "object" && !Array.isArray(value)) && value.enabled === false
  );
}
