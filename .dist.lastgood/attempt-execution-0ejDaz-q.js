...
import {
  i as resolveFallbackRetryPrompt,
  n as claudeCliSessionTranscriptHasContent,
  t as buildClaudeCliFallbackContextPrelude,
} from "./attempt-execution.helpers-WZ9zY_9l.js";
import { t as persistSessionEntry } from "./attempt-execution.shared-ZisKXlev.js";
...
import { r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-FZWoj6wf.js";
import { nt as buildUsageWithNoCost } from "./context-budget-CZcqCu6a.js";
import "./model-selection-CyVXHdEG.js";
import "./selection-BcCvjGlJ.js";
import { t as FailoverError } from "./failover-error-Dx3vQAkt.js";
...
import { r as resolveAuthProfileOrder } from "./order-2B7dbn6U.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-D_bdRDPs.js";
import { t as clearCliSessionInStore } from "./session-store-38n7MlYX.js";
import {
...
import {
  a as resolveSessionTranscriptFile,
  i as readTailAssistantTextFromSessionTranscript,
  s as appendSessionTranscriptMessage,
} from "./transcript-B5N3gLUE.js";
...
function resolveProfileProviderFromStore(params) {
  ...
  if (!profileId) return;
  return ensureAuthProfileStore(params.agentDir, { allowKeychainPrompt: false }).profiles[profileId]
    ?.provider;
}
...
function runAgentAttempt(params) {
  ...
  if (!isRawModelRun && isCliProvider(cliExecutionProvider, params.cfg)) {
    ...
    const runCliWithSession = (nextCliSessionId, activeCliSessionBinding = cliSessionBinding) =>
      runCliAgent({
        sessionId: params.sessionId,
        sessionKey: params.sessionKey,
        agentId: params.sessionAgentId,
...
//#endregion
export {
  emitAcpLifecycleStart as a,
  runAgentAttempt as c,
  emitAcpLifecycleError as i,
  emitAcpAssistantDelta as n,
  persistAcpTurnTranscript as o,
  emitAcpLifecycleEnd as r,
  persistCliTurnTranscript as s,
  buildAcpResult as t,
};
