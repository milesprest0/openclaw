import { o as isLocalDirectRequest } from "./auth-D_VLzYQI.js";
import {
...
import {
  a as killSubagentRunAdmin,
  c as resolveSubagentController,
  i as killControlledSubagentRun,
} from "./subagent-control-LdQOjN4T.js";
import { o as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-DESvhcq6.js";
...
async function handleSessionKillHttpRequest(req, res, opts) {
  ...
  const sessionKey = resolveSessionKeyFromPath(
