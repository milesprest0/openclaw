...
const WIKI_VAULT_MODES = ["isolated", "bridge", "unsafe-local"];
const WIKI_RENDER_MODES = ["native", "obsidian"];
const WIKI_SEARCH_BACKENDS = ["shared", "local"];
const WIKI_SEARCH_CORPORA = ["wiki", "memory", "all"];
...
const MemoryWikiConfigSource = zod_exports.z.strictObject({
  ...
  ingest: zod_exports.z
    ...
    .optional(),
  search: zod_exports.z
    .strictObject({
      backend: zod_exports.z.enum(WIKI_SEARCH_BACKENDS).optional(),
      corpus: zod_exports.z.enum(WIKI_SEARCH_CORPORA).optional(),
    })
    .optional(),
  context: zod_exports.z
    .strictObject({ includeCompiledDigestPrompt: zod_exports.z.boolean().optional() })
    .optional(),
  render: zod_exports.z
    .strictObject({
...
const memoryWikiConfigSchema = buildPluginConfigSchema(MemoryWikiConfigSource, {
  safeParse(value) {
    if (value === void 0)
      return {
        success: true,
...
//#endregion
export {
  WIKI_RENDER_MODES as a,
  WIKI_VAULT_MODES as c,
  resolveMemoryWikiConfig as d,
  DEFAULT_WIKI_VAULT_MODE as i,
  memoryWikiConfigSchema as l,
  DEFAULT_WIKI_SEARCH_BACKEND as n,
  WIKI_SEARCH_BACKENDS as o,
  DEFAULT_WIKI_SEARCH_CORPUS as r,
  WIKI_SEARCH_CORPORA as s,
  DEFAULT_WIKI_RENDER_MODE as t,
  resolveDefaultMemoryWikiVaultPath as u,
};
