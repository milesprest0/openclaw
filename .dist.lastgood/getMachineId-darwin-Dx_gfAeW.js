...
import { n as init_esm, t as esm_exports } from "./esm-ZCcDQpvN.js";
import { t as require_execAsync } from "./execAsync-7fnnXaCb.js";
...
var require_getMachineId_darwin = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function getMachineId() {
    try {
      const idLine = (
        await (0, execAsync_1.execAsync)('ioreg -rd1 -c "IOPlatformExpertDevice"')
      ).stdout
        .split("\n")
