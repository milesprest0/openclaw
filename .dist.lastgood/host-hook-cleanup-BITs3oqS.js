...
import {
  C as cleanupPluginSessionSchedulerJobs,
  D as makePluginSessionSchedulerJobKey,
  N as withPluginHostCleanupTimeout,
...
const OBJECT_PROTOTYPE_RESERVED_SLOT_KEYS = new Set([
  "prototype",
...
function hasPromotedSessionEntrySlot(entry, pluginId, sessionEntrySlotKeys) {
  ...
  for (const slotKey of slotKeys)
    if (Object.prototype.hasOwnProperty.call(entryRecord, slotKey)) return true;
  return false;
}
...
//#endregion
export {
  normalizeSessionEntrySlotKey as i,
  clearPluginOwnedSessionState as n,
  runPluginHostCleanup as r,
  cleanupReplacedPluginHostRegistry as t,
};
