...
import {
  i as supportsNativeExecApprovalClient,
  n as listNativeExecApprovalClientLabels,
  t as describeNativeExecApprovalClientSetup,
} from "./exec-approval-surface-DdO0jEpr.js";
import { E as resolveExecApprovalAllowedDecisions } from "./exec-approvals-VkyGhwX9.js";
import { t as formatHumanList } from "./human-list-DFxQUMlc.js";
import {
...
function resolveNativeExecApprovalClientList(params) {
  return formatHumanList(
    listNativeExecApprovalClientLabels({ excludeChannel: params?.excludeChannel }),
  );
}
...
function getExecApprovalReplyMetadata(payload) {
  ...
  const allowedDecisions = Array.isArray(record.allowedDecisions)
    ? record.allowedDecisions.filter(
        (value) => value === "allow-once" || value === "allow-always" || value === "deny",
      )
    : void 0;
  return {
    approvalId,
...
//#endregion
export {
  buildExecApprovalInteractiveReply as a,
  formatExecApprovalExpiresIn as c,
  parseExecApprovalCommandText as d,
  buildExecApprovalCommandText as i,
  getExecApprovalApproverDmNoticeText as l,
  buildApprovalInteractiveReplyFromActionDescriptors as n,
  buildExecApprovalPendingReplyPayload as o,
  buildExecApprovalActionDescriptors as r,
  buildExecApprovalUnavailableReplyPayload as s,
  buildApprovalInteractiveReply as t,
  getExecApprovalReplyMetadata as u,
};
