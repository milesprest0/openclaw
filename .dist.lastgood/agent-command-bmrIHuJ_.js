...
import {
  i as resolveInternalEventTranscriptBody,
  n as prependInternalEventContext,
  r as resolveAcpPromptBody,
  t as persistSessionEntry$1,
} from "./attempt-execution.shared-ZisKXlev.js";
...
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-CkWxZ_Vf.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-4m7JJmD2.js";
import { o as normalizeAccountId } from "./delivery-context.shared-mj-12Z6_.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { t as resolveFastModeState } from "./fast-mode-C7KEUg_P.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-CEQSCTGy.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-CEV2BIp0.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import { n as applyVerboseOverride } from "./level-overrides-Dz8iJ1QO.js";
import { r as ensureSelectedAgentHarnessPlugin } from "./live-model-switch-GuLEgeev.js";
import { f as resolveMessageChannel } from "./message-channel-GRZIhFYD.js";
import { n as loadManifestModelCatalog } from "./model-catalog-CJYpfYgw.js";
import {
...
import { w as createTrajectoryRuntimeRecorder } from "./selection-BcCvjGlJ.js";
...
import { t as clearSessionAuthProfileOverride } from "./session-override--A-ozV0V.js";
import { n as hydrateResolvedSkillsAsync } from "./snapshot-hydration-Ci9nXBDI.js";
import { r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-zGSeuSpR.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
  ...
  const cfg = hasAgentRuntimeSecretRefs({
    ...
    ? (
        await (
          await import("./command-config-resolution.runtime.js")
...
const attemptExecutionRuntimeLoader = createLazyImportLoader(
  () => import("./attempt-execution.runtime.js"),
);
const acpManagerRuntimeLoader = createLazyImportLoader(() => import("./manager-BynRErUg.js"));
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-C0BN-2gi.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-DJnjOrFO.js"));
const acpSessionIdentifiersRuntimeLoader = createLazyImportLoader(
  () => import("./session-identifiers-B0ZNHBIK.js"),
);
const deliveryRuntimeLoader = createLazyImportLoader(() => import("./delivery.runtime.js"));
const sessionStoreRuntimeLoader = createLazyImportLoader(
  () => import("./session-store.runtime.js"),
);
const cliCompactionRuntimeLoader = createLazyImportLoader(
  () => import("./cli-compaction-BTMeplf0.js"),
);
const transcriptResolveRuntimeLoader = createLazyImportLoader(
  () => import("./transcript-resolve.runtime.js"),
);
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-D7PfsdRR.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(
  () => import("./exec-defaults-kb9h9vYl.js"),
);
const skillsRuntimeLoader = createLazyImportLoader(() => import("./skills-D_vWcVag.js"));
const skillsFilterRuntimeLoader = createLazyImportLoader(() => import("./filter-_jOc1Evc.js"));
const skillsRefreshStateRuntimeLoader = createLazyImportLoader(
  () => import("./refresh-state-WaqknywN.js"),
);
const skillsRemoteRuntimeLoader = createLazyImportLoader(
  () => import("./skills-remote-CzpSFSbw.js"),
);
...
async function prepareAgentCommandExecution(opts, runtime) {
  ...
  if (agentIdOverride) {
    if (!listAgentIds(cfg).includes(agentIdOverride))
      throw new Error(
  ...
  const thinkingLevelsHint = formatThinkingLevels(
    ...
    ", ",
    configuredThinkingCatalog.length > 0 ? configuredThinkingCatalog : void 0,
  );
  ...
  const timeoutSecondsRaw =
    opts.timeout !== void 0 ? Number.parseInt(opts.timeout, 10) : isSubagentLane ? 0 : void 0;
  if (timeoutSecondsRaw !== void 0 && (Number.isNaN(timeoutSecondsRaw) || timeoutSecondsRaw < 0))
...
async function agentCommandInternal(opts, runtime = defaultRuntime, deps) {
  ...
  try {
    ...
    if (!isRawModelRun && acpResolution?.kind === "ready" && sessionKey) {
      ...
      try {
        ...
        const agentPolicyError = resolveAcpAgentPolicyError(
          cfg,
          normalizeAgentId(acpResolution.meta.agent || resolveAgentIdFromSessionKey(sessionKey)),
        );
    ...
    const explicitModelOverride =
      typeof opts.model === "string" ? normalizeExplicitOverrideInput(opts.model, "model") : void 0;
    ...
    if (
      ...
      if (Boolean(thinkOnce || thinkOverride))
        throw new Error(
      ...
      try {
        ...
        if (err instanceof LiveSessionModelSwitchError) {
          ...
          if (!allowAnyModel && !allowedModelKeys.has(switchKey)) {
            log.info(
              `Live session model switch in subagent run ${runId}: rejected ${sanitizeForLog(err.provider)}/${sanitizeForLog(err.model)} (not in allowlist)`,
            );
            if (!lifecycleEnded)
              emitAgentEvent({
                runId,
    ...
    const embeddedAssistantGapFill =
      ...
      (transcriptPersistenceRunner === void 0 &&
