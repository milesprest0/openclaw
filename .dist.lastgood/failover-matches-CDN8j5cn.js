...
const CJK_AUTH_ERROR_PATTERNS = ["无权访问", "认证失败", "鉴权失败", "密钥无效", "apikey 无效"];
...
//#endregion
export {
  isPeriodicUsageLimitErrorMessage as a,
  isTimeoutErrorMessage as c,
  isOverloadedErrorMessage as i,
  matchesFormatErrorPattern as l,
  isAuthPermanentErrorMessage as n,
  isRateLimitErrorMessage as o,
  isBillingErrorMessage as r,
  isServerErrorMessage as s,
  isAuthErrorMessage as t,
};
