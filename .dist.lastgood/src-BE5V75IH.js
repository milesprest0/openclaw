...
import { t as require_extend } from "./extend-DOViJc7w.js";
import { t as require_json_bigint } from "./json-bigint-B35yBN7H.js";
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-BbK7FZDe.js";
    ...
    static extractAPIErrorFromResponse(res, defaultErrorMessage = "The request failed") {
      ...
      if (
        ...
        if (typeof res.data.error === "object") {
          message =
            "message" in res.data.error && typeof res.data.error.message === "string"
              ? res.data.error.message
              : message;
          const status =
            "status" in res.data.error && typeof res.data.error.status === "string"
...
var require_retry = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function getRetryConfig(err) {
    ...
    config.noResponseRetries =
      config.noResponseRetries === void 0 || config.noResponseRetries === null
        ? 2
        : config.noResponseRetries;
    ...
    if (!(await (config.shouldRetry || shouldRetryRequest)(err)))
      return {
        shouldRetry: false,
        config: err.config,
      };
  ...
  function getNextRetryDelay(config) {
    const calculatedDelay =
      (config.currentRetryAttempt ? 0 : (config.retryDelay ?? 100)) +
      ((Math.pow(config.retryDelayMultiplier, config.currentRetryAttempt) - 1) / 2) * 1e3;
...
var require_gaxios = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Gaxios = class {
    ...
    async _defaultAdapter(config) {
      const fetchImpl =
        config.fetchImplementation || this.defaults.fetchImplementation || (await _a.#getFetch());
    ...
    async _request(opts) {
      try {
        ...
        if (!opts.validateStatus(translatedResponse.status)) {
          ...
          const errorInfo = common_js_1.GaxiosError.extractAPIErrorFromResponse(
            translatedResponse,
            `Request failed with status code ${translatedResponse.status}`,
          );
          throw new common_js_1.GaxiosError(
            errorInfo?.message,
            opts,
            translatedResponse,
            errorInfo,
    ...
    async getResponseData(opts, res) {
      ...
      if (
        ...
        opts.maxContentLength < Number.parseInt(res.headers?.get("content-length") || "")
      )
        throw new common_js_1.GaxiosError(
          "Response's `Content-Length` is over the limit.",
          opts,
          Object.assign(res, { config: opts }),
        );
    ...
    static async #getFetch() {
      ...
      this.#fetch ||= hasWindow ? window.fetch : (await import("./src-DDWvLp8X.js")).default;
      return this.#fetch;
    }
    /**
     * Merges headers.
    ...
    static mergeHeaders(base, ...append) {
      ...
      for (const headers of append)
        (headers instanceof Headers ? headers : new Headers(headers)).forEach((value, key) => {
...
var require_colours = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Colours = class Colours {
    ...
    static refresh() {
      Colours.enabled = Colours.isEnabled(
...
var require_logging_utils = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.env =
    exports.DebugLogBackendBase =
    exports.placeholder =
    exports.AdhocDebugLogger =
    exports.LogSeverity =
      void 0;
  ...
  var DebugLogBackendBase = class {
    constructor() {
      ...
      let nodeFlag =
        (_a = process$1.env[exports.env.nodeEnables]) !== null && _a !== void 0 ? _a : "*";
  ...
  var DebugBackend = class extends DebugLogBackendBase {
    ...
    setFilters() {
      ...
      const existingFilters =
        (_a = process$1.env["NODE_DEBUG"]) !== null && _a !== void 0 ? _a : "";
      process$1.env["NODE_DEBUG"] =
        `${existingFilters}${existingFilters ? "," : ""}${this.filters.join(",")}`;
    }
  };
  /**
  ...
  var StructuredBackend = class extends DebugLogBackendBase {
    ...
    makeLogger(namespace) {
      var _a;
      const debugLogger =
        (_a = this.upstream) === null || _a === void 0 ? void 0 : _a.makeLogger(namespace);
      return (fields, ...args) => {
        var _a;
...
var require_src$1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.gcpResidencyCache =
    exports.METADATA_SERVER_DETECTION =
    exports.HEADERS =
    exports.HEADER_VALUE =
    exports.HEADER_NAME =
    exports.SECONDARY_HOST_ADDRESS =
  ...
  function getBaseUrl(baseUrl) {
    if (!baseUrl)
      baseUrl =
        process.env.GCE_METADATA_IP || process.env.GCE_METADATA_HOST || exports.HOST_ADDRESS;
  ...
  async function metadataAccessor(type, options = {}, noResponseRetries = 3, fastFail = false) {
    ...
    if (metadataFlavor !== exports.HEADER_VALUE)
      throw new RangeError(
        `Invalid response from metadata service: incorrect ${exports.HEADER_NAME} header. Expected '${exports.HEADER_VALUE}', got ${metadataFlavor ? `'${metadataFlavor}'` : "no header"}`,
      );
  ...
  async function isAvailable() {
    if (process.env.METADATA_SERVER_DETECTION) {
      ...
      if (!(value in exports.METADATA_SERVER_DETECTION))
        throw new RangeError(
          `Unknown \`METADATA_SERVER_DETECTION\` env variable. Got \`${value}\`, but it should be \`${Object.keys(exports.METADATA_SERVER_DETECTION).join("`, `")}\`, or unset`,
        );
      switch (value) {
        case "assume-present":
          return true;
...
var require_util = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var LRUCache = class {
    ...
    #evict() {
      ...
      while (
        !oldestItem.done &&
        (this.#cache.size > this.capacity || oldestItem.value[1].lastAccessed < cutoffDate)
      ) {
  ...
  function getWellKnownCertificateConfigFileLocation() {
    const configDir =
      ...
      (_isWindows()
        ? path$2.join(process.env.APPDATA || "", CLOUDSDK_CONFIG_DIRECTORY)
        : path$2.join(process.env.HOME || "", ".config", CLOUDSDK_CONFIG_DIRECTORY));
...
var require_oauth2client = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.OAuth2Client = class OAuth2Client extends authclient_1.AuthClient {
    ...
    async generateCodeVerifierAsync() {
      ...
      return {
        codeVerifier,
        codeChallenge: (await crypto.sha256DigestBase64(codeVerifier))
          .split("=")[0]
          .replace(/\+/g, "-")
          .replace(/\//g, "_"),
      };
    ...
    async verifySignedJwtWithCertsAsync(jwt, certs, requiredAudience, issuers, maxExpiry) {
      ...
      if (!(await crypto.verify(cert, signed, signature)))
...
var require_idtokenclient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var IdTokenClient = class extends oauth2client_1.OAuth2Client {
    ...
    getIdTokenExpiryDate(idToken) {
      ...
      if (payloadB64)
        return JSON.parse(Buffer.from(payloadB64, "base64").toString("ascii")).exp * 1e3;
    }
  };
...
var require_getCredentials = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const readFile = fs$4.readFile
    ? (0, util_1$1.promisify)(fs$4.readFile)
    : async () => {
  ...
  var TokenHandler = class {
    ...
    hasExpired() {
      ...
      if (this.token && this.tokenExpiresAt)
        return /* @__PURE__ */ new Date().getTime() >= this.tokenExpiresAt;
      return true;
    }
    /**
...
var require_googleToken = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var GoogleToken = class {
    ...
    revokeToken(callback) {
      if (!this.accessToken)
        return Promise.reject(/* @__PURE__ */ new Error("No token to revoke."));
...
var require_jwtclient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.JWT = class JWT extends oauth2client_1.OAuth2Client {
        ...
        if (this.additionalClaims && this.additionalClaims.target_audience) {
          ...
          return {
            headers: this.addSharedMetadataHeaders(
              new Headers({ authorization: `Bearer ${tokens.id_token}` }),
            ),
          };
        } else {
          if (!this.access)
    ...
    async refreshTokenNoCache() {
      ...
      const tokens = {
        access_token: (await gtoken.getToken({ forceRefresh: this.isTokenExpiring() }))
          .access_token,
        token_type: "Bearer",
  ...
  exports.UserRefreshClient = class UserRefreshClient extends oauth2client_1.OAuth2Client {
    ...
    async fromStreamAsync(inputStream) {
      return new Promise((resolve, reject) => {
        if (!inputStream)
          return reject(
            /* @__PURE__ */ new Error("Must pass in a stream containing the user refresh token."),
          );
        let s = "";
        inputStream
          .setEncoding("utf8")
...
var require_baseexternalclient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.BaseExternalAccountClient = class BaseExternalAccountClient extends (
    ...
    constructor(options) {
      ...
      this.tokenUrl =
        opts.get("token_url") ?? DEFAULT_TOKEN_URL.replace("{universeDomain}", this.universeDomain);
  ...
  var UrlSubjectTokenSupplier = class {
    ...
    async getSubjectToken(context) {
      ...
      if (this.formatType === "text") subjectToken = (await context.transporter.request(opts)).data;
        ...
        subjectToken = (await context.transporter.request(opts)).data[this.subjectTokenFieldName];
      if (!subjectToken)
  ...
  var CertificateSubjectTokenSupplier = class {
    ...
    async #getKeyAndCert(certPath, keyPath) {
      ...
      try {
        ...
        throw new CertificateSourceUnavailableError(
          `Failed to read certificate file at ${certPath}: ${err instanceof Error ? err.message : String(err)}`,
        );
      }
      try {
        ...
        throw new CertificateSourceUnavailableError(
          `Failed to read private key file at ${keyPath}: ${err instanceof Error ? err.message : String(err)}`,
        );
      }
      return {
        cert,
    ...
    async #processChainFromPaths(leafCertBuffer) {
      ...
      try {
        const chainCerts = (
          (await fs$2.promises.readFile(this.trustChainPath, "utf8")).match(
...
var require_identitypoolclient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const gaxios_1 = require_src$3();
  exports.IdentityPoolClient = class IdentityPoolClient extends (
...
var require_awsrequestsigner = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function getSigningKey(crypto, key, dateStamp, region, serviceName) {
    return await sign(
      ...
      await sign(
        crypto,
        await sign(crypto, await sign(crypto, `AWS4${key}`, dateStamp), region),
        serviceName,
      ),
      "aws4_request",
    );
...
var require_executable_response = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.InvalidSubjectTokenError =
    exports.InvalidMessageFieldError =
    exports.InvalidCodeFieldError =
    exports.InvalidTokenTypeFieldError =
    exports.InvalidExpirationTimeFieldError =
    exports.InvalidSuccessFieldError =
    exports.InvalidVersionFieldError =
    exports.ExecutableResponseError =
    exports.ExecutableResponse =
      void 0;
    ...
    async retrieveSubjectToken() {
      ...
      if (!executableResponse.success)
        throw new pluggable_auth_handler_1.ExecutableError(
          executableResponse.errorMessage,
          executableResponse.errorCode,
        );
      if (this.outputFile) {
...
var require_externalAccountAuthorizedUserClient = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ExternalAccountAuthorizedUserClient = exports.EXTERNAL_ACCOUNT_AUTHORIZED_USER_TYPE =
    void 0;
  const authclient_1 = require_authclient();
  const oauth2common_1 = require_oauth2common();
  const gaxios_1 = require_src$3();
   ...
   */
  var ExternalAccountAuthorizedUserHandler = class ExternalAccountAuthorizedUserHandler
    extends oauth2common_1.OAuthClientAuthHandler
  {
...
var require_googleauth = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var GoogleAuth = class {
    ...
    async sign(data, endpoint) {
      ...
      if (client instanceof impersonated_1.Impersonated)
        return (await client.sign(data)).signedBlob;
      const crypto = (0, crypto_1.createCrypto)();
      if (client instanceof jwtclient_1.JWT && client.key)
        return await crypto.sign(client.key, data);
...
var require_downscopedclient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var DownscopedClient = class extends authclient_1.AuthClient {
    ...
    constructor(
      options,
      credentialAccessBoundary = { accessBoundary: { accessBoundaryRules: [] } },
    ) {
