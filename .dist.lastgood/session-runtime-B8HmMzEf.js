import {
  n as resolvePluginCapabilityProvider,
  r as resolvePluginCapabilityProviders,
} from "./capability-provider-runtime-BYdI2qTA.js";
...
import {
  n as normalizeCapabilityProviderId,
  t as buildCapabilityProviderMaps,
} from "./provider-registry-shared-LJEauKX2.js";
...
function createTalkDiagnosticEvent(event) {
  ...
  return {
    ...
    final: event.final,
    durationMs: firstFiniteNumber$1(payload, ["durationMs", "latencyMs", "elapsedMs"]),
...
const REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES = ["safe-read-only", "owner", "none"];
...
//#endregion
export {
  REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as A,
  createTalkLogRecord as C,
  TALK_EVENT_TYPES as D,
  recordTalkDiagnosticEvent as E,
  createTalkEventSequencer as O,
  recordTalkObservabilityEvent as S,
  createTalkDiagnosticEvent as T,
  resolveRealtimeVoiceAgentConsultToolPolicy as _,
  listRealtimeVoiceProviders as a,
  createTalkSessionController as b,
  REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME as c,
  buildRealtimeVoiceAgentConsultPolicyInstructions as d,
  buildRealtimeVoiceAgentConsultPrompt as f,
  parseRealtimeVoiceAgentConsultArgs as g,
  isRealtimeVoiceAgentConsultToolPolicy as h,
  getRealtimeVoiceProvider as i,
  REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as k,
  REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES as l,
  collectRealtimeVoiceAgentConsultVisibleText as m,
  resolveConfiguredRealtimeVoiceProvider as n,
  normalizeRealtimeVoiceProviderId as o,
  buildRealtimeVoiceAgentConsultWorkingResponse as p,
  canonicalizeRealtimeVoiceProviderId as r,
  REALTIME_VOICE_AGENT_CONSULT_TOOL as s,
  createRealtimeVoiceBridgeSession as t,
  buildRealtimeVoiceAgentConsultChatMessage as u,
  resolveRealtimeVoiceAgentConsultTools as v,
  recordTalkLogEvent as w,
  normalizeTalkTransport as x,
  resolveRealtimeVoiceAgentConsultToolsAllow as y,
};
