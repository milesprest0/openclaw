...
import { n as asObject } from "./provider-http-errors-Gz46brs9.js";
import { c as normalizeOptionalString } from "./string-coerce-BdEutqX5.js";
import {
  c as inferAzureSpeechFileExtension,
  d as normalizeAzureSpeechBaseUrl,
  l as isAzureSpeechVoiceCompatible,
  o as azureSpeechTTS,
  r as DEFAULT_AZURE_SPEECH_TELEPHONY_FORMAT,
  u as listAzureSpeechVoices,
} from "./tts-C08Sn5lV.js";
import "./secret-input-Bz1bMixv.js";
import "./speech-core-CbUuq71T.js";
...
function normalizeAzureSpeechProviderConfig(rawConfig) {
  ...
  return {
    ...
    voiceNoteOutputFormat:
      normalizeOptionalString(raw?.voiceNoteOutputFormat) ?? "ogg-24khz-16bit-mono-opus",
...
function readAzureSpeechProviderConfig(config) {
  ...
  return {
    ...
    voiceNoteOutputFormat:
      normalizeOptionalString(config.voiceNoteOutputFormat) ?? defaults.voiceNoteOutputFormat,
  ...
  return {
    ...
    resolveTalkConfig: ({ baseTtsConfig, talkProviderConfig }) => {
      ...
      const endpoint = normalizeOptionalString(
        talkProviderConfig.endpoint ?? talkProviderConfig.baseUrl,
      );
      const baseUrl = normalizeAzureSpeechBaseUrl({
    ...
    resolveTalkOverrides: ({ params }) => ({
      ...
      ...(normalizeOptionalString(params.languageCode) == null
        ? {}
        : { lang: normalizeOptionalString(params.languageCode) }),
