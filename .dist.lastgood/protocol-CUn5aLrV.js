...
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-OI5EnRxZ.js";
import { r as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DS5L8BzN.js";
import {
  i as SINGLE_VALUE_FILE_REF_ID,
  n as FILE_SECRET_REF_ID_INVALID_ESCAPE_JSON_SCHEMA_PATTERN,
  r as SECRET_PROVIDER_ALIAS_PATTERN,
  t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN,
} from "./ref-contract-PE7UucMZ.js";
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-CaNC1eIn.js";
...
const AgentsFilesListParamsSchema = Type.Object(
  { agentId: NonEmptyString },
  { additionalProperties: false },
);
...
const SkillsStatusParamsSchema = Type.Object(
  { agentId: Type.Optional(NonEmptyString) },
  { additionalProperties: false },
);
const SkillsBinsParamsSchema = Type.Object({}, { additionalProperties: false });
const SkillsBinsResultSchema = Type.Object(
...
const SkillsSearchResultSchema = Type.Object(
  {
    results: Type.Array(
      Type.Object(
        {
...
const SkillsDetailParamsSchema = Type.Object(
  { slug: NonEmptyString },
  { additionalProperties: false },
);
...
const ArtifactQueryParamsSchema = Type.Object(ArtifactQueryParamsProperties, {
  additionalProperties: false,
});
...
const TalkConfigParamsSchema = Type.Object(
...
const TalkSessionCloseParamsSchema = Type.Object(
  { sessionId: NonEmptyString },
  { additionalProperties: false },
);
...
const TalkSessionOkResultSchema = Type.Object(
  { ok: Type.Boolean() },
  { additionalProperties: false },
);
...
const TalkConfigResultSchema = Type.Object(
  {
    config: Type.Object(
      {
        talk: Type.Optional(TalkConfigSchema),
        session: Type.Optional(
          Type.Object({ mainKey: Type.Optional(Type.String()) }, { additionalProperties: false }),
        ),
        ui: Type.Optional(
          Type.Object({ seamColor: Type.Optional(Type.String()) }, { additionalProperties: false }),
        ),
      },
      { additionalProperties: false },
    ),
...
const CommandsListResultSchema = Type.Object(
...
const ConfigSchemaLookupParamsSchema = Type.Object(
...
const EnvironmentsListResultSchema = Type.Object(
  { environments: Type.Array(EnvironmentSummarySchema) },
  { additionalProperties: false },
);
const EnvironmentsStatusParamsSchema = Type.Object(
...
const ExecApprovalsDefaultsSchema = Type.Object(ExecApprovalsPolicyFields, {
  additionalProperties: false,
});
...
const ExecApprovalsNodeGetParamsSchema = Type.Object(
...
const ExecApprovalGetParamsSchema = Type.Object(
  { id: NonEmptyString },
  { additionalProperties: false },
);
...
const DevicePairApproveParamsSchema = Type.Object(
  { requestId: NonEmptyString },
  { additionalProperties: false },
);
const DevicePairRejectParamsSchema = Type.Object(
  { requestId: NonEmptyString },
  { additionalProperties: false },
);
const DevicePairRemoveParamsSchema = Type.Object(
...
const NodePairApproveParamsSchema = Type.Object(
  { requestId: NonEmptyString },
  { additionalProperties: false },
);
const NodePairRejectParamsSchema = Type.Object(
  { requestId: NonEmptyString },
  { additionalProperties: false },
);
const NodePairRemoveParamsSchema = Type.Object(
  { nodeId: NonEmptyString },
  { additionalProperties: false },
);
...
const NodePendingAckParamsSchema = Type.Object(
  { ids: Type.Array(NonEmptyString, { minItems: 1 }) },
  { additionalProperties: false },
);
const NodeDescribeParamsSchema = Type.Object(
  { nodeId: NonEmptyString },
  { additionalProperties: false },
);
...
const NodePendingDrainParamsSchema = Type.Object(
  {
...
const WebPushUnsubscribeParamsSchema = Type.Object(
  {
    endpoint: Type.String({
      minLength: 1,
      maxLength: 2048,
...
const validateSessionsMessagesUnsubscribeParams = ajv.compile(
...
const validateTalkSessionSubmitToolResultParams = ajv.compile(
...
function formatValidationErrors(errors) {
  ...
  if (!unique.length)
    return ajv.errorsText(errors, { separator: "; " }) || "unknown validation error";
  return unique.join("; ");
}
//#endregion
export {
  validateExecApprovalsNodeGetParams as $,
  parseSessionLabel as $a,
  TalkSessionCancelOutputParamsSchema as $i,
  SessionsAbortParamsSchema as $n,
  ShutdownEventSchema as $r,
  validateSkillsDetailParams as $t,
  validateConfigSchemaParams as A,
  AgentsListParamsSchema as Aa,
  ConfigSchemaParamsSchema as Ai,
  validateToolsInvokeParams as An,
  NodePairRemoveParamsSchema as Ar,
  validateSecretsResolveResult as At,
  validateDevicePairApproveParams as B,
  SkillsStatusParamsSchema as Ba,
  ChannelsStatusParamsSchema as Bi,
  validateWizardCancelParams as Bn,
  ChatEventSchema as Br,
  validateSessionsDeleteParams as Bt,
  validateChatSendParams as C,
  AgentsFileEntrySchema as Ca,
  CronStatusParamsSchema as Ci,
  validateTalkSessionSubmitToolResultParams as Cn,
  PluginsUiDescriptorsParamsSchema as Cr,
  validatePluginApprovalResolveParams as Ct,
  validateConfigPatchParams as D,
  AgentsFilesListResultSchema as Da,
  ConfigPatchParamsSchema as Di,
  validateTalkSpeakResult as Dn,
  NodePairApproveParamsSchema as Dr,
  validateRequestFrame as Dt,
  validateConfigGetParams as E,
  AgentsFilesListParamsSchema as Ea,
  ConfigGetParamsSchema as Ei,
  validateTalkSpeakParams as En,
  NodeListParamsSchema as Er,
  validatePushTestParams as Et,
  validateCronRemoveParams as F,
  SkillsDetailParamsSchema as Fa,
  COMMAND_DESCRIPTION_MAX_LENGTH as Fi,
  validateWebLoginWaitParams as Fn,
  NodePendingDrainResultSchema as Fr,
  validateSessionsCompactionBranchParams as Ft,
  validateDeviceTokenRotateParams as G,
  AgentEventSchema as Ga,
  TalkClientCreateParamsSchema as Gi,
  WizardCancelParamsSchema as Gn,
  LogsTailResultSchema as Gr,
  validateSessionsPatchParams as Gt,
  validateDevicePairRejectParams as H,
  ToolsCatalogParamsSchema as Ha,
  ChannelsStopParamsSchema as Hi,
  validateWizardStartParams as Hn,
  ChatInjectParamsSchema as Hr,
  validateSessionsListParams as Ht,
  validateCronRunParams as I,
  SkillsDetailResultSchema as Ia,
  CommandsListParamsSchema as Ii,
  validateWebPushSubscribeParams as In,
  NodePendingEnqueueParamsSchema as Ir,
  validateSessionsCompactionGetParams as It,
  validateEventFrame as J,
  AgentParamsSchema as Ja,
  TalkClientToolCallResultSchema as Ji,
  WizardStartParamsSchema as Jn,
  EventFrameSchema as Jr,
  validateSessionsResetParams as Jt,
  validateEnvironmentsListParams as K,
  AgentIdentityParamsSchema as Ka,
  TalkClientCreateResultSchema as Ki,
  WizardNextParamsSchema as Kn,
  ConnectParamsSchema as Kr,
  validateSessionsPluginPatchParams as Kt,
  validateCronRunsParams as L,
  SkillsInstallParamsSchema as La,
  CommandsListResultSchema as Li,
  validateWebPushTestParams as Ln,
  NodePendingEnqueueResultSchema as Lr,
  validateSessionsCompactionListParams as Lt,
  validateConnectParams as M,
  AgentsUpdateParamsSchema as Ma,
  ConfigSetParamsSchema as Mi,
  validateUpdateStatusParams as Mn,
  NodePairVerifyParamsSchema as Mr,
  validateSessionsAbortParams as Mt,
  validateCronAddParams as N,
  AgentsUpdateResultSchema as Na,
  UpdateRunParamsSchema as Ni,
  validateWakeParams as Nn,
  NodePendingAckParamsSchema as Nr,
  validateSessionsCleanupParams as Nt,
  validateConfigSchemaLookupParams as O,
  AgentsFilesSetParamsSchema as Oa,
  ConfigSchemaLookupParamsSchema as Oi,
  validateToolsCatalogParams as On,
  NodePairListParamsSchema as Or,
  validateResponseFrame as Ot,
  validateCronListParams as P,
  ModelsListParamsSchema as Pa,
  UpdateStatusParamsSchema as Pi,
  validateWebLoginStartParams as Pn,
  NodePendingDrainParamsSchema as Pr,
  validateSessionsCompactParams as Pt,
  validateExecApprovalsGetParams as Q,
  WakeParamsSchema as Qa,
  TalkSessionAppendAudioParamsSchema as Qi,
  WizardStepSchema as Qn,
  ResponseFrameSchema as Qr,
  validateSkillsBinsParams as Qt,
  validateCronStatusParams as R,
  SkillsSearchParamsSchema as Ra,
  ChannelsLogoutParamsSchema as Ri,
  validateWebPushUnsubscribeParams as Rn,
  NodePresenceAlivePayloadSchema as Rr,
  validateSessionsCompactionRestoreParams as Rt,
  validateChatInjectParams as S,
  AgentsDeleteResultSchema as Sa,
  CronRunsParamsSchema as Si,
  validateTalkSessionOkResult as Sn,
  WebPushVapidPublicKeyParamsSchema as Sr,
  validatePluginApprovalRequestParams as St,
  validateConfigApplyParams as T,
  AgentsFilesGetResultSchema as Ta,
  ConfigApplyParamsSchema as Ti,
  validateTalkSessionTurnResult as Tn,
  NodeInvokeParamsSchema as Tr,
  validatePollParams as Tt,
  validateDevicePairRemoveParams as U,
  ToolsEffectiveParamsSchema as Ua,
  TalkCatalogParamsSchema as Ui,
  validateWizardStatusParams as Un,
  ChatSendParamsSchema as Ur,
  validateSessionsMessagesSubscribeParams as Ut,
  validateDevicePairListParams as V,
  SkillsUpdateParamsSchema as Va,
  ChannelsStatusResultSchema as Vi,
  validateWizardNextParams as Vn,
  ChatHistoryParamsSchema as Vr,
  validateSessionsDescribeParams as Vt,
  validateDeviceTokenRevokeParams as W,
  ToolsInvokeParamsSchema as Wa,
  TalkCatalogResultSchema as Wi,
  ProtocolSchemas as Wn,
  LogsTailParamsSchema as Wr,
  validateSessionsMessagesUnsubscribeParams as Wt,
  validateExecApprovalRequestParams as X,
  PollParamsSchema as Xa,
  TalkConfigResultSchema as Xi,
  WizardStatusParamsSchema as Xn,
  HelloOkSchema as Xr,
  validateSessionsSendParams as Xt,
  validateExecApprovalGetParams as Y,
  MessageActionParamsSchema as Ya,
  TalkConfigParamsSchema as Yi,
  WizardStartResultSchema as Yn,
  GatewayFrameSchema as Yr,
  validateSessionsResolveParams as Yt,
  validateExecApprovalResolveParams as Z,
  SendParamsSchema as Za,
  TalkEventSchema as Zi,
  WizardStatusResultSchema as Zn,
  RequestFrameSchema as Zr,
  validateSessionsUsageParams as Zt,
  validateChannelsStatusParams as _,
  ArtifactsListParamsSchema as _a,
  CronAddParamsSchema as _i,
  validateTalkSessionCloseParams as _n,
  PushTestParamsSchema as _r,
  validateNodePendingAckParams as _t,
  validateAgentsCreateParams as a,
  TalkSessionJoinResultSchema as aa,
  ExecApprovalRequestParamsSchema as ai,
  validateTalkCatalogResult as an,
  SessionsCompactionRestoreParamsSchema as ar,
  validateNodeDescribeParams as at,
  validateChatEvent as b,
  AgentsCreateResultSchema as ba,
  CronRemoveParamsSchema as bi,
  validateTalkSessionJoinParams as bn,
  WebPushTestParamsSchema as br,
  validateNodePresenceAlivePayload as bt,
  validateAgentsFilesListParams as c,
  TalkSessionTurnParamsSchema as ca,
  ExecApprovalsSetParamsSchema as ci,
  validateTalkClientToolCallParams as cn,
  SessionsDescribeParamsSchema as cr,
  validateNodeInvokeParams as ct,
  validateAgentsUpdateParams as d,
  TalkSpeakResultSchema as da,
  EnvironmentsListParamsSchema as di,
  validateTalkConfigResult as dn,
  SessionsPluginPatchParamsSchema as dr,
  validateNodePairApproveParams as dt,
  TalkSessionCancelTurnParamsSchema as ea,
  TickEventSchema as ei,
  validateSkillsInstallParams as en,
  SessionsCleanupParamsSchema as er,
  validateExecApprovalsNodeSetParams as et,
  validateArtifactsDownloadParams as f,
  WebLoginStartParamsSchema as fa,
  EnvironmentsListResultSchema as fi,
  validateTalkEvent as fn,
  SessionsPreviewParamsSchema as fr,
  validateNodePairListParams as ft,
  validateChannelsStartParams as g,
  ArtifactsGetParamsSchema as ga,
  errorShape as gi,
  validateTalkSessionCancelTurnParams as gn,
  SessionsUsageParamsSchema as gr,
  validateNodePairVerifyParams as gt,
  validateChannelsLogoutParams as h,
  ArtifactsDownloadParamsSchema as ha,
  ErrorCodes as hi,
  validateTalkSessionCancelOutputParams as hn,
  SessionsSendParamsSchema as hr,
  validateNodePairRequestParams as ht,
  validateAgentWaitParams as i,
  TalkSessionJoinParamsSchema as ia,
  ExecApprovalGetParamsSchema as ii,
  validateTalkCatalogParams as in,
  SessionsCompactionListParamsSchema as ir,
  validateModelsListParams as it,
  validateConfigSetParams as j,
  AgentsListResultSchema as ja,
  ConfigSchemaResponseSchema as ji,
  validateUpdateRunParams as jn,
  NodePairRequestParamsSchema as jr,
  validateSendParams as jt,
  validateConfigSchemaLookupResult as k,
  AgentsFilesSetResultSchema as ka,
  ConfigSchemaLookupResultSchema as ki,
  validateToolsEffectiveParams as kn,
  NodePairRejectParamsSchema as kr,
  validateSecretsResolveParams as kt,
  validateAgentsFilesSetParams as l,
  TalkSessionTurnResultSchema as la,
  EnvironmentStatusSchema as li,
  validateTalkClientToolCallResult as ln,
  SessionsListParamsSchema as lr,
  validateNodeInvokeResultParams as lt,
  validateArtifactsListParams as m,
  ArtifactSummarySchema as ma,
  EnvironmentsStatusResultSchema as mi,
  validateTalkSessionAppendAudioParams as mn,
  SessionsResolveParamsSchema as mr,
  validateNodePairRemoveParams as mt,
  validateAgentIdentityParams as n,
  TalkSessionCreateParamsSchema as na,
  SnapshotSchema as ni,
  validateSkillsStatusParams as nn,
  SessionsCompactionBranchParamsSchema as nr,
  validateLogsTailParams as nt,
  validateAgentsDeleteParams as o,
  TalkSessionOkResultSchema as oa,
  ExecApprovalResolveParamsSchema as oi,
  validateTalkClientCreateParams as on,
  SessionsCreateParamsSchema as or,
  validateNodeEventParams as ot,
  validateArtifactsGetParams as p,
  WebLoginWaitParamsSchema as pa,
  EnvironmentsStatusParamsSchema as pi,
  validateTalkModeParams as pn,
  SessionsResetParamsSchema as pr,
  validateNodePairRejectParams as pt,
  validateEnvironmentsStatusParams as q,
  AgentIdentityResultSchema as qa,
  TalkClientToolCallParamsSchema as qi,
  WizardNextResultSchema as qn,
  ErrorShapeSchema as qr,
  validateSessionsPreviewParams as qt,
  validateAgentParams as r,
  TalkSessionCreateResultSchema as ra,
  StateVersionSchema as ri,
  validateSkillsUpdateParams as rn,
  SessionsCompactionGetParamsSchema as rr,
  validateMessageActionParams as rt,
  validateAgentsFilesGetParams as s,
  TalkSessionSubmitToolResultParamsSchema as sa,
  ExecApprovalsGetParamsSchema as si,
  validateTalkClientCreateResult as sn,
  SessionsDeleteParamsSchema as sr,
  validateNodeEventResult as st,
  formatValidationErrors as t,
  TalkSessionCloseParamsSchema as ta,
  PresenceEntrySchema as ti,
  validateSkillsSearchParams as tn,
  SessionsCompactParamsSchema as tr,
  validateExecApprovalsSetParams as tt,
  validateAgentsListParams as u,
  TalkSpeakParamsSchema as ua,
  EnvironmentSummarySchema as ui,
  validateTalkConfigParams as un,
  SessionsPatchParamsSchema as ur,
  validateNodeListParams as ut,
  validateChannelsStopParams as v,
  AgentSummarySchema as va,
  CronJobSchema as vi,
  validateTalkSessionCreateParams as vn,
  PushTestResultSchema as vr,
  validateNodePendingDrainParams as vt,
  validateCommandsListParams as w,
  AgentsFilesGetParamsSchema as wa,
  CronUpdateParamsSchema as wi,
  validateTalkSessionTurnParams as wn,
  NodeEventResultSchema as wr,
  validatePluginsUiDescriptorsParams as wt,
  validateChatHistoryParams as x,
  AgentsDeleteParamsSchema as xa,
  CronRunParamsSchema as xi,
  validateTalkSessionJoinResult as xn,
  WebPushUnsubscribeParamsSchema as xr,
  validateNodeRenameParams as xt,
  validateChatAbortParams as y,
  AgentsCreateParamsSchema as ya,
  CronListParamsSchema as yi,
  validateTalkSessionCreateResult as yn,
  WebPushSubscribeParamsSchema as yr,
  validateNodePendingEnqueueParams as yt,
  validateCronUpdateParams as z,
  SkillsSearchResultSchema as za,
  ChannelsStartParamsSchema as zi,
  validateWebPushVapidPublicKeyParams as zn,
  NodePresenceAliveReasonSchema as zr,
  validateSessionsCreateParams as zt,
};
