...
import { t as configureSqliteWalMaintenance } from "./sqlite-wal-uDekKp3n.js";
import { r as normalizeOptionalString } from "./string-utils-CQS7ux9I.js";
import "./internal-BUtLJk16.js";
import "./fs-utils-Bbrc6fw7.js";
import "./openclaw-runtime-io-C_pImxyL.js";
import "./read-file--JelGp9n.js";
import "./backend-config-CZCY9yBK.js";
...
function isMissingSqliteVecPackageError(err) {
  ...
  return (
    /Cannot find (?:package|module) ['"]sqlite-vec['"]/u.test(message) &&
    (code === void 0 || code === "ERR_MODULE_NOT_FOUND" || code === "MODULE_NOT_FOUND")
  );
}
...
//#endregion
export {
  ensureMemoryIndexSchema as a,
  loadSqliteVecExtension as i,
  configureMemorySqliteWalMaintenance as n,
  requireNodeSqlite as r,
  closeMemorySqliteWalMaintenance as t,
};
