...
const IrcGroupSchema = zod_exports.z
  .object({
  ...
  .strict();
const IrcNickServSchema = zod_exports.z
  .object({
    enabled: zod_exports.z.boolean().optional(),
...
const IrcAccountSchemaBase = zod_exports.z
  .object({
...
const IrcChannelConfigSchema = buildChannelConfigSchema(
