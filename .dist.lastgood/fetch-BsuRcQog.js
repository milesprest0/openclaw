...
import { i as resolveEffectiveDebugProxyUrl } from "./env-C2C0rw4L.js";
...
import { t as captureHttpExchange } from "./runtime-CIhJIx2w.js";
...
function resolveTelegramTransport(proxyFetch, options) {
  ...
  const managedProxyUrl =
    !effectiveProxyFetch && !hasEnvProxy ? resolveOpenClawProxyUrlForTelegram() : void 0;
  ...
  return {
    ...
    forceFallback: (reason) =>
      promoteStickyAttempt(
        stickyAttemptIndex + 1,
        /* @__PURE__ */ new Error("forced fallback"),
        reason,
      ),
    close,
  };
...
//#endregion
export {
  hasTelegramBotEndpointApiRoot as a,
  shouldRetryTelegramTransportFallback as i,
  resolveTelegramFetch as n,
  normalizeTelegramApiRoot as o,
  resolveTelegramTransport as r,
  resolveTelegramApiBase as t,
};
