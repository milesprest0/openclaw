...
import { i as isSupportedMatrixAvatarSource } from "./profile-RNqhXUQX.js";
import "./routing-BccEMOrJ.js";
import { t as applyAccountNameToChannelSection } from "./setup-helpers-BWYI0iQf.js";
import "./setup-9P7OQJwo.js";
import "./string-coerce-runtime-Xx8DhtgQ.js";
import {
  t as addWildcardAllowFrom,
  y as normalizeAllowFromEntries,
...
function resolveSingleAccountPromotionTarget(params) {
  ...
  if (namedAccounts.length > 1 && accounts["default"] && typeof accounts["default"] === "object")
...
function moveSingleMatrixAccountConfigToNamedAccount(cfg) {
  ...
  const resolvedTargetAccountId = resolveExistingMatrixAccountKey(
    accounts,
    resolveSingleAccountPromotionTarget({ channel: base }),
  );
...
//#endregion
export {
  namedAccountPromotionKeys as a,
  validateMatrixSetupInput as i,
  applyMatrixSetupAccountConfig as n,
  resolveSingleAccountPromotionTarget as o,
  moveSingleMatrixAccountConfigToNamedAccount as r,
  singleAccountKeysToMove as s,
  resolveMatrixSetupDmAllowFrom as t,
};
