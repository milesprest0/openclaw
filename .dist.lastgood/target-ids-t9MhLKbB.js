...
function normalizeMatrixMessagingTarget(raw) {
  return (
    stripKnownPrefixes(raw, [MATRIX_PREFIX, ROOM_PREFIX, CHANNEL_PREFIX, USER_PREFIX]) || void 0
  );
}
...
//#endregion
export {
  resolveMatrixTargetIdentity as a,
  resolveMatrixDirectUserId as i,
  normalizeMatrixMessagingTarget as n,
  normalizeMatrixResolvableTarget as r,
  isMatrixQualifiedUserId as t,
};
