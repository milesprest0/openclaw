...
function sanitizePerCallCacheUsage(params) {
  ...
  if (typeof promptTokens !== "number") return usage;
  if (cacheRead <= promptTokens) return usage;
  params.onDroppedCacheRead?.({
    cacheRead,
    promptTokens,
  });
  return {
...
//#endregion
export {
  makeZeroUsageSnapshot as a,
  sanitizePerCallCacheUsage as c,
  hasNonzeroUsage as i,
  toOpenAiChatCompletionsUsage as l,
  derivePromptTokens as n,
  normalizeUsage as o,
  deriveSessionTotalTokens as r,
  providerFamily as s,
  deriveContextPromptTokens as t,
};
