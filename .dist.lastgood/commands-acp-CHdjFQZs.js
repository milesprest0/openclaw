import { a as requireGatewayClientScopeForInternalChannel } from "./command-gates-Dc5hvS1H.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import {
  C as stopWithText,
  b as resolveAcpAction,
  d as COMMAND,
  x as resolveAcpHelpText,
} from "./shared-Xrh9BDj6.js";
//#region src/auto-reply/reply/commands-acp.ts
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-DuWmoaMM.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(
  () => import("./runtime-options-yqqxjZDu.js"),
);
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-soCGuhOG.js"));
...
const handleAcpCommand = async (params, _allowTextCommands) => {
  ...
  return await (
    await loadAcpActionHandler(action)
  )(params, tokens);
};
//#endregion
