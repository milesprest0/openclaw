...
import {
  O as DEFAULT_BROWSER_ACTION_TIMEOUT_MS,
  f as redactCdpUrl,
} from "./cdp.helpers-DnNpBUOj.js";
import { n as resolveBrowserConfig } from "./config-DhdywqBF.js";
...
import "./server-middleware-kETVHJXc.js";
import "./bridge-server-DFsurMfO.js";
import { n as detectMime } from "./mime-CSQ-Gv-M.js";
import { n as createBrowserControlContext } from "./plugin-enabled-C9LPRxsq.js";
import "./control-auth-B3jZZmk_.js";
import "./chrome.executables-BinpIko4.js";
import "./sdk-setup-tools-BVFP1IkU.js";
import { t as withTimeout } from "./sdk-node-runtime-Bn5PQapP.js";
import "./trash-Te3iBU3K.js";
import { r as loadBrowserConfigForRuntimeRefresh } from "./server-context-Il7jEHOv.js";
import "./pw-role-snapshot-DkK4EEVr.js";
import "./routes-D36s7FLv.js";
import {
  S as withBaseUrl,
  b as fetchBrowserJson,
  x as buildProfileQuery,
...
async function browserNavigate(baseUrl, opts) {
  return await fetchBrowserJson(
    withBaseUrl(baseUrl, `/navigate${buildProfileQuery(opts.profile)}`),
    {
      method: "POST",
...
async function browserArmDialog(baseUrl, opts) {
  return await fetchBrowserJson(
    withBaseUrl(baseUrl, `/hooks/dialog${buildProfileQuery(opts.profile)}`),
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
...
async function browserArmFileChooser(baseUrl, opts) {
  return await fetchBrowserJson(
    withBaseUrl(baseUrl, `/hooks/file-chooser${buildProfileQuery(opts.profile)}`),
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
...
function resolveRequestedBrowserProfile(params) {
  ...
  if (params.body && typeof params.body === "object") {
    const bodyProfile =
      "profile" in params.body ? normalizeOptionalString(params.body.profile) : void 0;
...
//#endregion
export {
  normalizeBrowserRequestPath as a,
  browserPdfSave as c,
  browserArmFileChooser as d,
  browserNavigate as f,
  isPersistentBrowserProfileMutation as i,
  browserAct as l,
  persistBrowserProxyFiles as n,
  resolveRequestedBrowserProfile as o,
  browserScreenshotAction as p,
  runBrowserProxyCommand as r,
  browserConsoleMessages as s,
  applyBrowserProxyPaths as t,
  browserArmDialog as u,
};
