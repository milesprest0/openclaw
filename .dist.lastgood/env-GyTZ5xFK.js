...
async function getLog() {
  if (!log) {
    logPromise ??= import("./subsystem-Bdga9sSu.js").then(({ createSubsystemLogger }) =>
...
//#endregion
export {
  normalizeZaiEnv as a,
  normalizeEnv as i,
  isVitestRuntimeEnv as n,
  logAcceptedEnvOption as r,
  isTruthyEnvValue as t,
};
