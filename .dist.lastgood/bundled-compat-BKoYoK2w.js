...
import { n as hasExplicitPluginConfig } from "./manifest-registry-DJ43wWua.js";
...
function withBundledPluginVitestCompat(params) {
  ...
  const entries = Object.fromEntries(
    params.pluginIds.map((pluginId) => [pluginId, { enabled: true }]),
  );
  return {
    ...params.config,
    plugins: {
...
//#endregion
export {
  withBundledPluginEnablementCompat as n,
  withBundledPluginVitestCompat as r,
  withBundledPluginAllowlistCompat as t,
};
