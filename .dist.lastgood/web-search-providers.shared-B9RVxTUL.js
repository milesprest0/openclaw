import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-lkE-qLhi.js";
...
function pluginManifestDeclaresProviderConfig(record, configKey, contract) {
  ...
  if (
    Object.keys(record.configUiHints ?? {}).some(
      (key) => key === configKey || key.startsWith(`${configKey}.`),
    )
  )
    return true;
...
function resolveManifestDeclaredWebProviderCandidates(params) {
  ...
  if (params.origin || scopedPluginIds !== void 0)
    return {
      pluginIds: [],
      manifestRecords,
    };
...
//#endregion
export {
  sortWebFetchProviders as a,
  resolveManifestDeclaredWebProviderCandidatePluginIds as c,
  resolveBundledWebFetchResolutionConfig as i,
  resolveManifestDeclaredWebProviderCandidates as l,
  sortWebSearchProviders as n,
  sortWebFetchProvidersForAutoDetect as o,
  sortWebSearchProvidersForAutoDetect as r,
  mapRegistryProviders as s,
  resolveBundledWebSearchResolutionConfig as t,
};
