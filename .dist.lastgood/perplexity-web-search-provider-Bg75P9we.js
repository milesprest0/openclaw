...
function loadPerplexityWebSearchRuntime() {
  perplexityWebSearchRuntimePromise ??=
    import("./perplexity-web-search-provider.runtime-BgWXNT4f.js");
...
function createPerplexityToolDefinition(searchConfig, runtimeTransport) {
  const schemaTransport =
    runtimeTransport ?? (hasPerplexityLegacyOverride(searchConfig) ? "chat_completions" : void 0);
  return {
    description:
