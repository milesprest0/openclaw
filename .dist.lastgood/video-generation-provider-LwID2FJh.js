...
import { t as OPENROUTER_BASE_URL } from "./provider-catalog-CAgucFoU.js";
...
const SUPPORTED_DURATION_SECONDS = [4, 6, 8];
const SUPPORTED_RESOLUTIONS = ["720P", "1080P"];
function toDataUrl(asset) {
  if (asset.buffer)
    return `data:${normalizeOptionalString(asset.mimeType) ?? "image/png"};base64,${asset.buffer.toString("base64")}`;
