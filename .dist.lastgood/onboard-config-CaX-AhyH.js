import { r as setConfigValueAtPath } from "./config-paths-ChbcwAm6.js";
...
function applySkipBootstrapConfig(cfg) {
  ...
  setConfigValueAtPath(next, ["agents", "defaults", "skipBootstrap"], true);
  return next;
}
//#endregion
export {
  applySkipBootstrapConfig as i,
  ONBOARDING_DEFAULT_TOOLS_PROFILE as n,
  applyLocalSetupWorkspaceConfig as r,
  ONBOARDING_DEFAULT_DM_SCOPE as t,
};
