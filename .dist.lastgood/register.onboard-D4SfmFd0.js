import { n as formatAuthChoiceChoicesForCli } from "./auth-choice-options-BMB3SPh1.js";
import { n as runCommandWithRuntime } from "./cli-utils-Ce4lxCq8.js";
import { t as formatDocsLink } from "./links-CNfoPWBd.js";
import { t as setupWizardCommand } from "./onboard-BUVwVPZm.js";
import { t as CORE_ONBOARD_AUTH_FLAGS } from "./onboard-core-auth-flags-B0MMu2nX.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-D-oJr9Ew.js";
...
function resolveInstallDaemonFlag(command, opts) {
  ...
  const getOptionValueSource =
    "getOptionValueSource" in command ? command.getOptionValueSource : void 0;
...
function pickOnboardProviderAuthOptionValues(opts) {
  return Object.fromEntries(
    ONBOARD_AUTH_FLAGS.map((flag) => [flag.optionKey, opts[flag.optionKey]]),
  );
}
function registerOnboardCommand(program) {
  ...
  command.action(async (opts, commandRuntime) => {
    await runCommandWithRuntime(defaultRuntime, async () => {
      ...
      const gatewayPort =
        typeof opts.gatewayPort === "string" ? Number.parseInt(opts.gatewayPort, 10) : void 0;
      ...
      await setupWizardCommand(
        {
          ...
          customImageInput:
            opts.customTextInput === true ? false : opts.customImageInput === true ? true : void 0,
          gatewayPort:
            typeof gatewayPort === "number" && Number.isFinite(gatewayPort) ? gatewayPort : void 0,
