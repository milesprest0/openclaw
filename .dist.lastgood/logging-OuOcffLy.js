...
import {
  i as setMatrixConsoleLogging,
  n as LogService,
  t as ConsoleLogger,
} from "./logger-DwhV1i8m.js";
...
function setMatrixJsSdkRootLoggerLevel(level) {
  ...
  if (typeof previousLevel === "string" || typeof previousLevel === "number")
    logger$1.setLevel?.(previousLevel, false);
  logger$1.rebuild?.();
}
...
//#endregion
export {
  setMatrixSdkLogMode as i,
  ensureMatrixSdkLoggingConfigured as n,
  setMatrixSdkConsoleLogging as r,
  createMatrixJsSdkClientLogger as t,
};
