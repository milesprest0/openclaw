...
function resolveSourceReplyDeliveryMode(params) {
  ...
  if (chatType === "group" || chatType === "channel")
    ...
    mode =
      (params.cfg.messages?.visibleReplies ?? params.defaultVisibleReplies) === "message_tool"
        ? "message_tool_only"
        : "automatic";
...
//#endregion
export {
  resolveSourceReplyDeliveryMode as n,
  resolveSourceReplyVisibilityPolicy as r,
  isExplicitSourceReplyCommand as t,
};
