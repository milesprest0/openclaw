import { c as resolveAssistantEventPhase } from "./chat-message-content-BLockgKs.js";
import {
  n as isSuppressedControlReplyText,
  t as isSuppressedControlReplyLeadFragment,
} from "./control-reply-text-CEeS0DFU.js";
...
function projectLiveAssistantBufferedText(rawText, options) {
  ...
  const text = startsWithSilentToken(rawText, "NO_REPLY")
...
//#endregion
export {
  shouldSuppressAssistantEventForLiveChat as i,
  projectLiveAssistantBufferedText as n,
  resolveMergedAssistantText as r,
  normalizeLiveAssistantEventText as t,
};
