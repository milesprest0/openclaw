...
import {
  a as DEFAULT_VIDEO_GENERATION_TIMEOUT_MS,
  n as DASHSCOPE_WAN_VIDEO_MODELS,
  p as runDashscopeVideoGenerationTask,
  r as DEFAULT_DASHSCOPE_WAN_VIDEO_MODEL,
  t as DASHSCOPE_WAN_VIDEO_CAPABILITIES,
} from "./video-generation-Dt6TOble.js";
import "./models-npOf4c2S.js";
...
function resolveDashscopeAigcApiBaseUrl(baseUrl) {
  ...
  if (baseUrl.startsWith("https://dashscope.aliyuncs.com/compatible-mode/v1"))
    return "https://dashscope.aliyuncs.com";
  if (baseUrl.startsWith("https://dashscope-intl.aliyuncs.com/compatible-mode/v1"))
    return DEFAULT_QWEN_VIDEO_BASE_URL;
