...
import { s as resolveStoredSessionOwnerAgentId } from "./combined-store-gateway-CtdiSumZ.js";
...
import { a as getLogger } from "./logger-BU4ooQvN.js";
...
import {
  h as resolveSessionArtifactCanonicalPathsForEntry,
  m as pruneUnreferencedSessionArtifacts,
  p as enforceSessionDiskBudget,
...
import {
  ...
  d as parseSessionThreadInfo,
  h as cloneSessionStoreRecord,
  i as capEntryCount,
  r as resolveMaintenanceConfig,
  t as loadSessionStore,
} from "./store-load-BSFLPYqQ.js";
import { i as resolveSessionStoreTargets } from "./targets-CSZl-lN0.js";
  ...
  try {
    ...
    if (hasRoutableDeliveryContext(storedDeliveryContext))
      deliveryContext = {
        ...
        threadId:
          storedDeliveryContext.threadId != null ? String(storedDeliveryContext.threadId) : void 0,
      };
  } catch {}
  return {
    deliveryContext,
...
async function previewStoreCleanup(params) {
  ...
  for (const key of Object.keys(beforeBudgetStore))
    if (!Object.hasOwn(previewStore, key)) budgetEvictedKeys.add(key);
...
async function purgeAgentSessionStoreEntries(cfg, agentId) {
  try {
    ...
    await updateSessionStore(
      resolveStorePath(cfg.session?.store, { agentId: normalizedAgentId }),
      (store) => {
...
//#endregion
export {
  extractDeliveryInfo as a,
  resolveMainSessionKeyFromConfig as c,
  serializeSessionCleanupResult as i,
  resolveSessionCleanupAction as n,
  readSessionHeaderStartedAtMs as o,
  runSessionsCleanup as r,
  resolveSessionLifecycleTimestamps as s,
  purgeAgentSessionStoreEntries as t,
};
