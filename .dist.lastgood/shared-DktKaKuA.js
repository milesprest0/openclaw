...
import { a as resolveWhatsAppAccount, n as hasAnyWhatsAppAuth } from "./accounts-MM0YxrKm.js";
import {
...
import { t as WhatsAppChannelConfigSchema } from "./config-schema-D2KsBR2G.js";
import { c as getChatChannelMeta, r as createChannelPluginBase } from "./core-BCeD7oMO.js";
import { n as whatsappDoctor } from "./doctor-Cu-18EZj.js";
...
import { t as resolveLegacyGroupSessionKey } from "./group-session-contract-GDMMo231.js";
import { a as normalizeWhatsAppAllowFromEntries } from "./normalize-target-B5_fp7Jp.js";
...
import {
  n as deriveLegacySessionChatType,
  r as isLegacyGroupSessionKey,
  t as canonicalizeLegacySessionKey,
} from "./session-contract-DXH5S8Mt.js";
import { a as createDelegatedSetupWizardProxy } from "./setup-wizard-proxy-CABzD4QZ.js";
...
const WHATSAPP_GROUP_SCOPE_FIELDS = ["groupPolicy", "groupAllowFrom", "groups"];
...
function resolveWhatsAppGroupScopeBasePath(params) {
  ...
  const matchesAnyGroupScopeField = (config) =>
    WHATSAPP_GROUP_SCOPE_FIELDS.some((field) => config?.[field] !== void 0);
  if (matchesAnyGroupScopeField(accountConfig)) return `channels.whatsapp.accounts.${accountKey}`;
  if (accountId !== "default" && matchesAnyGroupScopeField(defaultAccountConfig))
...
async function loadWhatsAppChannelRuntime() {
  return await import("./channel.runtime-DHelmQ-Q.js");
}
async function loadWhatsAppSetupSurface() {
  return await import("./setup-surface-B8bfjimd.js");
}
...
//#endregion
export {
  resolveWhatsAppGroupToolPolicy as a,
  formatWhatsAppConfigAllowFromEntries as c,
  resolveWhatsAppGroupRequireMention as i,
  loadWhatsAppChannelRuntime as n,
  resolveWhatsAppGroupIntroHint as o,
  whatsappSetupWizardProxy as r,
  resolveWhatsAppMentionStripRegexes as s,
  createWhatsAppPluginBase as t,
};
