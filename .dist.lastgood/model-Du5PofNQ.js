...
import { f as isSecretRefHeaderValueMarker } from "./model-auth-markers-CtsHE1k1.js";
import { n as modelKey, r as normalizeStaticProviderModelId } from "./model-ref-shared-C2I7TGOl.js";
import {
  a as shouldUnconditionallySuppress,
  n as buildSuppressedBuiltInModelError,
  r as shouldSuppressBuiltInModel,
} from "./model-suppression-06c0Ggan.js";
...
import {
  ...
  t as attachModelProviderRequestTransport,
  u as sanitizeConfiguredModelProviderRequest,
} from "./provider-request-config-B-kAAqy2.js";
import {
  G as shouldPreferProviderRuntimeResolvedModel,
  H as runProviderDynamicModel,
  _ as normalizeProviderResolvedModelWithPlugin,
  a as applyProviderResolvedTransportWithPlugin,
  b as prepareProviderDynamicModel,
  i as applyProviderResolvedModelCompatWithPlugins,
  l as buildProviderUnknownModelHintWithPlugin,
  y as normalizeProviderTransportWithPlugin,
...
function createEmptyPiDiscoveryStores() {
  const authStorage =
    typeof AuthStorage.inMemory === "function" ? AuthStorage.inMemory({}) : AuthStorage.create();
  return {
    authStorage,
    modelRegistry:
...
function normalizeResolvedModel(params) {
  ...
  const fallbackTransportNormalized =
    runtimeHooks.applyProviderResolvedTransportWithPlugin?.({
      provider: params.provider,
      config: params.cfg,
      workspaceDir: params.workspaceDir,
      context: {
...
function applyConfiguredProviderOverrides(params) {
  ...
  if (
    ...
    !providerConfig.api &&
    providerConfig.contextWindow === void 0 &&
    providerConfig.contextTokens === void 0 &&
    providerConfig.maxTokens === void 0 &&
...
//#endregion
export {
  buildInlineProviderModels as i,
  resolveModelAsync as n,
  resolveModelWithRegistry as r,
  resolveModel as t,
};
