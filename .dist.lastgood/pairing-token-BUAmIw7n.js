...
function resolveScopeOutsideRequestedRoles(params) {
  for (const scope of params.requestedScopes)
    if (
      !params.requestedRoles.some((role) =>
        roleScopesAllow({
          role,
          requestedScopes: [scope],
          allowedScopes: [scope],
...
//#endregion
export {
  reconcilePendingPairingRequests as a,
  resolveScopeOutsideRequestedRoles as c,
  pruneExpiredPending as i,
  roleScopesAllow as l,
  verifyPairingToken as n,
  resolvePairingPaths as o,
  coercePairingStateRecord as r,
  resolveMissingRequestedScope as s,
