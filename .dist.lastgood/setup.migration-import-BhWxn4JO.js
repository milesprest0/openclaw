...
const MEANINGFUL_STATE_ENTRIES = ["credentials", "sessions", "agents"];
...
async function detectSetupMigrationSources(params) {
  const [
    ...
    import("./migration-provider-runtime-CpnGZLFX.js"),
    import("./context-DbtOyUUY.js"),
...
async function selectSetupMigrationProvider(params) {
  ...
  } = await import("./migration-provider-runtime-CpnGZLFX.js");
...
async function runSetupMigrationImport(params) {
  const [
    ...
    import("./onboard-config-Cr3laJNS.js"),
    import("./context-DbtOyUUY.js"),
    import("./apply-CGMvKDru.js"),
    import("./output-D6pDlhn0.js"),
    import("./paths-MZ-M2Qqm.js"),
    import("./onboard-helpers-BTj6NKFG.js"),
  ]);
...
//#endregion
export {
  inspectSetupMigrationFreshness as n,
  runSetupMigrationImport as r,
  detectSetupMigrationSources as t,
};
