...
import { i as normalizeConversationText } from "./session-binding-normalization-C5mpgnkR.js";
...
function resolveBindingChannel(ctx, commandChannel) {
  return normalizeLowercaseStringOrEmpty(
    normalizeConversationText(
      ctx.OriginatingChannel ?? commandChannel ?? ctx.Surface ?? ctx.Provider,
    ),
  );
}
function resolveBindingAccountId(params) {
  ...
  return (
    normalizeConversationText(params.ctx.AccountId) ||
...
//#endregion
export {
  resolveConversationBindingThreadIdFromMessage as a,
  resolveConversationBindingContextFromMessage as i,
  resolveConversationBindingChannelFromMessage as n,
  resolveConversationBindingContextFromAcpCommand as r,
  resolveConversationBindingAccountIdFromMessage as t,
};
