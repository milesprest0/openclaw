...
import { s as SlackConfigSchema } from "./zod-schema.providers-whatsapp-O9hejQx6.js";
import "./config-api-XcCUJ6lF.js";
//#endregion
//#region extensions/slack/src/config-schema.ts
const SlackChannelConfigSchema = buildChannelConfigSchema(SlackConfigSchema, {
  uiHints: {
    "": {
      label: "Slack",
