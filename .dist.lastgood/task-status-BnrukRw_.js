import { t as INTERNAL_RUNTIME_CONTEXT_BEGIN } from "./internal-runtime-context-DfXSY94W.js";
...
function stripInlineLeakedInternalContext(value) {
  ...
  if (
    beginIndex !== -1 &&
    (value.includes("<<<END_OPENCLAW_INTERNAL_CONTEXT>>>") ||
...
function sanitizeTaskStatusValue(value, errorContext) {
  if (typeof value === "string")
    return (
      sanitizeUserFacingText(stripInlineLeakedInternalContext(value), { errorContext })
        .replace(/\s+/g, " ")
        .trim() || void 0
    );
...
function formatTaskStatusDetail(task) {
  if (task.status === "running" || task.status === "queued")
    return sanitizeTaskStatusText(task.progressSummary, { maxChars: 120 }) || void 0;
...
//#endregion
export {
  sanitizeTaskStatusText as a,
  formatTaskStatusTitleText as i,
  formatTaskStatusDetail as n,
  formatTaskStatusTitle as r,
  buildTaskStatusSnapshot as t,
};
