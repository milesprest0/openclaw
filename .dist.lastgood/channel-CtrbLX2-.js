...
import { a as resolveMatrixAccountConfig } from "./account-config-dncftWpr.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CNo6bQGN.js";
import {
  i as resolveMatrixAccount,
  r as resolveDefaultMatrixAccountId,
  t as listMatrixAccountIds,
} from "./accounts-Fm6UOeFA.js";
import { n as normalizeMatrixUserId } from "./allowlist-BMsQK3S3.js";
import {
...
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-CEmfb1ag.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-D474cv7x.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-CRA21CgU.js";
import {
...
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-Do1b_D-M.js";
...
import {
  n as matrixConfigAdapter,
  t as MatrixChannelConfigSchema,
} from "./config-schema-CIwwUpm4.js";
import "./approval-delivery-runtime-DFh6q7-3.js";
import {
...
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-3wMHaUCs.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-B764p6cP.js";
import "./approval-native-runtime-ChXPlXf7.js";
import "./outbound-runtime-DIb149kM.js";
import "./conversation-runtime-CDBIORy7.js";
import {
  n as normalizeCompatibilityConfig,
  t as legacyConfigRules,
} from "./doctor-contract-B8fV7jGZ.js";
import { t as formatMatrixErrorMessage } from "./errors-DQ-r4gaL.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-D1FPh_og.js";
import "./channel-status-BLgpG3VN.js";
import "./channel-actions-Ds3BuQCc.js";
import {
  a as isMatrixExecApprovalAuthorizedSender,
  c as shouldHandleMatrixApprovalRequest,
  d as matrixApprovalAuth,
  i as isMatrixApprovalClientEnabled,
  l as shouldSuppressLocalMatrixExecApprovalPrompt,
  n as getMatrixExecApprovalApprovers,
  o as isMatrixExecApprovalClientEnabled,
  r as isMatrixAnyApprovalClientEnabled,
  s as resolveMatrixExecApprovalTarget,
  t as getMatrixApprovalApprovers,
  u as getMatrixApprovalAuthApprovers,
} from "./exec-approvals-C80-iSgC.js";
...
import {
  i as autoPrepareLegacyMatrixCrypto,
  o as autoMigrateLegacyMatrixState,
  r as resolveMatrixMigrationStatus,
} from "./matrix-migration.runtime.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-DgNd27o3.js";
...
} from "./secret-contract-hH4EwmSu.js";
import { c as parseThreadSessionSuffix } from "./session-key-utils-B3KPN8Ee.js";
import {
...
import {
  a as namedAccountPromotionKeys,
  o as resolveSingleAccountPromotionTarget,
  s as singleAccountKeysToMove,
} from "./setup-dm-policy-DRRR5zwB.js";
import {
...
import {
  a as resolveMatrixTargetIdentity,
  i as resolveMatrixDirectUserId,
  n as normalizeMatrixMessagingTarget,
  r as normalizeMatrixResolvableTarget,
} from "./target-ids-t9MhLKbB.js";
import { t as chunkTextForOutbound } from "./text-chunking--YCa2npP.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-CbISJWcK.js";
import {
...
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-COC41TkY.js";
...
const matrixMessageActions = {
  ...
  handleAction: async (ctx) => {
    ...
    const dispatch = async (actionParams) =>
    ...
    if (action === "pin" || action === "unpin" || action === "list-pins") {
      const messageId =
        action === "list-pins" ? void 0 : readStringParam(params, "messageId", { required: true });
      return await dispatch({
    ...
    if (action === "permissions") {
      ...
      if (!resolvedAction)
        throw new Error(
          `Unsupported Matrix permissions operation: ${operation}. Supported values: ${Object.keys(operationToAction).join(", ")}`,
        );
      return await dispatch({
        ...params,
...
function resolveSuppressionAccountId(params) {
  return (
    params.target.accountId?.trim() || params.request.request.turnSourceAccountId?.trim() || void 0
  );
}
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
  ...
  nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
    ...
    load: async () =>
      (await import("./approval-handler.runtime-Dyz8HgEB.js")).matrixApprovalNativeRuntime,
  }),
});
...
const matrixApprovalCapability = createChannelApprovalCapability({
  ...
  getActionAvailabilityState: (params) => {
    ...
    return (
      matrixNativeApprovalCapability.getActionAvailabilityState?.(params) ?? { kind: "disabled" }
    );
  },
  getExecInitiatingSurfaceState: (params) =>
    matrixNativeApprovalCapability.getExecInitiatingSurfaceState?.(params) ?? { kind: "disabled" },
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(
  () => import("./resolver.runtime.js"),
  "matrixResolverRuntime",
);
const matrixResolverAdapter = {
  resolveTargets: async ({ cfg, accountId, inputs, kind, runtime }) =>
    (await loadMatrixChannelRuntime$1()).resolveMatrixTargets({
      cfg,
      accountId,
      inputs,
      kind,
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(
  () => import("./setup-surface-_vInNcTk.js"),
  "matrixSetupWizard",
);
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(
  () => import("./channel.runtime-Bo_2ovYT.js"),
...
const matrixDoctor = {
  ...
  runConfigSequence: async ({ cfg, env, shouldRepair }) =>
    await (
      await import("./doctor-CVxU_UdP.js")
  ...
  cleanStaleConfig: async ({ cfg }) =>
    await (await import("./doctor-CVxU_UdP.js")).cleanStaleMatrixPluginConfig(cfg),
};
const listMatrixDirectoryPeersFromConfig = createResolvedDirectoryEntriesLister({
  ...
  normalizeId: (entry) => {
    ...
    const cleaned = normalizeLowercaseStringOrEmpty(raw).startsWith("user:")
      ? raw.slice(5).trim()
      : raw;
  ...
  return {
    ...
    lastActivityAt:
      typeof binding.metadata?.lastActivityAt === "number"
        ...
        : binding.boundAt,
    idleTimeoutMs:
      typeof binding.metadata?.idleTimeoutMs === "number" ? binding.metadata.idleTimeoutMs : void 0,
  ...
  base: {
    ...
    gateway: {
      startAccount: async (ctx) => {
        ...
        try {
          monitorMatrixProvider = (await import("./monitor-ktPXT2e1.js")).monitorMatrixProvider;
        } finally {
          releaseLock();
        }
