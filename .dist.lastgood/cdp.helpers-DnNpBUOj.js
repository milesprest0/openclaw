...
import { t as BrowserCdpEndpointBlockedError } from "./errors-BxBS-H8t.js";
...
import { g as resolvePinnedHostnameWithPolicy, t as SsrFBlockedError } from "./ssrf-DO8eIXaD.js";
...
var NoProxyLeaseManager = class {
  ...
  release() {
    ...
    if (
      ...
      (currentNoProxyLower === applied || currentNoProxyLower === void 0)
    ) {
...
const BROWSERBASE_RATE_LIMIT_MESSAGE =
  "Browserbase rate limit reached (max concurrent sessions). Wait for the current session to complete, or upgrade your plan.";
...
function getHeadersWithAuth(url, headers = {}) {
  ...
  try {
    const parsed = new URL(url);
    if (Object.keys(mergedHeaders).some((key) => key.trim().toLowerCase() === "authorization"))
...
//#endregion
export {
  DEFAULT_BROWSER_EVALUATE_ENABLED as A,
  PROFILE_ATTACH_RETRY_TIMEOUT_MS as C,
  DEFAULT_AI_SNAPSHOT_MAX_CHARS as D,
  DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as E,
  DEFAULT_OPENCLAW_BROWSER_ENABLED as F,
  DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as I,
  withNoProxyForCdpUrl as L,
  DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS as M,
  DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS as N,
  DEFAULT_BROWSER_ACTION_TIMEOUT_MS as O,
  DEFAULT_OPENCLAW_BROWSER_COLOR as P,
  CHROME_STOP_TIMEOUT_MS as S,
  usesFastLoopbackCdpProbeClass as T,
  CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS as _,
  fetchOk as a,
  CHROME_MCP_ATTACH_READY_WINDOW_MS as b,
  isWebSocketUrl as c,
  parseBrowserHttpUrl as d,
  redactCdpUrl as f,
  CDP_JSON_NEW_TIMEOUT_MS as g,
  resolveBrowserRateLimitMessage as h,
  fetchJson as i,
  DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS as j,
  DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as k,
  normalizeCdpHttpBaseForJsonEndpoints as l,
  withAllowedHostname as m,
  assertCdpEndpointAllowed as n,
  getHeadersWithAuth as o,
  withCdpSocket as p,
  fetchCdpChecked as r,
  isDirectCdpWebSocketEndpoint as s,
  appendCdpPath as t,
  openCdpWebSocket as u,
  CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS as v,
  resolveCdpReachabilityTimeouts as w,
  CHROME_STDERR_HINT_MAX_CHARS as x,
  CHROME_LAUNCH_READY_WINDOW_MS as y,
};
