import { o as resolveDefaultDiscordAccountId } from "./accounts-Ctry1Kkb.js";
import {
...
import {
  i as resolveTimestampMs,
  n as formatDiscordUserTag,
  r as resolveDiscordSystemLocation,
} from "./format-C7NoGYAq.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BdfwDi2E.js";
import { d as recordPendingHistoryEntryIfEnabled } from "./history-CiK0qvRj.js";
...
import {
  c as resolveDiscordChannelInfo,
  l as resolveDiscordMessageChannelId,
  r as resolveDiscordMessageText,
} from "./message-utils-DmLq_iNk.js";
import {
  a as shouldIgnoreStaleDiscordRouteBinding,
  ...
  t as buildDiscordRoutePeer,
} from "./route-resolution-CPnNSuTg.js";
import "./thread-bindings-DLL_GW9B.js";
import {
  n as resolveDiscordWebhookId,
  t as resolveDiscordSenderIdentity,
} from "./sender-identity-CH3eO8XB.js";
...
import { l as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-CKQgXU5N.js";
...
async function loadDiscordSendRuntime() {
  discordSendRuntimePromise ??= import("./send-BJzVgxwX.js");
...
async function resolveDiscordDmPreflightAccess(params) {
  ...
  const directBindingRecord = (await loadConversationRuntime$1())
  ...
  const allowMatchMeta = formatAllowlistMatchMeta(
    dmAccess.allowMatch.allowed ? dmAccess.allowMatch : void 0,
  );
...
function resolveDiscordPreflightChannelContext(params) {
  ...
  return {
    ...
    threadChannelSlug,
    threadParentSlug,
    channelConfig: params.isGuildMessage
...
async function loadPluralKitRuntime() {
  pluralkitRuntimePromise ??= import("./pluralkit-B1smZ668.js");
  return await pluralkitRuntimePromise;
}
async function loadPreflightAudioRuntime() {
  preflightAudioRuntimePromise ??= import("./preflight-audio-CNpP-4Qq.js");
  return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
  systemEventsRuntimePromise ??= import("./system-events-DT4N_1mk.js");
  return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
  discordThreadingRuntimePromise ??= import("./threading-BUsvCVIB.js");
...
async function preflightDiscordMessage(params) {
  ...
  const channelName =
    ...
    (isGuildMessage || isGroupDm
      ? resolveDiscordChannelNameSafe("channel" in message ? message.channel : void 0)
      : void 0);
  ...
  const {
    ...
    boundAgentId,
    baseSessionKey,
  } = await resolveDiscordPreflightRoute({
    preflight: params,
    author,
    isDirectMessage,
    isGroupDm,
