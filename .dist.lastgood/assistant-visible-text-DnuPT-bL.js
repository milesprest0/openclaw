...
import { r as stripPlainTextToolCallBlocks } from "./tool-payload-CFuJ-o-I.js";
...
function stripReasoningTagsFromText(text, options) {
  ...
  if (
    ...
    thinkingDepth > 0 &&
    !trimmedResult &&
    firstUnclosedContentIndex !== void 0 &&
    cleaned.trim()
  )
...
function sanitizeAssistantVisibleTextWithOptions(text, options) {
  return sanitizeAssistantVisibleTextWithProfile(
    text,
    options?.trim === "none" ? "history" : "delivery",
  );
}
//#endregion
export {
  stripDowngradedToolCallText as a,
  stripToolCallXmlTags as c,
  stripModelSpecialTokens as d,
  findCodeRegions as f,
  stripAssistantInternalScaffolding as i,
  hasOrphanReasoningCloseBoundary as l,
  sanitizeAssistantVisibleTextWithOptions as n,
  stripLegacyBracketToolCallBlocks as o,
  isInsideCode as p,
  sanitizeAssistantVisibleTextWithProfile as r,
  stripMinimaxToolCallXml as s,
  sanitizeAssistantVisibleText as t,
  stripReasoningTagsFromText as u,
};
