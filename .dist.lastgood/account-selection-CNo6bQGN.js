import { t as listConfiguredAccountIds } from "./account-configured-ids-1cK0Xlm9.js";
import {
...
function resolveConfiguredMatrixAccountIds(cfg, env = process.env) {
  ...
  if (
    hasConfiguredDefaultMatrixAccountSource({
      channel,
      env,
    })
  )
  ...
  return listCombinedAccountIds({
    ...
    additionalAccountIds: listMatrixEnvAccountIds(env).filter((accountId) =>
      normalizeAccountId(accountId) === "default"
        ? hasConfiguredDefaultMatrixAccountSource({
            channel,
            env,
...
//#endregion
export {
  resolveMatrixDefaultOrOnlyAccountId as a,
  resolveMatrixChannelConfig as i,
  requiresExplicitMatrixDefaultAccount as n,
  resolveMatrixAccountStringValues as o,
  resolveConfiguredMatrixAccountIds as r,
  findMatrixAccountEntry as t,
};
