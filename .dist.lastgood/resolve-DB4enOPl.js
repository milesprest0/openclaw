...
import {
  i as DEFAULT_MAX_CHARS_BY_CAPABILITY,
  n as DEFAULT_MAX_BYTES,
  o as DEFAULT_PROMPT,
} from "./defaults.constants-u25YkDfl.js";
import { r as resolveEffectiveMediaEntryCapabilities } from "./entry-capabilities-BnctHCEh.js";
...
function resolveTimeoutMs(seconds, fallbackSeconds) {
  return Math.max(
    1e3,
    Math.floor(
      (typeof seconds === "number" && Number.isFinite(seconds) ? seconds : fallbackSeconds) * 1e3,
    ),
  );
}
...
export {
  resolvePrompt as a,
  normalizeMediaUnderstandingChatType as c,
  resolveModelEntries as i,
  resolveMediaUnderstandingScope as l,
  resolveMaxBytes as n,
  resolveScopeDecision as o,
  resolveMaxChars as r,
  resolveTimeoutMs as s,
  resolveConcurrency as t,
};
