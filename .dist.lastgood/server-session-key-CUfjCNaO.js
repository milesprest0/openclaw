import { c as getAgentRunContext, u as registerAgentRunContext } from "./agent-events-c6-2eZvI.js";
...
import { m as toAgentRequestSessionKey } from "./session-key-B4qUwRzq.js";
import "./session-utils-Dhg586UW.js";
...
function resolveSessionKeyForRun(runId) {
  ...
  const storeKey = resolvePreferredSessionKeyForSessionIdMatches(
    Object.entries(store).filter((entry) => entry[1]?.sessionId === runId),
    runId,
  );
  if (storeKey) {
