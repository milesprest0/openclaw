...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-D_VLzYQI.js";
...
import {
  c as resolveControlUiRootSync,
  n as isPackageProvenControlUiRootSync,
  s as resolveControlUiRootOverrideSync,
  t as ensureControlUiAssetsBuilt,
} from "./control-ui-assets-Do6Hq7Yd.js";
import {
  r as setCurrentPluginMetadataSnapshot,
  t as clearCurrentPluginMetadataSnapshot,
} from "./current-plugin-metadata-snapshot-DFTSvtud.js";
import { t as createDefaultDeps } from "./deps-C1pDH524.js";
import {
  a as isDiagnosticsEnabled,
  b as runWithDiagnosticTraceContext,
  d as createDiagnosticTraceContext,
  l as setDiagnosticsEnabledForProcess,
} from "./diagnostic-events-9isI4hMq.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-Cj36HzcW.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-D6zP6ThU.js";
import "./method-scopes-DaDxLn4o.js";
import {
  _ as stopDiagnosticHeartbeat,
  g as startDiagnosticHeartbeat,
} from "./diagnostic-TRyCbvnu.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-BYtpiqsl.js";
import { t as GatewayLockError } from "./gateway-lock-B9OXSyzf.js";
import "./sessions-Bdy1wToU.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-Vqo11IHR.js";
import {
...
} from "./health-state-BojGeCvr.js";
import {
  n as applyGatewayLaneConcurrency,
  t as resolveHookClientIpConfig,
} from "./hook-client-ip-config-DbXW9RxP.js";
import {
  n as sendGatewayAuthFailure,
  o as setDefaultSecurityHeaders,
} from "./http-common-CyzMuYsM.js";
import {
  A as applyConfigOverrides,
  c as promoteConfigSnapshotToLastKnownGood,
  i as getRuntimeConfig,
  u as readConfigFileSnapshot,
  v as registerConfigWriteListener,
} from "./io-CEQSCTGy.js";
import { i as resolveMainSessionKey } from "./main-session-BttihmeO.js";
import {
  g as resolveRequestClientIp,
  i as isLoopbackHost,
  m as resolveGatewayListenHosts,
} from "./net-BQYp2xgJ.js";
import {
  i as READ_SCOPE,
  n as APPROVALS_SCOPE,
  o as WRITE_SCOPE,
  r as PAIRING_SCOPE,
} from "./operator-scopes-Codapd9g.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dn5fzabK.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-mS-g2wAV.js";
...
import {
  ...
  r as listLoadedChannelPlugins,
} from "./registry-loaded-DVm3aV50.js";
import {
  m as setPreRestartDeferralCheck,
  p as setGatewaySigusr1RestartPolicy,
} from "./restart-BMF0Nrvt.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-DV5CXRS9.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-BmbSnICA.js";
import {
  n as isProtectedPluginRoutePathFromContext,
  r as resolvePluginRoutePathContext,
} from "./route-match-DIDN4VN8.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-uLckWPme.js";
import {
  b as resolveActivePluginHttpRouteRegistry,
  d as pinActivePluginChannelRegistry,
  f as pinActivePluginHttpRouteRegistry,
  h as releasePinnedPluginHttpRouteRegistry,
  m as releasePinnedPluginChannelRegistry,
} from "./runtime-ChXyIFtl.js";
import {
  i as getActiveSecretsRuntimeSnapshot,
  n as clearSecretsRuntimeSnapshot,
} from "./runtime-DyGaG6oO.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-B0aZX-OG.js";
import {
  a as createToolEventRecipientRegistry,
  n as createChatRunState,
} from "./server-chat-state-Drj9w4SF.js";
import {
  i as MAX_BUFFERED_BYTES,
  o as MAX_PREAUTH_PAYLOAD_BYTES,
} from "./server-constants-CI_c5cWv.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-C0RQ1k8x.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-C6g8ZbJy.js";
import {
  i as getRequiredSharedGatewaySessionGeneration,
  r as enforceSharedGatewaySessionGenerationForConfigWrite,
} from "./server-shared-auth-generation-CFRckQqN.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-D-9HmBa9.js";
import { r as resolveCronStorePath } from "./store-CuwH2dda.js";
import { c as normalizeOptionalString } from "./string-coerce-BdEutqX5.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
...
import {
  ...
  n as logWs,
  r as shouldLogWs,
} from "./ws-log-B_EDd3bo.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-YtU7CIJH.js";
...
function createLazyGatewayCronState(params) {
  ...
  const load = async () => {
    ...
    loading ??= import("./server-cron-BOQuV_4k.js").then(({ buildGatewayCronService }) => {
      loaded = {
...
function resolveBundledChannelGatewayAuthBypassPaths(params) {
  return (
    loadBundledChannelGatewayAuthApi(params.channelId)?.resolveGatewayAuthBypassPaths?.({
      cfg: params.cfg,
    }) ?? []
...
function getIdentityAvatarModule() {
  identityAvatarModulePromise ??= import("./identity-avatar-QQst1pA4.js");
  return identityAvatarModulePromise;
}
function getControlUiModule() {
  controlUiModulePromise ??= import("./control-ui-D-k24m37.js");
  return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
  embeddingsHttpModulePromise ??= import("./embeddings-http-Defwiw2K.js");
  return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
  managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-C9VWAs71.js");
  return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
  modelsHttpModulePromise ??= import("./models-http-Ds70bpX2.js");
  return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
  openAiHttpModulePromise ??= import("./openai-http-C7_BsA4m.js");
  return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
  openResponsesHttpModulePromise ??= import("./openresponses-http-27nMvWAO.js");
  return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
  sessionHistoryHttpModulePromise ??= import("./sessions-history-http-QmB6SGAt.js");
  return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
  sessionKillHttpModulePromise ??= import("./session-kill-http-B7GCRI9j.js");
  return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
  toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-qdJ1o68Q.js");
  return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
  pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-BP9mNG9E.js");
  return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
  httpAuthUtilsModulePromise ??= import("./http-auth-utils-B6qD3K21.js");
  return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
  pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-Bg0gJJlQ.js");
  ...
  try {
    ...
    const handleHooksRequest = async (req, res) => {
      ...
      if (!loadedHooksRequestHandler) {
        const { createGatewayHooksRequestHandler } = await import("./hooks-BRypYtLK.js");
    ...
    const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
      if (
        (resolveActivePluginHttpRouteRegistry(params.pluginRegistry).httpRoutes ?? []).length === 0
      )
        return false;
      if (!loadedPluginRequestHandler) {
        const { createGatewayPluginRequestHandler } = await import("./plugins-http-CPhoKovo.js");
    ...
    const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
      ...
      if (!loadedPluginUpgradeHandler) {
        const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-CPhoKovo.js");
...
async function __resetModelCatalogCacheForTest() {
  const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } =
    await import("./server-model-catalog-BCqaO8SU.js");
...
function loadGatewayStartupEarlyModule() {
  gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CGWDeAy6.js");
  return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
  gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-CEAkk6QN.js");
...
function getChannelRuntime() {
  cachedChannelRuntimePromise ??= import("./runtime-channel-CPR15BH4.js").then(
    ({ createRuntimeChannel }) => createRuntimeChannel(),
  );
  return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
  cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-NXXeCS2A.js").then(
...
async function closeMcpLoopbackServerOnDemand() {
  const { closeMcpLoopbackServer } = await import("./mcp-http-DFOrRBED.js");
...
const loadGatewayModelCatalog = async (...args) => {
  gatewayModelCatalogModulePromise ??= import("./server-model-catalog-BCqaO8SU.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
  const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BaDxzJFu.js");
...
const runDefaultSetupWizard = async (...args) => {
  const { runSetupWizard } = await import("./setup-B8nzM-PJ.js");
  return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
  const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-BAbpk7ka.js");
  ...
  const startupConfigModulePromise = import("./server-startup-config-C3pAU2Wc.js");
  let startupPluginsModulePromise = null;
  const loadStartupPluginsModule = () => {
    startupPluginsModulePromise ??= import("./server-startup-plugins-DLYG8n6a.js");
  ...
  const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
    const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-BPhix9dZ.js");
  ...
  const { createChannelManager } = await import("./server-channels-BWtYdVLK.js");
  ...
  const { createGatewayNodeSessionRuntime } =
    await import("./server-node-session-runtime-DuSYM-Vw.js");
  const {
    nodeRegistry,
    nodePresenceTimers,
  ...
  const { getRuntimeSnapshot, startChannels, startChannel, stopChannel, markChannelLoggedOut } =
    channelManager;
  const refreshGatewayHealthSnapshotWithRuntime = (opts) =>
  ...
  try {
    ...
    const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([
      import("./server-runtime-subscriptions-DSDb5hZW.js"),
      import("./server-runtime-services-DRb9xiJi.js"),
    ]);
    Object.assign(
      runtimeState,
    ...
    const { createGatewayAuxHandlers } = await import("./server-aux-handlers-B-F42l1v.js");
    ...
    const reloadAttachedGatewayPlugins = async (params) => {
      ...
      const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] =
        await Promise.all([
          import("./plugin-lookup-table-DYXqz-rV.js"),
          import("./server-plugin-bootstrap-CLEjU-xr.js"),
          import("./services-FX2MH79V.js"),
        ]);
    ...
    const { createGatewayRequestContext } = await import("./server-request-context-B3tFaqwi.js");
    ...
    if (!minimalTestGateway) {
      if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
        const { reloadDeferredGatewayPlugins } =
          await import("./server-plugin-bootstrap-CLEjU-xr.js");
    ...
    const { attachGatewayWsHandlers } = await import("./server-ws-runtime-BeseTLnB.js");
    const { listPluginNodeCapabilities } = await import("./route-capability-CdhFo4g6.js");
    ...
    const { startManagedGatewayConfigReloader } =
      await import("./server-reload-handlers-37K2MvB-.js");
  ...
  return {
    close: async (opts) => {
      try {
        markClosePreludeStarted();
        const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-D0QzDMlK.js");
