...
function resolveDeclaredSetupRuntimeSource(record) {
  return (
    record.setupSource ??
    resolveSetupApiPath(record.rootDir, { includeBundledSourceFallback: false })
  );
}
...
//#endregion
export {
  resolvePluginSetupRegistry as a,
  resolvePluginSetupProvider as i,
  resolvePluginSetupAutoEnableReasons as n,
  runPluginSetupConfigMigrations as o,
  resolvePluginSetupCliBackend as r,
  setPluginSetupRegistryModuleLoaderFactoryForTest as s,
  clearPluginSetupRegistryCache as t,
};
