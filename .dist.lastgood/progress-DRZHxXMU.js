...
} from "./progress-line-DPB4-OJE.js";
...
function shouldUseInteractiveProgressSpinner(params) {
  return (
    (params.fallback === void 0 || params.fallback === "spinner") &&
...
function createCliProgress(options) {
  ...
  if (isTty && stdinIsRaw && (options.fallback === void 0 || options.fallback === "spinner"))
    return noopReporter;
  let started = false;
...
//#endregion
export {
  withProgressTotals as i,
  shouldUseInteractiveProgressSpinner as n,
  withProgress as r,
  createCliProgress as t,
};
