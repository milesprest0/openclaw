...
import { t as MatrixAuthedHttpClient } from "./http-client-BMhj43-k.js";
import {
...
async function listMatrixDirectoryPeersLive(params) {
  ...
  return (
    (
      await requestMatrixJson(context.client, {
        method: "POST",
  ...
  try {
    return (
      normalizeOptionalString(
        (
          await requestMatrixJson(client, {
            method: "GET",
