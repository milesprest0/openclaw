...
import { t as runSecurityAudit } from "./audit-BpYaj67s.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-CkWxZ_Vf.js";
...
import { i as getRuntimeConfig, r as createConfigIO } from "./io-CEQSCTGy.js";
...
import {
  n as formatIcaclsResetCommand,
  t as createIcaclsResetCommand,
...
async function collectChannelSecurityConfigFixMutation(params) {
  ...
  const collectPlugins = async () => {
    ...
    try {
      ...
      const { listBundledChannelPlugins } = await import("./bundled-BmkrLxNM.js");
