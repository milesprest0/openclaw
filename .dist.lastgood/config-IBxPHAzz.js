...
const memoryConfigSchema = {
  parse(value) {
    ...
    const captureMaxChars =
      typeof cfg.captureMaxChars === "number" ? Math.floor(cfg.captureMaxChars) : void 0;
    const recallMaxChars =
      typeof cfg.recallMaxChars === "number" ? Math.floor(cfg.recallMaxChars) : void 0;
    if (typeof captureMaxChars === "number" && (captureMaxChars < 100 || captureMaxChars > 1e4))
      throw new Error("captureMaxChars must be between 100 and 10000");
    if (typeof recallMaxChars === "number" && (recallMaxChars < 100 || recallMaxChars > 1e4))
...
//#endregion
export {
  vectorDimsForModel as a,
  memoryConfigSchema as i,
  DEFAULT_RECALL_MAX_CHARS as n,
  MEMORY_CATEGORIES as r,
  DEFAULT_CAPTURE_MAX_CHARS as t,
};
