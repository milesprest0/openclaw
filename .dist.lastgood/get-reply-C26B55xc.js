...
import {
  ...
  o as shouldSkipMessageByAbortCutoff,
  r as readAbortCutoffFromSessionEntry,
} from "./abort-cutoff-BgQZjRld.js";
import {
  i as setAbortMemory,
  n as isAbortRequestText,
  t as getAbortMemory,
} from "./abort-primitives-DPafrLy1.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-LQJZzUT0.js";
...
import { n as resolveBlockStreamingChunking } from "./block-streaming-DC6SDJSU.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CYMhno0R.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-DPG0FPin.js";
import { t as normalizeChatType } from "./chat-type-DsuCa6up.js";
import { r as getCliSessionBinding } from "./cli-session-FZWoj6wf.js";
import { t as hasControlCommand } from "./command-detection-CTqIeWA8.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-BtommWHg.js";
import "./defaults-4m7JJmD2.js";
import "./config-CMOdcWpc.js";
import { t as buildCommandContext } from "./commands-context-orVmMlkg.js";
import "./message-channel-core-VUC-himU.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-Cuat2kXh.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-DnjoNcoU.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-0lCkiXVx.js";
import { rt as isReasoningTagProvider } from "./context-budget-CZcqCu6a.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-vXPPKbVX.js";
import {
  a as normalizeSessionDeliveryFields,
  i as normalizeDeliveryContext,
  n as deliveryContextKey,
  t as deliveryContextFromSession,
} from "./delivery-context.shared-mj-12Z6_.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-CL_POCCe.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BDWVFOM8.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Dkj0eQuC.js";
...
import {
  ...
  n as formatEnvelopeTimestamp,
  o as resolveSenderLabel,
...
import { t as normalizeGroupActivation } from "./group-activation-DbPqof9Q.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DuzLZrql.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-Cn4100FJ.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CPo3uYXb.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-DzzZF3B1.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-D_WQYNuU.js";
import "./model-selection-CyVXHdEG.js";
import { t as finalizeInboundContext } from "./inbound-context-C2mdUiyz.js";
import { t as hasInboundMedia } from "./inbound-media-7cYellca.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-Uelx5Y74.js";
import {
  a as isInterSessionInputProvenance,
...
import {
  n as deriveInboundMessageHookContext,
  o as toInternalMessageTranscribedContext,
  r as toInternalMessagePreprocessedContext,
} from "./message-hook-mappers-NjOeo4xK.js";
import { t as resolveChannelModelOverride } from "./model-overrides-DE0S2tE9.js";
import {
  n as createModelSelectionState,
  r as resolveContextTokens,
  t as createFastTestModelSelectionState,
} from "./model-selection-oJf-VcPz.js";
...
import { n as resolveOriginMessageProvider } from "./origin-routing-Dp7tWtVT.js";
import {
...
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-_btntJtc.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-C2hpt3LY.js";
import { r as resolveQueueSettings, t as isSteeringQueueMode } from "./queue-m5o6nz1B.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-D3zb3mnd.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-D11nh-V3.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-DVm3aV50.js";
import { a as normalizeAnyChannelId } from "./registry-V0yq5bwZ.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BH0HN0Ry.js";
import {
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-D5XM2Jco.js";
...
import {
  n as resolveParentForkDecision,
  t as forkSessionFromParent,
} from "./session-fork-BCuISueL.js";
import {
  n as buildSessionStartHookPayload,
  t as buildSessionEndHookPayload,
} from "./session-hooks-BZPaQlKg.js";
import {
...
import {
  n as resolveResetPreservedSelection,
  t as clearSessionResetRuntimeState,
} from "./session-reset-cleanup-uoK0J3yh.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-BwS_UrgH.js";
import { s as resolveSessionLifecycleTimestamps } from "./sessions-Bdy1wToU.js";
import { n as resolveSilentReplySettings } from "./silent-reply-B9HyBycr.js";
import {
  n as resolveSkillCommandInvocation,
  t as listReservedChatSlashCommandNames,
} from "./skill-commands-base-BdNIErH7.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-zGSeuSpR.js";
import {
...
import {
  _ as deriveSessionMetaPatch,
  f as resolveSessionStoreEntry,
  s as updateSessionStore,
  x as resolveGroupSessionKey,
} from "./store-BpWdoYPF.js";
import {
  f as parseSessionThreadInfoFast,
  l as resolveMaintenanceConfigFromInput,
  t as loadSessionStore,
} from "./store-load-BSFLPYqQ.js";
import {
  n as resolveStoredModelOverride,
  t as isModelOverrideStillAuthoritative,
} from "./stored-model-override-BzKob9aL.js";
import {
...
import {
  f as normalizeThinkLevel,
  h as normalizeVerboseLevel,
  n as isThinkingLevelSupported,
  o as resolveSupportedThinkingLevel,
} from "./thinking-C9_Z62px.js";
...
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-_3QUoIEC.js";
import { o as collectTextContentBlocks } from "./tool-result-middleware-CJ4A8Wvz.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-C7lm-riv.js";
import {
  n as resolveTypingMode,
  r as resolveActiveRunQueueAction,
} from "./typing-mode-BnBEhBdf.js";
import {
  a as shouldHandleFastReplyTextCommands,
  c as shouldUseReplyFastTestRuntime,
  i as resolveGetReplyConfig,
  n as buildFastReplyCommandContext,
  o as shouldUseReplyFastDirectiveExecution,
  r as initFastReplySessionState,
  s as shouldUseReplyFastTestBootstrap,
  t as resolveRunTypingPolicy,
  u as isSystemEventProvider,
} from "./typing-policy-AHCEyCmh.js";
import {
  n as createTypingKeepaliveLoop,
  t as createTypingStartGuard,
} from "./typing-start-guard-r51BUORG.js";
import { y as truncateUtf16Safe } from "./utils-BGRcpLKt.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-DZqNP2so.js";
...
const directiveLevelsLoader = createLazyImportLoader(
  () => import("./directive-handling.levels-DXR4ly1U.js"),
);
const directiveImplLoader = createLazyImportLoader(
  () => import("./directive-handling.impl-D3PW1fNM.js"),
);
const directiveFastLaneLoader = createLazyImportLoader(
  () => import("./directive-handling.fast-lane-CSTpaxLd.js"),
);
...
async function applyInlineDirectiveOverrides(params) {
  ...
  const perMessageQueueMode =
    directives.hasQueueDirective && !directives.queueReset ? directives.queueMode : void 0;
...
function resolveReplyExecOverrides(params) {
  const host =
    params.directives.execHost ?? params.sessionEntry?.execHost ?? params.agentExecDefaults?.host;
  const security =
    params.directives.execSecurity ??
    params.sessionEntry?.execSecurity ??
    params.agentExecDefaults?.security;
  const ask =
    params.directives.execAsk ?? params.sessionEntry?.execAsk ?? params.agentExecDefaults?.ask;
  const node =
...
function resolveDiscordGuilds(cfg, accountId) {
  ...
  return (
    (normalizedAccountId ? discord.accounts?.[normalizedAccountId]?.guilds : void 0) ??
    discord.guilds
  );
}
...
function resolveDiscordChannelEntry(channels, params) {
  ...
  return (
    (groupId ? channels[groupId] : void 0) ??
    (channelSlug ? (channels[channelSlug] ?? channels[`#${channelSlug}`]) : void 0) ??
    (groupChannel ? channels[groupChannel] : void 0) ??
    channels["*"]
  );
}
...
async function resolveGroupRequireMention(params) {
  ...
  const channel = await resolveRuntimeChannelId(
    groupResolution?.channel ?? normalizeOptionalString(ctx.Provider),
  );
  if (!channel) return true;
  const rawGroupId = (ctx.From ?? "").trim();
  const groupId =
    groupResolution?.id ?? extractExplicitGroupId(rawGroupId) ?? (rawGroupId || void 0);
  const groupChannel =
...
const EXPLICIT_ELEVATED_ALLOW_FIELDS = new Set(["id", "from", "e164", "name", "username", "tag"]);
...
function adaptiveThinkingLevelOverride(text, currentLevel) {
  const cleanText = (text ?? "").trim().toLowerCase();
  if (!cleanText) return "medium";
  if (
...
async function resolveReplyDirectives(params) {
  ...
  if (
    ...
    if (noMentions.trim().length > 0) {
      if (
        parseInlineDirectives(noMentions, { modelAliases: configuredAliases }).cleaned.trim()
          .length > 0
      )
        parsedDirectives =
  ...
  let cleanedBody = (() => {
    ...
    return `${existingBody.slice(0, markerIndex + CURRENT_MESSAGE_MARKER.length)}${
      parseInlineDirectives(existingBody.slice(markerIndex + CURRENT_MESSAGE_MARKER.length), {
        modelAliases: configuredAliases,
        allowStatusDirective,
      }).cleaned
    }`;
  ...
  const resolvedVerboseLevel =
    directives.verboseLevel ?? targetSessionEntry?.verboseLevel ?? agentCfg?.verboseDefault;
  ...
  const resolvedElevatedLevel = elevatedAllowed
    ? (directives.elevatedLevel ??
      targetSessionEntry?.elevatedLevel ??
  ...
  const thinkingExplicitlySet =
    directives.thinkLevel !== void 0 ||
    targetSessionEntry?.thinkingLevel !== void 0 ||
    agentCfg?.thinkingDefault !== void 0;
  const resolvedThinkLevelWithDefault =
    sourcedThinkLevel !== void 0
  ...
  const hasAgentReasoningDefault =
    (agentEntry?.reasoningDefault !== void 0 && agentEntry?.reasoningDefault !== null) ||
    (agentCfg?.reasoningDefault !== void 0 && agentCfg?.reasoningDefault !== null);
  if (
    !(
      directives.reasoningLevel !== void 0 ||
      unauthorizedReasoningDirectiveAttempt ||
      blockedSessionReasoningLevel ||
      (sessionReasoningLevel !== void 0 && sessionReasoningLevel !== null) ||
      hasAgentReasoningDefault
    ) &&
    resolvedReasoningLevel === "off" &&
    !(resolvedThinkLevelWithDefault !== "off") &&
    !thinkingExplicitlySet
  )
    resolvedReasoningLevel = await modelState.resolveDefaultReasoningLevel();
  let contextTokens = useFastReplyRuntime
    ? (agentCfg?.contextTokens ?? 2e5)
  ...
  const formatModelSwitchEvent = (label, alias) =>
...
const openClawToolsRuntimeLoader = createLazyImportLoader(
  () => import("./openclaw-tools.runtime.js"),
);
...
async function handleInlineActions(params) {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const tool = applyOwnerOnlyToolPolicy(
        createOpenClawTools({
...
const statusCommandRuntimeLoader = createLazyImportLoader(
  () => import("./commands-status-CNMndUk3.js"),
);
...
function resolveNativeSlashCommandName(ctx) {
  ...
  return normalizeOptionalString(
    stripStructuralPrefixes(ctx.BodyForCommands ?? ctx.CommandBody ?? ctx.RawBody ?? ctx.Body ?? "")
      .trim()
      .match(/^\/([^\s:]+)(?::|\s|$)/)?.[1],
  )?.toLowerCase();
}
...
function resolveInboundFormattingHints(ctx) {
  ...
  return getLoadedChannelPluginById(normalizeAnyChannelId(channelValue) ?? channelValue)
    ?.agentPrompt?.inboundFormattingHints?.({
...
function buildInboundMetaSystemPrompt(ctx, options) {
  ...
  const payload = {
    ...
    response_format:
      options?.includeFormattingHints === false ? void 0 : resolveInboundFormattingHints(ctx),
  };
  return [
...
function buildInboundUserContextPrefix(ctx, envelope) {
  ...
  const conversationInfo = {
    ...
    topic_id:
      ctx.MessageThreadId != null
        ? (normalizePromptMetadataString(String(ctx.MessageThreadId)) ?? void 0)
        : void 0,
    ...
    has_reply_context:
      replyChainPayload.length > 0 || sanitizePromptBody(ctx.ReplyToBody) ? true : void 0,
  ...
  if (Object.values(conversationInfo).some((v) => v !== void 0))
    blocks.push(
...
function buildInboundMediaNote(ctx) {
  ...
  const urls =
    Array.isArray(ctx.MediaUrls) && ctx.MediaUrls.length === paths.length ? ctx.MediaUrls : void 0;
  const types =
    Array.isArray(ctx.MediaTypes) && ctx.MediaTypes.length === paths.length
      ? ctx.MediaTypes
      : void 0;
  const canStripSingleAttachmentByTranscript =
    Boolean(ctx.Transcript?.trim()) && paths.length === 1;
  const entries = paths
    .map((entry, index) => ({
      path: entry ?? "",
    ...
    .filter((entry) => {
      const isAudioByMime =
        types !== void 0 && normalizeLowercaseStringOrEmpty(entry.type).startsWith("audio/");
...
function cleanupTypingOnSocketDrop(typing, err) {
  if (err instanceof SocketDropException) typing.cleanup();
}
...
function hasInboundHistoryBody(ctx) {
  return (
    ...
    ctx.InboundHistory.some((entry) => entry.body.replaceAll("\0", "").trim().length > 0)
  );
}
function resolveCurrentTurnPromptContext(ctx) {
  const replyChain = Array.isArray(ctx.ReplyChain)
    ...
    : void 0;
  if (replyChain && replyChain.length > 0) return { replyChain };
...
async function runPreparedReply(params) {
  ...
  const isMainSession =
    ...
    sessionKey === normalizeMainKey(sessionCfg?.mainKey);
  ...
  if (isActive && activeRunQueueAction === "run-now") {
    const queueState = await resolvePreparedReplyQueueState({
      ...
      waitForActiveRunEnd: (activeRunSessionId) =>
        piRuntime?.waitForEmbeddedPiRunEnd(activeRunSessionId) ?? Promise.resolve(void 0),
...
function loadDeliverRuntime() {
  deliverRuntimePromise ??= import("./deliver-runtime-DredlW6O.js");
...
function maybeRetireLegacyMainDeliveryRoute(params) {
  ...
  if (
    legacyMain.deliveryContext === void 0 &&
    legacyMain.lastChannel === void 0 &&
    legacyMain.lastTo === void 0 &&
    legacyMain.lastAccountId === void 0 &&
    legacyMain.lastThreadId === void 0
  )
    return;
  return {
...
async function initSessionState(params) {
  ...
  if (ingressTimingEnabled)
    log.info(
      `session-init store-load agent=${agentId} session=${sessionCtxForState.SessionKey ?? "(no-session)"} elapsedMs=${Date.now() - sessionStoreLoadStartMs} path=${storePath}`,
    );
  let sessionKey;
  let sessionEntry;
  let sessionId;
  ...
  if (!isNewSession && freshEntry && canReuseExistingEntry) {
    ...
    if (resetTriggered && entry) {
      ...
      persistedModelOverrideAt = preservedSelection.modelOverride ? entry.modelOverrideAt : void 0;
  ...
  const lastThreadIdRaw = isSystemEvent
    ...
    : ctx.MessageThreadId || (isThread ? baseEntry?.lastThreadId : void 0);
  ...
  if (
    ...
    if (forkDecision.status === "skip") {
      log.warn(
        `skipping parent fork (parent too large): parentKey=${parentSessionKey} → sessionKey=${sessionKey} parentTokens=${forkDecision.parentTokens} maxTokens=${forkDecision.maxTokens}`,
      );
      sessionEntry.forkedFromParent = true;
    } else {
      log.warn(
        `forking from parent session: parentKey=${parentSessionKey} → sessionKey=${sessionKey} parentTokens=${forkDecision.parentTokens ?? "unknown"}`,
      );
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-CsWbyQGd.js"));
...
async function getReplyFromConfig(ctx, opts, configOverride) {
  ...
  const traceGetReplyPhase = (name, run) =>
    measureDiagnosticsTimelineSpan(name, run, {
      phase: "agent-turn",
      config: cfg,
      attributes: traceAttributes,
  ...
  if (sessionEntry?.pendingFinalDelivery && sessionEntry.pendingFinalDeliveryText) {
    ...
    if (opts?.isHeartbeat) {
      ...
      if (sessionKey && storePath) {
        const { updateSessionStoreEntry } = await import("./sessions-CiPW-L7x.js");
