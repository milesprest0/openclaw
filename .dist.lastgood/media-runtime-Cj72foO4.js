...
import { n as sendTranscriptEcho } from "./echo-transcript-CqUJEINf.js";
import { r as writeExternalFileWithinRoot } from "./fs-safe-CgBWiL92.js";
import "./mime-CSQ-Gv-M.js";
import "./image-ops-B3yygUDw.js";
import "./store-N2etmi9e.js";
import "./fetch-CIuHGNdE.js";
import "./local-roots-CCSkqO59.js";
import "./local-media-access-gxEsNSj9.js";
import "./defaults-Miq3q5Uz.js";
import "./image-runtime-DLf9RXbB.js";
import "./defaults.constants-u25YkDfl.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BdfwDi2E.js";
import { r as withTempWorkspace, t as tempWorkspace } from "./private-temp-workspace-DKvr8oLR.js";
import { n as loadQrCodeRuntime, r as normalizeQrText } from "./qr-terminal-DNeh75Fq.js";
import { x as sendTextMediaPayload } from "./reply-payload-D_-IJF8p.js";
import {
  a as runCapability,
  i as resolveMediaAttachmentLocalRoots,
  l as isAudioAttachment,
  o as createMediaAttachmentCache,
  s as normalizeMediaAttachments,
  t as buildProviderRegistry,
} from "./runner-BV9etZbE.js";
import "./audio-D-EQxAcn.js";
import "./agent-media-payload-P6J0B-1F.js";
import "./outbound-runtime-DIb149kM.js";
import "./outbound-attachment-DFY24CXr.js";
import "./png-encode-DR19dLb8.js";
import { d as runFfprobe, u as runFfmpeg } from "./runner.entries-BWDlqt3w.js";
...
async function renderQrPngBase64(input, opts = {}) {
  ...
  ).toDataURL(normalizeQrText(input), {
...
async function probeVideoDimensions(buffer) {
  try {
    return parseFfprobeVideoDimensions(
      await runFfprobe(
        [
          "-v",
          "error",
...
//#endregion
export {
  resolveChannelMediaMaxBytes as a,
  unlinkIfExists as c,
  renderQrPngDataUrl as d,
  writeQrPngTempFile as f,
  transcribeFirstAudio as i,
  formatQrPngDataUrl as l,
  createScopedChannelMediaMaxBytesResolver as n,
  parseFfprobeVideoDimensions as o,
  transcodeAudioBufferToOpus as p,
  resolveScopedChannelMediaMaxBytes as r,
  probeVideoDimensions as s,
  createDirectTextMediaOutbound as t,
  renderQrPngBase64 as u,
};
