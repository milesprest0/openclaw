...
import {
  i as TrimmedNonEmptyStringFieldSchema,
  n as LowercaseNonEmptyStringFieldSchema,
  o as parseOptionalField,
  t as DeliveryThreadIdFieldSchema,
} from "./delivery-field-schemas-Ch3EV7Ve.js";
import { B as MEMORY_DREAMING_SYSTEM_EVENT_TEXT } from "./dreaming-BDr8qIGr.js";
import { t as inferLegacyName } from "./normalize-y9XtuoNT.js";
import { t as note } from "./note-DvJ3bfgI.js";
import { t as coerceFiniteScheduleNumber } from "./schedule-BabEAu9_.js";
import {
...
function isManagedDreamingJob(raw) {
  if (
    normalizeOptionalString(raw.description)?.includes(
...
function hasLegacyDeliveryHints(payload) {
  ...
  return (
    hints.deliver !== void 0 ||
    hints.bestEffortDeliver !== void 0 ||
    hints.channel !== void 0 ||
    hints.provider !== void 0 ||
    hints.to !== void 0 ||
    hints.threadId !== void 0
  );
}
...
function normalizeStoredCronJobs(jobs) {
  ...
  for (const raw of jobs) {
    ...
    if ("sessionKey" in raw) {
      const sessionKey =
        typeof raw.sessionKey === "string" ? normalizeOptionalString(raw.sessionKey) : void 0;
