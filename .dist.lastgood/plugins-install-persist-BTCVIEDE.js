...
import { t as buildNpmResolutionFields } from "./install-source-utils-DrH7L6Si.js";
import {
  n as recordPluginInstallInRecords,
  o as withoutPluginInstallRecords,
} from "./installed-plugin-index-records-BD2sKB0z.js";
import "./path-guards-DyZnivcw.js";
import { t as recordHookInstall } from "./installs-DxnG1Sbj.js";
import { r as replaceConfigFile } from "./mutate-IzL9dVFH.js";
import { i as isPathInside } from "./path-1liOXr_N.js";
import {
  i as enableInternalHookEntries,
  o as logHookPackRestartHint,
  s as logSlotWarnings,
...
import { c as buildPluginSnapshotReport } from "./status-BpQ1MVWd.js";
import { r as theme } from "./theme-CiH_wF8x.js";
import {
  n as applyPluginUninstallDirectoryRemoval,
  o as planPluginUninstall,
} from "./uninstall-BP_9HQOe.js";
...
async function persistPluginInstall(params) {
  ...
  let next =
    params.enable === false
      ? installConfig
      : enablePluginInConfig(installConfig, params.pluginId, { updateChannelConfig: false }).config;
...
//#endregion
export {
  resolvePinnedNpmInstallRecordForCli as i,
  persistPluginInstall as n,
  buildNpmInstallRecordFields as r,
