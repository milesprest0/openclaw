...
import { i as readRegularFileSync, r as readRegularFile } from "./regular-file-CoVHB-2u.js";
...
function trySetSecureMode(pathname) {
  ...
  try {
    fd = fs.openSync(
      pathname,
      fs.constants.O_RDONLY | (SUPPORTS_SYNC_NOFOLLOW ? fs.constants.O_NOFOLLOW : 0),
    );
...
export {
  readJsonSync as a,
  readRootStructuredFileSync as c,
  writeJson as d,
  writeJsonSync as f,
  readJsonIfExists as i,
  tryReadJson as l,
  JsonFileReadError as n,
  readRootJsonObjectSync as o,
  readJson as r,
  readRootJsonSync as s,
  writeTextAtomic as t,
  tryReadJsonSync as u,
};
