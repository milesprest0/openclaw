...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CEVjzmJk.js";
import "./channel-lifecycle-BBBTbPMe.js";
import "./accounts-K08f0yML.js";
import "./runtime-api-Cd0V8JUK.js";
import { t as sendMessageZalo } from "./send-CqajhPb4.js";
...
async function notifyZaloPairingApproval(params) {
  const { resolveZaloAccount } = await import("./accounts-DDcevQXi.js");
...
async function startZaloGatewayAccount(ctx) {
  ...
  const { monitorZaloProvider } = await import("./monitor-B6ZV9kxl.js");
