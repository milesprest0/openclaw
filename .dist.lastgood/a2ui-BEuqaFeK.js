...
async function resolveA2uiRootReal() {
  if (
    cachedA2uiRootReal !== void 0 &&
    (cachedA2uiRootReal !== null ||
      Date.now() - cachedA2uiResolvedAtMs < A2UI_ROOT_RETRY_NULL_AFTER_MS)
  )
...
async function handleA2uiHttpRequest(req, res) {
  ...
  const result = await resolveFileWithinRoot(
    a2uiRootReal,
...
//#endregion
export {
  CANVAS_HOST_PATH as a,
  isA2uiPath as c,
  A2UI_PATH as i,
  normalizeUrlPath as n,
  CANVAS_WS_PATH as o,
  resolveFileWithinRoot as r,
  injectCanvasLiveReload as s,
  handleA2uiHttpRequest as t,
};
