...
import { c as resolvePackedRootDir, t as extractArchive } from "./archive-CfKTdlm5.js";
import { _ as assertCanonicalPathWithinBase } from "./channel-catalog-registry-uu7_tUkL.js";
import { r as runCommandWithTimeout } from "./exec-Csn_09g3.js";
import { T as pathExists } from "./fs-safe-CgBWiL92.js";
import { o as withTempDir } from "./install-source-utils-DrH7L6Si.js";
...
async function assertInstallBaseStable(params) {
  if (!(await fs.stat(params.installBaseDir)).isDirectory())
    throw new Error(INSTALL_BASE_CHANGED_ERROR_MESSAGE);
  if ((await fs.realpath(params.installBaseDir)) !== params.expectedRealPath)
    throw new Error(INSTALL_BASE_CHANGED_ERROR_MESSAGE);
}
...
//#endregion
export {
  withExtractedArchiveRoot as i,
  installPackageDirWithManifestDeps as n,
  resolveExistingInstallPath as r,
  installPackageDir as t,
};
