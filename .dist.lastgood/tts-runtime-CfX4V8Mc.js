import "./zod-schema.core-CkFaNmbg.js";
import { t as createLazyFacadeObjectValue } from "./facade-loader-CMzIS_Ut.js";
import {
  n as loadActivatedBundledPluginPublicSurfaceModuleSync,
...
const buildTtsSystemPromptHint = createLazyFacadeValue(
  loadFacadeModule,
  "buildTtsSystemPromptHint",
);
const getLastTtsAttempt = createLazyFacadeValue(loadFacadeModule, "getLastTtsAttempt");
const getResolvedSpeechProviderConfig = createLazyFacadeValue(
  loadFacadeModule,
...
const resolveExplicitTtsOverrides = createLazyFacadeValue(
  loadFacadeModule,
...
//#endregion
export {
  textToSpeechStream as A,
  setTtsEnabled as C,
  streamSpeech as D,
  setTtsProvider as E,
  synthesizeSpeech as O,
  setTtsAutoMode as S,
  setTtsPersona as T,
  resolveTtsConfig as _,
  getTtsMaxLength as a,
  setLastTtsAttempt as b,
  isSummarizationEnabled as c,
  listSpeechVoices as d,
  listTtsPersonas as f,
  resolveTtsAutoMode as g,
  resolveExplicitTtsOverrides as h,
  getResolvedSpeechProviderConfig as i,
  textToSpeechTelephony as j,
  textToSpeech as k,
  isTtsEnabled as l,
  prewarmTtsRuntimeFacade as m,
  buildTtsSystemPromptHint as n,
  getTtsPersona as o,
  maybeApplyTtsToPayload as p,
  getLastTtsAttempt as r,
  getTtsProvider as s,
  _test as t,
  isTtsProviderConfigured as u,
  resolveTtsPrefsPath as v,
  setTtsMaxLength as w,
  setSummarizationEnabled as x,
  resolveTtsProviderOrder as y,
};
