...
export declare const INPUT_PROVENANCE_KIND_VALUES: readonly [
  "external_user",
  "inter_session",
  "internal_system",
];
...
export declare function applyInputProvenanceToUserMessage(
  message: AgentMessage,
  inputProvenance: InputProvenance | undefined,
): AgentMessage;
export declare function isInterSessionInputProvenance(value: unknown): boolean;
export declare function hasInterSessionUserProvenance(
  message:
    | {
        role?: unknown;
        provenance?: unknown;
...
export declare function buildInterSessionPromptPrefix(
  inputProvenance: InputProvenance | undefined,
): string;
export declare function annotateInterSessionPromptText(
  text: string,
  inputProvenance: InputProvenance | undefined,
): string;
