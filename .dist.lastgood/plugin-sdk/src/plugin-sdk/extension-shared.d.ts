...
export declare function buildPassiveChannelStatusSummary<TExtra extends object>(
...
export declare function buildPassiveProbedChannelStatusSummary<TExtra extends object>(
  snapshot: PassiveChannelStatusSnapshot,
  extra?: TExtra,
): {
  configured: boolean;
...
export declare function resolveLoggerBackedRuntime<TRuntime>(
...
export declare function readStatusIssueFields<TField extends string>(
  value: unknown,
...
export declare function formatPluginConfigIssue(
  issue: z.ZodIssue | undefined,
  options?: PluginConfigIssueMessageOptions,
): string;
export declare function normalizePluginConfigIssuePath(
  path: readonly unknown[],
): PluginConfigIssuePathSegment[];
export declare function mapPluginConfigIssues(
