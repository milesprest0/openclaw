...
export declare function resolveSenderCommandAuthorizationWithRuntime(
...
export declare function resolveSenderCommandAuthorization(
...
export declare function buildCommandsMessage(
  ...args: Parameters<typeof buildCommandsMessageCompat>
): ReturnType<typeof buildCommandsMessageCompat>;
/** @deprecated Use `openclaw/plugin-sdk/command-status` instead. */
export declare function buildCommandsMessagePaginated(
