...
export declare const DEFAULT_PROGRESS_DRAFT_LABELS: readonly [
  "Thinking...",
  "Shelling...",
  "Scuttling...",
  "Clawing...",
...
export declare function isChannelProgressDraftWorkToolName(
...
export declare function getChannelStreamingConfigObject(
  entry: StreamingCompatEntry | null | undefined,
): ChannelStreamingConfig | undefined;
export declare function resolveChannelStreamingChunkMode(
  entry: StreamingCompatEntry | null | undefined,
): TextChunkMode | undefined;
export declare function resolveChannelStreamingBlockEnabled(
  entry: StreamingCompatEntry | null | undefined,
): boolean | undefined;
export declare function resolveChannelStreamingBlockCoalesce(
  entry: StreamingCompatEntry | null | undefined,
): BlockStreamingCoalesceConfig | undefined;
export declare function resolveChannelStreamingPreviewChunk(
  entry: StreamingCompatEntry | null | undefined,
): BlockStreamingChunkConfig | undefined;
export declare function resolveChannelStreamingPreviewToolProgress(
  entry: StreamingCompatEntry | null | undefined,
  defaultValue?: boolean,
): boolean;
export declare function resolveChannelStreamingPreviewCommandText(
  entry: StreamingCompatEntry | null | undefined,
  defaultValue?: ChannelStreamingCommandTextMode,
): ChannelStreamingCommandTextMode;
export declare function resolveChannelStreamingSuppressDefaultToolProgressMessages(
  entry: StreamingCompatEntry | null | undefined,
  options?: {
...
export declare function resolveChannelStreamingNativeTransport(
  entry: StreamingCompatEntry | null | undefined,
): boolean | undefined;
export declare function resolveChannelPreviewStreamMode(
  entry: StreamingCompatEntry | null | undefined,
  defaultMode: "off" | "partial",
): StreamingMode;
export declare function resolveChannelProgressDraftConfig(
  entry: StreamingCompatEntry | null | undefined,
): ChannelStreamingProgressConfig;
...
export declare function resolveChannelProgressDraftMaxLines(
  entry: StreamingCompatEntry | null | undefined,
  defaultValue?: number,
): number;
export declare function resolveChannelProgressDraftRender(
  entry: StreamingCompatEntry | null | undefined,
  defaultValue?: ChannelProgressDraftRenderMode,
