...
export declare function collectDiscordStatusIssues(
...
export declare function listDiscordDirectoryGroupsFromConfig(
  params: DirectoryConfigParams,
): unknown[] | Promise<unknown[]>;
export declare function listDiscordDirectoryPeersFromConfig(
  params: DirectoryConfigParams,
): unknown[] | Promise<unknown[]>;
...
export declare function normalizeDiscordOutboundTarget(
  to?: string,
...
export declare function resolveDiscordGroupRequireMention(
