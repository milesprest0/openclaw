...
type FacadeModule = {
  ...
  readQaBusMessage: (params: { baseUrl: string; accountId: string; messageId: string }) => Promise<{
    message: QaBusMessage;
  }>;
  searchQaBusMessages: (params: { baseUrl: string; input: QaBusSearchMessagesInput }) => Promise<{
