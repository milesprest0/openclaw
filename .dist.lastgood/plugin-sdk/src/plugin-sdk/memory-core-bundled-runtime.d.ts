...
type RuntimeFacadeModule = {
  ...
  removeGroundedShortTermCandidates: (params: { workspaceDir: string }) => Promise<{
    removed: number;
    storePath: string;
  }>;
...
type ApiFacadeModule = {
  ...
  dedupeDreamDiaryEntries: (params: { workspaceDir: string }) => Promise<{
    dreamsPath: string;
    removed: number;
    kept: number;
  }>;
  ...
  removeBackfillDiaryEntries: (params: { workspaceDir: string }) => Promise<{
    dreamsPath: string;
    removed: number;
  }>;
