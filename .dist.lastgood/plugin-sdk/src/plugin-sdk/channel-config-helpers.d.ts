...
export declare function mapAllowFromEntries(
...
export declare function resolveOptionalConfigString(
  value: string | number | null | undefined,
): string | undefined;
/** Adapt `{ cfg, accountId }` accessors to callback sites that pass positional args. */
export declare function adaptScopedAccountAccessor<
  Result,
  Config extends OpenClawConfig = OpenClawConfig,
>(
...
export declare function createScopedAccountConfigAccessors<
  ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(params: {
...
export declare function createScopedChannelConfigBase<
  ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(
...
export declare function createScopedChannelConfigAdapter<
  ResolvedAccount,
  AccessorAccount = ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(
...
export declare function createTopLevelChannelConfigBase<
  ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(params: {
  sectionKey: string;
...
export declare function createTopLevelChannelConfigAdapter<
  ResolvedAccount,
  AccessorAccount = ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(params: {
...
export declare function createHybridChannelConfigBase<
  ResolvedAccount,
  Config extends OpenClawConfig = OpenClawConfig,
>(
  params: NamedAccountChannelConfigBaseParams<ResolvedAccount, Config> & {
...
export declare function createScopedDmSecurityResolver<
  ResolvedAccount extends {
    accountId?: string | null;
  },
>(params: {
  channelKey: string;
