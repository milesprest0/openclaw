...
}): (input: { channel: string; from: string; body: string; timestamp?: number }) => {
  storePath: string;
  body: string;
};
/** Resolve a route first, then return both the route and a formatter for future inbound messages. */
export declare function resolveInboundRouteEnvelopeBuilder<
  TConfig,
  TEnvelope,
...
export declare function resolveInboundRouteEnvelopeBuilderWithRuntime<
  TConfig,
  TEnvelope,
  TRoute extends RouteLike,
  TPeer extends RoutePeerLike,
