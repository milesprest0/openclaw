...
export declare function withCachedMigrationConfigRuntime(
...
export declare function archiveMigrationItem(
  item: MigrationItem,
  reportDir: string,
): Promise<MigrationItem>;
export declare function copyMigrationFileItem(
  item: MigrationItem,
  reportDir: string,
  opts?: {
    overwrite?: boolean;
...
export declare function writeMigrationReport(
