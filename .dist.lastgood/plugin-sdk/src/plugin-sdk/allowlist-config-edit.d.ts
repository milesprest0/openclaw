...
export declare function resolveDmGroupAllowlistConfigPaths(
  scope: "dm" | "group",
): AllowlistConfigPaths;
export declare function resolveLegacyDmAllowlistConfigPaths(
  scope: "dm" | "group",
): AllowlistConfigPaths | null;
/** Coerce stored allowlist entries into presentable non-empty strings. */
export declare function readConfiguredAllowlistEntries(
...
export declare function createNestedAllowlistOverrideResolver<
  ResolvedAccount,
  Outer,
  Inner,
>(params: {
