...
export declare function createMigrationItem(
  params: Omit<MigrationItem, "status"> & {
    status?: MigrationItem["status"];
  },
): MigrationItem;
export declare function markMigrationItemConflict(
  item: MigrationItem,
  reason: string,
): MigrationItem;
export declare function markMigrationItemError(item: MigrationItem, reason: string): MigrationItem;
export declare function markMigrationItemSkipped(
  item: MigrationItem,
  reason: string,
): MigrationItem;
...
export declare function readMigrationConfigPath(
  root: Record<string, unknown>,
  path: readonly string[],
): unknown;
export declare function mergeMigrationConfigValue(left: unknown, right: unknown): unknown;
export declare function writeMigrationConfigPath(
  root: Record<string, unknown>,
  path: readonly string[],
  value: unknown,
): void;
export declare function hasMigrationConfigPatchConflict(
...
export declare function readMigrationConfigPatchDetails(
  item: MigrationItem,
): MigrationConfigPatchDetails | undefined;
export declare function applyMigrationConfigPatchItem(
