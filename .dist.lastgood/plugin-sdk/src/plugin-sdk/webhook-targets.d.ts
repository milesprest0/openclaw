...
export declare function registerWebhookTargetWithPluginRoute<
  T extends {
    path: string;
  },
>(params: {
...
export declare function registerWebhookTarget<
  T extends {
    path: string;
  },
>(
...
export declare function resolveWebhookTargets<T>(
  req: IncomingMessage,
  targetsByPath: Map<string, T[]>,
): {
  path: string;
...
export declare function resolveSingleWebhookTarget<T>(
  targets: readonly T[],
...
export declare function resolveSingleWebhookTargetAsync<T>(
  targets: readonly T[],
...
export declare function rejectNonPostWebhookRequest(
  req: IncomingMessage,
  res: ServerResponse,
): boolean;
