...
export declare function runPreparedInboundReplyTurn<TDispatchResult>(
  params: PreparedChannelTurn<TDispatchResult>,
): Promise<import("../channels/turn/types.js").DispatchedChannelTurnResult<TDispatchResult>>;
/** Run a channel turn through shared ingest, record, dispatch, and finalize ordering. */
export declare function runInboundReplyTurn<TRaw, TDispatchResult = DispatchFromConfigResult>(
  params: RunChannelTurnParams<TRaw, TDispatchResult>,
): Promise<import("../channels/turn/types.js").ChannelTurnResult<TDispatchResult>>;
export {
 ...
 */
export declare function dispatchChannelMessageReplyWithBase(
 ...
 */
export declare function dispatchInboundReplyWithBase(
...
export declare function recordChannelMessageReplyDispatch(
 ...
 * have not moved to the message lifecycle yet.
 */
export declare function recordInboundSessionAndDispatchReply(
  params: RecordChannelMessageReplyDispatchParams,
): Promise<void>;
