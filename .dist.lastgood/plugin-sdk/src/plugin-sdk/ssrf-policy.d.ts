...
export declare function ssrfPolicyFromPrivateNetworkOptIn(
  input: PrivateNetworkOptInInput,
): SsrFPolicy | undefined;
export declare function ssrfPolicyFromDangerouslyAllowPrivateNetwork(
  dangerouslyAllowPrivateNetwork: boolean | null | undefined,
): SsrFPolicy | undefined;
export declare function mergeSsrFPolicies(
...
export declare function createLegacyPrivateNetworkDoctorContract(params: { channelKey: string }): {
...
export declare function ssrfPolicyFromAllowPrivateNetwork(
  allowPrivateNetwork: boolean | null | undefined,
): SsrFPolicy | undefined;
export declare function assertHttpUrlTargetsPrivateNetwork(
  url: string,
  params?: {
    dangerouslyAllowPrivateNetwork?: boolean | null;
    allowPrivateNetwork?: boolean | null;
...
export declare function normalizeHostnameSuffixAllowlist(
  input?: readonly string[],
  defaults?: readonly string[],
): string[];
/** Check whether a URL is HTTPS and its hostname matches the normalized suffix allowlist. */
export declare function isHttpsUrlAllowedByHostnameSuffixAllowlist(
  url: string,
 ...
 */
export declare function buildHostnameAllowlistPolicyFromSuffixAllowlist(
