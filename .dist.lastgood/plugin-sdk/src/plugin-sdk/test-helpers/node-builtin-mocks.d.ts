...
export declare function mockNodeBuiltinModule<TModule extends object>(
...
export declare function mockNodeChildProcessSpawnSync(
  spawnSync: (...args: unknown[]) => unknown,
): Promise<typeof import("node:child_process")>;
export declare function mockNodeChildProcessExecFile(
