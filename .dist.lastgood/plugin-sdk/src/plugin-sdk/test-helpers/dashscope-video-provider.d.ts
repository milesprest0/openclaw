...
export declare function mockSuccessfulDashscopeVideoTask(
...
export declare function expectDashscopeVideoTaskPoll(
  fetchWithTimeoutMock: ChainableResolvedValueMock,
  params?: {
    baseUrl?: string;
    taskId?: string;
...
export declare function expectSuccessfulDashscopeVideoResult(
