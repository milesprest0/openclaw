...
export declare function startAccountAndTrackLifecycle<
  TAccount extends {
    accountId: string;
  },
>(params: {
...
export declare function waitForStartedMocks(
  ...mocks: Array<ReturnType<typeof vi.fn>>
): () => Promise<void>;
export declare function expectLifecyclePatch(
  patches: ChannelAccountSnapshot[],
