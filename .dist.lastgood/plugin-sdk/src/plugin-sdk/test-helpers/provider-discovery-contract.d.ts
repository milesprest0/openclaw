...
export declare function describeMinimaxProviderDiscoveryContract(
  load: ProviderDiscoveryContractPluginLoader,
): void;
export declare function describeModelStudioProviderDiscoveryContract(
  load: ProviderDiscoveryContractPluginLoader,
): void;
export declare function describeCloudflareAiGatewayProviderDiscoveryContract(
  load: ProviderDiscoveryContractPluginLoader,
): void;
