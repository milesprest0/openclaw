...
export declare function getProviderHttpMocks(): {
  resolveApiKeyForProviderMock: import("vitest").Mock<
    () => Promise<{
      apiKey: string;
    }>
  >;
  ...
  assertOkOrThrowHttpErrorMock: import("vitest").Mock<
    (_response: Response, _label: string) => Promise<void>
  >;
  assertOkOrThrowProviderErrorMock: import("vitest").Mock<
    (_response: Response, _label: string) => Promise<void>
  >;
  sanitizeConfiguredModelProviderRequestMock: import("vitest").Mock<
    (
      request: SanitizeConfiguredModelProviderRequestParams,
    ) => import("../config-types.ts").ConfiguredModelProviderRequest | undefined
  >;
  resolveProviderHttpRequestConfigMock: import("vitest").Mock<
