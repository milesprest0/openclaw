...
export declare function textToolResult(
  text: string,
  details?: Record<string, unknown>,
): AgentToolResult<unknown>;
export declare function mediaToolResult(
  text: string,
  mediaUrl: string,
...
export declare function installOpenClawOwnedToolHooks(params?: {
  ...
  beforeToolCall: import("vitest").Mock<
    () => Promise<
      | {
          block: boolean;
          blockReason: string;
 ...
 */
export declare function installCodexToolResultMiddleware(
  handler: (event: CodexAppServerToolResultEvent) => AgentToolResult<unknown>,
): {
  middleware: import("vitest").Mock<
    (event: CodexAppServerToolResultEvent) => Promise<{
