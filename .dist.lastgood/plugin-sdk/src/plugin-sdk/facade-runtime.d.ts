...
export declare function createLazyFacadeValue<TFacade extends object, K extends keyof TFacade>(
...
export declare function loadBundledPluginPublicSurfaceModuleSync<T extends object>(
...
export declare function loadActivatedBundledPluginPublicSurfaceModuleSync<
  T extends object,
>(params: { dirName: string; artifactBasename: string; env?: NodeJS.ProcessEnv }): T;
export declare function tryLoadActivatedBundledPluginPublicSurfaceModuleSync<
  T extends object,
>(params: { dirName: string; artifactBasename: string; env?: NodeJS.ProcessEnv }): T | null;
