 ...
 */
export declare function defineChannelPluginEntry<TPlugin>({
  id,
  name,
  description,
  plugin,
...
> &
  Partial<
    ...
    >
  >;
type ChatChannelSecurityOptions<
  TResolvedAccount extends {
    accountId?: string | null;
  },
> = {
  dm: {
...
export declare function createChannelPluginBase<TResolvedAccount>(
