...
export declare function inferToolMetaFromArgs(
  toolName: string,
  args: unknown,
  options?: {
 ...
 */
export declare function formatToolProgressOutput(
  output: string,
  options?: {
    maxChars?: number;
  },
 ...
 */
export declare function classifyAgentHarnessTerminalOutcome(
