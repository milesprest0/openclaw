...
export declare function resolveWindowsExecutablePath(
  command: string,
  env: NodeJS.ProcessEnv,
): string;
/** Resolve the safest direct spawn candidate for Windows wrappers, scripts, and binaries. */
export declare function resolveWindowsSpawnProgramCandidate(
...
export declare function resolveWindowsSpawnProgram(
...
export declare function materializeWindowsSpawnProgram(
