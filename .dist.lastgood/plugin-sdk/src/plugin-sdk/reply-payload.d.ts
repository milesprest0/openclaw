...
export declare function normalizeOutboundReplyPayload(
  payload: Record<string, unknown>,
): OutboundReplyPayload;
/** Wrap a deliverer so callers can hand it arbitrary payloads while channels receive normalized data. */
export declare function createNormalizedOutboundDeliverer(
...
export declare function hasOutboundText(
  payload: {
    text?: string;
  },
  options?: {
...
export declare function hasOutboundReplyContent(
  payload: {
    text?: string;
    mediaUrls?: string[];
    mediaUrl?: string;
...
export declare function resolveSendableOutboundReplyParts(
  payload: {
    text?: string;
    mediaUrls?: string[];
    mediaUrl?: string;
...
export declare function resolveTextChunksWithFallback(
  text: string,
  chunks: readonly string[],
): string[];
/** Send media-first payloads intact, or chunk text-only payloads through the caller's transport hooks. */
export declare function sendPayloadWithChunkedTextAndMedia<
  TContext extends {
    payload: object;
  },
  TResult,
...
export declare function formatTextWithAttachmentLinks(
