...
export declare function cleanOldMedia(
  ttlMs?: number,
...
export declare function saveMediaSource(
  source: string,
  headers?: Record<string, string>,
  subdir?: string,
  maxBytes?: number,
): Promise<SavedMedia>;
export declare function saveMediaBuffer(
  buffer: Buffer,
  contentType?: string,
  subdir?: string,
  maxBytes?: number,
...
export declare function readMediaBuffer(
  id: string,
  subdir?: string,
  maxBytes?: number,
