...
export declare function detectLinuxSdBackedStateDir(
  stateDir: string,
  deps?: {
...
export declare function formatLinuxSdBackedStateDirWarning(
  displayStateDir: string,
  linuxSdBackedStateDir: LinuxSdBackedStateDir,
): string;
export declare function detectMacCloudSyncedStateDir(
  stateDir: string,
  deps?: {
    platform?: NodeJS.Platform;
    homedir?: string;
...
export declare function noteStateIntegrity(
  cfg: OpenClawConfig,
