...
export declare function createChannelDoctorEmptyAllowlistPolicyHooks(
...
export declare function collectChannelDoctorCompatibilityMutations(
  cfg: OpenClawConfig,
  options?: {
    env?: NodeJS.ProcessEnv;
  },
): ChannelDoctorConfigMutation[];
export declare function collectChannelDoctorStaleConfigMutations(
  cfg: OpenClawConfig,
  options?: {
    env?: NodeJS.ProcessEnv;
  },
...
export declare function collectChannelDoctorEmptyAllowlistExtraWarnings(
  params: ChannelDoctorEmptyAllowlistLookupParams,
): string[];
export declare function shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning(
  params: ChannelDoctorEmptyAllowlistLookupParams,
): boolean;
export {};
