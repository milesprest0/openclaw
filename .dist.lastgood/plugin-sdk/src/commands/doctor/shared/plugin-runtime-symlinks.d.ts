...
export declare function collectStalePluginRuntimeSymlinks(
  packageRoot: string | null | undefined,
  options?: PluginRuntimeSymlinkOptions,
): Promise<StalePluginRuntimeSymlink[]>;
export declare function noteStalePluginRuntimeSymlinks(
  packageRoot: string | null | undefined,
  options?: PluginRuntimeSymlinkOptions & {
...
export declare function removeStalePluginRuntimeSymlinks(
  packageRoot: string | null | undefined,
  options?: PluginRuntimeSymlinkOptions,
): Promise<{
  changes: string[];
