...
export declare const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV =
  "OPENCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export declare const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV =
...
export declare function preflightPluginRegistryInstallMigration(
  params?: PluginRegistryInstallMigrationParams,
): PluginRegistryInstallMigrationPreflight;
export declare function migratePluginRegistryForInstall(
  params?: PluginRegistryInstallMigrationParams,
