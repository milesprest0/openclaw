...
export declare function resolveStatusUsageSummary(
  timeoutMs?: number,
): Promise<import("../infra/provider-usage.types.ts").UsageSummary>;
export declare function loadStatusProviderUsageModule(): Promise<
  typeof import("../infra/provider-usage.js")
>;
  ...
  [
    {
      ...
      loadedText: string;
      runtime: Awaited<
        ReturnType<typeof import("./status.service-summary.ts").readServiceStatusSummary>
      >["runtime"];
