...
export declare const ensureFlagCompatibility: (opts: { json?: boolean; plain?: boolean }) => void;
...
export declare function resolveModelTarget(params: { raw: string; cfg: OpenClawConfig }): {
  provider: string;
  model: string;
};
...
export declare function upsertCanonicalModelConfigEntry(
...
export declare function mergePrimaryFallbackConfig(
