...
export declare function buildDeliveryFromLegacyPayload(
  payload: Record<string, unknown>,
): Record<string, unknown>;
export declare function buildDeliveryPatchFromLegacyPayload(
  payload: Record<string, unknown>,
): Record<string, unknown> | null;
export declare function mergeLegacyDeliveryInto(
