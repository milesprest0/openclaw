...
export declare function detectRootMemoryFiles(
  workspaceDir: string,
): Promise<RootMemoryFilesDetection>;
export declare function formatRootMemoryFilesWarning(
  detection: RootMemoryFilesDetection,
): string | null;
...
export declare function migrateLegacyRootMemoryFile(
  workspaceDir: string,
