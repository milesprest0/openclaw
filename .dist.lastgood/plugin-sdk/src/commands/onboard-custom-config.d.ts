...
export declare function resolveCustomModelImageInputInference(
  modelId: string,
...
export declare function resolveCustomProviderId(
  params: ResolveCustomProviderIdParams,
): ResolvedCustomProviderId;
export declare function parseNonInteractiveCustomApiFlags(
