...
export declare function ensureObject(
  target: Record<string, unknown>,
  key: string,
): Record<string, unknown>;
export declare function hasConfiguredSecretRef(
  value: unknown,
  defaults: SecretDefaults | undefined,
): boolean;
export type RuntimeWebProviderSurface<
  TProvider extends {
    id: string;
  },
> = {
...
export declare function resolveRuntimeWebProviderSurface<
  TProvider extends {
    id: string;
    requiresCredential?: boolean;
  },
...
export declare function resolveRuntimeWebProviderSelection<
  TProvider extends {
    id: string;
    requiresCredential?: boolean;
  },
