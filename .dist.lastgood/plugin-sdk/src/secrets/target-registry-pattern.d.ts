...
export declare function compileTargetRegistryEntry(
  entry: SecretTargetRegistryEntry,
): CompiledTargetRegistryEntry;
export declare function matchPathTokens(
  segments: string[],
  tokens: PathPatternToken[],
): {
  captures: string[];
} | null;
export declare function materializePathTokens(
  tokens: PathPatternToken[],
  captures: string[],
): string[] | null;
export declare function expandPathTokens(
  root: unknown,
  tokens: PathPatternToken[],
): ExpandedPathMatch[];
