...
export declare function getChannelRecord(
  config: {
    channels?: Record<string, unknown>;
  },
  channelKey: string,
): Record<string, unknown> | undefined;
export declare function getChannelSurface(
  config: {
    channels?: Record<string, unknown>;
  },
  channelKey: string,
...
export declare function resolveChannelAccountSurface(
  channel: Record<string, unknown>,
): ChannelAccountSurface;
export declare function isBaseFieldActiveForChannelSurface(
  surface: ChannelAccountSurface,
  rootKey: string,
): boolean;
export declare function normalizeSecretStringValue(value: unknown): string;
export declare function hasConfiguredSecretInputValue(
  value: unknown,
