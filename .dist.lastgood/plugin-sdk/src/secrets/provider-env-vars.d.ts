...
export declare function resolveProviderAuthEnvVarCandidates(
  params?: ProviderEnvVarLookupParams,
): Record<string, readonly string[]>;
export declare function resolveProviderAuthEvidence(
  params?: ProviderEnvVarLookupParams,
): Record<string, readonly ProviderAuthEvidence[]>;
export declare function resolveProviderEnvVars(
  params?: ProviderEnvVarLookupParams,
): Record<string, readonly string[]>;
/**
...
export declare function getProviderEnvVars(
  providerId: string,
  params?: ProviderEnvVarLookupParams,
): string[];
export declare function listKnownProviderAuthEnvVarNames(
  params?: ProviderEnvVarLookupParams,
): string[];
export declare function listKnownSecretEnvVarNames(params?: ProviderEnvVarLookupParams): string[];
export declare function omitEnvKeysCaseInsensitive(
