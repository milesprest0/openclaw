...
>;
export declare function loadBundledChannelSecretContractApi(
  channelId: string,
...
export declare function loadChannelSecretContractApiForRecord(
...
>;
export declare function loadBundledChannelSecurityContractApi(
  channelId: string,
