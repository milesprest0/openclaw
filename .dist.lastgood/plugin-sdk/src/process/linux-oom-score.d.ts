...
export declare function prepareOomScoreAdjustedSpawn(
  command: string,
  args?: readonly string[],
  options?: OomWrapOptions,
): OomScoreAdjustedSpawn;
export declare function wrapArgvForChildOomScoreRaise(
 ...
 */
export declare function hardenedEnvForChildOomWrap(
