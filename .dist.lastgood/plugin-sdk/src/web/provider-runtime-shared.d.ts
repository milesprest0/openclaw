...
export declare function resolveWebProviderConfig(
  cfg: OpenClawConfig | undefined,
  kind: "search" | "fetch",
): Record<string, unknown> | undefined;
export declare function readWebProviderEnvValue(
  envVars: string[],
  processEnv?: NodeJS.ProcessEnv,
): string | undefined;
export declare function providerRequiresCredential(
  provider: Pick<ProviderWithCredential, "requiresCredential">,
): boolean;
export declare function hasWebProviderEntryCredential<
...
export declare function resolveWebProviderDefinition<
  TProvider extends {
    id: string;
  },
  TConfig extends Record<string, unknown> | undefined,
