 ...
 */
export declare function registerContextEngineForOwner(
  id: string,
 ...
 */
export declare function resolveContextEngineOwnerPluginId(
 ...
 */
export declare function resolveContextEngine(
  config?: OpenClawConfig,
