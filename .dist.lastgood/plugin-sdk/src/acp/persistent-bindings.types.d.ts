...
export declare function toConfiguredAcpBindingRecord(
  spec: ConfiguredAcpBindingSpec,
...
export declare function resolveConfiguredAcpBindingSpecFromRecord(
  record: SessionBindingRecord,
): ConfiguredAcpBindingSpec | null;
export declare function toResolvedConfiguredAcpBinding(
  record: SessionBindingRecord,
