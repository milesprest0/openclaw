...
export declare function validateRuntimeConfigOptionInput(
  rawKey: unknown,
  rawValue: unknown,
): {
  key: string;
...
export declare function validateRuntimeOptionPatch(
  patch: Partial<AcpSessionRuntimeOptions> | undefined,
): Partial<AcpSessionRuntimeOptions>;
export declare function normalizeRuntimeOptions(
...
export declare function resolveRuntimeOptionsFromMeta(
  meta: SessionAcpMeta,
): AcpSessionRuntimeOptions;
export declare function runtimeOptionsEqual(
...
export declare function buildRuntimeConfigOptionPairs(
  options: AcpSessionRuntimeOptions,
): Array<[string, string]>;
export declare function inferRuntimeOptionPatchFromConfigOption(
  key: string,
  value: string,
): Partial<AcpSessionRuntimeOptions>;
