...
export declare function resolveSessionIdentityFromMeta(
  meta: SessionAcpMeta | undefined,
): SessionAcpIdentity | undefined;
export declare function identityHasStableSessionId(
  identity: SessionAcpIdentity | undefined,
): boolean;
export declare function resolveRuntimeResumeSessionId(
  identity: SessionAcpIdentity | undefined,
): string | undefined;
export declare function isSessionIdentityPending(identity: SessionAcpIdentity | undefined): boolean;
export declare function identityEquals(
...
export declare function resolveRuntimeHandleIdentifiersFromIdentity(
  identity: SessionAcpIdentity | undefined,
): {
