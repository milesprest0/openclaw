...
export declare function runConfigUnset(opts: { path: string; runtime?: RuntimeEnv }): Promise<void>;
export declare function runConfigFile(opts: { runtime?: RuntimeEnv }): Promise<void>;
export declare function runConfigSchema(opts?: { runtime?: RuntimeEnv }): Promise<void>;
