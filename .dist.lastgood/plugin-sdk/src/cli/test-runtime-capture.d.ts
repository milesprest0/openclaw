...
export declare function mockRuntimeModule<
  TModule extends {
    defaultRuntime: OutputRuntimeEnv;
  },
>(loadActual: () => Promise<TModule>, defaultRuntime: TModule["defaultRuntime"]): Promise<TModule>;
export declare function spyRuntimeLogs(
  runtime: Pick<OutputRuntimeEnv, "log">,
): import("vitest").Mock<(...args: unknown[]) => void>;
export declare function spyRuntimeErrors(
  runtime: Pick<OutputRuntimeEnv, "error">,
): import("vitest").Mock<(...args: unknown[]) => void>;
export declare function spyRuntimeJson(
  runtime: Pick<OutputRuntimeEnv, "writeJson">,
): import("vitest").Mock<(value: unknown, space?: number) => void>;
