...
export declare function failIfNixDaemonInstallMode(
  fail: (message: string, hints?: string[]) => void,
...
export declare function resolveRuntimeStatusColor(
  status: string | undefined,
): (value: string) => string;
export declare function parsePortFromArgs(programArguments: string[] | undefined): number | null;
export declare function pickProbeHostForBind(
  bindMode: string,
  tailnetIPv4: string | undefined,
  customBindHost?: string,
): string;
export declare function filterDaemonEnv(
...
export declare function renderRuntimeHints(
  runtime:
    | {
        missingUnit?: boolean;
...
export declare function filterContainerGenericHints(
  hints: string[],
  env?: NodeJS.ProcessEnv,
): string[];
