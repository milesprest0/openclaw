...
export declare function resolveFileNpmSpecToLocalPath(raw: string):
  ...
  | null;
export declare function applySlotSelectionForPlugin(
...
export declare function enableInternalHookEntries(
  config: OpenClawConfig,
  hookNames: string[],
): OpenClawConfig;
export declare function formatPluginInstallWithHookFallbackError(
  pluginError: string,
  hookError: string,
): string;
