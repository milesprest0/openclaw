...
export declare const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV =
...
export declare function completionCacheExists(
  shell: CompletionShell,
  binName?: string,
): Promise<boolean>;
export declare function isCompletionInstalled(
  shell: CompletionShell,
  binName?: string,
): Promise<boolean>;
/**
 ...
 */
export declare function usesSlowDynamicCompletion(
  shell: CompletionShell,
  binName?: string,
): Promise<boolean>;
export declare function installCompletion(
  shell: string,
  yes: boolean,
  binName?: string,
): Promise<void>;
