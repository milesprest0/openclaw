...
export declare const ModelsListParamsSchema: Type.TObject<{
  view: Type.TOptional<
    Type.TUnion<[Type.TLiteral<"default">, Type.TLiteral<"configured">, Type.TLiteral<"all">]>
  >;
}>;
...
export declare const SkillsInstallParamsSchema: Type.TUnion<
  [
    Type.TObject<{
      name: Type.TString;
...
>;
export declare const SkillsUpdateParamsSchema: Type.TUnion<
  [
    Type.TObject<{
...
export declare const ToolsEffectiveGroupSchema: Type.TObject<{
  ...
  tools: Type.TArray<
    Type.TObject<{
      ...
      rawDescription: Type.TString;
      source: Type.TUnion<
        [Type.TLiteral<"core">, Type.TLiteral<"plugin">, Type.TLiteral<"channel">]
      >;
      pluginId: Type.TOptional<Type.TString>;
      channelId: Type.TOptional<Type.TString>;
      risk: Type.TOptional<
