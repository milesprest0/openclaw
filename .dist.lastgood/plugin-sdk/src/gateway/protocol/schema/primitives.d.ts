...
export declare const GatewayClientIdSchema: Type.TEnum<
  [
    "openclaw-android",
    "cli",
    "openclaw-control-ui",
...
>;
export declare const GatewayClientModeSchema: Type.TEnum<
  ["backend", "cli", "node", "probe", "test", "ui", "webchat"]
>;
export declare const SecretRefSourceSchema: Type.TUnion<
  [Type.TLiteral<"env">, Type.TLiteral<"file">, Type.TLiteral<"exec">]
>;
export declare const SecretRefSchema: Type.TUnion<
  [
    Type.TObject<{
...
>;
export declare const SecretInputSchema: Type.TUnion<
  [
    Type.TString,
    Type.TUnion<
      [
