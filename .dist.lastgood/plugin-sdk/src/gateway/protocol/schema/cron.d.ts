...
export declare const CronScheduleSchema: Type.TUnion<
  [
    Type.TObject<{
...
>;
export declare const CronPayloadSchema: Type.TUnion<
  [
    Type.TObject<{
...
>;
export declare const CronPayloadPatchSchema: Type.TUnion<
  [
    Type.TObject<{
      kind: Type.TLiteral<"systemEvent">;
...
export declare const CronDeliverySchema: Type.TUnion<
  [
    Type.TObject<{
      channel: Type.TOptional<Type.TUnion<[Type.TLiteral<"last">, Type.TString]>>;
...
export declare const CronDeliveryPatchSchema: Type.TObject<{
  ...
  >;
  mode: Type.TOptional<
    Type.TUnion<[Type.TLiteral<"none">, Type.TLiteral<"announce">, Type.TLiteral<"webhook">]>
  >;
  to: Type.TOptional<Type.TString>;
}>;
...
export declare const CronUpdateParamsSchema: Type.TUnion<
  [
    Type.TObject<{
      id: Type.TString;
    }>,
...
>;
export declare const CronRemoveParamsSchema: Type.TUnion<
  [
    Type.TObject<{
      id: Type.TString;
    }>,
...
>;
export declare const CronRunParamsSchema: Type.TUnion<
  [
    Type.TObject<{
      id: Type.TString;
    }>,
