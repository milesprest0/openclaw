...
export declare const CommandSourceSchema: Type.TUnion<
  [Type.TLiteral<"native">, Type.TLiteral<"skill">, Type.TLiteral<"plugin">]
>;
export declare const CommandScopeSchema: Type.TUnion<
  [Type.TLiteral<"text">, Type.TLiteral<"native">, Type.TLiteral<"both">]
>;
export declare const CommandCategorySchema: Type.TUnion<
  [
