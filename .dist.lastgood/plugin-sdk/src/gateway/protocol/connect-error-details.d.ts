...
export type ConnectPairingRequiredDetails = Pick<
  ...
  "reason" | "requestId"
>;
export declare function resolveAuthConnectErrorDetailCode(
  reason: string | undefined,
): ConnectErrorDetailCode;
export declare function resolveDeviceAuthConnectErrorDetailCode(
  reason: string | undefined,
): ConnectErrorDetailCode;
export declare function readConnectErrorDetailCode(details: unknown): string | null;
export declare function readConnectErrorRecoveryAdvice(
  details: unknown,
): ConnectErrorRecoveryAdvice;
export declare function normalizePairingConnectRequestId(value: unknown): string | undefined;
export declare function describePairingConnectRequirement(
  reason: ConnectPairingRequiredReason | undefined,
): string;
export declare function buildPairingConnectErrorMessage(
  reason: ConnectPairingRequiredReason | undefined,
): string;
export declare function buildPairingConnectRecoveryTitle(
  reason: ConnectPairingRequiredReason | undefined,
): string;
...
export declare function readPairingConnectErrorDetails(
  details: unknown,
): PairingConnectErrorDetails | null;
export declare function readConnectPairingRequiredDetails(
  details: unknown,
): ConnectPairingRequiredDetails | null;
export declare function readConnectPairingRequiredMessage(
