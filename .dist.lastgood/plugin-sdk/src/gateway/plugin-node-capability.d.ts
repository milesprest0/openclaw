...
export declare function indexPluginNodeCapabilitySurfaces(
...
export declare function resolvePluginNodeCapabilityTtlMs(
  surface: PluginNodeCapabilitySurface,
): number;
export declare function mintPluginNodeCapabilityToken(): string;
export declare function buildPluginNodeCapabilityScopedHostUrl(
  baseUrl: string,
  capability: string,
): string | undefined;
export declare function replacePluginNodeCapabilityInScopedHostUrl(
  scopedUrl: string,
  capability: string,
): string | undefined;
export declare function normalizePluginNodeCapabilityScopedUrl(
  rawUrl: string,
