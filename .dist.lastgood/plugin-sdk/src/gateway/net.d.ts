...
export declare function isTrustedProxyAddress(
  ip: string | undefined,
...
export declare function resolveRequestClientIp(
  req?: IncomingMessage,
  trustedProxies?: string[],
  allowRealIpFallback?: boolean,
): string | undefined;
 ...
 */
export declare function resolveGatewayBindHost(
...
export declare function resolveGatewayListenHosts(
  bindHost: string,
  opts?: {
 ...
 */
export declare function isSecureWebSocketUrl(
  url: string,
  opts?: {
