...
export declare function deriveSessionTitle(
 ...
 */
export declare function resolveDeletedAgentIdFromSessionKey(
  cfg: OpenClawConfig,
  sessionKey: string,
): string | null;
...
export declare function resolveFreshestSessionStoreMatchFromStoreKeys(
  store: Record<string, SessionEntry>,
  storeKeys: string[],
):
  | {
  ...
  | undefined;
export declare function resolveFreshestSessionEntryFromStoreKeys(
  store: Record<string, SessionEntry>,
  storeKeys: string[],
 ...
 */
export declare function findStoreKeysIgnoreCase(
...
export declare function classifySessionKey(
  key: string,
  entry?: SessionEntry,
...
export declare function getSessionDefaults(
  cfg: OpenClawConfig,
  modelCatalog?: ModelCatalogEntry[],
  options?: {
...
export declare function resolveSessionModelRef(
  cfg: OpenClawConfig,
  entry?:
    | SessionEntry
...
export declare function resolveSessionModelIdentityRef(
  cfg: OpenClawConfig,
  entry?:
    | SessionEntry
    | Pick<SessionEntry, "model" | "modelProvider" | "modelOverride" | "providerOverride">,
...
export declare function loadGatewaySessionRow(
  sessionKey: string,
  options?: {
    includeDerivedTitles?: boolean;
    includeLastMessage?: boolean;
