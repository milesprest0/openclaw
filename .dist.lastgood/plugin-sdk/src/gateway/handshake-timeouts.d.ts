...
export declare function clampConnectChallengeTimeoutMs(
  timeoutMs: number,
  maxTimeoutMs?: number,
): number;
export declare function getConnectChallengeTimeoutMsFromEnv(
  env?: NodeJS.ProcessEnv,
): number | undefined;
export declare function resolveConnectChallengeTimeoutMs(
