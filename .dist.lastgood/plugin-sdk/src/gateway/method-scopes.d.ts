...
export declare function resolveRequiredOperatorScopeForMethod(
  method: string,
): OperatorScope | undefined;
export declare function resolveLeastPrivilegeOperatorScopesForMethod(
  method: string,
): OperatorScope[];
export declare function authorizeOperatorScopesForMethod(
  method: string,
