 ...
 */
export declare function setDefaultSecurityHeaders(
  res: ServerResponse,
  opts?: {
...
export declare function sendGatewayAuthFailure(
  res: ServerResponse,
  authResult: GatewayAuthResult,
): void;
export declare function sendInvalidRequest(res: ServerResponse, message: string): void;
export declare function readJsonBodyOrError(
  req: IncomingMessage,
  res: ServerResponse,
  maxBytes: number,
): Promise<unknown>;
...
export declare function watchClientDisconnect(
  req: IncomingMessage,
  res: ServerResponse,
