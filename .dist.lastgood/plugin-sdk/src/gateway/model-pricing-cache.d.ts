...
export declare function collectConfiguredModelPricingRefs(
  config: OpenClawConfig,
  options?: {
    manifestRegistry?: PluginManifestRegistry;
  },
): ModelRef[];
export declare function refreshGatewayModelPricingCache(
  params: GatewayModelPricingRefreshParams,
): Promise<void>;
export declare function startGatewayModelPricingRefresh(
  params: GatewayModelPricingRefreshParams,
): () => void;
