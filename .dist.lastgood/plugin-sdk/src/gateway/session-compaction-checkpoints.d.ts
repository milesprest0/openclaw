...
export declare function readSessionLeafIdFromTranscriptAsync(
  sessionFile: string,
  maxBytes?: number,
): Promise<string | null>;
...
export declare function cleanupCompactionCheckpointSnapshot(
...
export declare function listSessionCompactionCheckpoints(
