...
export declare function isSupportedGatewaySecretInputPath(
  path: string,
): path is SupportedGatewaySecretInputPath;
export declare function readGatewaySecretInputValue(
...
export declare function isTokenGatewaySecretInputPath(
  path: SupportedGatewaySecretInputPath,
): boolean;
