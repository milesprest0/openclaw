...
export declare function buildBootstrapTruncationSignature(
...
export declare function appendBootstrapPromptWarning(
  prompt: string,
  warningLines?: string[],
  options?: {
...
export declare function buildBootstrapPromptWarningNotice(
  warningLines?: string[],
): string | undefined;
