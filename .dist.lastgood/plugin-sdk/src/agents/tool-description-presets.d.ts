...
export declare const SESSIONS_LIST_TOOL_DISPLAY_SUMMARY =
  "List visible sessions with mailbox filters and optional previews.";
export declare const SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY =
  "Read sanitized message history for a visible session.";
export declare const SESSIONS_SEND_TOOL_DISPLAY_SUMMARY =
...
export declare const SESSION_STATUS_TOOL_DISPLAY_SUMMARY =
  "Show session status, usage, and model state.";
