...
export declare function resolveUserTimeFormat(
...
export declare function normalizeTimestamp(raw: unknown):
  ...
  | undefined;
export declare function withNormalizedTimestamp<T extends Record<string, unknown>>(
  value: T,
...
export declare function formatUserTime(
  date: Date,
  timeZone: string,
