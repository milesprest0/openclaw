...
export declare function listSubagentRunsForController(
...
export declare function getSubagentRunByChildSessionKey(
  childSessionKey: string,
): SubagentRunRecord | null;
export declare function isSubagentRunLive(
  entry: Pick<SubagentRunRecord, "runId" | "endedAt"> | null | undefined,
): boolean;
export declare function getSessionDisplaySubagentRunByChildSessionKey(
  childSessionKey: string,
): SubagentRunRecord | null;
export declare function getLatestSubagentRunByChildSessionKey(
  childSessionKey: string,
): SubagentRunRecord | null;
