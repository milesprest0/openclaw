...
export declare function resolveProvidersForModelsJsonWithDeps(
  params: {
    cfg: OpenClawConfig;
    agentDir: string;
    env: NodeJS.ProcessEnv;
...
export declare function planOpenClawModelsJsonWithDeps(
  params: {
    cfg: OpenClawConfig;
...
export declare function planOpenClawModelsJson(
