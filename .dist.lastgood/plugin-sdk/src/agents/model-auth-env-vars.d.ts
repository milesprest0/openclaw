...
export declare function resolveProviderEnvApiKeyCandidates(
  params?: ProviderEnvVarLookupParams,
): Record<string, readonly string[]>;
export declare function resolveProviderEnvAuthEvidence(
  params?: ProviderEnvVarLookupParams,
...
export declare function resolveProviderEnvAuthLookupKeys(
  params?: ProviderEnvVarLookupParams,
): string[];
