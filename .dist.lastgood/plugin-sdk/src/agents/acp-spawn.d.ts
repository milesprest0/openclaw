...
export declare const ACP_SPAWN_ERROR_CODES: readonly [
  "acp_disabled",
...
export declare function isSpawnAcpAcceptedResult(
  result: SpawnAcpResult,
): result is SpawnAcpAcceptedResult;
export declare const ACP_SPAWN_ACCEPTED_NOTE =
  "initial ACP task queued in isolated session; follow-ups continue in the bound thread.";
export declare const ACP_SPAWN_SESSION_ACCEPTED_NOTE =
