...
declare function prepareAgentCommandExecution(
  ...
  outboundSession:
    | import("../infra/outbound/session-context.js").OutboundSessionContext
    | undefined;
  workspaceDir: string;
  agentDir: string;
  runId: string;
...
export declare function agentCommand(
  opts: AgentCommandOpts,
  runtime?: RuntimeEnv,
  deps?: CliDeps,
): Promise<
  | {
      ...
      meta: import("./pi-embedded.ts").EmbeddedPiRunMeta &
        import("./command/types.js").AgentCommandResultMetaOverrides;
...
>;
export declare function agentCommandFromIngress(
