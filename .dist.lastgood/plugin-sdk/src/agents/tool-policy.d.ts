...
export declare function resolveOwnerOnlyToolApprovalClass(
  name: string,
 ...
 */
export declare function applyOwnerOnlyToolPolicy(
  tools: AnyAgentTool[],
...
export declare function collectExplicitAllowlist(
  policies: Array<ToolPolicyLike | undefined>,
): string[];
export declare function collectExplicitDenylist(
  policies: Array<ToolPolicyLike | undefined>,
): string[];
export declare function buildPluginToolGroups<
  T extends {
    name: string;
  },
>(params: {
...
export declare function expandPluginGroups(
  list: string[] | undefined,
  groups: PluginToolGroups,
): string[] | undefined;
export declare function expandPolicyWithPluginGroups(
  policy: ToolPolicyLike | undefined,
  groups: PluginToolGroups,
): ToolPolicyLike | undefined;
export declare function analyzeAllowlistByToolType(
  policy: ToolPolicyLike | undefined,
  groups: PluginToolGroups,
  coreTools: Set<string>,
): AllowlistResolution;
export declare function mergeAlsoAllowPolicy<
  TPolicy extends {
    allow?: string[];
  },
