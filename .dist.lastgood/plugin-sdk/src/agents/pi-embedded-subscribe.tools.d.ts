...
export declare function filterToolResultMediaUrls(
...
export declare function extractToolResultMediaArtifact(
  result: unknown,
...
export declare function extractMessagingToolSend(
  toolName: string,
