...
export declare function resolveDockerSpawnInvocation(
  args: string[],
  runtime?: DockerSpawnRuntime,
): {
  command: string;
  args: string[];
  shell?: boolean;
...
export declare function execDockerRaw(
  args: string[],
...
export declare function execDocker(
  args: string[],
  opts?: ExecDockerOptions,
): Promise<{
  stdout: string;
  stderr: string;
  code: number;
}>;
export declare function readDockerContainerLabel(
  containerName: string,
  label: string,
): Promise<string | null>;
export declare function readDockerContainerEnvVar(
  containerName: string,
  envVar: string,
): Promise<string | null>;
