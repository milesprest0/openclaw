...
export declare function inspectLegacySandboxRegistryFiles(): Promise<
  LegacySandboxRegistryInspection[]
>;
export declare function migrateLegacySandboxRegistryFiles(): Promise<
  LegacySandboxRegistryMigrationResult[]
>;
export declare function readRegistryEntry(
  containerName: string,
