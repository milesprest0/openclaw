...
export declare function registerExecApprovalRequest(
...
export declare function requestExecApprovalDecision(
  params: RequestExecApprovalDecisionParams,
): Promise<string | null>;
...
export declare function buildExecApprovalTurnSourceContext(
  params: ExecApprovalTurnSourceContext,
): ExecApprovalTurnSourceContext;
export declare function requestExecApprovalDecisionForHost(
  params: HostExecApprovalParams,
): Promise<string | null>;
export declare function registerExecApprovalRequestForHost(
  params: HostExecApprovalParams,
): Promise<ExecApprovalRegistration>;
export declare function registerExecApprovalRequestForHostOrThrow(
  params: HostExecApprovalParams,
): Promise<ExecApprovalRegistration>;
export {};
