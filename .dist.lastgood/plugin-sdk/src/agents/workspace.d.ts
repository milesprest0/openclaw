...
export declare function resolveWorkspaceBootstrapStatus(
  dir: string,
): Promise<"pending" | "complete">;
export declare function isWorkspaceBootstrapPending(dir: string): Promise<boolean>;
export declare function reconcileWorkspaceBootstrapCompletion(
  dir: string,
...
export declare function filterBootstrapFilesForSession(
  files: WorkspaceBootstrapFile[],
  sessionKey?: string,
): WorkspaceBootstrapFile[];
export declare function loadExtraBootstrapFiles(
  dir: string,
  extraPatterns: string[],
): Promise<WorkspaceBootstrapFile[]>;
export declare function loadExtraBootstrapFilesWithDiagnostics(
  dir: string,
  extraPatterns: string[],
): Promise<{
  files: WorkspaceBootstrapFile[];
