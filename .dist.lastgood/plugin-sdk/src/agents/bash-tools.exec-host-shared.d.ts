...
export declare function buildDefaultExecApprovalRequestArgs(
  params: DefaultExecApprovalRequestArgs,
): DefaultExecApprovalRequestArgs;
export declare function buildExecApprovalFollowupTarget(
...
export declare function sendExecApprovalFollowupResult(
