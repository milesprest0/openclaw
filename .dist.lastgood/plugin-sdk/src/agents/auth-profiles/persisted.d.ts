...
export declare function mergeAuthProfileStores(
  base: AuthProfileStore,
  override: AuthProfileStore,
): AuthProfileStore;
export declare function buildPersistedAuthProfileSecretsStore(
...
export declare function applyLegacyAuthStore(
  store: AuthProfileStore,
