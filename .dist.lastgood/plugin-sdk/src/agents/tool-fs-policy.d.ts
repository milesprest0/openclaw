...
export declare function createToolFsPolicy(params: { workspaceOnly?: boolean }): ToolFsPolicy;
export declare function resolveToolFsConfig(params: { cfg?: OpenClawConfig; agentId?: string }): {
