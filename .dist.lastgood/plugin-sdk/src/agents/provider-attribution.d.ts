...
export declare function resolveProviderEndpoint(
  baseUrl: string | null | undefined,
): ProviderEndpointResolution;
export declare function resolveProviderAttributionIdentity(
  env?: RuntimeVersionEnv,
): ProviderAttributionIdentity;
export declare function listProviderAttributionPolicies(
  env?: RuntimeVersionEnv,
): ProviderAttributionPolicy[];
export declare function resolveProviderAttributionPolicy(
  provider?: string | null,
  env?: RuntimeVersionEnv,
): ProviderAttributionPolicy | undefined;
export declare function resolveProviderAttributionHeaders(
  provider?: string | null,
  env?: RuntimeVersionEnv,
): Record<string, string> | undefined;
export declare function resolveProviderRequestPolicy(
  input: ProviderRequestPolicyInput,
  env?: RuntimeVersionEnv,
): ProviderRequestPolicyResolution;
export declare function resolveProviderRequestAttributionHeaders(
  input: ProviderRequestPolicyInput,
  env?: RuntimeVersionEnv,
): Record<string, string> | undefined;
export declare function resolveProviderRequestCapabilities(
  input: ProviderRequestCapabilitiesInput,
  env?: RuntimeVersionEnv,
): ProviderRequestCapabilities;
export declare function describeProviderRequestRoutingSummary(
  input: ProviderRequestPolicyInput,
  env?: RuntimeVersionEnv,
): string;
export {};
