 ...
 */
export declare function stripThoughtSignatures<T>(
  content: T,
...
export declare function resolveBootstrapPromptTruncationWarningMode(
  cfg?: OpenClawConfig,
): "off" | "once" | "always";
...
export declare function buildBootstrapContextFiles(
