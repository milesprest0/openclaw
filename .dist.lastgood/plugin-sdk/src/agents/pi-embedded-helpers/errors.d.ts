...
export declare function extractObservedOverflowTokenCount(
  errorMessage?: string,
): number | undefined;
...
export declare function classifyFailoverReasonFromHttpStatus(
...
export declare function classifyFailoverSignal(
  signal: FailoverSignal,
): FailoverClassification | null;
export declare function classifyProviderRuntimeFailureKind(
  signal: FailoverSignal | string,
): ProviderRuntimeFailureKind;
export declare function formatAssistantErrorText(
...
export declare function classifyFailoverReason(
  raw: string,
  opts?: {
    provider?: string;
  },
): FailoverReason | null;
export declare function isFailoverErrorMessage(
  raw: string,
  opts?: {
    provider?: string;
  },
