...
export declare function extractToolCallsFromAssistant(
  msg: Extract<
    AgentMessage,
    {
      role: "assistant";
...
export declare function extractToolResultId(
  msg: Extract<
    AgentMessage,
    {
      role: "toolResult";
 ...
 */
export declare function sanitizeToolCallIdsForCloudCodeAssist(
