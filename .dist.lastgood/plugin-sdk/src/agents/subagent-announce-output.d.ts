...
export declare function withSubagentOutcomeTiming(
...
export declare function readSubagentOutput(
  sessionKey: string,
  outcome?: SubagentRunOutcome,
...
export declare function waitForSubagentRunOutcome(
  runId: string,
  timeoutMs: number,
...
export declare function captureSubagentCompletionReply(
  sessionKey: string,
  options?: {
...
export declare function buildChildCompletionFindings(
  children: Array<{
...
export declare function dedupeLatestChildCompletionRows(
  children: Array<{
    childSessionKey: string;
    task: string;
    label?: string;
...
export declare function filterCurrentDirectChildCompletionRows(
  children: Array<{
    runId: string;
    childSessionKey: string;
