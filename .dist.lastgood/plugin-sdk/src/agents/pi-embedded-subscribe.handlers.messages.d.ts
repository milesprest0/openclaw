...
export declare function consumePendingToolMediaIntoReply(
  state: Pick<
    EmbeddedPiSubscribeState,
...
export declare function consumePendingToolMediaReply(
  state: Pick<
    EmbeddedPiSubscribeState,
    "pendingToolMediaUrls" | "pendingToolAudioAsVoice" | "pendingToolTrustedLocalMedia"
  >,
): BlockReplyPayload | null;
export declare function readPendingToolMediaReply(
  state: Pick<
    EmbeddedPiSubscribeState,
    "pendingToolMediaUrls" | "pendingToolAudioAsVoice" | "pendingToolTrustedLocalMedia"
  >,
): BlockReplyPayload | null;
export declare function recordPendingAssistantReplyDirectives(
  state: Pick<EmbeddedPiSubscribeState, "pendingAssistantReplyDirectives">,
  parsed: ReplyDirectiveParseResult | null | undefined,
): void;
export declare function consumePendingAssistantReplyDirectivesIntoReply(
  state: Pick<EmbeddedPiSubscribeState, "pendingAssistantReplyDirectives">,
  payload: BlockReplyPayload,
): BlockReplyPayload;
...
export declare function handleMessageStart(
  ctx: EmbeddedPiSubscribeContext,
  evt: AgentEvent & {
    message: AgentMessage;
  },
): void;
export declare function handleMessageUpdate(
  ctx: EmbeddedPiSubscribeContext,
  evt: AgentEvent & {
    message: AgentMessage;
...
export declare function handleMessageEnd(
  ctx: EmbeddedPiSubscribeContext,
  evt: AgentEvent & {
    message: AgentMessage;
  },
