...
export declare function applyImageModelConfigDefaults(
  cfg: OpenClawConfig | undefined,
  imageModelConfig: ImageModelConfig,
): OpenClawConfig | undefined;
export declare function applyImageGenerationModelConfigDefaults(
  cfg: OpenClawConfig | undefined,
  imageGenerationModelConfig: ToolModelConfig,
): OpenClawConfig | undefined;
export declare function applyVideoGenerationModelConfigDefaults(
  cfg: OpenClawConfig | undefined,
  videoGenerationModelConfig: ToolModelConfig,
): OpenClawConfig | undefined;
export declare function applyMusicGenerationModelConfigDefaults(
  cfg: OpenClawConfig | undefined,
...
export declare function resolveRemoteMediaSsrfPolicy(
  cfg: OpenClawConfig | undefined,
...
export declare function readBooleanToolParam(
...
export declare function buildTaskRunDetails(
  handle: TaskRunDetailHandle | null | undefined,
): Record<string, unknown>;
export declare function resolveMediaToolLocalRoots(
...
export declare function resolvePromptAndModelOverride(
  args: Record<string, unknown>,
