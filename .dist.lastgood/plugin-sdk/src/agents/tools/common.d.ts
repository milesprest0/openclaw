...
export declare function createActionGate<T extends Record<string, boolean | undefined>>(
  actions: T | undefined,
): ActionGate<T>;
export declare function readStringParam(
...
export declare function readStringArrayParam(
  params: Record<string, unknown>,
  key: string,
  options: StringParamOptions & {
    required: true;
...
export declare function readReactionParams(
  params: Record<string, unknown>,
  options: {
    emojiKey?: string;
    removeKey?: string;
...
export declare function textResult<TDetails>(
  text: string,
  details: TDetails,
): AgentToolResult<TDetails>;
export declare function failedTextResult<
  TDetails extends {
    status: "failed";
  },
...
export declare function wrapOwnerOnlyToolExecution(
  tool: AnyAgentTool,
