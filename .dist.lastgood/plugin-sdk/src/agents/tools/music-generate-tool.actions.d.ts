...
export declare function createMusicGenerateListActionResult(
  config?: OpenClawConfig,
): MusicGenerateActionResult;
export declare function createMusicGenerateStatusActionResult(
  sessionKey?: string,
): MusicGenerateActionResult;
export declare function createMusicGenerateDuplicateGuardResult(
  sessionKey?: string,
