...
export declare function readConfiguredSecretString(
  value: unknown,
  path: string,
): string | undefined;
export declare function readProviderEnvValue(envVars: string[]): string | undefined;
export declare function withTrustedWebSearchEndpoint<T>(
  params: {
    url: string;
...
export declare function withSelfHostedWebSearchEndpoint<T>(
  params: {
    url: string;
    timeoutSeconds: number;
    init: RequestInit;
...
export declare function postTrustedWebToolsJson<T>(
  params: {
    url: string;
    timeoutSeconds: number;
    apiKey: string;
...
export declare function throwWebSearchApiError(
  res: Response,
...
export declare function normalizeFreshness(
  value: string | undefined,
  provider: "brave" | "perplexity",
): string | undefined;
export declare function readCachedSearchPayload(
  cacheKey: string,
): Record<string, unknown> | undefined;
export declare function buildSearchCacheKey(
  parts: Array<string | number | boolean | undefined>,
): string;
export declare function writeCachedSearchPayload(
  cacheKey: string,
  payload: Record<string, unknown>,
  ttlMs: number,
): void;
export declare function buildUnsupportedSearchFilterResponse(
