...
export declare function sanitizeNonEmptyTransportPayloadText(
  text: string,
  fallback?: string,
): string;
export declare function coerceTransportToolCallArguments(
  argumentsValue: unknown,
): Record<string, unknown>;
export declare function mergeTransportHeaders(
  ...headerSources: Array<Record<string, string> | undefined>
): Record<string, string> | undefined;
export declare function mergeTransportMetadata<T extends Record<string, unknown>>(
  payload: T,
