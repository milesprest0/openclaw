...
export declare function buildCompactionSummarizationInstructions(
  customInstructions?: string,
  instructions?: CompactionSummarizationInstructions,
): string | undefined;
export declare function estimateMessagesTokens(messages: AgentMessage[]): number;
export declare function splitMessagesByTokenShare(
  messages: AgentMessage[],
  parts?: number,
): AgentMessage[][];
export declare const SUMMARIZATION_OVERHEAD_TOKENS = 4096;
export declare function chunkMessagesByMaxTokens(
  messages: AgentMessage[],
  maxTokens: number,
): AgentMessage[][];
/**
 ...
 */
export declare function computeAdaptiveChunkRatio(
  messages: AgentMessage[],
