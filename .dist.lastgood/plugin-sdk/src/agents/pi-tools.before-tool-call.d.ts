 ...
 */
export declare function isBeforeToolCallBlockedError(
  err: unknown,
): err is BeforeToolCallBlockedError;
declare function buildAdjustedParamsKey(params: { runId?: string; toolCallId: string }): string;
declare function mergeParamsWithApprovalOverrides(
...
export declare function wrapToolWithBeforeToolCallHook(
  tool: AnyAgentTool,
  ctx?: HookContext,
): AnyAgentTool;
export declare function isToolWrappedWithBeforeToolCallHook(tool: AnyAgentTool): boolean;
export declare function consumeAdjustedParamsForToolCall(
  toolCallId: string,
  runId?: string,
): unknown;
