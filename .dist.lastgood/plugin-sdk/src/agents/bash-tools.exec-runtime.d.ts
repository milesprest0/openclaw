...
export declare function renderExecTargetLabel(
  target: ExecTarget,
): "auto" | "gateway" | "node" | "sandbox";
...
export declare function applyShellPath(
...
export declare function emitExecSystemEvent(
  text: string,
  opts: {
    sessionKey?: string;
    contextKey?: string;
