...
declare function buildOpenAIClientHeaders(
  model: Model<Api>,
  context: Context,
...
declare function buildOpenAISdkRequestOptions(
  model: Model<Api>,
  signal?: AbortSignal,
):
  | {
  ...
  | undefined;
declare function createOpenAIResponsesClient(
  model: Model<Api>,
  context: Context,
  apiKey: string,
  optionHeaders?: Record<string, string>,
...
declare function sanitizeOpenAICodexResponsesParams<T extends Record<string, unknown>>(
  model: Model<Api>,
  params: T,
): T;
export declare function buildOpenAIResponsesParams(
  model: Model<Api>,
  context: Context,
...
declare function createAzureOpenAIClient(
  model: Model<Api>,
  context: Context,
  apiKey: string,
  optionHeaders?: Record<string, string>,
...
declare function createOpenAICompletionsClient(
  model: Model<Api>,
  context: Context,
  apiKey: string,
  optionHeaders?: Record<string, string>,
): OpenAI;
declare function buildOpenAICompletionsClientConfig(
  model: Model<Api>,
  context: Context,
  optionHeaders?: Record<string, string>,
): {
...
declare function processOpenAICompletionsStream(
...
export declare function buildOpenAICompletionsParams(
  model: OpenAIModeModel,
  context: Context,
  options: OpenAICompletionsOptions | undefined,
): Record<string, unknown>;
export declare function parseTransportChunkUsage(
