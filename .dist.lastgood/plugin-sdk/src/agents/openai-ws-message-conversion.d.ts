...
export declare function convertMessagesToInputItems(
  messages: Message[],
  modelOverride?: ReplayModelInfo,
): InputItem[];
export declare function buildAssistantMessageFromResponse(
...
export declare function convertResponseToInputItems(
  response: ResponseObject,
  modelInfo: {
    api: string;
    provider: string;
