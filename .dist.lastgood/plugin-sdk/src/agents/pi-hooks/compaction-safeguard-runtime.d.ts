...
export declare const setCompactionSafeguardRuntime: (
  sessionManager: unknown,
  value: CompactionSafeguardRuntimeValue | null,
) => void;
export declare const getCompactionSafeguardRuntime: (
  sessionManager: unknown,
) => CompactionSafeguardRuntimeValue | null;
export declare function setCompactionSafeguardCancelReason(
  sessionManager: unknown,
  reason: string | undefined,
): void;
export declare function consumeCompactionSafeguardCancelReason(
  sessionManager: unknown,
): string | null;
