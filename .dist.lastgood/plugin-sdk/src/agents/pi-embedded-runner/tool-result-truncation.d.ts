 ...
 */
export declare function truncateToolResultText(
  text: string,
  maxChars: number,
...
export declare function calculateMaxToolResultCharsWithCap(
 ...
 */
export declare function truncateToolResultMessage(
  msg: AgentMessage,
  maxChars: number,
  options?: ToolResultTruncationOptions,
): AgentMessage;
 ...
 */
export declare function truncateOversizedToolResultsInMessages(
 ...
 */
export declare function isOversizedToolResult(
  msg: AgentMessage,
  contextWindowTokens: number,
  maxCharsOverride?: number,
): boolean;
