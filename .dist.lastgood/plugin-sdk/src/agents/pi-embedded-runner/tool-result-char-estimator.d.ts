...
export declare function estimateMessageCharsCached(
  msg: AgentMessage,
  cache: MessageCharEstimateCache,
): number;
export declare function estimateContextChars(
  messages: AgentMessage[],
  cache: MessageCharEstimateCache,
): number;
export declare function invalidateMessageCharsCacheEntry(
  cache: MessageCharEstimateCache,
  msg: AgentMessage,
): void;
