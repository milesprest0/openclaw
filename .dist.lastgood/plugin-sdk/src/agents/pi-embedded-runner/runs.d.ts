...
export declare function queueEmbeddedPiMessage(
  sessionId: string,
  text: string,
...
export declare function abortEmbeddedPiRun(
  sessionId: undefined,
  opts: {
    mode: "all" | "compacting";
  },
...
export declare function resolveActiveEmbeddedRunHandleSessionId(
  sessionKey: string,
): string | undefined;
export declare function resolveActiveEmbeddedRunSessionId(sessionKey: string): string | undefined;
export declare function getActiveEmbeddedRunSnapshot(
  sessionId: string,
): ActiveEmbeddedRunSnapshot | undefined;
export declare function requestEmbeddedRunModelSwitch(
  sessionId: string,
  request: EmbeddedRunModelSwitchRequest,
): boolean;
export declare function consumeEmbeddedRunModelSwitch(
  sessionId: string,
 ...
 */
export declare function waitForActiveEmbeddedRuns(
  timeoutMs?: number,
  opts?: {
    pollMs?: number;
  },
...
export declare function setActiveEmbeddedRun(
  sessionId: string,
  handle: EmbeddedPiQueueHandle,
  sessionKey?: string,
): void;
export declare function updateActiveEmbeddedRunSnapshot(
  sessionId: string,
  snapshot: ActiveEmbeddedRunSnapshot,
): void;
export declare function clearActiveEmbeddedRun(
  sessionId: string,
  handle: EmbeddedPiQueueHandle,
  sessionKey?: string,
): void;
export declare function forceClearEmbeddedPiRun(
  sessionId: string,
  sessionKey?: string,
  reason?: string,
): boolean;
