...
export declare const PRUNED_HISTORY_IMAGE_MARKER =
  "[image data removed - already processed by model]";
export declare const PRUNED_HISTORY_MEDIA_REFERENCE_MARKER =
 ...
 */
export declare function pruneProcessedHistoryImages(
  messages: AgentMessage[],
): AgentMessage[] | null;
export declare function installHistoryImagePruneContextTransform(
