...
export declare function resolveAssistantMessageFamily(params: {
  assistant?: {
    provider?: string;
    model?: string;
  } | null;
...
export declare function resolveFinalAssistantVisibleText(
  lastAssistant: AssistantMessage | undefined,
): string | undefined;
export declare function resolveFinalAssistantRawText(
  lastAssistant: AssistantMessage | undefined,
): string | undefined;
export {};
