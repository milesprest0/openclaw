...
type BranchSummaryEntry = Extract<
  SessionEntry,
  {
    type: "branch_summary";
  }
>;
type CompactionEntry = Extract<
  SessionEntry,
  {
    type: "compaction";
  }
>;
type CustomEntry = Extract<
  SessionEntry,
  {
    type: "custom";
  }
>;
type CustomMessageEntry = Extract<
  SessionEntry,
  {
    type: "custom_message";
  }
>;
type LabelEntry = Extract<
  SessionEntry,
  {
    type: "label";
  }
>;
type ModelChangeEntry = Extract<
  SessionEntry,
  {
    type: "model_change";
  }
>;
type SessionInfoEntry = Extract<
  SessionEntry,
  {
    type: "session_info";
  }
>;
type SessionMessageEntry = Extract<
  SessionEntry,
  {
    type: "message";
  }
...
export declare function writeTranscriptFileAtomic(
  filePath: string,
