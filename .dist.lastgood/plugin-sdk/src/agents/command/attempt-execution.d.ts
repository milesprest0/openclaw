...
export declare function emitAcpLifecycleStart(params: { runId: string; startedAt: number }): void;
export declare function emitAcpLifecycleEnd(params: { runId: string }): void;
export declare function emitAcpLifecycleError(params: { runId: string; message: string }): void;
