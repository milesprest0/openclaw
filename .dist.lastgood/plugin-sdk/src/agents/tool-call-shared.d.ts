...
export declare const SESSIONS_SPAWN_ATTACHMENT_METADATA_KEYS: readonly [
  "name",
  "encoding",
  "mimeType",
];
export declare function normalizeAllowedToolNames(
  allowedToolNames?: Iterable<string>,
): Set<string> | null;
export declare function isAllowedToolCallName(
  name: unknown,
...
export declare function hasUnredactedSessionsSpawnAttachments(
