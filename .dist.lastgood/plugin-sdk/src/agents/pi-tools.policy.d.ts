...
export declare function resolveSubagentToolPolicy(
  cfg?: OpenClawConfig,
  depth?: number,
): SandboxToolPolicy;
export declare function resolveSubagentToolPolicyForSession(
...
export declare function filterToolsByPolicy(
  tools: AnyAgentTool[],
