...
export declare function imageFileExtensionForMimeType(
  mimeType: string | undefined,
  fallback?: string,
): string;
export declare function sniffImageMimeType(
  buffer: Buffer,
...
export declare function generatedImageAssetFromOpenAiCompatibleEntry(
...
export declare function parseOpenAiCompatibleImageResponse(
