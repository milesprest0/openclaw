...
export declare function configureCommitmentExtractionRuntime(
  next: CommitmentExtractionRuntime,
): void;
export declare function resetCommitmentExtractionRuntimeForTests(): void;
export declare function enqueueCommitmentExtraction(
  input: CommitmentExtractionEnqueueInput,
): boolean;
