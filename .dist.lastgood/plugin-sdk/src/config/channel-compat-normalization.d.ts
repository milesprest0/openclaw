...
export declare function hasLegacyAccountStreamingAliases(
  value: unknown,
  match: (entry: unknown) => boolean,
): boolean;
export declare function normalizeLegacyStreamingAliases(
  params: {
...
export declare function hasLegacyStreamingAliases(
  value: unknown,
  options?: {
    includePreviewChunk?: boolean;
