...
export declare function rotateConfigBackups(
  configPath: string,
 ...
 */
export declare function hardenBackupPermissions(
  configPath: string,
  ioFs: BackupRotationFs,
): Promise<void>;
/**
 ...
 */
export declare function cleanOrphanBackups(
  configPath: string,
  ioFs: BackupRotationFs,
): Promise<void>;
/**
 ...
 */
export declare function maintainConfigBackups(
  configPath: string,
