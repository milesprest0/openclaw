...
export declare function collectUnsupportedSecretRefPolicyIssues(
  raw: unknown,
 ...
 */
export declare function validateConfigObjectRaw(
  raw: unknown,
  opts?: {
    sourceRaw?: unknown;
...
export declare function validateConfigObject(
  raw: unknown,
  opts?: {
...
export declare function validateConfigObjectWithPlugins(
  raw: unknown,
  params?: ValidateConfigWithPluginsParams,
): ValidateConfigWithPluginsResult;
export declare function validateConfigObjectRawWithPlugins(
  raw: unknown,
  params?: ValidateConfigWithPluginsParams,
): ValidateConfigWithPluginsResult;
export {};
