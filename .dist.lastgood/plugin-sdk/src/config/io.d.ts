...
export declare function parseConfigJson5(
  raw: string,
  json5?: {
...
export declare function createConfigIO(
...
export declare function registerConfigWriteListener(
  listener: (event: ConfigWriteNotification) => void,
): () => void;
export declare function projectConfigOntoRuntimeSourceSnapshot(
...
export declare function promoteConfigSnapshotToLastKnownGood(
  snapshot: ConfigFileSnapshot,
): Promise<boolean>;
...
export declare function recoverConfigFromJsonRootSuffix(
  snapshot: ConfigFileSnapshot,
): Promise<boolean>;
