...
export declare function normalizeConfigIssues(
  issues: ReadonlyArray<ConfigValidationIssue>,
): ConfigValidationIssue[];
export declare function formatConfigIssueLine(
  issue: ConfigIssueLineInput,
  marker?: string,
  opts?: ConfigIssueFormatOptions,
): string;
export declare function formatConfigIssueLines(
  issues: ReadonlyArray<ConfigIssueLineInput>,
  marker?: string,
  opts?: ConfigIssueFormatOptions,
): string[];
export declare function formatConfigIssueSummary(
  issues: ReadonlyArray<ConfigIssueLineInput>,
