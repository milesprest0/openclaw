...
export declare const ensureRecord: (
  root: Record<string, unknown>,
  key: string,
) => Record<string, unknown>;
export declare const mergeMissing: (
  target: Record<string, unknown>,
  source: Record<string, unknown>,
) => void;
export declare const mapLegacyAudioTranscription: (
  value: unknown,
) => Record<string, unknown> | null;
export declare const defineLegacyConfigMigration: (
