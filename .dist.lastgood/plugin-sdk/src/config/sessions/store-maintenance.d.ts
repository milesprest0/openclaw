 ...
 */
export declare function resolveMaintenanceConfigFromInput(
 ...
 */
export declare function pruneStaleEntries(
...
export declare function isProtectedSessionMaintenanceEntry(
  sessionKey: string,
 ...
 * Mutates `store` in-place.
 */
export declare function capEntryCount(
  store: Record<string, SessionEntry>,
  overrideMax?: number,
  opts?: {
    log?: boolean;
