...
export declare function parseEnvTemplateSecretRef(
  value: unknown,
  provider?: string,
): SecretRef | null;
export declare function parseLegacySecretRefEnvMarker(
  value: unknown,
  provider?: string,
): SecretRef | null;
export declare function coerceSecretRef(
  value: unknown,
  defaults?: SecretDefaults,
): SecretRef | null;
export declare function hasConfiguredSecretInput(
  value: unknown,
  defaults?: SecretDefaults,
): boolean;
