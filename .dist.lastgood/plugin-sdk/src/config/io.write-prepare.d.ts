...
export declare function formatConfigValidationFailure(
  pathLabel: string,
  issueMessage: string,
): string;
export declare function unsetPathForWrite(
  root: OpenClawConfig,
  pathSegments: string[],
): {
  changed: boolean;
...
export declare function applyUnsetPathsForWrite(
  root: OpenClawConfig,
  unsetPaths: readonly string[][] | undefined,
): OpenClawConfig;
export declare function resolveManagedUnsetPathsForWrite(
  unsetPaths: readonly string[][] | undefined,
): string[][];
export declare function collectChangedPaths(
  base: unknown,
  target: unknown,
  path: string,
  output: Set<string>,
): void;
export declare function restoreEnvRefsFromMap(
  value: unknown,
  path: string,
