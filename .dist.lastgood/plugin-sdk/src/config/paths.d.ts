 ...
 */
export declare function resolveIncludeRoots(
 ...
 */
export declare function resolveCanonicalConfigPath(
  env?: NodeJS.ProcessEnv,
  stateDir?: string,
): string;
/**
 ...
 */
export declare function resolveConfigPathCandidate(
  env?: NodeJS.ProcessEnv,
  homedir?: () => string,
): string;
/**
 ...
 */
export declare function resolveDefaultConfigCandidates(
  env?: NodeJS.ProcessEnv,
  homedir?: () => string,
): string[];
