...
export declare function createTypedRuntimeEnv<TRuntime extends RuntimeEnv = OutputRuntimeEnv>(
  options?: RuntimeEnvOptions,
  _runtimeShape?: (runtime: TRuntime) => void,
): TRuntime;
export declare function createNonExitingRuntimeEnv(): OutputRuntimeEnv;
export declare function createNonExitingTypedRuntimeEnv<
  TRuntime extends RuntimeEnv = OutputRuntimeEnv,
>(runtimeShape?: (runtime: TRuntime) => void): TRuntime;
export {};
