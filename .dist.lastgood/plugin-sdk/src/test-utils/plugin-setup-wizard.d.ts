...
export declare function createTestWizardPrompter(
...
export declare function createSetupWizardAdapter(
  params: SetupWizardAdapterParams,
): import("openclaw/plugin-sdk/setup").ChannelSetupWizardAdapter;
export declare function createPluginSetupWizardAdapter(
  plugin: SetupWizardTestPlugin,
): import("openclaw/plugin-sdk/setup").ChannelSetupWizardAdapter;
export declare function createPluginSetupWizardConfigure(
  plugin: SetupWizardTestPlugin,
): (
  ctx: import("../channels/plugins/setup-wizard-types.ts").ChannelSetupConfigureContext,
) => Promise<import("../channels/plugins/setup-wizard-types.ts").ChannelSetupResult>;
export declare function createPluginSetupWizardStatus(
  plugin: SetupWizardTestPlugin,
): (
  ctx: import("../channels/plugins/setup-wizard-types.ts").ChannelSetupStatusContext,
) => Promise<import("../channels/plugins/setup-wizard-types.ts").ChannelSetupStatus>;
export declare function runSetupWizardConfigure<
  TCfg,
...
export declare function runSetupWizardPrepare<
  TCfg,
  TOptions extends Record<string, unknown>,
  TRuntime,
  TResult,
...
export declare function runSetupWizardFinalize<
  TCfg,
  TOptions extends Record<string, unknown>,
  TRuntime,
  TResult,
