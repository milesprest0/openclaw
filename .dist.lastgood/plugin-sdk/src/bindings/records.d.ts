...
export declare function createConversationBindingRecord(
...
export declare function resolveConversationBindingRecord(
  conversation: ConversationRef,
): SessionBindingRecord | null;
export declare function touchConversationBindingRecord(bindingId: string, at?: number): void;
export declare function unbindConversationBindingRecord(
