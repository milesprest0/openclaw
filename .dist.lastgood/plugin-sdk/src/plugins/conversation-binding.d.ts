...
export declare function isPluginOwnedBindingMetadata(
  metadata: unknown,
): metadata is PluginBindingMetadata;
export declare function isPluginOwnedSessionBindingRecord(
  record:
    | {
...
export declare function toPluginConversationBinding(
  record:
    | {
        bindingId: string;
...
export declare function buildPluginBindingUnavailableText(
  binding: PluginConversationBinding,
): string;
...
export declare function buildPluginBindingApprovalCustomId(
  approvalId: string,
  decision: PluginBindingApprovalDecision,
): string;
export declare function parsePluginBindingApprovalCustomId(
  value: string,
