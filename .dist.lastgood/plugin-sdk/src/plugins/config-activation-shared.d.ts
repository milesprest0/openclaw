...
export declare function resolvePluginActivationReason(
  cause?: PluginActivationCause,
  reason?: string,
): string | undefined;
export declare function toPluginActivationState(
...
export declare function resolveEnableStateResult<TParams>(
  params: TParams,
...
export declare function createPluginEnableStateResolver<TConfig, TOrigin extends string>(
  resolveState: (params: {
    id: string;
    origin: TOrigin;
    config: TConfig;
...
export declare function createEffectiveEnableStateResolver<TParams>(
  resolveState: (params: TParams) => EnableStateLike,
): (params: TParams) => {
  enabled: boolean;
  reason?: string;
