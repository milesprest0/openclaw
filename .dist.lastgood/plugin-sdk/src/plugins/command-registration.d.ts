...
export declare function validateCommandName(
  name: string,
  opts?: {
 ...
 */
export declare function validatePluginCommandDefinition(
  command: OpenClawPluginCommandDefinition,
  opts?: {
    allowReservedCommandNames?: boolean;
  },
): string | null;
export declare function listPluginInvocationKeys(
  command: OpenClawPluginCommandDefinition,
): string[];
export declare function pluginCommandSupportsChannel(
  command: OpenClawPluginCommandDefinition,
  channel?: string,
): boolean;
