...
export declare const DISABLE_PERSISTED_PLUGIN_REGISTRY_ENV =
...
export declare function loadPluginRegistrySnapshotWithMetadata(
  params?: LoadPluginRegistryParams,
): PluginRegistrySnapshotResult;
export declare function loadPluginRegistrySnapshot(
  params?: LoadPluginRegistryParams,
): PluginRegistrySnapshot;
export declare function listPluginRecords(
  params?: LoadPluginRegistryParams,
): readonly PluginRegistryRecord[];
export declare function getPluginRecord(
  params: GetPluginRecordParams,
): PluginRegistryRecord | undefined;
export declare function isPluginEnabled(params: GetPluginRecordParams): boolean;
export declare function inspectPluginRegistry(
  params?: LoadInstalledPluginIndexParams & InstalledPluginIndexStoreOptions,
): Promise<PluginRegistryInspection>;
export declare function refreshPluginRegistry(
