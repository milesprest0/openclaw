...
export declare function resolveDefaultPluginExtensionsDir(
  env?: NodeJS.ProcessEnv,
  homedir?: () => string,
): string;
export declare function resolveDefaultPluginNpmDir(
  env?: NodeJS.ProcessEnv,
  homedir?: () => string,
): string;
export declare function resolveDefaultPluginGitDir(
  env?: NodeJS.ProcessEnv,
  homedir?: () => string,
): string;
