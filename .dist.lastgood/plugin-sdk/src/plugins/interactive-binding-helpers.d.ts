...
export declare function createInteractiveConversationBindingHelpers(params: {
  ...
  ) => Promise<import("./conversation-binding.types.ts").PluginConversationBindingRequestResult>;
  detachConversationBinding: () => Promise<{
    removed: boolean;
  }>;
  getCurrentConversationBinding: () => Promise<
    import("./conversation-binding.types.ts").PluginConversationBinding | null
  >;
};
export {};
