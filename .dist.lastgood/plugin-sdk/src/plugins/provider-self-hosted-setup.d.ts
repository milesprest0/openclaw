...
export declare function applyProviderDefaultModel(
  cfg: OpenClawConfig,
  modelRef: string,
): OpenClawConfig;
...
export declare function promptAndConfigureOpenAICompatibleSelfHostedProvider(
  params: OpenAICompatibleSelfHostedProviderSetupParams,
): Promise<OpenAICompatibleSelfHostedProviderPromptResult>;
export declare function promptAndConfigureOpenAICompatibleSelfHostedProviderAuth(
  params: OpenAICompatibleSelfHostedProviderSetupParams,
): Promise<ProviderAuthResult>;
export declare function discoverOpenAICompatibleSelfHostedProvider<
