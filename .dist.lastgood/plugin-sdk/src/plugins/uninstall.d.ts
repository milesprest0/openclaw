...
export declare function createEmptyUninstallActions(
  overrides?: Partial<UninstallActions>,
): UninstallActions;
export declare function formatUninstallActionLabels(actions: UninstallActions): string[];
export declare function formatUninstallSlotResetPreview(
  slotKey: "memory" | "contextEngine",
): string;
 ...
 */
export declare function resolveUninstallChannelConfigKeys(
  pluginId: string,
  opts?: {
    channelIds?: string[];
  },
 ...
 */
export declare function removePluginFromConfig(
  cfg: OpenClawConfig,
  pluginId: string,
  opts?: {
    channelIds?: string[];
 ...
 */
export declare function planPluginUninstall(
  params: UninstallPluginParams,
): PluginUninstallPlanResult;
export declare function applyPluginUninstallDirectoryRemoval(
  removal: PluginUninstallDirectoryRemoval | null,
): Promise<{
  directoryRemoved: boolean;
  warnings: string[];
}>;
export declare function uninstallPlugin(
  params: UninstallPluginParams,
