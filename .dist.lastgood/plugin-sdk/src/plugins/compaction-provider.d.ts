 ...
 */
export declare function registerCompactionProvider(
  provider: CompactionProvider,
  options?: {
    ownerPluginId?: string;
  },
...
export declare function getRegisteredCompactionProvider(
  id: string,
...
export declare function restoreRegisteredCompactionProviders(
