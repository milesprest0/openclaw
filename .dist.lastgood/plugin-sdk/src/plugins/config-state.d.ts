...
export declare const normalizePluginsConfig: (
...
export declare function applyTestPluginDefaults(
  cfg: OpenClawConfig,
  env?: NodeJS.ProcessEnv,
): OpenClawConfig;
export declare function isTestDefaultMemorySlotDisabled(
  cfg: OpenClawConfig,
  env?: NodeJS.ProcessEnv,
): boolean;
...
export declare const resolveEnableState: (
  id: string,
  origin: PluginOrigin,
  config: SharedNormalizedPluginsConfig,
  enabledByDefault?: boolean,
) => {
  enabled: boolean;
  reason?: string;
