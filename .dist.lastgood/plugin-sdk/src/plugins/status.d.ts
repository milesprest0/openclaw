...
export declare function buildPluginRegistrySnapshotReport(
...
export declare function buildPluginDiagnosticsReport(
  params?: PluginReportParams,
): PluginStatusReport;
...
export declare function summarizePluginCompatibility(
