...
export declare function registerMemoryEmbeddingProvider(
  adapter: MemoryEmbeddingProviderAdapter,
  options?: {
    ownerPluginId?: string;
  },
): void;
export declare function getRegisteredMemoryEmbeddingProvider(
  id: string,
): RegisteredMemoryEmbeddingProvider | undefined;
export declare function getMemoryEmbeddingProvider(
  id: string,
...
export declare function restoreMemoryEmbeddingProviders(
  adapters: MemoryEmbeddingProviderAdapter[],
): void;
export declare function restoreRegisteredMemoryEmbeddingProviders(
