...
export declare function getPluginInteractiveHandlersState(): Map<
  string,
  RegisteredInteractiveHandler
>;
export declare function claimPluginInteractiveCallbackDedupe(
  dedupeKey: string | undefined,
  now?: number,
): boolean;
export declare function commitPluginInteractiveCallbackDedupe(
  dedupeKey: string | undefined,
  now?: number,
): void;
