...
export declare function resolveProviderRuntimePlugin(
...
export declare function resolveProviderRuntimePluginHandle(
  params: ProviderRuntimePluginLookupParams,
): ProviderRuntimePluginHandle;
export declare function ensureProviderRuntimePluginHandle(
