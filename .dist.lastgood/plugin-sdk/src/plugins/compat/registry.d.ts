...
export declare const PLUGIN_COMPAT_RECORDS: readonly [
  ...
  },
  {
    ...
    readonly surfaces: readonly [
      "before_tool_call block result",
      "before_tool_call approval result",
    ];
  ...
  },
  {
    ...
    readonly docsPath: "/plugins/manifest";
    readonly surfaces: readonly [
      "generated bundled channel config metadata",
  ...
  },
  {
    ...
    readonly docsPath: "/cli/plugins#registry";
    readonly surfaces: readonly [
      "plugins.installs authored config",
      "plugin install/update migration",
    ];
  ...
  },
  {
    ...
    readonly docsPath: "/cli/plugins#registry";
    readonly surfaces: readonly [
      "plugins.load.paths entries pointing at bundled plugin source/dist paths",
    ];
  ...
  },
  {
    ...
    readonly diagnostics: readonly [
      "provider validation warning when catalog and discovery both register",
    ];
    readonly tests: readonly [
  ...
  },
  {
    ...
    readonly docsPath: "/plugins/sdk-provider-plugins";
    readonly surfaces: readonly [
      "openclaw/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider",
    ];
    readonly diagnostics: readonly ["plugin SDK compatibility warning"];
    readonly tests: readonly ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"];
  },
