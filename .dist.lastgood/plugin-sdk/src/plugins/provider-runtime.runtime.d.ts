...
export declare function formatProviderAuthProfileApiKeyWithPlugin(
...
export declare function prepareProviderRuntimeAuth(
  ...args: Parameters<PrepareProviderRuntimeAuth>
): Promise<Awaited<ReturnType<PrepareProviderRuntimeAuth>>>;
export declare function refreshProviderOAuthCredentialWithPlugin(
