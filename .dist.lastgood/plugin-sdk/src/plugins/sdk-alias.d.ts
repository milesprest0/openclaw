...
export declare function resolveLoaderPackageRoot(
...
export declare function buildPluginLoaderAliasMap(
  modulePath: string,
  argv1?: string | undefined,
  moduleUrl?: string,
  pluginSdkResolution?: PluginSdkResolutionPreference,
): Record<string, string>;
export declare function resolvePluginRuntimeModulePath(
  params?: LoaderModuleResolveParams,
): string | null;
...
export declare function resolvePluginLoaderTryNative(
  modulePath: string,
  options?: {
