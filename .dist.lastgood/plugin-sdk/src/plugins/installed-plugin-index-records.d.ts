...
export declare function resolveInstalledPluginIndexRecordsStorePath(
  options?: InstalledPluginIndexRecordStoreOptions,
): string;
export declare function writePersistedInstalledPluginIndexInstallRecords(
  records: Record<string, PluginInstallRecord>,
  options?: InstalledPluginIndexRecordRefreshOptions,
): Promise<string>;
export declare function writePersistedInstalledPluginIndexInstallRecordsSync(
  records: Record<string, PluginInstallRecord>,
  options?: InstalledPluginIndexRecordRefreshOptions,
): string;
export declare function withPluginInstallRecords(
  config: OpenClawConfig,
  records: Record<string, PluginInstallRecord>,
): OpenClawConfig;
export declare function withoutPluginInstallRecords(config: OpenClawConfig): OpenClawConfig;
export declare function recordPluginInstallInRecords(
  records: Record<string, PluginInstallRecord>,
  update: PluginInstallUpdate,
): Record<string, PluginInstallRecord>;
export declare function removePluginInstallRecordFromRecords(
  records: Record<string, PluginInstallRecord>,
  pluginId: string,
): Record<string, PluginInstallRecord>;
