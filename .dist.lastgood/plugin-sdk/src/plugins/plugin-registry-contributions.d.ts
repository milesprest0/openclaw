...
export declare function loadPluginManifestRegistryForPluginRegistry(
  params?: LoadPluginRegistryManifestParams,
): PluginManifestRegistry;
export declare function normalizePluginsConfigWithRegistry(
  config: OpenClawConfig["plugins"] | undefined,
  index: PluginRegistrySnapshot,
  options?: PluginRegistryIdNormalizerOptions,
): NormalizedPluginsConfig;
export declare function listPluginContributionIds(
  params: ListPluginContributionIdsParams,
): readonly string[];
export declare function resolvePluginContributionOwners(
  params: ResolvePluginContributionOwnersParams,
): readonly string[];
export declare function resolveProviderOwners(
  params: ResolveProviderOwnersParams,
): readonly string[];
export declare function resolveChannelOwners(params: ResolveChannelOwnersParams): readonly string[];
export declare function resolveCliBackendOwners(
  params: ResolveCliBackendOwnersParams,
): readonly string[];
export declare function resolveSetupProviderOwners(
  params: ResolveSetupProviderOwnersParams,
): readonly string[];
export declare function resolveManifestContractPluginIds(
  params: ResolveManifestContractPluginIdsParams,
): string[];
export declare function resolveManifestContractPluginIdsByCompatibilityRuntimePath(
  params: ResolveManifestContractPluginIdsByCompatibilityRuntimePathParams,
): string[];
export declare function resolveManifestContractOwnerPluginId(
