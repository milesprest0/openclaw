...
export declare function sortPluginProviders<
  T extends Pick<WebProviderSortEntry, "id" | "pluginId">,
>(providers: T[]): T[];
export declare function sortPluginProvidersForAutoDetect<T extends WebProviderSortEntry>(
  providers: T[],
): T[];
...
export declare function mapRegistryProviders<
  TProvider extends {
    id: string;
  },
>(params: {
