...
export declare function setActivePluginRegistry(
...
export declare function resolveActivePluginHttpRouteRegistry(
...
export declare function getActivePluginRuntimeSubagentMode():
  | "default"
  | "explicit"
  | "gateway-bindable";
