...
export declare function resolvePluginInteractiveNamespaceMatch(
  channel: string,
  data: string,
): {
...
export declare function registerPluginInteractiveHandler(
  pluginId: string,
...
export declare function restorePluginInteractiveHandlers(
