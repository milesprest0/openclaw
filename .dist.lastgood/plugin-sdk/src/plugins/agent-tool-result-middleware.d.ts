...
export declare function normalizeAgentToolResultMiddlewareRuntimes(
...
export declare function normalizeAgentToolResultMiddlewareRuntimeIds(
  runtimes: readonly string[] | undefined,
): AgentToolResultMiddlewareRuntime[];
export declare function listAgentToolResultMiddlewares(
