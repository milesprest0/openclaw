...
export declare function registerMemoryCorpusSupplement(
  pluginId: string,
  supplement: MemoryCorpusSupplement,
): void;
export declare function registerMemoryCapability(
  pluginId: string,
  capability: MemoryPluginCapability,
): void;
export declare function getMemoryCapabilityRegistration():
...
export declare function registerMemoryPromptSectionForPlugin(
  pluginId: string,
  builder: MemoryPromptSectionBuilder,
): void;
export declare function registerMemoryPromptSupplement(
  pluginId: string,
  builder: MemoryPromptSectionBuilder,
): void;
...
export declare function registerMemoryFlushPlanResolverForPlugin(
  pluginId: string,
...
export declare function registerMemoryRuntimeForPlugin(
  pluginId: string,
  runtime: MemoryPluginRuntime,
): void;
