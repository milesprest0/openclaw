...
export declare function buildOpenAICompatibleReplayPolicy(
...
export declare function buildNativeAnthropicReplayPolicyForModel(
  modelId?: string,
): ProviderReplayPolicy;
export declare function buildHybridAnthropicOrOpenAIReplayPolicy(
...
export declare function buildPassthroughGeminiSanitizingReplayPolicy(
  modelId?: string,
): ProviderReplayPolicy;
export declare function sanitizeGoogleGeminiReplayHistory(
