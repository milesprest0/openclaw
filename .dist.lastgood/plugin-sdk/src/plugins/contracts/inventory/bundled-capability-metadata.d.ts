...
export type BundledCapabilityManifest = Pick<
  ...
  | "providers"
>;
export declare function buildBundledPluginContractSnapshot(
  manifest: BundledCapabilityManifest,
): BundledPluginContractSnapshot;
export declare function hasBundledPluginContractSnapshotCapabilities(
...
type BundledContractIdSnapshotKey = Exclude<
  ...
  "providerAuthEnvVars"
>;
export declare function resolveBundledContractSnapshotPluginIds(
