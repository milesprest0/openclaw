...
export declare const durableFinalDeliveryCapabilities: readonly [
  "text",
  "media",
  "payload",
  "silent",
...
export type ChannelMessageLiveCapability =
  ...
  | "nativeStreaming"
  | "quietFinalization";
export declare const channelMessageLiveCapabilities: readonly [
  "draftPreview",
  "previewFinalization",
  "progressUpdates",
  "nativeStreaming",
...
export declare const livePreviewFinalizerCapabilities: readonly [
  "finalEdit",
  "normalFallback",
  "discardPending",
  "previewReceipt",
...
export type ChannelMessageReceiveAckPolicy =
  ...
  | "after_durable_send"
  | "manual";
export declare const channelMessageReceiveAckPolicies: readonly [
  "after_receive_record",
  "after_agent_dispatch",
  "after_durable_send",
  "manual",
