...
export declare function defineFinalizableLivePreviewAdapter<TPayload, TId, TEdit>(
...
export declare function markLiveMessageFinalized<TPayload>(
...
export declare function markLiveMessagePreviewUpdated<TPayload>(
  state: LiveMessageState<TPayload>,
  rendered: RenderedMessageBatch<TPayload>,
): LiveMessageState<TPayload>;
export declare function markLiveMessageCancelled<TPayload>(
  state: LiveMessageState<TPayload>,
): LiveMessageState<TPayload>;
