...
export declare function listPotentialConfiguredChannelIds(
  cfg: OpenClawConfig,
  env?: NodeJS.ProcessEnv,
  options?: ChannelPresenceOptions,
): string[];
export declare function listPotentialConfiguredChannelPresenceSignals(
  cfg: OpenClawConfig,
  env?: NodeJS.ProcessEnv,
  options?: ChannelPresenceOptions,
): ChannelPresenceSignal[];
export declare function hasPotentialConfiguredChannels(
