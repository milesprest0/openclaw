...
export declare function implicitMentionKindWhen(
  kind: InboundImplicitMentionKind,
  enabled: boolean,
): InboundImplicitMentionKind[];
export declare function resolveInboundMentionDecision(
...
/** @deprecated Prefer `resolveInboundMentionDecision({ facts, policy })`. */
export declare function resolveMentionGatingWithBypass(
