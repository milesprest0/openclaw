...
export declare function addWildcardAllowFrom(
  allowFrom?: ReadonlyArray<string | number> | null,
): string[];
export declare function mergeAllowFromEntries(
...
export declare function parseSetupEntriesWithParser(
  raw: string,
...
export declare function parseSetupEntriesAllowingWildcard(
  raw: string,
  parseEntry: (entry: string) => ParsedSetupEntry,
): {
  entries: string[];
...
export declare function normalizeAllowFromEntries(
...
export declare function setSetupChannelEnabled(
  cfg: OpenClawConfig,
  channel: string,
  enabled: boolean,
): OpenClawConfig;
...
export declare function createPromptParsedAllowFromForAccount<
  TConfig extends OpenClawConfig,
>(params: {
