...
export declare function resolveSessionConversationRef(
  sessionKey: string | undefined | null,
  opts?: SessionConversationResolutionOptions,
): ResolvedSessionConversationRef | null;
export declare function resolveSessionThreadInfo(
  sessionKey: string | undefined | null,
  opts?: SessionConversationResolutionOptions,
): ParsedThreadSessionSuffix;
export declare function resolveSessionParentSessionKey(
  sessionKey: string | undefined | null,
): string | null;
export {};
