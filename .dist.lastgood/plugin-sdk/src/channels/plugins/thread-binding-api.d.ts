...
export declare function resolveBundledChannelThreadBindingDefaultPlacement(
  channelId: string,
): ThreadBindingPlacement | undefined;
export declare function resolveBundledChannelThreadBindingInboundConversation(
