...
export declare function buildChannelUiCatalog(
  plugins: Array<{
    id: string;
    meta: ChannelMeta;
  }>,
): ChannelUiCatalog;
export declare function listChannelPluginCatalogEntries(
  options?: CatalogOptions,
): ChannelPluginCatalogEntry[];
export declare function getChannelPluginCatalogEntry(
  id: string,
  options?: CatalogOptions,
