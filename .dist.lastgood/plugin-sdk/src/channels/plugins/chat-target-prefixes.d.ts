...
export declare function resolveServicePrefixedChatTarget<TService extends string, TTarget>(params: {
  ...
  | null;
export declare function parseChatTargetPrefixesOrThrow(
...
export declare function resolveServicePrefixedAllowTarget<TAllowTarget>(params: {
  ...
  | null;
export declare function resolveServicePrefixedOrChatAllowTarget<
...
export declare function parseChatAllowTargetPrefixes(
  params: ChatTargetPrefixesParams,
): ParsedChatTarget | null;
