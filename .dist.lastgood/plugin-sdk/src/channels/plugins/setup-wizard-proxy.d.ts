...
>[0];
export declare function createDelegatedResolveConfigured(
  loadWizard: () => Promise<ChannelSetupWizard>,
): ({ cfg, accountId }: ResolveConfiguredParams) => Promise<boolean>;
export declare function createDelegatedPrepare(loadWizard: () => Promise<ChannelSetupWizard>): (
  params: Parameters<NonNullable<ChannelSetupWizard["prepare"]>>[0],
) => Promise<
  | void
  | {
      cfg?: OpenClawConfig;
  ...
  | undefined
>;
export declare function createDelegatedFinalize(loadWizard: () => Promise<ChannelSetupWizard>): (
  params: Parameters<NonNullable<ChannelSetupWizard["finalize"]>>[0],
) => Promise<
  | void
  | {
      cfg?: OpenClawConfig;
