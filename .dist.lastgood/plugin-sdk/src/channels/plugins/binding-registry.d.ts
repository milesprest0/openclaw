...
export declare function resolveConfiguredBinding(
  ...args: Parameters<typeof resolveConfiguredBindingRaw>
): ReturnType<typeof resolveConfiguredBindingRaw>;
export declare function resolveConfiguredBindingRecordBySessionKey(
