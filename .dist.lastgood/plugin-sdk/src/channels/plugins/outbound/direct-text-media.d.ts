...
export declare function createScopedChannelMediaMaxBytesResolver(
  channel: string,
): (params: { cfg: OpenClawConfig; accountId?: string | null }) => number | undefined;
export declare function createDirectTextMediaOutbound<
