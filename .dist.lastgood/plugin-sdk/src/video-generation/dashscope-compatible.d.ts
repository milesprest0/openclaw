...
export declare function resolveVideoGenerationReferenceUrls(
  inputImages: VideoGenerationSourceAsset[] | undefined,
  inputVideos: VideoGenerationSourceAsset[] | undefined,
): string[];
export declare function buildDashscopeVideoGenerationParameters(
  req: VideoGenerationRequest,
  resolutionToSize?: Record<string, string>,
): Record<string, unknown> | undefined;
export declare function extractDashscopeVideoUrls(
  payload: DashscopeVideoGenerationResponse,
): string[];
