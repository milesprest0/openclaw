...
export declare function registerDetachedTaskLifecycleRuntime(
  pluginId: string,
...
export declare function getDetachedTaskLifecycleRuntimeRegistration():
  | DetachedTaskLifecycleRuntimeRegistration
  | undefined;
export declare function getRegisteredDetachedTaskLifecycleRuntime():
  | DetachedTaskLifecycleRuntime
  | undefined;
export declare function restoreDetachedTaskLifecycleRuntimeRegistration(
