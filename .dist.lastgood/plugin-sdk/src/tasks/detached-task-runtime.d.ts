...
export declare function getDetachedTaskLifecycleRuntimeRegistration():
  | DetachedTaskLifecycleRuntimeRegistration
  | undefined;
export declare function registerDetachedTaskRuntime(
  pluginId: string,
  runtime: DetachedTaskLifecycleRuntime,
): void;
export declare function setDetachedTaskLifecycleRuntime(
  runtime: DetachedTaskLifecycleRuntime,
): void;
export declare function resetDetachedTaskLifecycleRuntimeForTests(): void;
export declare function createQueuedTaskRun(
...
export declare function createRunningTaskRun(
...
export declare function startTaskRunByRunId(
...
export declare function recordTaskRunProgressByRunId(
...
export declare function completeTaskRunByRunId(
...
export declare function failTaskRunByRunId(
...
export declare function setDetachedTaskDeliveryStatusByRunId(
...
export declare function cancelDetachedTaskRunById(
...
export declare function tryRecoverTaskBeforeMarkLost(
