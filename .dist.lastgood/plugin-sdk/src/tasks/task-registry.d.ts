...
export declare function maybeDeliverTaskStateChangeUpdate(
  taskId: string,
...
export declare function cancelTaskById(params: { cfg: OpenClawConfig; taskId: string }): Promise<{
  found: boolean;
  cancelled: boolean;
  reason?: string;
  task?: TaskRecord;
...
export declare function findLatestTaskForRelatedSessionKey(
  sessionKey: string,
...
export declare function resetTaskRegistryForTests(opts?: { persist?: boolean }): void;
export declare function resetTaskRegistryDeliveryRuntimeForTests(): void;
export declare function setTaskRegistryDeliveryRuntimeForTests(
  runtime: TaskRegistryDeliveryRuntime,
): void;
export declare function resetTaskRegistryControlRuntimeForTests(): void;
export declare function setTaskRegistryControlRuntimeForTests(
  runtime: TaskRegistryControlRuntime,
): void;
export {};
