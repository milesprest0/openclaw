...
export declare function deriveTaskFlowStatusFromTask(
...
export declare function createManagedTaskFlow(
...
export declare function syncFlowFromTask(
  task: Pick<
    TaskRecord,
    | "parentFlowId"
    | "status"
...
export declare function resetTaskFlowRegistryForTests(opts?: { persist?: boolean }): void;
export {};
