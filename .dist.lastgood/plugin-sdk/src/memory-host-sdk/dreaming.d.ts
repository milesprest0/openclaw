...
export declare const MANAGED_MEMORY_DREAMING_CRON_TAG =
  "[managed-by=memory-core.short-term-promotion]";
export declare const MEMORY_DREAMING_SYSTEM_EVENT_TEXT =
...
export declare const LEGACY_MEMORY_LIGHT_DREAMING_CRON_TAG =
  "[managed-by=memory-core.dreaming.light]";
export declare const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT =
...
export declare function resolveMemoryDreamingPluginId(
  cfg: OpenClawConfig | Record<string, unknown> | undefined,
): string;
export declare function resolveMemoryDreamingPluginConfig(
  cfg: OpenClawConfig | Record<string, unknown> | undefined,
...
export declare function isSameMemoryDreamingDay(
  firstEpochMs: number,
  secondEpochMs: number,
  timezone?: string,
): boolean;
export declare function resolveMemoryDreamingWorkspaces(
  cfg: OpenClawConfig,
