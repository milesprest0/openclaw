...
export declare function readSystemdServiceExecStart(
...
export declare function isSystemdUnitActive(
  env: GatewayServiceEnv,
  unitName: string,
  scope?: SystemdUnitScope,
): Promise<boolean>;
export declare function stageSystemdService({
  stdout,
  ...args
...
export declare function uninstallSystemdService({
  env,
  stdout,
}: GatewayServiceManageArgs): Promise<void>;
export declare function stopSystemdService({
  stdout,
  env,
}: GatewayServiceControlArgs): Promise<void>;
export declare function restartSystemdService({
  stdout,
  env,
}: GatewayServiceControlArgs): Promise<GatewayServiceRestartResult>;
export declare function isSystemdServiceEnabled(args: GatewayServiceEnvArgs): Promise<boolean>;
export declare function readSystemdServiceRuntime(
  env?: GatewayServiceEnv,
...
export declare function uninstallLegacySystemdUnits({
  env,
  stdout,
