...
export declare function formatGatewayServiceStartRepairIssues(
  issues: GatewayServiceStartRepairIssue[],
): string;
export declare function readGatewayServiceState(
  service: GatewayService,
  args?: GatewayServiceEnvArgs,
): Promise<GatewayServiceState>;
export declare function startGatewayService(
  service: GatewayService,
  args: GatewayServiceControlArgs,
): Promise<GatewayServiceStartResult>;
export declare function describeGatewayServiceRestart(
  serviceNoun: string,
