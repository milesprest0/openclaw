...
export declare function readScheduledTaskCommand(
...
export declare function stageScheduledTask({
  stdout,
  ...args
...
export declare function uninstallScheduledTask({
  env,
  stdout,
}: GatewayServiceManageArgs): Promise<void>;
export declare function stopScheduledTask({
  stdout,
  env,
}: GatewayServiceControlArgs): Promise<void>;
export declare function restartScheduledTask({
  stdout,
  env,
}: GatewayServiceControlArgs): Promise<GatewayServiceRestartResult>;
export declare function isScheduledTaskInstalled(args: GatewayServiceEnvArgs): Promise<boolean>;
export declare function readScheduledTaskRuntime(
  env?: GatewayServiceEnv,
