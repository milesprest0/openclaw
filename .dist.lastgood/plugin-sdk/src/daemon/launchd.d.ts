...
export declare function readLaunchAgentProgramArguments(
...
export declare function readLaunchAgentRuntime(
...
export declare function uninstallLaunchAgent({
  env,
  stdout,
}: GatewayServiceManageArgs): Promise<void>;
export declare function stopLaunchAgent({
  stdout,
  env,
...
export declare function restartLaunchAgent({
  stdout,
  env,
