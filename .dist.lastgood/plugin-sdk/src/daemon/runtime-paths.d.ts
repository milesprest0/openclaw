...
export declare function isVersionManagedNodePath(
  nodePath: string,
  platform?: NodeJS.Platform,
): boolean;
export declare function isSystemNodePath(
  nodePath: string,
  env?: Record<string, string | undefined>,
  platform?: NodeJS.Platform,
): boolean;
export declare function resolveSystemNodePath(
  env?: Record<string, string | undefined>,
  platform?: NodeJS.Platform,
): Promise<string | null>;
...
export declare function renderSystemNodeWarning(
