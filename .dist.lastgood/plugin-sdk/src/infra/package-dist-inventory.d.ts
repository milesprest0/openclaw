...
export declare function collectLegacyPluginDependencyStagingDebrisPaths(
  packageRoot: string,
): Promise<string[]>;
export declare function assertNoLegacyPluginDependencyStagingDebris(
  packageRoot: string,
): Promise<void>;
export declare function writePackageDistInventory(packageRoot: string): Promise<string[]>;
export declare function readPackageDistInventoryIfPresent(
  packageRoot: string,
): Promise<string[] | null>;
