...
export declare function resolveExecApprovals(
  agentId?: string,
...
export declare function recordAllowlistUse(
...
export declare function addAllowlistEntry(
  approvals: ExecApprovalsFile,
  agentId: string | undefined,
  pattern: string,
  options?: {
...
export declare function addDurableCommandApproval(
  approvals: ExecApprovalsFile,
  agentId: string | undefined,
  commandText: string,
): void;
...
export declare const DEFAULT_EXEC_APPROVAL_DECISIONS: readonly [
  "allow-once",
  "allow-always",
  "deny",
];
