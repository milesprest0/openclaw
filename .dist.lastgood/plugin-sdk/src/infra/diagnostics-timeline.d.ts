...
export declare function emitDiagnosticsTimelineEvent(
  event: DiagnosticsTimelineEvent,
  options?: DiagnosticsTimelineOptions,
): void;
export declare function getActiveDiagnosticsTimelineSpan():
  | ActiveDiagnosticsTimelineSpan
  | undefined;
export declare function measureDiagnosticsTimelineSpan<T>(
  name: string,
  run: () => Promise<T> | T,
  options?: DiagnosticsTimelineSpanOptions,
): Promise<T>;
export declare function measureDiagnosticsTimelineSpanSync<T>(
  name: string,
  run: () => T,
  options?: DiagnosticsTimelineSpanOptions,
): T;
