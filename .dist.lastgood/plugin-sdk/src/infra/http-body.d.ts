...
export declare function isRequestBodyLimitError(
  error: unknown,
  code?: RequestBodyLimitErrorCode,
...
export declare function readRequestBodyWithLimit(
  req: IncomingMessage,
...
export declare function readJsonBodyWithLimit(
  req: IncomingMessage,
...
export declare function installRequestBodyLimitGuard(
  req: IncomingMessage,
  res: ServerResponse,
