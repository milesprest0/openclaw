...
export declare function bindGenericCurrentConversation(
  input: SessionBindingBindInput,
): Promise<SessionBindingRecord | null>;
export declare function resolveGenericCurrentConversationBinding(
  ref: ConversationRef,
): SessionBindingRecord | null;
export declare function listGenericCurrentConversationBindingsBySession(
  targetSessionKey: string,
): SessionBindingRecord[];
export declare function touchGenericCurrentConversationBinding(
  bindingId: string,
  at?: number,
): void;
export declare function unbindGenericCurrentConversationBindings(
