...
export declare function markDeliveryPlatformSendAttemptStarted(
  id: string,
  stateDir?: string,
): Promise<void>;
export declare function markDeliveryPlatformOutcomeUnknown(
  id: string,
  stateDir?: string,
): Promise<void>;
/** Load a single pending delivery entry by ID from the queue directory. */
export declare function loadPendingDelivery(
  id: string,
  stateDir?: string,
