...
export declare function resolveLatestVersionFromPackage(
  detail: ClawHubPackageDetail,
): string | null;
export declare function isClawHubFamilySkill(
  detail: ClawHubPackageDetail | ClawHubSkillDetail,
): boolean;
export declare function satisfiesPluginApiRange(
  pluginApiVersion: string,
  pluginApiRange?: string | null,
): boolean;
export declare function satisfiesGatewayMinimum(
