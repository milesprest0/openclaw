...
export declare const DEFAULT_RESTART_SUCCESS_CONTINUATION_MESSAGE =
  "The gateway restart completed successfully. Tell the user OpenClaw restarted successfully and continue any pending work.";
export declare function formatDoctorNonInteractiveHint(
  env?: Record<string, string | undefined>,
): string;
export declare function resolveRestartSentinelPath(env?: NodeJS.ProcessEnv): string;
export declare function writeRestartSentinel(
  payload: RestartSentinelPayload,
  env?: NodeJS.ProcessEnv,
): Promise<string>;
export declare function finalizeUpdateRestartSentinelRunningVersion(
  version?: string,
  env?: NodeJS.ProcessEnv,
): Promise<RestartSentinel | null>;
export declare function markUpdateRestartSentinelFailure(
  reason: string,
  env?: NodeJS.ProcessEnv,
): Promise<RestartSentinel | null>;
export declare function removeRestartSentinelFile(
...
export declare function readRestartSentinel(
  env?: NodeJS.ProcessEnv,
): Promise<RestartSentinel | null>;
export declare function hasRestartSentinel(env?: NodeJS.ProcessEnv): Promise<boolean>;
export declare function consumeRestartSentinel(
  env?: NodeJS.ProcessEnv,
): Promise<RestartSentinel | null>;
