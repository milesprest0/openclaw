...
export type ApproveDevicePairingResult =
  ...
  | null;
export declare function formatDevicePairingForbiddenMessage(
  result: DevicePairingForbiddenResult,
): string;
export declare function listApprovedPairedDeviceRoles(
  device: Pick<PairedDevice, "role" | "roles">,
): string[];
export declare function listEffectivePairedDeviceRoles(
  device: Pick<PairedDevice, "role" | "roles" | "tokens">,
): string[];
export declare function hasEffectivePairedDeviceRole(
  device: Pick<PairedDevice, "role" | "roles" | "tokens">,
  role: string,
): boolean;
export declare function listDevicePairing(baseDir?: string): Promise<DevicePairingList>;
export declare function getPairedDevice(
  deviceId: string,
  baseDir?: string,
): Promise<PairedDevice | null>;
export declare function getPendingDevicePairing(
  requestId: string,
  baseDir?: string,
): Promise<DevicePairingPendingRequest | null>;
export declare function requestDevicePairing(
...
export declare function approveDevicePairing(
  requestId: string,
  baseDir?: string,
...
export declare function approveBootstrapDevicePairing(
  requestId: string,
  bootstrapProfile: DeviceBootstrapProfile,
  baseDir?: string,
): Promise<ApproveDevicePairingResult>;
export declare function rejectDevicePairing(
  requestId: string,
  baseDir?: string,
): Promise<{
  requestId: string;
...
export declare function removePairedDevice(
  deviceId: string,
  baseDir?: string,
): Promise<{
  deviceId: string;
} | null>;
export declare function updatePairedDeviceMetadata(
  deviceId: string,
  patch: Partial<PairedDeviceMetadataPatch>,
  baseDir?: string,
): Promise<boolean>;
export declare function summarizeDeviceTokens(
