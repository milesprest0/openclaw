...
type NpmSpecArchiveInstallFlowResult<
  TResult extends {
    ok: boolean;
  },
> =
...
export declare function installFromNpmSpecArchiveWithInstaller<
  TResult extends {
    ok: boolean;
  },
...
export declare function finalizeNpmSpecArchiveInstall<
  TResult extends {
    ok: boolean;
  },
>(flowResult: NpmSpecArchiveInstallFlowResult<TResult>): NpmSpecArchiveFinalInstallResult<TResult>;
export declare function installFromNpmSpecArchive<
  TResult extends {
    ok: boolean;
  },
>(params: {
