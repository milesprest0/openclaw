...
export declare function consumeGatewayRestartIntentPayloadSync(
  env?: NodeJS.ProcessEnv,
  now?: number,
): GatewayRestartIntent | null;
export declare function consumeGatewayRestartIntentSync(
  env?: NodeJS.ProcessEnv,
  now?: number,
): boolean;
/**
...
export declare function setGatewaySigusr1RestartPolicy(opts?: { allowExternal?: boolean }): void;
...
export declare function resolveGatewayRestartDeferralTimeoutMs(
  timeoutMs: unknown,
): number | undefined;
/**
