...
export declare function resolveExpectedInstalledVersionFromSpec(
  packageName: string,
  spec: string,
): string | null;
...
export declare function createGlobalInstallEnv(
  env?: NodeJS.ProcessEnv,
): Promise<NodeJS.ProcessEnv | undefined>;
export declare function resolveNpmGlobalPrefixLayoutFromGlobalRoot(
  globalRoot?: string | null,
): NpmGlobalPrefixLayout | null;
export declare function resolveNpmGlobalPrefixLayoutFromPrefix(
  prefix: string,
): NpmGlobalPrefixLayout;
export declare function resolvePnpmGlobalDirFromGlobalRoot(
  globalRoot?: string | null,
): string | null;
export declare function resolveGlobalInstallCommand(
  manager: GlobalInstallManager,
  pkgRoot?: string | null,
...
export declare function resolveGlobalPackageRoot(
  managerOrCommand: GlobalInstallManager | ResolvedGlobalInstallCommand,
  runCommand: CommandRunner,
  timeoutMs: number,
  pkgRoot?: string | null,
...
export declare function detectGlobalInstallManagerForRoot(
  runCommand: CommandRunner,
  pkgRoot: string,
  timeoutMs: number,
): Promise<GlobalInstallManager | null>;
export declare function detectGlobalInstallManagerByPresence(
  runCommand: CommandRunner,
  timeoutMs: number,
): Promise<GlobalInstallManager | null>;
export declare function globalInstallArgs(
  managerOrCommand: GlobalInstallManager | ResolvedGlobalInstallCommand,
  spec: string,
  pkgRoot?: string | null,
  installPrefix?: string | null,
): string[];
export declare function globalInstallFallbackArgs(
  managerOrCommand: GlobalInstallManager | ResolvedGlobalInstallCommand,
  spec: string,
  pkgRoot?: string | null,
  installPrefix?: string | null,
