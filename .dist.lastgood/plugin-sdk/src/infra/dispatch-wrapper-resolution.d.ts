...
export declare function extractEnvAssignmentKeysFromDispatchWrappers(
  argv: string[],
  maxDepth?: number,
): string[];
...
export declare function unwrapKnownDispatchWrapperInvocation(
  argv: string[],
  platform?: NodeJS.Platform,
): DispatchWrapperUnwrapResult;
export declare function unwrapDispatchWrappersForResolution(
  argv: string[],
  maxDepth?: number,
  platform?: NodeJS.Platform,
): string[];
export declare function resolveDispatchWrapperTrustPlan(
  argv: string[],
  maxDepth?: number,
  platform?: NodeJS.Platform,
