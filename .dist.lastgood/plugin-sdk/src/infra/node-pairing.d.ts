...
export declare function getPairedNode(
  nodeId: string,
  baseDir?: string,
): Promise<NodePairingPairedNode | null>;
export declare function requestNodePairing(
...
export declare function approveNodePairing(
  requestId: string,
  options: {
...
export declare function rejectNodePairing(
  requestId: string,
  baseDir?: string,
): Promise<{
  requestId: string;
...
export declare function removePairedNode(
  nodeId: string,
  baseDir?: string,
): Promise<{
  nodeId: string;
} | null>;
export declare function verifyNodeToken(
  nodeId: string,
  token: string,
  baseDir?: string,
): Promise<{
...
export declare function updatePairedNodeMetadata(
  nodeId: string,
  patch: Partial<Omit<NodePairingPairedNode, "nodeId" | "token" | "createdAtMs" | "approvedAtMs">>,
  baseDir?: string,
): Promise<boolean>;
export declare function renamePairedNode(
  nodeId: string,
  displayName: string,
  baseDir?: string,
): Promise<NodePairingPairedNode | null>;
