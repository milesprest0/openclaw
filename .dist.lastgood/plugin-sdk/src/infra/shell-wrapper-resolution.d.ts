export declare const POSIX_SHELL_WRAPPERS: Set<
...
export declare function unwrapKnownShellMultiplexerInvocation(
  argv: string[],
...
export declare function extractBindableShellWrapperInlineCommand(
  argv: string[],
  rawCommand?: string | null,
): string | null;
export declare function extractShellWrapperCommand(
  argv: string[],
  rawCommand?: string | null,
): ShellWrapperCommand;
export declare function isBlockedShellWrapperCommand(
  argv: string[],
  rawCommand?: string | null,
): boolean;
export {};
