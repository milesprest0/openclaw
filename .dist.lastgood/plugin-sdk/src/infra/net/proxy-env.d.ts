export declare const PROXY_ENV_KEYS: readonly [
  "HTTP_PROXY",
  "HTTPS_PROXY",
  "ALL_PROXY",
  "http_proxy",
 ...
 */
export declare function resolveEnvHttpProxyUrl(
  protocol: "http" | "https",
  env?: NodeJS.ProcessEnv,
): string | undefined;
export declare function hasEnvHttpProxyConfigured(
  protocol?: "http" | "https",
  env?: NodeJS.ProcessEnv,
): boolean;
/**
 ...
 */
export declare function resolveEnvHttpProxyAgentOptions(
  env?: NodeJS.ProcessEnv,
...
export declare function shouldUseEnvHttpProxyForUrl(
  targetUrl: string,
  env?: NodeJS.ProcessEnv,
): boolean;
/**
