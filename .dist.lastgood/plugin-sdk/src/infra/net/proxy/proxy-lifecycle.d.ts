...
declare const ALL_PROXY_ENV_KEYS: readonly [
  "http_proxy",
  "https_proxy",
  "HTTP_PROXY",
  "HTTPS_PROXY",
...
export declare function registerManagedProxyGatewayLoopbackNoProxy(
  url: string,
): (() => void) | undefined;
export declare function withManagedProxyGatewayLoopbackRouting<T>(url: string, run: () => T): T;
export {};
