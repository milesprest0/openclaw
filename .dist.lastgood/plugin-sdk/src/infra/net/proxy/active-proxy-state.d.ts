...
export declare function registerActiveManagedProxyUrl(
  proxyUrl: URL,
  loopbackMode?: ActiveManagedProxyLoopbackMode,
): ActiveManagedProxyRegistration;
export declare function stopActiveManagedProxyRegistration(
  registration: ActiveManagedProxyRegistration,
): void;
export declare function getActiveManagedProxyLoopbackMode():
