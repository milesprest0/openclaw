...
>;
export declare function withStrictGuardedFetchMode(
  params: GuardedFetchPresetOptions,
): GuardedFetchOptions;
export declare function withTrustedEnvProxyGuardedFetchMode(
  params: GuardedFetchPresetOptions,
): GuardedFetchOptions;
export declare function withTrustedExplicitProxyGuardedFetchMode(
  params: GuardedFetchPresetOptions,
): GuardedFetchOptions;
export declare function retainSafeHeadersForCrossOriginRedirectHeaders(
  headers?: HeadersInit,
): Record<string, string> | undefined;
export { fetchWithRuntimeDispatcher } from "./runtime-fetch.js";
export declare function fetchWithSsrFGuard(
