...
export declare function ssrfPolicyFromHttpBaseUrlAllowedHostname(
  baseUrl: string,
): SsrFPolicy | undefined;
export declare function ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist(
  baseUrl: string,
): SsrFPolicy | undefined;
...
export declare function resolvePinnedHostnameWithPolicy(
  hostname: string,
  params?: {
    lookupFn?: LookupFn;
    policy?: SsrFPolicy;
...
export declare function assertHostnameAllowedWithPolicy(
  hostname: string,
  policy?: SsrFPolicy,
): string;
export declare function resolvePinnedHostname(
  hostname: string,
  lookupFn?: LookupFn,
): Promise<PinnedHostname>;
export declare function createPinnedDispatcher(
