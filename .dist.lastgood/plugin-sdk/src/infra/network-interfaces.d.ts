...
export declare function readNetworkInterfaces(
  networkInterfaces?: () => NetworkInterfacesSnapshot,
): NetworkInterfacesSnapshot;
export declare function safeNetworkInterfaces(
  networkInterfaces?: () => NetworkInterfacesSnapshot,
): NetworkInterfacesSnapshot | undefined;
export declare function listExternalInterfaceAddresses(
  snapshot: NetworkInterfacesSnapshot | undefined,
  family?: NetworkInterfaceFamily,
): ExternalNetworkInterfaceAddress[];
export declare function pickMatchingExternalInterfaceAddress(
  snapshot: NetworkInterfacesSnapshot | undefined,
  params: {
    family: NetworkInterfaceFamily;
