...
export declare function resolveControlUiDistIndexPath(
  argv1OrOpts?:
    | string
    | {
        argv1?: string;
...
export declare function isPackageProvenControlUiRootSync(
  root: string,
...
export declare function ensureControlUiAssetsBuilt(
  runtime?: RuntimeEnv,
  opts?: {
    timeoutMs?: number;
  },
