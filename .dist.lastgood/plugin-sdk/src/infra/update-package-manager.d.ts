...
export declare function resolveUpdateBuildManager(
  runCommand: PackageManagerCommandRunner,
  root: string,
  timeoutMs: number,
  baseEnv?: NodeJS.ProcessEnv,
  requirement?: UpdatePackageManagerRequirement,
): Promise<ResolvedBuildManager>;
export declare function managerScriptArgs(
  manager: BuildManager,
  script: string,
  args?: string[],
): string[];
export declare function managerInstallArgs(
  manager: BuildManager,
  opts?: {
