...
export declare function getWindowsInstallRoots(
  env?: Record<string, string | undefined>,
): WindowsInstallRoots;
export declare function getWindowsProgramFilesRoots(
  env?: Record<string, string | undefined>,
): readonly string[];
export declare function _resetWindowsInstallRootsForTests(
