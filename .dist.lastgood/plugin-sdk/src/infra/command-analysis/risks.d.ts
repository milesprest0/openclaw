...
export declare function buildCommandPayloadCandidates(
  argv: string[],
  seenArgv?: Set<string>,
): string[];
export declare function detectCarrierInlineEvalArgv(
  argv: string[],
): InterpreterInlineEvalHit | null;
export declare function detectInlineEvalArgv(
  argv: string[] | undefined | null,
): InterpreterInlineEvalHit | null;
export declare function detectInlineEvalInSegments(
...
export declare function detectShellWrapperThroughCarrierArgv(
  argv: string[],
  shellCommandFlag: (argv: string[], startIndex: number) => unknown,
): string | null;
export declare function detectCarriedShellBuiltinArgv(
  argv: string[],
): CarriedShellBuiltinHit | null;
