...
export declare function ensureFunnel(
  port: number,
  exec?: typeof runExec,
  runtime?: RuntimeEnv,
  prompt?: typeof promptYesNo,
...
export declare function hasTailscaleFunnelRouteForPort(
  port: number,
  exec?: typeof runExec,
): Promise<boolean>;
export declare function tailscaleFunnelStatusCoversPort(
...
export declare function readTailscaleWhoisIdentity(
  ip: string,
  exec?: typeof runExec,
  opts?: {
    timeoutMs?: number;
