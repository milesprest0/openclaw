export declare const GATEWAY_SUPERVISOR_RESTART_HANDOFF_FILENAME =
...
export declare function formatGatewayRestartHandoffDiagnostic(
...
export declare function readGatewayRestartHandoffSync(
  env?: NodeJS.ProcessEnv,
  now?: number,
): GatewayRestartHandoff | null;
