...
export declare function resolveCronRunLogPath(params: { storePath: string; jobId: string }): string;
...
export declare function appendCronRunLog(
  filePath: string,
...
export declare function readCronRunLogEntries(
  filePath: string,
  opts?: {
    limit?: number;
    jobId?: string;
...
export declare function readCronRunLogEntriesSync(
  filePath: string,
  opts?: {
    limit?: number;
    jobId?: string;
...
export declare function readCronRunLogEntriesPage(
  filePath: string,
  opts?: ReadCronRunLogPageOptions,
): Promise<CronRunLogPageResult>;
export declare function readCronRunLogEntriesPageAll(
