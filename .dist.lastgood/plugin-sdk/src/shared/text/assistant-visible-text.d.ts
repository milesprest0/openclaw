export declare function stripToolCallXmlTags(
  text: string,
  options?: {
...
export declare function sanitizeAssistantVisibleTextWithProfile(
  text: string,
 ...
 */
export declare function sanitizeAssistantVisibleTextWithOptions(
  text: string,
  options?: {
    trim?: "none" | "both";
  },
