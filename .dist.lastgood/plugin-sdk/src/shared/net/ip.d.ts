...
export declare function parseCanonicalIpAddress(
...
export declare function isBlockedSpecialUseIpv6Address(
  address: ipaddr.IPv6,
...
export declare function isBlockedSpecialUseIpv4Address(
  address: ipaddr.IPv4,
