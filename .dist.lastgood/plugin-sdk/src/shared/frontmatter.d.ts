...
export declare function getFrontmatterString(
...
export declare function resolveOpenClawManifestRequires(
  metadataObj: Record<string, unknown>,
): OpenClawManifestRequires | undefined;
export declare function resolveOpenClawManifestInstall<T>(
  metadataObj: Record<string, unknown>,
...
export declare function parseOpenClawManifestInstallBase(
  input: unknown,
  allowedKinds: readonly string[],
): ParsedOpenClawManifestInstallBase | undefined;
export declare function applyOpenClawManifestInstallCommonFields<
  T extends {
    id?: string;
    label?: string;
    bins?: string[];
