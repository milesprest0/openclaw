...
export declare function stripInlineDirectiveTagsForDisplay(
  text: string,
): StripInlineDirectiveTagsResult;
export declare function sanitizeReplyDirectiveId(rawReplyToId?: string): string | undefined;
export declare function stripInlineDirectiveTagsForDelivery(
  text: string,
): StripInlineDirectiveTagsResult;
/**
 ...
 */
export declare function stripInlineDirectiveTagsFromMessageForDisplay(
  message: DisplayMessageWithContent | undefined,
): DisplayMessageWithContent | undefined;
export declare function parseInlineDirectives(
  text?: string,
