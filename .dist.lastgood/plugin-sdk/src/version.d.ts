...
export declare function resolveUsableRuntimeVersion(
  version: string | undefined,
): string | undefined;
export declare function resolveRuntimeServiceVersion(
  env?: RuntimeVersionEnv,
  fallback?: string,
): string;
export declare function resolveCompatibilityHostVersion(
  env?: RuntimeVersionEnv,
  fallback?: string,
): string;
