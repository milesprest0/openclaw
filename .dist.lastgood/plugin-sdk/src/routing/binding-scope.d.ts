...
export declare function normalizeRouteBindingRoles(
  value: string[] | null | undefined,
): string[] | null;
export declare function normalizeRouteBindingChannelId(raw?: string | null): string | null;
export declare function resolveNormalizedRouteBindingMatch(
  binding: AgentRouteBinding,
): NormalizedRouteBindingMatch | null;
export declare function routeBindingScopeMatches(
