...
export declare function scopedHeartbeatWakeOptions<T extends object>(
  sessionKey: string,
  wakeOptions: T,
):
  | T
...
export declare function toAgentRequestSessionKey(
...
export declare function classifySessionKeyShape(
