...
>;
export declare function resolveDiagnosticStabilityBundleDir(
  options?: DiagnosticStabilityBundleLocationOptions,
): string;
export declare function listDiagnosticStabilityBundleFilesSync(
  options?: DiagnosticStabilityBundleLocationOptions,
): DiagnosticStabilityBundleFile[];
export declare function readDiagnosticStabilityBundleFileSync(
  file: string,
): ReadDiagnosticStabilityBundleResult;
export declare function readLatestDiagnosticStabilityBundleSync(
  options?: DiagnosticStabilityBundleLocationOptions,
): ReadDiagnosticStabilityBundleResult;
export declare function writeDiagnosticStabilityBundleSync(
  options: WriteDiagnosticStabilityBundleOptions,
): WriteDiagnosticStabilityBundleResult;
export declare function writeDiagnosticStabilityBundleForFailureSync(
  reason: string,
  error?: unknown,
  options?: WriteDiagnosticStabilityBundleForFailureOptions,
): DiagnosticStabilityBundleFailureWriteOutcome;
export declare function installDiagnosticStabilityFatalHook(
  options?: WriteDiagnosticStabilityBundleForFailureOptions,
): void;
