...
export declare function stripRedundantSubsystemPrefixForConsole(
  message: string,
  displaySubsystem: string,
): string;
export declare function createSubsystemLogger(subsystem: string): SubsystemLogger;
export declare function runtimeForLogger(
  logger: SubsystemLogger,
  exit?: RuntimeEnv["exit"],
): OutputRuntimeEnv;
export declare function createSubsystemRuntime(
  subsystem: string,
  exit?: RuntimeEnv["exit"],
): OutputRuntimeEnv;
