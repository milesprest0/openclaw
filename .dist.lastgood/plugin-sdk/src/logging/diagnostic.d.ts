...
export declare function resolveStuckSessionAbortMs(
...
export declare function logSessionStateChange(
  params: SessionRef & {
...
export declare function logSessionAttention(
  params: SessionRef & {
    state: SessionStateValue;
    ageMs: number;
    thresholdMs: number;
...
export declare function logRunAttempt(
  params: SessionRef & {
    runId: string;
    attempt: number;
  },
): void;
export declare function logToolLoopAction(
  params: SessionRef & {
    toolName: string;
...
export declare function startDiagnosticHeartbeat(
