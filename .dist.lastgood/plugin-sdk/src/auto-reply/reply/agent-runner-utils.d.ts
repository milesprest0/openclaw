...
export declare function resolveQueuedReplyExecutionConfig(
...
export declare const resolveEnforceFinalTag: (
  run: FollowupRun["run"],
  provider: string,
  model?: string,
) => boolean;
export declare function buildEmbeddedRunBaseParams(
  ...
  silentReplyPromptMode:
    | import("../../agents/system-prompt.types.ts").SilentReplyPromptMode
    | undefined;
  sourceReplyDeliveryMode:
    | import("openclaw/plugin-sdk/channel-reply-core").SourceReplyDeliveryMode
    | undefined;
  provider: string;
  model: string;
  ...
  execOverrides:
    | Pick<
        import("../../agents/bash-tools.exec-types.ts").ExecToolDefaults,
        "ask" | "host" | "node" | "security"
      >
    | undefined;
  bashElevated:
    | {
