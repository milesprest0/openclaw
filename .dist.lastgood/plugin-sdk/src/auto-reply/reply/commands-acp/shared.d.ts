...
export declare function parseSpawnInput(
...
export declare function parseSingleValueCommandInput(
  tokens: string[],
  usage: string,
):
  | {
...
export declare function parseOptionalSingleTarget(
  tokens: string[],
  usage: string,
):
  | {
