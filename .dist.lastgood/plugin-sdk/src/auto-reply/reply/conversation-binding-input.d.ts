...
export declare function resolveConversationBindingContextFromAcpCommand(
  params: HandleCommandsParams,
): ReturnType<typeof resolveConversationBindingContext>;
export declare function resolveConversationBindingChannelFromMessage(
  ctx: BindingMsgContext,
...
export declare function resolveConversationBindingThreadIdFromMessage(
