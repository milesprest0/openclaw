...
export declare function resolveSubagentEntryForToken(
  runs: SubagentRunRecord[],
...
export declare function resolveRequesterSessionKey(
  params: SubagentsCommandParams,
  opts?: {
    preferCommandTarget?: boolean;
  },
): string | undefined;
export declare function resolveCommandSubagentController(
  params: SubagentsCommandParams,
  requesterKey: string,
