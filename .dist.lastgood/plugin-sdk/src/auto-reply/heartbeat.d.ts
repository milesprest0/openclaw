...
export declare const HEARTBEAT_RESPONSE_TOOL_INSTRUCTIONS =
 ...
 */
export declare function isHeartbeatContentEffectivelyEmpty(
...
export declare function stripHeartbeatToken(
  raw?: string,
  opts?: {
 ...
 */
export declare function isTaskDue(
