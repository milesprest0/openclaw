...
export declare const HEARTBEAT_TOOL_OUTCOMES: readonly [
  "no_change",
  "progress",
  "done",
  "blocked",
...
export declare function normalizeHeartbeatToolResponse(
  value: unknown,
...
export declare function createHeartbeatToolResponsePayload(
  response: HeartbeatToolResponse,
): ReplyPayload;
export declare function resolveHeartbeatToolResponseFromReplyResult(
