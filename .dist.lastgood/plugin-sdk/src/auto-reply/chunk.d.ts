...
export declare function resolveTextChunkLimit(
...
export declare function resolveChunkMode(
  cfg: OpenClawConfig | undefined,
  provider?: TextChunkProvider,
  accountId?: string | null,
): ChunkMode;
 ...
 */
export declare function chunkByNewline(
  text: string,
 ...
 */
export declare function chunkByParagraph(
  text: string,
  limit: number,
  opts?: {
...
export declare function chunkMarkdownTextWithMode(
  text: string,
  limit: number,
  mode: ChunkMode,
): string[];
