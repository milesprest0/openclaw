...
export declare function isBinaryThinkingProvider(
  provider?: string | null,
  model?: string | null,
): boolean;
export declare function supportsXHighThinking(
  provider?: string | null,
  model?: string | null,
): boolean;
export declare function listThinkingLevels(
  provider?: string | null,
  model?: string | null,
  catalog?: ThinkingCatalogEntry[],
): ThinkLevel[];
export declare function listThinkingLevelOptions(
  provider?: string | null,
  model?: string | null,
  catalog?: ThinkingCatalogEntry[],
): ThinkingLevelOption[];
export declare function listThinkingLevelLabels(
  provider?: string | null,
  model?: string | null,
  catalog?: ThinkingCatalogEntry[],
): string[];
export declare function formatThinkingLevels(
  provider?: string | null,
  model?: string | null,
  separator?: string,
  catalog?: ThinkingCatalogEntry[],
...
export declare function resolveLargestSupportedThinkingLevel(
  provider?: string | null,
  model?: string | null,
): ThinkLevel;
