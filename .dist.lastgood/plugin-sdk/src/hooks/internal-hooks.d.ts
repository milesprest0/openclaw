 ...
 */
export declare function unregisterInternalHook(
  eventKey: string,
...
export declare function hasInternalHookListeners(
 ...
 */
export declare function createInternalHookEvent(
  type: InternalHookEventType,
  action: string,
  sessionKey: string,
...
export declare function isGatewayStartupEvent(
  event: InternalHookEvent,
): event is GatewayStartupHookEvent;
export declare function isMessageReceivedEvent(
  event: InternalHookEvent,
...
export declare function isMessageTranscribedEvent(
  event: InternalHookEvent,
): event is MessageTranscribedHookEvent;
export declare function isMessagePreprocessedEvent(
  event: InternalHookEvent,
): event is MessagePreprocessedHookEvent;
export declare function isSessionPatchEvent(
  event: InternalHookEvent,
): event is SessionPatchHookEvent;
