...
export declare function resolveAudioTranscriptionUploadFileName(
  fileName?: string,
  mime?: string,
): string;
...
export declare function fetchWithTimeoutGuarded(
  url: string,
  init: RequestInit,
...
export declare function requireTranscriptionText(
