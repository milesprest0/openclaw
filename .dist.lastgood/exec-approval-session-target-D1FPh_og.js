...
import { t as resolveSessionDeliveryTarget } from "./targets-session-gkBFAJFs.js";
import "./targets-BqvQ_FF9.js";
...
function resolvePersistedApprovalRequestSessionEntry(params) {
  ...
  const agentId =
    parseAgentSessionKey(sessionKey)?.agentId ?? params.request.request.agentId ?? "main";
...
//#endregion
export {
  doesApprovalRequestMatchChannelAccount as a,
  resolveExecApprovalSessionTarget as i,
  resolveApprovalRequestSessionConversation as n,
  resolveApprovalRequestAccountId as o,
  resolveApprovalRequestSessionTarget as r,
  resolveApprovalRequestChannelAccountId as s,
  resolveApprovalRequestOriginTarget as t,
};
