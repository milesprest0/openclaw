...
function createCronRunDiagnosticsFromAgentResult(result, opts) {
  ...
  const failureSignal =
    meta.failureSignal && typeof meta.failureSignal === "object" ? meta.failureSignal : void 0;
...
//#endregion
export {
  summarizeCronRunDiagnostics as a,
  normalizeCronRunDiagnostics as i,
  createCronRunDiagnosticsFromError as n,
  mergeCronRunDiagnostics as r,
  createCronRunDiagnosticsFromAgentResult as t,
};
