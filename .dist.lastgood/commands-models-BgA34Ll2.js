...
import { r as rejectUnauthorizedCommand } from "./command-gates-Dc5hvS1H.js";
...
import { n as isModelPickerVisibleProvider } from "./model-picker-visibility-DsRoNWpN.js";
import { n as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-BTwCXkkK.js";
...
async function buildModelsProviderData(cfg, agentId, options = {}) {
  ...
  const visibleCatalog = resolveVisibleModelCatalog({
    ...
    workspaceDir:
      ...
      (agentId ? resolveAgentWorkspaceDir(cfg, agentId) : void 0) ??
  ...
  const addRawModelRef = (raw) => {
    ...
    const resolved = resolveModelRefFromString({
      raw: trimmed,
      defaultProvider: !trimmed.includes("/")
...
const handleModelsCommand = async (params, allowTextCommands) => {
  ...
  const reply = await resolveModelsCommandReply({
    ...
    workspaceDir:
      ...
      (modelsAgentId === currentAgentId ? params.workspaceDir : void 0),
...
//#endregion
export {
  resolveModelsCommandReply as i,
  formatModelsAvailableHeader as n,
  handleModelsCommand as r,
  buildModelsProviderData as t,
};
