...
import {
  ...
  r as closeWaSocket,
  t as WHATSAPP_LOGGED_OUT_QR_MESSAGE,
...
import { d as renderQrPngDataUrl } from "./media-runtime-Cj72foO4.js";
...
async function startWebLoginWithQr(opts = {}) {
  ...
  if (authState.exists && !opts.force) {
    ...
    return {
      message: `WhatsApp is already linked (${selfId.e164 ?? selfId.jid ?? "unknown"}). Say “relink” if you want a fresh QR.`,
    };
  }
