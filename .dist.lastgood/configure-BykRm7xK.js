...
import { n as applyAuthChoice } from "./auth-choice-b9CHLqOC.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CNNDBjZs.js";
import {
  n as buildGatewayInstallPlan,
  r as gatewayInstallErrorHint,
} from "./auth-install-policy-Cz1r8ABN.js";
import { n as listChatChannels } from "./chat-meta-CUH0ZInO.js";
import { t as createClackPrompter } from "./clack-prompter-GJpmmrX5.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-BDbPXejY.js";
import { t as formatCliCommand } from "./command-format-yMavKibC.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-Do6Hq7Yd.js";
import { t as resolveControlUiLinks } from "./control-ui-links-BDyeBkh9.js";
import {
...
import { t as resolveGatewayInstallToken } from "./gateway-install-token-B-dA6zdQ.js";
import { n as healthCommand } from "./health-CcQ2KCV3.js";
import { n as formatHealthCheckFailure } from "./health-format-rRmRwTQ0.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CEQSCTGy.js";
import {
  a as maybeAddTailnetOriginToControlUiAllowedOrigins,
  i as TAILSCALE_MISSING_BIN_NOTE_LINES,
  n as TAILSCALE_DOCS_LINES,
  r as TAILSCALE_EXPOSURE_OPTIONS,
  t as validateIPv4AddressInput,
} from "./ipv4-C5esf1lo.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-DMiCXsU2.js";
import "./config-CMOdcWpc.js";
import { n as logConfigUpdated } from "./logging-DT4KjV2F.js";
import {
  i as promptModelAllowlist,
  n as applyModelFallbacksFromSelection,
  r as promptDefaultModel,
  t as applyModelAllowlist,
} from "./model-picker-CLYnYoJU.js";
import { t as ConfigMutationConflictError } from "./mutate-IzL9dVFH.js";
import { t as note$1 } from "./note-DvJ3bfgI.js";
import "./workspace-DvzHmVcJ.js";
import "./auth-profiles-BrCJ7JK3.js";
import { i as setupChannels } from "./onboard-channels-Bw-arf0e.js";
import { t as promptCustomApiConfig } from "./onboard-custom-B8mCx5bW.js";
import {
  a as guardCancel,
  c as normalizeGatewayTokenInput,
  f as summarizeExistingConfig,
  m as waitForGatewayReachable,
  n as applyWizardMetadata,
  p as validateGatewayPasswordInput,
  r as ensureWorkspaceAndSessions,
  t as DEFAULT_WORKSPACE,
  u as probeGatewayReachable,
} from "./onboard-helpers-BBY5G06B.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-Db9u6IjM.js";
import { t as setupSkills } from "./onboard-skills-y72WbDi0.js";
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Cnwfh6dH.js";
import { s as resolvePluginContributionOwners } from "./plugin-registry-CWiNK0Xv.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-BeU7cwXO.js";
import { r as withProgress } from "./progress-DRZHxXMU.js";
import {
  n as stylePromptMessage,
  r as stylePromptTitle,
  t as stylePromptHint,
} from "./prompt-style-ZgH7vAUU.js";
import { t as WizardCancelledError } from "./prompts-CGjOiPh-.js";
import { t as isBlockedObjectKey } from "./prototype-keys-D58M68EP.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CYTExC6W.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CapHfLfo.js";
import { t as randomToken } from "./random-token-DmDjF0kN.js";
...
import {
  i as resolveGatewayService,
  t as describeGatewayServiceRestart,
} from "./service-XaNrZpdz.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-Ck_TPJky.js";
import { n as ensureAuthProfileStore } from "./store-9hg03xJO.js";
import { c as normalizeOptionalString, f as readStringValue } from "./string-coerce-BdEutqX5.js";
import { s as normalizeStringEntries } from "./string-normalization-B6JUy5-Y.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-DKgtnjvB.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DJCTl4x4.js";
import { a as findTailscaleBinary } from "./tailscale-DxVPpgKm.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-CaNC1eIn.js";
import {
...
const confirm$1 = (params) =>
  confirm({
    ...params,
    message: stylePromptMessage(params.message),
  });
const select$1 = (params) =>
  select({
    ...params,
    message: stylePromptMessage(params.message),
...
function compareChannelRemovalChoices(left, right) {
  return (
    left.label.localeCompare(right.label, void 0, {
      numeric: true,
      sensitivity: "base",
    }) ||
  ...
  if (shouldInstall) {
    ...
    if (!params.daemonRuntime)
      if (GATEWAY_DAEMON_RUNTIME_OPTIONS.length === 1)
        daemonRuntime = GATEWAY_DAEMON_RUNTIME_OPTIONS[0]?.value ?? "node";
      else
...
async function resolveProviderChoiceModelPrompt(params) {
  const { resolvePluginProviders, resolveProviderPluginChoice } =
    await import("./provider-auth-choice.runtime-BVKgj_-J.js");
...
function resolveConfiguredProviderFromAuthChange(params) {
  ...
  return (
    params.preferredProvider ?? (configuredProviders.length === 1 ? configuredProviders[0] : void 0)
  );
}
...
async function promptGatewayConfig(cfg, runtime) {
  ...
  let customBindHost;
  if (bind === "custom")
    customBindHost = readStringValue(
      guardCancel(
        await text$1({
  ...
  if (authMode === "trusted-proxy") {
    ...
    trustedProxies = normalizeStringEntries(
      guardCancel(
        await text$1({
...
const setupPluginConfigModuleLoader = createLazyImportLoader(
  () => import("./setup.plugin-config-CbZE1e2X.js"),
);
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
  ...
  const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CAVtgXjy.js");
  ...
  if (enableSearch) {
    ...
    if (configureManagedProvider) {
      const { resolveSearchProviderOptions, setupSearch } =
        await import("./onboard-search-BK25Pl0q.js");
        ...
        try {
          ...
          if (err instanceof ConfigMutationConflictError && attempt < maxRetries - 1) {
            ...
            nextConfig = mergeWizardConfigOntoLatest(
              freshSnapshot.valid ? (freshSnapshot.sourceConfig ?? freshSnapshot.config) : {},
              mergeBaseConfig,
              nextConfig,
            );
            continue;
...
//#endregion
export {
  buildGatewayAuthConfig as n,
  CONFIGURE_WIZARD_SECTIONS as r,
  configureCommandFromSectionsArg as t,
};
