...
import { t as APEv2Parser } from "./APEv2Parser-B7oX-NFw.js";
import {
  C as UINT32_LE,
  a as UnsupportedFileTypeError,
  i as InternalParserError,
  k as textDecode,
  n as CouldNotDetermineFileTypeError,
} from "./BasicParser-DC3r8A4g.js";
import { s as __toESM, t as __commonJSMin } from "./chunk-A-jGZS85.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DFzvMrAH.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-Ck_ECRa1.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Dy7Qkhjs.js";
import { t as require_src } from "./src-Dce2BfHT.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-FndFYD-a.js";
import { l as toRatio, n as decodeString } from "./Util-DouHaPQs.js";
...
var MetadataCollector = class {
  ...
  handlePluralArtistTag(tagType, tag, singularId, pluralId) {
    if (
      !this.common[singularId] ||
      this.commonOrigin[singularId] === this.originPriority.artificial
    ) {
...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BI90J8Vk.js")).MpegParser;
  },
};
//#endregion
...
const apeParserLoader = {
  ...
  async load() {
    return (await import("./APEv2Parser-vb68UiXW.js")).APEv2Parser;
  },
};
//#endregion
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CLhLbf6u.js")).AsfParser;
  },
};
//#endregion
...
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-D1ol-Z_g.js")).DsdiffParser;
  },
};
//#endregion
...
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BgmNz2MD.js")).AIFFParser;
  },
};
//#endregion
...
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-D7rEGj0c.js")).DsfParser;
  },
};
//#endregion
...
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser--49aDT6F.js")).FlacParser;
  },
};
//#endregion
...
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CDZ6knsC.js")).MatroskaParser;
  },
};
//#endregion
...
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CSXF68m9.js")).MP4Parser;
  },
};
//#endregion
...
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-JxZMTPTr.js")).MusepackParser;
  },
};
//#endregion
...
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BTg8V6Ym.js")).OggParser;
  },
};
//#endregion
...
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser--7dYvYrY.js")).WavPackParser;
  },
};
//#endregion
...
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CCByj6FT.js")).WaveParser;
  },
};
//#endregion
...
//#endregion
export {
  scanAppendingHeaders as a,
  parseFromTokenizer as i,
  parseStream as n,
  parseBuffer as r,
  parseFile as t,
};
