import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-Ctry1Kkb.js";
import "./text-runtime-lKuAtsoz.js";
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-Ccuh9sQV.js";
...
import {
  ...
  t as shouldHandleDiscordApprovalRequest,
...
function createDiscordOriginTargetResolver(configOverride) {
  return createChannelNativeOriginTargetResolver({
    ...
    resolveSessionTarget: (sessionTarget, request) => {
      ...
      if (extractDiscordSessionKind(request.request.sessionKey?.trim() || null) === "dm")
        return null;
...
function createDiscordApprovalCapability(configOverride) {
  return createApproverRestrictedNativeApprovalCapability({
    ...
    nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
      ...
      load: async () =>
        (await import("./approval-handler.runtime-CQRVlURC.js")).discordApprovalNativeRuntime,
    }),
  });
}
