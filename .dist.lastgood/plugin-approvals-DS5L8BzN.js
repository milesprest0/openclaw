...
const DEFAULT_PLUGIN_APPROVAL_DECISIONS = ["allow-once", "allow-always", "deny"];
...
//#endregion
export {
  PLUGIN_APPROVAL_TITLE_MAX_LENGTH as a,
  buildPluginApprovalRequestMessage as c,
  PLUGIN_APPROVAL_DESCRIPTION_MAX_LENGTH as i,
  buildPluginApprovalResolvedMessage as l,
  DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS as n,
  approvalDecisionLabel as o,
  MAX_PLUGIN_APPROVAL_TIMEOUT_MS as r,
  buildPluginApprovalExpiredMessage as s,
  DEFAULT_PLUGIN_APPROVAL_DECISIONS as t,
  resolvePluginApprovalRequestAllowedDecisions as u,
};
