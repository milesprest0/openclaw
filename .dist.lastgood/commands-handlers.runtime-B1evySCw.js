...
import {
  n as resolveSessionEntryForKey,
  r as stopSubagentsForRequester,
  t as formatAbortReplyText,
} from "./abort-CkvPjBug.js";
import {
  a as shouldPersistAbortCutoff,
  i as resolveAbortCutoffFromContext,
  t as applyAbortCutoffToSessionEntry,
} from "./abort-cutoff-BgQZjRld.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-DPafrLy1.js";
import { r as normalizeOptionalAccountId } from "./account-id-BGKP_Par.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-mfAxMkYt.js";
...
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-DRiyym18.js";
import { t as isApprovalNotFoundError } from "./approval-errors-oLJjT2o6.js";
import "./archive-D8PAqNPu.js";
import "./installed-plugin-index-records-BD2sKB0z.js";
import { s as resolveArchiveKind } from "./archive-CfKTdlm5.js";
import { r as createExecTool } from "./bash-tools-K-AOne0H.js";
import { v as getFinishedSession, y as getSession } from "./bash-tools.exec-runtime-Brc0frDH.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BBGdGMkr.js";
import { t as extractBtwQuestion } from "./btw-command-DAC8FJcL.js";
import "./config-CMOdcWpc.js";
import { i as callGateway } from "./call-hIeQLRKk.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./channel-catalog-registry-uu7_tUkL.js";
import {
  _ as authorizeConfigWriteShared,
  b as resolveConfigWriteTargetFromPathShared,
  v as canBypassConfigWritePolicyShared,
  y as formatConfigWriteDeniedMessageShared,
} from "./channel-config-helpers-DVht29vx.js";
import { n as estimateTokensFromChars } from "./cjk-chars-CsQDKzuc.js";
import { r as installPluginFromClawHub } from "./clawhub-Bc1Chqe7.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-BFQuGMJA.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-BBJMHWvK.js";
import {
  a as requireGatewayClientScopeForInternalChannel,
  i as requireCommandFlagEnabled,
  n as rejectNonOwnerCommand,
  r as rejectUnauthorizedCommand,
  t as buildDisabledCommandReply,
} from "./command-gates-Dc5hvS1H.js";
import {
  n as buildCommandsMessagePaginated,
  r as buildHelpMessage,
  t as buildCommandsMessage,
} from "./command-status-builders-CO-ZMsTv.js";
import { t as handleAcpCommand } from "./commands-acp-CHdjFQZs.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-X9XPF_S-.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-DxJLSJ0J.js";
import { r as handleModelsCommand } from "./commands-models-BgA34Ll2.js";
import {
  i as resolveTextCommand,
  r as normalizeCommandBody,
} from "./commands-registry-normalize-Cuat2kXh.js";
import { t as buildStatusReply } from "./commands-status-qxnmt-0C.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-eNeAi_Jx.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DSmuIKZj.js";
import {
  i as unsetConfigValueAtPath,
  n as parseConfigPath,
  r as setConfigValueAtPath,
  t as getConfigValueAtPath,
} from "./config-paths-ChbcwAm6.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-vXPPKbVX.js";
import {
...
import { t as diagnosticLogger } from "./diagnostic-runtime-Bcy49DVv.js";
import {
  n as extractExplicitGroupId,
  t as formatElevatedUnavailableMessage,
} from "./elevated-unavailable-B0DCC4I6.js";
import "./diagnostic-TRyCbvnu.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { t as resolveFastModeState } from "./fast-mode-C7KEUg_P.js";
import { t as formatDurationCompact } from "./format-duration-DV-29w1K.js";
import { n as formatTimeAgo } from "./format-relative-Dc5mB_gw.js";
import { T as pathExists } from "./fs-safe-CgBWiL92.js";
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-DwslkMeP.js";
import "./selection-BcCvjGlJ.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { n as parseActivationCommand } from "./group-activation-DbPqof9Q.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-Djc3uDTp.js";
...
import {
  M as resetConfigOverrides,
  N as setConfigOverride,
  P as unsetConfigOverride,
  T as validateConfigObjectWithPlugins,
  j as getConfigOverrides,
  u as readConfigFileSnapshot,
} from "./io-CEQSCTGy.js";
import { t as createLazyImportLoader } from "./lazy-promise-B1nDYoKn.js";
import {
  i as parseConfigValue,
  n as setConfiguredMcpServer,
  r as unsetConfiguredMcpServer,
  t as listConfiguredMcpServers,
} from "./mcp-config-Dh5nL-t5.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-CX9MvOD0.js";
import {
  r as isInternalMessageChannel,
...
import { r as resolveModelWithRegistry } from "./model-Du5PofNQ.js";
...
import {
  ...
  n as getOfficialExternalPluginCatalogEntryForPackage,
  s as resolveOfficialExternalPluginId,
} from "./official-external-plugin-catalog-BYIstKqF.js";
import { r as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-CqBr51KZ.js";
import {
  a as readChannelAllowFromStore,
  l as removeChannelAllowFromStoreEntry,
...
import {
  ...
  r as resolveDefaultSessionStorePath,
} from "./paths-CfeECf6Z.js";
import "./sandbox-Cz0C2Qt-.js";
...
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-CM7tdiQ8.js";
import {
  d as resolveFileNpmSpecToLocalPath,
  r as createPluginInstallLogger,
} from "./plugins-command-helpers-D4actSTy.js";
import "./commands-registry-8mCZwy9x.js";
import {
  n as resolveChannelApprovalCapability,
  t as resolveChannelApprovalAdapter,
} from "./plugins-Dn-pJrhh.js";
import {
  n as persistPluginInstall,
  r as buildNpmInstallRecordFields,
} from "./plugins-install-persist-BTCVIEDE.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-1zaTwAzG.js";
...
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-DueHRTen.js";
...
import { n as routeReply } from "./route-reply-DsTHhNFd.js";
import { h as replyRunRegistry } from "./run-state-uLckWPme.js";
import {
  a as getActiveEmbeddedRunSnapshot,
  d as resolveActiveEmbeddedRunSessionId,
  l as queueEmbeddedPiMessage,
  o as isEmbeddedPiRunActive,
} from "./runs-CztEUxOL.js";
import { t as getActivePluginChannelRegistry } from "./runtime-ChXyIFtl.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CBtIrgBf.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-r0KsiafK.js";
import { r as getSessionBindingService } from "./session-binding-service-DjzRXKiv.js";
import {
  i as loadSessionCostSummary,
  n as loadCostUsageSummary,
} from "./session-cost-usage-sI8mpVrS.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-B4qUwRzq.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override--A-ozV0V.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-BjkUYNeL.js";
...
import {
  d as resolveChannelAccountId,
  f as resolveCommandSurfaceChannel,
  l as resolveSubagentsAction,
  o as resolveHandledPrefix,
  s as resolveRequesterSessionKey,
  u as stopWithText,
} from "./shared-DzDfuLAz.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DaDbzwlG.js";
import {
  a as buildPluginDiagnosticsReport,
  l as formatPluginCompatibilityNotice,
  o as buildPluginInspectReport,
  s as buildPluginRegistrySnapshotReport,
  t as buildAllPluginInspectReports,
} from "./status-BpQ1MVWd.js";
import { t as buildToolsMessage } from "./status-D7Y_gYth.js";
...
import "./command-export-CZhqCJeR.js";
import { s as normalizeStringEntries } from "./string-normalization-B6JUy5-Y.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-D_kvNQoY.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B5riyWdi.js";
import {
  n as listTasksForAgentIdForStatus,
  r as listTasksForSessionKeyForStatus,
} from "./task-status-access-DvVBcOJ1.js";
import {
  n as formatTaskStatusDetail,
  r as formatTaskStatusTitle,
  t as buildTaskStatusSnapshot,
} from "./task-status-BnrukRw_.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-C9_Z62px.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DyjCuJxS.js";
import "./clawhub-DyDPbDAx.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-DNLuAy8Q.js";
import { r as isSilentReplyPayloadText } from "./tokens-DWz8lWRf.js";
import {
  i as resolveImageSanitizationLimits,
  n as sanitizeImageBlocks,
} from "./tool-images-D8ZmIpdW.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CPI5yE2K.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-B5N3gLUE.js";
import {
  C as setTtsEnabled,
  E as setTtsProvider,
  T as setTtsPersona,
...
import { o as resolveFreshSessionTotalTokens } from "./types-C7lm-riv.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-DQx7gWeg.js";
import { p as resolveUserPath, r as clampInt } from "./utils-BGRcpLKt.js";
...
async function resolveAllowlistNames(params) {
  return mapResolvedAllowlistNames(
    (await getChannelPlugin(params.channelId)?.allowlist?.resolveNames?.({
      cfg: params.cfg,
      accountId: params.accountId,
      scope: params.scope,
...
async function readAllowlistConfig(params) {
  return (
    (await getChannelPlugin(params.channelId)?.allowlist?.readConfig?.({
      cfg: params.cfg,
      accountId: params.accountId,
    })) ?? {}
  );
...
const handleAllowlistCommand = async (params, allowTextCommands) => {
  ...
  if (shouldUpdateConfig) {
    ...
    if (!configChanged && !shouldTouchStore)
      return {
        shouldContinue: false,
        reply: {
          text: parsed.action === "add" ? "✅ Already allowlisted." : "⚠️ Entry not found.",
        },
      };
    if (shouldTouchStore)
    ...
    return {
      shouldContinue: false,
      reply: {
        text: `✅ ${scopeLabel} allowlist ${actionLabel}: ${locations.length > 0 ? locations.join(" + ") : "no-op"}.`,
      },
    };
  }
  if (!shouldTouchStore)
  ...
  return {
    shouldContinue: false,
    reply: {
      text: `✅ ${parsed.scope === "dm" ? "DM" : "group"} allowlist ${actionLabel} in pairing store.`,
    },
  };
};
//#endregion
...
const handleApproveCommand = async (params, allowTextCommands) => {
  ...
  const approveCommandBehavior = resolveChannelApprovalCapability(
...
function resolveRawCommandBody(params) {
  const stripped = stripStructuralPrefixes(
...
async function handleBashChatCommand(params) {
  ...
  const request = parseBashRequest(
    resolveRawCommandBody({
      ctx: params.ctx,
      cfg: params.cfg,
      agentId,
  ...
  if (request.action === "stop") {
    ...
    if (!running.backgrounded)
      return { text: `⚠️ Session ${formatSessionSnippet(sessionId)} is not backgrounded.` };
    ...
    const { killProcessTree } = await import("./kill-tree-TdNhiaWp.js");
    killProcessTree(pid);
    return {
  ...
  if (liveJob)
    return {
      text: `⚠️ A bash job is already running (${liveJob.state === "running" ? formatSessionSnippet(liveJob.sessionId) : "starting"}). Use !poll / !stop (or /bash poll / /bash stop).`,
    };
...
const handleBtwCommand = async (params, allowTextCommands) => {
  ...
  const sessionAgentId = params.sessionKey
    ...
    : params.agentId;
  const agentDir =
    (sessionAgentId ? resolveAgentDir(params.cfg, sessionAgentId) : void 0) ?? params.agentDir;
  if (!agentDir)
    return {
      shouldContinue: false,
      reply: {
...
function extractCompactInstructions(params) {
  ...
  const trimmed = (
    params.isGroup ? stripMentions(raw, params.ctx, params.cfg, params.agentId) : raw
  ).trim();
  if (!trimmed) return;
  const prefix = normalizeLowercaseStringOrEmpty(trimmed).startsWith("/compact")
    ? "/compact"
    : null;
  if (!prefix) return;
...
const handleCompactCommand = async (params) => {
  ...
  const sessionAgentDir =
    sessionAgentId === (params.agentId ?? "main") && params.agentDir
      ? params.agentDir
  ...
  const result = await runtime.compactEmbeddedPiSession({
    ...
    model: params.model,
    agentHarnessId:
      targetSessionEntry.sessionId === sessionId ? targetSessionEntry.agentHarnessId : void 0,
  ...
  const totalTokens =
    result.result?.tokensAfter ?? runtime.resolveFreshSessionTotalTokens(targetSessionEntry);
...
const handleConfigCommand = async (params, allowTextCommands) => {
  ...
  const nonOwner =
    configCommand.action === "show" && isInternalMessageChannel(params.command.channel)
      ? null
      : rejectNonOwnerCommand(params, "/config");
  if (nonOwner) return nonOwner;
  const disabled = requireCommandFlagEnabled(params.cfg, {
    label: "/config",
    configKey: "config",
  ...
  if (configCommand.action === "unset") {
    if (!unsetConfigValueAtPath(parsedBase, parsedWritePath ?? []))
      return {
        shouldContinue: false,
...
async function resolveContextReport(params) {
  ...
  const { resolveCommandsSystemPromptBundle } =
    await import("./commands-system-prompt-CyEZi8Oy.js");
...
async function buildContextReply(params) {
  const targetSessionEntry = params.sessionStore?.[params.sessionKey] ?? params.sessionEntry;
  const sub = normalizeLowercaseStringOrEmpty(
    parseContextArgs(params.command.commandBodyNormalized).split(/\s+/).find(Boolean),
  );
  if (!sub || sub === "help")
    return {
      text: [
  ...
  const formatNameList = (names, cap) =>
    names.length <= cap
      ? names.join(", ")
  ...
  const truncationCauseCounts = truncatedBootstrapFiles.reduce(
    (acc, file) => {
      for (const cause of file.causes)
        if (cause === "per-file-limit") acc.perFile += 1;
...
async function resolvePrivateCommandRouteTargets(params) {
  ...
  for (const candidate of listPrivateCommandRouteCandidateChannels(originChannel)) {
    ...
    const accountId =
      candidate.channel === originChannel ? (params.commandParams.ctx.AccountId ?? void 0) : void 0;
...
async function handleDiagnosticsCommandWithDeps(deps, params, allowTextCommands) {
  ...
  if (params.isGroup) {
    ...
    return {
      shouldContinue: false,
      reply: {
        text: (await deps.deliverPrivateDiagnosticsReply({
          commandParams: params,
          targets: [privateTarget],
          reply: privateReply,
        }))
          ? DIAGNOSTICS_PRIVATE_ROUTE_ACK
          : DIAGNOSTICS_PRIVATE_ROUTE_UNAVAILABLE,
      },
    };
  }
    ...
    const result = await deps
      .createExecTool({
        ...
        accountId: options.privateApprovalTarget
          ? (options.privateApprovalTarget.accountId ?? void 0)
          : (params.ctx.AccountId ?? void 0),
...
function hasCodexHarnessMetadata(params) {
  if ((params.sessionStore?.[params.sessionKey] ?? params.sessionEntry)?.agentHarnessId === "codex")
    return true;
...
async function executeCodexDiagnosticsAddon(params, args, options = {}) {
  ...
  return await executePluginCommand({
    ...
    ...(options.diagnosticsUploadApproved === void 0
      ? {}
      : { diagnosticsUploadApproved: options.diagnosticsUploadApproved }),
    ...(options.diagnosticsPreviewOnly === void 0
      ? {}
      : { diagnosticsPreviewOnly: options.diagnosticsPreviewOnly }),
    ...(options.diagnosticsPrivateRouted === void 0
      ? {}
...
function buildCodexDiagnosticsSessions(params) {
  ...
  for (const [sessionKey, entry] of Object.entries(params.sessionStore ?? {}))
    if (entry) sessions.set(sessionKey, entry);
  return Array.from(sessions.entries())
    ...
    .map(([sessionKey, entry]) => ({
      ...
      accountId:
        ...
        (sessionKey === params.sessionKey ? (params.ctx.AccountId ?? void 0) : void 0),
      messageThreadId:
  ...
  for (const ids of Object.values(params.identityLinks)) {
    ...
    if (
      !ids
        ...
        .filter(Boolean)
        .some((id) => params.sourceCandidates.has(id))
    )
      continue;
    for (const id of ids) {
...
const handleDockCommand = async (params, allowTextCommands) => {
  ...
  if (!(await persistSessionEntry(params)))
    return {
      shouldContinue: false,
...
function parseExportCommandOutputPath(commandBodyNormalized, aliases) {
  ...
  const outputPath = normalized
    .replace(new RegExp(`^/(${aliasPattern})\\s*`), "")
    .trim()
    .split(/\s+/)
...
async function buildExportTrajectoryCommandReply(params, deps = {}) {
  ...
  if (params.isGroup) {
    ...
    return {
      text: (await resolvedDeps.deliverPrivateTrajectoryReply({
        commandParams: params,
        targets: [privateTarget],
        reply: privateReply,
      }))
...
const handleToolsCommand = async (params, allowTextCommands) => {
  ...
  try {
    ...
    return {
      shouldContinue: false,
      reply: {
        text: String(err).includes("missing scope:")
...
const handleStatusCommand = async (params, allowTextCommands) => {
  if (!allowTextCommands) return null;
  if (!(params.directives.hasStatusDirective || params.command.commandBodyNormalized === "/status"))
    return null;
  if (!params.command.isAuthorizedSender) {
    logVerbose(
...
const handleMcpCommand = async (params, allowTextCommands) => {
  ...
  const nonOwner =
    mcpCommand.action === "show" && isInternalMessageChannel(params.command.channel)
      ? null
      : rejectNonOwnerCommand(params, "/mcp");
  if (nonOwner) return nonOwner;
  const disabled = requireCommandFlagEnabled(params.cfg, {
    label: "/mcp",
    configKey: "mcp",
  ...
  if (mcpCommand.action === "show") {
    ...
    if (mcpCommand.name) {
      ...
      return {
        shouldContinue: false,
        reply: {
          text: renderJsonBlock$1(`🔌 MCP server "${mcpCommand.name}" (${loaded.path})`, server),
        },
      };
    }
...
function formatPluginsList(report) {
  ...
  return [
    `🔌 Plugins (${report.plugins.filter((plugin) => plugin.status === "loaded").length}/${report.plugins.length} loaded)`,
...
const handlePluginsCommand = async (params, allowTextCommands) => {
  ...
  const nonOwner =
    ...
    isInternalMessageChannel(params.command.channel)
      ? null
      : rejectNonOwnerCommand(params, "/plugins");
  if (nonOwner) return nonOwner;
  const disabled = requireCommandFlagEnabled(params.cfg, {
    label: "/plugins",
    configKey: "plugins",
...
function parseSendPolicyCommand(raw) {
  ...
  const match = normalizeCommandBody(stripInboundMetadata(trimmed)).match(
    /^\/send(?:\s+([a-zA-Z]+))?\s*$/i,
  );
...
async function abortEmbeddedPiRunForSession(sessionId) {
  const { abortEmbeddedPiRun } = await import("./runs-C2rgbsf6.js");
...
const handleStopCommand = async (params, allowTextCommands) => {
  ...
  await triggerInternalHook(
    createInternalHookEvent("command", "stop", abortTarget.key ?? params.sessionKey ?? "", {
...
const handleSendPolicyCommand = async (params, allowTextCommands) => {
  ...
  return {
    shouldContinue: false,
    reply: {
      text: `⚙️ Send policy set to ${sendPolicyCommand.mode === "inherit" ? "inherit" : sendPolicyCommand.mode === "allow" ? "on" : "off"}.`,
    },
  };
};
...
const handleFastCommand = async (params, allowTextCommands) => {
  ...
  const rawMode = normalizeLowercaseStringOrEmpty(
    normalized === "/fast" ? "" : normalized.slice(5).trim(),
  );
...
const handleSessionCommand = async (params, allowTextCommands) => {
  ...
  const channelId =
    params.command.channelId ??
    normalizeChannelId$1(resolveCommandSurfaceChannel(params)) ??
    void 0;
  ...
  if (!bindingContext) {
    if (!channelId || !commandSupportsCurrentConversationBinding || !commandSupportsLifecycleUpdate)
      return {
        shouldContinue: false,
        reply: {
  ...
  const idleExpiresAt =
    idleTimeoutMs > 0 ? resolveSessionBindingLastActivityAt(activeBinding) + idleTimeoutMs : void 0;
...
function resolveSteerSessionId(params) {
  ...
  const sessionId = normalizeOptionalString(
    resolveStoredSessionEntry(params.commandParams, params.targetSessionKey)?.sessionId,
  );
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-BWZ3a_SZ.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-hUKlurlw.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-C7k7N_Kw.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-D9WARpEb.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-HtYsmJ93.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-BuqaVQCB.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-CjUfQqCL.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-C8senvvf.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-x9-A9H65.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-Bb_vlsHY.js"));
const controlRuntimeLoader = createLazyImportLoader(
  () => import("./commands-subagents-control.runtime-S2NHc4Yo.js"),
);
...
const handleSubagentsCommand = async (params, allowTextCommands) => {
  ...
  const requesterKey =
    action === "spawn"
      ? resolveRequesterSessionKey(params, { preferCommandTarget: true })
...
const handleTtsCommands = async (params, allowTextCommands) => {
  ...
  if (
    ...
    const latestText = (
      await readLatestAssistantTextFromSessionTranscript(params.sessionEntry.sessionFile)
    )?.text.trim();
