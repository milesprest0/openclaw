...
import { s as resolveBootstrapMode } from "./selection-BcCvjGlJ.js";
import {
  i as buildLimitedBootstrapPromptLines,
  r as buildFullBootstrapPromptLines,
} from "./system-prompt-vWC2MZis.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CPI5yE2K.js";
import { d as isWorkspaceBootstrapPending } from "./workspace-DvzHmVcJ.js";
  ...
  try {
    ...
    return new Map(
      uniqueStamps.map((stamp) => {
        ...
        return [
          stamp,
          [`${stamp}.md`, ...newestSluggedNames.slice(0, STARTUP_MEMORY_MAX_SLUGGED_FILES_PER_DAY)],
        ];
      }),
    );
  } catch {
...
//#endregion
export {
  resolveBareSessionResetPromptState as i,
  shouldApplyStartupContext as n,
  resolveBareResetBootstrapFileAccess as r,
  buildSessionStartupContextPrelude as t,
};
