...
import {
  ...
  o as listGoogleChatReactions,
  r as deleteGoogleChatReaction,
  t as createGoogleChatReaction,
...
import { i as resolveGoogleChatOutboundSpace } from "./targets-CecuSsuX.js";
...
function isReactionsEnabled(accounts) {
  for (const account of accounts)
    if (createActionGate(account.config.actions)("reactions")) return true;
  return false;
}
