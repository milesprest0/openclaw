...
import { n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-mwkm9MN4.js";
import { r as getSessionBindingService } from "./session-binding-service-DjzRXKiv.js";
import "./routing-BccEMOrJ.js";
import "./acp-binding-resolve-runtime-DWx_ZlS9.js";
...
function resolveMatrixThreadRouting(params) {
  const effectiveThreadReplies =
    params.isDirectMessage && params.dmThreadReplies !== void 0
    ...
    threadId:
      effectiveThreadReplies === "off"
        ...
        : effectiveThreadReplies === "inbound"
          ? inboundThreadId
          : (inboundThreadId ?? (messageId || void 0)),
  };
}
...
export {
  EventType as a,
  resolveMatrixThreadRouting as i,
  resolveMatrixReplyToEventId as n,
  RelationType as o,
  resolveMatrixThreadRootId as r,
  resolveMatrixInboundRoute as t,
};
