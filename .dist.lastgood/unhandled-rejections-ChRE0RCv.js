...
function isTransientFileWatchError(err) {
  if (!err) return false;
  const hasFileWatchSignal = (message) =>
  ...
  const hasFileWatchExhaustionSignal = (message) =>
...
//#endregion
export {
  isTransientNetworkError as a,
  isUncaughtExceptionHandled as c,
  registerUnhandledRejectionHandler as d,
  isTransientFileWatchError as i,
  isUnhandledRejectionHandled as l,
  isAbortError as n,
  isTransientSqliteError as o,
  isBenignUncaughtExceptionError as r,
  isTransientUnhandledRejectionError as s,
  installUnhandledRejectionHandler as t,
  registerUncaughtExceptionHandler as u,
};
