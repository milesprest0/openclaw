import {
  c as joinPresentTextSegments,
  t as getGlobalHookRunner,
} from "./hook-runner-global-DzzZF3B1.js";
import "./errors-DZMrVkYL.js";
import { a as buildAgentHookContext } from "./lifecycle-hook-helpers-HMjMszrP.js";
import "./version-BZr74W_5.js";
import "./agent-scope-9AmhTwki.js";
import { v as listCodexAppServerExtensionFactories } from "./loader-BLowS1kl.js";
import "./registry-D11nh-V3.js";
import { a as redactToolDetail } from "./redact-Mxj55RzQ.js";
import { t as createSubsystemLogger } from "./subsystem-Bjz8a2fE.js";
import "./session-write-lock-DjdS_616.js";
import "./transcript-B5N3gLUE.js";
import "./runs-CztEUxOL.js";
import "./bootstrap-files-C8WUuJVf.js";
import "./pi-tools.before-tool-call-KxT3QmrR.js";
import "./model-auth-Do8Bfz1M.js";
import "./tool-result-middleware-CJ4A8Wvz.js";
import "./logger-Ce0PtXjG.js";
import "./provider-auth-D0H8jtwm.js";
import "./heartbeat-tool-response-Dx8N2J-j.js";
import "./attempt.tool-run-context-DNKKeHVU.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-qyfb5lzi.js";
import "./tool-meta-DI7YbTn_.js";
import "./gateway-VO6GibHc.js";
import "./nodes-utils-B1_2Nbxw.js";
import "./sandbox-Cz0C2Qt-.js";
import "./attempt.thread-helpers-CPhQxp3A.js";
import "./result-fallback-classifier-Cnc2xj7H.js";
import "./build-BPMIpRAa.js";
import { y as truncateUtf16Safe } from "./utils-BGRcpLKt.js";
import "./native-hook-relay-AxDet15L.js";
...
function createCodexAppServerToolResultExtensionRunner(
  ctx,
  factories = listCodexAppServerExtensionFactories(),
) {
  const handlers = [];
  const runtime = {
    on(event, handler) {
  ...
  return {
    async applyToolResultExtensions(event) {
      await initPromise;
...
function classifyAgentHarnessTerminalOutcome(params) {
  if (
    ...
    (params.promptError !== void 0 && params.promptError !== null) ||
...
//#endregion
export {
  createCodexAppServerToolResultExtensionRunner as a,
  runAgentHarnessBeforeCompactionHook as c,
  inferToolMetaFromArgs as i,
  classifyAgentHarnessTerminalOutcome as n,
  resolveAgentHarnessBeforePromptBuildResult as o,
  formatToolProgressOutput as r,
  runAgentHarnessAfterCompactionHook as s,
  TOOL_PROGRESS_OUTPUT_MAX_CHARS as t,
};
