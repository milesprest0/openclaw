...
import { r as resolveCrestodianOperation } from "./dialogue-BE9EboBU.js";
import {
  i as isPersistentCrestodianOperation,
  n as executeCrestodianOperation,
} from "./operations-DkxdAyKV.js";
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-BrhxgTRB.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
  ...
  const runInteractiveTui =
    opts.runInteractiveTui ?? (await import("./tui-backend-BphNganT.js")).runCrestodianTui;
  opts.onReady?.();
