...
import {
  f as listConfiguredChannelIdsForReadOnlyScope,
  p as listExplicitConfiguredChannelIdsForConfig,
} from "./channel-plugin-ids-C9CG3lVz.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CiF70epQ.js";
...
import { r as getConfiguredChannelsCommandSecretTargetIds } from "./command-secret-targets-CkWxZ_Vf.js";
import { n as requireValidConfigSnapshot } from "./config-validation-DPqhMlGD.js";
...
import { t as resolveMissingOfficialExternalChannelPluginRepairHint } from "./official-external-plugin-repair-hints-0-5CLeOd.js";
...
import { o as redactSensitiveUrlLikeString } from "./redact-sensitive-url-Bu3cghBT.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-kqN0Yohi.js";
import {
  a as buildChannelAccountLine,
  i as appendTokenSourceBits,
  n as appendEnabledConfiguredLinkedBits,
  r as appendModeBit,
  t as appendBaseUrlBit,
} from "./shared-DbFZmdPe.js";
import {
  r as buildReadOnlySourceChannelAccountSnapshot,
  t as buildChannelAccountSnapshot,
} from "./status-B3gyOjOn.js";
...
async function formatConfigChannelsStatusLines(cfg, meta, opts) {
  ...
  const accountLines = (plugin, accounts) =>
...
function formatGatewayChannelsStatusLines(payload) {
  ...
  const channelLabels =
    payload.channelLabels && typeof payload.channelLabels === "object" ? payload.channelLabels : {};
  const accountLines = (provider, accounts) =>
    accounts.map((account) => {
      const bits = [];
      appendEnabledConfiguredLinkedBits(bits, account);
