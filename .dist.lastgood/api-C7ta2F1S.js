...
import "./setup-core-BKAKPD2K.js";
import {
  i as sendMessageZalouser,
  n as sendImageZalouser,
  r as sendLinkZalouser,
} from "./send-BoM09TMf.js";
import "./channel-B_Vb2oH4.js";
import { r as parseZalouserOutboundTarget } from "./session-route-CNqJY4ys.js";
import "./setup-surface-a4xmFBYp.js";
import "./channel.setup-BSpB3YGM.js";
...
async function executeZalouserTool(_toolCallId, params, _signal, _onUpdate, context) {
  try {
    switch (params.action) {
      ...
      case "friends":
        return json(await listZaloFriendsMatching(params.profile, params.query));
      case "groups":
        return json(await listZaloGroupsMatching(params.profile, params.query));
      case "me":
        return json((await getZaloUserInfo(params.profile)) ?? { error: "Not authenticated" });
      case "status": {
