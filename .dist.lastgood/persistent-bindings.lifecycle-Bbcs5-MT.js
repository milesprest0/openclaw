import { o as buildConfiguredAcpSessionKey } from "./binding-registry-CM9LsNMd.js";
...
function sessionMatchesConfiguredBinding(params) {
  ...
  const desiredBackend =
    normalizeOptionalString(params.spec.backend) ??
  ...
  if (desiredCwd !== void 0) {
    if (desiredCwd !== (params.meta.runtimeOptions?.cwd ?? params.meta.cwd ?? "").trim())
      return false;
  }
  return true;
}
