    ...
    entries: [
      ...
      },
      {
        ...
        openclaw: {
          ...
          contracts: { tools: ["query_group_info", "query_session_members", "yuanbao_remind"] },
          channel: {
            id: "yuanbao",
            label: "Yuanbao",
      ...
      },
      {
        ...
        openclaw: {
          ...
          install: {
            ...
            defaultChoice: "npm",
            expectedIntegrity:
              "sha512-FZnUVMQRpKGTKezeplr/DYal+5RSif2tXE51pljIFrO8rn7bVnnvpbj81/i9UMrYbuGiom1sl8OeSDzWRDKGhQ==",
...
function resolveOfficialExternalPluginInstall(entry) {
  ...
  const defaultChoice =
    ...
    (npmSpec ? "npm" : clawhubSpec ? "clawhub" : localPath ? "local" : void 0);
  return {
...
//#endregion
export {
  listOfficialExternalPluginCatalogEntries as a,
  resolveOfficialExternalPluginInstall as c,
  listOfficialExternalChannelCatalogEntries as i,
  resolveOfficialExternalPluginLabel as l,
  getOfficialExternalPluginCatalogEntryForPackage as n,
  listOfficialExternalProviderCatalogEntries as o,
  getOfficialExternalPluginCatalogManifest as r,
  resolveOfficialExternalPluginId as s,
  getOfficialExternalPluginCatalogEntry as t,
};
