...
import {
  n as reconstructWebhookUrl,
  r as verifyPlivoWebhook,
...
import { t as escapeXml } from "./voice-mapping-hp9BMUpM.js";
...
var PlivoProvider = class PlivoProvider {
  ...
  normalizeEvent(params, callIdOverride, dedupeKey) {
    ...
    const baseEvent = {
      ...
      timestamp: Date.now(),
      direction:
        direction === "inbound" ? "inbound" : direction === "outbound" ? "outbound" : void 0,
      from,
      to,
    };
