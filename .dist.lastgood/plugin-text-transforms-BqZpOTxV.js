  ...
  return {
    ...
    async return(value) {
      return (
        ...
        (await params.iterator.return?.(value)) ?? {
          done: true,
          value: void 0,
        }
      );
    ...
    async throw(error) {
      return (
        ...
        (await params.iterator.throw?.(error)) ?? {
          done: true,
          value: void 0,
        }
      );
...
//#endregion
export {
  createStreamIteratorWrapper as i,
  mergePluginTextTransforms as n,
  wrapStreamFnTextTransforms as r,
  applyPluginTextReplacements as t,
};
