...
function resolveTwitchToken(cfg, opts = {}) {
  ...
  if (accountId === "default")
    token = normalizeTwitchToken(
      (typeof twitchCfg?.accessToken === "string" ? twitchCfg.accessToken : void 0) ||
...
//#endregion
export {
  normalizeTwitchChannel as a,
  normalizeToken as i,
  isAccountConfigured as n,
  resolveTwitchToken as o,
  missingTargetError as r,
  generateMessageId as t,
};
