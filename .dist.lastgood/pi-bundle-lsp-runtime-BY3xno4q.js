...
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-CRhfBQz_.js";
...
import { o as setPluginToolMeta } from "./tools-DcY_52BH.js";
import {
...
function buildLspTools(session) {
  ...
  if (caps.referencesProvider)
    tools.push({
      ...
      execute: async (_toolCallId, input) => {
        const params = input;
        return formatLspResult(
          serverLabel,
          "references",
          await sendRequest(session, "textDocument/references", {
...
//#endregion
export {
  disposeAllBundleLspRuntimes as n,
  spawnLspServerProcess as r,
  createBundleLspToolRuntime as t,
};
