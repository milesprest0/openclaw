import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-BWOCdZvF.js";
import { t as getChannelEnvVars } from "./channel-env-vars-BhiFp6rv.js";
import {
...
function isChannelConfigured(cfg, channelId, env = process.env) {
  ...
  return Boolean(
    plugin?.config?.hasConfiguredState?.({
      cfg,
      env,
    }),
  );
...
//#endregion
export {
  listBundledChannelIdsWithConfiguredState as i,
  isStaticallyChannelConfigured as n,
  hasBundledChannelConfiguredState as r,
  isChannelConfigured as t,
};
