import {
  a as buildStatusOverviewSurfaceRows,
  t as buildGatewayStatusJsonPayload,
} from "./format-BCQX6-Ub.js";
...
import { r as resolveReadOnlyChannelPluginsForConfig } from "./read-only-DzM-sROf.js";
...
import { t as formatDaemonRuntimeShort } from "./status.format-D9HxkerB.js";
...
async function buildDaemonStatusSummary(serviceLabel) {
  const summary = await readServiceStatusSummary(
    serviceLabel === "gateway" ? resolveGatewayService() : resolveNodeService(),
    serviceLabel === "gateway" ? "Daemon" : "Node",
  );
  return {
    label: summary.label,
...
const providerUsageLoader = createLazyImportLoader(() => import("./provider-usage-D8GnM1jQ.js"));
...
async function resolveStatusRuntimeSnapshot(params) {
  return {
    securityAudit: params.includeSecurityAudit
...
//#endregion
export {
  resolveStatusSecurityAudit as a,
  buildStatusGatewayJsonPayloadFromSurface as c,
  buildStatusOverviewSurfaceFromScan as d,
  resolveStatusRuntimeSnapshot as i,
  buildStatusOverviewRowsFromSurface as l,
  resolveStatusGatewayHealth as n,
  resolveStatusServiceSummaries as o,
  resolveStatusGatewayHealthSafe as r,
  resolveStatusUsageSummary as s,
  loadStatusProviderUsageModule as t,
  buildStatusOverviewSurfaceFromOverview as u,
};
