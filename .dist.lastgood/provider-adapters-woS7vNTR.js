...
import {
  E as createLocalEmbeddingProvider,
...
import "./provider-env-vars-BEypkIHX.js";
...
function isNodeLlamaCppMissing(err) {
  ...
  return (
    err.code === "ERR_MODULE_NOT_FOUND" && err.message.includes(NODE_LLAMA_CPP_RUNTIME_PACKAGE)
  );
}
...
//#endregion
export {
  registerBuiltInMemoryEmbeddingProviders as i,
  getBuiltinMemoryEmbeddingProviderDoctorMetadata as n,
  listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata as r,
  canAutoSelectLocal as t,
};
