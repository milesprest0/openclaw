...
import { t as resolveAgentRuntimeLabel } from "./agent-runtime-label-C8cRoBjh.js";
...
import { i as resolveExtraParams } from "./extra-params-DDMcNhQe.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-B3SbiQ0U.js";
...
import {
  n as resolveSelectedAndActiveModel,
  t as formatProviderModelRef,
} from "./model-runtime-D7UoNxI6.js";
import {
...
import { S as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-CGPIaW-n.js";
import {
  n as findDecisionReason,
  s as summarizeDecisionReason,
...
import { s as readRecentSessionUsageFromTranscript } from "./session-utils.fs-z-7Kw0Lg.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-B8Yuw4Bp.js";
import {
...
function resolveExecutionLabel(args) {
  ...
  return `${
    (() => {
      ...
      return (
        sessionKey !==
        resolveMainSessionKey({ session: { scope: args.sessionScope ?? "per-sender" } }).trim()
      );
    })()
      ? "docker"
      : sessionKey
...
const formatContextUsageShort = (total, contextTokens) =>
...
function buildStatusMessage(args) {
  ...
  const selectedAuthLabelValue =
    args.modelAuth ??
    (selectedAuthMode && selectedAuthMode !== "unknown" ? selectedAuthMode : void 0);
  ...
  const activeAuthLabelValue =
    ...
    (activeAuthMode && activeAuthMode !== "unknown" ? activeAuthMode : void 0);
