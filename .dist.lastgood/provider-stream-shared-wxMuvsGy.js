...
import "./anthropic-payload-policy-rzH8F_Im.js";
import "./copilot-dynamic-headers-ALufaLHR.js";
import {
...
function isAnthropicModelRef(modelId) {
  return normalizeLowercaseStringOrEmpty(modelId).replace(/^~/, "").startsWith("anthropic/");
}
...
function isAnthropicBedrockModel(modelId) {
  ...
  if (
    ...
    return (normalized.split(":application-inference-profile/")[1] ?? "").includes("claude");
  return false;
}
...
function sanitizeGoogleThinkingConfigContainer(params) {
  ...
  if (typeof params.modelId === "string" && isGemma4Model(params.modelId)) {
    ...
    if (
      ...
      (disabledViaBudget && explicitMappedLevel === void 0 && !normalizedThinkingLevel)
    ) {
    ...
    const mappedLevel =
      explicitMappedLevel ?? normalizedThinkingLevel ?? (hadThinkingBudget ? "MINIMAL" : void 0);
...
//#endregion
export {
  createZaiToolStreamWrapper as C,
  isAnthropicFamilyCacheTtlEligible as D,
  isAnthropicBedrockModel as E,
  isAnthropicModelRef as O,
  createToolStreamWrapper as S,
  visitObjectContentBlocks as T,
  sanitizeGoogleThinkingPayload as _,
  createGoogleThinkingStreamWrapper as a,
  stripTrailingAssistantPrefillMessages as b,
  decodeHtmlEntitiesInObject as c,
  isGoogleGemini3FlashModel as d,
  isGoogleGemini3ProModel as f,
  resolveGoogleGemini3ThinkingLevel as g,
  isOpenAICompatibleThinkingEnabled as h,
  createGoogleThinkingPayloadWrapper as i,
  resolveAnthropicCacheRetentionFamily as k,
  defaultToolStreamExtraParams as l,
  isGoogleThinkingRequiredModel as m,
  createAnthropicThinkingPrefillPayloadWrapper as n,
  createHtmlEntityToolCallArgumentDecodingWrapper as o,
  isGoogleGemini3ThinkingLevelModel as p,
  createDeepSeekV4OpenAICompatibleThinkingWrapper as r,
  createPayloadPatchStreamWrapper as s,
  composeProviderStreamWrappers as t,
  isGoogleGemini25ThinkingBudgetModel as u,
  stripInvalidGoogleThinkingBudget as v,
  createBedrockNoCacheWrapper as w,
  wrapStreamMessageObjects as x,
  stripTrailingAnthropicAssistantPrefillWhenThinking as y,
};
