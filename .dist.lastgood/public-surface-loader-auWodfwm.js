...
import { i as resolveBundledPluginPublicSurfacePath } from "./public-surface-runtime-oqLUypXI.js";
import { i as openRootFileSync } from "./root-file-B8t_jFqF.js";
import {
  d as resolvePluginLoaderTryNative,
  l as resolveLoaderPackageRoot,
...
function loadBundledPluginPublicArtifactModuleSync(params) {
  ...
  if (!sameFileIdentity(validatedStat, fs.statSync(validatedPath)))
    throw new Error(
