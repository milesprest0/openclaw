...
import { r as listChannelPluginCatalogEntries } from "./catalog-CLuOxtzZ.js";
import {
  l as resolveDefaultPluginExtensionsDir,
  n as loadInstalledPluginIndexInstallRecords,
} from "./channel-catalog-registry-uu7_tUkL.js";
import { h as resolveConfiguredChannelPresencePolicy } from "./channel-plugin-ids-C9CG3lVz.js";
import {
...
import { M as parseRegistryNpmSpec } from "./discovery-bnS95tO3.js";
...
import { a as installPluginFromNpmSpec } from "./install-Djc3uDTp.js";
import { s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-BD2sKB0z.js";
import { f as loadInstalledPluginIndex } from "./installed-plugin-index-store-YgBbP4mp.js";
import { t as buildNpmResolutionInstallFields } from "./installs-Dt5uWKE7.js";
...
import {
  a as listOfficialExternalPluginCatalogEntries,
  c as resolveOfficialExternalPluginInstall,
  l as resolveOfficialExternalPluginLabel,
  s as resolveOfficialExternalPluginId,
} from "./official-external-plugin-catalog-BYIstKqF.js";
import { t as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-CqwJizDn.js";
import { s as normalizeOptionalLowercaseString } from "./string-coerce-BdEutqX5.js";
import { i as updateNpmInstalledPlugins } from "./update-02X0g2as.js";
import {
...
import { n as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog--oq5Ta8Q.js";
...
function collectBlockedPluginIds(cfg) {
  ...
  for (const [pluginId, entry] of Object.entries(entries ?? {}))
    if (pluginId.trim() && asObjectRecord(entry)?.enabled === false) ids.add(pluginId.trim());
  return ids;
}
...
function collectConfiguredPluginIdsWithMissingChannelConfigDescriptors(params) {
  ...
  for (const diagnostic of params.snapshot.diagnostics) {
    ...
    if (!pluginId || !diagnostic.message.includes(MISSING_CHANNEL_CONFIG_DESCRIPTOR_DIAGNOSTIC))
      continue;
    const ownsConfiguredChannel = pluginsById
      .get(pluginId)
      ?.channels.some((channelId) => params.configuredChannelIds.has(channelId));
...
async function repairMissingPluginInstalls(params) {
  ...
  const bundledPluginsById = new Map([
    ...
    ...currentBundledPlugins.map((plugin) => [
      plugin.pluginId,
