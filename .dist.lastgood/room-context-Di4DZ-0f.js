...
import { n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-COpbJNwP.js";
import { a as formatErrorMessage } from "./errors-DZMrVkYL.js";
import { r as logVerbose } from "./globals-BdfwDi2E.js";
import { t as evaluateGroupRouteAccessForPolicy } from "./group-access-CdIgeyPS.js";
...
import { r as buildUntrustedChannelMetadata } from "./security-runtime-6Bn2Pszp.js";
...
function resolveSlackSlashCommandConfig(raw) {
  const name =
    normalizeSlackSlashCommandName(normalizeOptionalString(raw?.name) ?? "openclaw") || "openclaw";
  return {
...
function resolveSlackChannelConfig(params) {
  ...
  const match = resolveChannelEntryMatchWithFallback({
    ...
    keys: buildChannelKeyCandidates(
      channelId,
      channelIdLower !== channelId ? channelIdLower : void 0,
      channelIdUpper !== channelId ? channelIdUpper : void 0,
      channelTarget,
      channelTargetLower !== channelTarget ? channelTargetLower : void 0,
      channelTargetUpper !== channelTarget ? channelTargetUpper : void 0,
      allowNameMatching ? (channelName ? `#${directName}` : void 0) : void 0,
      allowNameMatching ? directName : void 0,
      allowNameMatching ? normalizedName : void 0,
    ),
    wildcardKey: "*",
  });
  ...
  if (channelId) {
    ...
    if (params.interactiveEvent) {
      ...
      const sourceNormalized =
        typeof resolvedTypeSource === "string" ? resolvedTypeSource.toLowerCase().trim() : void 0;
      if (
        inferredFromId === void 0 &&
        !(
          sourceNormalized === "im" ||
  ...
  if (channelType === "im") {
    ...
    if (channelUsersAllowlistConfigured) {
      if (
        ...
        (params.interactiveEvent && ownerExplicitlyAllowed)
      )
        return {
          allowed: true,
          channelType,
...
//#endregion
export {
  resolveSlackEffectiveAllowFrom as a,
  normalizeSlackChannelType as c,
  resolveSlackChannelLabel as d,
  buildSlackSlashCommandMatcher as f,
  authorizeSlackSystemEventSender as i,
  resolveSlackChatType as l,
  stripSlackMentionsForCommandDetection as m,
  authorizeSlackDirectMessage as n,
  createSlackMonitorContext as o,
  resolveSlackSlashCommandConfig as p,
  authorizeSlackBotRoomMessage as r,
  isSlackChannelAllowedByPolicy as s,
  resolveSlackRoomContextHints as t,
  resolveSlackChannelConfig as u,
};
