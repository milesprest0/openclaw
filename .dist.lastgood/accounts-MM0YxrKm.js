...
import { t as resolveMergedWhatsAppAccountConfig } from "./account-config-G8voUoxJ.js";
...
import {
  n as listConfiguredAccountIds,
  r as resolveDefaultWhatsAppAccountId,
  t as listAccountIds,
} from "./account-ids-Cf3YHW18.js";
import { t as hasWebCredsSync } from "./creds-files-DXfG5BdV.js";
...
function resolveWhatsAppMediaMaxBytes(account) {
  return (
    (typeof account.mediaMaxMb === "number" && account.mediaMaxMb > 0 ? account.mediaMaxMb : 50) *
    1024 *
    1024
  );
}
...
//#endregion
export {
  resolveWhatsAppAccount as a,
  listWhatsAppAuthDirs as i,
  hasAnyWhatsAppAuth as n,
  resolveWhatsAppAuthDir as o,
  listEnabledWhatsAppAccounts as r,
  resolveWhatsAppMediaMaxBytes as s,
  DEFAULT_WHATSAPP_MEDIA_MAX_MB as t,
};
