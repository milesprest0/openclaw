...
} from "./cmd-argv-4E5k3WN1.js";
import { n as parseProcCmdline, t as isGatewayArgv } from "./gateway-process-argv-CHw7D59b.js";
...
import { a as inspectPortUsage } from "./ports-CzR_dSOf.js";
import {
  a as readWindowsProcessArgsSync,
  i as readWindowsListeningPidsOnPortSync,
  n as findGatewayPidsOnPortSync,
} from "./restart-stale-pids-KOGEujAp.js";
import {
  i as writeFormattedLines,
  n as formatLine,
  t as parseKeyValueOutput,
} from "./runtime-parse-B8z31bXs.js";
import { t as execSchtasks } from "./schtasks-exec-CFg2CBDn.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-BdEutqX5.js";
import { _ as sleep } from "./utils-BGRcpLKt.js";
import { t as getWindowsInstallRoots } from "./windows-install-roots-BcoLinij.js";
...
async function updateExistingScheduledTask(params) {
  ...
  if (
    (await execSchtasks(["/Change", "/TN", params.taskName, "/TR", params.quotedScript])).code !== 0
  )
    return false;
...
async function activateScheduledTask(params) {
  ...
  if (
    await updateExistingScheduledTask({
      ...params,
      taskName,
      quotedScript,
    })
...
//#endregion
export {
  resolveTaskScriptPath as a,
  stopScheduledTask as c,
  formatGatewayPidList as d,
  signalVerifiedGatewayPidSync as f,
  readScheduledTaskRuntime as i,
  uninstallScheduledTask as l,
  isScheduledTaskInstalled as n,
  restartScheduledTask as o,
  readScheduledTaskCommand as r,
  stageScheduledTask as s,
  installScheduledTask as t,
  findVerifiedGatewayListenerPidsOnPortSync as u,
};
