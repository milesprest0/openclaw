...
import {
  n as require_dist_cjs$1,
  r as require_dist_cjs$3,
  t as require_dist_cjs$2,
} from "./dist-cjs-BVrhceAl.js";
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function httpRequest(options) {
    return new Promise((resolve, reject) => {
      ...
      req.on("error", (err) => {
        reject(
          Object.assign(
            new propertyProvider.ProviderError("Unable to connect to instance metadata service"),
            err,
          ),
        );
        req.destroy();
      ...
      req.on("response", (res) => {
        ...
        if (statusCode < 200 || 300 <= statusCode) {
          reject(
            Object.assign(
              new propertyProvider.ProviderError(
  ...
  var InstanceMetadataV1FallbackError = class InstanceMetadataV1FallbackError
  ...
  const getInstanceMetadataEndpoint = async () =>
    urlParser.parseUrl((await getFromEndpointConfig()) || (await getFromEndpointModeConfig()));
  const getFromEndpointConfig = async () =>
    nodeConfigProvider.loadConfig(ENDPOINT_CONFIG_OPTIONS)();
      ...
      if (disableFetchToken) {
        ...
        try {
          ...
          if (error?.statusCode === 400)
            throw Object.assign(error, { message: "EC2 Metadata token request returned error" });
  ...
  const getMetadataToken = async (options) =>
    httpRequest({
      ...options,
