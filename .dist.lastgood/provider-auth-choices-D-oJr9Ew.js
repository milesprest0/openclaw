...
function resolvePreferredManifestAuthChoiceMetadata(params) {
  const preferred = pickPreferredManifestAuthChoice(
    resolveManifestProviderAuthChoiceCandidates(params.config).filter(params.matches),
  );
...
//#endregion
export {
  resolveManifestProviderOnboardAuthFlags as a,
  resolveManifestProviderAuthChoices as i,
  resolveManifestProviderApiKeyChoice as n,
  resolveManifestProviderAuthChoice as r,
  resolveManifestDeprecatedProviderAuthChoice as t,
};
