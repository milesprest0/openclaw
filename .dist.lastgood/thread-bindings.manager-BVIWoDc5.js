...
import { it as getChannel } from "./discord-Do-Uybag.js";
...
import { N as createDiscordRestClient } from "./send.shared-DW2ozbKR.js";
...
import {
  a as registerSessionBindingAdapter,
...
import { t as resolveThreadBindingConversationIdFromBindingId } from "./thread-binding-id-CC2lN0Wl.js";
import {
...
import {
  A as DEFAULT_THREAD_BINDING_IDLE_TIMEOUT_MS,
  C as resolveThreadBindingMaxAgeMs,
  D as shouldDefaultPersist,
  E as setBindingRecord,
  M as THREAD_BINDINGS_SWEEP_INTERVAL_MS,
  S as resolveThreadBindingMaxAgeExpiresAt,
  T as saveBindingsToDisk,
  _ as resetThreadBindingsForTests,
  a as THREAD_BINDING_TOUCH_PERSIST_MIN_INTERVAL_MS,
  b as resolveThreadBindingIdleTimeoutMs,
  c as getThreadBindingToken,
  d as normalizeThreadBindingDurationMs,
  f as normalizeThreadId,
  g as removeBindingRecord,
  h as rememberThreadBindingToken,
  n as MANAGERS_BY_ACCOUNT_ID,
  o as ensureBindingsLoaded,
  p as rememberRecentUnboundWebhookEcho,
  r as PERSIST_BY_ACCOUNT_ID,
  s as forgetThreadBindingToken,
  t as BINDINGS_BY_THREAD_ID,
  u as normalizeTargetKind,
  v as resolveBindingIdsForSession,
  w as resolveThreadBindingsPath,
  x as resolveThreadBindingInactivityExpiresAt,
  y as resolveBindingRecordKey,
    ...
    bind: async (input) => {
      ...
      const introText =
        typeof metadata.introText === "string"
          ...
          : void 0;
      const boundBy =
        typeof metadata.boundBy === "string" ? normalizeOptionalString(metadata.boundBy) : void 0;
      const agentId =
        typeof metadata.agentId === "string" ? normalizeOptionalString(metadata.agentId) : void 0;
      let threadId;
      let channelId;
...
//#endregion
export {
  getThreadBindingManager as i,
  createNoopThreadBindingManager as n,
  createThreadBindingManager as r,
  __testing as t,
};
