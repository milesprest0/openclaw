import { n as resolveGatewayProbeSurfaceAuth } from "./auth-surface-resolution-oMpr2b1p.js";
import { i as isLoopbackHost } from "./net-BQYp2xgJ.js";
import { t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-B5ny5Zpe.js";
...
function extractConfigSummary(snapshotUnknown) {
  ...
  return {
    ...
    valid,
    issues: issuesRaw
      .filter((i) => i && typeof i.path === "string" && typeof i.message === "string")
      .map((i) => ({
        path: i.path,
        message: i.message,
      })),
...
//#endregion
export {
  isScopeLimitedProbeFailure as a,
  renderTargetHeader as c,
  resolveTargets as d,
  sanitizeSshTarget as f,
  isProbeReachable as i,
  resolveAuthForTarget as l,
  extractConfigSummary as n,
  parseTimeoutMs as o,
  summarizeGatewayProbeCapability as p,
  isPostConnectProbeFailure as r,
  renderProbeSummaryLine as s,
  buildNetworkHints as t,
  resolveProbeBudgetMs as u,
};
