import {
  At as validateSecretsResolveResult,
  gi as errorShape,
  hi as ErrorCodes,
  kt as validateSecretsResolveParams,
} from "./protocol-CUn5aLrV.js";
import { i as isKnownSecretTargetId } from "./target-registry-BECxoPqR.js";
...
function invalidSecretsResolveField(errors) {
  for (const issue of errors ?? [])
    if (
      ...
      (issue.instancePath === "" && String(issue.params?.missingProperty) === "commandName")
    )
      return "commandName";
  return "targetIds";
}
