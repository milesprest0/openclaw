...
import {
  g as normalizeMattermostBaseUrl,
  i as resolveMattermostReplyToMode,
  n as resolveDefaultMattermostAccountId,
  r as resolveMattermostAccount,
  t as listMattermostAccountIds,
} from "./accounts-Cu-lJXIz.js";
import { n as formatNormalizedAllowFromEntries } from "./allow-from-BNON_Q4N.js";
...
import { r as createLoggedPairingApprovalNotifier } from "./channel-pairing-Tw2QazlD.js";
...
} from "./secret-contract-OB7uI-i7.js";
...
import { f as createStandardChannelSetupStatus } from "./setup-wizard-helpers-DMtL-dMq.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CLYqev3x.js";
import {
...
const MattermostGroupSchema = zod_exports.z
  .object({
...
const DmChannelRetrySchema = zod_exports.z
  .object({
  ...
  .optional();
const MattermostSlashCommandsSchema = zod_exports.z
  .object({
    /** Enable native slash commands. "auto" resolves to false (opt-in). */
    native: zod_exports.z
      .union([zod_exports.z.boolean(), zod_exports.z.literal("auto")])
      .optional(),
    /** Also register skill-based commands. */
    nativeSkills: zod_exports.z
      .union([zod_exports.z.boolean(), zod_exports.z.literal("auto")])
      .optional(),
  ...
  .strict()
  .optional();
const MattermostNetworkSchema = zod_exports.z
  .object({
    /** Dangerous opt-in for self-hosted Mattermost on trusted private/internal hosts. */
    dangerouslyAllowPrivateNetwork: zod_exports.z.boolean().optional(),
  })
  .strict()
  .optional();
const MattermostStreamingModeSchema = zod_exports.z.enum(["off", "partial", "block", "progress"]);
const MattermostStreamingProgressSchema = zod_exports.z
  .object({
  ...
  .strict();
const MattermostStreamingPreviewSchema = zod_exports.z
  .object({ toolProgress: zod_exports.z.boolean().optional() })
  .strict();
const MattermostStreamingBlockSchema = zod_exports.z
  .object({
...
const MattermostAccountSchemaBase = zod_exports.z
  .object({
    ...
    chatmode: zod_exports.z.enum(["oncall", "onmessage", "onchar"]).optional(),
    ...
    replyToMode: zod_exports.z.enum(["off", "first", "all", "batched"]).optional(),
    ...
    groups: zod_exports.z
      .record(zod_exports.z.string(), MattermostGroupSchema.optional())
      .optional(),
...
const MattermostChannelConfigSchema = buildChannelConfigSchema(
  MattermostAccountSchemaBase.extend({
    accounts: zod_exports.z
      .record(zod_exports.z.string(), MattermostAccountSchema.optional())
      .optional(),
...
const mattermostSetupWizard = {
  ...
  status: createStandardChannelSetupStatus({
    ...
    resolveConfigured: ({ cfg, accountId }) =>
      isMattermostConfigured(resolveMattermostAccountWithSecrets(cfg, accountId ?? "default")),
  }),
  introNote: {
...
const loadMattermostChannelRuntime = createLazyRuntimeModule(
  () => import("./channel.runtime-zOKkJnko.js"),
);
    ...
    if (action === "react") {
      ...
      if (
        !(
          ...
          }).config.actions?.reactions ??
          mattermostConfig?.actions?.reactions ??
          true
        )
      )
...
//#endregion
export {
  describeMattermostAccount as a,
  mattermostMeta as c,
  MattermostChannelConfigSchema as i,
  mattermostSetupWizard as n,
  isMattermostConfigured$1 as o,
  mattermostSetupAdapter as r,
  mattermostConfigAdapter as s,
  mattermostPlugin as t,
};
