import { l as onAgentEvent, t as clearAgentRunContext } from "./agent-events-c6-2eZvI.js";
import { r as onHeartbeatEvent } from "./heartbeat-events-Dux0y1fS.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-D9760v5u.js";
...
function startGatewayEventSubscriptions(params) {
  ...
  const getAgentEventHandler = () => {
    agentEventHandlerPromise ??= Promise.all([
      import("./server-chat-BNDpOm69.js"),
      import("./server-session-key-CJsPxIKH.js"),
  ...
  const getTranscriptUpdateHandler = () => {
    transcriptUpdateHandlerPromise ??= import("./server-session-events-Ckz3D6Nd.js").then(
  ...
  const getLifecycleEventHandler = () => {
    lifecycleEventHandlerPromise ??= import("./server-session-events-Ckz3D6Nd.js").then(
