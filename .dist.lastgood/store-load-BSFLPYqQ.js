...
import { r as parseStrictNonNegativeInteger } from "./parse-finite-number-Bfn_46hj.js";
import { t as getLoadedChannelPluginForRead } from "./registry-loaded-read-MOL61L91.js";
import { i as resolveSessionThreadInfo } from "./session-conversation-YLqp8hUs.js";
...
import { a as normalizeSessionRuntimeModelFields } from "./types-C7lm-riv.js";
import { r as parseByteSize } from "./zod-schema-DbvbVEd2.js";
...
function pruneStaleEntries(store, overrideMaxAgeMs, opts = {}) {
  ...
  if (pruned > 0 && opts.log !== false)
    log$1.info("pruned stale session entries", {
      pruned,
      maxAgeMs,
    });
  return pruned;
...
function pruneQuotaSuspensions(params) {
  ...
  if ((resumed.length > 0 || cleared > 0) && params.log !== false)
    log$1.info("processed quota-suspension TTLs", {
...
function capEntryCount(store, overrideMax, opts = {}) {
  ...
  if (opts.log !== false)
    log$1.info("capped session entry count", {
...
//#endregion
export {
  getFileStatSnapshot as C,
  createExpiringMapCache as S,
  resolveCacheTtlMs as T,
  getSerializedSessionStore as _,
  getActiveSessionMaintenanceWarning as a,
  takeMutableSessionStoreCache as b,
  pruneStaleEntries as c,
  parseSessionThreadInfo as d,
  parseSessionThreadInfoFast as f,
  dropSessionStoreObjectCache as g,
  cloneSessionStoreRecord as h,
  capEntryCount as i,
  resolveMaintenanceConfigFromInput as l,
  clearSessionStoreCaches as m,
  normalizeSessionStore as n,
  isProtectedSessionMaintenanceEntry as o,
  resolveLoadedSessionThreadInfo as p,
  resolveMaintenanceConfig as r,
  pruneQuotaSuspensions as s,
  loadSessionStore as t,
  shouldRunSessionEntryMaintenance as u,
  isSessionStoreCacheEnabled as v,
  isCacheEnabled as w,
  writeSessionStoreCache as x,
  setSerializedSessionStore as y,
};
