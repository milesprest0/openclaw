...
import { n as registerTempPathForExit } from "./write-queue-CClMlwr5.js";
...
function tempWorkspaceSync(options) {
  ...
  return {
    ...
    read: (fileName) => {
      ...
      if (!opened.ok)
        throw Object.assign(/* @__PURE__ */ new Error(`File not found: ${fileName}`), {
          code: "ENOENT",
        });
      try {
...
//#endregion
export {
  withTempWorkspaceSync as i,
  tempWorkspaceSync as n,
  withTempWorkspace as r,
  tempWorkspace as t,
};
