...
import { x as collectUniqueCommandDescriptors } from "./argv-DQxa_OA3.js";
...
import { c as loadOpenClawPluginCliRegistry, l as loadOpenClawPlugins } from "./loader-BLowS1kl.js";
...
async function resolvePluginCliRootOwnerIds(params) {
  ...
  const logger = resolvePluginCliLogger(params.logger);
  return (
    (await resolvePrimaryCommandPluginIds(
      resolvePluginCliLoadContext({
        cfg: params.cfg,
        env: params.env,
        logger,
...
//#endregion
export {
  loadPluginCliRegistrationEntries as a,
  resolvePluginCliRootOwnerIds as c,
  loadPluginCliMetadataRegistryWithContext as i,
  loadPluginCliCommandRegistryWithContext as n,
  loadPluginCliRegistrationEntriesWithDefaults as o,
  loadPluginCliDescriptors as r,
  resolvePluginCliLoadContext as s,
  createPluginCliLogger as t,
};
