...
import { y as restoreCredsFromBackupIfNeeded } from "./auth-store-2Cym1SYy.js";
import { t as formatCliCommand } from "./command-format-yMavKibC.js";
import {
  a as waitForWhatsAppLoginResult,
  i as closeWaSocketSoon,
...
import { r as logInfo } from "./logger-BWdMCYqK.js";
import { t as renderQrTerminal } from "./qr-terminal-DNeh75Fq.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import { i as resolveWhatsAppSocketTiming, t as createWaSocket } from "./session-DdgvKejg.js";
...
async function loginWeb(verbose, waitForConnection, runtime = defaultRuntime, accountId) {
  ...
  const onQr = (qr) => {
    ...
    renderQrTerminal(qr, { small: true })
      .then((output) => {
