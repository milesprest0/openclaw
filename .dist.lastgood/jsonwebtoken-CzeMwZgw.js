...
import { t as require_jws } from "./jws-BbK7FZDe.js";
import { t as require_ms } from "./ms-CafVAZqo.js";
...
var require_verify = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const {
    KeyObject: KeyObject$1,
    createSecretKey: createSecretKey$1,
    createPublicKey,
  } = __require("crypto");
    ...
    return getSecret(header, function (err, secretOrPublicKey) {
      ...
      if (secretOrPublicKey != null && !(secretOrPublicKey instanceof KeyObject$1))
        try {
          ...
          try {
            secretOrPublicKey = createSecretKey$1(
      ...
      if (typeof payload.nbf !== "undefined" && !options.ignoreNotBefore) {
        ...
        if (payload.nbf > clockTimestamp + (options.clockTolerance || 0))
          return done(
            new NotBeforeError("jwt not active", /* @__PURE__ */ new Date(payload.nbf * 1e3)),
          );
      }
      if (typeof payload.exp !== "undefined" && !options.ignoreExpiration) {
        ...
        if (clockTimestamp >= payload.exp + (options.clockTolerance || 0))
          return done(
            new TokenExpiredError("jwt expired", /* @__PURE__ */ new Date(payload.exp * 1e3)),
          );
      }
      if (options.audience) {
        const audiences = Array.isArray(options.audience) ? options.audience : [options.audience];
        if (
          !(Array.isArray(payload.aud) ? payload.aud : [payload.aud]).some(
        ...
        if (clockTimestamp >= maxAgeTimestamp + (options.clockTolerance || 0))
          return done(
            new TokenExpiredError(
              "maxAge exceeded",
              /* @__PURE__ */ new Date(maxAgeTimestamp * 1e3),
            ),
          );
      }
      if (options.complete === true) {
...
var require_sign = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  module.exports = function (payload, secretOrPrivateKey, options, callback) {
    ...
    if (!secretOrPrivateKey && options.algorithm !== "none")
      return failure(/* @__PURE__ */ new Error("secretOrPrivateKey must have a value"));
    ...
    if (header.alg.startsWith("HS") && secretOrPrivateKey.type !== "secret")
      ...
      if (
        ...
        secretOrPrivateKey.asymmetricKeyDetails !== void 0 &&
    ...
    if (typeof payload === "undefined")
      return failure(/* @__PURE__ */ new Error("payload is required"));
