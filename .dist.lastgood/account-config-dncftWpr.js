...
import { s as resolveMergedAccountConfig } from "./account-helpers-DgSuSC4_.js";
...
function selectInheritedMatrixRoomEntries(params) {
  ...
  const selected = Object.fromEntries(
    Object.entries(entries).filter(([, value]) => {
      const scopedAccount =
        typeof value?.account === "string" ? normalizeAccountId(value.account) : void 0;
...
//#endregion
export {
  resolveMatrixAccountConfig as a,
  resolveMatrixAccountAllowlistConfig as i,
  hasExplicitMatrixAccountConfig as n,
  resolveMatrixBaseConfig as o,
  listNormalizedMatrixAccountIds as r,
  findMatrixAccountConfig as t,
};
