import { n as buildGatewayInstallPlan } from "./auth-install-policy-Cz1r8ABN.js";
import { a as callGatewayCli } from "./call-hIeQLRKk.js";
import { t as formatCliCommand } from "./command-format-yMavKibC.js";
import { n as isRestartEnabled } from "./commands.flags-DSmuIKZj.js";
import {
  i as OPENCLAW_WRAPPER_ENV_KEY,
  s as resolveOpenClawWrapperPath,
} from "./daemon-install-plan.shared-Bdw5CBKo.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CkYPLluX.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-B-dA6zdQ.js";
import { t as mergeInstallInvocationEnv } from "./install-B13nQGLF.js";
import { d as readConfigFileSnapshotForWrite, l as readBestEffortConfig } from "./io-CEQSCTGy.js";
import {
  o as repairLaunchAgentBootstrap,
  r as launchAgentPlistExists,
} from "./launchd-CUsyAGNR.js";
import {
...
import { a as probeGateway } from "./probe-BYE8ps06.js";
import { g as writeGatewayRestartIntentSync } from "./restart-BMF0Nrvt.js";
import {
  a as renderGatewayPortHealthDiagnostics,
  c as waitForGatewayHealthyListener,
  l as waitForGatewayHealthyRestart,
  o as renderRestartDiagnostics,
  s as terminateStaleGatewayPids,
  t as DEFAULT_RESTART_HEALTH_ATTEMPTS,
} from "./restart-health-B4e32uo2.js";
import { n as defaultRuntime } from "./runtime-kqN0Yohi.js";
import {
  d as formatGatewayPidList,
  f as signalVerifiedGatewayPidSync,
  u as findVerifiedGatewayListenerPidsOnPortSync,
} from "./schtasks-C3ohY86f.js";
import {
  i as resolveGatewayService,
  n as formatGatewayServiceStartRepairIssues,
} from "./service-XaNrZpdz.js";
import { l as renderGatewayServiceStartHints, s as parsePortFromArgs } from "./shared-CD1EqH1S.js";
...
async function recoverInstalledLaunchAgent(params) {
  ...
  if (
    !(
      await repairLaunchAgentBootstrap({ env }).catch(() => ({
        ok: false,
...
async function resolveGatewayLifecyclePort(service = resolveGatewayService()) {
  ...
  return (
    parsePortFromArgs(command?.programArguments) ??
    resolveGatewayPort(await readBestEffortConfig(), mergedEnv)
  );
}
function resolveGatewayPortFallback() {
  return readBestEffortConfig()
    .then((cfg) => resolveGatewayPort(cfg, process.env))
    .catch(() => resolveGatewayPort(void 0, process.env));
}
async function assertUnmanagedGatewayRestartEnabled(port) {
  ...
  if (!probe?.ok) return;
  if (!isRestartEnabled(probe.configSnapshot))
    throw new Error(
...
//#endregion
export {
  recoverInstalledLaunchAgent as a,
  runDaemonUninstall as i,
  runDaemonStart as n,
  runDaemonStop as r,
  runDaemonRestart as t,
};
