import { u as randomIdempotencyKey } from "./call-hIeQLRKk.js";
...
import { n as parsePairingList, t as parseNodeList } from "./node-list-parse-BrnqkfDF.js";
import {
...
import {
  ...
  i as resolveNode,
  n as callGatewayCli,
  o as unauthorizedHintForMessage,
  r as nodesCallOpts,
  s as formatPermissions,
  t as buildNodeInvokeParams,
} from "./rpc-BatpuIU2.js";
    ...
    camera
      ...
      .action(async (opts) => {
        await runNodesCommand("camera list", async () => {
          ...
          const payload =
            typeof res.payload === "object" && res.payload !== null ? res.payload : {};
    ...
    nodes
      ...
      .action(async (opts) => {
        await runNodesCommand("push", async () => {
          ...
          const reason =
            typeof parsed.reason === "string" ? normalizeOptionalString(parsed.reason) : void 0;
          const env =
    ...
    nodes
      ...
      .action(async (opts) => {
        await runNodesCommand("screen record", async () => {
          ...
          const parsed = parseScreenRecordPayload(
    ...
    nodes
      ...
      .action(async (opts) => {
        await runNodesCommand("list", async () => {
          ...
          const filteredPaired = mergePairedNodesWithEffectiveNodes(
            paired,
            hasFilters
