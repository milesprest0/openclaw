...
import { u as resolveDefaultPluginGitDir } from "./channel-catalog-registry-uu7_tUkL.js";
import "./replace-file-8cLr_oo0.js";
import { r as runCommandWithTimeout } from "./exec-Csn_09g3.js";
import { r as installPluginFromInstalledPackageDir } from "./install-Djc3uDTp.js";
...
import { a as guardedRm, r as guardedRename } from "./write-queue-CClMlwr5.js";
...
function splitGitSpecRef(input) {
  ...
  if (atIndex > Math.max(input.lastIndexOf("/"), input.lastIndexOf("\\")) && atIndex > 0)
    return {
