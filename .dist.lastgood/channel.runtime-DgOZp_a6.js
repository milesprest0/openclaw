...
import {
  c as sendGoogleChatMessage,
  d as verifyGoogleChatRequest,
  i as downloadGoogleChatMedia,
  l as updateGoogleChatMessage,
  n as deleteGoogleChatMessage,
  s as probeGoogleChat,
  u as uploadGoogleChatAttachment,
} from "./api-RdXJShn-.js";
...
import { t as getGoogleChatRuntime } from "./runtime-api-BQ7_xRCl.js";
import {
...
function isSenderAllowed(senderId, senderEmail, allowFrom, allowNameMatching = false) {
  ...
  return allowFrom.some((entry) => {
    ...
    if (withoutPrefix.startsWith("users/"))
      return normalizeUserId$1(withoutPrefix) === normalizedSenderId;
...
async function applyGoogleChatInboundAccessPolicy(params) {
  ...
  const isGoogleChatSenderAllowed = (_senderId, allowFrom) =>
