...
import {
  o as listSecretTargetRegistryEntries,
  r as discoverConfigSecretTargetsByIds,
...
function isScopedChannelSecretTargetEntry(params) {
  ...
  return (
    ...
    (params.entry.refPathPattern === void 0 ||
  ...
  if (channels && typeof channels === "object" && !Array.isArray(channels))
    for (const channelId of Object.keys(channels)) {
      ...
      for (const entry of contract?.secretTargetRegistryEntries ?? [])
        if (
          isScopedChannelSecretTargetEntry({
            entry,
...
//#endregion
export {
  getQrRemoteCommandSecretTargetIds as a,
  getStatusCommandSecretTargetIds as c,
  getModelsCommandSecretTargetIds as i,
  getChannelsCommandSecretTargetIds as n,
  getScopedChannelsCommandSecretTargets as o,
  getConfiguredChannelsCommandSecretTargetIds as r,
  getSecurityAuditCommandSecretTargetIds as s,
  getAgentRuntimeCommandSecretTargetIds as t,
};
