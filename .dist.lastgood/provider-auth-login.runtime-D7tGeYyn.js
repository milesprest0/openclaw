...
import {
  ...
  n as exchangeChutesCodeForTokens,
  r as generateChutesPkce,
  t as CHUTES_AUTHORIZE_ENDPOINT,
} from "./chutes-oauth-96yUmrYJ.js";
...
import {
  r as runOpenAIOAuthTlsPreflight,
  t as formatOpenAIOAuthTlsPreflightFix,
} from "./provider-openai-codex-oauth-tls-DQj9WOZE.js";
...
function createManualCodeInputHandler(params) {
  ...
  const runLocalManualFallback = async () => {
    ...
    if (
      (await waitForDelayOrLoginSettle({
...
const githubCopilotLoginCommand = (...args) =>
  loadFacadeModule()["githubCopilotLoginCommand"](...args);
//#endregion
