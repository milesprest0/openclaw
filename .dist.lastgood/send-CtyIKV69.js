import { r as resolveDefaultWhatsAppAccountId } from "./account-ids-Cf3YHW18.js";
import {
...
import { t as getRegisteredWhatsAppConnectionController } from "./connection-controller-registry-gWe3KErm.js";
import { i as getChildLogger } from "./logger-BU4ooQvN.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-BjMHBbxn.js";
import { n as isWhatsAppNewsletterJid } from "./normalize-target-B5_fp7Jp.js";
import {
  a as resolveWhatsAppOutboundMediaUrls,
  i as prepareWhatsAppOutboundMedia,
  n as normalizeWhatsAppPayloadText,
...
import { i as markdownToWhatsApp, o as toWhatsappJid } from "./text-runtime-BMQLJDUy.js";
...
function requireOutboundActiveWebListener(params) {
  const resolvedAccountId =
    resolveOutboundWhatsAppAccountId(params) ?? resolveDefaultWhatsAppAccountId(params.cfg);
  const listener =
...
async function sendMessageWhatsApp(to, body, options) {
  ...
  try {
    ...
    if (visibleTextAfterVoice)
      if (sendOptions)
        await active.sendMessage(to, visibleTextAfterVoice, void 0, void 0, sendOptions);
...
//#endregion
export {
  sendTypingWhatsApp as i,
  sendPollWhatsApp as n,
  sendReactionWhatsApp as r,
  sendMessageWhatsApp as t,
};
