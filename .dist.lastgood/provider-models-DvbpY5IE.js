import { f as cloneFirstTemplateModel } from "./provider-model-shared-CmD-CscC.js";
...
function buildGoogleTemplateSources(params) {
  ...
  const orderedTemplateProviderIds =
    isGoogleGeminiCliProvider(params.providerId) && params.family.preferExternalFirstForCli === true
