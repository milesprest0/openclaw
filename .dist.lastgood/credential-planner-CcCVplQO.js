...
function createGatewayCredentialPlan(params) {
  ...
  const localTokenSurfaceActive =
    localTokenCanWin &&
    !envToken &&
    (authMode === "token" || (authMode === void 0 && !(envPassword || localPassword.configured)));
...
//#endregion
export {
  trimToUndefined as a,
  trimCredentialToUndefined as i,
  hasGatewayPasswordEnvCandidate as n,
  hasGatewayTokenEnvCandidate as r,
  createGatewayCredentialPlan as t,
};
