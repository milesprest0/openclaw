...
import { n as resolveStoredSubagentCapabilities } from "./subagent-capabilities-C7k0LjTH.js";
import {
  a as resolveSessionEntryForKey,
  t as buildLatestSubagentRunIndex,
} from "./subagent-list-CDDt_IaF.js";
import {
  d as markSubagentRunForSteerRestart,
  f as markSubagentRunTerminated,
  i as countPendingDescendantRuns,
  m as replaceSubagentRunAfterSteer,
  t as clearSubagentRunSteerRestart,
...
import {
  a as sortSubagentRuns,
  i as resolveSubagentTargetFromRuns,
  r as resolveSubagentLabel,
} from "./subagents-utils-BysrAM37.js";
...
function resolveSubagentController(params) {
  ...
  return {
    ...
    controlScope: resolveStoredSubagentCapabilities(callerSessionKey, { cfg: params.cfg })
      .controlScope,
  };
}
...
function ensureControllerOwnsRun(params) {
  if (
    (params.entry.controllerSessionKey?.trim() || params.entry.requesterSessionKey) ===
...
async function steerControlledSubagentRun(params) {
  ...
  const cleared = (await resolveSubagentControlRuntime()).clearSessionQueues([
...
async function sendControlledSubagentMessage(params) {
  ...
  const targetSessionEntry = loadSessionStore(
    resolveStorePath(params.cfg.session?.store, { agentId: parsed?.agentId }),
  )[targetSessionKey];
...
//#endregion
export {
  killSubagentRunAdmin as a,
  resolveSubagentController as c,
  killControlledSubagentRun as i,
  sendControlledSubagentMessage as l,
  MAX_STEER_MESSAGE_CHARS as n,
  listControlledSubagentRuns as o,
  killAllControlledSubagentRuns as r,
  resolveControlledSubagentTarget as s,
  MAX_RECENT_MINUTES as t,
  steerControlledSubagentRun as u,
};
