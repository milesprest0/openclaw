...
function normalizeTelegramCommandName(value) {
  ...
  if (!trimmed) return "";
  return (
    normalizeOptionalLowercaseString(trimmed.startsWith("/") ? trimmed.slice(1) : trimmed) ?? ""
  ).replace(/-/g, "_");
}
...
//#endregion
export {
  resolveTelegramCustomCommands as i,
  normalizeTelegramCommandDescription as n,
  normalizeTelegramCommandName as r,
  TELEGRAM_COMMAND_NAME_PATTERN as t,
};
